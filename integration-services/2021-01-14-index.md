...
Es la forma más rápida y segura de migrar su contenido, aplicaciones web y API a Azion, sin importar qué tan complejo seas o la gran cantidad de recursos que poseas. Nuestro equipo de **Servicios de integración** habilitará los servicios que has contratado y te proporcionará las herramientas, la documentación y la capacitación necesarias para que uses exitosamente la Plataforma de Azion.

#### El servicio de integración está disponible en las siguientes modalidades, planificadas según las necesidades individuales de cada cliente:
...
## 1. Standard Integration{#integracion-estandar}
