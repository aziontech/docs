...
You want to filter your data by requests, but, in the request, you want to show only results that use the HTTPS method and that are larger than a certain value. 

In this situation, you should use **Https Requests Total** and **Greater than**. In the value field, you should add the value that you want to use as a starting point, such as "120". Then, your response will contain only results that are greater than the value informed.
