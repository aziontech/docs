...
To use Cache and analyze data on it, you must activate it in your account. See the [Cache documentation](https://www.azion.com/en/documentation/build/cache/) for more information.
