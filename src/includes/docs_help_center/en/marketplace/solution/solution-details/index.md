...
> If your Functions are using previous versions of a solution, they won’t be automatically updated or affected by it. To run the latest version, go to the functions section on your Applications and select the new version. Visit the [Updating a version of your solution on Marketplace's documentation](https://www.azion.com/en/documentation/marketplace/#versioning) page to learn more.
