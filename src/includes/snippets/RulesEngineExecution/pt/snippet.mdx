...
Se um behavior do tipo **Set**, como **Set Custom Response** no Edge Firewall ou **Set Origin** no Edge Application, for adicionado múltiplas vezes à regras no Rules Engine, apenas o último behavior da última regra na qual o criteria foi atendido será executado.
