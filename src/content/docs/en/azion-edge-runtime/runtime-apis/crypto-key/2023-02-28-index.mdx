...
The `CryptoKey` interface represents a cryptographic key obtained from one of the [SubtleCrypto methods](https://www.azion.com/en/documentation/products/edge-application/edge-functions/runtime-apis/javascript/subtle-crypto/).
