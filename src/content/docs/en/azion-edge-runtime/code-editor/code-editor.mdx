...
To know more about the preview, go to [Azion Preview Deployment](https://www.azion.com/en/documentation/products/edge-application/edge-functions/runtime-api/preview-deployment/).
...
Take a look at [Edge Functions ChatGPT integration](https://www.azion.com/en/documentation/products/edge-application/edge-functions/runtime-api/ai-integration/).
...
| --- | --- |
| [How to build an API with Edge Functions and ChatGPT](https://www.azion.com/en/documentation/products/guides/edge-functions/api-builder/) | See how to build an API and have its responses returned in JSON, with the help of ChatGPT |
