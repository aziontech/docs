...
The message is then collected and made available to be accessed on [Data Streaming](https://www.azion.com/en/documentation/products/data-streaming/).
...
Check the [Data Streaming documentation](https://www.azion.com/en/documentation/products/data-streaming/) to learn more.
