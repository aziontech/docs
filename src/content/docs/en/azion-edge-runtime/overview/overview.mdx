...
The **Azion Edge Runtime** is a set of tools for developing applications at the **Edge**. The Azion Edge Runtime allows you to write JavaScript [edge functions](https://www.azion.com/en/documentation/products/edge-application/edge-functions/) built on Web standards.
...
- [Next.js](https://www.azion.com/en/documentation/products/edge-application/edge-functions/runtime-api/supported-frameworks/nextjs/)
