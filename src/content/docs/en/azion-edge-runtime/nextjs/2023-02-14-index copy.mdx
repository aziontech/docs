...
- The latest [Azion CLI](https://www.azion.com/en/documentation/products/cli/first-steps/) version installed.

See how to have a Next.js project up and running on the Azion platform on [How to Build and Publish a Next.js Project with Server-side Rendering (SSR) on the Azion Platform](https://www.azion.com/en/documentation/products/guides/nextjs-ssr-on-azion-platform/).
