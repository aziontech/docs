...
**Note**: to see how to manage your edge functions in details, go to [Managing your Edge Functions using Azion CLI]({% tl documentation_how_to_cli_edge_functions %}).
