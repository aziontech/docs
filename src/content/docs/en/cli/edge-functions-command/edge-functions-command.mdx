...
**Note**: to see how to manage your edge functions in detail, go to [Managing your Edge Functions using Azion CLI](https://www.azion.com/en/documentation/products/guides/cli-managing-edge-functions/).
---
