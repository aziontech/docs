...
## 1. Listing your edge application's edge functions instances
...
## 2. Creating an edge functions instance
...
## 3. Updating an edge functions instance
...
## 4. Describing an edge functions instance
...
## 5. Deleting an edge functions instance
