...
Alternatively, you can [install Azion CLI manually](https://www.azion.com/en/documentation/products/guides/cli-installing-manually/).

If you're installing the CLI on a macOS operating system, see [running Azion CLI on macOS](https://www.azion.com/en/documentation/products/guides/cli-running-macos/).
...
> For more information on how to create and manage your *tokens*, use the [Azion API](https://api.azion.com/#aab16606-2014-43d0-9b7a-dc564146a1ac) or see the [Personal Tokens](https://www.azion.com/en/documentation/products/accounts/personal-tokens/) documentation page.
...
- [Edge Applications](https://www.azion.com/en/documentation/products/cli/edge-applications/)
- [Edge Functions](https://www.azion.com/en/documentation/products/cli/edge-functions/)
