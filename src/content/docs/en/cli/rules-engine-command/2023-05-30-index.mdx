...
## 1. Listing your edge application's rules in Rules Engine
...
## 2. Generating a template for the rules_engine create and update subcommands
...
## 3. Creating a rule in Rules Engine
...
## 4. Updating a rule in Rules Engine
...
## 5. Describing a rule in Rules Engine
...
## 6. Deleting a rule in Rules Engine
