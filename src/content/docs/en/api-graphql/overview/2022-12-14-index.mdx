...
Having in mind clients who want to request and visualize their data with easy and improved performance, Azion now provides support for GraphQL. You can use the API to maximize the use of your data accessed through [Real-Time Metrics](https://www.azion.com/en/documentation/products/real-time-metrics/), which provides you with real-time access to metrics so you can optimize all of your potential, and [Real-Time Events](https://www.azion.com/en/documentation/products/real-time-events/), which provides data in real time so you can perform complex searches to explore your information.

You can also check all Azion **Observe** products: [Data Streaming](https://www.azion.com/en/documentation/products/data-streaming/) and [Edge Pulse](https://www.azion.com/en/documentation/products/edge-pulse/).
