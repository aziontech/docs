...
Depending on the [type of field of a dataset](https://www.azion.com/en/documentation/products/graphql-api-features/#queries-datasets) you're querying for, you'll get to use different operators:
