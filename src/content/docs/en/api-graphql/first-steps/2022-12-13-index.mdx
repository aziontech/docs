...
The second option is to create a **Personal Token** through the Azion configuration interface, [Real-Time Manager (RTM)](https://manager.azion.com/). This option is more suitable for use with APIs due to the possibility of creating a long-lived token. See the [Personal Tokens](https://www.azion.com/en/documentation/products/accounts/personal-tokens/) documentation page to create one.
...
To interact with the GraphQL playground, you first need to log in to [RTM](https://manager.azion.com/). If you haven't created an account, see the [Creating an account on Azion](https://www.azion.com/en/documentation/products/accounts/creating-account/) documentation page.
