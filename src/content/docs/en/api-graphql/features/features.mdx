...
| Dataset   | Description |
|----------|-----------|
| httpMetrics | Request events registered by [Edge Application](https://www.azion.com/en/documentation/products/edge-application/) and [Edge Firewall](https://www.azion.com/en/documentation/products/edge-firewall/).     |
...
| edgeFunctionsMetrics | Events executed by [Edge Functions](https://www.azion.com/en/documentation/products/edge-application/edge-functions/).     |
| imagesProcessedMetrics |  Image processing events by [Image Processor](https://www.azion.com/en/documentation/products/edge-application/image-processor/).    |
| idnsQueriesMetrics | Query events performed on [Intelligent DNS](https://www.azion.com/en/documentation/products/intelligent-dns/).     |
| dataStreamedMetrics | Sent events of data by [Data Streaming](https://www.azion.com/en/documentation/products/data-streaming/) to the clients' endpoint.    |
| httpEvents | Request events registered by [Edge Application](https://www.azion.com/en/documentation/products/edge-application/) and [Edge Firewall](https://www.azion.com/en/documentation/products/edge-firewall/).     |
| l2CacheEvents | Request events registered by [L2 Caching](https://www.azion.com/en/documentation/products/edge-application/edge-caching/#l2-caching).    |
| edgeFunctionsEvents | Events executed by [Edge Functions](https://www.azion.com/en/documentation/products/edge-application/edge-functions/).     |
| imagesProcessedEvents |  Image processing events by [Image Processor](https://www.azion.com/en/documentation/products/edge-application/image-processor/).    |
| idnsQueriesEvents | Query events performed on [Intelligent DNS](https://www.azion.com/en/documentation/products/intelligent-dns/).     |
| dataStreamedEvents | Sent events of data by [Data Streaming](https://www.azion.com/en/documentation/products/data-streaming/) to the clients' endpoint.    |
| cellsConsoleEvents |  Events logs from applications using [Edge Runtime](https://www.azion.com/en/documentation/products/edge-application/edge-functions/runtime/overview/) returned by the Cells Console.  |

To see which fields are available for each Metrics dataset, read the [Fields Metrics GraphQL API](https://www.azion.com/en/documentation/products/graphql-api/features/metrics-fields/) documentation. You can also run an Introspection Query to consult metadata on the Metrics and Events datasets. Find out more on the [How to query metadata with GraphQL API](https://www.azion.com/en/documentation/products/guides/graphql-metadata/) guide.

> Find out more on [How to select Top X queries with GraphQL API](https://www.azion.com/en/documentation/products/guides/graphql-top-x-query/).
...
> Find out more on how to aggregate data with the [How to query aggregated data with GraphQL API](https://www.azion.com/en/documentation/products/guides/graphql-aggregated-data/) guide.
