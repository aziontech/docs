...
If you receive any of the described error responses, see the rest of the [GraphQL API documentation](https://www.azion.com/en/documentation/products/graphql-api/) to find specifications and correct your request.
