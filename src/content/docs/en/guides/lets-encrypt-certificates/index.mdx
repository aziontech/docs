...
## 2. Generating a Let's Encrypt certificate
...
### 2.1. Option 1: Preparing DNS entry on Azion Intelligent DNS
...
## 2.2. Option 2: Preparing DNS entry with an external DNS provider
...
## 4. Checking the status of Let's Encrypt certificates
...
## 5. Managing a Let's Encrypt certificate
