...
## 1. Configuring the SAML app on Azure AD portal
...
## 2. Configuring the Identity Provider on RTM
...
## 3. Completing the registration of the APP on Azure AD
...
## 4. Adding users on the Azure AD custom SAML app
...
## 5. Turning on the Identity Provider on RTM
