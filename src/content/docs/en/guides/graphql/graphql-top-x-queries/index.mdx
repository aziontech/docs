...
To query Top X queries through the [GraphQL API](/en/documentation/products/graphql-api-overview), follow the steps described on [How to query GraphQL requests on Postman](https://www.azion.com/en/documentation/products/guides/query-graphql-postman/) using the `https://api.azionapi.net/events/graphql` URL.
