...
permalink_pt-br: /documentacao/produtos/real-time-metrics/data-transferred-dash/
menu_namespace: 
og_image: 
---
...
To create a dashboard on Grafana with the **Data Transferred** metrics from [Real-Time Metrics](https://www.azion.com/en/documentation/products/real-time-metrics/), use the following JSON with the `https://api.azionapi.net/metrics/graphql` URL:
