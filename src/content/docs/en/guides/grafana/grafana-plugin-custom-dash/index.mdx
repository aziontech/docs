...
## 2. Installing the plugin on Grafana
...
## 3. Customizing a dashboard on Grafana
...
- [How to use the pre-built dashboard with the Azion plugin on Grafana](/en/documentation/products/guides/azion-plugin-grafana-pre-built-dash/)
- [Real-Time Metrics](/en/documentation/products/real-time-metrics/)
- [GraphQL API](/en/documentation/products/graphql-api-overview)
