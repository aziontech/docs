...
## 1. Add a Trusted CA to your Digital Certificates library
...
## 3. Adding specific rules for using Permissive mTLS
...
## 4. Specifying mTLS variables in the application header
