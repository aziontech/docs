...
- [How to build an edge application from scratch](/en/documentation/products/getting-started/#build-edge-app)
- [How to manage an edge application](/en/documentation/products/getting-started/#settings-app)
