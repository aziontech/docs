...
In this document, we will indicate the features used in the deprecated versions, showing how to bring them to the latest version. To learn more about new features, and how to use them, see the [product page](https://www.azion.com/pt-br/produtos/edge-firewall/) and [documentation](https://www.azion.com/en/documentation/products/edge-firewall/).
...
[![banner](/static/images/docs/update-edge-firewall/banner.jpg)](/static/images/docs/update-edge-firewall/banner.jpg)
...
[![referer-blocking](/static/images/docs/update-edge-firewall/referer-blocking.jpg)](/static/images/docs/update-edge-firewall/referer-blocking.jpg)
...
[![geo-blocking](/static/images/docs/update-edge-firewall/geo-blocking.jpg)](/static/images/docs/update-edge-firewall/geo-blocking.jpg)
...
[![secure-token](/static/images/docs/update-edge-firewall/secure-token.jpg)](/static/images/docs/update-edge-firewall/secure-token.jpg)
...
[![ip-blocking](/static/images/docs/update-edge-firewall/ip-blocking.jpg)](/static/images/docs/update-edge-firewall/ip-blocking.jpg)
...
[![rate-limiting](/static/images/docs/update-edge-firewall/rate-limiting.jpg)](/static/images/docs/update-edge-firewall/rate-limiting.jpg)
