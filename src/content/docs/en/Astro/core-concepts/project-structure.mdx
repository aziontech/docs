...
- [Styles (CSS, Sass)](/en/astro/guides/styling/)
- [Markdown](/en/astro/guides/markdown-content/)
...
The [`src/assets`](/en/astro/guides/assets/) directory is the recommended folder to use for storing assets (e.g. images) that are processed by Astro. This is not required, and this is not a special reserved folder.
...
The `src/content/` directory is reserved to store [content collections](/en/astro/guides/content-collections/) and an optional collections configuration file. No other files are allowed inside this folder.

### `src/layouts`

[Layouts](/en/core-concepts/layouts/) are a special kind of component that wrap some content in a larger page layout. These are most often used by [Astro pages](/en/core-concepts/astro-pages/) and [Markdown or MDX pages](/en/astro/guides/markdown-content/) to define the layout of the page.
...
See the [Configuring Astro Guide](/en/astro/guides/configuring-astro/) for details on setting configurations.
...
See the [TypeScript Guide](/en/astro/guides/typescript/) for details on setting configurations.
