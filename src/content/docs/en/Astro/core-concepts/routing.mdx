...
You can define rules to [redirect users to permanently-moved pages](#configured-redirects-experimental) in your Astro config. Or, [redirect users dynamically](#dynamic-redirects) as they use your site.

### Configured Redirects (experimental)
<Since v="2.6.0" />

After enabling the experimental flag `redirects: true`, you can specify a mapping of permanent redirects in your Astro config. For most redirects, this is a mapping of an old route to the new route:
