...
Astro ships with [optional integrations](/en/astro/guides/integrations-guide/) for React, Preact, Svelte, Vue, SolidJS, AlpineJS and Lit. One or several of these Astro integrations can be installed and configured in your project.

⚙️ View the [Integrations Guide](/en/astro/guides/integrations-guide/) for more details on installing and configuring Astro integrations.
...
📚 Learn more about [client-side `<script>` tags in Astro components](/en/astro/guides/client-side-scripts/)
