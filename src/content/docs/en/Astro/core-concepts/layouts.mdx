...
- a [**`<slot />`**](/en/core-concepts/astro-components/#slots) to specify where individual page content should be injected.
 ...
 But, there is nothing special about a layout component! They can [accept props](/en/core-concepts/astro-components/#component-props) and [import and use other components](/en/core-concepts/astro-components/#component-structure) like any other Astro component. They can include [UI frameworks components](/en/core-concepts/framework-components/) and [client-side scripts](/en/astro/guides/client-side-scripts/). They do not even have to provide a full page shell, and can instead be used as partial UI templates.
...
Page layouts are especially useful for [Markdown and MDX pages](/en/astro/guides/markdown-content/#markdown-and-mdx-pages) which otherwise would not have any page formatting. 
...
You can set a layout’s [`Props` type](/en/astro/guides/typescript/#component-props) with the `MarkdownLayoutProps` or `MDXLayoutProps` helper:
...
Astro.props = {
  ...
  url: "/en/astro/guides/markdown-content/",
  frontmatter: {
...
:::note
A Markdown/MDX layout will have access to all its file's [exported properties](/en/astro/guides/markdown-content/#exported-properties) from `Astro.props` **with some key differences:**
...
📚 Learn more about Astro’s Markdown and MDX support in our [Markdown/MDX guide](/en/astro/guides/markdown-content/).
