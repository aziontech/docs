...
First, check to see that you have **imported the component** in your [`.astro` component script](/en/core-concepts/astro-components/#the-component-script) or [`.mdx` file](/en/astro/guides/markdown-content/#using-components-in-mdx).
...
```
See [Astro's integration guide](/en/astro/guides/integrations-guide/) for instructions on adding framework renderers, CSS tools and other packages to Astro.
