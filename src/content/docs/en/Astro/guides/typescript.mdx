...
Astro supports [import aliases](/en/astro/guides/aliases/) that you define in your `tsconfig.json` & `jsconfig.json` `paths` configuration. [Read our guide](/en/astro/guides/aliases/) to learn more.
...
📚 Read more about [`.ts` file imports](/en/astro/guides/imports/#typescript) in Astro.
