...
See our separate guide for [deploying to Firebase hosting](/en/astro/guides/deploy/google-firebase/).
...
- An Astro project with [server-side rendering (SSR)](/en/astro/guides/server-side-rendering/#enabling-ssr-in-your-project) enabled.
...
:::tip
Read more about [environment variables](/en/astro/guides/environment-variables/) and `.env` files in Astro.
:::
