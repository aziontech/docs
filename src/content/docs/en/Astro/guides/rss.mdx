...
You can generate this array from a content collection schema or by using [glob imports](/en/astro/guides/imports/#astroglob) for blog posts located within `src/pages/`.


### Using content collections

To create an RSS feed of pages managed in [content collections](/en/astro/guides/content-collections/), use the `getCollection()` function to retrieve the list of your items.
