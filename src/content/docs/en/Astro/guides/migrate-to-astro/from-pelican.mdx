...
- Pelican and Astro are both static-site generators, ideally suited to [content-focused websites](/en/concepts/why-astro/#content-focused) like blogs.

- Pelican and Astro both have built-in support for [writing in Markdown](/en/astro/guides/content/#markdown-authoring), including frontmatter YAML properties for page metadata. However, Astro has very few reserved frontmatter properties compared to Pelican. Even though many of your existing Pelican frontmatter properties will not be "special" in Astro, you can continue to use your existing Markdown files and frontmatter values.
...
- Pelican supports writing content in Markdown and reStructured Text (`.rst`). Astro supports [creating pages from Markdown and MDX](/en/astro/guides/markdown-content/) files, but does not support reStructured Text.
