...
- Astro and Eleventy both allow you to use a [headless CMS, APIs or Markdown files for data](/en/astro/guides/data-fetching/). You can continue to use your preferred [content authoring](/en/astro/guides/content/) system, and will be able to keep your existing content.

- Both Astro and Eleventy build [multi-page apps](/en/concepts/mpa-vs-spa/).
...
- In Eleventy, bundling CSS, JavaScript, and other assets needs to be configured manually. [Astro handles this for you out-of-the-box](/en/concepts/why-astro/#fully-featured-but-flexible).
