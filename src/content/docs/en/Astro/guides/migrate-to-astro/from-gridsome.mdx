...
- Astro has [an official integration for using Vue components](/en/astro/guides/integrations-guide/vue/) and supports [installing NPM packages](/en/astro/guides/imports/#npm-packages), including several for Vue. You will be able to write Vue UI components, and may be able to keep some or all of your existing Gridsome Vue components and dependencies.

- Astro and Gridsome both allow you to use a [headless CMS, APIs or Markdown files for data](/en/astro/guides/data-fetching/). You can continue to use your preferred [content authoring](/en/astro/guides/content/) system, and will be able to keep your existing content.
...
Bring your existing Markdown (or MDX, with our optional integration) files as content to [create Markdown or MDX pages](/en/astro/guides/markdown-content/).
...
Since Astro queries and imports your local files differently than Gridsome, you may want to read about [how to load files using `Astro.glob()`](/en/astro/guides/imports/#astroglob) to understand how to work with your local files.
