...
- Astro has [an official integration for using Svelte components](/en/astro/guides/integrations-guide/svelte/) and supports [installing NPM packages](/en/astro/guides/imports/#npm-packages), including several for Svelte. You will be able to write Svelte UI components, and may be able to keep some or all of your existing components and dependencies.

- Astro and SvelteKit both allow you to use a [headless CMS, APIs or Markdown files for data](/en/astro/guides/data-fetching/). You can continue to use your preferred [content authoring](/en/astro/guides/content/) system, and will be able to keep your existing content.
