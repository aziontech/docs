...
- Both Astro and Docusaurus support [MDX pages](/en/astro/guides/markdown-content/). You should be able to use your existing `.mdx` files to Astro.
...
- Astro has an [official integration for using React components](/en/astro/guides/integrations-guide/react/). Note that in Astro, React files **must** have a `.jsx` or `.tsx` extension.

- Astro supports [installing NPM packages](/en/astro/guides/imports/#npm-packages), including several for React. You may be able to keep some or all of your existing React components and dependencies.
...
- Docusaurus sites use MDX pages for content. Astro's docs theme uses Markdown (`.md`) files by default and does not require you to use MDX. You can optionally [install Astro's MDX integration](/en/astro/guides/integrations-guide/mdx/) and use `.mdx` files in addition to standard Markdown files.
