...
:::tip
You can [use WordPress as a headless CMS for your Astro project](/en/astro/guides/cms/wordpress/). Follow our guide to use your existing WordPress content in a new Astro project.
:::
...
You can continue to [use your existing WordPress blog as your CMS for Astro](/en/astro/guides/cms/wordpress/), which means you will keep using your WordPress dashboard for writing your posts. Your content will be managed at WordPress, but all other aspects of your Astro site will be built in your code editing environment, and you will [deploy your Astro site](/en/astro/guides/deploy/) separately from your WordPress site. (Be sure to update your domain at your host to keep the same website URL!)
