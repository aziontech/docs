...
📚 Read more about using [static assets](/en/astro/guides/imports/) located in `public/` or `src/`.
...
:::note
This is a [Vite-specific setting](https://vitejs.dev/config/ssr-options.html#ssr-noexternal) that does _not_ relate to (or require) [Astro SSR](/en/astro/guides/server-side-rendering/).
:::
...
📚 See the [Integrations Guide](/en/astro/guides/integrations-guide/) for instructions on installing, importing and configuring these integrations.
...
You can apply global styles to your Markdown content by adding [`<style>` tags](#global-styles) and [imported stylesheets](#external-styles) to the layout that wraps your page content. You can also add [CSS integrations](#css-integrations) including [Tailwind](/en/astro/guides/integrations-guide/tailwind/).
