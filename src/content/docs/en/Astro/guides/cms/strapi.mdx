...
```
:::tip
Make sure to choose the right rendering for your content. For markdown check out our [markdown guide](/en/astro/guides/markdown-content/). If you are rendering html refer to [this guide](/en/reference/directives-reference/#sethtml) for safety.
:::

#### Server-side rendering

If you've [opted into SSR mode](/en/astro/guides/server-side-rendering/#enabling-ssr-in-your-project) with `output: server` or `output: hybrid`, [generate your dynamic routes](/en/core-concepts/routing/#server-ssr-mode) using the following code:
...
To deploy your website, visit our [deployment guides](/en/astro/guides/deploy/) and follow the instructions for your preferred hosting provider.
