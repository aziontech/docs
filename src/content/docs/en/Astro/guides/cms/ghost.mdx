...
```
:::tip
Read more about [using environment variables](/en/astro/guides/environment-variables/) and `.env` files in Astro.
:::
...
1. A Ghost blog 
2. An Astro project integrated with the [Ghost content API](https://www.npmjs.com/package/@tryghost/content-api) - See [integrating with Astro](/en/astro/guides/cms/ghost/#integrating-with-astro) for more details on how to set up an Astro project with Ghost.
...
```
:::note
`<Fragment />` is a built-in Astro component which allows you to avoid an unnecessary wrapper element. This can be especially useful when fetching HTML from a CMS (e.g. Ghost or [WordPress](/en/astro/guides/cms/wordpress/)).
:::

### Publishing your site
To deploy your site visit our [deployment guide](/en/astro/guides/deploy/) and follow the instructions for your preferred hosting provider.
