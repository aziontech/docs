...
Astro no longer supports components or JSX expressions in Markdown pages by default. For long-term support you should migrate to the [`@astrojs/mdx`](/en/astro/guides/integrations-guide/mdx/) integration.
...
1. Install the [`@astrojs/mdx`](/en/astro/guides/integrations-guide/mdx/) integration.
...
RSS feeds should now be generated using the `@astrojs/rss` package, as described in our [RSS guide](/en/astro/guides/rss/).
...
See how to use [client-side scripts](/en/astro/guides/client-side-scripts/) in Astro for full details.
...
The `renderers` config has been replaced by a new, official integration system! This unlocks some really exciting new features for Astro. You can read our [Using Integrations](/en/astro/guides/integrations-guide/) guide for more details on how to use this new system.
...
Read our [step-by-step walkthrough](/en/astro/guides/integrations-guide/) to learn how to add a new Astro integration for the framework(s) that you currently use.
...
For a deeper walkthrough, read our [step-by-step guide](/en/astro/guides/integrations-guide/) to learn how to replace existing renderers with a new Astro framework integration.

```shell add={3-4}
# Install your new integrations and frameworks:
# (Read the full walkthrough: https://docs.astro.build/en/astro/guides/integrations-guide)
...
If you see a `"Cannot find package 'react'"` (or similar) warning when you start up Astro, that means that you need to install that package into your project. See our [note on peer dependencies](/en/astro/guides/troubleshooting/#cannot-find-package-x) in the troubleshooting guide for more information.
...
Check our new [syntax highlighting docs](/en/astro/guides/markdown-content/#syntax-highlighting) for full details. **If you prefer to keep Prism as your syntax highlighter,** [set the `syntaxHighlight` option to `'prism'`](/en/astro/guides/markdown-content/#prism-configuration) in your project's markdown configuration.
