...
With the [@astrojs/mdx integration](/en/astro/guides/integrations-guide/mdx/) installed, Astro also supports [MDX](https://mdxjs.com/) (`.mdx`) files which bring added features like support for JavaScript expressions and components in your Markdown content. 
...
You can manage your Markdown and MDX files in Astro in a special `src/content/` folder. [Content collections](/en/astro/guides/content-collections/) help you organize your content, validate your frontmatter, and provide automatic TypeScript type-safety while working with your content. 
...
See more about using [content collections in Astro](/en/astro/guides/content-collections/).
...
Astro provides Markdown and MDX pages with a special frontmatter `layout` property that can specify a relative path (or [alias](/en/astro/guides/aliases/)) to an Astro [layout component](/en/core-concepts/layouts/#markdownmdx-layouts).
...
You can also [style your Markdown](/en/astro/guides/styling/#markdown-styling) in your layout component.
...
Adding the Astro [MDX integration](/en/astro/guides/integrations-guide/mdx/) enhances your Markdown authoring with JSX variables, expressions and components. 
...
You can import one specific page with an `import` statement, or multiple pages with [`Astro.glob()`](/en/astro/guides/imports/#astroglob).
...
- **`url`** - If it's a page, the URL of the page (e.g. `/en/astro/guides/markdown-content`).
...
<RecipeLinks slugs={["en/astro/recipes/reading-time"]} />
...
To avoid extending your Markdown config from MDX, set [the `extendMarkdownConfig` option](/en/astro/guides/integrations-guide/mdx/#extendmarkdownconfig) (enabled by default) to `false`:
