...
Learn how to deploy your Astro site in our [Deno Deploy deployment guide](/en/astro/guides/deploy/deno/).
...
After [performing a build](/en/astro/guides/deploy/#building-your-site-locally) there will be a `dist/server/entry.mjs` module. You can start a server by importing this module in your Deno app:
