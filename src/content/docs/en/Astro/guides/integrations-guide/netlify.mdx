...
Learn how to deploy your Astro site in our [Netlify deployment guide](/en/astro/guides/deploy/netlify/).

## Why Astro Netlify

If you're using Astro as a static site builder—its behavior out of the box—you don't need an adapter.

If you wish to [use server-side rendering (SSR)](/en/astro/guides/server-side-rendering/), Astro requires an adapter that matches your deployment runtime.
...
[Read the full deployment guide here.](/en/astro/guides/deploy/netlify/)

After [performing a build](/en/astro/guides/deploy/#building-your-site-locally) the `netlify/` folder will contain [Netlify Functions](https://docs.netlify.com/functions/overview/) in the `netlify/functions/` folder.
