...
- [CSS stylesheets or libraries](/en/astro/guides/styling/) including Tailwind.

- [Markdown/MDX files](/en/astro/guides/markdown-content/), configured using your existing [remark and rehype plugins](/en/astro/guides/markdown-content/#configuring-markdown-and-mdx).

- [Content from a CMS](/en/astro/guides/cms/) through an integration or API.
...
Astro allows you to choose between a statically-generated site and [server-side rendering (SSR)](/en/astro/guides/server-side-rendering/), making it a great replacement for SSGs or for sites that need to fetch some page data on the fly.
...
- Providing client-side interactivity with [client-side `<script>` tags](/en/astro/guides/client-side-scripts/) or [UI framework components](/en/core-concepts/framework-components/).
