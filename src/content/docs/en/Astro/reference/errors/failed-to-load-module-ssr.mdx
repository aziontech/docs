...
This message can also appear when a type is imported without specifying that it is a [type import](/en/astro/guides/typescript/#type-imports).

**See Also:**
-  [Type Imports](/en/astro/guides/typescript/#type-imports)
