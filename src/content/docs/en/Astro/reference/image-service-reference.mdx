...
Astro [assets](/en/astro/guides/assets/) were designed to make it easy for any image optimization service to build a service on top of Astro.

:::caution
The Image Services API is an experimental Astro feature introduced in v2.1. This API is subject to change before it is marked as stable.
:::
