...
This reference page is for anyone writing their own integration. To learn how to use an integration in your project, check out our [Using Integrations](/en/astro/guides/integrations-guide/) guide instead.

## Examples

The official Astro integrations can act as reference for you as you go to build your own integrations.

- **Renderers:** [`lit`](/en/astro/guides/integrations-guide/lit/), [`svelte`](/en/astro/guides/integrations-guide/svelte/), [`react`](/en/astro/guides/integrations-guide/react/), [`preact`](/en/astro/guides/integrations-guide/preact/), [`vue`](/en/astro/guides/integrations-guide/vue/), [`solid`](/en/astro/guides/integrations-guide/solid-js/)
- **Libraries:** [`tailwind`](/en/astro/guides/integrations-guide/tailwind/), [`partytown`](/en/astro/guides/integrations-guide/partytown/)
- **Features:** [`sitemap`](/en/astro/guides/integrations-guide/sitemap/)
...
A mutable instance of the Vite server used in "dev" mode. For instance, this is [used by our Partytown integration](/en/astro/guides/integrations-guide/partytown/) to inject the Partytown server as middleware:
...
**Why:** To get access to the SSR manifest, this is useful when creating custom SSR builds in plugins or integrations.
