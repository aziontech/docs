...
📚 See the [Styling & CSS](/en/astro/guides/styling/#global-styles) page for more details about how global styles work.
...
📚 See how [client-side scripts](/en/astro/guides/client-side-scripts/) work in Astro components.
...
For scripts, try [passing variables to scripts manually](/en/astro/guides/client-side-scripts/#pass-frontmatter-variables-to-scripts) instead.
:::
