...
You should only provide this option if you run the `astro` CLI commands in a directory other than the project root directory. Usually, this option is provided via the CLI instead of the [Astro config file](/en/astro/guides/configuring-astro/#supported-config-file-types), since Astro needs to know your project root before it can locate your config file.
...
Deploy to your favorite server, serverless, or edge host with build adapters. Import one of our first-party adapters for [Netlify](/en/astro/guides/deploy/netlify/#adapter-for-ssredge), [Vercel](/en/astro/guides/deploy/vercel/#adapter-for-ssr), and more to engage Astro SSR.

[See our Server-side Rendering guide](/en/astro/guides/server-side-rendering/) for more on SSR, and [our deployment guides](/en/astro/guides/deploy/) for a complete list of hosts.
...
Shiki configuration options. See [the Markdown configuration docs](/en/astro/guides/markdown-content/#shiki-configuration) for usage.
...
Read our [Integrations Guide](/en/astro/guides/integrations-guide/) for help getting started with Astro Integrations.
