...
4. Display Reading Time
  ...
  Use the `minutesRead` frontmatter property from `Astro.props` to add the reading time to a [Markdown layout](/en/astro/guides/markdown-content/#markdown-and-mdx-pages). The example layout below displays the reading time above the page content:
