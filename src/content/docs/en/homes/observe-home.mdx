  ...
  - title: Products
    cards:
      - icon: /assets/docs/images/uploads/data-stream.svg
        ...
        link: /en/documentation/observe/data-stream/
      - icon: /assets/docs/images/uploads/real-time-metrics.svg
        ...
        link: /en/documentation/platform/real-time-metrics/
