...
<HeroHome
  ...
  buttons={[
    ...
    { label: "Platform overview", link: "/en/documentation/fundamentals/", severity: "secondary" }
  ]}
/>
...
Here are a few of our most popular templates to get you started. For more information, you can visit our documentation page on [using templates](/en/documentation/marketplace/).
...
To view the complete list of availiable Astro templates, [click here](/en/documentation/devtools/runtime/frameworks/astro/#available-templates).

<DocButton href="/en/documentation/guides/application-development/frameworks/astro-boilerplate/" label="Get Started" kind="secondary" size="medium" />
...
To view the complete list of availiable Gatsby templates, [click here](/en/documentation/devtools/runtime/frameworks/gatsby/#available-templates).

<DocButton href="/en/documentation/marketplace/" label="Get Started" kind="secondary" size="medium" />
...
To view the complete list of availiable React templates, [click here](/en/documentation/devtools/runtime/frameworks/react/#available-templates).

<DocButton href="/en/documentation/guides/application-development/frameworks/react-boilerplate/" label="Get Started" kind="secondary" size="medium" />
...
To view the complete list of availiable Next.js templates, [click here](/en/documentation/devtools/runtime/frameworks/nextjs/#available-templates).

<DocButton href="/en/documentation/guides/application-development/frameworks/nextjs-static-boilerplate/" label="Get Started" kind="secondary" size="medium" />
...
To view the complete list of availiable Angular templates, [click here](/en/documentation/devtools/runtime/frameworks/angular/#available-templates).

<DocButton href="/en/documentation/guides/application-development/frameworks/angular-boilerplate/" label="Get Started" kind="secondary" size="medium" />
### More frameworks 

We are continously expanding our framework support. Click below to see the full list.

<DocButton href="/en/documentation/devtools/runtime/frameworks/frameworks-compatibility/" label="View details" kind="secondary" size="medium" />
...
You can use the Azion CLI to deploy a project compatible with our [availiable frameworks](/en/documentation/devtools/runtime/frameworks/frameworks-compatibility/).

:::tip
Visit our [CLI guide](/en/documentation/devtools/cli/#installing-azion-cli) for detailed installation instructions.
:::
...
<DocButton href="/en/documentation/guides/platform/account-and-billing/how-to-access-azion-console/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="https://api.azion.com/?_gl=1*kkolsv*_gcl_au*OTAxOTIzMjQ2LjE3NDc3NDYzNTkuMTk3ODMzMTk3LjE3NDg0NTUzNTYuMTc0ODQ1NjI4OQ.." label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/devtools/cli/" label="View details" kind="secondary" size="medium" />

### Azion Lib

Azion Lib are JavaScript/TypeScript tools designed to work inside the [Azion Runtime](https://www.azion.com/en/documentation/devtools/runtime/), leveraging internal features for enhanced performance. They also function outside the runtime, accessing Azion services such as Purge, Object Storage, and Image Processor via REST APIs. The libraries support debug mode and environment variable configuration.

<DocButton href="/en/documentation/devtools/azion-lib/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/devtools/console-kit/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/devtools/graphql/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/devtools/sdk/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/devtools/terraform/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/guides/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/fundamentals/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/" label="View details" kind="secondary" size="medium" />

### <i class='ai ai-secure-pillar'></i> Secure

Fully protect your applications.

<DocButton href="/en/documentation/platform/firewall/" label="View details" kind="secondary" size="medium" />

### <i class='ai ai-deploy-pillar'></i> Deploy

Manage edge resources efficiently.

<DocButton href="/en/documentation/build/orchestrator/" label="View details" kind="secondary" size="medium" />

### <i class='ai ai-observe-pillar'></i> Observe

Monitor and gain analytics in real-time.

<DocButton href="/en/documentation/platform/real-time-metrics/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/changelog/" label="View details" kind="secondary" size="medium" />
