...
<DocButton href="/en/documentation/products/templates/astro-boilerplate/" label="Get Started" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/products/templates/gatsby-blog/" label="Get Started" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/products/templates/react-boilerplate/" label="Get Started" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/products/templates/nextjs-static-boilerplate/" label="Get Started" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/products/templates/angular-boilerplate/" label="Get Started" kind="secondary" size="medium" />
### More frameworks 

We are continously expanding our framework support. Click below to see the full list.

<DocButton href="/en/documentation/products/devtools/azion-edge-runtime/frameworks-compatibility/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/products/guides/how-to-access-azion-console/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/products/azion-cli/overview/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/products/azion-lib/overview/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/devtools/graphql-api/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/devtools/sdk/go/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/products/terraform-provider/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/architectures/by-solution/application-development/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/architectures/by-solution/application-and-infrastructure-automation/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/architectures/by-solution/application-and-network-security/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/architectures/by-solution/artificial-intelligence/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/architectures/by-solution/service-performance-and-reliability/" label="View details" kind="secondary" size="medium" />

### Find more

View all architectures for use cases.

<DocButton href="/en/documentation/architectures/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/products/azion-platform-overview/" label="View details" kind="secondary" size="medium" />

### <i class='ai ai-build-pillar'></i> Build

Create with powerful tools and frameworks.

<DocButton href="/en/documentation/products/guides/build/overview/" label="View details" kind="secondary" size="medium" />

### <i class='ai ai-store-pillar'></i> Store

Manage and proccess data at the edge.

<DocButton href="/en/documentation/products/store/overview/" label="View details" kind="secondary" size="medium" />

### <i class='ai ai-secure-pillar'></i> Secure

Fully protect your applications.

<DocButton href="/en/documentation/products/secure/overview/" label="View details" kind="secondary" size="medium" />

### <i class='ai ai-deploy-pillar'></i> Deploy

Manage edge resources efficiently.

<DocButton href="/en/documentation/products/deploy/overview/" label="View details" kind="secondary" size="medium" />

### <i class='ai ai-observe-pillar'></i> Observe

Monitor and gain analytics in real-time.

<DocButton href="/en/documentation/products/observe/overview/" label="View details" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/products/release-notes/" label="View details" kind="secondary" size="medium" />
