...
<Button href="/en/documentation/products/templates/astro-boilerplate/" label="Get Started" kind="secondary" size="medium" class="not-prose no-underline" />
...
<Button href="/en/documentation/products/templates/gatsby-blog/" label="Get Started" kind="secondary" size="medium" class="not-prose no-underline" />
...
<Button href="/en/documentation/products/templates/react-boilerplate/" label="Get Started" kind="secondary" size="medium" class="not-prose no-underline" />
...
<Button href="/en/documentation/products/templates/nextjs-static-boilerplate/" label="Get Started" kind="secondary" size="medium" class="not-prose no-underline" />
...
<Button href="/en/documentation/products/templates/angular-boilerplate/" label="Get Started" kind="secondary" size="medium" class="not-prose no-underline" />
### More frameworks 

We are continously expanding our framework support. Click below to see the full list.

<Button href="/en/documentation/products/devtools/azion-edge-runtime/frameworks-compatibility/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />
...
<Button href="/en/documentation/products/guides/how-to-access-azion-console/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />
...
<Button href="https://api.azion.com/?_gl=1*kkolsv*_gcl_au*OTAxOTIzMjQ2LjE3NDc3NDYzNTkuMTk3ODMzMTk3LjE3NDg0NTUzNTYuMTc0ODQ1NjI4OQ.." label="View details" kind="secondary" size="medium" class="not-prose no-underline" />
...
<Button href="/en/documentation/products/azion-cli/overview/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />
...
<Button href="/en/documentation/products/azion-lib/overview/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />
...
<Button href="/en/documentation/devtools/console-kit/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />
...
<Button href="/en/documentation/devtools/graphql-api/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />
...
<Button href="/en/documentation/devtools/sdk/go/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />
...
<Button href="/en/documentation/products/terraform-provider/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />
...
<Button href="/en/documentation/architectures/by-solution/application-development/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />
...
<Button href="/en/documentation/architectures/by-solution/application-and-infrastructure-automation/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />
...
<Button href="/en/documentation/architectures/by-solution/application-and-network-security/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />
...
<Button href="/en/documentation/architectures/by-solution/artificial-intelligence/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />
...
<Button href="/en/documentation/architectures/by-solution/service-performance-and-reliability/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />

### Find more

View all architectures for use cases.

<Button href="/en/documentation/architectures/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />
...
<Button href="/en/documentation/products/azion-platform-overview/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />

### <i class='ai ai-build-pillar'></i> Build

Create with powerful tools and frameworks.

<Button href="/en/documentation/products/guides/build/overview/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />

### <i class='ai ai-store-pillar'></i> Store

Manage and proccess data at the edge.

<Button href="/en/documentation/products/store/overview/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />

### <i class='ai ai-secure-pillar'></i> Secure

Fully protect your applications.

<Button href="/en/documentation/products/secure/overview/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />

### <i class='ai ai-deploy-pillar'></i> Deploy

Manage edge resources efficiently.

<Button href="/en/documentation/products/deploy/overview/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />

### <i class='ai ai-observe-pillar'></i> Observe

Monitor and gain analytics in real-time.

<Button href="/en/documentation/products/observe/overview/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />
...
<Button href="/en/documentation/products/release-notes/" label="View details" kind="secondary" size="medium" class="not-prose no-underline" />

### <i class='pi pi-discord'></i> Join the Community

Share your experiences with the Azion community on Discord.

<Button href="https://discord.com/invite/Yp9N7RMVZy" label="Join" kind="secondary" size="medium" class="not-prose no-underline" />
