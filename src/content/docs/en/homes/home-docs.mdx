...
Console is Azion's configuration interface where you can access all the available products and their settings. It enables you to complete all tasks in Azion's platform, such as creating Applications, configuring Functions, managing Edge Firewall rules, setting up Edge Caching, and monitoring real-time metrics and events.
