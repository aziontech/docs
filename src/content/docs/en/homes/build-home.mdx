...
description: >-
  Build and run your application with Edge Cache, Application Acceleration and
  ...
  - title: Modules
    cards:
      - icon: /assets/docs/images/uploads/app-aceleration.svg
        ...
        link: /en/documentation/products/build/edge-application/application-acceleration/
