...
description: >-
  Build and run your application with Cache, Application Accelerator, and
    ...
    cards:
      - icon: /assets/docs/images/uploads/edge-application.svg
        ...
        description: >-
          ...
          Azion Web Platform.
        link: /en/documentation/platform/applications/
  - title: Modules
    cards:
      ...
      - icon: /assets/docs/images/uploads/edge-functions.svg
        ...
        link: /en/documentation/build/functions/
      - icon: /assets/docs/images/uploads/image-processor.svg
        ...
        description: >-
          ...
          the user experience.
        link: /en/documentation/build/image-processor/
      - icon: /assets/docs/images/uploads/load-balancer.svg
        ...
        description: >-
          ...
          APIs.
        link: /en/documentation/platform/load-balancer/
  - title: Resources
    cards:
