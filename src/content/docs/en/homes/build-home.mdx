...
description: >-
  Build and run your application with Edge Caching, Application Accelerator and
  ...
  - title: Modules
    cards:
      - icon: /assets/docs/images/uploads/app-aceleration.svg
        ...
        link: /en/documentation/products/build/edge-application/application-accelerator/
      - icon: /assets/docs/images/uploads/edge-caching.svg
        title: Edge Caching
        description: >-
          Turbocharge delivery by caching content at the edge of the network,
          closer to your users.
        link: /en/documentation/products/build/edge-application/edge-caching/
      ...
      - icon: /assets/docs/images/uploads/load-balancer.svg
        ...
        description: >-
          ...
          APIs.
        link: /en/documentation/products/build/edge-application/load-balancer/
  - title: Resources
    cards:
