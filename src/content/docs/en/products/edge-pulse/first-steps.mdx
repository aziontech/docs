...
# Edge Pulse first steps

Before using **Edge Pulse**, make sure you have a [Real-Time Manager (RTM)](https://manager.azion.com/) account. You can find more information on creating one on the [documentation page]({% tl documentation_creating_account %}).
