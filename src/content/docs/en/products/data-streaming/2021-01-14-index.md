...
To enable sampling, on the **Sampling (%)** field, enter the number for the *percentage* of data you want to receive. This percentage will return the total data related to all your domains.
