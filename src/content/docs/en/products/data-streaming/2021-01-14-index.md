...
See the [Data Streaming first steps](https://www.azion.com/en/documentation/products/data-streaming/first-steps/).
...
> 1. [Selecting data sources](#selecting-data-sources)
> 2. [Using a template](#using-template)
> 3. [Associating domains](#associating-domains)
> 4. [Setting an endpoint](#setting-endpoint)\
...
> 5. [Customizing payload](#customizing-payload)
...
> You can add the $traceback variable when using a custom template for the Edge Applications data source if you have the *Debug rules* option activated in your application. See more on [Debugging rules on Edge Application]({% tl documentation_products_edge_applications_rules_engine %}#debugging-rules).
