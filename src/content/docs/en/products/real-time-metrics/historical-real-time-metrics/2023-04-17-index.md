...
**Real-Time Metrics** has two versions: **Historical** and **New**. If you want to access data of up to 2 years before the date of October 15th, 2022, [contact the Support team](https://www.azion.com/en/documentation/services/support/#3-service-channels) and request access to **Historical Real-Time Metrics**. This version will remain available until the end of 2024, when it'll be discontinued.

You can already use the [New Real-Time Metrics]({% tl documentation_products_real_time_analytics %}) and will be able to continue using it.

**Historical Real-Time Metrics** is an [Observe]({% tl documentation_observe_home %}) product that provides you with real-time access to metrics, through graphs, so you can analyze the events of your applications and products configured on Azion. It also helps you optimize the use of Azion products and how your content is delivered.
...
You can combine your metrics analysis with [Real-Time Events]({% tl documentation_products_real_time_events %}) to further inspect your logs.
...
On average, the difference between the two is smaller than 1%. See [Azion Pricing](https://www.azion.com/en/pricing/) and the [Billing documentation](https://www.azion.com/en/documentation/products/accounts/billing/) for more information.

---

> 1. [Access](#access)
> 2. [Navigating through tabs](#navigate-tabs)
> 3. [Configuring filters](#configure-filters)
> 4. [Graph's information](#graph-information)
> 5. [Monitoring your metrics with graphs](#monitor-metrics-graphs)

---

## 1. Access {#access}

To access Real-Time Metrics, [contact the Support team](https://www.azion.com/en/documentation/services/support/#3-service-channels) and request access to **Historical Real-Time Metrics**. You'll receive the access link to the data source you want to analyze.

See the [Historical Real-Time Metrics first steps](https://www.azion.com/en/documentation/products/historical-real-time-metrics/first-steps/).
...
[Data Streaming]({% tl documentation_products_data_streaming %}), [Edge Functions]({% tl documentation_products_edge_functions %}), [Intelligent DNS]({% tl documentation_products_intelligent_dns %}), and [Image Processor]({% tl documentation_products_image_optimization %}) are paid products. To view their metrics, you must subscribe to the products and activate them in your account.
...
![Historical Real-Time Metrics graph properties location on Real-Time Manager's screen.](/static/images/uploads/doc/graph-historical-real-time-metrics.png)
...
You can find detailed information about each tab and subtabs and about each of the graphs available on the [New Real-Time Metrics documentation]({% tl documentation_products_real_time_analytics %}#monitor-metrics).
