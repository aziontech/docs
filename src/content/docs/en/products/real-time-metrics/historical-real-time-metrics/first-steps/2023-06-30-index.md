...
# Historical Real-Time Metrics first steps

To access Historical Real-Time Metrics:

[Contact the Support team](https://www.azion.com/en/documentation/services/support/#3-service-channels) and request access to **Historical Real-Time Metrics**. You'll receive the access link to the data source you want to analyze.

Before using **Real-Time Metrics**, make sure you have a [Real-Time Manager (RTM)](https://manager.azion.com/) account. You can find more information on creating one on the [documentation page]({% tl documentation_creating_account %}).
