...
![Edge Application IN](https:/www.azion.com/static/images/uploads/doc/edge-applications-in.png)

- **Edge Applications Out**: data transferred from the client origin to the Edges, and from the Edges to the user.

![Edge Application OUT](https:/www.azion.com/static/images/uploads/doc/edge-applications-out.png)

- **Edge Applications**: all data that was transferred in the process. The value of Edge Applications In + Edge Applications Out.

![Edge Applications](https:/www.azion.com/static/images/uploads/doc/edge-applications.png)
...
![Edge Applications IN](https:/www.azion.com/static/images/uploads/doc/l2-enabled-edge-applications-in.png)

- **Edge Applications Out**: data transferred from the L2 Caching to the Edges, and from the Edges to the user.

![Edge Applications OUT](https:/www.azion.com/static/images/uploads/doc/l2-enabled-edge-applications-out.png)

- **Edge Applications**: all data that was transferred in the process. The value of Edge Applications In + Edge Applications Out.

![Edge Applications](https:/www.azion.com/static/images/uploads/doc/l2-enabled-edge-applications.png)
...
![L2 Caching IN](https:/www.azion.com/static/images/uploads/doc/l2-caching-in.png)

- **L2 Caching Out**: data transferred from the client origin, through L2 Caching to the Azion Edges.

![L2 Caching OUT](https:/www.azion.com/static/images/uploads/doc/l2-caching-out.png)

- **L2 Caching**: all data that was transferred in the process. The value of L2 Caching In + L2 Caching Out.

![L2 Caching](https:/www.azion.com/static/images/uploads/doc/l2-caching.png)
