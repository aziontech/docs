...
Before using [Real-Time Events](https://www.azion.com/en/documentation/products/real-time-events/), make sure you have a [Real-Time Manager (RTM)](https://manager.azion.com/) account. You can find more information on creating one on the [documentation page]({% tl documentation_creating_account %}).
