...
> 2. [Available error status codes](#available-error-responses)
...
> Read the guide [How to customize an error response page]({% tl documentation_how_to_configurations_customizing_error_response_page %}) for more instructions about how to use this feature.
...
## 2. Available error status codes
