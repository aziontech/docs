...
6. In the *Match Zone* fields, choose the matching zones you'd like to put into the allowlist. You can create as many *Match Zones* as desired, according to the the type of setup:
