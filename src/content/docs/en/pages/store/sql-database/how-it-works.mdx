...
<ItemList>
  ...
  <DocItem title="SQL Database quickstart" href="/en/documentation/store/sql-database/quickstart/">Creating a first database and running statements against it.</DocItem>
