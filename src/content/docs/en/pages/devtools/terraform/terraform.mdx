...
If you're upgrading from Terraform Provider v1.x (API v3), see the [Terraform Provider Migration Guide](/en/documentation/products/terraform-provider/migration-v3-to-v4/) for detailed instructions on migrating your configurations to v2.0.
