...
permalink: /documentation/devtools/terraform/terraform-migration-v3-to-v4/
---
...
- [Terraform Provider v1.x Documentation](/en/documentation/devtools/terraform/terraform-provider-v3/) (Deprecated)
