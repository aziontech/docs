...
permalink: /documentation/devtools/terraform/getting-started/
---
...
- A [Personal Token](/en/documentation/fundamentals/personal-tokens/) with appropriate permissions
...
- [Workloads](/en/documentation/devtools/terraform/workloads/) - Learn about workloads
- [Applications](/en/documentation/devtools/terraform/applications/) - Configure applications
- [Security](/en/documentation/devtools/terraform/security/) - Configure firewall and WAF
...
**Solution**: Verify that the resource exists in API v4. Some v3 resources were removed or renamed. See the [Migration Guide](/en/documentation/devtools/terraform/terraform-migration-v3-to-v4/).
