...
permalink: /documentation/devtools/terraform/connectors/
---
...
See the [Migration Guide](/en/documentation/devtools/terraform/terraform-migration-v3-to-v4/) for more details.
