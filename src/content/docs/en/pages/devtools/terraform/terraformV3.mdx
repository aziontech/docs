...
permalink: /documentation/devtools/terraform/terraform-provider-v3/
---

:::warning
**Version 1.x is deprecated.** This documentation is for Terraform Provider v1.x (API v3), which no longer receives updates. For new projects or to access the latest features, use [Terraform Provider v2.0](/en/documentation/devtools/terraform/) with API v4.

See the [Migration Guide](/en/documentation/devtools/terraform/terraform-migration-v3-to-v4/) for upgrading from v1.x to v2.0.
:::
...
With the provider configured, it's recommended to configure a [personal token](/en/documentation/fundamentals/personal-tokens/):
...
To migrate your Terraform configurations to v2.0 (API v4), see the [Terraform Provider Migration Guide](/en/documentation/devtools/terraform/terraform-migration-v3-to-v4/).
