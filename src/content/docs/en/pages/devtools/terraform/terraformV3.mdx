...
See the [Migration Guide](/en/documentation/products/terraform-provider/migration-v3-to-v4/) for upgrading from v1.x to v2.0.
:::
...
To migrate your Terraform configurations to v2.0 (API v4), see the [Terraform Provider Migration Guide](/en/documentation/products/terraform-provider/migration-v3-to-v4/).
