...
| **Hosting** | Edge Functions | Distributed execution on Azion |
...
The MCP server can be deployed as an Edge Function on Azion:
...
- [Azion MCP Repository](https://github.com/aziontech/azion-copilot-api) - Azion server source code
