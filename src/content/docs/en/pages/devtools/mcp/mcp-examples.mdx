...
<Tabs client:visible>
  ...
  <Fragment slot="tab.response">Assistant Response</Fragment>
...
<Tabs client:visible>
  <Fragment slot="tab.request">Request</Fragment>
  <Fragment slot="tab.query">Query Generated</Fragment>
...
<Tabs client:visible>
  <Fragment slot="tab.request">Request</Fragment>
  <Fragment slot="tab.config">Configuration Generated</Fragment>
...
<Tabs client:visible>
  <Fragment slot="tab.problem">Problem</Fragment>
  <Fragment slot="tab.guidance">Assistant Guidance</Fragment>
