...
<Code client:visible lang="plaintext" code={`You: "I have a static website with HTML, CSS, and JavaScript files. 
...
#### Request
  ...
  <Code client:visible lang="plaintext" code={`You: "Create a GraphQL query to show my application's traffic 
from the last 7 days, grouped by edge location."`} />

#### Response

  <Code client:visible lang="graphql" code={`query TrafficByLocation {
  httpMetrics(
    filter: {
...
#### Request
  ...
  <Code client:visible lang="plaintext" code={`You: "Generate a query to analyze cache hit rates for my images."`} />

##### Response

  <Code client:visible lang="graphql" code={`query CachePerformance {
  httpMetrics(
    filter: {
...
#### Request
  ...
  <Code client:visible lang="plaintext" code={`You: "Create Rules Engine rules to add security headers including 
...
#### Request
  ...
  <Code client:visible lang="plaintext" code={`You: "Configure Rules Engine to cache static assets for 1 year 
...
#### Request
  ...
  <Code client:visible lang="plaintext" code={`You: "My deployment is failing with error 503. How can I debug this?"`} />

#### Response

  1. **Check deployment logs**:
     <Code client:visible lang="bash" code={`azion logs --type edge --tail`} />
  ...
  3. **Test origin connectivity**:
     <Code client:visible lang="bash" code={`curl -I https://your-origin.com`} />
...
<Code client:visible lang="plaintext" code={`You: "Deploy my Next.js app with Incremental Static Regeneration"`} />
...
<Code client:visible lang="plaintext" code={`You: "Set up staging and production environments for my app"`} />
...
<Code client:visible lang="plaintext" code={`You: "Optimize my site's Core Web Vitals scores"`} />
