...
The Azion **Client** provides a unified interface to interact with all products and services. You can use the client to access and manage all functionalities across Storage, SQL, Purge, and more. 
...
If you are using TypeScript, you can import the appropriate types as in the example below:
