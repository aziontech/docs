---
title: Azion Lib `Cookies` Library
description: >-
  Learn how to use the Azion Lib `Cookies` library to handle cookies in web applications.
permalink: /documentation/products/azion-lib/cookies/
meta_tags: >-
  Azion Lib, edge computing, edge applications, Azion products, cookies
...
| `key`             | `string` (optional) | The name of the cookie to retrieve. If not provided, returns all cookies as an object. |
...
| `secure` | `boolean` | Optional. If true, cookie will only be transmitted over secure HTTPS. |
| `httpOnly` | `boolean` | Optional. If true, cookie is inaccessible to JavaScript's Document.cookie API. |
