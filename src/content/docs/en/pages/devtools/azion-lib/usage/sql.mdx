...
description: >-
  Learn how to use the SQL library to interact with the SQL Database API.
permalink: /documentation/devtools/azion-lib/sql/
meta_tags: >-
...
<DocButton href="/en/documentation/devtools/azion-lib/" label="Go to Azion Libraries Overview" kind="secondary" size="medium" />
...
:::note
In the following examples, the methods are called directly without the creation of a `client`. For more information on how to interact with services and products using a `client`, check the [Azion Lib Client documentation](/en/documentation/devtools/azion-lib/client/).
:::
