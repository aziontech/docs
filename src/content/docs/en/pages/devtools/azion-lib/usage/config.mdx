...
This function configures and validates the options for the Azion Edge Application. It receives a configuration object which contains the setting for domains, cache, rules, and more.

:::note
The code examples in this page show a partial implementation of the configuration object. Check the full list of properties for more details.
:::
