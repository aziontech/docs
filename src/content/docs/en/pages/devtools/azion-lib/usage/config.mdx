...
This function configures and validates the options for Azion Edge Application. It receives a configuration object that contains the settings for workloads, cache, rules, and more.
