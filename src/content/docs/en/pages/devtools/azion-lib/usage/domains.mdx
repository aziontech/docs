---
title: Azion Lib `Domains` Library
description: >-
  Learn how to use the Azion Lib `Domains` library to manage domains in edge applications.
...
Azion **Edge Domains** library provides a simple interface to interact with the Azion Edge Domains API, allowing you to create, list, get, update, and delete domains.
...
|-------------|-------------|
| [`AzionDomainsClient`](#aziondomainsclient) | An object with methods to interact with Domains. |
...
| `options` | `{ debug?: boolean }` | Optional. Object containing debug flag to enable detailed logging. |
...
|-----------|------|-------------|
| `domainId` | `number` | Domain ID. |
| `domain` | `AzionUpdateDomain` | Domain object to update. |
| `options` | `{ debug?: boolean }` | Optional. Object containing debug flag to enable detailed logging. |
...
If you are using **TypeScript**, you`ll need to import and use the appropriate types for the parameters and return values. Here you can see a list of all the types used by the **Domains** library:
...
| `id` | `number` | Optional. Domain ID. |
| `name` | `string` | Domain name. |
| `url` | `string` | Optional. Domain URL. |
| `environment` | `string` | Optional. Domain environment. |
...
| `edgeFirewallId` | `number` | Optional. Edge firewall ID. |
