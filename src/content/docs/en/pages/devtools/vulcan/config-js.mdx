...
<br />
<LinkButton link="https://github.com/aziontech/vulcan//node-pages-12-3-1-fs" label="go to an implementation of the vulcan.config.js file" outlined target="_blank" />
