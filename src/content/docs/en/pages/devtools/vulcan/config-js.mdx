...
AQUI TERÁ UM BUTTON QUE LEVARÁ PARA -> https://github.com/aziontech/vulcan/tree/main/examples/next/node-pages-12-3-1-fs
AQUI TERÁ UM BUTTON QUE LEVARÁ PARA AS WEB APIS COMPATIVEIS
AQUI TERÁ UM BUTTON QUE LEVARÁ PARA OS FRAMEWORKS COMPATIVEIS
AQUI TERÁ UM BUTTON QUE LEVARÁ PARA AS APIS NODE COMPATIVEIS