...
<br />
<LinkButton outlined link="https://github.com/aziontech/vulcan/tree/main/examples/next/node-pages-12-3-1-fs" label="go to an implementation of the vulcan.config.js file" variant="secondary" target="_blank" />
