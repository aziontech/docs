...
To interact with the GraphQL playground, you first need to log in to [RTM](https://console.azion.com/). If you haven't created an account, see the [Creating an account on Azion](/en/documentation/products/accounts/creating-account/) documentation page.

After successfully logging in to **RTM**, go to [https://console.azion.com/metrics/graphql](https://console.azion.com/metrics/graphql) or [https://console.azion.com/events/graphql](https://console.azion.com/events/graphql) and interact with the GraphQL playground.
