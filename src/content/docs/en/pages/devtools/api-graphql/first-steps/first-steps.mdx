...
After successfully logging in to **Azion Console**, go to [https://console.azion.com/metrics/graphql](https://console.azion.com/metrics/graphql) or [https://console.azion.com/events/graphql](https://console.azion.com/events/graphql) and interact with the GraphQL playground.
