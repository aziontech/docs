...
description: Explore detailed fields and descriptions for the Accounting GraphQL API dataset on Azion, including client IDs, product metrics, and financial data.
permalink: /documentation/devtools/graphql-api/features/gql-accounting-fields/
meta_tags: GraphQL API, Azion GraphQL, accounting data, product metrics, client identifiers, dataset fields, API dataset accounting, financial data API, metric accounting, data querying
