...
| classified |  |
| clientId |  |
| countryVariation | Country variation by a fingerprint. |
| customFieldVariation | Fields variations by a fingerprint. |
| errorCount |  |
| errorRate | Error by a fingerprint. |
| fingerprint |  |
...
| host | Host information sent on the request line. Stores: host name from the request line, or host name from the “Host” request header field, or the server name matching a request. Example: `g1sdetynmxe0ao.map.azionedge.net` |
| logTag |  |
| postRequestCount | POST requests by a fingerprint. |
| postRequestFrequencyRate |  |
| remoteAddr | IP address of the origin that generated the request. Example: `127.0.0.1` |
| requestCount |  |
| requestUriVariation | Variation of a unique URI. |
| ts | Timestamp of when the event was created. Example: `2022-10-20T10:10:10` |
| uniqueCountryCount | Count of country variation by a fingerprint. |
| uniqueCustomFieldCount | Count of custom fields by a fingerprint. |
| uniqueRemoteAddressCount |  |
| uniqueRequestUriCount | Unique URIs by a fingerprint. |
...
| Calculated field | Description |
| ---------------- | ----------- |
| countryVariationAvg | Average of country variation by a fingerprint. |
| countryVariationMedian |  |
| customFieldVariationAvg | Average of fields variations by a fingerprint. |
| customFieldVariationMedian |  |
| errorCountAvg |  |
| errorCountMedian |  |
| errorRateAvg | Average of error by a fingerprint. |
| errorRateMedian |  |
| frequencyRateAvg | Average of the rate of frequency a fingerprint accessed an application. |
| frequencyRateMedian |  |
| headRequestCountAvg |  |
| headRequestCountMedian |  |
| headRequestFrequencyRateAvg |  |
| headRequestFrequencyRateMedian |  |
| postRequestCountAvg | Average of POST requests by a fingerprint. |
| postRequestCountMedian |  |
| postRequestFrequencyRateAvg |  |
| postRequestFrequencyRateMedian |  |
| requestCountAvg |  |
| requestCountMedian |  |
| requestUriVariationAvg | Average of variation of a unique URI. |
| requestUriVariationMedian |  |
| uniqueCountryCountAvg | Average of the count of country variation by a fingerprint. |
| uniqueCountryCountMedian |  |
| uniqueCustomFieldCountAvg | Average of the count of custom fields by a fingerprint. |
| uniqueCustomFieldCountMedian |  |
| uniqueRemoteAddressCountAvg |  |
| uniqueRemoteAddressCountMedian |  |
| uniqueRequestUriCountAvg | Average of unique URIs by a fingerprint. |
| uniqueRequestUriCountMedian |  |
