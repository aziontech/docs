...
| initiatorType | Initiator used in the function. Can be `1` (Edge Application) or `2` (Firewall). |
...
| edgeFirewallInvocations | Total amount of invocations of a function from an firewall. Example: `30` |
