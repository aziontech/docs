...
:::note
The Real-Time Metrics interface on Azion Console also has the `workloads` field for some dashboards, which exhibits all the workloads configured in your account.
:::
