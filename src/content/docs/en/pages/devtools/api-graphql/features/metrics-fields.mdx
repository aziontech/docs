...
description: Explore comprehensive insights on Real-Time Metrics and GraphQL API datasets
  with detailed field descriptions for Edge Applications on Azion Console.
permalink: /documentation/devtools/graphql-api/features/gql-real-time-metrics-fields/
meta_tags: GraphQL API, Real-Time Metrics, Azion Console, data analytics, Edge Applications,
  HTTP status, cached data, request methods, Edge Computing, WAF
