...
:::note
The Real-Time Metrics interface on Azion Console also has the `Workload` field for some dashboards, which exhibits all the Workload configured in your account.
:::
