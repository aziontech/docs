...
| Dataset | Description |
| ------- | ----------- |
| botProtectionMetrics | Registered events from the [Bot Protection](/en/documentation/products/marketplace/bot-protection/) integration. The weight for the metrics in this dataset were pondered according to the MITRE ATT&CK and OWASP 2023 frameworks. |
