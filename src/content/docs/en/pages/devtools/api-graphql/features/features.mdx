...
| idnsQueriesMetrics | Query events performed on [Edge DNS](/en/documentation/products/secure/edge-dns/). |
...
| idnsQueriesEvents | Query events performed on [Edge DNS](/en/documentation/products/secure/edge-dns/). |
