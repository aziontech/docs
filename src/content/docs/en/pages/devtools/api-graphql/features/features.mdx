...
description: Explore the capabilities of Azion GraphQL API with features like datasets,
  real-time metrics, events handling, and advanced data querying options like filtering,
  sorting, and pagination.
permalink: /documentation/devtools/graphql-api/features/
meta_tags: GraphQL API, Real-Time Metrics, Real-Time Events, datasets, filtering,
  sorting, pagination, Azion Edge Computing, data querying, web API, API features
