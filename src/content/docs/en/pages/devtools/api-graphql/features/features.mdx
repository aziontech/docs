...
| Dataset | Description |
| ------- | ----------- |
| dataStreamedMetrics | Sent events of data by [Data Streaming](/en/documentation/products/observe/data-streaming/) to the clients' endpoint. |
| edgeFunctionsMetrics | Events executed by [Edge Functions](/en/documentation/products/build/edge-application/edge-functions/). |
| httpMetrics | Request events registered by [Edge Application](/en/documentation/products/build/edge-application/) and [Edge Firewall](/en/documentation/products/edge-firewall/). |
| idnsQueriesMetrics | Query events performed on [Intelligent DNS](/en/documentation/products/secure/intelligent-dns/). |
...
| dataStreamedEvents | Sent events of data by [Data Streaming](/en/documentation/products/observe/data-streaming/) to the clients' endpoint. |
| edgeFunctionsEvents | Events executed by [Edge Functions](/en/documentation/products/build/edge-application/edge-functions/). |
| httpEvents | Request events registered by [Edge Application](/en/documentation/products/build/edge-application/) and [Edge Firewall](/en/documentation/products/edge-firewall/). |
| idnsQueriesEvents | Query events performed on [Intelligent DNS](/en/documentation/products/secure/intelligent-dns/). |
...
<Button href="/en/documentation/devtools/graphql-api/queries/#raw-data" text="go to raw queries reference" variant="secondary"></Button> <br></br>

<Button href="/en/documentation/devtools/graphql-api/queries/#aggregated-data" text="go to aggregated queries reference" variant="secondary"></Button> <br></br>
