...
permalink: /documentation/devtools/graphql/features/
meta_tags: >-
...
| Dataset | Description |
| ------- | ----------- |
| dataStreamedMetrics | Sent events of data by [Data Stream](/en/documentation/observe/data-stream/) to the clients' endpoint |
| edgeFunctionsMetrics | Events executed by [Functions](/en/documentation/build/functions/) |
| httpMetrics | Request events registered by [Applications](/en/documentation/platform/applications/) and [Firewall](/en/documentation/platform/firewall/) |
| httpBreakdownMetrics | Query real-time, detailed, aggregated data on [HTTP request events blocked](/en/documentation/guides/platform/observability/query-httpbreakdownmetrics-data-with-graphql/) |
| edgeDnsQueriesMetrics | Query events performed on [Edge DNS](/en/documentation/secure/edge-dns/) |
| imagesProcessedMetrics | Image processing events by [Image Processor](/en/documentation/build/image-processor/) |
| tieredCacheMetrics | Request events registered by [Tiered Cache](/en/documentation/build/cache/tiered-cache/) |
| connectedUsersMetrics | Query the number of users connected to your applications, using [Live Ingest](/en/documentation/guides/platform/observability/query-connected-users-data-with-graphql/) |
| botManagerMetrics | Query the number of requests evaluated and the actions performed by [Azion Bot Manager](/en/documentation/guides/platform/observability/query-bot-manager-data-with-graphql/) (if subscribed) |
| botManagerBreakdownMetrics | Query the URLs most impacted by bad bots, according to [Azion Bot Manager](/en/documentation/guides/platform/observability/query-bot-manager-breakdown-data-with-graphql/) data (if subscribed) |

<DocButton href="/en/documentation/devtools/graphql/gql-real-time-metrics-fields/" label="Go to Real-Time Metrics GraphQL API fields descriptions" kind="secondary" size="medium" />

### Real-Time Events GraphQL API

| Dataset | Description |
| ------- | ----------- |
| activityHistoryEvents | Events logs from an account on Azion Console regarding activities registered on [Activity History](/en/documentation/fundamentals/activity-history/). It stores data for *2 years* and exhibits data starting from *September 22nd, 2023*. |
| functionConsoleEvents |  Events logs from applications using [Azion Runtime](/en/documentation/devtools/runtime/) returned by the Cells Console. |
| dataStreamedEvents | Sent events of data by [Data Stream](/en/documentation/observe/data-stream/) to the clients' endpoint. |
| functionEvents | Events executed by [Functions](/en/documentation/build/functions/). |
| workloadEvents | Request events registered by [Applications](/en/documentation/platform/applications/) and [Firewall](/en/documentation/platform/firewall/). |
| edgeDnsQueriesEvents | Query events performed on [Edge DNS](/en/documentation/secure/edge-dns/). |
| imagesProcessedEvents |  Image processing events by [Image Processor](/en/documentation/build/image-processor/). |
| tieredCacheEvents | Request events registered by [Tiered Cache](/en/documentation/build/cache/tiered-cache/). |
...
<DocButton href="/en/documentation/devtools/graphql/gql-real-time-events-fields/" label="Go to Real-Time Events GraphQL API fields descriptions" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/devtools/graphql/gql-billing-fields/" label="Go to Billing GraphQL API fields descriptions" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/devtools/graphql/gql-accounting-fields/" label="Go to Accounting GraphQL API fields descriptions" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/devtools/graphql/gql-consumption-fields/" label="Go to Consumption GraphQL API fields descriptions" kind="secondary" size="medium" />

---

:::tip
You can also run an **Introspection Query** to consult metadata on the Metrics and Events datasets. Metadata provide what each dataset of the GraphQL APIs supports and specific information: name, description, and format. Find out more on the [How to query metadata with GraphQL API](/en/documentation/guides/platform/observability/graphql-metadata/) guide.
:::

You can request both the *raw* model, using the **Events** datasets, and the *aggregated* model, using the **Metrics** datasets.

<DocButton href="/en/documentation/devtools/graphql/queries/#raw-data" label="go to raw queries reference" kind="secondary" size="medium" /> <br></br>

<DocButton href="/en/documentation/devtools/graphql/queries/#aggregated-data" label="go to aggregated queries reference" kind="secondary" size="medium" /> <br></br>

<DocButton href="/en/documentation/guides/platform/observability/graphql-aggregated-data/" label="go to How to query aggregated data guide" kind="secondary" size="medium" />
