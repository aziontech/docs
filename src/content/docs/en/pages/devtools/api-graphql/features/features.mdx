...
description: Explore the capabilities of Azion GraphQL API with features like datasets, real-time metrics, events handling, and advanced data querying options like filtering, sorting, and pagination.
permalink: /documentation/devtools/graphql-api/features/
meta_tags: GraphQL API, Real-Time Metrics, Real-Time Events, datasets, filtering, sorting, pagination, Azion Edge Computing, data querying, web API, API features
...
<LinkButton link="/en/documentation/devtools/graphql-api/features/gql-real-time-metrics-fields/" label="see Real-Time Metrics GraphQL API fields descriptions" outlined />
...
<LinkButton link="/en/documentation/devtools/graphql-api/features/gql-real-time-events-fields/" label="see Real-Time Events GraphQL API fields descriptions" outlined />
...
<LinkButton link="/en/documentation/devtools/graphql-api/features/gql-billing-fields/" label="see Billing GraphQL API fields descriptions" outlined />
...
<LinkButton link="/en/documentation/devtools/graphql-api/features/gql-accounting-fields/" label="see Accounting GraphQL API fields descriptions" outlined />
...
<LinkButton link="/en/documentation/devtools/graphql-api/queries/#raw-data" label="go to raw queries reference" outlined /> <br></br>

<LinkButton link="/en/documentation/devtools/graphql-api/queries/#aggregated-data" label="go to aggregated queries reference" outlined /> <br></br>

<LinkButton link="/en/documentation/products/guides/graphql-aggregated-data/" label="go to How to query aggregated data guide" outlined />
