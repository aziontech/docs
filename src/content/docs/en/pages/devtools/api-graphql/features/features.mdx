...
<Button href="/en/documentation/devtools/graphql-api/features/gql-real-time-metrics-fields/" text="see Real-Time Metrics GraphQL API fields descriptions" variant="secondary"></Button>
...
<Button href="/en/documentation/devtools/graphql-api/features/gql-real-time-events-fields/" text="see Real-Time Events GraphQL API fields descriptions" variant="secondary"></Button>
...
<Button href="/en/documentation/devtools/graphql-api/features/gql-billing-fields/" text="see Billing GraphQL API fields descriptions" variant="secondary"></Button>
...
<Button href="/en/documentation/devtools/graphql-api/features/gql-accounting-fields/" text="see Accounting GraphQL API fields descriptions" variant="secondary"></Button>
