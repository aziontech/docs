...
<LinkButton outlined link="/en/documentation/devtools/graphql-api/features/gql-real-time-metrics-fields/" label="see Real-Time Metrics GraphQL API fields descriptions" variant="secondary" />
...
| cellsConsoleEvents |  Events logs from applications using [Edge Runtime](/en/documentation/devtools/runtime/overview/) returned by the Cells Console. |
...
<LinkButton outlined link="/en/documentation/devtools/graphql-api/features/gql-real-time-events-fields/" label="see Real-Time Events GraphQL API fields descriptions" variant="secondary" />
...
<LinkButton outlined link="/en/documentation/devtools/graphql-api/features/gql-billing-fields/" label="see Billing GraphQL API fields descriptions" variant="secondary" />
...
<LinkButton outlined link="/en/documentation/devtools/graphql-api/features/gql-accounting-fields/" label="see Accounting GraphQL API fields descriptions" variant="secondary" />
...
<LinkButton outlined link="/en/documentation/devtools/graphql-api/queries/#raw-data" label="go to raw queries reference" variant="secondary" /> <br></br>

<LinkButton outlined link="/en/documentation/devtools/graphql-api/queries/#aggregated-data" label="go to aggregated queries reference" variant="secondary" /> <br></br>

<LinkButton outlined link="/en/documentation/products/guides/graphql-aggregated-data/" label="go to How to query aggregated data guide" variant="secondary" />
