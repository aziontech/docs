...
| telemetryDeviceInfoEvents | Events related to the device being used for access and recorded by [Bot Protection](/en/documentation/products/marketplace/bot-protection/), both at the hardware and software levels. |
| telemetrySensorsEvents | Events related to the device's sensors recorded by [Bot Protection](/en/documentation/products/marketplace/bot-protection/), such as touchscreen interactions and gyroscope information. |
