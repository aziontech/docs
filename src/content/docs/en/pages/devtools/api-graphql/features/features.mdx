...
:::note
If you use a query with resampling, but your data already returns an amount of points that are accessible to charts, such as `30 points`, for example, the API will ignore the resampling request and return all points.
:::
