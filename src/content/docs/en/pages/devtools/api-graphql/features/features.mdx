...
| tieredCacheMetrics | Request events registered by [Tiered Cache](/en/documentation/products/edge-application/l2-caching/). |
...
| tieredCacheEvents | Request events registered by [Tiered Cache](/en/documentation/products/edge-application/l2-caching/). |
