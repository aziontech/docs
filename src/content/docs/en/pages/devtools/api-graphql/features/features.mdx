...
| l2CacheMetrics | Request events registered by [Tiered Cache](/en/documentation/products/edge-application/l2-caching/). |
...
| l2CacheEvents | Request events registered by [Tiered Cache](/en/documentation/products/edge-application/l2-caching/). |
