...
| botManagerMetrics | Query the number of requests evaluated and the actions performed by [Azion Bot Manager Advanced](/en/documentation/products/guides/query-bot-manager-advanced-data-with-graphql/) (if subscribed) |
