...
<DocButton href="/en/documentation/devtools/graphql/queries/#raw-data" label="go to raw queries reference" kind="secondary" size="medium" />

<DocButton href="/en/documentation/devtools/graphql/queries/#aggregated-data" label="go to aggregated queries reference" kind="secondary" size="medium" />
