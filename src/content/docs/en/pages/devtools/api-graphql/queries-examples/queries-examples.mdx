...
description: Explore Azion's dedicated repository for GraphQL API query examples.
  Find updated query samples for Data Stream, Edge Applications, and more on GitHub.
permalink: /documentation/devtools/graphql-api/queries-examples/
meta_tags: Azion, GraphQL API, repository, query examples, Edge Functions, Data Stream,
