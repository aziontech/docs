---
title: Custom Pages GraphQL API
description: >-
  The GraphQL API returns standard HTTP status codes to indicate an error.
  Whenever you receive a status code while trying to run a request, you'll also
  receive a Custom Page.
meta_tags: 'graphql, api, azion, query, custom pages'
namespace: documentation_graphql_error_responses
permalink: /documentation/devtools/graphql-api/error-responses/
menu_namespace: graphqlMenu
---

The **GraphQL API** returns standard HTTP status codes to indicate an error. Whenever you receive a status code while trying to run a request, you'll also receive a Custom Page. These pages relate to *authentication*, *limits*, *access*, or query and GraphQL *construction* issues.

You can receive the following status codes and Custom Pages in a query format:
...
| 400         | Argument\"[value]" has invalid value [[value], [value]invoceationsss].\nIn element #1: Expected type \"[value]", found [value]. | An invalid argument value, indicated in the Custom Page, was used in the request. |
| 400         | Cannot query field\"[value]\" on type \"[value]".                                                                               | A non-existing field, indicated in the Custom Page, was used in the request.      |
| 400         | Unknown argument \"[value]" on field \"[value]" of type \"Query\". Did you mean \"[value]"?                                      | An invalid argument, indicated in the Custom Page, was used in the query.         |
...
If you receive any of the described Custom Pages, see the rest of the [GraphQL API documentation](/en/documentation/devtools/graphql-api/) to find specifications and correct your request.
