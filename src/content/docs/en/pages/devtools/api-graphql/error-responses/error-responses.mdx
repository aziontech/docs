...
| 400         | The start and end dates must have the same timezone.                                                                            | The timezone entered in the `tsGt` and `tsLt` fields are different. If you are using only one of them, use the time in UTC format (Ex.: "2023-10-10T10:47:00")
