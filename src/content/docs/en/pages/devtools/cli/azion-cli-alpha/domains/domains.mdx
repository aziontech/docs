...
The `--domain-id` flag specifies the unique identifier of the domain you want to retrieve detailed information.
...
The `--active` option sets the domain should be active.
