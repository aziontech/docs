...
Azion CLI works together with an open-source framework adapter called [Vulcan](https://github.com/aziontech/vulcan). Vulcan adapts a variety of web frameworks to run on the edge of the network.

The supported frameworks that run **static** applications include:
...
For applications that require processing on the edge rather than only delivery of content, it's supoorted:
