...
The `--slice-l2-caching-enabled` option informs whether Large File Optimization is active or not.
...
The `--slice-l2-caching-enabled` option informs whether Large File Optimization for L2 is active or not.
