...
The `--help` option displays more information about the 'list storage bucket' command.
...
The `-h` or `--help` option displays more detailed information about the `azion list storage object` command.
