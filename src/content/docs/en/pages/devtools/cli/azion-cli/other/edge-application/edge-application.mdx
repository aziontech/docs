...
The `--application-acceleration` flag specifies if the edge application has the [Application Accelerator](/en/documentation/products/build/edge-application/application-accelerator/) module active.
