...
meta_tags: >-
  ...
  configuration, cache settings, workloads management, Azion edge connector, edge storage
...
The `--cnames` option is a list of workloads' CNAMEs to associate with the domain.
