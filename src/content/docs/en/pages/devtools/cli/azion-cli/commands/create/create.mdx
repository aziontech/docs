...
The `--object-key` flag sets the name of the object to be stored in the bucket. It can also be used to indicate a full file path (like 'path/to/file/bucket/file.txt').
