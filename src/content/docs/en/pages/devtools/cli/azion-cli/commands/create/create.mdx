...
description: Learn how to utilize Azion CLI for creating and managing edge applications, functions, and other resources efficiently to enhance your edge solutions.
permalink: /documentation/devtools/cli/create/
meta_tags: Azion CLI, edge applications, create edge functions, rules engine configuration, cache settings, domains management, Azion origins, edge storage solutions, CLI commands for edge, Azion resource creation
