...
The `-h` or `--help` option displays more information about the `azion delete storage bucket` command.
...
The `-h` or `--help` option displays more information about the `azion delete storage object` command.
