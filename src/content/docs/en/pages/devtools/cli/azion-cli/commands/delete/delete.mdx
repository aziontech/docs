...
description: Learn to manage your Edge resources using Azion CLI, including deleting
  edge applications, functions, and setting up cache rules effectively.
permalink: /documentation/devtools/cli/delete/
meta_tags: azion CLI, edge application deletion, edge function removal, cache settings
  management, rules engine configuration, domain handling, edge storage solutions
