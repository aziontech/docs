...
- [azion login](/en/documentation/devtools/cli/login/): authenticates the CLI with your Azion account.
- [azion logout](/en/documentation/devtools/cli/logout/): signs out and removes the locally stored personal token.
