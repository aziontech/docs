...
permalink: /documentation/devtools/cli/azion-config-js/
---
...
- [Functions](/en/documentation/build/functions/) - Serverless compute on Azion Platform
- [Applications](/en/documentation/platform/applications/) - Configure and manage your applications
- [Firewall](/en/documentation/platform/firewall/) - Protect your applications
- [WAF](/en/documentation/secure/waf/) - Web Application Firewall
- [Cache](/en/documentation/build/cache/) - Configure cache policies
- [Object Storage](/en/documentation/store/object-storage/) - Object storage
