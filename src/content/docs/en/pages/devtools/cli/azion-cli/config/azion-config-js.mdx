...
[For further information, access azion.config.js schema in Vulcan repository](https://api.azion.com/#42279c76-58b3-4ce5-9852-1bce43c89524) or [Azion API specification](https://api.azion.com/#f1a07e9b-861c-4aed-9a93-2dee337df1d1).
