...
description: Learn how to customize your application build process using the azion.config.js file. This documentation provides detailed explanations of the configuration properties.
