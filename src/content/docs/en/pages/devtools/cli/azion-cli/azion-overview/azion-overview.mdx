---
title: Azion CLI
description: Explore Azion CLI for edge computing: manage and deploy edge applications,
  integrate with Azion APIs, and optimize with Go SDK.
permalink: /documentation/products/azion-cli/overview/
meta_tags: Azion CLI, edge computing, edge applications, Jamstack, Go SDK, web frameworks,
  SSR, deployment, API integration, Azion products
