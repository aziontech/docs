...
<Button href="/en/documentation/devtools/azion-edge-runtime/compatibility/nextjs/" label="go to Azion and Next.js compatibility docs" type="primary" theme="light" target="_blank" />
