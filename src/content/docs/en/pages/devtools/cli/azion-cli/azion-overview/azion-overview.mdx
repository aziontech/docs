---
title: Azion CLI
description: Dive into Azion CLI, your tool for optimized edge management. Learn commands, features, and that allow you to interact with Azion products via terminal.
