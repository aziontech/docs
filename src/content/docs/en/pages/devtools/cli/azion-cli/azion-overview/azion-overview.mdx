...
Learn how to install the Azion CLI with a step-by-step tutorial. Watch now on Azion's YouTube channel.
	...
	<iframe width="560" height="315" src="https://www.youtube.com/embed/uIuiJPtVIww?si=M9NYz3CzSOaNAI1n" loading="lazy" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
