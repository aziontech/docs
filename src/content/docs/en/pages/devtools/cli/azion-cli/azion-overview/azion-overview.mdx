...
permalink: /documentation/devtools/cli/
meta_tags: >-
...
The Azion CLI is built in Go and interacts with Azion products through the [Azion Go SDK](/en/documentation/devtools/sdk/). You can also interact with Azion using the [Terraform Provider](/en/documentation/devtools/terraform/) or the [Azion API](https://api.azion.com/).
...
<DocButton href="/en/documentation/guides/" label="View supported frameworks" kind="secondary" target="_blank" size="medium" />
<DocButton href="/en/documentation/devtools/runtime/frameworks/frameworks-compatibility/" label="Framework compatibility reference" kind="secondary" target="_blank" size="medium" />
