---
title: Azion CLI
description: Explore Azion CLI for edge computing: manage and deploy edge applications, integrate with Azion APIs, and optimize with Go SDK.
permalink: /documentation/products/azion-cli/overview/
meta_tags: Azion CLI, edge computing, edge applications, Jamstack, Go SDK, web frameworks, SSR, deployment, API integration, Azion products
...
<LinkButton link="/en/documentation/products/devtools/azion-edge-runtime/frameworks-compatibility/" label="go to supported Web Frameworks" outlined target="_blank" />
...
<LinkButton link="/en/documentation/products/azion-edge-runtime/compatibility/node/" label="go to node.js support reference" outlined target="_blank" />


Learn how to install the Azion CLI with a step-by-step tutorial. Watch now on Azion's YouTube channel.

	<iframe width="560" height="315" src="https://www.youtube.com/embed/52jzXvWBFe8?si=J3lZJStBMCBRZdUa" loading="lazy" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
