...
description: Explore detailed command usage for managing edge applications, functions,
...
meta_tags: azion, CLI, edge applications, edge functions, rules engine, cache settings,
  domains, origins, variables, edge storage, command usage, resource management
