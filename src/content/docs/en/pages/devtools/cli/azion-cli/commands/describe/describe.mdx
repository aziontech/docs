...
description: Explore detailed command usage for managing edge applications, functions, domains, and more with Azion CLI.
permalink: /documentation/devtools/cli/describe/
meta_tags: azion, CLI, edge applications, edge functions, rules engine, cache settings, domains, origins, variables, edge storage, command usage, resource management
