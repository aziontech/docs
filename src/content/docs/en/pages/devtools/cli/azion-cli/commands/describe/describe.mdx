...
description: >-
  Explore detailed command usage for managing edge applications, functions,
  workloads, and more with Azion CLI.
permalink: /documentation/devtools/cli/describe/
meta_tags: >-
  azion, CLI, edge applications, edge functions, rules engine, cache settings,
  workloads, edge connector, variables, edge storage, command usage, resource management
