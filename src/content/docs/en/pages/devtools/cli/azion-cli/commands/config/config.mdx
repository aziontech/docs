...
:::note
**API Versions:** Accounts created after 2026-01-01 automatically use API v4, while older accounts may use API v3. The CLI automatically detects the correct version.

To check which account is being used, run `azion whoami`.
