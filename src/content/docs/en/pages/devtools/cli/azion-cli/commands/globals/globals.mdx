...
description: Explore essential Azion CLI commands for managing configurations, tokens, and debugging. Helpful guide for version checks, log settings, and more.
permalink: /documentation/devtools/cli/globals/
meta_tags: Azion CLI, configuration commands, debug logs, token management, CLI version, log levels, command settings, CLI help, silent mode, command line interface
