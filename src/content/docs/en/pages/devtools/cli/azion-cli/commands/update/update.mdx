...
The `--load-balancer` flag specifies if the edge application has the [Load Balancer](/en/documentation/products/secure/edge-connector/load-balancer/) module active.
