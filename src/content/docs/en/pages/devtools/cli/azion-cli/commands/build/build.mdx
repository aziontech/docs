...
description: Learn how to build and deploy edge applications effectively using commands
  like 'azion build' with support for multiple frameworks and configurations.
permalink: /documentation/devtools/cli/build/
meta_tags: edge computing, edge application, deployment, azion build, CLI, Javascript,
