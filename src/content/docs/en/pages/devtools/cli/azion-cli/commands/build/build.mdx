...
description: Build an application and prepare it for the deployment on the edge.
...
Build your edge application locally and prepare to deploy it onto the edge.
