...
description: >-
  Watch your functions and edge application's HTTP events logs through
  Azion CLI.
...
Watch your functions logs and edge application's HTTP events logs through Azion CLI.
