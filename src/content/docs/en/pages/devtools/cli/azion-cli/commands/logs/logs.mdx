...
description: Watch your edge functions and edge application's logs through Azion CLI.
...
Watch your edge functions and edge application's logs through Azion CLI.
...
The `--limit` option defines how many logs will be shown per request. By default, it's 100.
