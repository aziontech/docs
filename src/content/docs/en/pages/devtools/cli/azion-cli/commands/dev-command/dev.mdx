...
title: Azion CLI dev
description: >-
  Discover how to build and run Azion Edge Applications locally using the dev
  command. Learn to link projects and use Edge Functions effectively.
permalink: /documentation/products/cli/dev-command/
meta_tags: >-
  Azion, Edge Computing, Edge Application, Edge Functions, Local Development
...
The `dev` command adapts the environment for building your edge application and run it locally. It's used for projects already initialized or linked to an **Azion edge application**.

:::tip
If you want to run this command for a project that hasn't been initialized as an Azion edge application, you can run the `link` command to link the project to Azion.
:::
...
<LinkButton link="/en/documentation/products/guides/edge-functions/first-steps/" label="Edge Functions for Edge Application" severity="secondary" /> 
