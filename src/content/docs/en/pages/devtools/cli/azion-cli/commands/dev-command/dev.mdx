...
<DocButton href="/en/documentation/guides/application-development/functions-and-runtime/first-steps/" label="Functions for Applications" kind="secondary" size="medium" /> 
