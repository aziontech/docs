...
<Button href="/en/documentation/products/cli/link-command/" label="Link an Existing Project to Azion" type="primary" theme="light" /> 
...
<Button href="/en/documentation/products/guides/edge-functions/first-steps/" label="Functions for Applications" type="primary" theme="light" /> 

<br />

<Button href="/en/documentation/products/secure/edge-firewall/edge-functions/" label="Functions for Firewall" type="primary" theme="light" /> 
