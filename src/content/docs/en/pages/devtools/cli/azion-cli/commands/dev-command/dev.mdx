...
The `dev` command adapts the environment for building your edge application and run it locally. It's used for projects already initialized or linked to an **Azion edge applications**.

:::tip
If you want to run this command for a project that has not been initialized as an Azion edge application yet, you can run the `link` command it to link the project to Azion.
:::
