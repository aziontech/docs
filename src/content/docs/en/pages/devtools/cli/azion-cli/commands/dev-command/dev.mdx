...
meta_tags: >-
  Azion, Edge Computing, Edge Application, Functions, Local Development
...
<LinkButton link="/en/documentation/products/guides/edge-functions/first-steps/" label="Functions for Edge Application" severity="secondary" /> 

<br />

<LinkButton link="/en/documentation/products/secure/edge-firewall/edge-functions/" label="Functions for Edge Firewall" severity="secondary" /> 
