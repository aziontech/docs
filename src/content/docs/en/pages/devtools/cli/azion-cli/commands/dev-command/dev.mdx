...
The `--firewall` option indicates the function is intended for the Edge Firewall


<Button href="/en/documentation/products/guides/edge-functions/first-steps/" text="edge functions for edge applications" variant="secondary"> 
</Button>

<br />

<Button href="/en/documentation/products/secure/edge-firewall/edge-functions/" text="edge functions for edge firewall" variant="secondary"> 
</Button>
