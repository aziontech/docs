...
For a faster setup, generate a [personal token](/en/documentation/guides/platform/account-and-billing/personal-tokens/) in [Azion Console](https://console.azion.com) and save it in a `.env.development` file:
...
Azion **Console Kit** can run natively on Azion's edge using the [Azion CLI](/en/documentation/devtools/cli/) (version >= 0.70.0). To do so, follow these steps:

1. [Download and install the Azion CLI](/en/documentation/devtools/cli/#installing-azion-cli) using your preferred method.
2. Configure your [personal token](/en/documentation/guides/platform/account-and-billing/personal-tokens/) on the CLI:
...
- [How to customize the Azion Console interface using the Console Kit](/en/documentation/guides/application-development/automation/customize-interface-console-kit/)
- [How to integrate the Azion Console and the Azion API using the Console Kit](/en/documentation/guides/application-development/automation/integrate-with-api-console-kit/)
