...
For a faster setup, generate a [personal token](/en/documentation/products/guides/personal-tokens/) in Azion [Real-Time Manager](https://console.azion.com) and save it in a `.env.development` file:
