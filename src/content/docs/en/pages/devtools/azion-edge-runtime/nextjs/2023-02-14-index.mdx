...
description: Discover how various Next.js versions perform on the Azion Edge Platform, highlighting compatibility, SSR, SSG, and essential middleware features.
permalink: /documentation/devtools/azion-edge-runtime/compatibility/nextjs/
meta_tags: Next.js compatibility, Azion Edge Platform, SSR, SSG, Middleware Features, Static Generation, Server-side Rendering, Next.js Routing, Next.js Performance, Next.js Integrations
