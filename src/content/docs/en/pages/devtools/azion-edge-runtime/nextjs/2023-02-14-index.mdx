...
description: Discover how various Next.js versions perform on the Azion Edge Platform,
...
meta_tags: Next.js compatibility, Azion Edge Platform, SSR, SSG, Middleware Features,
  Static Generation, Server-side Rendering, Next.js Routing, Next.js Performance,
