...
permalink: /documentation/devtools/runtime/api-reference/add-eventlistener/
---

## How it works

The *addEventListener* function defines the trigger for the execution of JavaScript code to receive the request data. The event listener type is `fetch` and gets the [fetchEvent](/en/documentation/devtools/runtime/api-reference/fetch-event/)
