...
For a complete list of the Azion Runtime supported types, go to [Azion Runtime supported types](/en/documentation/products/edge-application/edge-functions/runtime-apis/javascript/supported-types/).
