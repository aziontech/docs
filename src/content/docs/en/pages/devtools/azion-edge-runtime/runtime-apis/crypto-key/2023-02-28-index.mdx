...
permalink: /documentation/devtools/runtime/api-reference/crypto-key/
---

## How it works

The `CryptoKey` interface represents a cryptographic key obtained from one of the [SubtleCrypto methods](/en/documentation/devtools/runtime/api-reference/subtle-crypto/).
