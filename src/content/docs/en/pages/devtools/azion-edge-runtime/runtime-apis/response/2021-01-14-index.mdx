...
permalink: /documentation/devtools/runtime/api-reference/response/
---

The `Response` interface represents an HTTP response and integrates the [Fetch API](/en/documentation/devtools/runtime/api-reference/fetch/).
