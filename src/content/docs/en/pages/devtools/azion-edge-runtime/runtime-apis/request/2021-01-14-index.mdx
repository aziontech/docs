...
permalink: /documentation/devtools/runtime/api-reference/request/
---

The `Request` interface represents an HTTP request and integrates the [Fetch API](/en/documentation/devtools/runtime/api-reference/fetch/).

## How it works

The Request object can be built and also seen as the property of a [fetchevent](/en/documentation/devtools/runtime/api-reference/fetch-event/) received by function.
