...
description: Explore the WebAssembly interface, functions like compile and instantiate,
...
meta_tags: WebAssembly, wasm, WebAssembly compile, WebAssembly instantiate, WebAssembly
  examples, WebAssembly objects, WebAssembly syntax, WebAssembly functions, JavaScript
  WebAssembly interface, WebAssembly Memory structure
