---
title: Metadata API
description: Explore how Edge Functions and Edge Firewall utilize metadata for enhanced security, including GeoIP, TLS, and remote client details to manage and secure access.
permalink: documentation/products/edge-application/edge-functions/runtime/api-reference/metadata
meta_tags: edge functions, edge firewall, edge computing security, metadata manipulation, GeoIP metadata, client IP management, TLS certificates, remote client information, network security, protocol information
