...
permalink: /documentation/devtools/runtime/api-reference/network-list/
---
...
Find out more about [Network Lists on the Azion Platform](/en/documentation/secure/network-shield/network-lists/).
