...
description: >-
  The Azion.networkList.contains interface can be used by edge functions on Edge
...
permalink: >-
  /documentation/products/edge-application/edge-functions/runtime/api-reference/network-list
