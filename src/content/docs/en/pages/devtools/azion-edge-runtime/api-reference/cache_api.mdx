...
title: Cache API
description: >-
 The Cache API allows you to control reading and writing from Cache through Edge Functions.
meta_tags: 'edge function, edge computing'
namespace: documentation_products_edge_functions_cache_api
permalink: >-
  /documentation/runtime/api-reference/cache/
...
The Cache API allows you to control reading and writing from [Cache](https://www.azion.com/en/products/edge-cache/) through Edge Functions.
