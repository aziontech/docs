...
permalink: /documentation/devtools/runtime/api-reference/read/
---
...
- [Write key-value pairs](/en/documentation/devtools/runtime/api-reference/write/)
- [Delete key-value pairs](/en/documentation/devtools/runtime/api-reference/delete/)
- [KV Store API overview](/en/documentation/devtools/runtime/api-reference/kv-store/)
