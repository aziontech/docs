---
title: Edge SQL API 
description: The Edge Functions SQL API is an interface for access Azion Edge SQL to read and write data in the storage and its buckets.
...
> <Value> could be a number, bigint, string, or boolean.
