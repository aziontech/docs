...
permalink: /documentation/devtools/runtime/api-reference/kv-store/
---
...
|--------|-------------|-----------|
| `put(key, value, options?)` | Store a key-value pair | [Write key-value pairs](/en/documentation/devtools/runtime/api-reference/write/) |
| `get(key, type?, options?)` | Retrieve a value by key | [Read key-value pairs](/en/documentation/devtools/runtime/api-reference/read/) |
| `getWithMetadata(key, type?, options?)` | Retrieve a value with its metadata | [Read key-value pairs](/en/documentation/devtools/runtime/api-reference/read/) |
| `delete(key)` | Delete a key-value pair | [Delete key-value pairs](/en/documentation/devtools/runtime/api-reference/delete/) |
...
- [KV Store reference](/en/documentation/store/kv-store/)
- [How to manage KV Store with Functions](/en/documentation/guides/application-development/data/manage-with-functions/)
