...
description: The Edge Functions Storage API is an interface that allows access to the Azion Edge Storage. Through this interface, it's possible to read and write data in the storage and its buckets.
...
The [Edge Functions](/en/documentation/products/edge-application/edge-functions/) Storage API is an interface that allows access to the Azion Edge Storage. Through this interface, it's possible to read and write data in the storage and its buckets.
...
Storage object used to access Azion Edge Storage.
...
The `Storage.delete(key)` is used to remove an object from Azion Edge Storage.
...
1. To remove an object stored in Azion Edge Storage related to a specific `bucket`:
