...
meta_tags: 'function, edge computing, storage, jamstack, apis'
namespace: documentation_runtime_storage
permalink: /documentation/devtools/runtime/api-reference/storage/
---

The [Functions](/en/documentation/build/functions/) Storage API is an interface that allows access to the Object Storage. Through this interface, it's possible to read and write data in the storage and its buckets.
...
:::note 
The **bucket** is created during the deploy of a static application through [Azion CLI](/en/documentation/devtools/cli/) or through [Azion API](https://api.azion.com/) requests.
:::
