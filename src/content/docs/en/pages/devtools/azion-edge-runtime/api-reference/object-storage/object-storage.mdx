...
| - | - | - |
| `bucket` | string | Name of a bucket created during an [Azion CLI](/en/documentation/products/azion-cli/overview/) deploy or through [Real-Time Manager (RTM)](/en/documentation/products/guides/getting-to-know-real-time-manager/) |
...
1. To remove an object stored in Azion Object Storage related to a specific `bucket`:
