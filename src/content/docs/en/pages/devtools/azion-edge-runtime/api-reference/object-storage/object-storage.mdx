...
description: The Edge Functions Storage API is an interface that allows access to the Azion Object Storage. Through this interface, it's possible to read and write data in the storage and its buckets.
...
The [Edge Functions](/en/documentation/products/edge-application/edge-functions/) storage API is an interface that allows access to the Azion Object Storage. Through this interface, it's possible to read and write data in the storage and its buckets.
...
| - | - | - |
| `bucket` | string | Name of a bucket created during an [Azion CLI](/en/documentation/products/azion-cli/overview/) deploy or through [RTM](/en/documentation/products/guides/getting-to-know-real-time-manager/). |

### Return value

Storage object used to access Azion Object Storage.
...
The `Storage.delete(key)` is used to remove an object from Azion Object Storage.
...
| Success | Error | 
|-|-|
| Returns an object of the class `StorageObjectList` | Throws a `StorageError`|


#### Code sample

1. To list objects stored in Azion Object Storage related to a specific `bucket`:
