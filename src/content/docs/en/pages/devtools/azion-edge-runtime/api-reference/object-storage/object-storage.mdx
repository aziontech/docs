...
The [Edge Functions](/en/documentation/products/edge-application/edge-functions/) Storage API is an interface that allows access to the Edge Storage. Through this interface, it's possible to read and write data in the storage and its buckets.
