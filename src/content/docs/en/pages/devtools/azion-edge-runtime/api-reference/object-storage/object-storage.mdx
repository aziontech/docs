...
The [Edge Functions](/en/documentation/products/edge-application/edge-functions/) storage API is an interface that allows access to Azion Storage. Through this interface, it's possible to write and retrieve data.
