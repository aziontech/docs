...
description: Explore the Edge Functions Code Editor on Azion, featuring VS Code’s
  Monaco editor, ChatGPT integration, and tools like debugging and IntelliSense for
  efficient edge development.
permalink: documentation/products/edge-application/edge-functions/runtime-api/code-editor
meta_tags: Edge Functions, Azion, JavaScript, Monaco Code Editor, VS Code, code development,
  ChatGPT integration, API development, debugging, code editor
