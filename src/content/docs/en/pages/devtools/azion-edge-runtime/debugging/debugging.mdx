---
title: Debugging
description: Explore debugging in Edge Functions for enhanced control and observability,
  including setup guides for log management and Data Stream on the Azion platform.
permalink: /documentation/devtools/debugging/
meta_tags: Edge Functions, debugging process, serverless computing, Data Stream setup,
  observability, log management, Azion platform, console.log, JavaScript debugging,
  cloud diagnostics
