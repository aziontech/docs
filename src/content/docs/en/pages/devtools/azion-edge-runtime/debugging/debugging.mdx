...
Now that you've created the function, you must configure your **edge application** to run the function before the logs are accessible.

---

### Instantiating the function

To instantiate the newly created function in your edge application, follow these steps:
...
Now your function is instantiated and ready to be used in your edge application. You can configure the execution conditions and behaviors using the [Rules Engine](/en/documentation/products/build/edge-application/rules-engine/):
