---
title: Debugging
description: Explore debugging in Edge Functions for enhanced control and observability, including setup guides for log management and Data Stream on the Azion platform.
permalink: /documentation/devtools/debugging/
meta_tags: Edge Functions, debugging process, serverless computing, Data Stream setup, observability, log management, Azion platform, console.log, JavaScript debugging, cloud diagnostics
...
Check the use of the `console.log` function below:
...
The message is then collected and made available to be accessed on [Data Stream](/en/documentation/products/observe/data-stream/).

---

## Setting up

1. Access [Azion Console](https://sso.azion.com/login) with your login credentials.
2. On the upper left corner, select **Products Menu** > **Observe** > **Data Stream**.
...
**Name for Data Stream**: Define a name for your template.
...
**Endpoint Type**: the method by which your endpoint will receive the data collected by Data Stream. Select an option.

**Endpoint URL**: the URL that will receive information transmitted by Data Stream. Define the URL.

**Custom Headers**: include here the need to add headers at requests.

5. Click the **Save** button to finish the process.

Check the [Data Stream documentation](/en/documentation/products/observe/data-stream/) to learn more.
