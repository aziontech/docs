...
The message is then collected and made available to be accessed on [Data Streaming](/en/documentation/products/observe/data-streaming/).
...
Check the [Data Streaming documentation](/en/documentation/products/observe/data-streaming/) to learn more.
