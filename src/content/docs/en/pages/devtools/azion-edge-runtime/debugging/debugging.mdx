...
To debug codes, you must create a new [Edge Function](/en/documentation/products/build/edge-application/edge-functions/) that will use the **log** method. This method prints to the console a message that was previously sent by a parameter to the function.
...
5. Select the **Edge Functions Event Collector** template. In the **Data Set** box, you will see the preset of variables:
