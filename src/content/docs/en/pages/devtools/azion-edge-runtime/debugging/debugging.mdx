...
- **Query the events**: the `functionConsoleEvents` query returns `level`, `lineSource`, and `line` for a time range. Refer to [How to debug functions using GraphQL API](/en/documentation/guides/application-development/functions-and-runtime/debugging-functions-graphql/).
...
<FrameBox>
<ItemList>
  <DocItem title="Functions quickstart" href="/en/documentation/build/functions/quickstart/">Create, instantiate, and run a function end to end, the chain most symptoms break in.</DocItem>
  ...
  <DocItem title="azion dev" href="/en/documentation/devtools/cli/dev-command/">Run the function locally and read its output in your terminal.</DocItem>
  <DocItem title="Limits" href="/en/documentation/build/functions/limits/">The complete set of ceilings a function runs inside, and how to raise them.</DocItem>
  <DocItem title="Best practices" href="/en/documentation/build/functions/best-practices/">Scope, configure, and instrument a function so it stays inside the CPU, sub-request, and Args ceilings.</DocItem>
  ...
  <DocItem title="How to debug functions on Data Stream" href="/en/documentation/guides/platform/observability/debugging-functions-data-stream/">The full stream setup, including the workload association.</DocItem>
  <DocItem title="How to debug functions using GraphQL API" href="/en/documentation/guides/application-development/functions-and-runtime/debugging-functions-graphql/">The query that returns function events, with an example response.</DocItem>
  ...
  <DocItem title="Real-Time Metrics" href="/en/documentation/platform/real-time-metrics/">The Functions tab, with the metrics of the invocations of the functions in your account.</DocItem>
