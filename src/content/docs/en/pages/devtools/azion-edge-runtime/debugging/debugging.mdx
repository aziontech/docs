...
To debug codes, you must create a new [function](/en/documentation/build/functions/) that will use the **log** method. This method prints to the console a message previously sent by a parameter to the function.
...
2. Click on the application where you want to add the function or [create a new one](/en/documentation/platform/applications/first-steps/).
...
Now your function is instantiated and ready to be used in your application. You can configure the execution conditions and behaviors using the [Rules Engine](/en/documentation/platform/applications/rules-engine/):
...
Check the [documentation](/en/documentation/observe/data-stream/) to learn more about **Data Stream** and its configurations. You can also use **Real-Time Events** to observe and analyze the generated logs. 
...
Read the [Real-Time Events documentation](/en/documentation/observe/real-time-events/) to learn more.
