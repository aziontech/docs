...
permalink: /documentation/products/functions/environment-variables/
meta_tags: >-
...
The command `variables` is available and can be used to manage your environment variables using [Azion CLI](/en/documentation/products/azion-cli/overview/).

Learn more about the command on [Variables command and its subcommands](/en/documentation/products/azion-cli/overview/)
...
Learn more about the [Environment Variables interface](/en/documentation/products/applications/functions/runtime/api-reference/environment-variables/).
