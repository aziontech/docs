...
description: Explore how Environment Variables enhance security, flexibility, and compliance on the Azion platform, and their integration with Edge Functions.
permalink: documentation/products/edge-functions/environment-variables/
meta_tags: Environment Variables, Edge Functions, Application Security, Configuration Management, Application Deployment, API Token Management, Azure CLI, Compliance Standards, Data Protection, Variable Scope and Limits
