...
<div class="[&_.flex.flex-col]:!gap-4 [&_.flex.flex-col]:md:!gap-8 [&_.flex.flex-col]:2xl:!gap-16">
  <HeroHome
    ...
    description="The Astro with Vitest template deploys a new edge application based on Astro working with Vitest."
    logos={[]}
    buttons={[
      { label: "Deploy template", link: "https://console.azion.com/create/astro/astro-with-vitest", outlined: false },
