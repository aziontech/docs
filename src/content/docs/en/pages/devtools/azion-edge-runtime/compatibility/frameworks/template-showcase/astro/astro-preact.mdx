...
<div class="[&_.flex.flex-col]:!gap-4 [&_.flex.flex-col]:md:!gap-8 [&_.flex.flex-col]:2xl:!gap-16">
  <HeroHome
    title="Astro with Framework Preact"
    description="The Astro with Preact Framework template deploys a new edge application based on Astro working with Preact. "
    logos={[]}
    buttons={[
      { label: "Deploy template", link: "https://console.azion.com/create/astro/astro-with-framework-preact", outlined: false },
