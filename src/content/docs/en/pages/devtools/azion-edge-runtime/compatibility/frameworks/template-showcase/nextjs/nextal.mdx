...
<div class="[&_.flex.flex-col]:!gap-4 [&_.flex.flex-col]:md:!gap-8 [&_.flex.flex-col]:2xl:!gap-16">
  <SectionBasicContent
    ...
    buttons={[
      { label: "Deploy template", link: "/en/documentation/products/cli/frameworks/nextal/", outlined: false, icon: "ai ai-azion", iconPos: "left" }
    ]}
  />
</div>
...
For more information about deploying this template visit the [template guide](/en/documentation/products/cli/frameworks/nextal/).