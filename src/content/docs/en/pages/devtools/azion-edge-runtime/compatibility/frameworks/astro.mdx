...
| Astro with Framework Alpine | Starter project | <LinkButton link="/en/documentation/products/templates/astro-alpine/" label="Learn more" severity="secondary" /> |
| Astro with Framework Lit | Starter project | <LinkButton link="/en/documentation/products/templates/astro-lit/" label="Learn more" severity="secondary" /> |
| Astro with Multiple Frameworks | Starter project | <LinkButton link="/en/documentation/products/templates/astro-multiple-frameworks/" label="Learn more" severity="secondary" /> |
| Astro with Framework Preact | Starter project | <LinkButton link="/en/documentation/products/templates/astro-preact/" label="Learn more" severity="secondary" /> |
| Astro with Framework React | Starter project | <LinkButton link="/en/documentation/products/templates/astro-react/" label="Learn more" severity="secondary" /> |
| Astro with Framework Solid | Starter project | <LinkButton link="/en/documentation/products/templates/astro-solid/" label="Learn more" severity="secondary" /> |
| Astro with Framework Svelte | Starter project | <LinkButton link="/en/documentation/products/templates/astro-svelte/" label="Learn more" severity="secondary" /> |
| Astro with Framework Vue | Starter project | <LinkButton link="/en/documentation/products/templates/astro-vue/" label="Learn more" severity="secondary" /> |
| Astro Minimal | Starter project | <LinkButton link="/en/documentation/products/templates/astro-minimal/" label="Learn more" severity="secondary" /> |
...
| Astro with Markdoc | Starter project | <LinkButton link="/en/documentation/products/templates/astro-markdoc/" label="Learn more" severity="secondary" /> |
| Astro Markdown with Plugins | Starter project | <LinkButton link="/en/documentation/products/templates/astro-markdown-with-plugins/" label="Learn more" severity="secondary" /> |
| Astro Markdown with Shiki | Code demo | <LinkButton link="/en/documentation/products/templates/astro-markdown-with-shiki/" label="Learn more" severity="secondary" /> |
| Astro with MDX | Starter project | <LinkButton link="/en/documentation/products/templates/astro-mdx/" label="Learn more" severity="secondary" /> |
| Astro with Nano Stores | E-commerce | <LinkButton link="/en/documentation/products/templates/astro-nanostores/" label="Learn more" severity="secondary" /> |
...
| Astro with Vitest | Starter project | <LinkButton link="/en/documentation/products/templates/astro-vitest/" label="Learn more" severity="secondary" /> |
| Cosmic - Simple Astro Blog | Blog | <LinkButton link="/en/documentation/products/templates/astro-cosmic-blog/" label="Learn more" severity="secondary" /> |
