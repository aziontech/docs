...
title: " "
description: >-
  The Astro Markdown with Shiki template showcases Astro's built-in Markdown support.
meta_tags: >-
...
<div class="[&_.flex.flex-col]:!gap-4 [&_.flex.flex-col]:md:!gap-8 [&_.flex.flex-col]:2xl:!gap-16">
  <HeroHome
    ...
    description="The Astro Markdown with Shiki template showcases Astro's built-in Markdown support."
    logos={[]}
    buttons={[
