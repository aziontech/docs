...
permalink: /documentation/devtools/runtime/node/
meta_tags: >-
...
A polyfill is a code snippet, often used in JavaScript, that brings new features to environments lacking these capabilities. Polyfills are used during build time at Azion and can be configured through the [azion.config.js](/en/documentation/devtools/cli/azion-config-js/) file.
...
| [async_hooks](/en/documentation/devtools/runtime/node/async-hooks/)     | 🟢 Supported     |
| [buffer](/en/documentation/devtools/runtime/node/buffer/)          | 🟡 Partially supported     |
| child_process    | 🟡 Partially supported     |
| cluster          | 🟢 Supported     |
| console          | 🟢 Supported     |
| constants        | 🟢 Supported     |
| [crypto](/en/documentation/devtools/runtime/node/crypto/)          | 🟡 Partially supported     |
| dgram           | 🟢 Supported     |
| diagnostics_channel | 🟢 Supported     |
| dns             | 🔴 Build-only     |
| dns/promises    | 🔴 Build-only     |
| domain          | 🟢 Supported     |
| [events](/en/documentation/devtools/runtime/node/events/)          | 🟢 Supported     |
| [fs](/en/documentation/devtools/runtime/node/fs/)              | 🟡 Partially supported     |
| fs/promises     | 🟡 Partially supported     |
| [http](/en/documentation/devtools/runtime/node/http/)            | 🟡 Partially supported     |
| http2           | 🟡 Partially supported     |
| https           | 🟡 Partially supported     |
| inspector       | 🟢 Supported     |
| inspector/promises    | 🟡 Partially supported     |
| [module](/en/documentation/devtools/runtime/node/module/)          | 🟡 Partially supported     |
| net             | 🟡 Partially supported     |
| [os](/en/documentation/devtools/runtime/node/os/)              | 🔴 Build-only     |
| [path](/en/documentation/devtools/runtime/node/path/)            | 🟢 Supported     |
| path/posix            | 🟡 Partially supported     |
| path/win32           | 🟡 Partially supported     |
| perf_hooks     | 🟢 Supported     |
| [process](/en/documentation/devtools/runtime/node/process/)         | 🟡 Partially supported     |
| punycode             | 🟡 Partially supported     |
| querystring          | 🟡 Partially supported     |
| readline        | 🟢 Supported     |
| readline/promises | 🟢 Supported     |
| repl                  | 🟡 Partially supported     |
| [stream](/en/documentation/devtools/runtime/node/stream/)          | 🟡 Partially supported     |
| stream/consumers      | 🟡 Partially supported     |
| stream/promises       | 🟡 Partially supported     |
| stream/web           | 🟢 Supported     |
| [string_decoder](/en/documentation/devtools/runtime/node/string-decoder/)  | 🟢 Supported     |
| sys                   | 🟡 Partially supported     |
| [timers](/en/documentation/devtools/runtime/node/timers/)          | 🟡 Partially supported     |
| timers/promises | 🟢 Supported     |
| tls             | 🟡 Partially supported     |
| trace_events    | 🟢 Supported     |
| tty             | 🟢 Supported     |
| [url](/en/documentation/devtools/runtime/node/url/)             | 🟢 Supported     |
| [util](/en/documentation/devtools/runtime/node/utils/)            | 🟡 Partially supported     |
| util/types           | 🟡 Partially supported     |
| v8              | 🟢 Supported     |
| [vm](/en/documentation/devtools/runtime/node/vm/)              | 🟢 Supported     |
| wasi            | 🟢 Supported     |
| worker_threads  | 🟡 Partially supported     |
| [zlib](/en/documentation/devtools/runtime/node/zlib/)            | 🟢 Supported     |
