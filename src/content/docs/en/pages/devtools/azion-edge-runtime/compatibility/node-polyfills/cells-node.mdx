...
|---------|---------------|----------|-------------|
| async_hooks | 🟡 Partially supported Partially supported | [Access code sample](https://github.com/aziontech/azion-samples/tree/dev/samples/node-async-hooks) | Only [AsyncLocalStorage](https://nodejs.org/api/async_context.html#class-asynclocalstorage) and [AsyncResource](https://nodejs.org/api/async_hooks.html#class-asyncresource) are implemented. |
| fs | 🟡 Partially supported Partially supported| | Only async methods ([check the list below](#fs-support)), others through [polyfills](#node-polyfills). |
| module | 🟡 Partially supported Partially supported | | Also supported in local dev through polyfills ([check table below](#node-polyfills)). |
...
| Module                | Status |
|-----------------------|--------|
| _http_agent           | 🔴 Not supported     |
| _http_client          | 🔴 Not supported     |
| _http_common          | 🔴 Not supported     |
| _http_incoming        | 🔴 Not supported     |
| _http_outgoing        | 🔴 Not supported     |
| _http_server          | 🔴 Not supported     |
| _stream_duplex        | 🔴 Not supported     |
| _stream_passthrough   | 🔴 Not supported     |
| _stream_readable      | 🔴 Not supported     |
| _stream_transform      | 🔴 Not supported     |
| _stream_wrap          | 🔴 Not supported     |
| _stream_writable      | 🔴 Not supported     |
| _tls_common           | 🔴 Not supported     |
| _tls_wrap             | 🔴 Not supported     |
| [assert](#)          | 🟡 Partially supported     |
| assert/strict         | 🔴 Not supported     |
...
| inspector       | 🟢 Supported     |
| inspector/promises    | 🔴 Not supported     |
...
| path/posix            | 🔴 Not supported     |
| path/win32           | 🔴 Not supported     |
...
| stream/consumers      | 🔴 Not supported     |
| stream/promises       | 🔴 Not supported     |
