...
<div class="[&_.flex.flex-col]:!gap-4 [&_.flex.flex-col]:md:!gap-8 [&_.flex.flex-col]:2xl:!gap-16">
  <HeroHome
    ...
    description="The Astro Quickstore helps you rapidly set up and deploy on the edge using the Astro framework and Tailwind CSS. "
    logos={[]}
    buttons={[
      { label: "Deploy template", link: "https://console.azion.com/create/azion-community/astro-quickstore", outlined: false },
      { label: "View demo", link: "https://xxx.map.azionedge.net/", severity: "secondary" }
    ]}
  />
</div>
