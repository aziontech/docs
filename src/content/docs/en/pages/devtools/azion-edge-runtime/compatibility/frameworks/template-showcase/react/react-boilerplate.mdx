...
This template is a minimal starter for applications built with [React](/en/documentation/devtools/runtime/frameworks/react/), a component-based JavaScript library for building user interfaces. It offers a clean baseline with build and deploy steps already configured, giving you a solid structure to grow from. Once deployed on Azion, the app runs on a distributed architecture for low-latency access worldwide.
...
For more information about deploying this template visit the [template guide](/en/documentation/guides/application-development/frameworks/react-boilerplate/).