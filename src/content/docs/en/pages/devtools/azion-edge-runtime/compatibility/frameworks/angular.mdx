...
| ButterCMS + Angular Starter Project | Blog creation | <LinkButton link="/en/documentation/products/templates/angular-buttercms/" label="Learn more" severity="secondary" /> |
| Clean Angular + Sanity app | E-commerce platform | <LinkButton link="/en/documentation/products/templates/angular-sanity/" label="Learn more" severity="secondary" /> |
