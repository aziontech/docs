...
|:-------------|:---------|:-----|
| Angular Boilerplate | Starter project | <Button href="/en/documentation/products/templates/angular-boilerplate/" label="Learn more" type="primary" theme="light" /> |
| ButterCMS + Angular Starter Project | Starter Project | <Button href="/en/documentation/products/templates/angular-buttercms/" label="Learn more" type="primary" theme="light" /> |
| Clean Angular + Sanity app | Starter Project | <Button href="/en/documentation/products/templates/angular-sanity/" label="Learn more" type="primary" theme="light" /> |
