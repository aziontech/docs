...
description: >-
  This documentation explores the integration and use of the Node.js Stream module within the Azion Edge Runtime. The Stream module is a fundamental part of Node.js, providing an abstract interface for handling streaming data.
