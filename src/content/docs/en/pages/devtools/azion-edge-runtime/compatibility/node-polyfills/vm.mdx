...
description: >-
  Explore the integration and application of the Node.js VM module within the Azion Edge Runtime. The VM module provides utilities to run JavaScript code in a virtualized environment, offering a level of isolation from the main application.
