...
|:-------------|:---------|:-----|
| Next.js Static Boilerplate | Static/SPA | <Button href="/en/documentation/products/templates/nextjs-static-boilerplate/" label="Learn more" type="primary" theme="light" /> |
| Next.js Store Ecommerce Template | E-commerce | <Button href="/en/documentation/products/templates/nextjs-store/" label="Learn more" type="primary" theme="light" /> |
| Next.js App Middleware | Middleware Example | <Button href="/en/documentation/products/templates/nextjs-app-midddleware/" label="Learn more" type="primary" theme="light" /> |
| Next.js App Configurations | Config Example | <Button href="/en/documentation/products/templates/nextjs-app-configurations/" label="Learn more" type="primary" theme="light" /> |
| Next.js Pages Configurations | Config Example | <Button href="/en/documentation/products/templates/nextjs-pages-configurations/" label="Learn more" type="primary" theme="light" /> |
| Next.js Pages Middleware | Middleware Example | <Button href="/en/documentation/products/templates/nextjs-pages-middleware/" label="Learn more" type="primary" theme="light" /> |
| Kupingplug Store| E-commerce | <Button href="/en/documentation/products/templates/kupingplug/" label="Learn more" type="primary" theme="light" /> |
| Next.js Stationary Store | E-commerce | <Button href="/en/documentation/products/templates/stationary-ecommerce/" label="Learn more" type="primary" theme="light" /> |
| Cosmic Next Blog | Blog | <Button href="/en/documentation/products/templates/cosmic-nextjs-blog/" label="Learn more" type="primary" theme="light" /> |
| Cosmic Agency | Agency/Starter | <Button href="/en/documentation/products/templates/cosmic-agency/" label="Learn more" type="primary" theme="light" /> |
| Space Jelly Shop | E-commerce | <Button href="/en/documentation/products/templates/space-jelly-shop/" label="Learn more" type="primary" theme="light" /> |
