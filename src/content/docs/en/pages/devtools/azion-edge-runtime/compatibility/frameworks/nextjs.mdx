...
permalink: /documentation/devtools/runtime/frameworks/nextjs/
meta_tags: >-
...
Next.js also allows for Server Side Rendering (SSR) on the Azion Web Platform. For more information about Next.js compatibility [visit our documentation](/en/documentation/devtools/runtime/frameworks/nextjs-compatibility/).

## Available Templates

| Template name | Use case | Details |
|:-------------|:---------|:-----|
| Next.js Static Boilerplate | Static/SPA | <DocButton href="/en/documentation/guides/application-development/frameworks/nextjs-static-boilerplate/" label="Learn more" kind="secondary" size="medium" /> |
| Cosmic Next Blog | Blog | <DocButton href="/en/documentation/marketplace/" label="Learn more" kind="secondary" size="medium" /> |
| Cosmic Agency | Agency/Starter | <DocButton href="/en/documentation/marketplace/" label="Learn more" kind="secondary" size="medium" /> |
| Space Jelly Shop | E-commerce | <DocButton href="/en/documentation/marketplace/" label="Learn more" kind="secondary" size="medium" /> |
| Nextal | Starter | <DocButton href="/en/documentation/marketplace/" label="Learn more" kind="secondary" size="medium" /> |
...
- [If you chose to have a local development server running](/en/documentation/devtools/runtime/frameworks/nextjs/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/devtools/runtime/frameworks/nextjs/#answering-no-to-local-dev).
...
You can use the Azion CLI to deploy a project compatible with our [available frameworks](/en/documentation/devtools/runtime/frameworks/frameworks-compatibility/).
