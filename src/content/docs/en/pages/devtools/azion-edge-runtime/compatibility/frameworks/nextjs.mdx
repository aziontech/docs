...
Next.js also allows for Server Side Rendering (SSR) on the Azion Web Platform, for more information about Next.js compatibility visit [click here](/en/documentation/devtools/azion-edge-runtime/compatibility/nextjs/)
