...
|:-------------|:---------|:-----|
| Next.js Static Boilerplate 14 | Static/SPA | <LinkButton link="#" label="Deploy" severity="secondary" /> |
| Next.js Static Boilerplate 13 | Static/SPA | <LinkButton link="#" label="Deploy" severity="secondary" /> |
| Next.js Store Ecommerce Template | E-commerce | <LinkButton link="#" label="Deploy" severity="secondary" /> |
| Next.js Faststore Boilerplate | E-commerce | <LinkButton link="#" label="Deploy" severity="secondary" /> |
| Next.js App 13.5.9 Middleware | Middleware Example | <LinkButton link="#" label="Deploy" severity="secondary" /> |
| Next.js App 13.5.9 Config | Config Example | <LinkButton link="#" label="Deploy" severity="secondary" /> |
| Next.js Pages 13.5.9 Config | Config Example | <LinkButton link="#" label="Deploy" severity="secondary" /> |
| Next.js Pages 13.5.9 Middleware | Middleware Example | <LinkButton link="#" label="Deploy" severity="secondary" /> |
| Node Pages 12.3.5 | Node Example | <LinkButton link="#" label="Deploy" severity="secondary" /> |
| Kupingplug | E-commerce | <LinkButton link="https://console.azion.com/create/azion-community/kupingplug" label="Deploy" severity="secondary" /> |
| Next.js Ecommerce Stationary | E-commerce | <LinkButton link="https://console.azion.com/create/azion-community/ecommerce-stationery-next" label="Deploy" severity="secondary" /> |
| Cosmic Next Blog | Blog | <LinkButton link="#" label="Deploy" severity="secondary" /> |
| Cosmic Agency | Agency/Starter | <LinkButton link="#" label="Deploy" severity="secondary" /> |
| Space Jelly Shop | E-commerce | <LinkButton link="https://console.azion.com/create/azion-community/space-jelly-shop" label="Deploy" severity="secondary" /> |
| Next.js Store React | E-commerce | <LinkButton link="#" label="Deploy" severity="secondary" /> |
