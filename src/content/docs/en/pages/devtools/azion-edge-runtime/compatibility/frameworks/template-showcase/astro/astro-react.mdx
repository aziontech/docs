...
<div class="[&_.flex.flex-col]:!gap-4 [&_.flex.flex-col]:md:!gap-8 [&_.flex.flex-col]:2xl:!gap-16">
  <SectionBasicContent
    ...
    buttons={[
      ...
      { label: "View demo", link: "https://flrfded7id.map.azionedge.net/", severity: "secondary", target:"_blank" }
    ]}
  />
</div>
...
<div style="display: flex; gap: 1rem; align-items: center; flex-direction: row; flex-wrap: wrap;">
  ...
  <div style="display: flex; justify-content: center; align-items: center; flex: 1; min-width: 300px;">
    <img src="/assets/docs/images/uploads/template-showcase/astro/astro-react.png" width="400" alt="Astro with React" style="max-width: 100%; height: auto;" />
  </div>
</div>
