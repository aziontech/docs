...
<div class="[&_.flex.flex-col]:!gap-4 [&_.flex.flex-col]:md:!gap-8 [&_.flex.flex-col]:2xl:!gap-16">
  <HeroHome
    ...
    description="The Astro with React Framework template deploys a new edge application based on Astro working with React. Using this template, you can write your React components as .jsx or .tsx files in your project."
    logos={[]}
    buttons={[
