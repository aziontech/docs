...
Eleventy is a simple static site generator, which allows you to write using your favorite template language. It's highly flexible and doesn't dictate how you should structure your project. It's a popular choice for developers who want to have full control over their project structure and workflow.

Learn more about [Eleventy](https://www.11ty.dev/docs/).

Implementation:

- [Azion Console Eleventy boilerplate](/en/documentation/products/guides/gatsby-boilerplate/)
