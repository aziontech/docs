...
description: >-
  Explore how Vulcan integrates with JavaScript frameworks like Next.js, React,
...
meta_tags: >-
  Azion, Edge Computing, Vulcan framework, JavaScript frameworks, Next.js,
...
<LinkButton link="https://github.com/aziontech/vulcan/" label="go to a compute mode project example" severity="secondary" target="_blank" />
