...
- [Azion CLI on how to build with Next.js](/en/documentation/products/cli/frameworks/next/)
...
- [Nuxt Content template](/en/documentation/products/guides/nuxt-content/)
