...
<LinkButton link="https://github.com/aziontech/vulcan/tree/main/examples/next/node-pages-12-3-1" label="go to a compute mode project example" severity="secondary" target="_blank" />
