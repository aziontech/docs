...
description: Explore how Vulcan integrates with JavaScript frameworks like Next.js,
  React, Vue on Azion Edge Runtime, enhancing web development and performance.
permalink: /documentation/products/devtools/azion-edge-runtime/frameworks-compatibility/
meta_tags: Azion, Edge Computing, Vulcan framework, JavaScript frameworks, Next.js,
