---
title: Compatibilidade com Frameworks | <i class='ai ai-react'></i> React
description: >-
    Explore como o Azion Bundler se integra com o React, uma biblioteca JavaScript que utiliza componentes para elementos de interface de usuário (UI).
...
| Template name | Use case | Details |
|:-------------|:---------|:-----|
| Space Jelly Shop| E-commerce | <LinkButton link="/en/documentation/products/templates/gatsby-boilerplate/" label="Learn more" severity="secondary" /> |
| Cosmic Agency | Startert | <LinkButton link="/en/documentation/products/templates/gatsby-boilerplate/" label="Learn more" severity="secondary" /> |
| NextJs Store with React | E-commerce | <LinkButton link="/en/documentation/products/templates/gatsby-boilerplate/" label="Learn more" severity="secondary" /> |
