...
| Cosmic Agency | Startert | <LinkButton link="/en/documentation/products/templates/cosmic-agency/" label="Learn more" severity="secondary" /> |
| NextJs Store with React | E-commerce | <LinkButton link="/en/documentation/products/templates/nextjs-store/" label="Learn more" severity="secondary" /> |
