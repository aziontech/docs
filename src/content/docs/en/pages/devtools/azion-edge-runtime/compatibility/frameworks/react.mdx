...
|:-------------|:---------|:-----|
| ButterCMS + React Starter Project | Starter | <Button href="/en/documentation/products/templates/react-buttercms/" label="Learn more" type="primary" theme="light" /> |
| React Boilerplate | Starter project | <Button href="/en/documentation/products/templates/react-boilerplate/" label="Learn more" type="primary" theme="light" /> |
...
| Cosmic Agency | Starter | <Button href="/en/documentation/products/templates/cosmic-agency/" label="Learn more" type="primary" theme="light" /> |
| Next.js Store with React | E-commerce | <Button href="/en/documentation/products/templates/nextjs-store/" label="Learn more" type="primary" theme="light" /> |
| Astro with React | Starter | <Button href="/en/documentation/products/templates/astro-react/" label="Learn more" type="primary" theme="light" /> |
| Astro With Multiple Frameworks | Starter | <Button href="/en/documentation/products/templates/astro-multiple-frameworks/" label="Learn more" type="primary" theme="light" /> |
