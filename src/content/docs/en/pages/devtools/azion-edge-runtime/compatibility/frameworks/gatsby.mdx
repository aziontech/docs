...
|:-------------|:---------|:-----|
| ButterCMS + Gatsby Starter Project | E-commerce | <Button href="/en/documentation/products/templates/gatsby-butter-starter/" label="Learn more" type="primary" theme="light" /> |
| Gatsby Blog Starter Kit| Starter project | <Button href="/en/documentation/products/templates/gatsby-blog/" label="Learn more" type="primary" theme="light" /> |
| Gatsby Ecommerce Theme | Blog creation | <Button href="/en/documentation/products/templates/gatsby-ecommerce/" label="Learn more" type="primary" theme="light" /> |
| Gatsby Boilerplate| E-commerce platform | <Button href="/en/documentation/products/templates/gatsby-boilerplate/" label="Learn more" type="primary" theme="light" /> |
