...
|:-------------|:---------|:-----|
| ButterCMS + Gatsby Starter Project | E-commerce | <DocButton href="/en/documentation/products/templates/gatsby-butter-starter/" label="Learn more" kind="secondary" size="medium" /> |
| Gatsby Blog Starter Kit| Starter project | <DocButton href="/en/documentation/products/templates/gatsby-blog/" label="Learn more" kind="secondary" size="medium" /> |
| Gatsby Ecommerce Theme | Blog creation | <DocButton href="/en/documentation/products/templates/gatsby-ecommerce/" label="Learn more" kind="secondary" size="medium" /> |
| Gatsby Boilerplate| E-commerce platform | <DocButton href="/en/documentation/products/templates/gatsby-boilerplate/" label="Learn more" kind="secondary" size="medium" /> |
