...
Azion supports some frameworks. This support is upheld by an open-source framework adapter called [Vulcan](https://github.com/aziontech/vulcan), which automates polyfills for edge computing.
