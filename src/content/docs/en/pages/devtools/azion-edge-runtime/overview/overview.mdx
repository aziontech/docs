---
title: Azion Runtime
description: The Azion Runtime is a set of tools for developing applications at the Edge. The Azion Runtime allows you to write JavaScript edge functions built on Web standards. Edge functions help you to implement the business logic and create serverless applications, at the edge of the network, closer to users.
