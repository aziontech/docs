...
<br />
<LinkButton link="/en/documentation/products/devtools/azion-edge-runtime/frameworks-compatibility/" label="go to supported frameworks reference" outlined target="_blank" />
<LinkButton link="/en/documentation/products/edge-application/edge-functions/runtime-apis/javascript/" label="go to supported Web APIs reference" outlined target="_blank" />
