...
description: Explore edge computing with JavaScript examples on using args and event handling for web development, including async functions and JSON parameters.
permalink: /documentation/products/edge-application/edge-functions/javascript-examples/using-args
meta_tags: edge computing, javascript, edge functions, args, event handling, code examples, web development, async functions, HTTP headers, JSON parameters
