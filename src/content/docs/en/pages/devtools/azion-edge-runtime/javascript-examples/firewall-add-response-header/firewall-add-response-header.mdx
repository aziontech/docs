...
<ItemList>
  ...
  <DocItem title="Scope and limits" href="/en/documentation/build/functions/#scope-and-limits">The languages, runtime, and execution contexts a function is written against.</DocItem>
</ItemList>
</FrameBox>
