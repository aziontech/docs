...
description: >-
  ...
  application responses using Edge Functions and JavaScript.
permalink: >-
  /documentation/products/edge-application/edge-functions/javascript-examples/adding-response-header
meta_tags: >-
  Edge Computing, JavaScript, Edge Functions, GeoIP Country Code, Response
