...
description: Learn how to handle URL redirects using JavaScript with Edge Functions,
  ideal for site maintenance or downtime strategies.
permalink: documentation/products/edge-application/edge-functions/javascript-examples/redirect-requests
meta_tags: Edge Functions, JavaScript, URL redirection, HTTP 301, maintenance workflow,
  downtime strategy, web development, URL forwarding, redirect handler, serverless
  architecture
