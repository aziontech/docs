...
description: Learn how to manage geographic restrictions in edge computing using JavaScript
  to access geoip country codes and control content accessibility through a dynamic
  firewall.
permalink: documentation/products/edge-application/edge-functions/javascript-examples/deny-request
meta_tags: edge computing, JavaScript, edge functions, geographic restrictions, geoip
  country code, web security, content accessibility, firewall integration, event handling,
  async JavaScript
