...
Whenever the installation code is run for any device and it has been authenticated by the Token, the edge nodes will be listed in [Real-Time Manager (RTM)](https://console.azion.com/).

To view the list of edge nodes created for your account, follow the steps below:

1. [Go to RTM](https://console.azion.com/).
...
1. Open the list of **Edge Nodes** [in RTM](https://console.azion.com/).
