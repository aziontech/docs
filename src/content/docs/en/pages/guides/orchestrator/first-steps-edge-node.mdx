...
1. Generate a credential to run the actions:
   ...
   > To generate the credential required to authenticate your edge nodes, follow the steps in the [credentials documentation](/en/documentation/products/deploy/credentials/).
...
Whenever the installation code is run for any device and it has been authenticated by the Token, the edge nodes will be listed in [Azion Console](https://console.azion.com/).
...
Watch a video tutorial to work with Azion Edge Node on Azion’s YouTube channel:
