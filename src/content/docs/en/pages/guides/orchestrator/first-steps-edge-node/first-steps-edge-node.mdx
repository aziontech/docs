...
> **Note**: The commands executed in the edge-orchestrator agent, must be executed with root user privileges. So it might be necessary to run the commands with sudo.
