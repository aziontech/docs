...
:::tip
Check the guide on [How to build an API with Edge Functions and ChatGPT](https://www.azion.com/en/documentation/products/guides/edge-functions/api-builder/) for an example of a function you can run in your application. 
:::
...
5. In the **Behaviors** section, choose **Run Function**, then select the *Hello World function* and click **Save**. 
