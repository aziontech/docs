...
| **Platform TLS** | API-driven TLS certificate and key management. | [Certificate Manager](https://www.azion.com/en/documentation/products/build/applications/certificate-manager/) + [Azion API](https://www.azion.com/en/documentation/products/developer/api/) |
...
| **Fastly API** | Programmatic management of Fastly resources. | [Azion API](https://www.azion.com/en/documentation/products/developer/api/) |
