...
| **Certainly** | Fastly certificate authority for TLS certificates. | [Certificate Manager](https://www.azion.com/en/documentation/products/build/applications/certificate-manager/) |
| **Platform TLS** | API-driven TLS certificate and key management. | [Certificate Manager](https://www.azion.com/en/documentation/products/build/applications/certificate-manager/) + [Azion API](https://www.azion.com/en/documentation/products/overview-azion-api/) |
| **TLS Service Options** | TLS configuration for serving sites and applications over HTTPS. | [Certificate Manager](https://www.azion.com/en/documentation/products/build/applications/certificate-manager/) + [Workloads](https://www.azion.com/en/documentation/products/secure/workloads/) |
