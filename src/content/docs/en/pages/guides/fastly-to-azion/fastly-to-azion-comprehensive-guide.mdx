...
permalink: /documentation/guides/platform/migration/fastly-migration-guide/
---
...
| :------------------------ | :---------- | :--------------- |
| **Full-Site Delivery** | Website, application, API, and mobile delivery through Fastly services. | [Applications](https://www.azion.com/en/documentation/platform/applications/) |
| **Fastly services** | Main delivery resource for domains, origins, caching, request handling, and service versions. | [Applications](https://www.azion.com/en/documentation/platform/applications/) + [Workloads](https://www.azion.com/en/documentation/platform/workloads/) |
| **Domains** | Hostnames associated with Fastly services. | [Workloads](https://www.azion.com/en/documentation/platform/workloads/) |
| **Hosts and origins** | Backend origin configuration for Fastly delivery services. | [Connectors](https://www.azion.com/en/documentation/platform/connectors/) |
| **Origin Shield / shielding patterns** | Reduce origin traffic by routing cache misses through an intermediate shield location. | [Origin Shield](https://www.azion.com/en/documentation/secure/origin-shield/) + [Tiered Cache](https://www.azion.com/en/documentation/build/cache/tiered-cache/) |
| **Conditions** | Request, cache, and response conditions in Fastly service configuration. | [Rules Engine for Applications](https://www.azion.com/en/documentation/platform/applications/rules-engine/) |
| **Request settings** | Request manipulation, forwarding, and handling behavior. | [Rules Engine for Applications](https://www.azion.com/en/documentation/platform/applications/rules-engine/) + [Functions](https://www.azion.com/en/documentation/build/functions/) |
| **Response settings** | Response header and delivery behavior. | [Rules Engine for Applications](https://www.azion.com/en/documentation/platform/applications/rules-engine/) |
| **VCL snippets / custom VCL** | Custom delivery logic for redirects, headers, cache keys, origin selection, and request control. | [Rules Engine for Applications](https://www.azion.com/en/documentation/platform/applications/rules-engine/) + [Functions](https://www.azion.com/en/documentation/build/functions/) |
| **Compute** | Serverless compute platform that runs custom code on Fastly's network. | [Functions for Applications](https://www.azion.com/en/documentation/build/functions/) |
| **Compute packages** | Packaged application code deployed to Fastly Compute. | [Functions](https://www.azion.com/en/documentation/build/functions/) + [Azion CLI](https://www.azion.com/en/documentation/devtools/cli/) |
| **Edge Data Storage** | Key-value data used by Fastly Compute services. | [KV Store](https://www.azion.com/en/documentation/store/kv-store/) |
| **Object Storage** | S3-compatible object storage integrated with delivery and compute services. | [Object Storage](https://www.azion.com/en/documentation/store/object-storage/) |
| **Cache Reservation** | Reserved cache capacity for content on Fastly. | [Cache](https://www.azion.com/en/documentation/build/cache/) + [Tiered Cache](https://www.azion.com/en/documentation/build/cache/tiered-cache/) |
| **Cache APIs** | Programmatic cache interaction patterns for Compute applications. | [Functions](https://www.azion.com/en/documentation/build/functions/) + [Cache](https://www.azion.com/en/documentation/build/cache/) + [Real-Time Purge](https://www.azion.com/en/documentation/build/cache/real-time-purge/) |
| **Streaming Delivery** | Delivery of live and video-on-demand streaming content. | [Applications](https://www.azion.com/en/documentation/platform/applications/) + [Cache](https://www.azion.com/en/documentation/build/cache/) + [Object Storage](https://www.azion.com/en/documentation/store/object-storage/) |
| **Media Shield for Live** | Reduces origin traffic for live video workflows. | [Tiered Cache](https://www.azion.com/en/documentation/build/cache/tiered-cache/) + [Origin Shield](https://www.azion.com/en/documentation/secure/origin-shield/) |
| **Media Shield for VOD** | Reduces origin traffic for video-on-demand workflows. | [Tiered Cache](https://www.azion.com/en/documentation/build/cache/tiered-cache/) + [Origin Shield](https://www.azion.com/en/documentation/secure/origin-shield/) |
| **Image Optimizer** | Real-time image transformation and optimization service. | [Image Processor](https://www.azion.com/en/documentation/build/image-processor/) |
| **WebSockets** | Long-lived, bidirectional communication for real-time applications. | [WebSocket Proxy](https://www.azion.com/en/documentation/platform/applications/websocket/) + [WebSocket API](https://www.azion.com/en/documentation/devtools/runtime/api-reference/websocket/) |
| **Fanout** | Publish-subscribe messaging patterns on Fastly. | [Functions](https://www.azion.com/en/documentation/build/functions/) + [WebSocket Proxy](https://www.azion.com/en/documentation/platform/applications/websocket/) |
| **AI Accelerator** | Semantic caching and traffic acceleration for generative AI APIs. | [AI Inference](https://www.azion.com/en/documentation/build/ai-inference/) + [Cache](https://www.azion.com/en/documentation/build/cache/) |
| **Fastly Next-Gen WAF** | Web application firewall for suspicious traffic detection and application protection. | [Web Application Firewall](https://www.azion.com/en/documentation/secure/waf/) |
| **Edge Rate Limiting** | Count requests and apply actions when limits are exceeded. | [Rules Engine for Firewall](https://www.azion.com/en/documentation/platform/firewall/rules-engine/) + [Functions for Firewall](https://www.azion.com/en/documentation/platform/firewall/functions/) |
| **Fastly DDoS Protection** | DDoS visibility and mitigation. | [DDoS Protection](https://www.azion.com/en/documentation/platform/ddos-protection/) + [Network Shield](https://www.azion.com/en/documentation/secure/network-shield/) |
| **Bot Management** | Detect and respond to automated traffic. | [Bot Manager](https://www.azion.com/en/documentation/secure/bot-manager/) + [Bot Manager Lite](https://www.azion.com/en/documentation/secure/bot-manager/bot-manager-lite/) |
| **Certainly** | Fastly certificate authority for TLS certificates. | [Certificate Manager](https://www.azion.com/en/documentation/platform/certificate-manager/for-firewall/) |
| **Platform TLS** | API-driven TLS certificate and key management. | [Certificate Manager](https://www.azion.com/en/documentation/platform/certificate-manager/for-firewall/) + [Azion API](https://www.azion.com/en/documentation/devtools/api/) |
| **TLS Service Options** | TLS configuration for serving sites and applications over HTTPS. | [Certificate Manager](https://www.azion.com/en/documentation/platform/certificate-manager/for-firewall/) + [Workloads](https://www.azion.com/en/documentation/platform/workloads/) |
| **High Volume Logging** | Real-time log streaming to external destinations. | [Data Stream](https://www.azion.com/en/documentation/observe/data-stream/) |
| **Log Explorer & Insights** | Inspect and monitor log data on the Fastly platform. | [Real-Time Events](https://www.azion.com/en/documentation/observe/real-time-events/) |
| **Domain Inspector** | Domain-level traffic visibility and reporting. | [Real-Time Metrics](https://www.azion.com/en/documentation/platform/real-time-metrics/) |
| **Origin Inspector** | Origin response visibility and reporting. | [Real-Time Metrics](https://www.azion.com/en/documentation/platform/real-time-metrics/) + [Real-Time Events](https://www.azion.com/en/documentation/observe/real-time-events/) |
| **Observability features** | Traffic, security, performance, and origin visibility. | [Real-Time Metrics](https://www.azion.com/en/documentation/platform/real-time-metrics/) + [Real-Time Events](https://www.azion.com/en/documentation/observe/real-time-events/) + [Data Stream](https://www.azion.com/en/documentation/observe/data-stream/) |
| **Fastly API** | Programmatic management of Fastly resources. | [Azion API](https://www.azion.com/en/documentation/devtools/api/) |
| **Fastly CLI** | Command-line workflow for Fastly services and Compute projects. | [Azion CLI](https://www.azion.com/en/documentation/devtools/cli/) |
| **Fastly Terraform Provider** | Infrastructure as Code for Fastly resources. | [Terraform Provider](https://www.azion.com/en/documentation/devtools/terraform/) |
...
* [WebSocket Proxy](https://www.azion.com/en/documentation/platform/applications/websocket/)
* [WebSocket API](https://www.azion.com/en/documentation/devtools/runtime/api-reference/websocket/)
* [Tiered Cache](https://www.azion.com/en/documentation/build/cache/tiered-cache/)
* [Origin Shield](https://www.azion.com/en/documentation/secure/origin-shield/)
