...
description: >-
  During the [Transition to API v4]() you might see some pages with different versions for v3 and v4. This guide helps you verify if your accoount has already beed migrated to v4.
...
During the [Transition to API v4](/en/documentation/products/api-v4-migration/) you might see some pages with different versions for v3 and v4. This guide helps you verify if your accoount has already beed migrated to v4.
