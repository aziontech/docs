...
You have now created a rule for non-complex request sharing with CORS.
...
To enable CORS within a configuration for specific origin servers, you will need to enable the [Application Acceleration](/en/documentation/products/edge-application/application-acceleration/) module:
