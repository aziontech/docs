...
permalink: /documentation/guides/application-development/automation/run-mcp-server/
---
...
In this guide we will create an [Function](/en/documentation/build/functions/) to run a MCP server.
