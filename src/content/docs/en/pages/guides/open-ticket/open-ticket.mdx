...
permalink: /documentation/guides/platform/account-and-billing/open-tickets/
---
...
1. Access [Support Center](https://tickets.azion.com/en/support/login).
   - Alternatively, log in to [Azion Console](https://console.azion.com) and click **Help** > **Contact Support**.
