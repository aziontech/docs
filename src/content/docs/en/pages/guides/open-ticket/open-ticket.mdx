...
| Type* | Select the reason for opening the ticket:<br /><br />• **Incident:** to report an incident.<br />• **Question:** to clarify your question.<br />• **Request:** to make a specific request; for example, request a new integration or feature. |
