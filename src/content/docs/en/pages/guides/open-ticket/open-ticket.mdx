...
1. Access [Support Center](https://tickets.azion.com/) or log in to [Azion Console](https://console.azion.com/) and on the header, click on the Help Center icon **(?)** > select the **Contact Support** option.
