...
<Button href="/en/documentation/products/edge-application/image-processor/" variant="secondary" text="Go to Image Processor documentation"></Button>
...
To activate this module and start processing your images, you must have:

- An [Azion account](link_accounts).
- An [edge application](link_build_with_edge_app).
- An [Azion domain](link_config_domain).

You can optimize your images through the [Real-Time Manager (RTM)](#via-rtm) or the [Azion API](#via-api).
