...
5. Run the following `POST` request to create a rule in the **Request Phase**, replacing the edge application ID value with the value you received in the previous response:
