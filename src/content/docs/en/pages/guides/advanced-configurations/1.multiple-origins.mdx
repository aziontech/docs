...
Azion Edge Application requires at least one origin. However, more complex and robust infrastructures might need multiple origin configurations for the same application. The **Load Balancer** module allows you to use load balancing algorithms to manage high access numbers and control your origin behaviors.
...
To create a load balancer origin for your edge application, you must have:
...
In this scenario, the following business rules of different origin servers must be configured with load balancing:
