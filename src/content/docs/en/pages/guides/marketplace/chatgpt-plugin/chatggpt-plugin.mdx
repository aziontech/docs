---
title: How to create a custom plugin with Acceleration ChatGPT Plugin
description: With Acceleration ChatGPT Plugin, you can implement the default setup or customize new plugins according to your needs.
meta_tags: templates, guides, Azion Marketplace
namespace: docs_guides_acceleration_chatgpt_plugin
permalink: /documentation/products/guides/acceleration-chatgpt-plugin/
---
...
**Acceleration ChatGPT Plugin** is a template designed by Azion to enable the creation of ChatGPT plugins quickly and simply. With this template, you can implement the default setup (to complete a search within the GitHub repositories of an account) or customize new plugins according to your needs. 
...
2. Generate your GitHub personal token, as explained in the [Creating a personal access token documentation](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens#creating-a-personal-access-token-classic).

---

## Getting the template

The Acceleration ChatGPT Plugin template is available at Azion Marketplace.

To start using this template, follow the steps:
...
3. Find the **Acceleration ChatGPT Plugin** card and select it.
...
In the configuration form, you must provide the information to configure your Azion application and others. Fill in the presented fields. 
...
- **Edge function creation**: an edge function is created and it provides the arguments for the template, including routes to the plugin and OpenAPI settings.
- **GitHub repository creation**: a new repository is created in your GitHub account based on a [public template](https://github.com/aziontech/).
...
:::caution[Warning]
You need to activate this product separately via RTM. Review the [Azion documentation](https://www.azion.com/en/documentation/products/edge-application/edge-functions/).
...
The default setup of this template completes a search within the GitHub repositories of an given account. If you want to maintain this configuration, skip to the [Registering your plugin](#registering-your-plugin) section.
...
1. Access your Acceleration ChatGPT Plugin repository on GitHub.
...
```
5. Add your **Azion Personal Token** to the repository's *Secrets*. Read more about [getting an Azion Personal Token](https://www.azion.com/en/documentation/products/accounts/personal-tokens/).
...
:::note
This template also includes an automation for continuous deployment in the **github/workflows/main.yml** file.
:::
...
:::tip
Read the documentation about [managing edge applications](https://www.azion.com/en/documentation/products/getting-started/#settings-app) for more details. For specific ChatGPT-related questions, check the [OpenAI documentation](https://platform.openai.com/docs/introduction).
:::
