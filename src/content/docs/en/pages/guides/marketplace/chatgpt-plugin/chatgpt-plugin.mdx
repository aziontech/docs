...
:::tip
Read the documentation about [managing edge applications](/en/documentation/products/getting-started/#step-2-managing-edge-applications) for more details. For specific ChatGPT-related questions, check the [OpenAI documentation](https://platform.openai.com/docs/introduction).
:::
...
2. Add the ChatGPT Plugin details:
