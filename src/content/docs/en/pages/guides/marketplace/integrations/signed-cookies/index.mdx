...
4. On the integration's page, click the **Get It Now** button to install it.
...
4. Still under the **Modules** section, locate the **Application Acceleration** switch and turn it on to enable the **Forward Cookies** functionality for your application.
...
5. On the *behavior* field, select **Run Function** from the dropdown menu.
6. Select the **Signed Cookies - Hash Generator** function, according to the name you gave it in the instantiation step.
...
4. Pass the *criteria* you need to in order to run your integration.
5. On the *behavior* field, select **Run Function** from the dropdown menu.
6. Select the **Signed Cookies - Hash Validator** function, according to the name you gave it in the instantiation step.
    - You'll also need a *second behavior* for the **Signed Cookies - Hash Validator** function: **Forward Cookies**. 
7. To add it, click the **+** button and select the **Forward Cookies** option from the dropdown menu.
