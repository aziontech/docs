...
permalink: /documentation/guides/application-development/integrations/limit-payload-size/
---
...
To finish, you have to set up the [Rules Engine](/en/documentation/platform/firewall/rules-engine/) to configure the *behavior* and the *criteria* to run the function.
