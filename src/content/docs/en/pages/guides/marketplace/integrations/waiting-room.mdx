...
| `ttl_wait` | Yes | Maximum time, in seconds, a client can remain inactive in the waiting room (for example, by closing the tab/window of the site) without losing their place. Example: `180` |
