...
5. In the **Arguments** box, you'll pass your variables:
...
| `api_key` | Yes | API Key of your Axur account. |
...
5. In the **Args** tab, you'll pass your variables:
...
Done. Now the **Upstash Cardstream** integration is running.
</Fragment>
