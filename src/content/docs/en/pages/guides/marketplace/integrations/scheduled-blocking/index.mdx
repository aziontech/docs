...
By clicking the **Code** tab, you'll be able to navigate through the source code but not to change it. In the same box, there's the **Args** tab, which is where you'll pass the parameters you want to use with your integration.
...
:::note
For `static_response` parameter in `action`, you can define the status code that will be used in the response, as well as set a custom HTML page that will be delivered to your users.
:::
