...
permalink: /documentation/guides/application-development/integrations/liveness-detection/
---

:::caution[Deprecated]
The **Liveness Detection** integration has been removed from Azion Marketplace and is no longer available for new installations. This documentation is maintained for customers who have already installed the integration. It will be removed from the documentation in approximately 6 months.
:::
...
- **[Real-Time Events](/en/documentation/observe/real-time-events/)**: Access the **Functions** tab to inspect individual request logs and function responses.
