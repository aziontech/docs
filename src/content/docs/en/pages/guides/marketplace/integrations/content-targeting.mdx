...
The **Content Targeting** integration is available at the Azion Marketplace. This integration can be accessed through [Real-Time Manager (RTM)](https://manager.azion.com/) by selecting **Products menu**, represented by the three horizontal lines on the upper-left corner, and then **Marketplace**.

> In order to access RTM, you must have an Azion account. If you don't have one, [visit the sign-up page](https://manager.azion.com/signup).
