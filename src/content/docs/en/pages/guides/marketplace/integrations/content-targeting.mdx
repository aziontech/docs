...
You can see how to instantiate and configure the Content Targeting integration by visiting the [How to install the Content Targeting integration through Azion Marketplace](/en/documentation/products/guides/content_target_mktp/) guide on the documentation page.
