...
You can use [Data Streaming](/en/documentation/products/observe/data-streaming/) and [Real-Time Events](/en/documentation/products/observe/real-time-events/) to get the **Bot Manager** logs and monitor the bot activity in your applications.
