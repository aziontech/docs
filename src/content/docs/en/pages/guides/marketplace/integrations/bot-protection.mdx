...
You can use [Azion Data Streaming](/en/documentation/products/observe/data-streaming/) and [Azion Real-Time Events](/en/documentation/products/observe/real-time-events/) to get the **Bot Manager** logs and monitor the bot activity in your applications.
...
To create a new streaming for Bot Manager activity:

1. Access [Azion Console](https://console.azion.com/) > **Data Streaming**.
2. Click the **Add** button.
...
:::tip
Check [Data Streaming First Steps](/en/documentation/products/observe/data-streaming/first-steps/) and [How to configure Data Streaming main settings](/en/documentation/products/guides/use-data-streaming/) for more details.
:::
