...
permalink: /documentation/products/build/edge-application/edge-functions/method-and-route-validator/
---
...
With this integration, you can define a list of routes and which method each route expects. Each time the function is executed, it will follow the following steps:
...
3. If the arguments are invalid, it will write a log message and continue the request.
