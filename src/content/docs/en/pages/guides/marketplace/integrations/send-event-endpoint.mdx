---
title: How to install the Send Event to Endpoint integration through Azion Marketplace
...
4. Select a *criteria* to run and catch the domain you want to run the integration on. For example: `if Hostname is equal xxxxxxxxxxxx.map.azionedge.net`.
5. Below, select a *behavior* to the *criteria*. In this case, it'll be **Run Function**. Then, select the adequate **Send Event to Endpoint** function according to the name you gave it in the instantiating step.
6. Click the **Save** button.
