---
title: How to install the Send messages to a queue integration through Azion Marketplace
description: Send messages to a queue is a integration to help you in messaging services and queues.
