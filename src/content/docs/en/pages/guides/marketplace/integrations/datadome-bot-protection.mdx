---
title: "Install DataDome Bot Protection"
description: >-
  DataDome Bot Protection is a Marketplace integration that detects and blocks automated threats in real time on your websites, applications, and APIs.
...
permalink: /documentation/guides/application-development/integrations/datadome-bot-protection/
---
...
4. Once the integration's page opens, select **Install**.
...
3. Give a descriptive name to your firewall.
...
:::caution[Warning]
Activating modules may generate usage-related costs. Check the [pricing page](/en/documentation/fundamentals/pricing/) for more details.
:::
...
3. Give a descriptive name to your instance.
...
3. Give a descriptive name to the rule.
...
5. Below, select **Run Function** as the *behavior*.
   - Select the DataDome Bot Protection function instance you created.
6. Select **Save**.

Now, configure your domain to be protected by this firewall:

7. Access **Workloads** in Azion Console.
8. Select the domain you want to protect.
9. In the **Settings** section, open the `Firewall` selector and choose the firewall you created.
10. Select **Save**.
...
- **[Real-Time Events](/en/documentation/observe/real-time-events/)**: Access the **Functions** tab to inspect individual request logs and DataDome responses.
- **[Data Stream](/en/documentation/observe/data-stream/)**: Create a stream using the **Functions Event Collector** template to forward logs to your preferred endpoint for long-term analysis.
