...
1. Access Real-Time Manager (RTM) and go to Marketplace.
...
A successful message appears. Your integration is installed.
...
For more information about how to use the Content Targeting integration, visit the Use Case at [Using cookies and logic from Edge Computing for content-targeting](/en/documentation/products/guides/content-targeting/).
