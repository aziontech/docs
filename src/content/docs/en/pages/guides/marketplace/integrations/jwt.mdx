...
permalink: /documentation/guides/application-development/integrations/jwt/
---
...
To finish, you have to set up the [Rules Engine](/en/documentation/platform/firewall/rules-engine/) to configure the behavior and the criteria to run the JWT.
...
:::tip
You can see a use case by visiting the [Setting up a paywall with Function JWT](/en/documentation/guides/application-development/functions-and-runtime/paywall-function-jwt/) page.
:::
