...
:::tip
You can see a use case by visiting the [Set up a paywall with the JWT function](/en/documentation/guides/application-development/functions-and-runtime/paywall-function-jwt/) page.
:::
