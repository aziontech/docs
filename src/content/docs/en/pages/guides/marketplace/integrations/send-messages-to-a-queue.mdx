...
permalink: /documentation/guides/application-development/integrations/send-messages-to-a-queue/
---
...
Being an [Application function](/en/documentation/marketplace/integrations/#edge-application-functions), **Send messages to a queue** runs on the edge *employing* an existing application.

:::tip
Go to the [building section](/en/documentation/guides/application-development/getting-started/build-an-application/) for more details on how to build an application.
:::
