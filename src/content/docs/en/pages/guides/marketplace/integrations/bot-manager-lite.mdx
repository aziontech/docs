...
<DocButton href="/en/documentation/products/secure/firewall/bot-manager-lite/#configuring-actions" label="See all configuring actions in the reference" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/products/guides/secure/manage-bots/" label="Go to the Manage Bots Guide" outlined size="medium" />
