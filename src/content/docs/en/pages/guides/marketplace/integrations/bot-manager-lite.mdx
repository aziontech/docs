...
4. Select a *criteria* to run and catch the workloads that you want to run the integration on.
...
Done. You now have your workloads protected against bot attacks by using Azion **Bot Manager Lite**.
...
6. On **Workloads**, select between **Filter Workloads** or **All Current and Future Workloads**.
