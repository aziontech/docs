...
:::caution[Warning]
If a product or module is activated, it could generate usage-related costs. Check the [pricing page](/en/documentation/fundamentals/pricing/) for more details.
:::
...
For a complete list of available arguments and their descriptions, see the [Bot Manager Lite reference](/en/documentation/secure/bot-manager/bot-manager-lite/#setting-up-the-function).
...
<DocButton href="/en/documentation/secure/bot-manager/bot-manager-lite/#configuring-actions" label="See all configuring actions in the reference" kind="secondary" size="medium" />

---

## Viewing logs

You can use [Data Stream](/en/documentation/observe/data-stream/) and [Real-Time Events](/en/documentation/observe/real-time-events/) to get the **Bot Manager Lite** logs and monitor the bot activity in your applications.

:::caution[Warning]
If a product or module is activated, it could generate usage-related costs. Check the [pricing page](/en/documentation/fundamentals/pricing/) for more information.
:::
...
7. Under **Destination**, select a **Connector** on the dropdown menu.
  - You'll see different fields depending on the endpoint type you choose. Find more information on each of them on the [Setting an endpoint page](/en/documentation/observe/data-stream/#endpoints).
8. Click the **Save** button.

Now, you can check the logs in the selected endpoint.

:::tip
Check [Data Stream First Steps](/en/documentation/observe/data-stream/first-steps/) and [How to configure Data Stream main settings](/en/documentation/guides/platform/observability/use-data-stream/) for more details.
:::
...
:::tip
Check [Real⁠-⁠Time Events first steps](/en/documentation/observe/real-time-events/first-steps/) and [How to understand Real⁠-⁠Time Events logs](/en/documentation/guides/platform/observability/understand-logs/) for more details.
:::
...
:::tip
Check [How to debug rules created with Rules Engine](/en/documentation/guides/application-development/getting-started/debug-rules/) for step-by-step instructions on querying `traceback` via Data Stream, Real-Time Events, and the GraphQL API.
:::

<DocButton href="/en/documentation/guides/application-security/bots-and-network/manage-bots/" label="Go to the Manage Bots Guide" outlined size="medium" />
