---
title: How to install the Request Variation Controller integration through Azion Marketplace
description: The Request Variation Controller integration is, in fact, two integrations that work together to protect your online assets.
...
4. Still on the application page, on the **Main Settings** tab, locate the **Application Accelerator** switch and turn it on to enable the *Forward Cookies* functionality for your application; this will be addressed at the [Rules Engine section](#rules-engine).
