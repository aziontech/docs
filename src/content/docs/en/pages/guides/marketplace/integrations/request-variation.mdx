...
permalink: /documentation/guides/application-development/integrations/request-variation-controller/
---
...
:::tip
To create an application, go to the [building](/en/documentation/guides/application-development/getting-started/build-an-application/) section.
:::
