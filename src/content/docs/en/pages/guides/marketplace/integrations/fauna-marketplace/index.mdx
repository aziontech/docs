...
3. An existant edge application on Azion.
...
1. Access [Real-Time Manager (RTM)](/en/documentation/products/guides/getting-to-know-real-time-manager/) and go to **Marketplace**.
...
This action will load the function, showing a form with the integration source code and, just above it, two tabs: **Code** and **Args**. By clicking the Code tab you will be able to navigate through the code, but won't be able to change it.
