...
description: In this document you'll learn how to use a Azion's Markletplace integration to redirect your domains.
...
2. Give an easy-to-remember name and, optionally, a description to your rule.
3. Set a criteria for checking your domain. You'll have something like `if: ${domain} is equal xpto.com`.
4. On the behavior section, on `Then`, select `Run a Function` from the dropdown menu and then select the Massive Redirect option according to the name you gave it. 
5. Click the **Save** button on the lower-right corner.
</Fragment>
