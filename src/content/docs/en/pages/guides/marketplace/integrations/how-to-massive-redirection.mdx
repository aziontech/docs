...
permalink: /documentation/guides/application-development/integrations/massive-redirect-integration/
---
...
:::tip
To create an applications, go to the [building](/en/documentation/guides/application-development/getting-started/build-an-application/) section.
:::
