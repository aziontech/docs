...
permalink: /documentation/guides/application-development/integrations/scheduled-blocking/
---
...
Finally, you must set up the [Rules Engine](/en/documentation/platform/firewall/rules-engine/) to configure the *behavior* and the *criteria* to run the function.
