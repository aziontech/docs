...
The edge function Massive Redirect is available on Azion Marketplace and can be accessed through [Azion Console](https://console.azion.com), on the **Products menu** on the upper-left corner, represented by three horizontal lines.
