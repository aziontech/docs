...
description: >-
  The Massive Redirect edge function is a serverless integration available at
  Azion Marketplace. It's designed to handle a large number of redirects and can
  be used when a large number of addresses need to be changed, for example, when
  migrating domains.
