...
Azion provides you with easy-to-go configurations, that should be enough for most of the cases. If you need a more detailed configuration, such as custom rules, you can edit the `JSON` file for the integration.
...
If you've already install the Fingerprint integration, Bot Protection will automatically use any generated fingerprints. To do so, the Fingerprint function must have been exectuted before the Bot Protection function.
