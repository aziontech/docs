...
A successful message appears to confirm that your integration has been installed.
...
Even when `threshold` and `action` are mandatory variables, you can add and define more variables, according to your needs, as shown in the example below that includes [integration with a SIEM](#integrating-with-a-siem).
...
Azion **Bot Protection** is able to execute **5 different actions** whenever the request's score is greater than or equals the defined threshold:
