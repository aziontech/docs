...
This action will load the function, showing a form with the function code and, just above it, two tabs: **Code** and **Arguments**. By clicking the **Code** tab, you’ll be able to navigate through the code but not change it. On the **Arguments** tab, you’ll pass your variables.
