...
To finish, you have to set up the [Rules Engine](/en/documentation/products/build/edge-application/rules-engine/) to configure the *behavior* and the *criteria* to run the integration.
