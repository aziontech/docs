...
permalink: /documentation/guides/application-development/integrations/process-request-data-into-headers/
---
...
To finish, you have to set up the [Rules Engine](/en/documentation/platform/firewall/rules-engine/) to configure the *behavior* and the *criteria* to run the integration.
