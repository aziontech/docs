...
To finish, you have to set up the [Rules Engine](/en/documentation/products/edge-application/rules-engine/) to configure the *behavior* and the *criteria* to run the integration.
