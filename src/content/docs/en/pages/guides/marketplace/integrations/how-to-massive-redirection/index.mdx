...
:::note
You have to observe the limit of 300kb for the JSON file.
:::
...
:::tip
To create an edge application, go to the [building](/en/documentation/products/guides/build/build-an-application/) section for more details.
:::
