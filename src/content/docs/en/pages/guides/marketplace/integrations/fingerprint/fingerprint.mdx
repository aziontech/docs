...
The browser script is a JavaScript code that runs in the web page you want to fingerprint, a process also know as JavaScript injection. It captures multiple data from the web browser:
