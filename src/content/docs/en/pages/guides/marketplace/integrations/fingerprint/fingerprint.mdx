...
Azion **Fingerprint** enables you to capture session data to better identify devices accessing your applications. It can be classified as a *Session Fingerprinting* and captures some browser-related data, alongside connection data, to generate a unique identifier and add it as a request header.
