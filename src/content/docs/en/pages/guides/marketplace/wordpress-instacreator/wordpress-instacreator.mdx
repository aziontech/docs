...
The WordPress InstaCreator template is available at [Azion Marketplace](/en/documentation/products/marketplace/).
...
2. On the top right corner, open the **Account menu**.
3. Select **Billing & Subscriptions**.
4. Click the **Subscriptions** tab.
5. Active the switch for the product you want to enable on your account.
