...
:::tip
Read the documentation about [managing edge applications](/en/documentation/products/getting-started/#step-2-managing-edge-applications) for more details. For specific WordPress-related questions, check [WordPress official](https://wordpress.com/) channels.
:::
