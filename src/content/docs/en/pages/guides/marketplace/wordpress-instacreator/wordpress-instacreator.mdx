...
It sets up an edge application and its domain, along with a pre-configured set of common cache rules, image file cache rules, static file cache rules, and bypass routes. These configurations optimize your website's performance.

This template employs WordPress and Amazon Web Services (AWS) infrastructure to implement the new project, as well as Azion Edge Platform to manage it and run it on the edge.

---

## Requirements
The WordPress InstaCreator template employs Amazon Web Services (AWS) infrastructure to work. To successfully create a project from scratch, you need to have an AWS account to generate or retrieve your **AWS Access Key ID** and **AWS Secret Access Key**.
...
<Badge>
[Edge Caching](https://www.azion.com/en/documentation/products/edge-application/edge-caching/)
</Badge>
<Badge>
[Image Processor](https://www.azion.com/en/documentation/products/edge-application/image-processor/)
</Badge>

:::caution[Warning]
You need to activate the products separately via RTM. Review the [Azion documentation](https://www.azion.com/en/documentation) to do so.
...
:::tip
Read the documentation about [managing edge applications](https://www.azion.com/en/documentation/products/getting-started/#settings-app) for more details. For specific WordPress-related questions, check [WordPress official](https://wordpress.com/) channels.
:::
...
<Button href="en/documentation/products/edge-application/domains/" text="Visit Domains page"> 
