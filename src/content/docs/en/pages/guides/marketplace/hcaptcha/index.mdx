...
Now your site configured to use the hCaptcha solution.

To configure our Azion's solution, you now have to get the site-key from hCaptcha. Still in the hCaptcha site, follow these steps:
...
3. Hover the string and click to copy your site key.
4. Save the site key and the secret key to configure the Azion's solution as explained in the next sections.
