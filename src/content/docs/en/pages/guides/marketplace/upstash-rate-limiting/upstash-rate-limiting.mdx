...
1. Access [Real-Time Manager (RTM)](https://manager.azion.com/).
  - If you don’t have one yet, create an account [by visiting the sign-up page](https://manager.azion.com/signup/).
...
4. You'll be redirected to the **Edge Application** page.
- It lists all the edge applications you've created. 
5. Find the edge application by the name you defined during the template execution and select it. 
...
3. Open a pull request with the changes to the main branch and start the automatic deployment.
