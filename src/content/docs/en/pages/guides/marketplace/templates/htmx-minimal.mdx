...
The **HTMX Boilerplate** facilitates you to deploy and test a minimal example of the HTMX library in Azion Web Platform. The deployment of this template will create a new edge function, a new domain, and an edge application, including the function instance and a default rule to run the instance.
