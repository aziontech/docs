...
The WordPress EdgeAccelerator template is available at [Azion Marketplace](/en/documentation/products/marketplace/).
...
This template creates a new Azion edge application and domain, as well as defines some key configurations, including common cache rules, image file cache rules, static file cache rules, and bypass routes to optimize your WordPress website's performance.
