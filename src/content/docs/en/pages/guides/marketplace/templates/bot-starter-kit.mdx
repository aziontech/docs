...
Being a testing template, the initial configuration is mostly demonstrative. However, you can use it as a base for creating an actual functional application. You can [configure a new Connector](/en/documentation/products/secure/connectors/) for the application and use it as *Default Origin*. You can also modify the JSON Args of your **Bot Manager Lite** instance for a more customized configuration.
