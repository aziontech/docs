...
- **A new application**, with the Edge Functions module enabled, to instantiate your newly created function. The application will receive the requests that trigger the function.
