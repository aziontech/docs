...
1. Access [Real-Time Manager (RTM)](/en/documentation/products/guides/how-to-access-rtm/).
2. Select the **Start with a template** option on the homepage.
3. This will open a new page where you can select the **WordPress InstaCreator** card.
...
You must activate the modules separately via RTM. To do so:
