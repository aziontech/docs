...
permalink: /documentation/guides/application-development/frameworks/preact-typescript-boilerplate/
---
...
With the Azion **Preact TypeScript Boilerplate**, you can start a project using [Preact](https://preactjs.com/) and deploy it at the edge. **Preact** is a JavaScript library with the same API as React but optimized for speed and small bundle size.
...
This template uses Preact `10.25.3` and Vite `6.0.4` as its build tool.
