...
description: >-
  This template deploys a repository with a project based on Jekyll, a framework
  written in Ruby, that enables you to create static sites using Markdown and
  HTML files.
meta_tags: 'templates, guides, Azion Marketplace'
namespace: docs_guides_jekyll_boilerplate
permalink: /documentation/guides/application-development/frameworks/jekyll-boilerplate/
---
