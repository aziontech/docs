...
To get the **QStash EdgeFunction Scheduler** template, access [Real-Time Manager (RTM)](/en/documentation/products/guides/how-to-access-rtm/) and select the **Start with a template** option on the homepage.
...
Moreover, to guarantee the optimal performance of this template, you must activate:
...
4. Find the edge application relate to the Qstash Scheduler template and select it. 
