...
description: >-
  This template is written in TypeScript using the Docusaurus framework, a
...
permalink: /documentation/guides/application-development/frameworks/docusaurus-typescript-boilerplate/
---
