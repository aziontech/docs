...
permalink: /documentation/products/guides/devscard/
---
...
This template contains the configurations to *create your online and print resume using the DevsCard project*. After the deployment, you can update it with your information and create your portfolio.

The **DevsCard** template deploys an edge application, a domain, and a related GitHub repository to facilitate your access and management of the content and configurations. It also contains a GitHub Action to enable a continuous integration workflow and keep your application and repository up to date.
...
- Enable [Edge Functions](/en/documentation/products/build/edge-application/edge-functions/), [Application Accelerator](/en/documentation/products/build/edge-application/application-accelerator/), and [Edge Cache](/en/documentation/products/build/edge-application/edge-cache/) in your Azion account.
    ...
    - If these modules are activated, deploying this template could generate usage-related costs. Check the [pricing page](/en/documentation/products/pricing/) for more information.
