...
You can follow the deployment process through a window showing off the logs. When it's complete, During the deployment, you'll be able to follow the process through a window showing off the logs. When it's complete, the page shows information about the application and some options to continue your journey.
