...
The **Bot Manager Integration Kit** template provides an easy way to integrate the Bot Manager function in an existent Edge Firewall instance on Azion. This template automatically creates a new function instance for Bot Manager and a Rules Engine rule to run it in the selected Edge Firewall instance.
