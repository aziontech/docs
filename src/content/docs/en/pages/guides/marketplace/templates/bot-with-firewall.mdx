...
- Have a [Firewall](/en/documentation/platform/firewall/) created in your account.
    - During the setup of the template, you must inform the ID of your existing Firewall to add the Bot Manager Lite instance. If the ID doesn't exist, the execution will fail. Check [how to configure and edit a Firewall](/en/documentation/platform/firewall/#step-1-configure-main-settings).
...
- **Firewall ID** *: the ID of your existing Firewall to add the Bot Manager Lite instance.
    - To get the ID, go to the [Firewall page](https://console.azion.com/edge-firewall), select the one you want to use, and copy the ID from the URL. You can also get it via [Azion API](https://api.azion.com/#e21929ff-f172-44d0-a3dc-58ecc11b652e).
...
You can calibrate and edit the arguments to better adjust the integration to your needs. Read more on [How to manage bots](/en/documentation/guides/application-security/bots-and-network/manage-bots/).

---

## Viewing logs

After executing the template, the requests will generate logs that can be seen in [Real-Time Events](/en/documentation/observe/real-time-events/). By analyzing the logs generated by Bot Manager Lite, you can get insights to understand if any changes in the function instance's JSON Args are needed.

Read more on [How to observe and calibrate rules](/en/documentation/guides/application-security/bots-and-network/manage-bots/).

You can also use [Data Stream](/en/documentation/observe/data-stream/) to monitor the activity. 
...
:::tip
Read the documentation about [managing applications](/en/documentation/platform/applications/first-steps/) and [how to configure cache policies for Applications](/en/documentation/guides/application-performance/cache-and-purge/cache-settings/) for more details.
:::
