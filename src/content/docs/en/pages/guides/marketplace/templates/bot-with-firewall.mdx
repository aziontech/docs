...
description: >-
  This template provides an easy way to integrate the Bot Manager function in an
...
Learn how to add Bot Manager to an existent edge firewall with a template. Watch the video below:
<div class="cms-embed">
