...
description: >-
The CosmicJS Simple Next.js Blog template allows you to create and manage a blog easily, using the capabilities of Next.js for optimal performance and user experience.
...
The Azion CosmicJS Simple Next.js Blog template provides an efficient blogging platform using [Next.js](https://nextjs.org/docs) and [Cosmic](https://www.cosmicjs.com/), a headless CMS. 
It allows you to create and manage a blog easily, using the capabilities of Next.js for optimal performance and user experience.
...
3. Fill in the information to setup the application:
 ...
 - **Cosmic Bucket Slug**: the identifier of the bucket from where the application will fetch content.
 - **Cosmic Read Key**: the access key required to read the bucket.
