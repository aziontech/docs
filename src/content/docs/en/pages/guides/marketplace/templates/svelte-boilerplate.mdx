---
title: How to deploy edge applications with the Svelte Boilerplate
description: The Svelte Boilerplate accelerates the deployment of Svelte static applications to run directly on the edge.
...
To start using the **Svelte Boilerplate**:
...
4. Browse and select the **Svelte Boilerplate** card.
