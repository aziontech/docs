...
In the configuration form, you must provide the information to configure your new application, which will include the function. Fill in the presented fields. 
...
3. Find the application related to the **Function GitHub AutoDeploy** template and select it. 
