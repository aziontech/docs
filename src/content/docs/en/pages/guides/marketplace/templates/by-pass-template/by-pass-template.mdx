---
title: How to deploy the Suite By Pass template
...
namespace: docs_guides_by_pass_template
permalink: /documentation/products/guides/suite-by-pass/
---
...
**Suite By Pass** includes configurations for adding a layer of engine rules to ignore all cache settings for a specific URL route. These configurations use a standard rule based on criteria and behaviors applied through Rules Engine for Edge Application.
...
This will open a new page where you can select the **Suite By Pass** card.
