...
description: >-
  This template deploys a repository with a project based on Hugo, a framework
  written in Go, that enables you to create static sites.
meta_tags: 'templates, guides, Azion Marketplace'
namespace: docs_guides_hugo_boilerplate
permalink: /documentation/guides/application-development/frameworks/hugo-boilerplate/
---
