...
description: This template deploys a repository with a project based on Hugo, a framework written in Ruby, that enables you to create static sites using Markdown and HTML files.
