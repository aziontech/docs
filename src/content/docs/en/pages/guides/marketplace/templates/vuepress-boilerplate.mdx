...
With the **VuePress Boilerplate** you can start a project using [VuePress]() and deploy it at the edge. **VuePress** is a markdown-centered static site generator. It allows developers to write content like documentation and blogs in Markdown.
