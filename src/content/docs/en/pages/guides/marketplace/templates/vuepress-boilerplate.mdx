...
With the **VuePress Boilerplate** you can start a project using [VuePress](https://vuepress.vuejs.org/guide/introduction.html) and deploy it at the edge. **VuePress** is a static site generator which allows developers to write content like documentation and blogs in Markdown.
