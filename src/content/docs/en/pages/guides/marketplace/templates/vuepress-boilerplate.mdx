---
title: How to deploy the VuePress Boilerplate
description: This template deploys a repository with a project based on VuePress.
meta_tags: guides, Azion Marketplace, web, VuePress
namespace: docs_guides_vuepress_boilerplate
permalink: /documentation/guides/application-development/frameworks/vuepress-boilerplate/
---
...
With the **VuePress Boilerplate**, you can start a project using [VuePress](https://vuepress.vuejs.org/guide/introduction.html) and deploy it at the edge. **VuePress** is a static site generator that allows developers to write content such as documentation and blogs in **Markdown**.
