...
description: The Clean Astro + Sanity application template creates a minimal Astro website integrated with Sanity.io for managing the content.
...
The Azion **Clean Astro + Sanity application** template creates a minimal [Astro](https://docs.astro.build/en/concepts/why-astro/) website integrated with [Sanity](http://sanity.io/) for managing the content.
...
- **CLI**: create your project for free by selecting the blog template.
- **GUI**: the use of this option may incur costs. For more information, visit the [Sanity CMS](http://sanity.io/) website.
:::
...
3. Fill in the information to setup the application:
   ...
   - **Sanity Project ID**: project ID from where the content will be read.
   - **Sanity Studio Dataset**: dataset from which the content
 will be read. 
