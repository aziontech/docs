...
The Azion **React Boilerplate** helps you build a **React edge application** and run it directly on the edge of the network. By executing the boilerplate, several steps are automated, from repository management to edge deployment.
