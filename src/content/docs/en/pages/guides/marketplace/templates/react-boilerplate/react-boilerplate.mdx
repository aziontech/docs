...
description: The React Boilerplate provides an automation solution to build an React application on Azion.
...
The Azion **React Boilerplate** provides an automation solution to build an **React edge application** and run it directly on the edge of the network

 encapsulating several steps, from repository management to edge deployment.

This template uses React CLI version `xxxx`.

---

## Getting the template

To start using the **React Boilerplate**, proceed as follows:
...
The script creates a GitHub repository to manage the source code and then it installs all required dependencies. With the integration of the Vulcan library, the application undergoes an optimized build process, emphasizing optimal performance and efficiency.

Besides that, the script deploys your application on the Azion Edge Platform and carries out multiple configurations, including setting up the edge application and its domain to host your React project and an edge function for custom logic.
...
4. You'll be redirected to the **Edge Application** page.
- It lists all the edge applications you've created. 
5. Find the edge application relate to the React Boilerplate and select it. 
- The list is organized alphabetically. You can also use the **search bar** located in the upper-left corner of the list; currently, it filters only by **Application Name**.

After selecting the edge application you’ll work on, you’ll be directed to a page containing all the settings you can configure.

:::tip
Read the documentation about [managing edge applications](/en/documentation/products/getting-started/#step-2-managing-edge-applications) for more details.
:::
