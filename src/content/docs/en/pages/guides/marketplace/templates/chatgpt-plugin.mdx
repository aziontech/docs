---
title: How to create a custom plugin with ChatGPT Plugin template
description: With ChatGPT Plugin, you can implement the default setup or customize new plugins according to your needs.
meta_tags: templates, guides, Azion Marketplace
namespace: docs_guides_chatgpt_plugin
permalink: /documentation/products/guides/chatgpt-plugin/
---
...
To get this template, access [Real-Time Manager (RTM)](/en/documentation/products/guides/how-to-access-rtm/) and select the **Start with a template** option on the homepage.

This will open a new page where you can select the **ChatGPT Plugin** card.
...
5. Add your **Azion personal token** to the repository's *Secrets*. Read more about [getting an Azion personal token](/en/documentation/products/guides/personal-tokens/).
...
4. Find the edge application related to your **ChatGPT Plugin* and select it. 
...
:::tip
Read the documentation about [managing edge applications](/en/documentation/products/edge-application/first-steps/) for more details. For specific ChatGPT-related questions, check the [OpenAI documentation](https://platform.openai.com/docs/introduction).
:::
