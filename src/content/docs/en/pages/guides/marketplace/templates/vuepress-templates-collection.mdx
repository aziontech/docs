...
description: >-
  This guide contains instructions to create a web application using templates based on VuePress.
meta_tags: >-
...
The **VuePress Templates** collection offers configurations for building web applications using templates. These templates are all based on the **VuePress** framework.
...
- **VuePress Moefy**: create a VuePress website with animations.. It uses versions `1.9.9` of VuePress.
- **VuePress Live2D Plus**: create a VuePress documentation website. It uses versions `2.0.0` of VuePress.
- **VuePress Solid**: create a beautiful static site with VuePress.. It uses versions `2.0.0` of VuePress.
