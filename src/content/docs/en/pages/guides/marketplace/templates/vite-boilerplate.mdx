...
permalink: /documentation/guides/application-development/frameworks/vue-vite-boilerplate/
---
...
This template deploys a new stack with a new application containing a domain to access the Single-Page Application (SPA), as well as [Object Storage configuration](/en/documentation/store/object-storage/), cache settings, and Rules Engine rules to improve the performance of the static files. Additionally, it creates a new GitHub repository, including a GitHub Action to enable a continuous development workflow and keep your application up to date.
