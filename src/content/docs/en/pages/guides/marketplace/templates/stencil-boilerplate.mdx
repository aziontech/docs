...
permalink: /documentation/guides/application-development/frameworks/stencil-boilerplate/
---
...
With the **Stencil Boilerplate**, you can start a project using [Stencil](https://stenciljs.com/docs/introduction) and deploy it at the edge. **Stencil** is a compiler that generates Web Components and combines the best concepts of the most popular frameworks into a simple build-time tool.
