...
description: This template helps you deploy a Docusaurus website integrated with Material UI directly on the edge.
meta_tags: templates, guides, Azion Marketplace, Docusaurus, React, Material UI
namespace: docs_guides_docusaurus_docusaurus_material_ui_template
...
Docusaurus is a static-site generator while Material UI is a popular React UI framework that provides reusable UI components. The **Docusaurus with Material UI** template allows you deploy a Docusaurus website integrated with Material UI directly on the edge.
...
To start using the **Docusaurus with Material UI** template:
...
4. Browse and select the **Docusaurus with Material UI** card.
