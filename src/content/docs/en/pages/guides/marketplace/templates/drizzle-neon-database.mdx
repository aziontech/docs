---
title: How to deploy the Drizzle + Neon Database template
...
namespace: docs_guides_drizzle_neon_database
permalink: /documentation/products/guides/drizzle-neon-database/
---
...
The **Drizzle + Neon Database** template contains the configurations for connecting an edge function to a Neon database via Drizzle ORM.
