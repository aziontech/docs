---
title: How to deploy the Suite Image Cache template
description: This template includes configurations for enhancing image loading and caching, based on the file extension.
meta_tags: templates, guides, Azion Marketplace
namespace: docs_guides_image_cache_template
permalink: /documentation/products/guides/suite-image-cache/
---
...
**Suite Image Cache** includes configurations for enhancing image loading and caching, based on the file extension. These configurations use advanced cache key rules that are applied through Rules Engine for Edge Application.
...
File extensions that can be enhanced with these configurations: `.jpg`, `.jpeg`, `.bmp`, `.ico`, `.gif`, `.png`.
...
This will open a new page where you can select the **Suite Image Cache** card.
...
:::tip
Read the documentation about [managing edge applications](/en/documentation/products/edge-application/first-steps/) and [Azion Image Processor](/en/documentation/products/edge-application/image-processor/) for more details.
:::
