...
permalink: /documentation/guides/application-development/frameworks/preact-javascript-boilerplate/
---
...
With the Azion **Preact JavaScript Boilerplate**, you can start a project using [Preact](https://preactjs.com/) and deploy it at the edge. **Preact** is a JavaScript library with the same API as React but optimized for speed and small bundle size.
