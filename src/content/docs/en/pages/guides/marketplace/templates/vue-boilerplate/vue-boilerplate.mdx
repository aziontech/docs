...
description: The Vue Boilerplate provides an automation solution to build a Vue application on Azion.
...
The Azion **Vue Boilerplate** provides an automation solution to build an **Vue edge application** and run it directly on the edge of the network, encapsulating several steps, from repository management to edge deployment.

This template uses Vue version `16.1.3`.

---

## Getting the template

To start using the **Vue Boilerplate**, proceed as follows:
...
4. You'll be redirected to the **Edge Application** page.
- It lists all the edge applications you've created. 
5. Find the edge application relate to the Vue Boilerplate and select it. 
...
To do so, open your new **Vue Boilerplate** repository on GitHub. Then, go to **Settings** > **Secrets and variables** > **Action** to [add your variables](https://docs.github.com/en/actions/security-guides/encrypted-secrets), following these instructions:
