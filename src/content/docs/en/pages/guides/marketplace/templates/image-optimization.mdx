...
:::tip
Read the documentation about [managing applications](/en/documentation/platform/applications/first-steps/) and [Azion Image Processor](/en/documentation/build/image-processor/) for more details.
:::
