---
title: How to deploy an e-commerce with Eleventy using templates
description: >-
...
The **Eleventy E-commerce Templates** collection offers configurations for building e-commerce applications using templates. These templates are all based on the **Eleventy** framework.

The available templates are:

- **Eleventy 2 Snipcart**: Generate a simple static site with 11ty and JavaScript. Uses version `0.5.4` of Eleventy.
- **11ty and Snipcart for eCommerce**: Deploy a new e-commerce with Snipcart integration, based on Eleventy. Uses version `2.0.1` of Eleventy.
