...
permalink: /documentation/guides/application-development/frameworks/next-js-ecommerce-collection/
---
...
You can obtain and configure your templates through the Azion Console. To easily deploy any of them at the edge, click the respective button below.
  ...
  <DocButton
    ...
    href="https://console.azion.com/create/azion-community/simple-ecommerce-next"
    icon="ai ai-azion"
    size="medium"
  />
  <DocButton
    label="Deploy Space Jelly Shop"
    href="https://console.azion.com/create/azion-community/space-jelly-shop"
    icon="ai ai-azion"
    size="medium"
  />
