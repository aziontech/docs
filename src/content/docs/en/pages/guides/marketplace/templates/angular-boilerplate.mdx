...
To start using the **Angular Boilerplate**, [access Azion Console](/en/documentation/products/guides/how-to-access-rtm/) and select the **Start with a template** option on the homepage.
