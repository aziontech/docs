...
To start using the **Angular Boilerplate**, [access Real-Time Manager (RTM)](/en/documentation/products/guides/how-to-access-rtm/) and select the **Start with a template** option on the homepage.

This will open a new page where you can select the **Angular Boilerplate** card.
