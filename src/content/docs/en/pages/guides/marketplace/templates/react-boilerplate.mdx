...
permalink: /documentation/guides/application-development/frameworks/react-boilerplate/
---
...
- This template uses [Functions](/en/documentation/build/functions/) and [Cache](/en/documentation/build/cache/), and it may generate usage-related costs. Check the [pricing page](https://www.azion.com/en/pricing/) for more information.
...
With the integration of the [Azion Bundler framework adapter](/en/documentation/devtools/runtime/frameworks/frameworks-compatibility/), the application undergoes an optimized build process, emphasizing optimal performance and efficiency.
...
<DocButton href="/en/documentation/platform/workloads/domains/" label="go to Workloads reference" kind="secondary" size="medium" /> 
