---
title: How to deploy the Drizzle + Turso template
...
namespace: docs_guides_drizzle_turso
permalink: /documentation/products/guides/drizzle-turso/
---
...
The **Drizzle + Turso** template contains the configurations for creating and connecting an edge application to a Turso database via Drizzle ORM.
...
<LinkButton
    label="Deploy"
    link="https://console.azion.com/create/azion-community/drizzle-turso"
    icon="ai ai-azion"
    icon-pos="left"
  />
