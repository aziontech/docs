...
description: This template contains the configurations to connect an Edge Function to a Turso database.
...
The **Drizzle + Turso** template contains the configurations for connecting an edge function to a Turso database via Drizzle ORM.
