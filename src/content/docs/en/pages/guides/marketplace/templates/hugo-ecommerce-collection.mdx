...
permalink: /documentation/guides/application-development/frameworks/hugo-ecommerce-collection/
---
...
The **Hugo E-commerce Templates** collection offers configurations for building e-commerce applications using templates. These templates are all based on the **Hugo** framework.

The available templates are:

- **Influencer Hugo**: deploy a site based on Hugo to showcase your products. It uses version `0.62.0` of min-Hugo.
- **Vex Hugo**: create a Hugo-based product landing page in a few steps. It uses version `0.62.2`of min-Hugo.
