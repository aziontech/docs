...
To get **MongoDB Atlas Boilerplate**, access [Real-Time Manager (RTM)](/en/documentation/products/guides/how-to-access-rtm/) and select the **Start with a template** option on the homepage.
...
- <Badge>[Application Acceleration](/en/documentation/products/build/edge-application/application-acceleration/)</Badge>
