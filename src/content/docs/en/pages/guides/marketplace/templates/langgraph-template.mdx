...
This template creates two databases, one for conversation history and another for reference documents. To start using your own documents, you must set the appropriate database by following these steps:
