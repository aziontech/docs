...
permalink: /documentation/guides/application-development/frameworks/astro-blog-starter-kit/
---
...
- This template uses [Application Accelerator](/en/documentation/build/application-accelerator/), [Functions](/en/documentation/build/functions/), and [Image processor](/en/documentation/build/image-processor/), and it may generate usage-related costs. Check the [pricing page](https://www.azion.com/en/pricing/) for more information.
