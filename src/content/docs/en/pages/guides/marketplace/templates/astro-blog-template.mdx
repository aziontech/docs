...
permalink: /documentation/products/guides/astro-blog-template/
---
...
The **Astro Blog** template deploys an edge application, a domain, and a related GitHub repository to facilitate your access and management of the content and configurations. It also contains a GitHub Action to enable a continuous integration workflow and keep your application and repository up to date.
...
This will open a modal where you can select **Templates** > **Astro Blog** card.
...
To do so, open your new **Astro Blog** repository on GitHub. Then, go to **Settings** > **Secrets and variables** > **Action** to [add your variables](https://docs.github.com/en/actions/security-guides/encrypted-secrets), following these instructions:
