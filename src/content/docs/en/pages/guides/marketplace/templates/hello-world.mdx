...
The Azion **Hello World** template deploys an edge application that prints a *Hello, World!* message in your browser and you can use it as a starting point to become familiar with **Azion Web Platform** and edge computing capabilities.
