---
title: How to deploy edge applications with the Qwik Boilerplate
description: >-
  The Qwik Boilerplate provides an automation solution to build Qwik application on Azion.
...
The Azion **Qwik Boilerplate**, helps you set up a project using the Qwik framework and run it directly on the edge of the network. It encapsulates and automates several steps, from repository management to edge deployment.
...
The script creates a [GitHub repository](https://github.com/aziontech/azion-samples/tree/dev/templates/qwik-boilerplate) to manage the source code and then it installs all required dependencies. It also includes a GitHub Action to enable continuous deployment. Besides that, your application is deployed on Azion's platform and includes multiple configurations, such as setting up the edge application and its domain to host your Qwik project and an edge function for custom logic.
