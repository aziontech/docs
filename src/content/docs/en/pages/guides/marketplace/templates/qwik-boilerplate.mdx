...
With the Azion **Qwik Boilerplate** template, you can start a project using [Qwik](https://qwik.dev/docs/) and deploy it at the edge. **Qwik** is a web framework that uses resumability instead of hydration, loading JavaScript only when needed for better performance and faster page loads.
