...
permalink: /documentation/guides/application-development/frameworks/book-store-react/
---
...
The **Book Store React** template contains the configurations for creating a React-based e-commerce application in a few steps. It includes styled components and tools to add functionality, simplifying customization.
