...
To start using the **Astro Boilerplate**, access [Real-Time Manager (RTM)](/en/documentation/products/guides/how-to-access-rtm/) and select the **Start with a template** option on the homepage.
...
4. Find the edge application related to the **Astro Boilerplate** and select it. 
