---
title: How to deploy applications with the Astro Boilerplate
description: >-
  The Astro Boilerplate provides an automation solution to build Astro applications on Azion.
meta_tags: Astro, templates, guides, Azion Marketplace
namespace: docs_guides_astro_boilerplate
permalink: /documentation/guides/application-development/frameworks/astro-boilerplate/
---
...
With the Azion **Astro Boilerplate**, you can start a project using [Astro](https://astro.build/) and deploy it at the edge. **Astro** is a web framework for building content-driven websites like blogs, marketing, and e-commerce.
