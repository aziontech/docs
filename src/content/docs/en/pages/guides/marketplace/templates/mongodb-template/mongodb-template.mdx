...
The **MongoDB Atlas** template allows you to deploy a database directly on Azion's edge. Besides, due to the integration with the Atlas Data API, you're able to create, retrieve, update, and delete items in your collections through standard HTTPS requests.
