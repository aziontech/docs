---
title: How to deploy a database on the edge with the MongoDB Atlas template
...
The **MongoDB Atlas** template allows you to deploy a database directly on the Azion's edge. Besides, thanks to the integration with the Atlas Data API, you're able to create, retrieve, update, and delete items in your collections through standard HTTPS requests.
