...
Any cost generated by MongoDB usage will be processed and billed separately on the MongoDB platform. Visit the [Atlas MongoDB documentation](https://www.mongodb.com/docs/atlas/) for more details.
:::
