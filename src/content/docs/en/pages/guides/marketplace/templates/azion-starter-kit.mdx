...
The logs can be checked in [Real-Time Events](/en/documentation/products/observe/real-time-events/). By analyzing the logs generated by Bot Manager, you can get insights to understand if any changes in the function Instance's JSON Args are needed. You can also use Azion [Data Streaming](/en/documentation/products/observe/data-streaming/) as an observability tool. Read more on [How to observe logs and calibrate rules](/en/documentation/products/guides/secure/manage-bots/#use-real-time-events-to-observe-and-calibrate-rules).
...
To do so, open your new **Azion Starter Kit** repository on GitHub. Then, go to **Settings** > **Secrets and variables** > **Action** to [add your variables](https://docs.github.com/en/actions/security-guides/encrypted-secrets), following these instructions:
