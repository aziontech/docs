...
permalink: /documentation/guides/application-development/frameworks/azion-starter-kit/
---
...
- This template uses [Application Accelerator](/en/documentation/build/application-accelerator/), [Functions](/en/documentation/build/functions/), [Image processor](/en/documentation/build/image-processor/), and [Network Shield](/en/documentation/secure/network-shield/), and it may generate usage-related costs. Check the [pricing page](https://www.azion.com/en/pricing/) for more information.
...
- **Custom Host Header**: in some cases, it may be necessary to add host information in the header request to retrieve information from the origin. This variable is used for that purpose.
    - Example: `${host}`. Read more about the host header and how to customize it on the [Origins](/en/documentation/platform/connectors/origins/#host-header) documentation.
...
- A default rule composed of:
    ...
    - **Behavior**: then [Set Origin](/en/documentation/platform/applications/rules-engine/#set-origin) as `Default Origin`.
...
Additionally, the Firewall enhances security through the [Azion IP Tor Exit Nodes](/en/documentation/guides/application-security/bots-and-network/block-tor-networks/) network list and Azion [Bot Manager Lite](/en/documentation/guides/application-development/integrations/bot-manager-lite/).
...
The logs can be checked in [Real-Time Events](/en/documentation/observe/real-time-events/). By analyzing the logs generated by Bot Manager Lite, you can get insights to understand if any changes in the function instance's JSON Args are needed. You can also use Azion [Data Stream](/en/documentation/observe/data-stream/) as an observability tool. Read more on [How to observe logs and calibrate rules](/en/documentation/guides/application-security/bots-and-network/manage-bots/#use-real-time-events-to-observe-and-calibrate-rules).
