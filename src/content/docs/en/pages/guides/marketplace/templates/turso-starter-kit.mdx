...
You can use the Azion domain to access it through the browser, as explained in the [deployment section](#deploying-the-template), and interact with it through the static interface that was created.
