...
- The template uses [Application Accelerator](/en/documentation/build/application-accelerator/), [Functions](/en/documentation/build/functions/), and [AI Inference](/en/documentation/build/ai-inference/). This may generate usage-related costs. Check the [pricing page](/en/documentation/fundamentals/pricing/) for more information.
...
This example uses the [Qwen3 model](/en/documentation/build/ai-inference/qwen3-30ba3b/). You can change the model and the request parameters according to your preferences. 
Check the [AI models reference](/en/documentation/build/ai-inference/models/) for more information about the available models and how to use them in your application.
...
<DocButton href="/en/documentation/guides/platform/migration/configure-a-domain/" label="Go to the domain configuration guide" kind="secondary" size="medium" />
