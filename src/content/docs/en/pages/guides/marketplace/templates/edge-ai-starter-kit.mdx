...
description: The Edge AI Starter Kit template allows you to create an AI-powered application running OpenAI-compatible APIs directly on Azion's distributed network. 
meta_tags: templates, guides, Azion Marketplace, AI, Edge Function, Applications
...
The deployment of this template creates an application with an edge function and a domain to facilitate your access and management through Azion Web Platform.
