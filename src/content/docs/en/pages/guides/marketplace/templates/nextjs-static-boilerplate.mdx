...
To start using the **Next.js Static Boilerplate**, access [Azion Console](/en/documentation/products/guides/how-to-access-rtm/) and click the **+ Create** button on the homepage.
