...
To use the **Hexo Boilerplate**, access [Azion Console](/en/documentation/products/guides/how-to-access-azion-console/) and click the **+ Create** button on the homepage.
