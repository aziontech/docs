...
description: Hexo Boilerplate facilitates you to build and run a Hexo Single-Page Application (SPA) directly on the edge.
...
To use the **Hexo Boilerplate**, access [Real-Time Manager (RTM)](/en/documentation/products/guides/how-to-access-rtm/) and select the **Start with a template** option on the homepage.
...
You must activate it separately via RTM. To do so:
...
4. Find the edge application related to the Hexo Boilerplate and select it. 
