---
title: How to deploy the Docusaurus Blog Starter Kit
description: Create and manage a blog page with support to Markdown, MDX, and React components, based on Docusaurus.
meta_tags: templates, guides, Azion Marketplace, Docusaurus, React
namespace: docs_guides_docusaurus_docusaurus_blog_template
permalink: /documentation/products/guides/docusaurus-blog-starter-kit/
---
...
The **Docusaurus Blog Starter Kit** streamlines the creation and management of a blog page with support to Markdown and MDX, making it easy to write content with rich media and React components.

Docusaurus is a static-site generator, that builds a single-page application with fast client-side navigation and leverages React to make the site interactive. It's ideal for documentation features and other cases, including website, product pages, blog, and landing pages.
...
To start using the **Docusaurus Blog Starter Kit**:
...
4. Browse and select the **Docusaurus Blog Starter Kit** card.
