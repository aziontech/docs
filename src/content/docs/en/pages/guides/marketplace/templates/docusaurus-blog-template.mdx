---
title: How to deploy the Docusaurus Blog template
...
permalink: /documentation/products/guides/docusaurus-blog-template/
---
...
The **Docusaurus Blog** template streamlines the creation and management of a blog page with support to Markdown and MDX, making it easy to write content with rich media and React components.
...
To start using the **Docusaurus Blog** template:
...
4. Browse and select the **Docusaurus Blog** card.
