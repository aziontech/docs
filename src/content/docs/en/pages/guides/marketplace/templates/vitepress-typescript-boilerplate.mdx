...
description: This template is written in TypeScript using VitePress, a static site generator built on top of Vite and Vue.js, which is ideal for creating documentation websites.
meta_tags: templates, guides, Azion Marketplace, VitePress, Vite, Vue.js, Jamstack, TypeScript
...
To start using the **VitePress TypeScript Boilerplate**:
...
4. Browse and select the **VitePress TypeScript Boilerplate** card.
