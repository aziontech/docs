---
title: How to deploy the Neon Database Starter Kit with Drizzle template
description: This template contains the configurations to build and connect your application to Neon Database.
meta_tags: templates, guides, drizzle, neon database, Azion Marketplace, web, edge computing
...
The **Neon Database Starter Kit with Drizzle ORM** template contains the configurations for connecting an edge function to a Neon database via Drizzle ORM.
...
:::note
Database storage and operations could also generate costs directly by Neon. Check [Neon's pricing page](https://neon.tech/pricing) for details.
:::
