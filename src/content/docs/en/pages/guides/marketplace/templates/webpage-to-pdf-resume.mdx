...
permalink: /documentation/guides/application-development/frameworks/webpage-to-pdf-resume/
---
...
The **Webpage to PDF Resume template** contains the configurations for creating a resume that can be displayed on the web, printed, or saved as a PDF using the Webpage to PDF Resume project. Once deployed, you can easily customize it with your personal information and develop your portfolio.
...
This template uses version `4.6.1` of Astro.
