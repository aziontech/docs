---
title: How to deploy a Webpage to PDF Resume using a template
description: >-
...
This template contains the configurations to *create a resume for the web, print or PDF using the Webpage to PDF Resume project*. After the deployment, you can update it with your information and create your portfolio.

The **Webpage to PDF Resume** template deploys an edge application, a domain, and a related GitHub repository to facilitate your access and management of the content and configurations. It also contains a GitHub Action to enable a continuous integration workflow and keep your application and repository up to date.
