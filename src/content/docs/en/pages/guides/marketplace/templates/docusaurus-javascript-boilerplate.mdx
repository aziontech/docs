...
description: >-
  This template is written in JavaScript using the Docusaurus framework, a
...
permalink: /documentation/guides/application-development/frameworks/docusaurus-javascript-boilerplate/
---
