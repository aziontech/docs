...
- This template uses [Functions](/en/documentation/build/functions/) and [Network Shield](/en/documentation/secure/network-shield/), and it may generate usage-related costs. Check the [pricing page](https://www.azion.com/en/pricing/) for more information.
...
You can calibrate and edit the arguments to better adjust the integration to your needs. To read more about the Bot Manager Lite variables, check the [How to install Azion Bot Manager Lite](https://www.azion.com/en/documentation/guides/application-development/integrations/bot-manager-lite/) and [How to manage bots guides](https://www.azion.com/en/documentation/guides/application-security/bots-and-network/manage-bots/).
...
Read more on [How to observe and calibrate rules](/en/documentation/guides/application-security/bots-and-network/manage-bots/#use-real-time-events-to-observe-and-calibrate-rules).
...
<DocButton href="/en/documentation/guides/platform/migration/configure-a-domain/" label="go to configuring a domain guide reference" kind="secondary" size="medium" /> 
