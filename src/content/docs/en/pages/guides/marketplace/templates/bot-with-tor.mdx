...
description: >-
  Deploy a basic security suite to protect your workloads from bad bots and Tor
  Exit Nodes requests.
...
- **Domain ID(s)**: the IDs of the workloads you want to protect with this template. 
    - To get the IDs, you can go to the [workloads page](https://console.azion.com/workloads), select the one you want to use, and copy the ID in the URL. You can also get it via [Azion API](https://api.azion.com/#8eb89cc2-e58c-4c93-bb96-a4a30d96b8185).
