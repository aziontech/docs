...
permalink: /documentation/products/guides/block-tor-exit-nodes-template/
---
...
The **Bot Manager and TOR Exit Nodes** template enables you to deploy a basic security suite to protect your domains from bad bots and Tor Exit Nodes requests.
...
This will open a new page where you can select the **Bot Manager and TOR Exit Nodes** card.
...
Read more on [How to use Real-Time Events to observe and calibrate rules](/en/documentation/products/guides/secure/manage-bots/#use-real-time-events-to-observe-and-calibrate-rules).
