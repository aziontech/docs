...
During the deployment, you can follow the process through a window showing the logs. When it's complete, the *deployment* page appears, confirming the edge application has been successfully created.
