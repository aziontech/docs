---
title: How to deploy an e-commerce using the Gatsbry E-commerce Theme template
description: >-
...
The **Gatsby E-commerce Theme template** contains the configurations for creating a Gatsby-based e-commerce application in a few steps.  It includes styled components and tools to add functionality, simplifying the customization process.
