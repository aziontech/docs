...
permalink: /documentation/guides/application-development/frameworks/gatsby-ecommerce-theme/
---
...
The **Gatsby E-commerce Theme** template contains the configurations for creating a Gatsby-based e-commerce application in a few steps. It includes styled components and tools to add functionality, simplifying customization.
