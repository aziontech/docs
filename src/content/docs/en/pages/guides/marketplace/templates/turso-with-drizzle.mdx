---
title: How to deploy the Turso Starter Kit with Drizzle template
description: This template contains the configurations to connect an Edge Application to a Turso database.
meta_tags: Drizzle ORM, Turso database, Edge Function, Azion Marketplace, web, guides, templates
...
:::note
Database storage and operations could also generate costs directly by Turso. Check [Turso's pricing page](https://turso.tech/pricing) for details.
:::
