...
permalink: /documentation/guides/application-development/frameworks/turso-with-drizzle/
---
...
The **Turso Starter Kit with Drizzle ORM** template contains the configurations for creating and connecting an application to a Turso database via Drizzle ORM.

The deployment of this template creates a GitHub repository containing your project, as well as an application and a domain to facilitate your access and management through Azion Web Platform. It also creates a new database with a new table in your Turso account.
...
- A [Turso account](https://turso.tech/) with an empty database slot.

- This template uses [Application Accelerator](/en/documentation/build/application-accelerator/), [Functions](/en/documentation/build/functions/), and [Cache](/en/documentation/build/cache/), and it may generate usage-related costs. Check the [pricing page](https://www.azion.com/en/pricing/) for more information. Database storage and operations could also generate costs directly by Turso. Check [Turso's pricing page](https://turso.tech/pricing) for details.
...
<DocButton
    label="Deploy"
    href="https://console.azion.com/create/azion-community/turso-with-drizzle"
    icon="ai ai-azion"
    size="medium"
/>
...
3. Fill in the information to setup the application:
    ...
    - **Turso Authorization Token**: the token used to communicate with the Turso API. It must have writing permission.
    - **Turso Organization**: the name of your organization at Turso.
    - **Turso Group**: the group at Turso where the template will launch the new database. 
