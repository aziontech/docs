---
title: How to deploy applications with the Vue Boilerplate
description: >-
...
permalink: /documentation/guides/application-development/frameworks/vue-boilerplate/
---
...
3. Find the application relate to the **Vue Boilerplate** and select it. 
