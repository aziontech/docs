...
permalink: /documentation/products/guides/nuxt-content/
---
...
The deployment of this template creates a GitHub repository containing your project, as well as an application and a domain to facilitate your access and management through the Azion Web Platform. It also creates an [Object Storage](/en/documentation/products/store/object-storage/) origin to deliver the content from the edge. 
