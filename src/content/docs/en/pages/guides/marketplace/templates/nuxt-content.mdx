---
title: How to deploy the Nuxt Content template
description: This template contains the configurations to create a blog or documentation website with Nuxt Content.
meta_tags: templates, guides, Azion Marketplace, web
namespace: docs_guides_nuxt_content
permalink: /documentation/guides/application-development/frameworks/nuxt-content/
---
...
The deployment of this template creates a GitHub repository containing your project, as well as an application and a domain to facilitate your access and management through the Azion Web Platform. It also creates an [Object Storage](/en/documentation/store/object-storage/) origin to deliver the content from the edge. 

This template uses Nuxt version `3.6.1`.
...
<DocButton
    label="Deploy"
    href="https://console.azion.com/create/azion-community/nuxt-content"
    icon="ai ai-azion"
    size="medium"
/>
...
:::note
The link to the application allows you to see it on the browser. However, it may take some time to propagate and configure the application in Azion's edge locations. It may be necessary to wait a few minutes for the URL to be activated and for the application page to be effectively displayed in the browser.
:::
