...
The deployment of this template creates a GitHub repository containing your project, as well as an edge application and a domain to facilitate your access and management through the Azion Web Platform. It also creates an [Edge Storage](/en/documentation/products/store/edge-storage/) origin to deliver the content from the edge. 
