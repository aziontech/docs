...
The deployment of this template creates an application, a basic "Hello World” edge function, and a domain to facilitate your access and management through Azion Web Platform.
