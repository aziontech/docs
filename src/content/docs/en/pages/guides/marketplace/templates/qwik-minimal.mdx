...
With the Azion **Qwik Minimal** template, you can you can quickly set up a basic project using [Qwik](https://qwik.dev/docs/) and deploy it at the edge. **Qwik** is a web framework that uses resumability instead of hydration, loading JavaScript only when needed for better performance and faster page loads.
