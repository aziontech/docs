---
title: How to deploy edge applications with Qwik Minimal
description: >-
...
permalink: /documentation/products/guides/qwik-minimal/
---
...
The Azion **Qwik Minimal** template, helps you to quickly set up a basic project using the Qwik framework and run it directly on the edge of the network. It encapsulates and automates several steps, from repository management to edge deployment.
