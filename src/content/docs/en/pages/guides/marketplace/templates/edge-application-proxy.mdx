...
To use this template, access [Real-Time Manager (RTM)](/en/documentation/products/guides/how-to-access-rtm/) and select the **Start with a template** option on the homepage.
...
4. Find the edge application related to the **Edge Application Proxy*** template and select it. 
