...
permalink: /documentation/guides/application-development/frameworks/edge-application-proxy-template/
---
...
- **Behavior**: then [Set Origin](/en/documentation/platform/applications/rules-engine/#set-origin) `Default Origin`, [Bypass Cache](/en/documentation/platform/applications/rules-engine/#bypass-cache), and [Forward Cookies](/en/documentation/platform/applications/rules-engine/#forward-cookies).
