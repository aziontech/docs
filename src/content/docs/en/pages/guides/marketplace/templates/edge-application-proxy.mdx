...
To use this template, access [Azion Console](/en/documentation/products/guides/how-to-access-rtm/) and click the **+ Create** button on the homepage.

This will open a modal where you can select **Templates** > **Edge Application Proxy** card.
...
After completing all the information, click the **Save** button, located in the bottom-right corner. This will start the deployment process.
