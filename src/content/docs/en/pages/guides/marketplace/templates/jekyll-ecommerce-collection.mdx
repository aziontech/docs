...
permalink: /documentation/guides/application-development/frameworks/jekyll-ecommerce-collection/
---
...
The **Jekyll E-commerce Templates** collection offers configurations for building e-commerce applications using templates. These templates are all based on the **Jekyll** framework.

The available templates are:

- **Jekyll Cart**: deploy a Jekyll-based shopping cart built with simpleCart(js). It uses version `0.1.0` of Jekyll Cart.
- **Supply**: build an e-commerce using Supply, a Jekyll theme with Gumroad integration. It uses version `1.1.1` of Supply.
...
- These templates use [Application Accelerator](/en/documentation/build/application-accelerator/), [Functions](/en/documentation/build/functions/), and [Cache](/en/documentation/build/cache/), and it may generate usage-related costs. Check the [pricing page](https://www.azion.com/en/pricing/) for more information.
