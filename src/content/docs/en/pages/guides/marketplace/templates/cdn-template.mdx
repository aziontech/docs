...
description: This template helps you to deploy an application with common caching rules to improve the delivery of your content.
meta_tags: templates, guides, Azion Marketplace
namespace: docs_guides_XXXXX
permalink: /documentation/products/guides/XXXXXXXX/
---
...
You need to enable these modules via Real-Time Manager (RTM). To do so:
...
This will open a new page where you can select the **XXXXXX** card.
...
Now you can [manage and adjust the settings](#managing-the-template) through RTM.
...
Considering that this initial setup may not be optimal for your specific edge application, all settings can be customized any time you need through RTM.
