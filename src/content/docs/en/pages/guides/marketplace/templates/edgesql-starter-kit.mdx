...
With the **SQL Database Starter Kit** template, you can deploy a basic JavaScript-based CRUD project and use it to interact with an SQL Database. 

The deployment of this template creates a GitHub repository containing your project, as well as an application, a database and a domain to facilitate your access and management through Azion Web Platform.
...
- An SQL Database slot.
    -  The number of available slots is defined by your service plan. For more information visit our [SQL Database reference](https://www.azion.com/en/documentation/store/sql-database/).
...
:::tip
Read the documentation for more details about [managing applications](/en/documentation/platform/applications/first-steps/) and [managing EdgeSQL databases](/en/documentation/guides/application-development/data/manage-sql-database/).
:::
