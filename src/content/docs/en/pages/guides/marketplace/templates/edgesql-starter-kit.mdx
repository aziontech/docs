...
The deployment of this template creates a GitHub repository containing your project, as well as an edge application, database and a domain to facilitate your access and management through Azion Edge Platform.
...
:::tip
Read the documentation for more details about [managing edge applications](/en/documentation/products/build/edge-application/first-steps/) and [managing EdgeSQL database](/en/documentation/products/guides/manage-databases-edge-sql/).
:::
