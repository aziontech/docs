---
title: How to deploy edge applications with the EdgeSQL Starter Kit
description: >-
...
permalink: /documentation/products/guides/edgesql-starter-kit/
---
...
With the **EdgeSQL Starter Kit** template, you can deploy a basic JavaScript-based CRUD project and use it to interact with an EdgeSQL database. 

The deployment of this template creates a GitHub repository containing your project, as well as an edge application, a database and a domain to facilitate your access and management through Azion Edge Platform.

---

## Requirements

- An EdgeSQL database slot.
    -  The number of available slots is defined by your service plan. For more information visit our [EdgeSQL reference](https://www.azion.com/en/documentation/products/store/edge-sql/).
...
:::tip
Read the documentation for more details about [managing edge applications](/en/documentation/products/build/edge-application/first-steps/) and [managing EdgeSQL databases](/en/documentation/products/guides/manage-databases-edge-sql/).
:::
