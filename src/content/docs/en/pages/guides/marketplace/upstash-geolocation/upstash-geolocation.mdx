---
title: How to use the Upstash GeoLocation EdgeDeploy template through Azion Marketplace
description: Upstash GeoLocation EdgeDeploy enables you to manage and deliver personalized greeting messages, based on geolocation.
...
The **Upstash GeoLocation EdgeDeploy** template is an automation designed to enable an easy management and delivery of your personalized greeting messages, based on the geographical location of the end-users, without requiring extensive manual setup.
...
3. Generate your GitHub personal token, as explained in the [Creating a personal access token documentation](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens#creating-a-personal-access-token-classic).

## Getting the template

The Upstash GeoLocation EdgeDeploy template is available at Azion Marketplace.

To start using it, proceed as follows:
...
3. Find the Upstash GeoLocation EdgeDeploy card and select it.
...
### Key configurations
The Upstash GeoLocation EdgeDeploy template defines a series of key configurations to implement the geolocalization solution. When you execute this template, the following processes are completed:
...
- **Edge function creation**: an edge function is created and it provides the arguments for the geolocation.
...
- **GitHub repository creation**: a new repository is created in the user's GitHub account based on a public template.
...
5. Find the edge application relate to the QStash template and select it. 
  - The list is organized alphabetically. You can also use the **search bar** located in the upper-left corner of the list; currently, it filters only by **Application Name**.

After selecting the edge application you’ll work on, you’ll be directed to a page containing all the settings you can configure.

:::tip
Read the documentation about [managing edge applications](https://www.azion.com/en/documentation/products/getting-started/#settings-app) for more details. For specific Upstash-related questions, check the [Upstash documentation](https://docs.upstash.com/).
:::
...
The 'secrets' section should look similar to this:
