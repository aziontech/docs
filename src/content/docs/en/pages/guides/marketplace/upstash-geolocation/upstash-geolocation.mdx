---
title: How to use the Upstash GeoLocation EdgeDeploy template through Azion
...
:::tip
GitHub tokens are linked with the scope of the accounts and, in case of corporate accounts, organization owners can restrict the access. While generating your personal token, consider your scope and the level of access (classic or fine-grain) you're providing. Read the [Creating a personal access token documentation](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens#creating-a-personal-access-token-classic) for more information.
:::

## Getting the template

To start using the **Upstash GeoLocation EdgeDeploy** template, proceed as follows:
...
:::tip
Read the documentation about [managing edge applications](/en/documentation/products/getting-started/#step-2-managing-edge-applications) for more details. For specific Upstash-related questions, check the [Upstash documentation](https://docs.upstash.com/).
:::
