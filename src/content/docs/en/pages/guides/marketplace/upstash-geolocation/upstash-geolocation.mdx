...
The Upstash GeoLocation EdgeDeploy template is available at [Azion Marketplace](/en/documentation/products/marketplace/).
...
Upstash GeoLocation EdgeDeploy creates a new Azion edge application and its domain. It also creates an edge function to provide the arguments for the geolocation, and a new repository in your GitHub account based on a [public template](https://github.com/aziontech/).
...
2. On the upper-right corner, open the **Account menu**.
