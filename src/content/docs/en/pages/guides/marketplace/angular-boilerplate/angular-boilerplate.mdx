...
The Azion **Angular Boilerplate** provides an automation solution to build an **Angular edge application** and run it directly on the edge of the network, encapsulating several steps, from repository management to edge deployment.
