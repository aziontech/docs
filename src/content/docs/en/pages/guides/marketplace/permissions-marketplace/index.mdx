...
Some solutions will run on the **Edge Firewall** instance. These solutions will need more privileges than granted to an edge application. To know the **Edge Firewall** access privileges, visit the documentation for [Teams Permissions](/en/documentation/products/accounts/teams-permissions/).
