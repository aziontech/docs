...
14. Click **Save**.
15. On the box **Set up Azure AD SAML Toolkit**, copy the *Login URL* and *Azure AD Identifier*. You’ll need this information on RTM.
...
1. Log in to [Real-Time Manager](https://console.azion.com/).
...
1. Back on RTM, access the [SSO Management](https://console.azion.com/iam/sso/identity-providers) page.
