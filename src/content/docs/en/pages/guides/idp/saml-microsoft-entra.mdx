...
permalink: /documentation/guides/application-security/access-and-compliance/sso-microsoft-entra-saml/
---
...
Alternatively, you can enable Automated User Provisioning, using the SCIM protocol. Check the [how-to guide](/en/documentation/guides/application-security/access-and-compliance/microsoft-entra-automated-user-provisioning/) to get more information.
