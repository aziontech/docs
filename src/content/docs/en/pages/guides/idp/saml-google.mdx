---
title: Using Google custom SAML app as an IdP for Azion Console
description:  Hands-on to configure Google custom SAML app as an IdP for Azion Console.
...
:::caution[warning]
Even if you're using an IdP, it’s necessary to register all users of the account on Azion Console as they're synced in both Console and IdP. An inexistent user on Console won’t be able to log in to it.
:::
