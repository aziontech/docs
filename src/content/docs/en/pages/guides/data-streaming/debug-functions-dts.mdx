...
The debugging process in edge functions' code on [Data Streaming](/en/documentation/products/observe/data-streaming/) helps you identify if errors are still occurring or if the process was successful.
...
9. On the **Destination** section, select an **Endpoint Type** on the dropdown menu. See more about [setting an endpoint](/en/documentation/products/observe/data-streaming/#endpoints).
