...
You can see the entire list of variables and their descriptions for each data set on the [Data Streaming documentation](/en/documentation/products/observe/data-streaming/). Or, you can navigate through the pre-set templates on RTM by clicking on the **Template** dropdown menu and then copying the variables you desire.
