...
While [configuring a data streaming](/en/documentation/products/guides/use-data-streaming/) on **Azion Console**, after choosing a data source on Data Streaming, you have two options:
...
You can see the entire list of variables and their descriptions for each data set on the [Data Streaming documentation](/en/documentation/products/observe/data-streaming/). Or, you can navigate through the pre-set templates on Azion Console by clicking on the **Template** dropdown menu and then copying the variables you desire.
