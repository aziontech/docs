...
permalink: /documentation/guides/application-development/frameworks/data-stream-custom-template/
---
...
While [configuring a stream](/en/documentation/guides/platform/observability/use-data-stream/) on **Azion Console**, after choosing a data source on Data Stream, you have two options:
...
You can see the entire list of variables and their descriptions for each data set on the [Data Stream documentation](/en/documentation/observe/data-stream/). Or, you can navigate through the pre-set templates on Azion Console by clicking on the **Template** dropdown menu and then copying the variables you desire.
