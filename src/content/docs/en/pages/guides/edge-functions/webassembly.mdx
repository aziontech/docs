...
Learn about the required process to create a [function](/en/documentation/build/functions/) that uses a [WebAssembly](https://webassembly.org/getting-started/developers-guide/) originated function.
...
Now, the function is ready to be instantiated in an application. Check how to [instantiate and execute the functions in your application](/en/documentation/build/functions/functions-instances/) and try it out.
