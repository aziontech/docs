...
- To use ALTCHA through Bot Manager, [read the documentation](https://www.azion.com/en/documentation/secure/bot-manager/#captcha).
:::
...
To finish, you have to set up the [Rules Engine](/en/documentation/platform/firewall/rules-engine/) to configure the behavior and the criteria to run ALTCHA. To do this:
