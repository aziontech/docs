...
To run ALTCHA as the redirect target of Bot Manager, refer to [Bot Manager best practices](/en/documentation/secure/bot-manager/best-practices/#challenge-on-a-path-a-person-uses-deny-on-the-rest).
...
<DocCardGroup cols={2}>
  ...
  <DocCard title="Bot Manager best practices" href="/en/documentation/secure/bot-manager/best-practices/#challenge-on-a-path-a-person-uses-deny-on-the-rest" label="Send traffic classified as suspicious to the ALTCHA challenge page." />
</DocCardGroup>
