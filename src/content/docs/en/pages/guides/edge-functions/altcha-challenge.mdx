...
:::note
- It's possible to use the ALTCHA Edge Function independently—only with Edge Firewall—to protect specific areas of your application by requiring the challenge. 
