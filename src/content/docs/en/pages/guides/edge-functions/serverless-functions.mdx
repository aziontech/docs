---
title: How to run serverless functions on Azion Console
...
<LinkButton outlined link="/en/documentation/products/build/edge-application/edge-functions-instances/" label="Learn more about Edge Functions for Edge Application" />
