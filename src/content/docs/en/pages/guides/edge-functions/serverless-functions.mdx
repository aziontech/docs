...
<Button href="/en/documentation/products/build/edge-application/edge-functions-instances/" text="Learn more about Edge Functions for Edge Application"></Button>
