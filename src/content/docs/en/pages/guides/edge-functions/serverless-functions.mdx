...
[Functions](/en/documentation/build/functions/) is a module of the Azion Web Platform that allows you to program and execute serverless functions.

<DocButton href="/en/documentation/build/functions/functions-instances/" label="Go to Functions for Applications reference" kind="secondary" size="medium" />
...
- Define activation triggers within [Rules Engine](/en/documentation/platform/applications/rules-engine/).
...
:::tip
Check the guide on [How to build an API with Functions and ChatGPT](/en/documentation/guides/application-development/functions-and-runtime/api-builder/) for an example of a function you can run in your application. 
:::
