...
<DocSteps>
  <DocStep title="Create the environment variables">

  Create `TEST_ORIGIN` and `TEST_TIMEOUT` on the function, as described in [Environment variables](/en/documentation/build/functions/environment-variables/).
