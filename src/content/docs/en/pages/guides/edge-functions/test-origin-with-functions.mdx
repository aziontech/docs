...
- An [application](/en/documentation/guides/application-development/getting-started/build-an-application/) with production traffic
- A [domain](/en/documentation/guides/platform/migration/configure-a-domain/) associated with your application
- A test origin (your new software) accessible via HTTPS
- A [Firewall](/en/documentation/guides/application-security/firewall-and-waf/firewall-configure-main-settings/) associated with your domain
...
:::note
The following steps describe configuration in Azion Console. For detailed information about these interfaces, see the [Functions reference](/en/documentation/build/functions/) and [Firewall documentation](/en/documentation/platform/firewall/).
:::
...
:::note
The features described in this section—`event.console.log()`, `event.console.warn()`, and Real-Time Events integration—are Azion platform capabilities documented separately. For more information, see [Real-Time Events](/en/documentation/observe/real-time-events/).
:::
...
This approach **abandons the core principle** of traffic mirroring described in this guide. Use it only during short diagnostic phases, never as an operational standard. For extended monitoring without user impact, consider using [Data Stream](/en/documentation/observe/data-stream/) instead.
:::

### Step 5: View logs in Real-Time Events

1. Access [Azion Console](/en/documentation/guides/platform/account-and-billing/how-to-access-azion-console/) > **Real-Time Events**.
...
- [Functions reference](/en/documentation/build/functions/)
- [Rules Engine for Firewall](/en/documentation/platform/firewall/rules-engine/)
- [Real-Time Events](/en/documentation/observe/real-time-events/)
