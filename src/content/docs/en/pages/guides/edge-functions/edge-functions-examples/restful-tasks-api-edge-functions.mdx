...
For more details, see [SQL Database documentation](https://www.azion.com/en/documentation/#edge-sql).
...
<DocButton href="/en/documentation/store/sql-database/" label="Learn more about SQL Database" size="medium" />
