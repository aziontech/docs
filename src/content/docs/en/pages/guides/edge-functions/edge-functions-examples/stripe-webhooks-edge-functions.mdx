...
<DocSteps>
  <DocStep title="Request the status route">
  ...
  <DocStep title="Send two events the switch names">
  ...
  <DocStep title="Send an event the switch does not name">
  ...
  <DocStep title="Read what the handler logged">
