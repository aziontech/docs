...
<Button href="/en/documentation/products/store/edge-storage/" type="primary" theme="light" />
<Button href="/en/documentation/products/build/edge-application/edge-functions/" type="primary" theme="light" />
