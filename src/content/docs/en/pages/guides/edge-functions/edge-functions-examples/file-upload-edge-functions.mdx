...
<DocButton href="/en/documentation/store/object-storage/" label="Learn more about Object Storage" size="medium" />
<DocButton href="/en/documentation/build/functions/" label="Learn more about Functions" size="medium" />
