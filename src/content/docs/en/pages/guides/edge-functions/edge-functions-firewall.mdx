...
1. On [Real-Time Manager RTM](https://console.azion.com/), on the upper-left corner, select **Edge Functions** in the **Edge Libraries** section.
...
1. On [Real-Time Manager RTM](https://console.azion.com/), on the upper-left corner, select **Edge Firewall** in the **Secure** section.
