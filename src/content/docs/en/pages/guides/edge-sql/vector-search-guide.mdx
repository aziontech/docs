...
<DocButton href="/en/documentation/products/store/sql-database/vector-search/" label="Go to Vector Search Reference" kind="secondary" target="_blank" size="medium" />
