...
<DocButton href="/en/documentation/store/sql-database/vector-search/" label="Go to Vector Search Reference" kind="secondary" target="_blank" size="medium" />
...
- Generate an [Azion personal token](/en/documentation/guides/platform/account-and-billing/personal-tokens/).
- Generate an [OpenAI API Key](https://platform.openai.com/docs/quickstart/create-and-export-an-api-key).
- Install [Azion CLI](/en/documentation/devtools/cli/).
...
- Set up [SQL Database](/en/documentation/store/sql-database/).
