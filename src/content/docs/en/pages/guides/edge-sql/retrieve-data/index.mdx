...
<LinkButton link="/en/documentation/products/guides/build/instantiate-functions/" label="go to How to instantiate functions in your application" severity="secondary" />
