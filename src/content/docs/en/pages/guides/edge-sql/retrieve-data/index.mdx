---
title: "Retrieve data with SQL Database and Functions"
description: >-
  Read rows from an existing SQL Database inside a function with the azion:sql module.
...
- [Azion Functions enabled](/en/documentation/build/functions/).
- An active [Azion Personal Token](/en/documentation/guides/platform/account-and-billing/personal-tokens/).
...
## Create a function that queries the database
...
<DocButton href="/en/documentation/guides/application-development/getting-started/instantiate-functions/" label="go to How to instantiate functions in your application" kind="secondary" size="medium" />
