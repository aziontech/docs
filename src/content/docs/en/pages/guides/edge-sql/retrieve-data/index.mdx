...
permalink: /documentation/products/guides/edge-sql/retrieve-data-with-functions/
---
...
<Button href="/en/documentation/products/guides/build/instantiate-edge-functions/" label="go to How to instantiate functions in your application" type="primary" theme="light" />
