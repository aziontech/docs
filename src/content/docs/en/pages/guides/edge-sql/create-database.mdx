---
title: How to create an Edge SQL database
...
permalink: /documentation/products/guides/create-databases-edge-sql/
---

import Button from '~/components/Button.astro'

**Edge SQL** allows you to create databases so you can insert data. This guide covers how to create, list, and delete a database using the [Azion API](https://api.azion.com).

<Button href="/en/documentation/products/store/edge-sql/" text="go to Edge SQL reference" variant="secondary"></Button>

After creating a database, read [How to create an Edge SQL query](/en/documentation/products/guides/create-query-edge-sql/) to populate your database.
...
```bash
curl --location 'https://stage-edge-sql-api.azion.net/edge-sql/api/databases/{id_database}' \
--header 'Authorization: Token [TOKEN VALUE]'
```
...
```bash
curl --location --request DELETE 'https://stage-edge-sql-api.azion.net/edge-sql/api/databases/{id_database}' \
--header 'Authorization: Token [TOKEN VALUE]'
```
