...
- **SQL Database Shell Installed**: Ensure that you have the SQL Database shell properly [installed on your system](/en/documentation/guides/application-development/data/install-edge-sql-shell/).
