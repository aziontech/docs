...
meta_tags: >-
  rules, graphql, Data Stream, real-time events, application, edge
  firewall, rules engine
namespace: documentation_how_to_debug_rules
permalink: /documentation/guides/application-development/getting-started/debug-rules/
---
...
<DocButton href="/en/documentation/platform/applications/rules-engine/" label="Learn more about Rules Engine" kind="secondary" size="medium" />
...
:::tip
Check the [GraphQL API documentation](/en/documentation/devtools/graphql/overview/) for more information.
:::

To query the available rules data in the **GraphQL API**, follow the steps described on [How to query GraphQL requests on Postman](/en/documentation/guides/platform/observability/query-graphql-postman/) using the `https://api.azionapi.net/events/graphql` URL.
...
For more information on the **GraphQL API**, visit the [datasets documentation page](/en/documentation/devtools/graphql/features/#datasets).
...
:::tip
See the [Data Stream documentation](/en/documentation/observe/data-stream/) for more information on how to set it up.
:::
...
8. On **Workloads**, select between **Filter Workloads** or **All Current and Future Workloads**. See more about each option on [How to associate domains on Data Stream](/en/documentation/guides/platform/observability/data-stream-associate-workloads/).
...
8. On **Domains**, select between **Filter Domains** or **All Current and Future Domains**. See more about each option on [How to associate domains on Data Stream](/en/documentation/guides/platform/observability/data-stream-associate-domains/).
...
To make sure your logs are being sent to your endpoint through the configured stream, you can use [Real-Time Events](/en/documentation/observe/real-time-events/) to query detailed analysis.
...
:::tip
See the [Real-Time Events documentation](/en/documentation/observe/real-time-events/) for more information on how to configure a Data Stream endpoint.
:::
