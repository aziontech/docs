...
description: >-
  ...
  rule set created using Rules Engine for Applications or Edge Firewall.
meta_tags: >-
...
**Debug Rules** allows you to check whether rules or rule sets created using the **Rules Engine** module for **Application** and **Edge Firewall** have been successfully executed in your application.
...
In this example, the **GraphQL API** has returned all active request and response phase rules created for **Application**, as well as an active **Edge Firewall** rule set.
...
| $traceback | Provides the names of the rules created using Rules Engine for Application and Edge Firewall that are run by the request. |
...
In this example, the **traceback** field contains all active request and response phase rules created for **Application**, as well as an active **Edge Firewall** rule set.
