...
description: The Azion Console Kit allows you to craft a custom Azion interface to fit your business needs. In this guide, you'll learn how to show more information from the Azion API on the Console.
...
The Azion **Console Kit** allows you to craft a custom Azion interface to fit your business needs. In this guide, you'll learn how to show more information from the Azion API on the Console.
...
The goal is to show the TTL values for browser and edge cache, informed by the `browser_cache_settings_maximum_ttl` and `cdn_cache_settings_maximum_ttl` properties in the [Cache Settings API](https://api.azion.com/#fc4c8368-a64d-4743-9064-58e03786edf4). To do so:
...
<AuthorList filePath="src/content/docs/en/pages/guides/devtools/integrate-with-api/index.mdx"/>