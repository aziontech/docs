...
12. **Optional**: to ensure images are successfully converted to WEBP format, you must also add the behavior **Add Request Header** and send the header `Accept: image/webp`.
