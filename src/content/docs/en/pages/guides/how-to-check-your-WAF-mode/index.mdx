...
> If you don’t have a configured WAF Rule Set, check the documentation for more details on [Web Application Firewall Rule Sets](/en/documentation/products/edge-firewall/waf-rule-sets/).
