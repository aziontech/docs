...
permalink: /documentation/platform/real-time-metrics/metrics-dash/
---

Follow the steps described in [How to use a pre-built dashboard with the Azion plugin on Grafana](/en/documentation/guides/platform/observability/azion-plugin-grafana-pre-built-dash/) and then use the following JSON with the `https://api.azionapi.net/metrics/graphql` URL to create a dashboard on Grafana with data from the Real-Time Metrics GraphQL API such as:
