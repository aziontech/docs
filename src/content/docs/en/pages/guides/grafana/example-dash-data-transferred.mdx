...
description: >-
  You can use the JSON example to create a dashboard on Grafana with the Data
  Transferred metrics from Real-Time Metrics.
meta_tags: 'graphql, grafana, data, observability, application'
namespace: docs_grafana_data_transferred_dash_json
permalink: /documentation/platform/real-time-metrics/data-transferred-dash/
---

To create a dashboard on Grafana with the **Data Transferred** metrics from [Real-Time Metrics](/en/documentation/platform/real-time-metrics/), follow the steps described in [How to use a pre-built dashboard with the Azion plugin on Grafana](/en/documentation/guides/platform/observability/azion-plugin-grafana-pre-built-dash/) and then use the following JSON with the `https://api.azionapi.net/metrics/graphql` URL:
