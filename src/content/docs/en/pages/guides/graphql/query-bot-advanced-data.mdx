...
The **botManagerMetrics** dataset provides access real-time aggregated data from Azion Bot Manager Advanced activity, related to bot traffic, actions, and behavior across your applications. This dataset is part of the [Real-Time Metrics GraphQL API](/en/documentation/devtools/graphql-api/features/gql-real-time-metrics-fields/) and is generated from the requests analyzed and identified as bots, whether they're good or bad.
...
This guide will explain how to query Bot Manager Advanced data using the GraphiQL playground.

:::note
To retrieve this data, you must be subscribed to Azion Bot Manager Advanced and use the [GraphQL API](https://www.azion.com/en/documentation/devtools/graphql-api/overview/). Contact the [Sales team](https://www.azion.com/en/contact-sales/) for more details on the subscription.
:::
...
| Field | Description |
|----------|----------|
| `action` | Action performed by Azion Bot Manager Advanced for accesses identified as Bots |
