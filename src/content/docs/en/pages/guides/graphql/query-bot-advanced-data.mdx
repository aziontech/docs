...
The **botManagerMetrics** dataset provides access real-time aggregated data from Azion Bot Manager Advanced activity, related to bot traffic, actions, and behavior across your applications. This dataset is part of the Real-Time Metrics GraphQL API and is generated from the requests analyzed and identified as bots, whether they're good or bad, or legitimate traffic.
...
:::note
To retrieve this data, you must be subscribed to Azion Bot Manager Advanced and use the [GraphQL API](/en/documentation/devtools/graphql-api/overview/). Contact the [Sales team](https://www.azion.com/en/contact-sales/) for more details on the subscription.
:::
