...
permalink: /documentation/guides/platform/observability/query-data-stream-usage-data-with-graphql/
---
...
This guide explains how to query the total data streamed by Data Stream using the [GraphiQL Playground](/en/documentation/devtools/graphql/graphql-playground/).
