...
permalink: /documentation/guides/platform/observability/query-top-ips-attack-traffic-with-graphql/
---
...
:::tip
To know more about the available fields, check the [Real-Time Events GraphQL API Fields documentation](/en/documentation/devtools/graphql/gql-real-time-events-fields/#httpevents-edge-applications-waf).
:::
