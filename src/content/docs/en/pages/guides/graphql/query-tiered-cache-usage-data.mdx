...
This guide explains how to query the total data transferred by Tiered Cache using the [GraphiQL Playground](/en/documentation/devtools/graphql/graphql-playground/).
