...
permalink: /documentation/guides/platform/observability/graphql-top-x-query/
---
...
To query Top X queries through the [GraphQL API](/en/documentation/devtools/graphql/overview/), follow the steps described on [How to query GraphQL requests on Postman](/en/documentation/guides/platform/observability/query-graphql-postman/) using the `https://api.azionapi.net/events/graphql` URL.
