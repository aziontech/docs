...
description: Unlock the power of GraphQL API metadata with this guide to understand the relationship and the utility of the request processes using the available datasets.
...
<iframe
   src="https://www.youtube.com/embed/PB2Oe5Dyd94"
   title="How to query metadata with GraphQL API"
   loading="lazy"
   width="600"
   height="400"
