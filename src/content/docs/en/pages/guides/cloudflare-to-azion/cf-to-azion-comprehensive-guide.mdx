...
permalink: /documentation/guides/platform/migration/cloudflare-migration-guide/
---
...
* [Rules Engine variables and operators](https://www.azion.com/en/documentation/platform/applications/rules-engine/#variables)
* [Applications reference](https://www.azion.com/en/documentation/platform/applications/)
...
* [SQL Database API (Runtime)](https://www.azion.com/en/documentation/devtools/runtime/api-reference/sql-database/.md)
* [Azion Lib SQL (SDK)](https://www.azion.com/en/documentation/devtools/azion-lib/sql/.md)
