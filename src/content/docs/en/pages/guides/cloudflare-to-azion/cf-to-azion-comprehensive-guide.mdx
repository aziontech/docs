...
| :----- | :----------------- | :----------------------- |
| **Certificate types** | Universal SSL, Custom | Azion SAN, Let's Encrypt, Custom |
| **Validation** | HTTP-01, DNS-01 | HTTP-01, DNS-01 |
| **Renewal** | Automatic | Automatic for Let's Encrypt |
| **Edge certificates** | Managed | Managed |
| **mTLS support** | Supported | Supported (requires Trusted CA) |
...
| :----- | :-------------- | :----------------------------------- |
| **Access method** | Pull API, Push to S3 | Real-time query, Push to 10+ destinations |
