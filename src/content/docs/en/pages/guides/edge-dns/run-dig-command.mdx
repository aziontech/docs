...
<LinkButton link="https://console.azion.com/signup/" label="create Azion account" outlined /> <br></br>

<LinkButton link="/en/documentation/products/guides/secure/edge-dns-configure-main-settings/" label="create zone" outlined />

If you've configured a load balance with a DNS record, you can test and check if the load balance is working properly.

<LinkButton link="/en/documentation/products/guides/secure/load-balance-dns/#testing-your-balanced-record" label="test balanced record" outlined />
