...
<iframe width="560" height="315" src="https://www.youtube.com/embed/KB4f4bSyHgI?si=m80i1wUfkARz7Ifg" title="Dig into DNS: Install & Use Dig Command Like a Pro" loading="lazy" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
<LinkButton outlined link="/en/documentation/products/guides/secure/edge-dns-configure-main-settings/" label="Create zone" outlined /> <br></br>
