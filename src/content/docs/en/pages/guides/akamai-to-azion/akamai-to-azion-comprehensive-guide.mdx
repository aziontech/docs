...
permalink: /documentation/guides/platform/migration/akamai-migration-guide/
---
...
| :------------------------ | :---------- | :--------------- |
| **Ion** | Web performance, reliability, and user experience optimization at scale. | [Applications](https://www.azion.com/en/documentation/platform/applications/) + [Application Accelerator](https://www.azion.com/en/documentation/build/application-accelerator/) + [Cache](https://www.azion.com/en/documentation/build/cache/) |
| **API Acceleration** | API performance and reliability optimization. | [Application Accelerator](https://www.azion.com/en/documentation/build/application-accelerator/) + [Cache](https://www.azion.com/en/documentation/build/cache/) |
| **Adaptive Media Delivery** | Large-scale online video delivery. | [Applications](https://www.azion.com/en/documentation/platform/applications/) + [Cache](https://www.azion.com/en/documentation/build/cache/) + [Object Storage](https://www.azion.com/en/documentation/store/object-storage/) |
| **Download Delivery** | Optimized delivery for large files, software, games, and media assets. | [Applications](https://www.azion.com/en/documentation/platform/applications/) + [Cache](https://www.azion.com/en/documentation/build/cache/) + [Object Storage](https://www.azion.com/en/documentation/store/object-storage/) |
| **Dedicated Delivery** | High-volume media delivery with origin offload requirements. | [Applications](https://www.azion.com/en/documentation/platform/applications/) + [Cache](https://www.azion.com/en/documentation/build/cache/) + [Tiered Cache](https://www.azion.com/en/documentation/build/cache/tiered-cache/) |
| **Image & Video Manager** | Image and video optimization for devices and network conditions. | [Image Processor](https://www.azion.com/en/documentation/build/image-processor/) |
| **Media Services Live** | Live video ingest and delivery workflows. | [Applications](https://www.azion.com/en/documentation/platform/applications/) + [Cache](https://www.azion.com/en/documentation/build/cache/) + [Live ingest best practices](https://www.azion.com/en/documentation/guides/application-performance/delivery-optimization/live-ingest-best-practices/) |
| **Cloudlets** | Predefined policy applications for redirects, load balancing, traffic control, phased releases, and request handling. | [Rules Engine for Applications](https://www.azion.com/en/documentation/platform/applications/rules-engine/) + [Functions](https://www.azion.com/en/documentation/build/functions/) + [Load Balancer](https://www.azion.com/en/documentation/platform/load-balancer/) + [Firewall](https://www.azion.com/en/documentation/platform/firewall/) |
| **Cloud Wrapper** | Private caching layer for origin offload and reduced egress. | [Tiered Cache](https://www.azion.com/en/documentation/build/cache/tiered-cache/) + [Origin Shield](https://www.azion.com/en/documentation/secure/origin-shield/) + [Cache](https://www.azion.com/en/documentation/build/cache/) |
| **EdgeWorkers** | JavaScript functions that customize request and response behavior. | [Functions for Applications](https://www.azion.com/en/documentation/build/functions/) |
| **Akamai Functions** | Distributed serverless execution for application and AI workloads. | [Functions](https://www.azion.com/en/documentation/build/functions/) |
| **EdgeKV** | Distributed key-value data for EdgeWorkers applications. | [KV Store](https://www.azion.com/en/documentation/store/kv-store/) |
| **API Gateway** | API registration, routing, delivery, and protection. | [Applications](https://www.azion.com/en/documentation/platform/applications/) + [Rules Engine](https://www.azion.com/en/documentation/platform/applications/rules-engine/) + [Functions](https://www.azion.com/en/documentation/build/functions/) + [Firewall](https://www.azion.com/en/documentation/platform/firewall/) |
| **App Platform** | Managed containerized application deployment. | [Orchestrator](https://www.azion.com/en/documentation/build/orchestrator/) |
| **Akamai Inference Cloud** | Distributed AI inference platform. | [AI Inference](https://www.azion.com/en/documentation/build/ai-inference/) |
| **App & API Protector** | Application and API protection against vulnerabilities, abuse, and distributed threats. | [Firewall](https://www.azion.com/en/documentation/platform/firewall/) + [Web Application Firewall](https://www.azion.com/en/documentation/secure/waf/) + [DDoS Protection](https://www.azion.com/en/documentation/platform/ddos-protection/) + [Bot Manager](https://www.azion.com/en/documentation/secure/bot-manager/) |
| **Firewall for AI** | Protection for LLM and AI-driven applications. | [Firewall](https://www.azion.com/en/documentation/platform/firewall/) + [AI Inference](https://www.azion.com/en/documentation/build/ai-inference/) |
| **API Security** | API discovery, monitoring, and protection workflows. | [Firewall](https://www.azion.com/en/documentation/platform/firewall/) + [Web Application Firewall](https://www.azion.com/en/documentation/secure/waf/) + [Applications](https://www.azion.com/en/documentation/platform/applications/) |
| **Bot Manager** | Bot detection and automated traffic response. | [Bot Manager](https://www.azion.com/en/documentation/secure/bot-manager/) |
| **Account Protector** | Protection for account abuse and credential attacks. | [Bot Manager](https://www.azion.com/en/documentation/secure/bot-manager/) + [Firewall](https://www.azion.com/en/documentation/platform/firewall/) |
| **Content Protector** | Protection against content scraping and abusive automated access. | [Bot Manager](https://www.azion.com/en/documentation/secure/bot-manager/) + [Firewall](https://www.azion.com/en/documentation/platform/firewall/) + [Rules Engine for Applications](https://www.azion.com/en/documentation/platform/applications/rules-engine/) |
| **Input Validation Cloudlet** | Form and request validation controls. | [Firewall](https://www.azion.com/en/documentation/platform/firewall/) + [Rules Engine for Firewall](https://www.azion.com/en/documentation/platform/firewall/rules-engine/) |
| **Request Control Cloudlet** | Fast access control and request filtering. | [Firewall](https://www.azion.com/en/documentation/platform/firewall/) + [Rules Engine for Firewall](https://www.azion.com/en/documentation/platform/firewall/rules-engine/) |
| **Cloud Firewall** | Network security controls for cloud workloads. | [Network Shield](https://www.azion.com/en/documentation/secure/network-shield/) + [Firewall](https://www.azion.com/en/documentation/platform/firewall/) |
| **Prolexic Solutions** | DDoS protection for infrastructure, cloud, hybrid, and on-premises environments. | [DDoS Protection](https://www.azion.com/en/documentation/platform/ddos-protection/) + [Network Shield](https://www.azion.com/en/documentation/secure/network-shield/) |
| **Forward Rewrite Cloudlet** | URL rewrite logic for clean and semantic URLs. | [Rules Engine for Applications](https://www.azion.com/en/documentation/platform/applications/rules-engine/) + [Functions](https://www.azion.com/en/documentation/build/functions/) |
| **Phased Release Cloudlet** | Gradual release and rollback control. | [Rules Engine for Applications](https://www.azion.com/en/documentation/platform/applications/rules-engine/) + [Applications](https://www.azion.com/en/documentation/platform/applications/) |
| **API Prioritization Cloudlet** | API traffic prioritization. | [Rules Engine for Applications](https://www.azion.com/en/documentation/platform/applications/rules-engine/) + [Application Accelerator](https://www.azion.com/en/documentation/build/application-accelerator/) |
| **Application Load Balancer Cloudlet** | Application load balancing for performance and availability. | [Load Balancer](https://www.azion.com/en/documentation/platform/load-balancer/) |
| **Audience Segmentation Cloudlet** | Cookie-based segmentation, A/B testing, and session affinity patterns. | [Rules Engine for Applications](https://www.azion.com/en/documentation/platform/applications/rules-engine/) + [Applications](https://www.azion.com/en/documentation/platform/applications/) |
| **Edge Redirector Cloudlet** | Centralized redirect management. | [Rules Engine for Applications](https://www.azion.com/en/documentation/platform/applications/rules-engine/) + [Applications](https://www.azion.com/en/documentation/platform/applications/) |
| **NodeBalancers** | Layer 4 and Layer 7 load balancing for compute instances. | [Load Balancer](https://www.azion.com/en/documentation/platform/load-balancer/) |
| **DNS Infrastructure** | DNS services for provider and enterprise environments. | [Edge DNS](https://www.azion.com/en/documentation/secure/edge-dns/) |
| **Edge DNS** | Highly available authoritative DNS. | [Edge DNS](https://www.azion.com/en/documentation/secure/edge-dns/) |
| **Global Traffic Management** | Traffic steering for performance optimization and outage avoidance. | [Load Balancer](https://www.azion.com/en/documentation/platform/load-balancer/) + [Edge DNS](https://www.azion.com/en/documentation/secure/edge-dns/) |
| **DNS Manager** | DNS record management interface. | [Edge DNS](https://www.azion.com/en/documentation/secure/edge-dns/) |
| **NetStorage** | Replicated storage for content delivery. | [Object Storage](https://www.azion.com/en/documentation/store/object-storage/) |
| **Object Storage** | Durable object storage for data and distribution use cases. | [Object Storage](https://www.azion.com/en/documentation/store/object-storage/) |
| **Managed Databases** | Managed relational database workloads. | [SQL Database](https://www.azion.com/en/documentation/store/sql-database/) |
| **Akamai TrafficPeak** | Observability for operations and security visibility. | [Real-Time Metrics](https://www.azion.com/en/documentation/platform/real-time-metrics/) + [Real-Time Events](https://www.azion.com/en/documentation/observe/real-time-events/) + [Data Stream](https://www.azion.com/en/documentation/observe/data-stream/) |
| **DataStream** | Low-latency data feed to third-party monitoring tools. | [Data Stream](https://www.azion.com/en/documentation/observe/data-stream/) |
| **mPulse** | Real-user monitoring and digital experience analytics. | [Edge Pulse](https://www.azion.com/en/documentation/observe/edge-pulse/) + [Real-Time Metrics](https://www.azion.com/en/documentation/platform/real-time-metrics/) |
...
* [Origin Shield](https://www.azion.com/en/documentation/secure/origin-shield/)
...
* [Advanced Cache Key](https://www.azion.com/en/documentation/guides/application-performance/cache-and-purge/advanced-cache-key/)
* [Tiered Cache](https://www.azion.com/en/documentation/build/cache/tiered-cache/)
...
* [How to enforce HLS cache for live streaming delivery](https://www.azion.com/en/documentation/guides/application-performance/cache-and-purge/enforce-hls-cache/)
...
* [Application Accelerator](https://www.azion.com/en/documentation/build/application-accelerator/)
...
* [Certificate Manager](/en/documentation/platform/certificate-manager/for-firewall/)
...
* [WAF Rule Sets](https://www.azion.com/en/documentation/secure/waf/rules-set/)
...
* [Edge DNS](https://www.azion.com/en/documentation/secure/edge-dns/)
* [How to configure Edge DNS main settings](https://www.azion.com/en/documentation/guides/application-security/dns/edge-dns-configure-main-settings/)
* [How to add DNS records](https://www.azion.com/en/documentation/guides/application-security/dns/add-records/)
* [Load Balancer](https://www.azion.com/en/documentation/platform/load-balancer/)
...
* [Manage KV Store with Functions](https://www.azion.com/en/documentation/guides/application-development/data/manage-with-functions/)
* [KV Store API](https://www.azion.com/en/documentation/store/kv-store/kv-client/)
* [Functions](https://www.azion.com/en/documentation/build/functions/)
...
* [How to create and query data on SQL Database](https://www.azion.com/en/documentation/guides/application-development/data/create-tables-sql-database/)
* [How to import data to SQL Database](https://www.azion.com/en/documentation/guides/application-development/data/import-data-sql-database/)
* [How to retrieve data from a database with SQL Database and Functions](https://www.azion.com/en/documentation/guides/application-development/data/retrieve-data-with-functions/)
...
* [How to configure sampling on Data Stream](https://www.azion.com/en/documentation/guides/platform/observability/configure-sampling/)
* [How to select variables on Data Stream](https://www.azion.com/en/documentation/guides/platform/observability/data-stream-select-variables/)
...
* [Edge Pulse first steps](https://www.azion.com/en/documentation/observe/edge-pulse/first-steps/)
* [How to analyze navigation data from Edge Pulse](https://www.azion.com/en/documentation/guides/platform/observability/analyze-navigation-data/)
...
* [Understand Real-Time Events logs](https://www.azion.com/en/documentation/guides/platform/observability/understand-logs/)
...
* [Review Data Stream](https://www.azion.com/en/documentation/observe/data-stream/)
