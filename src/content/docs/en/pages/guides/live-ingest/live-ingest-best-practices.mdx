...
permalink: /documentation/guides/application-performance/delivery-optimization/live-ingest-best-practices/
...
- Basic knowledge of [Applications](/en/documentation/platform/applications/) and [Cache Settings](/en/documentation/build/cache/cache-settings/).
- Familiarity with the [Rules Engine](/en/documentation/platform/applications/rules-engine/) for Applications.
...
See the documentation on [how to query connected users data with GraphQL API](/en/documentation/guides/platform/observability/query-connected-users-data-with-graphql/) to implement custom monitoring dashboards.
...
See the guide [Implement HLS cache](/en/documentation/guides/application-performance/cache-and-purge/enforce-hls-cache/) for detailed instructions.
...
- [Live Streaming Delivery with HLS](/en/documentation/guides/application-performance/delivery-optimization/live-streaming-delivery-with-hls/)
- [Implement HLS cache](/en/documentation/guides/application-performance/cache-and-purge/enforce-hls-cache/)
- [Applications](/en/documentation/platform/applications/)
...
- [Real-Time Metrics](/en/documentation/platform/real-time-metrics/)
- [Query connected users data with GraphQL API](/en/documentation/guides/platform/observability/query-connected-users-data-with-graphql/)