...
- [How to add Bot Manager to an existent Edge Firewall instance with a template](/en/documentation/products/guides/bot-manager-with-edge-firewall-template/)
- [How to block Tor Exit Nodes requests using a template](/en/documentation/products/guides/block-tor-exit-nodes-template/)
...
- [How to test Bot Manager using a template](/en/documentation/products/guides/bot-manager-basic-template/)
