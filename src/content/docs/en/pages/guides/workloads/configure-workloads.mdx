---
title: How to configure a Workloads
description: >-
  Use Azion Workloads to enable browser access to your app, allowing user traffic
...
5. In the **Subdomain** and **Domain** fields, you may list [custom domain](#linking-a-custom-domain-to-your-application) addresses to link to your application.
