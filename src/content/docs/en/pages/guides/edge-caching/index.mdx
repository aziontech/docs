...
> See the [Bypass Cache](/en/documentation/products/edge-application/rules-engine/#bypass-cache) documentation to find out more about the difference between this behavior and TTL set to zero.
