...
A TTL zero is not the same as a cache bypass. For more details, read about the difference between these settings on the [Bypass cache](/en/documentation/products/edge-application/rules-engine/#difference-between-bypass-cache-and-ttl-0) documentation.
:::
