...
<Button href="link_edge_app" variant="secondary" text="Go to Edge Application documentation"></Button>
...
Customize your TLS cipher suite and edit the minimum TLS version by doing the following:
