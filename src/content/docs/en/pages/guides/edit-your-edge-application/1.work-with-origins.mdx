...
5. Leave **Origin Path** blank.
  ...
  The path included in this field will be appended to the origin address, which should be an apex domain. You may add multiple layers to the path if needed.
...
Only paths configured via Rules Engine become active in your application. When accessing a path with an unconfigured origin, you should receive a `404` error.
