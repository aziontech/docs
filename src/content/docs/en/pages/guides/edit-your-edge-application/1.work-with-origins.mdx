...
In this section, you will add a new origin to your application. The default origin will maintain its original behavior, but the
...
You've created a new origin, but it's not active in your application yet. First, you need to define what will trigger a request to the new origin and for this, you can use your edge application's **Rules Engine**.
