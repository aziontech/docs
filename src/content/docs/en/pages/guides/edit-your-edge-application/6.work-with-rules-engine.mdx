...
permalink: /documentation/products/guides/build/work-with-rules/
---
...
6. Run the following `POST` request to create a rule in the **Response Phase**, replacing the edge application ID value:
