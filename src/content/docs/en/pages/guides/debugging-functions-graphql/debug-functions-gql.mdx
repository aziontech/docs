...
<DocCardGroup cols={2}>
  ...
  <DocCard title="How to debug functions on Data Stream" href="/en/documentation/guides/platform/observability/debugging-functions-data-stream/" label="Send the same log output to an endpoint you own." />
</DocCardGroup>
