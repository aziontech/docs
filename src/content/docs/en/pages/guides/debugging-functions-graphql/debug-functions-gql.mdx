...
You can use the [debugging process](/en/documentation/build/functions/) to identify errors in your functions. One of the options for debugging is using the [GraphQL API](/en/documentation/devtools/graphql/overview/).

To do so, follow the steps described on [How to query GraphQL requests on Postman](/en/documentation/guides/platform/observability/query-graphql-postman/) using the `https://api.azionapi.net/events/graphql` URL.
