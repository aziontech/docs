...
description: This documentation explains how the Azion GitHub App works and how to manage it according to your preferences.
...
After you finish the installation of the Azion GitHub App, you can find it as part of your installed applications in the **Settings** of your GitHub account. Check the [Managing the Azion GitHub App](#managing-the-github-app) section for more details.
...
1. Find the Azion GitHub App.
2. Click the **Configure** button.
3. On the *Danger zone* section, click the **Uninstall** button. A modal will appear requesting to confirm the action.
...
1. On the **Authorized GitHub Apps** list:
2. Find the Azion GitHub App and click the **Revoke** button.
