...
**Azion Object Storage** allows you to create buckets and integrate your object storage with your edge infrastructure. This guide covers how to create and serve a static application hosted using Object Storage using the [Azion API](https://api.azion.com) and [Real-Time Manager](https://manager.azion.com).
