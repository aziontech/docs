---
title: How to use an Azion Object Storage bucket as the origin of a static edge application
...
## Create an edge application and set origin type to Object Storage
