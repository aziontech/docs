...
**Object Storage** allows you to create buckets and integrate your object storage with your edge infrastructure. This guide covers how to create, modify, and delete a bucket using the [Azion API](https://api.azion.com).
