...
**Azion Object Storage** allows you to create buckets and integrate your object storage with your edge infrastructure. This guide covers how to upload and download objects from a bucket using the [Azion API](https://api.azion.com) and [Edge Runtime](/en/documentation/devtools/runtime/api-reference/storage/).

<Button href="/en/documentation/products/store/object-storage/" text="go to Object Storage reference" variant="secondary"></Button>
