---
title: How to upload and download objects from an Azion Object Storage bucket
...
**Object Storage** allows you you to create buckets and integrate your object storage with your edge infrastructure. This guide covers how to upload and download objects from a bucket using the [Azion API](https://api.azion.com) and [Edge Runtime](/en/documentation/devtools/runtime/overview/).
...
Read [How to create and modify an Azion Object Storage bucket](/en/documentation/products/guides/how-to-upload-and-download-objects-from-bucket/) for bucket operations.
