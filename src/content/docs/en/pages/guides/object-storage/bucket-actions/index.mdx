...
**Azion Object Storage** allows you you to create buckets and integrate your object storage with your edge infrastructure. This guide covers how to upload and download objects from a bucket using the [Azion API](https://api.azion.com) and [Edge Runtime](/en/documentation/devtools/runtime/overview/).
