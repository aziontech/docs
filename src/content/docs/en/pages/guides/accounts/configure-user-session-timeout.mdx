...
description: This guide walks you through configuring the User Session Timeout feature to protect your account from unauthorized access.
...
The **User Session Timeout** feature enables you to define a **maximum idle time**, ensuring that sessions are automatically terminated after a period of inactivity. It also allows you to define a **maximum session time** to avoid sessions staying open indefinitely.

This guide walks you through configuring the User Session Timeout feature.
...
This means the feature is configured with *1 minute for the maximum idle time and 5 minutes for the maximum session time*.
