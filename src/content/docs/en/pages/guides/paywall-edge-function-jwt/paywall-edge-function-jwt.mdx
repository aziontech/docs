...
**Parameters**: once you've selected the JWT function on you applications a form with the source code will appear in the **Code** field. It's just for information, you can't change it. On the **Args** tab, you'll pass the list of KID pairs (*key IDs*) and secret keys used to generate the signature of the token and save the function. 
