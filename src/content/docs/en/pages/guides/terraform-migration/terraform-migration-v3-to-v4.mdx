...
namespace: documentation_guides_terraform_migration_v3_v4
permalink: /documentation/guides/platform/migration/terraform-migration-v3-to-v4/
redirect_from: /documentation/products/terraform-provider/migration-v3-to-v4/
---
...
- **Personal Token**: A valid [personal token](/en/documentation/fundamentals/personal-tokens/) with appropriate permissions
...
- [Terraform Provider v2.0 Documentation](/en/documentation/devtools/terraform/)
- [Terraform Provider v1.x Documentation](/en/documentation/devtools/terraform/terraform-provider-v3/) (Legacy)
