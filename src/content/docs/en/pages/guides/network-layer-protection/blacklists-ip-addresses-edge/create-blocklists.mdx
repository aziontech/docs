...
permalink: /documentation/guides/application-security/bots-and-network/blocklists-ip-addresses-edge/
---
...
There are separate instructions using [legacy Domains](/en/documentation/platform/workloads/domains/) settings using the new [Workloads](/en/documentation/platform/workloads/) product.
...
To bind the Firewall to a Workload, follow these steps:
To bind the Firewall to a Workload:

1. Still in the Console, go to **Products Menu** > **Workloads**
2. Under **Settings** select the firewall you created.
3. Click the **Save** button.

</Fragment>

<Fragment slot="panel.consoledomains">
To bind the Firewall to a Domain, follow these steps:
To bind the Firewall to a Domain:
...
1. Access [Azion Console](/en/documentation/guides/platform/account-and-billing/how-to-access-azion-console/) > **Network Lists**, from the **Edge Libraries** section.
...
| Field              | Description                                                                                                                                                                |
|--------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `Name`             | Identification name of your Network List. This name will appear in the list of options in the *Criteria* section, within the **Firewall Rules Engine** configuration  |
...
## Associating a Network List with Firewall Rule Set

1. Access [Azion Console](/en/documentation/guides/platform/account-and-billing/how-to-access-azion-console/) > **Firewall**.
2. Select the firewall you created on the [first section](#creating-an-edge-firewall).
