...
<br/>
<Button href="/en/documentation/products/secure/edge-firewall/network-layer-protection/" text="go to Network Layer Protection reference" variant="secondary"></Button>
