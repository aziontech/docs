...
> Learn more about [Network Lists](/en/documentation/products/secure/edge-firewall/network-layer-protection/network-lists/), [Network Layer Protection](/en/documentation/products/secure/edge-firewall/network-layer-protection/), [Edge Firewall modules](/en/documentation/products/secure/edge-firewall/)
...
3. Write the edge firewall identification name on the **Edge Firewall Name** placeholder.
