...
permalink: /documentation/guides/application-security/bots-and-network/retrieve-azion-ip-ranges/
---
...
- The [Network Shield module](/en/documentation/secure/network-shield/) enabled on your Firewall.
...
Run the following request, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/guides/platform/account-and-billing/personal-tokens/):
...
<DocButton href="/en/documentation/secure/network-shield/" label="Secure an infrastructure" kind="secondary" size="medium" />
<DocButton href="/en/documentation/secure/origin-shield/" label="Origin Shield reference" kind="secondary" size="medium" />
<DocButton href="/en/documentation/secure/network-shield/" label="Network Shield reference" kind="secondary" size="medium" />
<DocButton href="/en/documentation/secure/network-shield/network-lists/" label="Network Lists reference" kind="secondary" size="medium" />
