...
3. Under **Deployment Settings** select the edge firewall you wish to use or click the **+ Edge Firewall** button to create a new edge firewall.
4. Click the **Save** button.
5. Still in the Console, go to **Products Menu** > **Edge Firewall**.
...
3. Under **Settings** select the edge firewall you wish to use or click the **+ Edge Firewall** button to create a new edge firewall.
4. Click the **Save** button.
5. Still in the Console, go to **Products Menu** > **Edge Firewall**.
6. Click the **Rules Engine** tab.
7. Click the **+ Rule** button.
