...
## Choose the workloads

After adding a **Trusted CA** to your certificate library, you need to configure which workloads should operate with mTLS.
...
3. Under **Workloads**, select your application domain and click the `>` button to send the chosen domain to **Selected**.
