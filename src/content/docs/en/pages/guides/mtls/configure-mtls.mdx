...
1. Go to the [Real-Time Manager (RTM)](https://console.azion.com) and click on the **Products Menu**, indicated by the ☰ icon. Search for the **Edge Libraries** category and click on **Digital Certificates**.
