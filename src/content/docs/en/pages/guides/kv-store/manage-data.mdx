---
title: Manage KV Store with Functions
description: >-
  Store, retrieve, and delete key-value data from inside a function with the
  KV Store client.
meta_tags: 'kv store, storage, key-value, functions, data'
...
<DocButton href="/en/documentation/store/kv-store/" label="Go to KV Store reference" kind="secondary" size="medium" />
...
- [Functions enabled](/en/documentation/build/functions/) in your application.
- A KV Store namespace created via Console or API.

---

## Create a function that reaches KV Store
...
- Learn more about [KV Store](/en/documentation/store/kv-store/)
