...
permalink: /documentation/guides/application-security/access-and-compliance/unlock-account-lockout-policy/
---
...
<DocButton href="/en/documentation/fundamentals/account-lockout-policy/" label="Go to Account Lockout Policy reference" kind="secondary" target="_blank" size="medium" />
...
To manually unlock a user, you need to [get the logs](/en/documentation/guides/application-security/access-and-compliance/account-lockout-policy-logs/) and confirm the data about the user. Then, execute the unlocking. To do so:
