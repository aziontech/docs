...
permalink: /documentation/guides/application-security/firewall-and-waf/how-to-update-your-firewall/
...
Previously, to use a rule set from Firewall or Web Application Firewall (WAF), you had to activate these modules in the **Main Settings** tab of each applications. Then, criteria and behaviors were applied in the application's **Rules Engine** tab.

Azion **Firewall** has evolved into an independent product including all security functionalities: DDoS Protection, Network Shield, Web Application Firewall, and **Functions**. This update facilitates the creation of new security policies that can be applied globally or specifically. Consequently, rule sets used in deprecated versions of **Firewall** have also been deprecated.
...
<DocButton href="/en/documentation/platform/firewall/" label="Go to Firewall reference" kind="secondary" size="medium" />
...
1. Access [Azion Console](/en/documentation/guides/platform/account-and-billing/how-to-access-azion-console/) > **Network Lists**.
...
3. In **Main Settings**, enable the **Network Shield** module.
...
6. In **Function**, select the **Secure Token** function.
...
After creating and applying the rule for the latest version of Firewall for your domain, you must remove the rules in your applications:

1. Access [Azion Console](/en/documentation/guides/platform/account-and-billing/how-to-access-azion-console/) > **Applications**.
2. Select the applications with the deprecated configurations.
