...
permalink: /documentation/products/guides/how-to-update-your-firewall/
...
<Button href="/en/documentation/products/secure/edge-firewall/" label="Go to Firewall reference" type="primary" theme="light" />
