...
1. Log into [Real-Time Manager](https://console.azion.com/), go to the Products menu in the upper left corner, under **SECURE** select **Edge Firewall**. You can also click directly on Edge Firewall on the Getting started page.
...
1. Access the [Real-Time Manager](https://console.azion.com/) and enter the **Libraries** > **Network Lists** menu.
...
1. Log into [Real-Time Manager](https://console.azion.com/), go to the **Products** menu in the upper left corner and under **BUILD** select **Edge Applications**.
