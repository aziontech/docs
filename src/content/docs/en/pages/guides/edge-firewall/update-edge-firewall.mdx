...
7. For each domain in **Accepted workloads** of the old rule set, click the **+ Add Criteria** button and repeat the step 6.
...
### workloads association

You can also associate one or more workloads with the new edge firewall: 

1. Access [Azion Console](/en/documentation/products/guides/how-to-access-azion-console/) > **Edge Firewall**.
2. Select the firewall you created previously. 
3. In the **Main Settings** tab, go to the **Workloads** section.
    ...
    - Select `>>` to select all workloads presented on the **Available** list.
4. Click the **Save** button.
