...
<DocSteps>
  ...
  <DocStep title="Paste the arguments in the Arguments tab">
...
<DocSteps>
  ...
  <DocStep title="Select the firewall that secures the upload routes" />
  <DocStep title="Turn on the modules the design needs">
...
<DocSteps>
  ...
  <DocStep title="Enter a name for the instance" />
  <DocStep title="Select the function you created" />
  <DocStep title="Select Save" />
</DocSteps>
...
<DocSteps>
  ...
  <DocStep title="Enter a name for the rule" />
  <DocStep title="Select the Request URI variable">

  In the **Criteria** section, select the `Request URI` variable.

  </DocStep>
  <DocStep title="Set the comparison operator to starts with" />
  <DocStep title="Enter the upload route">

  Enter an upload route as the argument, such as `/upload`.

  </DocStep>
  <DocStep title="Select Run Function">
