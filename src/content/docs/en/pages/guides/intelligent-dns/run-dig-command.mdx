...
description: Learn how to effectively use the "dig" command with Windows and Linux, enabling precise DNS querying and troubleshooting and testing it with edge applications.
...
If you have a zone configured in **Azion Edge DNS**, you can test it to check if your zone is working properly.

<LinkButton outlined link="https://console.azion.com/signup/" label="create Azion account" variant="secondary" /> <br></br>

<LinkButton outlined link="/en/documentation/products/guides/secure/edge-dns-configure-main-settings/" label="create zone" variant="secondary" />
...
If you've [configured a zone](/en/documentation/products/guides/secure/edge-dns-configure-main-settings/), you can use the dig command to test how and if it's receiving proper traffic. For example, if you've configured a load balance with a DNS record, you can test and check if the load balance is working properly.

<LinkButton outlined link="/en/documentation/products/guides/secure/load-balance-dns/#testing-your-balanced-record" label="test balanced record" variant="secondary" />
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/KB4f4bSyHgI" title="Looking up DNS servers with Dig command YouTube video" loading="lazy" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
