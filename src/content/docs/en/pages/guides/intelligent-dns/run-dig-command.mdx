...
If you have a zone configured in **Azion Intelligent DNS**, you can test it to see if your zone is working properly.

<Button href="https://console.azion.com/signup/" text="create Azion account" variant="secondary"></Button> <br></br>

<Button href="/en/documentation/products/guides/secure/intelligent-dns-configure-main-settings/" text="create zone" variant="secondary"></Button>
...
If you've [configured a zone](/en/documentation/products/guides/secure/intelligent-dns-configure-main-settings/), you can use the dig command to test how and if it's receiving proper traffic. For example, if you've configured a load balance with DNS record, you can test and see if the load balance is working properly.

<Button href="/en/documentation/products/guides/secure/load-balance-dns/#testing-your-balanced-record" text="test balanced record" variant="secondary"></Button>

You can also check the latency of a web application with the dig command is one of the ways of validating Azion Edge Computing service. For example, you can compare the latency of your application, served by cloud and by Azion Edge Computing platform.

<iframe width="560" height="315" src="https://www.youtube.com/embed/LsXHGoP1sz0" title="Looking up DNS servers with Dig command YouTube video" loading="lazy" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
