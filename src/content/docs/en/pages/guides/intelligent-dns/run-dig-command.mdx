...
<LinkButton outlined link="https://console.azion.com/signup/" label="create Azion account" outlined /> <br></br>

<LinkButton outlined link="/en/documentation/products/guides/secure/edge-dns-configure-main-settings/" label="create zone" outlined />
...
<LinkButton outlined link="/en/documentation/products/guides/secure/load-balance-dns/#testing-your-balanced-record" label="test balanced record" outlined />
