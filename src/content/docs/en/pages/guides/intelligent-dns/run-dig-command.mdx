...
If you have a zone configured in **Azion Intelligent DNS**, you can test it to check if your zone is working properly.
...
If you've [configured a zone](/en/documentation/products/guides/secure/intelligent-dns-configure-main-settings/), you can use the dig command to test how and if it's receiving proper traffic. For example, if you've configured a load balance with a DNS record, you can test and check if the load balance is working properly.
