...
Edge application cloning is not available through the Workloads interface. To clone an edge application, use the traditional Domains interface described in the Console - Domains tab or the API methods.

</Fragment>

<Fragment slot="panel.consoledomain">

To clone an existing edge application via traditional Domains interface: 
...
Edge application cloning is not available via API v4. Use the Console interface to clone edge applications.

</Fragment>

<Fragment slot="panel.apiv3">

Edge application cloning is not available via API v3. Use the Console interface to clone edge applications.
