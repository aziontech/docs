...
description: >-
  Rules Engine is an Application capability that allows you to create
...
**Rules Engine** is an **Application** capability that allows you to create no-code solutions that follow the business rules of your application.
