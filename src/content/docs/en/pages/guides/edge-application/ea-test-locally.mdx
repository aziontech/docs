...
permalink: /documentation/products/guides/stage-applications-through-hosts-file/
---
...
- An application and a [configured domain](/en/documentation/products/guides/configure-a-domain/).
