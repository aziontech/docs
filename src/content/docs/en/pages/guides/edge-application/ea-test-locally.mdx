---
title: How to stage an application through the hosts file
description: >-
...
permalink: /documentation/guides/application-development/getting-started/stage-applications-through-hosts-file/
---

Before you [point your domain to Azion](/en/documentation/guides/platform/migration/point-domain-to-azion/), you can stage running your application on the edge by changing the name resolution of your `hosts` file. This way, you'll have a chance to stage any changes and correct bugs before you publish your application using your custom domain.

:::note
This guide describes how you can test your application's hostname on the edge before pointing your domain to Azion. To run an application in localhost, use the [Azion CLI](/en/documentation/devtools/cli/).
:::
...
- An application and a [configured domain](/en/documentation/guides/platform/migration/configure-a-domain/).
...
:::caution[warning]
For the association to take place, you must first [configure your domain](/en/documentation/guides/platform/migration/configure-a-domain/) and add at least one custom domain CNAME to the domain's CNAME list.
:::
...
In the absence of cache, if your original application is already served on the CNAME you assigned but hasn't undergone [domain record modifications](/en/documentation/guides/platform/migration/point-domain-to-azion/#step-2-modify-domain-records) in the DNS provider, the `hosts` file will serve the application using the custom host.
...
You should now see your Azion domain as if it was in production and perform any necessary tests before [pointing your DNS resolution from your provider](/en/documentation/guides/platform/migration/point-domain-to-azion/) or [migrating your authoritative nameservers](/en/documentation/guides/platform/migration/migrate-ns-to-azion/) to Azion.