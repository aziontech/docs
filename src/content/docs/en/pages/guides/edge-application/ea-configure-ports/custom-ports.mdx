...
permalink: /documentation/guides/application-development/getting-started/configure-ports/
---
...
There are separate instructions for API v3 using [legacy Origins](/en/documentation/platform/connectors/origins/) settings and API v4 using the new [Connectors](/en/documentation/platform/connectors/) product.

:::tip
If you're not sure which steps apply to your account, see [the Verify Your Account Migration guide](/en/documentation/guides/application-security/access-and-compliance/verify-account-migration/) to determine if your account has already been migrated.
:::
...
1. Access [Azion Console](/en/documentation/guides/platform/account-and-billing/how-to-access-azion-console/) > **Connectors**.
...
6. Access [Azion Console](/en/documentation/guides/platform/account-and-billing/how-to-access-azion-console/) > **Workloads**.
...
:::tip
You can also use **Rules Engine** and [create a rule](/en/documentation/guides/application-development/getting-started/work-with-rules-engine/) using the behavior **Redirect HTTP to HTTPS** to prevent your users from accessing application through the HTTP protocol given a specific scenario.
:::
...
5. In **Address**, type the hostname of your origin. Example: `yourorigin.com`.
6. Click the **Save** button.
7. Access [Azion Console](/en/documentation/guides/platform/account-and-billing/how-to-access-azion-console/) > **Workloads**.
...
2. Access [Azion Console](/en/documentation/guides/platform/account-and-billing/how-to-access-azion-console/) > **Connectors**.
...
1. Access [Azion Console](/en/documentation/guides/platform/account-and-billing/how-to-access-azion-console/) > **Applications**.
