---
title: How to configure HTTP and HTTPS ports for edge connector and delivery address
description: >-
...
The choice of delivery ports are limited to those supported by Azion. However, for edge connector of the **Single Origin** or **Load Balancer** types, you can retrieve your content from the appropriate origin port, as long as the port exists.
...
1. In the **Edge Connector** tab, select the default origin or add a new origin.
...
2. Go to the **Edge Connector** tab.
