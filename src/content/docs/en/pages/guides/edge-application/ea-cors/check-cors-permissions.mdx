...
permalink: /documentation/guides/application-development/getting-started/cross-origin-resource-sharing-cors/
---
...
The first step in allowing CORS access is to create a rule in [Rules Engine](/en/documentation/platform/applications/rules-engine/):
...
To enable CORS within a configuration for specific origin servers, you'll need to enable the [Application Accelerator](/en/documentation/build/application-accelerator/) module:
