...
## Enabling CORS permission for specific edge connector
...
Now you need to create a rule that processes requests from multiple edge connector:
...
| Field | Value |
|-----------|------|
| **Name** | Multiple edge connector CORS |
| **Phase** | Response Phase |
