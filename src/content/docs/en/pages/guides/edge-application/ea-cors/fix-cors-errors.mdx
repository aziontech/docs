...
To solve this type of error, configure your browser on [Real-Time Manager (RTM)](https://console.azion.com/) using [Rules Engine](/en/documentation/products/build/edge-application/rules-engine/).
...
Go to [RTM](https://console.azion.com/) and proceed as follows:
