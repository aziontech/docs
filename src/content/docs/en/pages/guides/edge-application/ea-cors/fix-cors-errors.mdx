...
permalink: /documentation/guides/application-development/getting-started/cors-errors/
---
...
To solve this type of error, configure your browser on [Azion Console](https://console.azion.com) using [Rules Engine](/en/documentation/platform/applications/rules-engine/).
...
1. Access [Console](/en/documentation/guides/platform/account-and-billing/how-to-access-azion-console/) > **Applications**.
