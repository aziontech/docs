...
To solve this type of error, configure your browser on [Azion Console](https://console.azion.com) or [Azion Real-Time Manager (RTM)](https://manager.azion.com/) using [Rules Engine](/en/documentation/products/build/edge-application/rules-engine/).
...
1. Access [Console](/en/documentation/products/guides/how-to-access-rtm/) > **Edge Application**.
