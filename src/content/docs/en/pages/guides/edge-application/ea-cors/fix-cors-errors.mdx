...
To solve this type of error, configure your browser on [Real-Time Manager (RTM)](https://manager.azion.com/) using [Rules Engine](/en/documentation/products/build/edge-application/rules-engine/).
