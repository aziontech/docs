...
Edge application deletion is not available through the Workloads interface. To delete an edge application, use the traditional Domains interface described in the Console - Domains tab or the API methods.
