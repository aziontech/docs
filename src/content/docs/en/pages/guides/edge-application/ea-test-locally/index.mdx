...
description: By changing your device's name resolution in the hosts file, you can test your application on the edge before pointing your domain to Azion.
