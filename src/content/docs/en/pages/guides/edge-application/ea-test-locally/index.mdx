...
You'll receive a response containing the Azion domain and the IP address of the edge node:
...
:::caution[warning]
Most browsers keep DNS resolution in cache. That means that if you've previously accessed your application using the CNAME you configured in the domain, your browser may serve your application using the IP from cache and not from the edge node.
:::
