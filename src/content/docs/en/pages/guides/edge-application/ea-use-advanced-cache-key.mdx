...
description: Learn how you can improve the performance of your application and APIs by configuring content cache policies based on the Query String or Cookie of a page using Application Accelerator for Edge Application.
...
4. Select the application you want to configure or [create a new one](/en/documentation/products/guides/build/build-an-application/).
5. On the **Main settings** tab, under the **Modules** section, enable the **Application Accelerator** switch.
...
2. On the upper-left corner of the page, select **Products menu**, represented by three horizontal lines.
3. Under **BUILD**, click **Edge Application**.
4. Select the application and ensure **Application Accelerator** is active.
...
5. Give your setting an easy-to-remember name.
7. Configure **Browser Cache Settings** and **Edge Cache Settings** as desired.
