...
To create an Azion **Domain**, you must have an edge application. If you haven't created an edge application yet, follow the [Getting started](/en/documentation/products/get-started/) guide.
...
<Fragment slot="panel.rtm">
1. Access [Real-Time Manager (RTM)](https://manager.azion.com/), access the **Products menu**.
