...
You may choose to generate a Let’s Encrypt certificate for domain records hosted in [Intelligent DNS](/en/documentation/products/secure/intelligent-dns/) or in the external DNS provider of your top-level domain.
...
Azion allows you to host DNS zones by redirecting the DNS resolution of a domain to **Intelligent DNS**. When using Intelligent DNS, all configurations needed are made through **Azion Console**.
...
> For more information on how to redirect your domain's authoritative DNS servers, see the [Intelligent DNS](/en/documentation/products/secure/intelligent-dns/) documentation.
...
1. In the **Intelligent DNS** page in [Azion Console](https://console.azion.com), select the desired zone.
