...
1. In the **Intelligent DNS** page in [RTM](https://console.azion.com), select the desired zone.
...
1. In [Real-Time Manager](https://console.azion.com), access the **Products menu**.
