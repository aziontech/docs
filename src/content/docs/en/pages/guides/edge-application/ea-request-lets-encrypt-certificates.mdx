...
To create a **Workload**, you must have an edge application. If you haven't created an edge application yet, check the [Build an application documentation](/en/documentation/products/guides/build/build-an-application/).
