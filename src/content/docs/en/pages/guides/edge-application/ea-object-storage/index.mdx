...
```bash
curl --location --request PATCH 'https://api.azionapi.net/storage/buckets' \
...
## Option 1: Run cURL commands to upload and retrieve object from storage



## Option 2: Run edge function to upload and retrieve object from storage
...
Now you can copy the link of the edge application and execute the commands from the function.
