---
title: How to create and manage an object storage bucket
description: Learn how to create your buckets and upload, list, and delete files in your object storage.
...
**Azion Object Storage** allows you you to create buckets and integrate your object storage with your edge infrastructure. This guide covers how to create a storage bucket, and upload, list, and delete objects.
...
Now you need to create an edge function to upload objects to your bucket using a `POST` console command and see if an object is available using a `GET` console command. To do so:
