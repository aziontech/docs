...
**Object Storage** allows you you to create buckets and integrate your object storage with your edge infrastructure. This guide covers how to create a storage bucket, and upload, list, and delete objects using [Azion API](https://api.azion.com), [Edge Runtime](/en/documentation/devtools/runtime/api-reference/storage/), or Azion CLI.
