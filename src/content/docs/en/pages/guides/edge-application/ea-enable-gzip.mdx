...
permalink: /documentation/guides/application-performance/delivery-optimization/gzip-compression/
---
...
:::note
**Brotli compression** is also available for Applications. Brotli typically achieves better compression ratios than gzip, resulting in smaller file sizes and faster delivery. To enable Brotli compression for your application, contact [Azion Support](https://www.azion.com/en/documentation/support/).
:::
...
You can enable gzip compression for any application using the [Rules Engine for Applications](/en/documentation/platform/applications/rules-engine/).
