...
- An existing Azion application, or [create a new one](/en/documentation/guides/application-development/getting-started/build-an-application/).
- [A domain associated with the application](/en/documentation/guides/platform/migration/configure-a-domain/).
- [Tiered Cache enabled](/en/documentation/guides/platform/account-and-billing/billing-and-subscriptions/) in your account.
...
1. Open [Azion CLI](/en/documentation/devtools/cli/) in your terminal.
...
:::tip
Read more about setting up [cache settings](/en/documentation/build/cache/cache-settings/) for your applications.
:::
...
:::tip
Go to the [Rules Engine for Applications](/en/documentation/platform/applications/rules-engine/) documentation for more details.
:::

<DocButton href="/en/documentation/guides/application-performance/delivery-optimization/live-streaming-delivery-with-hls/" label="Go to Live Streaming Delivery architecture" kind="secondary" size="medium" />
