...
<LinkButton link="/en/documentation/architecture/live-streaming-delivery/live-streaming-delivery-with-hls/" label="Go to Live Streaming Delivery architecture" severity="secondary" />
