...
The cache setting appears in the **Cache Settings** tab. The same setting can also vary the cached object by query string or by cookie, which is the [Advanced Cache Key](/en/documentation/build/cache/cache-settings/#advanced-cache-key) feature.
