...
description: Learn how you can optimize processing times by defining the time-to-live (TTL) for cached content at the origin and at the browser, bypass origin cache settings, and forward cookies using Application Accelerator for Edge Application.
...
<LinkButton link="/en/documentation/products/build/edge-application/rules-engine/#bypass-cache" label="Go to Bypass Cache reference" outlined />
