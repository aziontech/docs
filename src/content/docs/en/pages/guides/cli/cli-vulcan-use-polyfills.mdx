...
:::tip
You can access a list of APIs resolved through polyfills by Vulcan build on [its repository](https://github.com/aziontech/vulcan) and on [Azion's compatibility documentation](/en/documentation/products/azion-edge-runtime/compatibility/node/). Vulcan's an **open-source** project and you can propose new presets and implementations.
:::
