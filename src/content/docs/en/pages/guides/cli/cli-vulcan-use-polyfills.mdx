...
The projects built with these frameworks typically use Node.js APIs. Through the Azion build process, carried by [Vulcan](https://github.com/aziontech/vulcan), these APIs are resolved through the use of *polyfills*. 
...
:::tip
You can access a list of APIs resolved through polyfills by Vulcan build on [Vulcan's repository](https://github.com/aziontech/vulcan). Vulcan's an **open-source** project and you can propose new presets and implementations.
:::
