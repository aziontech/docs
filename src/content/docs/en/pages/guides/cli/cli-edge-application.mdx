...
> **Tip**: if you want to retrieve your application's URL, [on Real-Time Manager](https://console.azion.com/), select **Products Menu** > **Domains**. You'll see a list of your domains, including the one created by the CLI commands in this guide.
