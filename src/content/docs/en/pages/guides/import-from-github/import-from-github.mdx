...
description: This documentation assists you in importing your own GitHub repository to build and deploy an edge application on Azion's edge.
...
- A pop-up window will open to confirm the installation of the [Azion GitHub App](/en/documentation/products/guides/azion-github-app/), a tool that connects your GitHub account with Azion's platform. Define your permissions and repository access as desired.
...
7. In the **Variables** section, you can add project variables as needed.
...
8. Click the **Save** button to start the deployment.
