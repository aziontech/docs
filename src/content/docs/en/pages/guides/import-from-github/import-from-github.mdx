...
description: >-
  ...
  build and deploy an edge application on Azion's edge.
...
8. Click the **Deploy** button to start the deployment.

You can follow the deployment process through a window showing the logs. When it's complete, a notification appears, confirming the edge application has been successfully created.
