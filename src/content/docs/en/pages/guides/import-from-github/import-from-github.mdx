...
permalink: /documentation/guides/application-development/automation/import-an-existing-project-from-github/
---
...
- An Azion account.
    - Check the [How to create an account on Azion](/en/documentation/fundamentals/creating-account/) guide for more information.
...
Check [some code samples](https://github.com/aziontech/azion-samples/tree/dev/templates) to fork and use as boilerplate, if desired. Read more about [Frameworks compatibility](/en/documentation/devtools/runtime/frameworks/frameworks-compatibility/) in the documentation.
...
- You can use them as global variables and edit or turn them into secrets on the **Variables** page. Read the [Variables](/en/documentation/guides/) documentation for more details.
