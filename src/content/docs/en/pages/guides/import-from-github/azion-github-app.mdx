...
permalink: /documentation/guides/application-development/automation/azion-github-app/
---
...
- When [deploying a template](/en/documentation/marketplace/templates/) or [importing a project for GitHub](/en/documentation/guides/application-development/automation/import-an-existing-project-from-github/).
...
:::tip
For more details, check the [How to import an existing project to build an application](/en/documentation/guides/application-development/automation/import-an-existing-project-from-github/) and [How to create an account on Azion](/en/documentation/fundamentals/creating-account/) guides.
:::
