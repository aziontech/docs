...
unique: documentation_products_object_storage_upload
...
Once you have the edge function ready, you need to create an application that will proxy the upload process for the bucket.
