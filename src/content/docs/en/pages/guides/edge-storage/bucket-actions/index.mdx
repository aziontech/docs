...
Azion **Edge Storage** allows you to create buckets and integrate your object storage with your edge infrastructure. This guide covers how to upload and download objects from a bucket using the [Azion API](https://api.azion.com) and [Azion Runtime](/en/documentation/devtools/runtime/api-reference/storage/).
