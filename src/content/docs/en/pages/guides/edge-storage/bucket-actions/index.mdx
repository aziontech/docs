...
To download an object, run the following `GET` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/guides/platform/account-and-billing/personal-tokens/), `<bucket_name>` with the name of your bucket, and `<object_key>` with the key created for the object:
