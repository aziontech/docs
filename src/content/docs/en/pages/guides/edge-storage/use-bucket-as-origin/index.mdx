...
See the guides on [How to create and modify an Edge Storage bucket](/en/documentation/products/guides/create-and-modify-bucket/) for bucket operations and [How to upload and download objects from an Edge Storage bucket](/en/documentation/products/guides/upload-and-download-objects-from-bucket/) for object operations.
