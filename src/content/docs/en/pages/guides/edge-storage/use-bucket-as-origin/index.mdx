...
:::note
You can also use the `async storage.get(key)` method from the [Runtime API](/en/documentation/runtime/api-reference/storage/#async-storagegetkey) to serve the application using an **Edge Function** instead.
:::
