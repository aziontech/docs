...
permalink: /documentation/guides/platform/migration/aws-migration-guide/
---
...
| :---------- | :---------- | :--------------- |
| **Amazon CloudFront** | AWS CDN for delivering static content, dynamic content, APIs, applications, and video globally. | [Applications](https://www.azion.com/en/documentation/platform/applications/) |
| **CloudFront Distributions** | Main CloudFront delivery resource for domains, origins, cache behavior, certificates, security, and edge delivery settings. | [Applications](https://www.azion.com/en/documentation/platform/applications/) |
| **CloudFront Alternate Domain Names** | Configure custom domains for CloudFront distributions. | [Workloads](https://www.azion.com/en/documentation/platform/workloads/) |
| **CloudFront Cache Behaviors** | Path-based delivery behavior, cache policy, origin request policy, allowed methods, and edge function associations. | [Rules Engine for Applications](https://www.azion.com/en/documentation/platform/applications/rules-engine/) |
| **CloudFront Cache Policies** | Control cache keys, TTLs, headers, cookies, query strings, and compression. | [Cache](https://www.azion.com/en/documentation/build/cache/) |
| **CloudFront Origin Request Policies** | Control which request values CloudFront forwards to origin. | [Rules Engine](https://www.azion.com/en/documentation/platform/applications/rules-engine/) |
| **CloudFront Response Headers Policies** | Add or modify response headers such as security headers and CORS headers. | [Rules Engine for Applications](https://www.azion.com/en/documentation/platform/applications/rules-engine/) |
| **CloudFront Origin Shield** | Additional centralized caching layer to reduce origin load and improve cache hit ratio. | [Tiered Cache](https://www.azion.com/en/documentation/build/cache/tiered-cache/) |
| **CloudFront Invalidation** | Remove content from CloudFront edge caches before expiration. | [Real-Time Purge](https://www.azion.com/en/documentation/build/cache/real-time-purge/) |
| **CloudFront Functions** | Lightweight JavaScript execution at the edge for redirects, rewrites, headers, and cache-key normalization. | [Functions for Applications](https://www.azion.com/en/documentation/build/functions/) |
| **Lambda@Edge** | Node.js or Python functions triggered by CloudFront events to customize delivery. | [Functions for Applications](https://www.azion.com/en/documentation/build/functions/) |
| **Lambda@Edge for security logic** | Use CloudFront-triggered functions for request validation, authentication, or blocking logic. | [Functions for Firewall](https://www.azion.com/en/documentation/platform/firewall/functions/) |
| **CloudFront Device Detection** | Detect device type and pass device metadata to the origin. | [Device Groups](https://www.azion.com/en/documentation/platform/applications/device-groups/) |
| **AWS Elemental MediaLive** | Real-time live video encoding. | [Live Ingest](https://www.azion.com/en/documentation/guides/application-performance/delivery-optimization/live-ingest-best-practices/) |
| **AWS Elemental MediaPackage** | Package and originate live video streams for HLS, DASH, and related formats. | [Live Ingest](https://www.azion.com/en/documentation/guides/application-performance/delivery-optimization/live-ingest-best-practices/) + [Applications](https://www.azion.com/en/documentation/platform/applications/) |
| **CloudFront for live streaming** | Deliver live video globally using CloudFront with AWS Media Services. | [Applications](https://www.azion.com/en/documentation/platform/applications/) + [Live Ingest](https://www.azion.com/en/documentation/guides/application-performance/delivery-optimization/live-ingest-best-practices/) |
| **AWS Lambda** | General-purpose serverless compute for event-driven code execution. | [Functions for Applications](https://www.azion.com/en/documentation/build/functions/) |
| **Amazon API Gateway** | Create and manage REST, HTTP, and WebSocket APIs with backend integrations. | [Applications](https://www.azion.com/en/documentation/platform/applications/) + [Functions](https://www.azion.com/en/documentation/build/functions/) |
| **API Gateway request validation / throttling** | Apply API request controls, throttling, and validation rules. | [Rules Engine](https://www.azion.com/en/documentation/platform/applications/rules-engine/) + [Firewall](https://www.azion.com/en/documentation/platform/firewall/) |
| **AWS Amplify Hosting** | Git-based CI/CD and hosting for static and server-side rendered web apps. | [Applications](https://www.azion.com/en/documentation/platform/applications/) + [Azion CLI](https://www.azion.com/en/documentation/devtools/cli/) |
| **AWS App Runner** | Deploy source code or container images to managed web applications. | [Applications](https://www.azion.com/en/documentation/platform/applications/) + [Orchestrator](https://www.azion.com/en/products/orchestrator/) |
| **Amazon Bedrock** | Foundation model access and generative AI application development. | [AI Inference](https://www.azion.com/en/documentation/build/ai-inference/) |
| **Amazon Bedrock model inference** | Invoke foundation models for text, image, embedding, and generative AI use cases. | [AI Inference](https://www.azion.com/en/documentation/build/ai-inference/) |
...
| **Amazon Bedrock Custom Model Import** | Import customized foundation models into Bedrock. | [AI Inference](https://www.azion.com/en/documentation/build/ai-inference/) + [LoRA Fine-Tune](https://www.azion.com/en/learning/ai/what-is-lora-fine-tuning/) |
| **Amazon SageMaker AI Real-Time Inference** | Deploy ML models to managed real-time inference endpoints. | [AI Inference](https://www.azion.com/en/documentation/build/ai-inference/) |
| **Amazon S3** | Object storage for unstructured data, static assets, backups, archives, and websites. | [Object Storage](https://www.azion.com/en/documentation/store/object-storage/) |
| **Amazon S3 Static Website Hosting** | Host static websites from S3 buckets. | [Object Storage](https://www.azion.com/en/documentation/store/object-storage/) + [Applications](https://www.azion.com/en/documentation/platform/applications/) |
| **S3 Object Lambda** | Transform S3 objects with Lambda before returning them to the requester. | [Object Storage](https://www.azion.com/en/documentation/store/object-storage/) + [Functions](https://www.azion.com/en/documentation/build/functions/) |
| **S3 Object Lambda for image transformation** | Resize, watermark, redact, or transform content retrieved from S3. | [Image Processor](https://www.azion.com/en/documentation/build/image-processor/) + [Functions](https://www.azion.com/en/documentation/build/functions/) |
| **Amazon Aurora DSQL** | Serverless distributed relational SQL database for transactional workloads. | [SQL Database](https://www.azion.com/en/documentation/store/sql-database/) |
| **Amazon DynamoDB** | Serverless key-value and document database. | [KV Store](https://www.azion.com/en/documentation/store/kv-store/) |
| **DynamoDB Global Tables** | Multi-Region replication for globally distributed NoSQL data. | [KV Store](https://www.azion.com/en/documentation/store/kv-store/) |
| **AWS WAF** | Web application firewall for protecting applications and APIs. | [WAF](https://www.azion.com/en/documentation/secure/waf/) / [Firewall](https://www.azion.com/en/documentation/platform/firewall/) |
| **AWS Managed Rules for AWS WAF** | Managed rule groups for common vulnerabilities and unwanted traffic. | [WAF Rule Sets](https://www.azion.com/en/documentation/secure/waf/rules-set/) |
| **AWS WAF custom rules** | Create custom match conditions and actions for web requests. | [Rules Engine for Firewall](https://www.azion.com/en/documentation/platform/firewall/rules-engine/) |
| **AWS WAF Bot Control** | Managed bot detection and mitigation. | [Bot Manager](https://www.azion.com/en/documentation/secure/bot-manager/) |
| **AWS WAF Rate-Based Rules** | Rate limit requests based on IP, headers, URI, method, or other keys. | [Rules Engine](https://www.azion.com/en/documentation/platform/applications/rules-engine/) + [Network Shield](https://www.azion.com/en/documentation/secure/network-shield/) |
| **AWS WAF IP Sets** | Reusable IP/CIDR lists for allow or block rules. | [Network Lists](https://www.azion.com/en/documentation/secure/network-shield/network-lists/) |
| **AWS Shield Standard** | Standard DDoS protection for AWS resources. | [DDoS Protection](https://www.azion.com/en/documentation/platform/ddos-protection/) |
| **AWS Shield Advanced** | Advanced DDoS protection with additional visibility and mitigation options. | [DDoS Protection](https://www.azion.com/en/documentation/platform/ddos-protection/) |
| **Shield Advanced automatic DDoS mitigation** | Automatically creates or updates WAF protections during application-layer attacks. | [DDoS Protection](https://www.azion.com/en/documentation/platform/ddos-protection/) + [WAF](https://www.azion.com/en/documentation/secure/waf/) |
| **AWS Network Firewall** | Managed VPC network firewall. | [Network Shield](https://www.azion.com/en/documentation/secure/network-shield/) |
| **Elastic Load Balancing** | Distributes traffic across multiple targets and availability zones. | [Load Balancer](https://www.azion.com/en/documentation/platform/load-balancer/) |
| **Application Load Balancer** | Layer 7 HTTP/HTTPS load balancing with application-level routing. | [Load Balancer](https://www.azion.com/en/documentation/platform/load-balancer/) |
| **Network Load Balancer** | Layer 4 TCP/UDP/TLS load balancing. | [Load Balancer](https://www.azion.com/en/documentation/platform/load-balancer/) |
| **AWS Global Accelerator** | Global Anycast IPs and optimized routing over the AWS global network. | [Applications](https://www.azion.com/en/documentation/platform/applications/) + [Load Balancer](https://www.azion.com/en/documentation/platform/load-balancer/) |
| **CloudFront Origin Access Control** | Secure S3 origins so users access content through CloudFront instead of directly from S3. | [Connectors](https://www.azion.com/en/documentation/platform/connectors/) + [Origin Shield](https://www.azion.com/en/documentation/secure/origin-shield/) |
| **CloudFront Signed URLs / Signed Cookies** | Restrict access to private content using signed URLs or cookies. | [Rules Engine](https://www.azion.com/en/documentation/platform/applications/rules-engine/) + [Functions](https://www.azion.com/en/documentation/build/functions/) |
| **CloudFront Geographic Restrictions** | Allow or block content access by country. | [Rules Engine](https://www.azion.com/en/documentation/platform/applications/rules-engine/) + [Network Shield](https://www.azion.com/en/documentation/secure/network-shield/) |
| **Amazon Route 53** | Authoritative DNS, domain registration, routing policies, and health checks. | [Edge DNS](https://www.azion.com/en/documentation/secure/edge-dns/) |
| **AWS Certificate Manager** | Provision, import, manage, deploy, and renew SSL/TLS certificates. | [Certificate Manager](https://www.azion.com/en/documentation/platform/certificate-manager/for-firewall/) |
| **AWS Private CA** | Create and operate private certificate authorities. | [Certificate Manager](https://www.azion.com/en/documentation/platform/certificate-manager/for-firewall/) |
| **AWS Private CA for client authentication** | Private PKI patterns for certificate-based client authentication. | [mTLS](https://www.azion.com/en/documentation/platform/certificate-manager/mtls/) |
...
| **Amazon CloudWatch Metrics** | Collect, query, visualize, and alarm on service and application metrics. | [Real-Time Metrics](https://www.azion.com/en/documentation/platform/real-time-metrics/) |
| **Amazon CloudWatch Logs** | Collect, monitor, query, and analyze logs. | [Real-Time Events](https://www.azion.com/en/documentation/observe/real-time-events/) |
| **CloudWatch Logs Insights** | Query and investigate logs interactively. | [Real-Time Events](https://www.azion.com/en/documentation/observe/real-time-events/) |
| **Amazon Data Firehose** | Deliver streaming data to destinations such as S3, Redshift, OpenSearch, and HTTP endpoints. | [Data Stream](https://www.azion.com/en/documentation/observe/data-stream/) |
| **CloudWatch RUM** | Real user monitoring for browser and mobile application performance. | [Edge Pulse](https://www.azion.com/en/documentation/observe/edge-pulse/) |
| **AWS Marketplace** | Discover, buy, deploy, and manage third-party software, data, and services. | [Marketplace](https://www.azion.com/en/documentation/marketplace/) |
| **AWS Management Console** | Web interface for accessing and managing AWS services. | [Azion Console](https://console.azion.com/) |
| **AWS APIs** | Programmatic interface for AWS service operations. | [Azion API](https://www.azion.com/en/documentation/devtools/api/) |
| **Amazon CloudWatch APIs / Metrics APIs** | Query metrics, logs, alarms, and observability data programmatically. | [GraphQL API](https://www.azion.com/en/documentation/devtools/graphql/) |
| **AWS CLI** | Command-line interface for managing AWS services. | [Azion CLI](https://www.azion.com/en/documentation/devtools/cli/) |
| **AWS SDKs** | Language-specific SDKs for building integrations with AWS services. | [SDK](https://www.azion.com/en/documentation/devtools/sdk/) |
| **AWS SDK for JavaScript** | JavaScript libraries for interacting with AWS services. | [Azion Lib](https://www.azion.com/en/documentation/devtools/azion-lib/) |
| **AWS CloudFormation** | Infrastructure as Code service for modeling and provisioning AWS resources. | [Terraform Provider](https://www.azion.com/en/documentation/devtools/terraform/) |
| **AWS Cloud Development Kit** | Define infrastructure using programming languages and synthesize to CloudFormation. | [Terraform Provider](https://www.azion.com/en/documentation/devtools/terraform/) + [Azion API](https://www.azion.com/en/documentation/devtools/api/) |
| **Terraform AWS Provider** | Terraform provider for managing AWS resources. | [Terraform Provider](https://www.azion.com/en/documentation/devtools/terraform/) |
| **Lambda runtime environment** | Runtime layer used by Lambda functions. | [Azion Runtime](https://www.azion.com/en/documentation/devtools/runtime/) |
| **CloudFront edge runtime** | Runtime environment for CloudFront Functions and Lambda@Edge. | [Azion Runtime](https://www.azion.com/en/documentation/devtools/runtime/) |
...
* [Applications](https://www.azion.com/en/documentation/platform/applications/)
* [Applications first steps](https://www.azion.com/en/documentation/platform/applications/first-steps/)
* [Azion CLI overview](https://www.azion.com/en/documentation/devtools/cli/)
* [Import an existing project from GitHub](https://www.azion.com/en/documentation/guides/application-development/automation/import-an-existing-project-from-github/)
...
* [Azion CLI overview](https://www.azion.com/en/documentation/devtools/cli/)
* [azion.config.js reference](https://www.azion.com/en/documentation/devtools/cli/azion-config-js/)
...
`} />
:::note
Azion manages environment variables at the Function instance level, not through a standalone variables API. Variables are configured as key-value pairs in the `vars` field when creating or updating a function instance. See the [Functions Instances documentation](https://www.azion.com/en/documentation/build/functions/functions-instances/) for details.
:::
</Fragment>
</Tabs>
...
* [Environment Variables](https://www.azion.com/en/documentation/guides/)
* [Working with variables](https://www.azion.com/en/documentation/guides/application-development/automation/work-with-variables/)
* [Azion runtime environment variables reference](https://www.azion.com/en/documentation/build/functions/environment-variables/)
...
* [Applications](https://www.azion.com/en/documentation/platform/applications/)
* [Applications Main Settings](https://www.azion.com/en/documentation/platform/applications/main-settings/)
* [Rules Engine for Applications](https://www.azion.com/en/documentation/platform/applications/rules-engine/)
* [Connectors](https://www.azion.com/en/documentation/platform/connectors/)
...
* [Functions](https://www.azion.com/en/documentation/build/functions/)
* [Functions Instances](https://www.azion.com/en/documentation/build/functions/functions-instances/)
* [Rules Engine for Applications](https://www.azion.com/en/documentation/platform/applications/rules-engine/)
...
* [Functions](https://www.azion.com/en/documentation/build/functions/)
* [Functions Instances](https://www.azion.com/en/documentation/build/functions/functions-instances/)
* [Runtime APIs](https://www.azion.com/en/documentation/guides/)
* [JavaScript Runtime APIs reference](https://www.azion.com/en/documentation/devtools/runtime/api-reference/javascript/)
...
* [Load Balancer](https://www.azion.com/en/documentation/platform/load-balancer/)
* [Connectors](https://www.azion.com/en/documentation/platform/connectors/)
* [Application Main Settings](https://www.azion.com/en/documentation/platform/applications/main-settings/)
...
* [Cache](https://www.azion.com/en/documentation/build/cache/)
* [Cache Settings](https://www.azion.com/en/documentation/build/cache/cache-settings/)
* [Tiered Cache](https://www.azion.com/en/documentation/build/cache/tiered-cache/)
* [Real-Time Purge](https://www.azion.com/en/documentation/build/cache/real-time-purge/)
...
* [Image Processor](https://www.azion.com/en/documentation/build/image-processor/)
* [How to process images](https://www.azion.com/en/documentation/guides/application-performance/delivery-optimization/process-images/)
* [Object Storage](https://www.azion.com/en/documentation/store/object-storage/)
...
* [AI Inference](https://www.azion.com/en/documentation/build/ai-inference/)
* [AI Inference models](https://www.azion.com/en/documentation/build/ai-inference/models/)
* [AI Inference Starter Kit](https://www.azion.com/en/documentation/guides/application-development/frameworks/ai-inference-starter-kit/)
...
Create a workload in Azion Console and associate your custom domain. See [Workloads Documentation](https://www.azion.com/en/documentation/platform/workloads/).
...
* [Workloads](https://www.azion.com/en/documentation/platform/workloads/)
* [Create an Azion custom domain](https://www.azion.com/en/documentation/guides/application-development/getting-started/create-azion-custom-domain/)
* [Edge DNS](https://www.azion.com/en/documentation/secure/edge-dns/)
* [Certificate Manager](https://www.azion.com/en/documentation/platform/certificate-manager/for-firewall/)
...
* [Edge DNS](https://www.azion.com/en/documentation/secure/edge-dns/)
* [DNSSEC compatibility](https://www.azion.com/en/documentation/secure/edge-dns/dnssec-compatibility/)
* [Run the dig command](https://www.azion.com/en/documentation/guides/application-security/dns/run-the-dig-command/)
* [Run the traceroute command](https://www.azion.com/en/documentation/guides/application-security/dns/run-the-traceroute-command/)
...
4. See the [mTLS configuration guide](/en/documentation/guides/application-security/tls-and-certificates/mtls/) for detailed steps.
...
* [Certificate Manager](https://www.azion.com/en/documentation/platform/certificate-manager/for-firewall/)
* [Create a digital certificate](https://www.azion.com/en/documentation/guides/application-security/tls-and-certificates/create-a-digital-certificate/)
* [mTLS](https://www.azion.com/en/documentation/platform/certificate-manager/mtls/)
...
* [Web Application Firewall](https://www.azion.com/en/documentation/secure/waf/)
* [Rules Engine for Firewall](https://www.azion.com/en/documentation/platform/firewall/rules-engine/)
* [Functions for Firewall](https://www.azion.com/en/documentation/platform/firewall/functions/)
...
* [DDoS Protection](https://www.azion.com/en/documentation/platform/ddos-protection/)
* [DDoS Mitigation](https://www.azion.com/en/documentation/platform/ddos-protection/ddos-mitigation/)
* [Network Shield](https://www.azion.com/en/documentation/secure/network-shield/)
...
* [Bot Manager](https://www.azion.com/en/documentation/secure/bot-manager/)
* [Bot Manager Lite](https://www.azion.com/en/documentation/secure/bot-manager/bot-manager-lite/)
* [Bot Manager Lite integration kit](https://www.azion.com/en/documentation/guides/application-development/integrations/bot-manager-lite-integration-kit/)
* [Radware Bot Manager](https://www.azion.com/en/documentation/guides/application-development/integrations/radware-bot-manager/)
...
* [Rules Engine for Firewall](https://www.azion.com/en/documentation/platform/firewall/rules-engine/)
* [Functions for Firewall](https://www.azion.com/en/documentation/platform/firewall/functions/)
* [Functions Instances for Firewall](https://www.azion.com/en/documentation/platform/firewall/functions-instances/)
...
* [Network Lists](https://www.azion.com/en/documentation/secure/network-shield/network-lists/)
* [Real-Time Events](https://www.azion.com/en/documentation/observe/real-time-events/)
* [Data Streaming](https://www.azion.com/en/documentation/products/observe/data-streaming/)
...
* [Object Storage](https://www.azion.com/en/documentation/store/object-storage/)
* [Use S3-compatible tools with Object Storage](https://www.azion.com/en/documentation/guides/application-development/data/use-s3-compatible-tools-with-object-storage/)
* [Create and modify a bucket](https://www.azion.com/en/documentation/guides/application-development/data/create-and-modify-bucket/)
* [Upload and download objects](https://www.azion.com/en/documentation/guides/application-development/data/upload-and-download-objects-from-bucket/)
* [Use a bucket as origin](https://www.azion.com/en/documentation/guides/application-development/data/use-bucket-as-origin/)
* [Storage library reference](https://www.azion.com/en/documentation/devtools/azion-lib/storage/)
...
For key-value workloads, use KV Store from inside a function:

<Code client:visible lang="javascript" code={`
// Azion.KV is a runtime global. There is no import line.
...
<Fragment slot="panel.console">
Azion Console has no KV Store screen. A namespace is created through the Azion API, on the
**API** tab. For the fields, the operations, and the errors, refer to
[Namespaces](/en/documentation/store/kv-store/namespaces/).
</Fragment>
...
* [KV Store](https://www.azion.com/en/documentation/store/kv-store/)
* [KV Store](https://www.azion.com/en/documentation/store/kv-store/)
* [SQL Database](https://www.azion.com/en/documentation/store/sql-database/)
* [Create a database](https://www.azion.com/en/documentation/guides/application-development/data/manage-sql-database/)
* [Install SQL Shell](https://www.azion.com/en/documentation/guides/application-development/data/install-edge-sql-shell/)
* [Import data into SQL Database](https://www.azion.com/en/documentation/guides/application-development/data/import-data-sql-database/)
...
* [SQL Database](https://www.azion.com/en/documentation/store/sql-database/)
* [Vector Search](https://www.azion.com/en/documentation/store/sql-database/vector-search/)
* [Create a database](https://www.azion.com/en/documentation/guides/application-development/data/manage-sql-database/)
* [Install SQL Shell](https://www.azion.com/en/documentation/guides/application-development/data/install-edge-sql-shell/)
* [SQL Database Shell commands](https://www.azion.com/en/documentation/store/sql-database/edgesql-shell/)
* [Import data into SQL Database](https://www.azion.com/en/documentation/guides/application-development/data/import-data-sql-database/)
* [SQL Database API reference](https://www.azion.com/en/documentation/devtools/runtime/api-reference/sql-database/)
...
| **Engines** | Redis, Memcached | HTTP cache | `Azion.KV`, from inside a function |
| **Persistence** | Optional (Redis AOF/RDB) | Time-based TTL | Persistent |
| **Data structures** | Strings, hashes, lists, sets, sorted sets | HTTP responses | One value per key: string, object, ArrayBuffer, or stream |
...
For key-value operations, use KV Store from inside a function:
...
// After: KV Store put with expiration
...
* [Real-Time Metrics](https://www.azion.com/en/documentation/platform/real-time-metrics/)
* [Real-Time Metrics first steps](https://www.azion.com/en/documentation/platform/real-time-metrics/first-steps/)
* [Historical Real-Time Metrics](https://www.azion.com/en/documentation/platform/real-time-metrics/historical-real-time-metrics/)
* [Analyze metrics](https://www.azion.com/en/documentation/guides/platform/observability/analyze-metrics/)
* [Grafana plugin custom dashboards](https://www.azion.com/en/documentation/guides/platform/observability/azion-plugin-grafana-custom-dash/)
* [Grafana plugin pre-built dashboards](https://www.azion.com/en/documentation/guides/platform/observability/azion-plugin-grafana-pre-built-dash/)
...
* [Real-Time Events](https://www.azion.com/en/documentation/observe/real-time-events/)
* [Real-Time Events first steps](https://www.azion.com/en/documentation/observe/real-time-events/first-steps/)
* [Investigate requests with the GraphQL API](https://www.azion.com/en/documentation/guides/platform/observability/investigate-requests-graphql-api/)
* [Configure sampling](https://www.azion.com/en/documentation/guides/platform/observability/configure-sampling/)
...
* [Data Stream](https://www.azion.com/en/documentation/observe/data-stream/)
* [Data Stream first steps](https://www.azion.com/en/documentation/observe/data-stream/first-steps/)
* [Use Data Stream](https://www.azion.com/en/documentation/guides/platform/observability/use-data-stream/)
* Connectors: [Amazon S3](https://www.azion.com/en/documentation/guides/platform/observability/endpoint-amazon-s3/), [Azion Object Storage](https://www.azion.com/en/documentation/guides/platform/observability/connector-azion-object-storage/), [Datadog](https://www.azion.com/en/documentation/guides/platform/observability/endpoint-datadog/), [Splunk](https://www.azion.com/en/documentation/guides/platform/observability/endpoint-splunk/), [Elasticsearch](https://www.azion.com/en/documentation/guides/platform/observability/endpoint-elasticsearch/), [Kinesis](https://www.azion.com/en/documentation/guides/platform/observability/endpoint-amazon-kinesis/), [BigQuery](https://www.azion.com/en/documentation/guides/platform/observability/endpoint-google-bigquery/)
* [Edge Pulse](https://www.azion.com/en/documentation/observe/edge-pulse/)
...
| DynamoDB queries fail after migration | KV Store API syntax differs | Open the client with `await Azion.KV.open(name)`, a runtime global that needs no import; check key naming conventions |
...
* Review [Real-Time Metrics](https://www.azion.com/en/documentation/platform/real-time-metrics/) to monitor application performance
* Set up [Real-Time Events](https://www.azion.com/en/documentation/observe/real-time-events/) for production visibility
* Configure [Web Application Firewall](https://www.azion.com/en/documentation/secure/waf/) for production security
* Review the individual feature guides for advanced configuration
* Set up [Data Stream](https://www.azion.com/en/documentation/observe/data-stream/) to export logs to your existing SIEM or analytics tools
...
* [Read the Applications documentation](https://www.azion.com/en/documentation/platform/applications/)
* [Explore the Azion CLI](https://www.azion.com/en/documentation/devtools/cli/)
