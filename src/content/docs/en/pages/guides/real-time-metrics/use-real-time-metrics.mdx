...
permalink: /documentation/guides/platform/observability/use-real-time-metrics/
---
...
:::note
The new Real-Time Metrics provides data and metrics starting from **October 15th, 2022**. If you want to view metrics for up to 2 years and before October 15th, 2022, see [Historical Real-Time Metrics](/en/documentation/platform/real-time-metrics/historical-real-time-metrics/).
:::
...
<DocButton href="/en/documentation/guides/platform/observability/analyze-metrics/" label="go to analyze metrics guide" kind="secondary" target="_blank" size="medium" />
