...
<LinkButton link="/en/documentation/products/observe/real-time-metrics/" label="go to Real-Time Metrics reference" outlined />
...
<LinkButton link="/en/documentation/products/guides/observe/analyze-metrics/" label="go to analyze metrics guide" outlined target="_blank" />
...
<LinkButton link="/en/documentation/products/observe/real-time-events/" label="go to Real-Time Events reference" outlined />
