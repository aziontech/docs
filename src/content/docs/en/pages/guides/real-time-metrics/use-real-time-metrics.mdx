...
<LinkButton outlined link="/en/documentation/products/observe/real-time-metrics/" label="go to Real-Time Metrics reference" variant="secondary" />
...
Access [Azion Console](https://console.azion.com/) and select **Products menu** > **Real-Time Metrics** on the **OBSERVE** section, or access [Real-Time Manager](https://manager.azion.com/) and select **Products menu** > **Real-Time Metrics** on the **Observe** section.
...
<LinkButton outlined link="/en/documentation/products/guides/observe/analyze-metrics/" label="go to analyze metrics guide" variant="secondary" target="_blank" />
...
<LinkButton outlined link="/en/documentation/products/observe/real-time-events/" label="go to Real-Time Events reference" variant="secondary" />
