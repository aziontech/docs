...
Access [Azion Console](https://console.azion.com) and select **Products menu** > **Real-Time Metrics** on the **OBSERVE** section and select **Products menu** > **Real-Time Metrics** on the **Observe** section.
