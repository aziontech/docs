...
**Real-Time Metrics** provides you with real-time access to metrics, through charts, so you can analyze the events of your applications and products configured on Azion.

<Button href="/en/documentation/products/real-time-metrics/" text="go to Real-Time Metrics reference"></Button>
...
After creating your Azion account:
...
<Button href="/en/documentation/products/real-time-events/" text="go to Real-Time Events reference"></Button>
