...
<LinkButton link="/en/documentation/products/secure/edge-firewall/web-application-firewall/custom-allowed-rules/" text="go to Custom Allowed Rules reference" outlined />
