...
<LinkButton link="/en/documentation/products/secure/firewall/web-application-firewall/custom-allowed-rules/" label="go to Custom Allowed Rules reference" severity="secondary" />
