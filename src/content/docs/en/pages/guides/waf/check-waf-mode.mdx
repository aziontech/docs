...
:::tip
Check the list of all [threat families](/en/documentation/secure/waf/) that WAF can protect your applications from.
:::
...
- A [firewall](/en/documentation/guides/application-security/firewall-and-waf/firewall-configure-main-settings/) associated with the domains of your applications.
- This firewall should have at least one [WAF Rule Set](/en/documentation/secure/waf/rules-set/). 

If you don't have a configured WAF Rule Set, check [this guide](/en/documentation/guides/application-security/firewall-and-waf/create-waf-rule-set/) for more details.
...
1. Access [Azion Console](/en/documentation/guides/platform/account-and-billing/how-to-access-azion-console/) > **Firewall**, in the **Secure** section.
