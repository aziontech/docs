...
- An [edge firewall](/en/documentation/products/guides/secure/edge-firewall-configure-main-settings/) associated with the workloads of your edge applications.
