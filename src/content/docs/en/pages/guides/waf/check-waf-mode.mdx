...
> See the list of all [threat families](/en/documentation/products/secure/edge-firewall/web-application-firewall/) that WAF can protect your applications from.
...
> If you don't have a configured WAF Rule Set, check the documentation for more details on [Web Application Firewall](/en/documentation/products/secure/edge-firewall/web-application-firewall/).
