...
- A [firewall](/en/documentation/products/guides/secure/firewall-configure-main-settings/) associated with the [workloads](/en/documentation/products/secure/workloads/) of your applications.
...
3. From the **Main Settings** tab, make sure:
   - All workloads from your application are on the **Selected** list.
