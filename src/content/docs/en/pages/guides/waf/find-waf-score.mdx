...
meta_tags: >-
  web application firewall, waf, azion, waf score, real-time events, firewall
...
:::tip
Check the [Real-Time Events documentation](/en/documentation/observe/real-time-events/) to learn more about each field.
:::
...
:::tip
Check the scores for each sensitivity level available in the [Web Application Firewall](/en/documentation/secure/waf/) documentation. To find out if your WAF is operating in Learning or Blocking mode, you can use this same method and check the `waf_learning` field, or see [How to check your WAF mode](/en/documentation/guides/application-security/firewall-and-waf/how-to-check-your-waf-mode/) guide.
:::