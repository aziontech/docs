...
## WAF queries in Real-Time Events via Console (Workloads)
...
## WAF queries in Real-Time Events via Console (Domains)
...
## WAF queries in Real-Time Events via API v4

To find information on requests blocked by WAF using API v4, you can use Real-Time Events API:

1. Run the following `GET` request to retrieve WAF events data, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/products/guides/personal-tokens/):
...
2. You can also query with status and upstream_status:
...
3. To get specific WAF-related fields, use:
...
Replace `domain.com` with your domain. The higher the `waf_score` value, the more indicative of threats were found in the request.

</Fragment>

<Fragment slot="panel.apiv3">

## WAF queries in Real-Time Events via API v3

To find information on requests blocked by WAF using API v3, you can use Real-Time Events API:

1. Run the following `POST` request to retrieve WAF events data, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/products/guides/personal-tokens/):
