...
> Visit the [Real-Time Events](/en/documentation/products/observe/real-time-events/) documentation for more information about this product.
...
See the scores for each sensitivity level available in the [Web Application Firewall](/en/documentation/products/secure/edge-firewall/web-application-firewall/) documentation.
