...
This documentation page will assist you to start your [Azion's journey](#azions-journey). It includes building your first edge application using a template, further setting up, and connecting your newly created application to domains and traffic, as well as viewing metrics.
