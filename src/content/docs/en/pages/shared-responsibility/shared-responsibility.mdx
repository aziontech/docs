...
The publication also provides a simple and unambiguous categorisation of cloud services models:
...
Customers are responsible for the correct configuration and usage of the controls and for the application and content they put on or through Azion’s Edge Platform.

The diagram below illustrates this concept.

| Entity | Responsibilities |
| ------ | ---------------- |
| Customer<br /><br />RESPONSIBILITY FOR SECURITY 'IN' THE EDGE PLATFORM | Customer data (e.g application and content)<br /><br />Correct configuration of Azion Products and Services<br /><br />Identity & Access Management<br /><br />Management of the guest operating system and any Azion software when running on-premises or third-party infrastructure |
| Azion<br /><br />RESPONSIBILITY FOR SECURITY 'OF' THE EDGE PLATFORM | Configuration management of the Edge Platform<br /><br />Software to provide its Product and Services<br /><br /> |
...
- Vulnerability and patch management of the systems.
