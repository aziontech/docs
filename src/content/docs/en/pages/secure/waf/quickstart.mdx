...
<DocCardGroup cols={2}>
  ...
  <DocCard title="Exempt one query string parameter" href="/en/documentation/secure/waf/examples/exempt-query-parameter/" label="Take one argument out of the scoring of one internal rule, the first time a legitimate request is blocked." />
  <DocCard title="A rule that applies a rule set" href="/en/documentation/secure/waf/examples/apply-rule-set/" label="The Set WAF binding as a snippet, for the next firewall that needs one." />
