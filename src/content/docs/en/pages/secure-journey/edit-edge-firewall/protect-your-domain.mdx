...
description: >-
  Learn how to configure an firewall to protect your domain.
meta_tags: 'secure, firewall, configuration, settings, domains'
namespace: docs_guides_secure_protect_your_domain
permalink: /documentation/guides/application-security/firewall-and-waf/firewall-protect-your-domain/
---
