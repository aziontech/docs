...
- <Badge variant="accent">[DDoS Protection Unmetered](/en/documentation/products/secure/edge-firewall/ddos-protection/)</Tag>
...
- <Badge variant="accent">[Edge Functions](/en/documentation/products/secure/edge-firewall/edge-functions/)</Tag>
...
- <Badge variant="accent">[Network Layer Protection](/en/documentation/products/secure/edge-firewall/network-layer-protection/)</Tag>
...
- <Badge variant="accent">[Web Application Firewall](/en/documentation/products/secure/edge-firewall/web-application-firewall/)</Tag>
