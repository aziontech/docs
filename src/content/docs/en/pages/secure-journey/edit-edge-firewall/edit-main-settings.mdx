...
In this section, you'll modify the main settings of your edge firewalls: name, domains, and modules via [Real-Time Manager (RTM)](https://console.azion.com).
...
[Modules](/en/documentation/products/secure/edge-firewall/#about-edge-firewall-modules) can unlock additional functionalities and features related to your configured firewalls. See the [Pricing page](https://www.azion.com/en/pricing/) for more details.
