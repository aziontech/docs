...
description: Customize your firewall workloads and modules.
meta_tags: 'secure, firewall, configuration, settings, workloads'
...
Once you create a firewall with Azion, you can modify a few configurations. In this guide, you'll learn to modify the workloads associated with your firewall and to enable the available modules.
...
In this section, you'll modify the main settings of your firewalls: name, workloads, and modules via [Azion Console](https://console.azion.com).
...
<LinkButton link="/en/documentation/products/guides/secure/firewall-protect-your-domain/" label="go to How to protect your domain" severity="secondary" />
...
- <Tag severity="info" client:only="vue">[DDoS Protection](/en/documentation/products/secure/firewall/ddos-protection/)</Tag>
...
- <Tag severity="info" client:only="vue">[Functions](/en/documentation/products/secure/firewall/functions/)</Tag>
...
- <Tag severity="info" client:only="vue">[Network Shield](/en/documentation/products/secure/firewall/network-shield/)</Tag>
...
- <Tag severity="info" client:only="vue">[Web Application Firewall](/en/documentation/products/secure/firewall/web-application-firewall/)</Tag> Protects your applications against threats such as SQL Injections, Remote File Inclusion (RFI), Cross-Site Scripting (XSS), and many others.
