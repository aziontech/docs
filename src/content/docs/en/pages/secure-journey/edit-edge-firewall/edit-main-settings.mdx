...
description: Customize your edge firewall workloads and modules.
...
Once you create an edge firewall with Azion, you can modify a few configurations. In this guide, you'll learn to modify the workloads associated with your firewall and to enable the available modules.
...
In this section, you'll modify the main settings of your edge firewalls: name, workloads, and modules via [Azion Console](https://console.azion.com).
...
| `workloads` | Array of IDs of the workloads you want to associate with this edge firewall |
