...
- <Badge variant="accent">[DDoS Protection Unmetered](/en/documentation/products/secure/edge-firewall/ddos-protection/)</Badge>
...
- <Badge variant="accent">[Edge Functions](/en/documentation/products/secure/edge-firewall/edge-functions/)</Badge>
...
- <Badge variant="accent">[Network Layer Protection](/en/documentation/products/secure/edge-firewall/network-layer-protection/)</Badge>
...
- <Badge variant="accent">[Web Application Firewall](/en/documentation/products/secure/edge-firewall/web-application-firewall/)</Badge>
