...
- <Tag severity="primary" client:only="vue">[DDoS Protection Unmetered](/en/documentation/products/secure/edge-firewall/ddos-protection/)</Tag>
...
- <Tag severity="primary" client:only="vue">[Edge Functions](/en/documentation/products/secure/edge-firewall/edge-functions/)</Tag>
...
- <Tag severity="primary" client:only="vue">[Network Layer Protection](/en/documentation/products/secure/edge-firewall/network-layer-protection/)</Tag>
...
- <Tag severity="primary" client:only="vue">[Web Application Firewall](/en/documentation/products/secure/edge-firewall/web-application-firewall/)</Tag>
...
<LinkButton outlined link="/en/documentation/products/guides/debug-rules/" label="go to How to debug rules guide" variant="secondary" />
