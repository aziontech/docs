...
1. Access [Real-Time Manager (RTM)](https://manager.azion.com/) > **Digital Certificates**.
...
1. Access [Real-Time Manager (RTM)](https://manager.azion.com/) > **Domains**.
2. Click on the domain you'd like to configure **mTLS** for.
...
<Fragment slot="panel.rtm">
1. Access [Real-Time Manager (RTM)](https://manager.azion.com/) > **Edge Application**.
2. Find and click on the application with the mTLS domain.
3. Click the **Rules Engine** tab.
...
10. To add another variable, click the **+ And** button in the **Criteria** section and repeat the remaining steps.
11. Click the **Save** button when you're done.
</Fragment>
