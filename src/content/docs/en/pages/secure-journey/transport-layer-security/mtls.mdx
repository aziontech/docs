...
- <Badge variant="accent">[Application Accelerator](/en/documentation/products/guides/build/configure-main-settings/#modules)</Tag>
- <Badge variant="accent">[Domain with an mTLS certificate](#add-a-trusted-ca-certificate-and-associate-it-to-a-domain)</Tag>
