...
- <Tag severity="primary" client:only="vue">[Application Accelerator](/en/documentation/products/guides/build/configure-main-settings/#modules)</Tag>
- <Tag severity="primary" client:only="vue">[Domain with an mTLS certificate](#add-a-trusted-ca-certificate-and-associate-it-to-a-domain)</Tag>
