...
Requires:
- <Badge variant="accent">[Application Acceleration](/en/documentation/products/guides/build/configure-main-settings/#modules)</Badge></ br>
- <Badge variant="accent">[Domain with an mTLS certificate](#add-a-trusted-ca-certificate-and-associate-it-to-a-domain)</Badge></ br>

:::tip
You can also insert other variables from [the list of available mTLS variables](/en/documentation/products/edge-application/rules-engine/#mutual-transport-layer-security-mtls-variables).
:::
