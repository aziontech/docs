...
There are separate instructions for API v3, which uses **Delivery** settings previously located within **Edge Application **Main Settings. On API v4, **Delivery** settings have been moved to the new [Workloads](/en/documentation/products/secure/workloads) product.
...
To specify the [minimum TLS version](/en/documentation/products/build/edge-application/main-settings/#minimum-tls-version) and the [cipher suite](/en/documentation/products/build/edge-application/main-settings/#tls-ciphers) supported by your application, follow these steps:
