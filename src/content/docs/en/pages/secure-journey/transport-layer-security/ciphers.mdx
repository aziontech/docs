...
```
  ...
  | `supported_ciphers` | Enum that sets the supported cipher suite. See the full list of [list of supported ciphers](/en/documentation/products/edge-application/main-settings/#ciphers) for further details |
