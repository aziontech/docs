...
Now to specify the [minimum TLS version](/en/documentation/products/edge-application/main-settings/#minimum-tls-version) and the [cipher suite](/en/documentation/products/edge-application/main-settings/#tls-ciphers) supported by your application:
...
| `supported_ciphers` | Enum that sets the supported cipher suite. See the full list of [list of supported ciphers](/en/documentation/products/edge-application/main-settings/#tls-ciphers) for further details |
