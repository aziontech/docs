---
title: Automate security with Azion SDK
description: >-
  The Azion SDK for Go serves as a powerful developer toolkit designed to
  streamline the integration of Azion's API services into Go programming
  language applications.
meta_tags: 'edge, security'
namespace: documentation_secure_automate_sdk
permalink: /documentation/products/secure/automate/sdk/
---
...
<DocButton href="/en/documentation/devtools/sdk/go/" label="go to Azion SDK reference" kind="secondary" size="medium" />

---

## Code sample

The following code sample represents how Azion SDK can be used to facilitate the interaction between Go applications and Azion API services:
