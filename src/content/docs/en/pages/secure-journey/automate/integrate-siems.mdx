...
6. On **Option**, select between **Filter workloads** or **All Current and Future workloads**.
- Find more information on each option on [How to associate workloads on Data Stream](/en/documentation/products/guides/data-stream-associate-workloads/).
