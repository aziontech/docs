...
Your logs from [Web Application Firewall (WAF)](/en/documentation/products/secure/edge-firewall/web-application-firewall/) can be integrated with SIEM platforms through **Data Streaming** to monitor your edge applications behaviors, performance, and security.

<Button href="/en/documentation/products/observe/data-streaming/" text="go to data streaming reference" variant="secondary"></Button>

---

## Via Azion Console

1. [Access Azion Console](/en/documentation/products/guides/how-to-access-rtm/) > **Data Streaming**.
