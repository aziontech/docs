...
Your logs from [Web Application Firewall (WAF)](/en/documentation/secure/waf/) can be integrated with SIEM platforms through **Data Stream** to monitor your applications behaviors, performance, and security.
...
- Find more information on each option on [How to associate domains on Data Stream](/en/documentation/guides/platform/observability/data-stream-associate-domains/).
...
- You'll see different fields depending on the endpoint type you choose. Find more information on each of them on the specific guide for the endpoint on the [Observe guides section](/en/documentation/guides/#observe).
8. Click the **Save** button.
</Fragment>

<Fragment slot="panel.api">
1. Run the following `POST` request, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/guides/platform/account-and-billing/personal-tokens/): 
