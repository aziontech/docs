...
<LinkButton link="/en/documentation/products/secure/firewall/functions/" label="go to Functions for Firewall reference" severity="secondary" target="_blank" />
...
<LinkButton link="/en/documentation/products/applications/functions/runtime/api-reference/metadata/" label="go to Metadata API reference" severity="secondary" target="_blank" />
...
<LinkButton link="/en/documentation/products/applications/functions/runtime/api-reference/metadata/" label="go to Network List API reference" severity="secondary" target="_blank" />
