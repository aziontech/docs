...
description: >-
  Through Edge Functions, you can write your own security source code in
...
Edge Functions are functions that run on the Azion Web Platform with low latency, bringing the operational power closer to the end user.
...
<LinkButton link="/en/documentation/products/secure/edge-firewall/edge-functions/" label="go to Edge Functions for Edge Firewall reference" severity="secondary" target="_blank" />
