...
- Use APIs that provide request and response header manipulation
...
1. The rules configured on the [Edge Firewall Rules Engine](/en/documentation/products/edge-firewall/rules-engine/) for the function to run are triggered.
...
<Button href="/en/documentation/products/edge-firewall/edge-functions/firewall/" text="go to edge functions for edge firewall reference" variant="secondary" target="_blank"></Button>
...
<br />
<Button href="/en/documentation/products/azion-edge-runtime/compatibility/node/" text="go to node.js compatibility" variant="secondary" target="_blank"></Button>
...
<Button href="/en/documentation/products/edge-application/edge-functions/runtime/api-reference/metadata/" text="go to metadata api reference" variant="secondary" target="_blank"></Button>
...
<Button href="/en/documentation/products/edge-application/edge-functions/runtime/api-reference/metadata/" text="go to network list api reference" variant="secondary" target="_blank"></Button>
<br />
<Button href="/en/documentation/products/edge-firewall/network-layer-protection/network-lists/" text="go to network list reference" variant="secondary" target="_blank"></Button>
