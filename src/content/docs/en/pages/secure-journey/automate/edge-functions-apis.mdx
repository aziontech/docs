...
<Button href="/en/documentation/products/secure/edge-firewall/edge-functions/" text="go to edge functions for edge firewall reference" variant="secondary" target="_blank"></Button>
...
<br />
<Button href="/en/documentation/products/secure/edge-firewall/network-layer-protection/network-lists/" text="go to network list reference" variant="secondary" target="_blank"></Button>
<br /><br />
---
