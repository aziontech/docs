...
- <Tag severity="info" client:only="vue">[Configured firewall](/en/documentation/products/guides/secure/firewall-configure-main-settings/)</Tag><br></br>

- <Tag severity="info" client:only="vue">[Activated WAF in the firewall](/en/documentation/products/guides/secure/firewall-configure-main-settings/#modules)</Tag>
