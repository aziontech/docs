...
- <Badge variant="accent">[Configured edge firewall](/en/documentation/products/guides/secure/edge-firewall-configure-main-settings/)</Badge><br></br>

- <Badge variant="accent">[Activated WAF in the edge firewall](/en//documentation/products/guides/secure/edge-firewall-configure-main-settings/#modules)</Badge>
...
Once you filter a query with WAF Tuning, you can create an [allowed rule](/en/documentation/products/edge-firewall/web-application-firewall/waf-custom-allowed-rules/) from the presented results. To do so:
