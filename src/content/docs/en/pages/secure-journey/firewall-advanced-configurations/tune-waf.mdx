...
- <Badge variant="accent">[Configured edge firewall](/en/documentation/products/guides/secure/edge-firewall-configure-main-settings/)</Tag><br></br>

- <Badge variant="accent">[Activated WAF in the edge firewall](/en//documentation/products/guides/secure/edge-firewall-configure-main-settings/#modules)</Tag>
