...
You can use the [WAF Tuning](/en/documentation/secure/waf/#waf-tuning) feature to analyze network lists, IPs, and countries that have matched configured WAF rule sets.
...
- <Tag severity="info">[Configured firewall](/en/documentation/guides/application-security/firewall-and-waf/firewall-configure-main-settings/)</Tag><br></br>

- <Tag severity="info">[Activated WAF in the firewall](/en/documentation/guides/application-security/firewall-and-waf/firewall-configure-main-settings/#modules)</Tag>
...
1. Access [Azion Console](/en/documentation/guides/platform/account-and-billing/how-to-access-azion-console/) > **WAF Rules**.
2. Select the WAF Rule Set you want to tune or [create a new one](/en/documentation/guides/application-security/firewall-and-waf/create-waf-rule-set/).
...
Once you filter a query with WAF Tuning, you can create an [allowed rule](/en/documentation/secure/waf/custom-allowed-rules/) from the presented results. To do so:
