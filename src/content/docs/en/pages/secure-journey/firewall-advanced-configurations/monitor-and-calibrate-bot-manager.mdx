...
After deploying [Bot Manager](/en/documentation/secure/bot-manager/), the next step is to understand what the data tells you and adjust the configuration to match your application's traffic patterns. This guide walks you through reading logs, interpreting classifications, and calibrating thresholds and rules to reduce false positives while blocking real threats.

:::note
Bot Manager is a Firewall add-on. Contact the [Sales team](https://www.azion.com/en/contact/) for subscription details. If you're using [Bot Manager Lite](/en/documentation/guides/application-development/integrations/bot-manager-lite/), the same observability tools apply, though some advanced configuration options differ.
:::
...
- <Tag severity="info">[Bot Manager configured in a Firewall](/en/documentation/secure/bot-manager/)</Tag>
...
[Real-Time Events](/en/documentation/observe/real-time-events/) is the fastest way to inspect individual Bot Manager decisions.
...
For aggregate analysis across large volumes of traffic, use the [GraphQL API](/en/documentation/devtools/graphql/overview/) to query the `botManagerMetrics` dataset.
...
<DocButton href="/en/documentation/guides/platform/observability/query-bot-manager-data-with-graphql/" label="Query Bot Manager data with GraphQL" kind="secondary" size="medium" />
<br />
<DocButton href="/en/documentation/guides/platform/observability/query-bot-manager-breakdown-data-with-graphql/" label="Query top impacted URLs with GraphQL" kind="secondary" size="medium" />

---

## Step 5: Monitor with Real-Time Metrics dashboards

[Real-Time Metrics](/en/documentation/platform/real-time-metrics/#bot-manager) provides pre-built dashboards for Bot Manager with two sections:
...
<DocButton href="/en/documentation/platform/real-time-metrics/#bot-manager" label="Go to Bot Manager dashboards" kind="secondary" size="medium" />
...
For long-term analysis and SIEM integration, use [Data Stream](/en/documentation/observe/data-stream/) to forward Bot Manager logs to your observability stack.
...
<DocButton href="/en/documentation/secure/bot-manager/" label="Bot Manager reference" kind="secondary" size="medium" />
<br />
<DocButton href="/en/documentation/guides/application-development/integrations/bot-manager-lite/" label="Bot Manager Lite guide" kind="secondary" size="medium" />
<br />
<DocButton href="/en/documentation/observe/real-time-events/" label="Real-Time Events reference" kind="secondary" size="medium" />
<br />
<DocButton href="/en/documentation/platform/real-time-metrics/" label="Real-Time Metrics reference" kind="secondary" size="medium" />
<br />
<DocButton href="/en/documentation/guides/platform/observability/query-bot-manager-data-with-graphql/" label="Query Bot Manager data with GraphQL" kind="secondary" size="medium" />
<br />
<DocButton href="/en/documentation/guides/platform/observability/query-bot-manager-breakdown-data-with-graphql/" label="Query top impacted URLs with GraphQL" kind="secondary" size="medium" />
<br />
<DocButton href="/en/documentation/observe/data-stream/" label="Data Stream reference" kind="secondary" size="medium" />
