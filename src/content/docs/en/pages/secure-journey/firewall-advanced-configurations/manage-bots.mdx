...
Azion provides the [Bot Manager](/en/documentation/products/marketplace/bot-manager/) add-on, a comprehensive solution for bot management. A [lite version integration](/en/documentation/products/guides/bot-manager-lite/) is also available in the Marketplace.
...
By adding these variables, all the requests passed through the **Bot Manager** will be logged and exhibited on [Real-Time Events](/en/documentation/products/observe/real-time-events/) and graphs in [Real-Time Metrics](/en/documentation/products/observe/real-time-metrics/).
