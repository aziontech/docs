...
You can protect your applications and their contents from bot attacks through Azion Web Platform. To do so, you leverage on edge functions and allow a serverless solution aligned with [Edge Firewall](/en/documentation/products/secure/edge-firewall/) security policies to execute this task.
