...
Once you're done configuring your main settings, you can add records to your Edge DNS. Note that an SOA record is not required when configuring DNS entries for Azion's services.
...
In this section, you'll create or edit the main settings of **Edge DNS** with a domain via [Real-Time Manager (RTM)](https://manager.azion.com/).

1. Access [Real-Time Manager (RTM)](https://manager.azion.com/) > **Edge DNS**.
2. To create a new zone, click the **Add Zone** button. To edit an existing zone, select the zone you want to edit from the list.

### Creating a new zone

1. Give your zone a unique and easy-to-remember name.
2. In **Domain**, add the name of the domain you want to host in Edge DNS. For example: `mydomain.com`.
3. Click the **Save** button.
