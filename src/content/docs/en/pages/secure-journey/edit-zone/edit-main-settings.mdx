...
permalink: /documentation/guides/application-security/dns/edge-dns-configure-main-settings/
---
...
In this guide, you'll learn to create an [Edge DNS](/en/documentation/secure/edge-dns/) zone with its main settings and edit them after you create the zone.
...
1. Run the following `POST` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/guides/platform/account-and-billing/personal-tokens/) to create a new zone:
