...
Once you've [created an firewall and secured your application](/en/documentation/platform/firewall/), you can use **Origin Shield** to secure your infrastructure by blocking threats.
...
:::tip
If you need Azion's IP ranges to configure an allowlist on your origin server, Nginx `set_real_ip_from`, or a cloud firewall such as AWS ELB, see [How to retrieve Azion IP ranges for origin server allowlisting](/en/documentation/guides/application-security/bots-and-network/retrieve-azion-ip-ranges/).
:::
...
- The [Network Shield module](/en/documentation/guides/application-security/firewall-and-waf/firewall-configure-main-settings/#modules) enabled.
...
1. Access [Azion Console](/en/documentation/guides/platform/account-and-billing/how-to-access-azion-console/) > select **Network Lists**.
2. Select **Azion Origin Shield**.
3. On the **List** field, you can copy the IP addresses list.
</Fragment>

<Fragment slot="panel.api">
1. Run the following `GET` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/guides/platform/account-and-billing/personal-tokens/)
