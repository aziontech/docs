...
**Firewall** allows you to secure your [applications](/en/documentation/products/guides/build/build-an-application/) and [workloads](/en/documentation/products/secure/workloads/) against several types of threats and attacks.
...
- The workloads you want to associate with the firewall.
...
<Tag severity="info" client:only="vue">[Functions for Firewall](/en/documentation/products/secure/firewall/functions/)</Tag>
...
<LinkButton link="/en/documentation/products/guides/secure/instantiate-functions/" label="go to instantiate Functions guide" severity="secondary" /> <br></br>
