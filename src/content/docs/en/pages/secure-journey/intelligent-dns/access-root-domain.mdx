...
description: Configure your Intelligent DNS to allow access to an address through its root domain.
...
You can configure your Intelligent DNS to allow access to an address through its root domain, which is also called naked domain or apex domain, representing the simplest form a domain name can have. This configuration occurs by creating an **ANAME record type**.
