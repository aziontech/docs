...
You can configure your **Intelligent DNS** to allow access to an address through its root domain, also known as naked domain or apex domain, by using an **ANAME record**.
