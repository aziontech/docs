...
To check how Intelligent DNS handles a type A query, registered to the `www` record, run:
...
To check how Intelligent DNS handles a type A query, registered to the `www` record, run the following command:
