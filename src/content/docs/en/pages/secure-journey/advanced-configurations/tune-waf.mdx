...
- <Badge variant="accent">[Configured edge firewall]()</Badge><br></br>

- <Badge variant="accent">[Activated WAF in the edge firewall](/en/documentation/products/guides/secure/configure-main-settings/#modules)</Badge>
