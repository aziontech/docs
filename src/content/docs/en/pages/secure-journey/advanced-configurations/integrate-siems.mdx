...
3. Choose a a unique and easy-to-remember name.
...
:::tip
This example uses the **Apache Kafka endpoint**, but you can change the `endpoint_type` with any of the available enddpoints and add the specific mandatory fields. See the available endpoints and their fields in the [Data Streaming Endpoints](https://api.azion.com/#b9aac0c7-173a-462b-87f6-a18d6558d3e5) table.
:::
