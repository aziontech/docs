...
description: The Azion IP Tor Exit Nodes network list can be used to configure a behavior using Rules Engine to block all requests coming from IPs contained in the network list.
