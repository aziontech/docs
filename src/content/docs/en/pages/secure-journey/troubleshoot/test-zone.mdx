...
To test **Intelligent DNS**, you must use one of the [Azion nameservers](/en/documentation/products/secure/intelligent-dns/#dns-provider-configuration) that you've configured in your DNS registry.
