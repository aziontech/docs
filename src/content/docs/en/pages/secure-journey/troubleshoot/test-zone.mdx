...
Once you've set up your [Edge DNS zone](/en/documentation/guides/application-security/dns/edge-dns-configure-main-settings/), you can test it to see if it's properly processing your information.
...
To test **Edge DNS**, you must use one of the [Azion nameservers](/en/documentation/secure/edge-dns/#dns-provider-configuration) that you've configured in your DNS registry.
