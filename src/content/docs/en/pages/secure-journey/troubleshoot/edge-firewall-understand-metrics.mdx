...
<Button href="/en/documentation/products/observe/real-time-metrics/#waf" label="view aggregated metrics" type="primary" theme="light" /> <br></br>

<Button href="/en/documentation/devtools/graphql-api/features/#datasets" label="query data" type="primary" theme="light" /> <br></br>

<Button href="/en/documentation/products/observe/real-time-events/#waf-events" label="view raw data" type="primary" theme="light" /><br />
