...
<LinkButton link="/en/documentation/products/secure/edge-firewall/" severity="secondary" label="go to Firewall documentation" /><br></br>

<LinkButton link="/en/documentation/products/guides/secure/edge-firewall-configure-main-settings/" severity="secondary" label="go to Firewall main settings guide" />
