...
If you've chosen Azion's **Domain** feature to create a Let's Encrypt certificate directly from Azion Console for a zone that is fully configured in Intelligent DNS, the entire process is automated, including the handling of the TXT record. Find out more in the [Let's Encrypt guide](/en/documentation/products/guides/how-to-generate-a-lets-encrypt-certificate/).
:::
