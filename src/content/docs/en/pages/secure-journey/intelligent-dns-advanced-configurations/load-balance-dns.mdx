...
11. Repeat steps 4 to 10 as many times as you want, but changing the **Weight** field.
...
5. Repeat the steps as many times as you want, but changing the **Weight** parameter.
