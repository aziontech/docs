...
5. Repeat the steps to create the other balanced DNS records needed while observing Intelligent DNS limits, and always using the same **entry** and setting the desired addresses in the **answers_list** parameter and weights for each record in the **weight** parameter.
