...
11. Repeat steps 4 to 10 to create the other balanced DNS records needed while observing Intelligent DNS limits, and always using the same **Name** and setting the desired addresses in **Value** and weights for each record in **Weight**.
