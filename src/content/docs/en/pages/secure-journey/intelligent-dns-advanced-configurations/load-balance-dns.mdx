...
11. Repeat steps 4 to 10 as many times as you want, but changing the **Value** and **Weight** fields.
    - Optionally, you can choose different values for the **Name** and **Description** fields.
