...
- `HeightRatio` is an optional parameter that sets the watermark height as a percentage relative to the image. If you don't specify a value, it'll default to `none`.
