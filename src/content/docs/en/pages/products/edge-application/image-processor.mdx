...
| Scope | Resource |
| --- | --- |
| First steps | [Image Processor first steps](/en/documentation/products/guides/image-processor/) |
...
By appending the query `?ims=400x400` to the image URL, it'll be resized to 400 by 400 pixels with auto-crop. For example:
