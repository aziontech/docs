...
**Image Processor** is an **Edge Application** module that can manipulate and process images directly at the edge, which allows you to optimize content transfer times and elevate user experience across your applications by maintaining your images for you.
...
Specify the required size as arguments in the query string using the following key-value pair:
