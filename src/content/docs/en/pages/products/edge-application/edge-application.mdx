...
Azion limits the duration of connections between users and edge applications to 15 minutes. To avoid the termination of active connections that require more time to complete, such as when downloading large files over slow connections, consider implementing [file slicing](/en/documentation/products/edge-application/edge-caching/#slice-settings) or [file compression](/en/documentation/products/guides/using-gzip-mime-types/) in your application.
