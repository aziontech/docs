...
| [WebSocket](/en/documentation/products/edge-application/websocket/) | Enables the WebSocket protocol to establish full-duplex communication channels over one TCP connection. |
