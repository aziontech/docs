...
Azion [Domains](/en/documentation/products/edge-application/domains/) provides you with the flexibility to use automatically generated domains or your own custom domains, allowing you to manage and deliver content effectively through their Edge Applications with support for secure connections over HTTP and HTTPS.

---

## Digital Certificates

With [Digital Certificates](/en/documentation/products/edge-application/digital-certificates/), you can enhance the security of your HTTPS applications by binding a custom TLS certificate to your edge application.

---

## Real-Time Purge

Use [Real-Time Purge](/en/documentation/products/edge-application/real-time-purge/) to clear cached content from Azion's edge or from the [Layer 2](/en/documentation/products/edge-application/l2-caching/) to maintain content accuracy, reduce outdated content delivery, and deliver an optimal user experience on your edge application. 
