...
Operating on a reverse proxy architecture, Edge Application allows you to create applications within [Real-Time Manager (RTM)](https://manager.azion.com/), the [Azion API](https://api.azion.com), or [Azion CLI](/en/documentation/products/cli/), and direct traffic from your domain to Azion. Through this process, your users can effortlessly access your application via our highly distributed global network of edge nodes. Then, Azion selects which edge node closest to the user can handle the request.
...
> Start creating an edge application with [Getting Started](/en/documentation/products/getting-started/) guide.
...
| Setting | Description |
| --- | --- |
| [Origins](/en/documentation/products/edge-application/single-origin/) | Modify your origin address, `Host` header, path, protocol policies, and HMAC authentication credentials. |
