...
| [WebSocket](/en/documentation/products/edge-application/websocket/) | Enable the WebSocket protocol to establish full-duplex communication channels over one TCP connection. |
