...
Azion [Domains](/en/documentation/products/edge-application/domains/) provides you with the flexibility to use automatically generated domains or your own custom domains, allowing you to manage and deliver content effectively through your edge applications with support for secure connections over HTTP and HTTPS.
...
Azion enforces a connection duration limit of 10 to 15 minutes between users and edge applications. To avoid the termination of active connections that require more time to complete, such as when downloading large files over slow connections, consider implementing [file slicing](/en/documentation/products/edge-application/edge-caching/#slice-settings) or [file compression](/en/documentation/products/guides/using-gzip-mime-types/) in your application.
