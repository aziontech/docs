...
Cache policies with long expiration times, such as 1 year, can optimize the performance of your application, improving the experience for your users, reducing traffic with Azion, and reducing the load at your origin. However, a low cache TTL can help you ensure end-users always see the most current information.
