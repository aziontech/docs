...
There are different ways to manage your edge functions on the Azion Edge platform. You can do this through [RTM](https://manager.azion.com/), [Azion CLI](/en/documentation/products/cli/), [Azion API](https://api.azion.com/) and [Terraform](/en/documentation/products/terraform-provider/)

### RTM

You can create and manage edge functions through [Real-time Manage(RTM)](https://manager.azion.com/), below Edge Libraries.
