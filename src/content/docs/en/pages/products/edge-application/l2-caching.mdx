...
To activate **L2 Caching**, [contact the Sales team](https://www.azion.com/en/contact-sales/).
...
When you turn on **L2 Caching** as an extra cache layer, the edge servers for the L2 are hosted in the US (`na-united-states`) by default.

Azion also offers the option for L2 servers to be hosted in Brazil (`sa-brazil`). To switch between regions in your edge applications, contact the [Sales team](https://www.azion.com/en/contact-sales/).
