...
To use your Custom Certificate with Azion, the SNI (Server Name Indication) extension of the TLS protocol is used. Check the [browser list with SNI support](https://caniuse.com/#feat=sni).
