...
Slice can be applied to both the edge caching layer or the L2, provided that [L2 Caching](/en/documentation/products/edge-application/l2-caching/) is an active module.
...
When choosing the option **Content varies by some Device Groups (Whitelist)**, you are allowing Azion to keep device-based variations of its objects in cache.
