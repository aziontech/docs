...
In [Cache Settings](/en/documentation/products/edge-application/cache-settings/), you can reference an existing device group for **Adaptive Delivery**.
...
You can choose one or more device groups to apply the same Adaptive Delivery policies.
