...
| Scope | Resource |
| First steps | [Edge Application first steps](/en/documentation/products/edge-application/first-steps/) |
| About Rules Engine | [Rules Engine](/en/documentation/products/edge-application/rules-engine/) |
| About Adaptive Delivery | [Rules Engine](/en/documentation/products/edge-application/cache-settings/#adaptive-delivery) |
...
In [Cache Settings](/en/documentation/products/edge-application/cache-settings/), you can reference an existing device group for **Adaptive Delivery**. You can choose one or more device groups to apply the same Adaptive Delivery policies.
