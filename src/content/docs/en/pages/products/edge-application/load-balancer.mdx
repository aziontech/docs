...
In cases of maintenance or origin outages, you can disable an address temporarily from the balance. Turn off the **Active** switch and your server will become inactive, ensuring your infrastructure will smoothly undergoe maintenance procedures without disrupting the overall performance.
