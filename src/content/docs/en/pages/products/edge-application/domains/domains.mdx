...
You may also bind a [Digital Certificate](/en/documentation/products/edge-application/digital-certificate/) to domains of applications that use the HTTPs protocol.
...
To enable environment selection, contact our [Sales Team](https://www.azion.com/en/contact-sales/).
...
You may restrict access to your custom domain from the Azion domain by enabling the **CNAME Access Only** switch.
