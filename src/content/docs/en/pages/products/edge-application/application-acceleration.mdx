...
With **Application Acceleration**, you can expand the supported HTTP methods beyond the native `GET` and `HEAD` methods for your edge applications. By enabling this feature, you'll gain the ability to utilize the `OPTIONS`, `POST`, `PUT`, `PATCH`, and `DELETE` HTTP methods in your applications.
...
Find out more about [HTTP method caching](/en/documentation/products/edge-application/cache-settings/#caching-http-methods).
