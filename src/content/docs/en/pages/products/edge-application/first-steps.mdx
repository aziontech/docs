...
You are now in the area where you can configure general delivery settings of your application. 
...
1. [Access RTM](https://manager.azion.com/).
2. On the upper-right corner, access the **Account menu**.
3. Select **Billing & Subscriptions**.
4. Access the **Subscriptions** tab.
5. On the **Edge Application** section, turn on the switch for the desired module.
...
## Other Edge Application settings
...
Configure your edge application's [Single Origin](/en/documentation/products/edge-application/single-origin/) in the **Origins** tab:
...
Edit your cache configuration in [Cache Settings](/en/documentation/products/edge-application/edge-caching/):
