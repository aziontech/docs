...
:::note
This module is only available for **Enterprise** and **Mission Critical** plans. For further details on Azion's plans, go to the [Pricing](https://www.azion.com/pt-br/precos/) page. Contact the [Support team](https://tickets.azion.com/) to activate this feature on your account.
:::

Due to their nature as a bidirectional open connection, WebSocket Proxy is incompatible with the use of the [Edge Functions](/en/documentation/products/edge-application/edge-functions/) and [Image Processor](/en/documentation/products/edge-application/image-processor/) modules. WebSocket connections will also not work in conjunction with edge caching or [L2 Caching](/en/documentation/products/edge-application/l2-caching/).
