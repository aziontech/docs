...
To prevent a user from receiving another user's `Set-Cookie` session, see the [cache policies guide](/en/documentation/products/guides/edge-caching/#creating-a-rule-to-bypass-cache-from-the-origin).
