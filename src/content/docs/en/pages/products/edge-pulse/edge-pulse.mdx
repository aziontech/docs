...
Edge Pulse collects information from the Resolver used for DNS resolution, edge location tested, and the user's anonymous network. 

You can explore user experience and navigation data via [Real-Time Events](/en/documentation/products/real-time-events/). You can use this data to make decisions regarding user routing.
