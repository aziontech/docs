...
Displays the event records of requests made to your edge functions. You must be subscribed to the [Edge Funcions](/en/documentation/products/edge-application/edge-functions/) module to view data.
...
| $locationhref | Returns the complete URL of the current page. |
...
| $navigation.redirectCount | Returns the number of redirects since the last navigation without redirection in the context of the current navigation. |
...
Displays the event records of requests analyzed by WAF to allow you to map the score assigned to the request, the WAF rules that matched, the reason for the block, and more.. You must be subscribed to the [Web Application Firewall (WAF)](/en/documentation/products/edge-firewall/web-application-firewall/) module to view data.
