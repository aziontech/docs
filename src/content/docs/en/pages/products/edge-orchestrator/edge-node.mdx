...
It is an open software that can be run on different types of microprocessor architecture: x86 and ARM, and different sizes of equipment, including:
...
| --help or -h | It helps with the commands that the agent can execute. |
