...
| start -g OR --join-group | By using these flags followed by a comma-separated list of group names, you can enroll your edge node with the specified group(s) through the command line while starting your node for the first time. <br/> Example: sudo edge-orchestrator start -g GROUP1,GROUP2,GROUP3 --foreground |
