...
[Use the Historical Real-Time Metrics](/en/documentation/products/historical-real-time-metrics/).
...
[Data Streaming](/en/documentation/products/data-streaming/), [Edge Functions](/en/documentation/products/edge-application/edge-functions/), [Intelligent DNS](/en/documentation/products/intelligent-dns/), [Image Processor](/en/documentation/products/edge-application/image-processor/), and [L2 Caching](/en/documentation/products/edge-application/edge-caching/#l2-caching) are paid products. To view their metrics, you must subscribe to the products and have them activated in your account.
...
- **Date calendar**: calendar field with the date and time of your chosen time range. When you select a time range, it automatically sets the begin and end dates, but if you want to use a different time range, you need to manually set up the beginning and ending dates in the calendar fields.
...
For a complete step by step, see the [How to use Real-Time Metrics](/en/documentation/products/guides/use-real-time-metrics/) guide.
