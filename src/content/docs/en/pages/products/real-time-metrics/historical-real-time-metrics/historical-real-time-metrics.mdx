...
![Historical Real-Time Metrics graph properties location on Real-Time Manager's screen.](https://www.azion.com/assets/docs/images/uploads/graph-historical-real-time-metrics.png)
