...
Through **Network Lists**, you can create, search, or update all Network Lists used in the **Edge Firewall Rules Engine**. Also, maintain your own lists, via [Real-Time Manager (RTM)](https://manager.azion.com), through the Network Lists configuration page, or via [API](https://api.azion.com/), through the Network Lists endpoints. 
