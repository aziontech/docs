...
| Field              | Description                                                                                                                                                                       |
|--------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `Rule ID`          | Unique numeric ID of WAF Rule                                                                                                                                                     | 
...
| `Match Zone`       | Parts or fields of the requisition that'll be compared with the `match pattern`. It can be `Path`, `Query String`, `Request Header`, `Request Body`, `File Name`, and `Raw Body`. | 
| `Active`           | Allowed Rule active status switch.                                                                                                                                                |

> Learn more about each Match Zone field at the *Match Zone dropdown options* table below.

### Match Zone dropdown options table
...
> The `Last Editor` and `Last Modified` fileds are only available through the [API](https://api.azion.com).
