...
## Setting up a Custom Allowed Rule
...
* The use of Regex only applies to *Conditional* type *Match Zones* with *Content Type* having key and value semantics.
  ...
  ![Regex Conditional](https://www.azion.com/assets/docs/images/uploads/regex_conditional.png)

* When using Regex you have to enable the `This Match Zone uses Regex` switch.

  ![Regex switch](https://www.azion.com/assets/docs/images/uploads/regex_switch.gif)
