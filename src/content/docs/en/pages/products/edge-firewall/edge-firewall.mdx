...
The Criteria and Behaviors available in the Edge Firewall depends on the modules you have enabled in the Rule Set main configuration. Here is the list of Criteria and Behaviors available to each Edge Firewall module:
