...
The Criteria and Behaviors available in Edge Firewall depends on the modules you have enabled in the Rule Set main configuration. Here's the list of Criteria and Behaviors available to each Edge Firewall module:
...
> DDoS Protection module is activated by standard and doesn't need any additional configuration.
...
[Find out more about DDoS Protection](/en/documentation/products/edge-firewall/ddos-protection/).
...
[Find out more about Edge Functions for Edge Firewall](/en/documentation/products/edge-firewall/edge-functions/firewall/).
...
[Find out more about Network Layer Protection](/en/documentation/products/edge-firewall/network-layer-protection/).
...
[Find out more about Origin Shield](/en/documentation/products/edge-firewall/network-layer-protection/#origin-shield).
...
[Find out more about Web Application Firewall](/en/documentation/products/edge-firewall/web-application-firewall/).