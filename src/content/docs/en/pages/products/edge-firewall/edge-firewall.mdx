...
The Criteria and Behaviors available in the Edge Firewall depends of the modules you have enabled in the Rule Set main configuration. Here is the list of Criteria and Behaviors available to each Edge Firewall module:
...
> DDoS Protection module is activated by standard and dont need any aditional configuration.
...
[See more](/en/documentation/products/edge-firewall/edge-functions/firewall/).
