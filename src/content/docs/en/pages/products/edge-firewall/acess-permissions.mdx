...
With **access permissions** it's possible to have more confidence, security, and flexibility when defining functions and roles for users, as well as for groups of users.
