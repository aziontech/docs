...
To activate **DDoS Protection - Unmetered** you need to have an Azion *Business*, *Enterprise*, or *Mission Critical* account. The *Developer* account doesn't have support for DDoS Protection.

The account type configuration is available at the **Real-Time Manager (RTM)** account menu, under *Billing & Subscriptions*, then on *Subscriptions* tab, at the last section, [Service Plans](https://manager.azion.com/billing-subscriptions/subscriptions).

## DDoS Protection - Unmetered advantages and characteristics

### Always-on mitigation

**DDoS Protection - Unmetered** is *always-on*. It is continuously monitoring network flow by inspecting incoming traffic and using *Deep Packet Inspection (DPI)*. It also provides advanced traffic analysis and signature algorithms to detect and block malicious traffic in time and with no impact on your applications.

You can also optimize protection against DDoS attacks at the application layer (layer 7) using the [Web Application Firewall](/en/documentation/products/edge-firewall/web-application-firewall/) [Edge Firewall](/en/documentation/products/edge-firewall/) module.
...
**DDoS Protection - Unmetered** offers sophisticated algorithms for automated attack mitigation. It is suitable for medium-sized businesses to companies that use Azion in mission-critical systems, with a direct impact on business results, and that want protection against any volume of attack.

### Support for add-ons extensions

**DDoS Protection - Unmetered** have support for *add-ons*, such as **Infrastructure Protection** and **DNS Protection**, which together guarantee the protection of your entire *Autonomous System (AS)* infrastructure and your *Domain Name System (DNS)* service.
...
**DDoS Protection - Unmetered** offers 24-hour access to Azion's *Security Response Team (SRT)*. The SRT can be contacted during an attack, after an attack, or even preventively, in the construction of customized rules. Whenever contacted, the SRT will support you in incident triage, root cause identification, and application of necessary mitigations on your behalf.
