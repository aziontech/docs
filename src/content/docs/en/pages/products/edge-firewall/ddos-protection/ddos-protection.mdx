...
**DDoS Protection - Unmetered** is *always-on*. It's continuously monitoring network flow by inspecting incoming traffic and using *Deep Packet Inspection (DPI)*. It also provides advanced traffic analysis and signature algorithms to detect and block malicious traffic in time and with no impact on your applications.
