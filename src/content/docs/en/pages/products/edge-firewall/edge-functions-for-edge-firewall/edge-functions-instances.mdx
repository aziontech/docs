...
namespace: documentation_products_edge_firewall_edge_functions_for_edge_firewall_edge_functions_instances
permalink: /documentation/products/edge-firewall/edge-functions-for-edge-firewall/edge-functions-instances/
---
...
To learn more about how they work and how to apply some of these Edge Functions, visit our [Use Cases](/en/documentation/use-cases/).