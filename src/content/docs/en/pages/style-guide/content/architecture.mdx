...
- [Deploy Jamstack websites on a distributed network](/en/documentation/guides/application-development/frameworks/deploy-jamstack-applications/): a diagram, a numbered dataflow, the components involved, and links out to the implementation.
