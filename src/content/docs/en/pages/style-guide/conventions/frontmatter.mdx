...
- Use lowercase ASCII letters, digits, hyphens, and slashes only, and end with a slash: `/documentation/guides/application-development/data/create-and-modify-bucket/`.
