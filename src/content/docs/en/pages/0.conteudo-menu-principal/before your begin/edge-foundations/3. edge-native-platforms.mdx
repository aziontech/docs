...
In this matter, the [2023 GigaOm Radar for Edge Platforms](https://www.azion.com/en/lp/gigaom-radar/) highlights two critical characteristics:
...
<Button href="/en/documentation/products/azion-foundations/about-azion-edge-platform/" text="Go to Azion foundations"> 
