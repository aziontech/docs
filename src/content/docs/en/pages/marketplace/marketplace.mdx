...
**Azion Marketplace** is a digital catalog that makes it easy to find, test, and deploy edge-running software. With a wide range of solutions, you can quickly deploy new edge applications based on [templates](#azion-templates) or use [integrations](#azion-integrations) to improve, compose, or customize your applications.
...
Additionally, the marketplace provides a way for Azion to distribute the solutions easily to be used in your applications, as well as allowing Independent Software Vendors (ISVs), software developers, and open-source communities to distribute software to an audience of thousands of buyers.
...
| [Azion Marketplace Solutions’ permissions](/en/documentation/products/guides/permissions-mktp/) | Reference to learn about required permissions for some solutions.|
| [Marketplace Sellers Guide](https://www.azion.com/en/documentation/products/marketplace/marketplace-seller-guide/) | Check the basics for ISVs who want to have their applications integrated and distributed via Azion Marketplace.  |

---

## How Azion Marketplace works

**Azion Marketplace** provides solutions to speed up your workflow: from development and deployment to management and monitoring. These solutions include [pre-built templates](#azion-templates) to deploy a new project from scratch and [integrations](#azion-integrations) to increase the capabilities of your applications and services.

By accessing [Real-Time Manager (RTM)](https://manager.azion.com/), Azion's configuration inteface, you find the solutions to attend to your needs. You can select the desired solution, complete the setup, and deploy it.
