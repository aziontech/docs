...
Additionally, the marketplace provides a way for Azion to easily distribute the solutions to be used in your applications, as well as allowing Independent Software Vendors (ISVs), software developers, and open-source communities to distribute software to an audience of thousands of buyers.
...
By accessing [Real-Time Manager (RTM)](https://manager.azion.com/), you find the solutions to attend to your needs. You can select the desired solution, complete the setup, and deploy it.
