...
The integrations included within the Marketplace aren’t static. Azion and Azion’s partners can update them when they launch new features. Thus, the recommendation is always to have the most updated integration.
...
2. On the Marketplace's homepage, select the solution you want to check.
...
By clicking the **Get New Version** button, you’ll download the solution’s latest version.
...
When you update a integration in Azion Marketplace, *it won’t overwrite the version of the solution’s version you’re currently running on your edge application*. This occurs to give you control over the version you want to use with your application.
...
<Button href="/en/documentation/products/guides/build/configure-main-settings/" text="go to configuring main settings guide" variant="secondary"> 
