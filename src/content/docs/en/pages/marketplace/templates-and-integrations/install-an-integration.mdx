...
Considering Azion Marketplace has solutions that run edge functions in two ways, you'll need to proceed according to the type of integration you want to install:
...
On the **Code** tab, you’ll be able to navigate through the code, but won’t be able to change it. On the **Args** tab, you’ll pass the solution parameters.
