...
description: Compatibility between Azion Edge Runtime and web frameworks through Vulcan.
...
Azion Edge Runtime supports Next 12.3.1 for `compute` applications. 

**Node.js**

Node.js runtime (v12.3.1) is currently is supported.

Currently Edge Runtime is not supported.

Node.js APIs 

| API | Support |
|async_hooks| `asyncLocalStorage` and `AsyncResource` are implemented |
...
:::note
If the project is in Next.js version 12.3.1, some dependencies won't work and must be resolved.
:::
...
- [RTM Next.js boilerplate](/en/documentation/products/guides/nextjs-static-boilerplate/)
