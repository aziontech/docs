...
By clicking on the link sent by email, the [Real-Time Manager](https://console.azion.com/) page will open. To sign in:
...
You're now able to access **Azion Console** and start building your edge applications. Check the [Get Started](/en/documentation/products/getting-started/) page to continue your onboarding journey.
...
You're now able to access **Console** and start building your edge applications. Check the [Get Started](/en/documentation/products/getting-started/) page to continue your onboarding journey.
