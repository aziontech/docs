...
To begin using Azion Edge Platform and all the available products, you need to complete the sign-up process and log in to the configuration interface, [Real-Time Manager (RTM)](https://console.azion.com/).
