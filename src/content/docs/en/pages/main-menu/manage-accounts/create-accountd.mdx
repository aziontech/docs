...
To begin using Azion Edge Platform and all the available products, you need to complete the sign-up process and log in to the configuration interface, [Azion Console](https://console.azion.com/).
...
1. On the [sign-up page](https://console.azion.com/signup), click the **Sign Up with Work Email** button; a new page will open.
