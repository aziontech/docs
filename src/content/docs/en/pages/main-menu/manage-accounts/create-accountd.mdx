...
permalink: /documentation/fundamentals/creating-account/
---
...
You're now able to access **Azion Console** and start building your applications. Check the [build an application](/en/documentation/guides/application-development/getting-started/build-an-application/) page to continue your onboarding journey.
...
You're now able to access **Console** and start building your applications. Check [build an application](/en/documentation/guides/application-development/getting-started/build-an-application/) page to continue your onboarding journey.
