...
You're now able to access **Azion Console** and start building your edge applications. Check the [build an application](/en/documentation/products/guides/build/build-an-application/) page to continue your onboarding journey.
...
You're now able to access **Console** and start building your edge applications. Check [build an application](/en/documentation/products/guides/build/build-an-application/) page to continue your onboarding journey.
