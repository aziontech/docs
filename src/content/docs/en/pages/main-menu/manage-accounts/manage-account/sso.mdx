...
permalink: /documentation/guides/platform/account-and-billing/sso/
---
...
<DocButton href="/en/documentation/guides/#accounts" label="Identity Providers guides" kind="secondary" size="medium" />
