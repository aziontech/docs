...
description: Find out how to use Multi-Factor Authentication on Azion Console.
...
3. Scan the QR code that appears when you log into **Azion Console**.
4. Type the six-digit code and click **Verify Code**.

With MFA, you must have access to your mobile phone to log into Console and provide the 6-digit code.
...
To log in to Azion Console with Multi-Factor Authentication activated:
...
In case of loss or theft of your mobile phone, you won't be able to log in to Console unless an **Account owner** resets the MFA function.
