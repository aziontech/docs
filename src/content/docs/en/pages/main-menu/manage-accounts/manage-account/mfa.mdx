...
permalink: /documentation/guides/platform/account-and-billing/multi-factor-authentication/
---

[Multi-Factor Authentication (MFA)](/en/documentation/fundamentals/multi-factor-authentication/) allows you to secure logins by requiring an extra layer to authentication.
