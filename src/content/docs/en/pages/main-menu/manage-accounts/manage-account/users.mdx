...
description: Find out how to use Users Management on Azion Console.
...
If you haven't yet created a team when adding a user, you can choose the **Default Team** [in Azion Console](https://console.azion.com/).
...
:::note
New users will receive an automatic email to activate the account, which will be available for 14 days. If it isn't activated within that period, they will be automatically removed from Console.
:::
