...
1. Log in to [Real-Time Manager (RTM)](https://console.azion.com/).
...
If you haven't yet created a team when adding a user, you can choose the **Default Team** [in RTM](https://console.azion.com/).
