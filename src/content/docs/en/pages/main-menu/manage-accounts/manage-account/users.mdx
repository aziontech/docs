...
permalink: /documentation/guides/platform/account-and-billing/users-management/
---


[Users Management](/en/documentation/fundamentals/users-management/) allows you to add, modify, and delete users to your account.
...
You can add users before or after [creating teams](/en/documentation/fundamentals/teams-permissions/).
