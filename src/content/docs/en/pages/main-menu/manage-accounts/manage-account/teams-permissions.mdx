...
With [Teams Permissions](/en/documentation/products/accounts/teams-permissions/), you can create and manage teams, control and configure access rights for distinct teams within your organization.
