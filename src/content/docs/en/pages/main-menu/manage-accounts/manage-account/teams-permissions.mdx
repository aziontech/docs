...
permalink: /documentation/guides/platform/account-and-billing/teams-permissions/
---

With [Teams Permissions](/en/documentation/fundamentals/teams-permissions/), you can create and manage teams, as well as control and configure access rights for distinct teams within your organization.
