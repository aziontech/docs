...
[Personal Tokens](/en/documentation/products/accounts/personal-tokens/) allow you to authenticate your access to interfaces and tools such as the [Azion CLI](/en/documentation/products/build/develop-with-azion/cli/) and [Azion API](https://api.azion.com). 
