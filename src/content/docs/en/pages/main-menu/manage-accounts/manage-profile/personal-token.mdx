...
permalink: /documentation/guides/platform/account-and-billing/personal-tokens/
---

import Tabs from '~/components/tabs/Tabs'


[Personal Tokens](/en/documentation/fundamentals/personal-tokens/) allow you to authenticate your access to interfaces and tools such as the [Azion CLI](/en/documentation/guides/) and [Azion API](/en/documentation/devtools/api/). 
