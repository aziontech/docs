...
<LinkButton outlined link="/en/documentation/devtools/graphql-api/first-steps/#accessing-graphql-playground" label="access graphql playground" variant="secondary" />
