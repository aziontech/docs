...
permalink: /documentation/devtools/graphql/graphql-playground/
---
...
<DocButton href="/en/documentation/devtools/graphql/first-steps/#accessing-graphql-playground" label="Access GraphiQL Playground" kind="secondary" size="medium" />
...
:::tip
For more details, check the [How to identify the Top IPs generating attack traffic using GraphQL API](/en/documentation/guides/platform/observability/query-top-ips-attack-traffic-with-graphql/) guide.
:::
...
:::tip
Visit the [Guides page](/en/documentation/guides/#graphql-api) and the [GraphQL API documentation](/en/documentation/devtools/graphql/) to explore more options for querying data.
:::
