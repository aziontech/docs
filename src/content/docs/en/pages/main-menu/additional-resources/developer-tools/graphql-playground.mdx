...
description: Use the GraphiQL API plaground to explore and understand how it works.
...
<LinkButton link="/en/documentation/devtools/graphql-api/first-steps/#accessing-graphql-playground" label="Access GrapihQL Playground" severity="secondary" />
...
query TOP5IPsWAFRequests {
  httpEvents(
    ...
    groupBy:[remoteAddress, naxsiAttackFamily]
    orderBy:[count_DESC]
  )
  {
    remoteAddress
