...
| [Hello World](/en/documentation/products/guides/hello-world/) | Test how the edge technology works, by displaying a message, `Hello World`, on your browser using an edge application. |
...
<LinkButton outlined link="/en/documentation/products/guides/#marketplace" label="Go to integrations guides" variant="secondary" /> 
...
| Integration | Description |
|---|---|
| [Azion Bot Manager](/en/documentation/products/guides/bot-manager/) | Use this integration to analyze incoming requests and assign a score based on rules and behaviors. |
