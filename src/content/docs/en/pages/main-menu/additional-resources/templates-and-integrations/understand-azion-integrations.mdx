...
| [Add Request ID](/en/documentation/products/guides/add-request-id-header/) | Add an additional HTTP header in the incoming request object, assigning a unique identifier to each HTTP request attended by Azion Edge Platform. |
