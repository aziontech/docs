...
<LinkButton outlined link="/en/documentation/products/guides/build/instantiate-edge-functions/" label="go to How to instantiate edge functions guide" variant="secondary" /> 
