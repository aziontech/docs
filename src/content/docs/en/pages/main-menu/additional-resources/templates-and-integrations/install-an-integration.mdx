...
:::tip
To build a new edge application, go to the [Build](/en/documentation/products/guides/build/build-an-application/) journey for more details on this topic.
:::
...
4. Select the workloads you want to protect with the function.
