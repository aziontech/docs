...
<Button href="/en/documentation/products/guides/ynamic-and-static-file-optimization-template/" text="go to the Dynamic and Static File Optimization template guide" variant="secondary"> 
