...
The VuePress Templates collection presents a number of templates for deploying web applications based on VuePress. You can choose and deploy the template that best fits your needs and preferences.
