...
<Button href="/en/documentation/products/guides/jekyll-boilerplate/" text="go to the Jekyll Boilerplate guide" variant="secondary"> 
...
<Button href="/en/documentation/products/guides/svelte-boilerplate/" text="go to the Svelte Boilerplate guide" variant="secondary" />
