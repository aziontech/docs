...
<br />
<Button href="https://manager.azion.com/build-application/build/choose-template/template/hexo/hexo-boilerplate" text="deploy this template" variant="secondary"> 
...
<br />
<Button href="https://manager.azion.com/build-application/build/choose-template/template/nextjs/nextjs-static-boilerplate" text="deploy this template" variant="secondary"> 
...
<br />
<Button href="https://manager.azion.com/build-application/build/choose-template/template/github/edge-function-github-autodeploy" text="deploy this template" variant="secondary"> 
...
<br />
<Button href="https://manager.azion.com/build-application/build/choose-template/template/azion/edge-hello-world/" text="deploy this template" variant="secondary"> 
...
<br />
<Button href="https://manager.azion.com/build-application/build/choose-template/template/azion/static-cache" text="deploy this template" variant="secondary"> 
...
<br />
<Button href="https://manager.azion.com/build-application/build/choose-template/template/azion/image-optimization" text="deploy this template" variant="secondary"> 
...
<br />
<Button href="https://manager.azion.com/build-application/build/choose-template/template/azion/edge-application-proxy" text="deploy this template" variant="secondary"> 
...
<br />
<Button href="https://manager.azion.com/build-application/build/choose-template/template/azion/dynamic-and-static-file-optimization" text="deploy this template" variant="secondary"> 
</Button>
...
<br />
<Button href="https://manager.azion.com/build-application/build/choose-template/template/mongodb-atlas/mongodb-atlas" text="deploy this template" variant="secondary"> 
...
<br />
<Button href="https://manager.azion.com/build-application/build/choose-template/template/fauna/faunadb-boilerplate" text="deploy this template" variant="secondary"> 
