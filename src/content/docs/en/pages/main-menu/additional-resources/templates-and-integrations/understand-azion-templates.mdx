...
The **Qwik Minimal template**, helps you to quickly set up a basic project using the Qwik framework and run it directly on the edge of the network.

<LinkButton link="/en/documentation/products/guides/qwik-minimal/" label="go to the Qwik Minimal guide" severity="secondary" /> 
...
The Azion **Qwik Boilerplate*, helps you set up a project using the Qwik framework and run it directly on the edge of the network.
