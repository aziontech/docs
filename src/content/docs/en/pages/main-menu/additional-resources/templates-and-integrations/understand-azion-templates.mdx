...
<Button href="/en/documentation/products/guides/gatsby-boilerplate/" text="go to the Gatsby Boilerplate guide" variant="secondary"> 
...
<Button href="/en/documentation/products/guides/nextjs-app-configurations/" text="go to the Next.js App + Configurations template guide" variant="secondary"> 
...
<Button href="/en/documentation/products/guides/nextjs-app-configurations-turso/" text="go to the Next.js App + Configurations + Turso template guide" variant="secondary"> 
...
<Button href="/en/documentation/products/guides/nextjs-app-middleware/" text="go to the Next.js App + Middleware template guide" variant="secondary"> 
...
<Button href="/en/documentation/products/guides/nextjs-pages-configurations/" text="go to the Next.js Pages + Configurations template guide" variant="secondary"> 
...
<Button href="/en/documentation/products/guides/nextjs-pages-middleware/" text="go to the Next.js Pages + Middleware template guide" variant="secondary"> 
...
<Button href="/en/documentation/products/guides/gatsby-blog-starter-kit/" text="go to the Gatsby Blog Starter Kit guide" variant="secondary"> 
...
The **HTMX Minimal** template facilitates you to deploy and test a minimal example of the HTMX library in Azion Edge Platform.

<Button href="/en/documentation/products/guides/htmx-minimal-template/" text="go to the HTMX Minimal template guide" variant="secondary"> 
...
<Button href="/en/documentation/products/guides/turso-starter-kit/" text="go to the Turso Starter Kit guide" variant="secondary"> 
