...
<br />
<Button href="https://manager.azion.com/build-application/build/choose-template/" text="deploy this template" variant="secondary"> 
...
<Button href="/en/documentation/products/guides/suite-static-cache/" text="go to the Suite Static Cache template guide" variant="secondary"> 
...
**Suite Image Cache** includes configurations for enhancing image loading and caching based on file extension. These configurations use advanced cache key rules that are applied through Rules Engine for Edge Application.

<Button href="/en/documentation/products/guides/suite-image-cache/" text="go to the Suite Image Cache template guide" variant="secondary"> 
...
<Button href="/en/documentation/products/guides/suite-bypass/" text="go to the Suite Bypass template guide" variant="secondary"> 
