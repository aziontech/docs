...
The **Bot Manager Lite and TOR Block Starter Kit** template enables you to deploy a basic security suite to protect your workloads from bad bots and Tor Exit Nodes requests.
