...
<LinkButton link="/en/documentation/products/guides/static-cache-videoteca-player/" label="go to the Static Cache + Videoteca Player template guide" severity="secondary" /> 
