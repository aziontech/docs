...
#### Clean Clean Astro + Sanity application

This template creates a minimal Astro website integrated with Sanity.io for managing the content.
...
#### Clean Clean Nuxt + Sanity application
...
<LinkButton link="/en//documentation/products/guides/cosmic-simple-next-blog/" label="Go to the Cosmic + Simple Next.js Blog guide" severity="secondary" />
