...
Create and manage a blog page with support to Markdown, MDX, and React components, based on Docusaurus.

<LinkButton link="/en/documentation/products/guides/docusaurus-blog-starter-kit/" label="go to the Docusaurus Blog Starter Kit guide" severity="secondary" /> 
