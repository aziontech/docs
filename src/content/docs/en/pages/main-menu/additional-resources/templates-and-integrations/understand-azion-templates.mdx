...
The Cosmic CMS Templates collection presents a number of templates to deploy an application using Cosmic CMS. You can choose and deploy the template that best fits your needs and preferences.

<LinkButton link="/en/documentation/products/guides/cosmic-cms-collection/" label="Go to the Cosmic CMS Templates guide" severity="secondary" /> 
