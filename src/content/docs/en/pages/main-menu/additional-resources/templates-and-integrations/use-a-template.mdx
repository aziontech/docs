...
Go to the [guides page](https://www.azion.com/en/documentation/guides/#azion-templates) and check more details on the specific template you're willing to use.

:::tip
To know more on how to edit and customize your application's main settings, go to the [Configuring main settings](/en/documentation/guides/application-development/getting-started/configure-main-settings/) guide. You can also [Go live with Azion](/en/documentation/products/go-live-with-azion/), adding a custom domain and poiting your traffic.
:::
