...
:::tip
To know more on how to edit and customize your application's main settings, go to the [Configuring main settings](/en/documentation/guides/application-development/getting-started/configure-main-settings/) guide. You can also [Go live with Azion](/en/documentation/fundamentals/), adding a custom domain and poiting your traffic.
:::
