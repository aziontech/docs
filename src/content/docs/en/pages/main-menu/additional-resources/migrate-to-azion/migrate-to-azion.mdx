...
- **Azion account**: Create a free account at [Azion Console](https://console.azion.com/). You'll need access to the Console to create applications and configure domains.
  <LinkButton link="/en/documentation/products/guides/create-account-azion/" label="Create an Azion account" severity="secondary" target="_blank" />
...
You can start by creating an application using a basic template. A recommended option is the [Hello World](/en/documentation/products/guides/hello-world-template/) template, which uses **Functions** to run a simple function on a distributed architecture.
