...
You can start by creating an edge application using a basic template. A recommended option is the [Hello World](/en/documentation/products/guides/hello-world-template/) template, which uses **Functions** to run a simple function on the edge.
