...
1. **Origin address**: the source server of the application. This entry point to the edge takes the form of either a host, an IPv4, or an IPv6 address of a storage service or an existing application.
  <LinkButton link="/en/documentation/products/build/edge-application/origins/" label="Go to Origins reference" outlined target="_blank" />
...
2. **Delivery domain**: the target domain of the application. This output takes the form of an Azion domain, which can be pointed to a custom domain. 
  <LinkButton link="/en/documentation/products/edge-application/domains/" label="Go to Domains reference" outlined target="_blank" />
...
<LinkButton link="/en/documentation/products/guides/build/overview/" label="Go to Edge Application overview" outlined target="_blank" />
...
<LinkButton link="/en/documentation/products/marketplace/templates-and-integrations-overview/" label="Go to Templates reference" outlined target="_blank" />
...
<LinkButton link="/en/documentation/products/guides/point-domain-to-azion/" label="How to point a domain to Azion" outlined />
