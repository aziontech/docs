...
- [Build](/en/documentation/guides/)
- [Store](/en/documentation/)
- [Secure](/en/documentation/platform/firewall/)
- [Deploy](/en/documentation/build/orchestrator/)
- [Observe](/en/documentation/platform/real-time-metrics/)

Common use cases:

- Build and deploy [applications](/en/documentation/platform/applications/) on Azion’s global infrastructure.
- Speed up delivery with [templates and integrations](/en/documentation/marketplace/templates-and-integrations-overview/).
- Adopt [zero trust architectures](/en/documentation/guides/) for apps and content.
- Improve delivery on a [highly distributed network](https://www.azion.com/en/products/our-network/).
- Configure [caching rules](/en/documentation/build/cache/) and advanced optimizations.
- Monitor performance with [real-time metrics](/en/documentation/platform/real-time-metrics/).
- Improve [performance](/en/documentation/guides/application-performance/delivery-optimization/content-delivery/) and reduce bandwidth and operational costs.
- Develop with [supported frameworks and languages](/en/documentation/guides/).
- [Migrate your architecture and content](/en/documentation/fundamentals/migrate-to-azion/).
...
- [Azion Console](/en/documentation/guides/platform/account-and-billing/getting-to-know-azion-console/): configure products, provisioning, billing, and permissions
- [Azion CLI](/en/documentation/devtools/cli/): manage services via terminal (Go-based, open source)
- [Azion API](https://api.azion.com/): REST API over HTTPS for integration and automation
- [Azion Terraform Provider](/en/documentation/devtools/terraform/): manage Azion resources as code
