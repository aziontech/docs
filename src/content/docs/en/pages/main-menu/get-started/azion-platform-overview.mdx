...
meta_tags: >-
  Azion, edge application, Azion Web Platform, edge computing, edge-native platform
...
**Azion Web Platform** is an edge-native and full-stack platform that simplifies building and running modern applications anywhere: on Azion's network edge, remote devices, on-premises, or multi-cloud.
