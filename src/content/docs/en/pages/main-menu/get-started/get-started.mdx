...
description: >-
  This documentation introduces the Azion Edge Platform and key concepts to help you better understand edge computing.
meta_tags: >-
  Azion, edge application, Azion Edge Platform, edge computing, edge-native platform
...
**Azion Edge Platform** is an edge-native and full-stack platform that simplifies building and running modern applications anywhere: on Azion's network edge, remote devices, on-premises, or multi-cloud.
...
**Azion Edge Platform** is built over a robust infrastructure composed of various key components, as well as business logic and rules that allow for offering a reliable, scalable, and high-performance service.
...
1. A request is sent to a web service running on the **Azion Edge Platform** and it defines, using software-define routing, the best path to the request and redirects it to the *closest* edge location.
...
- Building and deploying [edge applications](/en/documentation/products/build/edge-application/) that run directly at the edge of the network.
...
- Creating [zero trust architectures](https://www.azion.com/en/blog/first-steps-to-simplify-the-zero-trust-model-adoption/) to protect your content and applications.
