...
<LinkButton outlined link="/en/documentation/products/guides/migrate-ns-to-azion/" label="Go to Migrate your NS to Azion guide" variant="secondary" /> 
...
<LinkButton outlined link="/en/documentation/products/guides/point-domain-to-azion/" label="Go to Point your domain to Azion guide" variant="secondary" /> 
