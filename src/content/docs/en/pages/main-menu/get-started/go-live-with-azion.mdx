...
<Button href="/en/documentation/products/guides/migrate-ns-to-azion/" label="Go to Migrate your NS to Azion guide" type="primary" theme="light" />
...
<Button href="/en/documentation/products/guides/point-domain-to-azion/" label="Go to Point your domain to Azion guide" type="primary" theme="light" />
