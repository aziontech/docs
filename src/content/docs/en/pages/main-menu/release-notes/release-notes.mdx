...
- **Custom Domain (azion.app)**: Instantly share applications with a readable domain (FQDN) available via the API. Coming soon to Console.  
- **Expanded Integrations**: New CMS platforms (Sanity, Cosmic, ButterCMS).  
