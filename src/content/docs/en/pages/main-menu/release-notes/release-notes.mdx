...
- **Cache Settings**: Cache TTL is now preserved when Application Accelerator is enabled.
- **Versioning**: Minor improvements to the versioning drawer.
...
- **Data Stream**: Added data sources and resources for managing Data Stream.
...
Read more about [Azion CLI](/en/documentation/products/azion-cli/overview/), [Azion Lib](/en/documentation/products/azion-lib/overview/), and [Azion Bundler](/en/documentation/products/devtools/azion-edge-runtime/frameworks-compatibility/).
...
To learn more about Azion Console, check out the [documentation](/en/documentation/products/guides/how-to-access-azion-console/).
...
Learn more about [Data Stream](/en/documentation/products/observe/data-stream/) and [Azion Console](/en/documentation/products/guides/how-to-access-azion-console/).
