...
Check the [How to deploy edge applications with the Vue3/Vite Boilerplate](/en/documentation/products/guides/vue-vite-boilerplate/ss) guide for more details.
