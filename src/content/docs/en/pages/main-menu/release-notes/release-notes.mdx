...
Azion **Edge SQL** is an edge-native SQL solution designed for serverless applications, now available in **Preview**. Edge SQL is fully ACID-compliant and utilizes SQLite’s SQL dialect, allowing you to interact in two ways: create, read, update, delete, and list databases via REST API or retrieve data from a database via Edge Functions. 
