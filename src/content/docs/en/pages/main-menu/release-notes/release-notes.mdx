...
- **Custom Domain (azion.app)**: Instantly share apps with a readable subdomain available in the API. Coming soon to Console.  
...
As part of the ongoing Launch Week, we also want to highlight some of the transformative updates recently introduced to our platform: Node.js API Compatibility with [broader support](https://azion-node-matrix-compat.azion.app/) for Node.js APIs, and expanded framework support compatibility with Next.js, Vue, React, Angular, Gatsby, Astro, and more.
...
As part of the ongoing Launch Week, we also want to highlight some of the transformative updates recently introduced to our platform: Vector Search for distributed vector databases and efficient RAG pipelines.
