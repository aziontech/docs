...
- **Azion Lib**: Simplify service interactions with our new libraries. Visit the [reference documentation](/en/documentation/products/azion-lib/overview/) for more details.  
...
- **Console Improvements**:  
  ...
  - Dark mode and new navigation drawers. 
