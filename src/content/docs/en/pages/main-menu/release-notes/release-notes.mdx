...
Image Processor now supports images in the AVIF format, which provides superior compression and quality compared to other formats like WEPB, JPEG or PNG.
AVIF processing offer better compression rates, ensures higher visual quality especially for images with a lot of details and color variations, and reduces load time, enhancing user experience.

- Check the [Image Processor](/en/documentation/products/build/edge-application/image-processor/) documentation for more information.
