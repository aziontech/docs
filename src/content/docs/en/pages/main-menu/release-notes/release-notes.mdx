...
- **Node.js API Compatibility**: [Broader support](https://azion-node-matrix-compat.azion.app/) for Node.js APIs through new polyfills; including FS, Crypto, Process, HTTP/HTTPS, Events, and Stream modules.  
