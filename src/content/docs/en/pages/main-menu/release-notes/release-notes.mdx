...
Azion introduces **Edge AI**, enabling the execution of advanced AI models directly at the edge for minimal latency and maximum performance.
...
- **Advanced Workflows**: Includes reasoning, audio, text, image conversions, and tool calling.
- **Agent Support**: Build AI agents with **Tool Calling** and **Agentic RAG**, leveraging LangGraph from [LangChain](https://www.langchain.com/).
- **Edge SQL Integration**: Deploy distributed vector databases, semantic queries, and hybrid search for efficient RAG implementations.
- **Compatibility**: Integrates with OpenAI-compatible APIs, LangChain/LangGraph, and N8N for workflow automation.

For more details, visit the [Edge AI documentation](/en/documentation/products/edge-ai/overview/).
