...
- **CLI (GA, cross-platform):** Faster, intuitive, and now natively available for Windows, macOS, and Linux. Supports resource management, CI/CD integration, and full IaC workflows.  
- **Azion Bundler v5.1:** Twice as fast, optimized build times for major frameworks.  
- **Azion Lib:** Simplify service interactions with our new libraries. Visit the [reference documentation](https://www.azion.com/en/documentation/products/azion-lib/overview/) for more details.  
- **Git Deployments:** Easy deploys from Git repositories via new pre-configured templates and automatic CI/CD.  
- **Custom Domain (azion.app):** Instantly share apps with a readable subdomain—Coming soon to Console.  
- **Azion CLI & IaC:** Automate infrastructure with the latest version of command-line provisioning and management, integrated with Infrastructure as Code.
- **Expanded Integrations:** New CMS (Sanity, Cosmic, ButterCMS) platforms.  
- **Deploy to Azion Badge:** One-click deployment from your repo README or docs.  
- **API v4 (GA):**  
  - New event-driven architecture with decoupled design.  
  - Up to 80% faster critical operations.  
  - JWT/Bearer authentication.  
  - Activity History available via GraphQL.  
  - "Workload" resource model replaces "Domain"  
- **Console Improvements**:  
  - Headless, open-source UI.  
  - Dark mode & new navigation drawers. 
  - Real-Time Events: improved filtering and GraphQL queries.

These enhancements deliver unprecedented automation, speed, and developer experience across all Azion Dev Tools.
...
- **Node.js API Compatibility:** [Broader suppor](https://azion-node-matrix-compat.azion.app/)t for Node.js APIs through new polyfills; including FS, Crypto, Process, HTTP/HTTPS, Events, and Stream modules.  
- **WinterTC (ECMA Open Standard):** Over 80% compatibility with WinterTC APIs, promoting portability and eliminating vendor lock-in.  
- **Expanded Framework Support:** Now compatible with Next.js, Vue, React, Angular, Gatsby, Astro, and more.  
- **Runtime Limits Increased:** Edge Functions now run up to 5 minutes of CPU time and support application bundles up to 20 MB.  
- **Templates:** New templates for fast deployment of e-commerce, web sites, blogs, and more—available in Console.
...
- **Universal Open Data Ecosystem:** Openness for integrating external tools and rapid onboarding for distributed data needs.
...
- **Zero Egress Fees:** No cost for data transfer between Edge Storage and Edge Applications.

#### Platform Advancements

- **Network Upgrades:** New HTTP/2 and HTTP/3 optimizations for faster, modern application delivery.  
- **Reliability at Scale:** Global replication moved from millions to billions of workloads supported with high availability.
...
- **Vector Search:** distributed vector databases and efficient RAG pipelines.
...
Azion now offers support for multiple Node.js APIs in Azion Runtime, expanding the Node.js API compatibility to approximately 88.4% of Node.js functionalities by using [unenv](https://github.com/unjs/unenv) to resolve polyfills. For more information about supported Node.JS APIs, visit the [compatibility list](/en/documentation/products/azion-edge-runtime/compatibility/node/).
