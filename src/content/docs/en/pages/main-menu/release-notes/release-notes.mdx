...
- **Runtime Limits Increased**: Edge Functions now run up to 5 minutes of CPU time and support application bundles up to 20MB.  
- **Templates**: New templates for fast deployment of e-commerce, web sites, blogs, and more now available in the Console.
...
- **Zero Egress Fees**: No cost for data transfer between Azion Edge Storage and Azion Edge Applications.
