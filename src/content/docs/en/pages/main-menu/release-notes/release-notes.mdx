...
The latest version of **Azion CLI** introduces synchronized deploy: when you run the command `azion deploy`, you will be redirected to the Azion Console, where you can monitor the deployment logs for your application in real-time.
