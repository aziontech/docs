...
The new **Edge Function Starter Kit** template allow you to create an edge function-based application without origin dependencies. You  can use this template to quickly deploy an edge function that is ready to run at the edge.   

Check the [how-to guide](/en/documentation/products/guides/edge-function-starter-kit/) to learn more about it.
