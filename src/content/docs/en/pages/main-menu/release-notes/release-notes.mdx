...
Azion introduces several new Artificial Intelligence capabilities, including **Edge AI**, enabling the execution of advanced AI models directly at the Azion infrastructure for minimal latency and maximum performance.
...
For more details, visit the documentation for [Edge AI](/en/documentation/products/ai/edge-ai/), [Edge Functions](/en/documentation/products/build/edge-application/edge-functions/), and [Edge SQL](/en/documentation/products/store/edge-sql/).
