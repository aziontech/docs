...
- **events/graphql**: Added the Runners dataset.

#### Bug Fixes

- **Billing queries**: Filtered plans and support products by `metric_slug` instead of `product_slug`.
- **Aggregated billing queries**: Kept plans and support products rows visible in aggregated billing queries.
