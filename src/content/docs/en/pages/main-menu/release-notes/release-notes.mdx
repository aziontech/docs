...
**New Activity History dataset**

Now you can query your account activities using the GraphQL API. Search and filter the following data:
...
See more details on the [Real-Time Events GraphQL API Datasets reference documentation](https://www.azion.com/en/documentation/products/graphql-api-features/#datasets).
