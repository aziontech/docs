...
Templates for deploying a resume for the web:
...
Templates for deploying an E-commerce:
...
- [Bot Manager Basic](/en/documentation/products/guides/bot-manager-starter-kit/): with this template, you're able to deploy a new edge stack and see the Bot Manager in action.
- [Add Bot Manager to existent Edge Firewall](/en/documentation/products/guides/bot-manager-integration-kit/): an easy way to integrate the Bot Manager function in an existent Edge Firewall instance on Azion.
- [Bot Manager and TOR Exit Nodes](/en/documentation/products/guides/bot-manager-and-tor-block-starter-kit/): deploy a basic security suite to protect your domains from bad bots and TOR Exit Nodes requests.
