...
- The [Nuxt Notes](/en/documentation/products/guides/nuxt-notes/) template deploys a a basic note taking application which stores the notes in the browser’s local storage.
