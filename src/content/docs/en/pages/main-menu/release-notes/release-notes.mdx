...
Azion launched the **LangGraph AI Agent Boilerplate**, a powerful template designed to help create a real-time AI agent using **LangGraph**. This boilerplate uses Azion's robust edge computing infrastructure, ensuring optimized performance and reduced latency for applications that interact with data stored in an [Azion EdgeSQL](/en/documentation/products/store/edge-sql/) database.

You can check the [LangGraph AI Agent Boilerplate](/en/documentation/products/guides/langgraph-ai-agent-boilerplate/) guide to learn more about it.
