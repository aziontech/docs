...
Azion extends support for the Docusarurus framework with two new templates, covering more use cases:

- The [Docusaurus Blog Starter Kit](/en/documentation/products/guides/docusaurus-blog-starter-kit/) streamlines the creation and management of a blog page with support to Markdown and MDX, making it easy to write content with rich media and React components.
