...
title: Release notes
description: >-
  Check the latest changes and release notes in the Azion Edge Platform, Azion
...
We are excited to introduce Azion Lib, a comprehensive JavaScript SDK designed to facilitate seamless interactions with various Azion services, including **Edge Storage**, **Edge SQL**, and Purge functionalities. This versatile library is compatible with both Azion's **Edge Runtime** and external environments, ensuring efficient integration across diverse applications.
...
- **Flexible Configuration**: Supports environment variable-based configurations and debug modes to cater to various development needs.​
 ...
 For detailed installation and usage instructions, please refer to the [Azion Lib documentation](https://www.npmjs.com/package/azion).

### Azion Infrastructure as Code (IaC)

Azion Config – Enhanced Resource Support

The `azion.config.js` file, integral to Azion's Infrastructure as Code (IaC) approach, now supports a broader range of resources. This enhancement enables more granular and comprehensive configurations, encompassing:
...
For a comprehensive overview of the configurable properties, please consult the [Azion Config documentation](/en/documentation/devtools/cli/configs/azion-config-js/).

### Azion CLI

#### Improvements to `azion sync` Command

The `azion sync` command has been refined to enhance synchronization between local files and remote resources.

For more information, please visit our [CLI Command Sync Documentation](/en/documentation/devtools/cli/sync/).

#### Native Windows Support

We are pleased to announce that Azion CLI now offers native support for Windows operating systems using Powershell. You can install it through **Chocolatey** or **WinGet**.

For more information on these updates, please visit our [CLI documentation](/en/documentation/products/azion-cli/overview/).
...
The new **Edge Function Starter Kit** template allows you to create an edge function-based application without origin dependencies. You can use this template to quickly deploy an edge function ready to run at the edge.   

Check the [Edge Function Starter Kit template guide](/en/documentation/products/guides/edge-function-starter-kit/) to learn more about it.
...
Azion launched a number of new templates which you can use to deploy applications integrated with headless Content Management Systems (CMS).

For **creating applications with Butter**, you can choose one of the templates in the following collection:

- [Butter Templates Collection](/en/documentation/products/guides/butter-templates-collection/)

For **creating applications with Cosmic**, you can choose from the following templates:

- [CosmicJS Agency Website](/en/documentation/products/guides/cosmic-agency-website/)
- [Cosmic Simple Astro Blog](/en/documentation/products/guides/cosmic-simple-astro-blog/)
- [Cosmic Simple Next Blog](/en/documentation/products/guides/cosmic-simple-next-blog/)

For **creating applications with Sanity**, you can choose from the following templates:

- [Clean Angular + Sanity App](/en/documentation/products/guides/clean-angular-sanity/)
- [Clean Astro + Sanity App](/en/documentation/products/guides/clean-astro-sanity/)
- [Clean Nuxt + Sanity App](/en/documentation/products/guides/clean-nuxt-sanity/)
...
Azion launched the first set of Nuxt templates:

- The [Nuxt Static Boilerplate](/en/documentation/products/guides/nuxt-static-boilerplate/) create a `Hello World` Nuxt application.
- The [Nuxt Notes](/en/documentation/products/guides/nuxt-notes/) template deploys a a basic note taking application which stores the notes in the browser’s `localStorage`.
- The [Nuxt Content](/en/documentation/products/guides/nuxt-content/) template deploys a sample application using Nuxt and the Nuxt Content plugin for a documentation, changelog or blog website.
...
- [DevsCard](/en/documentation/products/guides/devscard/)
- [Webpage to PDF Resume](/en/documentation/products/guides/webpage-to-pdf-resume/)

For **creating an e-commerce**, you can choose from templates based on popular web frameworks:

- [Templates based on Astro](/en/documentation/products/guides/astro-ecommerce-collection/):
    - Astro Audiophile
    - Astro Ecommerce
    - Astro Quickstore
- [Templates based on Eleventy](/en/documentation/products/guides/eleventy-ecommerce-collection/):
    - Eleventy 2 Snipcart
    - Eleventy and Snipcart for eCommerce
- [Template based on Gatsby](/en/documentation/products/guides/gatsby-ecommerce-theme/):
    - Gatsby Ecommerce Theme
- [Templates based on Hugo](/en/documentation/products/guides/hugo-ecommerce-collection/):
    - Influencer Hugo
    - Vex Hugo
- [Templates based on Jekyll](/en/documentation/products/guides/jekyll-ecommerce-collection/):
    - Jekyll Cart
    - Jekyll Supply
- [Templates based on Next.js](/en/documentation/products/guides/next-js-ecommerce-collection/):
    - Ecommerce Stationery NextJs
    - Kupingplug
    - NextJs Store Ecommerce
    - Simple Ecommerce Next.js
    - Space Jelly Shop
- [Based on React](/en/documentation/products/guides/book-store-react/):
    - Book Store React
...
- The [Docusaurus with Material UI](/en/documentation/products/guides/docusaurus-typescript-boilerplate/) template helps you deploy a Docusaurus website integrated with Material UI directly on the edge.
...
- [Bot Manager Lite Starter Kit](/en/documentation/products/guides/bot-manager-lite-starter-kit/): with this template, you're able to deploy a new edge stack and see the Bot Manager Lite in action.
- [Bot Manager Lite Integration Kit](/en/documentation/products/guides/bot-manager-lite-integration-kit/): an easy way to integrate the Bot Manager Lite function in an existent Edge Firewall instance on Azion.
- [Bot Manager Lite and Tor Block Starter Kit](/en/documentation/products/guides/bot-manager-lite-and-tor-block-starter-kit/): deploy a basic security suite to protect your domains from bad bots and TOR Exit Nodes requests.
