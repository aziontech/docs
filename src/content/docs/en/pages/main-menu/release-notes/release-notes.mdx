...
See more details on the [Object Storage documentation](/en/documentation/products/azion-cli/overview/), the [API documentation](https://api.azion.com/#af706383-073d-41f0-aba4-ba3540701137), and the following guides:
...
**Code Assistance for Chat GPT** incorporates AI code assistance when building edge functions. This integration is incorporated into the Real-Time Manager interface for an optimized coding experience.

See the [Edge Functions ChatGPT integration](/en/documentation/products/edge-application/edge-functions/runtime-api/ai-integration/) documentation for more information.
