...
For **creating applications with CosmicJS**, you can choose from the following templates:
...
For **creating applications with Sanity**, you can choose one of the templates in the following collection:
