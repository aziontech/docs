...
Use the [Azion API](https://api.azion.com/#56c3cab2-527e-478b-8dad-1b25b2b48248) to manage CRLs and see the [Digital Certificates reference](/en/documentation/products/secure/edge-firewall/digital-certificates/#certificate-revocation-list-crl) for more information.
