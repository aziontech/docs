...
Incrementally decode or encode UTF-8 (and other encodings) while respecting back-pressure. Ideal for Server-Sent Events, chunked JSON, and real-time log tails.
