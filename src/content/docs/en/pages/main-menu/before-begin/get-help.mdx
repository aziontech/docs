...
- [Consult the Help Center](/en/documentation/products/guides/getting-to-know-real-time-manager/): while navigating **Azion Console**, you can open the **Help Center** by clicking the question mark **(?)** icon on Console's header or the **Get help** tags on product's pages. It’ll display a series of documentations related to the screen you're currently on and other helpful links.
