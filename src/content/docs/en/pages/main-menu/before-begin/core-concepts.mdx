...
- Build and deploy [edge applications](/en/documentation/products/build/edge-application/) that run directly on the edge of the network.
- Use [templates and integrations](/en/documentation/products/marketplace/templates-and-integrations-overview/) to speed up your deployment and test pre-built solutions.
...
- Define [caching rules](/en/documentation/products/build/edge-application/edge-caching/), custom optimizations, and advanced configurations.
- Monitor your applications with [data in real time](/en/documentation/products/observe/real-time-metrics/). 
...
:::tip
For more details on edge computing foundations and Azion Edge Platform, go to the [Introduction to Edge Foundations](https://www.youtube.com/watch?v=ZBC8h-0l1FQ&list=PL02NW2s3y10N0SQ-2mWL9WN-RWHE8atMp) playlist.
:::
