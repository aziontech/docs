...
Azion contracted a [Qualified Security Assessor (QSA)](https://listings.pcisecuritystandards.org/assessors_and_solutions/qualified_security_assessors). Customers with **Enterprise** or **Mission-Critical** Support plans can reach out to the **Azion Support Team** to request more information.
...
Azion anually renews its **PCI-DSS certification** for the newest version released. Customers with **Business**, **Enterprise**, or **Mission-Critical** Support plans can reach out to the **Azion Support Team** to request more details.

- **How can I get a copy of Azion's Attestation of Compliance (AOC)?**

Customers with **Business**, **Enterprise**, or **Mission-Critical** Support plans can reach out to **Azion Support Team**. *An NDA is required*.
