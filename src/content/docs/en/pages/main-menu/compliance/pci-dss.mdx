...
Azion's PCI compliance extends across the entire Azion Web Platform, which includes the Edge Application product and its add-ons (Application Accelerator, Edge Cache, Functions, and Load Balancer) and the Edge Firewall product and its add-ons (DDoS Protection, Network Layer Protection, Web Application Firewall - WAF, and Origin Shield), covering all regions where it's deployed. Presently, Azion is deployed in six continents.
