...
Azion contracted a [Qualified Security Assessor (QSA)](https://listings.pcisecuritystandards.org/assessors_and_solutions/qualified_security_assessors). Customers with **Enterprise** or **Mission Critical** Service Plans can reach out to their Account Executive to request more information.
...
Customers with **Enterprise** or **Mission Critical** Service Plans can reach out to Azion Sales Team. *An NDA is required*.
