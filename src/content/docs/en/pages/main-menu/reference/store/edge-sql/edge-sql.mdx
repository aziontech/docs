...
| Write on a database with an edge function | [How to interact with Azion Edge SQL with Edge Functions](/en/documentation/products/guides/edge-sql/how-to-interact-db-edge-functions/) |
