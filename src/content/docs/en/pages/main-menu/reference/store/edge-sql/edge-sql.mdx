...
<LinkButton link="guidelink" label="go to analyze snapshots guide" outlined />
...
<LinkButton link="apilink" label="create a database with Azion API" outlined />
<br> </br>

<LinkButton link="guidelink" label="create a database with edge functions" outlined />
...
<LinkButton link="apilink" label="create a query with Azion API" outlined />
<br> </br>

<LinkButton link="/en/documentation/products/guides/create-tables-edge-sql/" label="go to create a query guide" outlined />
