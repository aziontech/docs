...
There are two ways to build a database through Edge SQL: using the Edge SQL REST API or writing an edge function. The REST API allows you to create, read, update, delete, and list databases. An edge function allows you to write on a database.
...
| Write on a database with an edge function | [How to interact with Azion Edge SQL through Edge Functions](/en/documentation/products/guides/edge-sql/how-to-interact-db-edge-functions/) |
