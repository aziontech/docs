...
| Scope | Resource |
| ----- | -------- |
| Manage databases with REST API | [How to create an SQL Database database](/en/documentation/guides/application-development/data/manage-sql-database/) |
| Create queries with REST API | [How to create and query data on SQL Database](/en/documentation/guides/application-development/data/create-tables-sql-database/) |
| Retrieve data from a database | [How to retrieve data from a database with SQL Database and Functions](/en/documentation/guides/application-development/data/retrieve-data-with-functions/) |
| Get to know SQL Database Vector Search | [SQL Database Vector Search reference](/en/documentation/store/sql-database/vector-search/) |
| Import data to SQL Database | [How to import data guide ](/en/documentation/guides/application-development/data/import-data-sql-database/) |
...
:::note
If you receive a `creation_failed` state, try creating the database again or contact the [support team](/en/documentation/support/#service-channels) to check.
:::
...
[Creating a database](/en/documentation/guides/application-development/data/manage-sql-database/) is the first step to use SQL Database and add data:
...
<DocButton href="/en/documentation/guides/application-development/data/install-edge-sql-shell/" label="Go to SQL Database Shell installation guide" kind="secondary" size="medium" /> 
<DocButton href="/en/documentation/guides/application-development/data/sql-database-shell-commands/" label="Go to SQL Database Shell commands reference" kind="secondary" size="medium" />
...
To view the databases associated with your acount visit this [guide](/en/documentation/guides/application-development/data/list-databases/).
