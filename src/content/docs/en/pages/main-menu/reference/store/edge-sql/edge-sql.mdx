...
<DocCardGroup cols={2}>
  <DocCard title="Quickstart" href="/en/documentation/store/sql-database/quickstart/" label="Create your first database and run a query, from Azion Console or the API." />
