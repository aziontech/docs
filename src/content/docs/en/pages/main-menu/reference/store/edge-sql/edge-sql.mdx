...
| Retrieve data from a database | [How to retrieve data from a database with SQL Database and Edge Functions](/en/documentation/products/guides/edge-sql/retrieve-data-with-edge-functions/) |
