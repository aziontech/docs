...
<Button href="guidelink" text="go to analyze snapshots guide"></Button>
...
<Button href="apilink" text="create a database with Azion API"></Button>

<Button href="guidelink" text="create a database with edge functions"></Button>
...
--header 'Authorization: Token seuToken' \
--header 'Content-Type: application/json' \
--data '{
    "statements": [
...
<Button href="apilink" text="create a query with Azion API"></Button>

<Button href="guidelink" text="go to create a query guide"></Button>
