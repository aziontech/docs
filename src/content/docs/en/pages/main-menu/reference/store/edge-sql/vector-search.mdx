...
- Building AI-based applications, leveraging Natural Language Processing (NLP) for voice assistants and chatbots, with integration to [AI Inference](/en/documentation/build/ai-inference/) that enables powerful Retrieval-Augmented Generation (RAG) applications using frameworks like LangChain and LangGraph directly at the edge.
...
| Scope | Resource |
|---|---|
| Implement Vector Search | Guide explaining the basics of [implementing Vector Search](/en/documentation/guides/application-development/data/sql-database-vector-search/) |
| Get to know Azion SQL Database and its features | [SQL Database reference](/en/documentation/store/sql-database/) |
| Integrate with AI Inference | Learn about [AI Inference capabilities](/en/documentation/build/ai-inference/) |
