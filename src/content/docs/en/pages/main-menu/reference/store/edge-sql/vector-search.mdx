...
| Scope | Resource |
|---|---|
| [Implement Vector Search](/en/documentation/products/guides/edge-sql-vector-search/) | Guide explaining the basics of implementing Vector Search |
| [Edge SQL](/en/documentation/products/store/edge-sql/) |  Get to know the Azion Edge SQL and its features |
