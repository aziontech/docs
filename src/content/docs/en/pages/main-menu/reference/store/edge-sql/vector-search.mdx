...
- Building AI-based applications, leveraging Natural Language Processing (NLP) for voice assistants and chatbots, with seamless integration to [Edge AI](/en/documentation/products/ai/edge-ai/) that enables powerful Retrieval-Augmented Generation (RAG) applications using frameworks like LangChain and LangGraph directly at the edge.
