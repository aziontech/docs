...
Find out more about S3 capabilities in [S3 protocol compatibility](#s3-protocol-compatibility).
...
- `listBuckets`: equivalent to [ListBuckets](#listbuckets), returns a list of buckets within the account.
