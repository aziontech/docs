...
| Use bucket as origin | [How to use an Azion Object Storage bucket as the origin of a static edge application](/en/documentation/products/guides/use-bucket-as-origin/) |
