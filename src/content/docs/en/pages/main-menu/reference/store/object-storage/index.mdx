...
| Use bucket as origin | [How to use an Edge Storage bucket as the origin of a static edge application](/en/documentation/products/guides/use-bucket-as-origin/) |
...
Objects, or files, can be uploaded, modified, downloaded, and removed from buckets using the [Azion API](https://api.azion.com), [Edge Runtime](/en/documentation/devtools/runtime/overview/) and the [S3 protocol](#s3-protocol-compatibility).
...
All operations are available in the [Azion API](https://api.azion.com/#cc7b8b24-4a82-4f70-8660-40e17f6d5440) documentation.
...
<Button href="/en/documentation/products/guides/s3-protocol-for-edge-storage/" text="learn How to access Edge Storage using the S3 protocol" variant="secondary"/>
