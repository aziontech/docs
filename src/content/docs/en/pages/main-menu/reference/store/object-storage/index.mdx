...
| Use bucket as origin | [How to use an Object Storage bucket as the origin of a static edge application](/en/documentation/products/store/storage/use-bucket-as-origin/) |
...
With **Object Storage**, you can use buckets as an [origin](/en/documentation/products/secure/connector/#connector-type) in Azion **Connector** to retrieve the content of an application.
...
<LinkButton link="/en/documentation/products/store/storage/s3-protocol-for-edge-storage/" label="learn How to access Object Storage using the S3 protocol" severity="secondary"/>
