...
| --- | --- | --- |
| `listAllBucketNames` | `GET` | `https://s3-use-east-005.azionstorage.net/` |
| `listBuckets` | ?? | ?? |
| `listFiles` | `GET` | `https://s3-use-east-005.azionstorage.net/<bucket_name>`<br />`https://<bucket_name>.s3-use-east-005.azionstorage.net/` |
| `readFiles` | `GET` | `https://s3-use-east-005.azionstorage.net/<bucket_name>/<object_key>`<br />`https://<bucket_name>.s3-use-east-005.azionstorage.net/<object_key>` |
| `writeFiles` | `PUT` | `https://s3-use-east-005.azionstorage.net/<bucket_name>/<object_key>`<br />`https://<bucket_name>.s3-use-east-005.azionstorage.net/<object_key>` |
| `deleteFiles` | `DELETE` | `https://s3-use-east-005.azionstorage.net/<bucket_name>/<object_key>`<br />`https://<bucket_name>.s3-use-east-005.azionstorage.net/<object_key>` |
...
- Encrypted signature:
  - `<signature>`: The  cryptographic signature generated using the secret key and the request details.
