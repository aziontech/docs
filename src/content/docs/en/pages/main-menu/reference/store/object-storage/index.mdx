...
The recommended way to deliver objects stored in **Object Storage** to end users is through [Applications](/en/documentation/products/edge-application/) connected to your buckets using [Connectors](/en/documentation/products/secure/connectors/). This approach:
...
| Set up S3 credentials | [Set up S3 credentials for Object Storage](/en/documentation/products/store/storage/s3-protocol-for-object-storage/) |
...
With **Object Storage**, you can use buckets as an [origin](/en/documentation/products/secure/connectors/#connector-type) in Azion **Connectors** to retrieve the content of an application.
...
Read more on [Set up S3 credentials for Object Storage](/en/documentation/products/store/storage/s3-protocol-for-object-storage/).
...
To [create a S3 credential](/en/documentation/products/store/storage/s3-protocol-for-object-storage/), you must use an Azion personal token and run a `POST` request via API. However, after the credential is created, it works independently from your Azion token. This way, even if the token expires, the credential remains valid.
...
<DocButton href="/en/documentation/products/store/storage/s3-protocol-for-object-storage/" label="learn how to set up S3 credentials for Object Storage" kind="secondary" size="medium" />
