...
<LinkButton link="/en/documentation/products/guides/s3-protocol-for-edge-storage/" label="learn How to access Edge Storage using the S3 protocol" severity="secondary"/>
