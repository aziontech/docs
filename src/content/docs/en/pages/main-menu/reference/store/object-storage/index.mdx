...
Operation history can be accessed through [Real-Time Events GraphQL API](/en/documentation/devtools/graphql-api/features/gql-real-time-events-fields/#activityhistoryevents-activity-history).
