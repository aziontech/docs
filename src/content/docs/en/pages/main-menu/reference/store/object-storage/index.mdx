...
| Set up the S3 protocol | [How to access an Object Storage bucket using the S3 protocol](/en/documentation/products/store/storage/s3-protocol-for-object-storage/) |
...
Read more on [How to access Object Storage using the S3 protocol](/en/documentation/products/store/storage/s3-protocol-for-object-storage/).
...
<LinkButton link="/en/documentation/products/store/storage/s3-protocol-for-object-storage/" label="learn How to access Object Storage using the S3 protocol" severity="secondary"/>
