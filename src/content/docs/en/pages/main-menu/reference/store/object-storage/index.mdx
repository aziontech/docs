...
:::note
Operations A and B are charged separately. Class C operations are free. If an operation falls outside of the scope of class C operations, it'll be billed to your account according to the established costs. For more information on operation and class charges, see the [Pricing](https://www.azion.com/en/pricing/) page.
:::
