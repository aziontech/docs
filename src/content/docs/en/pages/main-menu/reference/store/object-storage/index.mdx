...
:::note
Class A operations are free. If an operation falls out of the scope of class A operations, it'll be billed to your account according to the established costs. For more information on operation and class charges, see the [Pricing](/en/documentation/products/pricing/) page.
:::
...
<LinkButton outlined link="/en/documentation/products/guides/s3-protocol-for-edge-storage/" label="learn How to access Edge Storage using the S3 protocol" variant="secondary"/>
