...
<LinkButton outlined link="/en/documentation/products/build/edge-application/cache-settings/#browser-cache-settings" label="Learn more about expiration settings" />
...
<LinkButton outlined link="/en/documentation/products/build/edge-application/real-time-purge/" label="Learn more about Real-Time Purge" />
