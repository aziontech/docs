...
permalink: /documentation/products/edge-application/delivery-settings/
---
...
:::note
If you choose to deliver your application through HTTP & HTTPS, you must associate a [digital certificate](/en/documentation/products/edge-application/delivery-settings/digital-certificates/) to your domain.
:::
