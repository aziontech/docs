...
permalink: /documentation/platform/applications/main-settings-v3/
---
...
:::note
If you choose to deliver your application through HTTP & HTTPS, you must associate a [digital certificate](/en/documentation/platform/certificate-manager/for-firewall/) to your domain.
:::
