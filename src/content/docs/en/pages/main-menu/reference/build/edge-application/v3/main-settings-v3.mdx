...
:::caution[important]
You're viewing an earlier version of this documentation. If your account has already been migrated, see the updated [Edge Application main settings reference](/en/documentation/products/build/edge-application/main-settings/).
:::
