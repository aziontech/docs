...
To use your domain in HTTPS, you'll need a TLS certificate (X.509). Without additional costs, you may include your TLS certificates in [Azion Console](http://console.azion.com) or generate a *Let's Encrypt*™ certificate, which will be automatically managed by Azion.
