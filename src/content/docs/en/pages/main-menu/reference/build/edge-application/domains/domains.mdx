...
When you [build an edge application](/en/documentation/products/get-started/), your application is given an automatically generated **Azion domain**, in the format `xxxx.map.azionedge.net`. You can create multiple domains for your edge applications.
