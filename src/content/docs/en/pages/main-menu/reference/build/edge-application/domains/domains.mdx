...
title: Domains
description: >-
  Azion domains keep your application content cached at the edge and can be
  customized to fit your needs.
meta_tags: 'application, domains'
namespace: documentation_products_edge_application_domains
permalink: /documentation/platform/workloads/domains/
---
...
For more information about the new product, visit the [Workloads Reference](/en/documentation/platform/workloads/).
:::


**Domains** is an [Azion Console](https://console.azion.com) tool that provides a domain generation and management service.

When you [build an application](/en/documentation/guides/application-development/getting-started/build-an-application/), your application is given an automatically generated **Azion domain**, in the format `xxxx.map.azionedge.net`. You can create multiple domains for your applications.

If you already own a domain, you can [redirect your traffic to Azion](/en/documentation/guides/platform/migration/point-domain-to-azion/) by configuring the records in your DNS provider and listing your **custom domains**.
...
The **default limit** is *50* CNAMEs per domain. However, you can increase the limits based on your plan, contacting the [technical support team](/en/documentation/support/). To know more about Domains limits, check the [section](#limits) below.
