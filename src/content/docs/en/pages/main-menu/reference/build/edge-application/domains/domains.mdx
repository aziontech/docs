...
title: Workloads
description: >-
  Azion workloads keep your edge application content cached at the edge and can be
  customized to fit your needs.
meta_tags: 'edge application, workloads'
namespace: documentation_products_edge_application_workloads
permalink: /documentation/products/build/edge-application/workloads/
---

**Workloads** is an [Azion Console](https://console.azion.com) tool that provides a domain generation and management service.
...
If you already own a domain, you can [redirect your traffic to Azion](/en/documentation/products/guides/point-domain-to-azion/) by configuring the records in your DNS provider and listing your **custom workloads**.

You may also bind a **Digital Certificate** to workloads that use the HTTPS protocol.
...
The **default limit** is *50* CNAMEs per domain. However, you can increase the limits based on your plan, contacting the [technical support team](/en/documentation/services/support/). To know more about workloads limits, check the [section](#limits) below.
