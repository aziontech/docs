...
<Button href="/en/documentation/products/build/edge-application/edge-functions/" text="Learn more about Edge Functions"></Button>
...
<Button href="/en/documentation/products/build/edge-application/rules-engine/#run-function" text="Learn more about the Run Function behavior"></Button>
