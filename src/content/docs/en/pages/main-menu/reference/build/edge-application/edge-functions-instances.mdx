...
<LinkButton outlined link="/en/documentation/products/build/edge-application/edge-functions/" label="Learn more about Edge Functions" />
...
<LinkButton outlined link="/en/documentation/products/build/edge-application/rules-engine/#run-function" label="Learn more about the Run Function behavior" />
