...
title: Device Groups
description: >-
  Device Groups can help you manage content delivery and set specific behaviors
  according to the devices that access your application.
meta_tags: >-
  Azion, edge computing, application, adaptive delivery, rules engine,
  user-agent, device
namespace: documentation_edge_application_device_groups
permalink: /documentation/platform/applications/device-groups/
---
...
| About Rules Engine | [Rules Engine](/en/documentation/platform/applications/rules-engine/) |
| About Adaptive Delivery | [Adaptive Delivery](/en/documentation/build/cache/cache-settings/#application-accelerator) |
...
> To use this variable, you must enable [Application Accelerator](/en/documentation/build/application-accelerator/).
...
<DocButton href="/en/documentation/build/cache/cache-settings/#application-accelerator" label="Learn more about Adaptive Delivery" size="medium" />
