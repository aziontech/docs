...
permalink: /documentation/products/build/edge-application/device-groups/
---
...
| About Rules Engine | [Rules Engine](/en/documentation/products/build/edge-application/rules-engine/) |
| About Adaptive Delivery | [Adaptive Delivery](/en/documentation/products/build/edge-application/cache-settings/#adaptive-delivery) |
...
> To use this variable, you must enable [Application Accelerator](/en/documentation/products/build/edge-application/application-accelerator/).
...
<LinkButton link="/en/documentation/products/build/edge-application/cache-settings/#adaptive-delivery" label="Learn more about Adaptive Delivery" />
