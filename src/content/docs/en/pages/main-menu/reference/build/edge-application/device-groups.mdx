...
permalink: /documentation/products/build/applications/device-groups/
---
...
<Button href="/en/documentation/products/build/applications/cache-settings/#adaptive-delivery" label="Learn more about Adaptive Delivery" type="primary" theme="light" />
