...
permalink: /documentation/products/build/edge-application/first-steps/v3/
---

You're currently viewing an older version of this guide. Use this if your account hasnt been migrated yet. For the updated v4 version [click here]()
