...
With [Edge Application](/en/documentation/products/build/edge-application/), you can choose your application's delivery protocol and ports. You can also ensure the security of the HTTPS connection between the application and its users with TLS ciphers.
...
:::note
If you choose to deliver your application through HTTP & HTTPS, you must associate a [digital certificate](/en/documentation/products/build/edge-application/digital-certificates/) to your domain.
:::
...
<LinkButton outlined link="/en/documentation/products/guides/secure/ciphers/" label="go to configure TLS cipher suite guide" variant="secondary" />
