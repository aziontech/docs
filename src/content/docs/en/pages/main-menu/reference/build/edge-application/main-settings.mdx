...
permalink: /documentation/platform/applications/main-settings/
---
...
:::caution[important]
You're viewing the latest version of this documentation. If your account hasn't been migrated yet, refer to the [legacy Applications main settings reference](/en/documentation/platform/applications/main-settings/).
:::

With [Applications](/en/documentation/platform/applications/), you can manage your application's modules and status.

:::note
With the release of API v4, delivery settings were moved to [Workloads](/en/documentation/platform/workloads/). For more details about the changes [visit the migration documentation.](/en/documentation/fundamentals/api-v4-migration/#workloads) 
:::
...
<DocButton href="/en/documentation/build/application-accelerator/" label="Learn more about Application Accelerator" size="medium" />
...
<DocButton href="/en/documentation/build/cache/" label="Learn more about Cache" size="medium" />
...
<DocButton href="/en/documentation/build/image-processor/" label="Learn more about Image Processor" size="medium" />
...
<DocButton href="/en/documentation/build/cache/tiered-cache/" label="Learn more about Tiered Cache" size="medium" />
