...
<LinkButton outlined label="Build your first edge application" link="/en/documentation/products/getting-started/" />
...
<LinkButton outlined label="Learn more about Domains" link="/en/documentation/products/build/edge-application/domains/" />
...
<LinkButton outlined label="Learn more about Digital Certificates" link="/en/documentation/products/build/edge-application/digital-certificates/" />
...
<LinkButton outlined label="Learn more about Real-Time Purge" link="/en/documentation/products/build/edge-application/real-time-purge/" />
