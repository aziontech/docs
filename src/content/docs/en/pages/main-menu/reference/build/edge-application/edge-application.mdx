...
| Setting | Description |
| --- | --- |
| [Delivery Settings](/en/documentation/products/edge-application/delivery-settings/) | Customize your application delivery with Azion's range of protocol options including HTTP, HTTPS, and HTTP/3 support for a better user experience and secure your connection with TLS ciphers. |
