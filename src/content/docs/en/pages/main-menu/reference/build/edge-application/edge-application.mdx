...
Each account can have up to a number of edge applications. These are the **default limits** for each Service Plan:

| Developer | Business | Enterprise | Mission Critical |
| --- | --- | --- | --- |
| 10 | 50 | 200 | Negotiable |

### Debug Rules logs

Debug Rules logs have a size limit of 1.5 kB.
