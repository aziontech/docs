...
Your content or application has to be available from one or several edge connector. This origin can consist of one or more web servers from your infrastructure, a cloud service, or one of Azion's **Origin** services.
...
- Customize edge connector and error pages.
...
| Get to know custom pages | [custom pages](/en/documentation/products/build/edge-application/custom-pages/) |
| Get to know edge connector | [edge connector](/en/documentation/products/build/edge-application/edge connector/) |
...
**Edge Application** allows advanced configuration of edge connector, cache, functions, error pages, and more, optimizing content delivery for improved performance and user experience.
...
| [edge connector](/en/documentation/products/build/edge-application/edge connector/) | Modify your origin address, `Host` header, path, protocol policies, and HMAC authentication credentials. |
...
| [custom pages](/en/documentation/products/build/edge-application/custom-pages/) | Customize error response pages, their cache expiration time, and their origin. |
...
Azion **Workloads** provides you with the flexibility to use automatically generated workloads or your own custom workloads, allowing you to manage and deliver content effectively through your edge applications with support for secure connections over HTTP and HTTPS.

<LinkButton severity="secondary" label="Learn more about workloads" link="/en/documentation/products/build/edge-application/workloads/" />
