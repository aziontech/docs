...
| Feature | Developer | Business | Enterprise | Mission Critical |
| --- | --- | --- | --- | --- |
| Edge applications per account | 10 | 50 | 200 | Negotiable |

The following limits apply to **all** Service Plans:

| Scope | Limit |
| --- | --- |
| Minimum CDN cache TTL | 60 seconds<br /><br />For the [Application Acceleration](/en/documentation/products/build/edge-application/application-acceleration/) module: 0 seconds |
