...
title: Applications
description: >-
  Applications is a product that lets you build applications on Azion Edge
...
| Get to know Functions | [Functions Instances](/en/documentation/products/build/applications/edge-functions-instances/) |
...
| Get to know Connector | [Connector](/en/documentation/products/secure/connector/) |
...
| [Cache Settings](/en/documentation/products/build/applications/cache-settings/) | Configure your application's browser and edge cache expiration time, large file optimization, and advanced cache behavior based on cookies or query strings. |
