...
<Button href="/en/documentation/products/build/edge-application/origins/#address" text="Learn more about origin addresses"></Button>
...
**Load Balancer** has specific metrics that define how the product is billed.

<Button href="https://www.azion.com/en/pricing/#LoadBalancer" text="see pricing"></Button>

### Data Transferred

Total volume of data transferred by Azion Edge Computing Platform with the Load Balancer module enabled, whether it's delivered through cache or fetched from an origin, calculated in GB.

If an edge application transfers data and it has the Load Balance module enabled in it, charges will apply for the pricing of the module.
