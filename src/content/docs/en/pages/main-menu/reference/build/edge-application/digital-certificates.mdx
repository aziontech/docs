...
<LinkButton severity="secondary" link="/en/documentation/products/guides/secure/digital-certificates/" label="go to acquire and register a digital certificate guide" severity="secondary" /> 
...
<LinkButton severity="secondary" link="/en/documentation/products/guides/secure/lets-encrypt-record/" label="go to add TXT record for Let's Encrypt certificate guide" severity="secondary" /> 
...
<LinkButton severity="secondary" link="https://api.azion.com/#b2df23ee-7a28-4900-9ad5-ffd135b4c6cf" label="create CRL via API" severity="secondary" />
