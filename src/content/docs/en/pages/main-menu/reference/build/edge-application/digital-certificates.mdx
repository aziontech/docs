...
| Scope | Resource |
| --- | --- |
| About Workloads | [Workloads](/en/documentation/products/secure/workloads/) |
...
The CRL works when associated with an [mTLS CA Certificate](/en/documentation/products/secure/firewall/mtls/). Therefore, you must have mTLS enabled in the workload you want to associate it with.
