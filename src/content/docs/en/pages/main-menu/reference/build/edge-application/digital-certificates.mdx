...
<LinkButton outlined link="/en/documentation/products/guides/secure/digital-certificates/" label="go to acquire and register a digital certificate guide" outlined /> 
...
<LinkButton outlined link="/en/documentation/products/guides/secure/lets-encrypt-record/" label="go to add TXT record for Let's Encrypt certificate guide" outlined /> 
...
<LinkButton outlined link="https://api.azion.com/#56c3cab2-527e-478b-8dad-1b25b2b48248" label="create CRL via API" outlined />
