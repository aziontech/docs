...
<Button href="/en/documentation/products/guides/secure/digital-certificates/" text="go to acquire and register a digital certificate guide" variant="secondary"></Button> 
...
<Button href="/en/documentation/products/guides/secure/lets-encrypt-record/" text="go to add TXT record for Let's Encrypt certificate guide" variant="secondary"></Button> 
