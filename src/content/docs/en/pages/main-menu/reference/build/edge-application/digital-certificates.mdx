...
<Button href="/en/documentation/products/guides/secure/digital-certificates/" label="go to acquire and register a digital certificate guide" type="primary" theme="light" /> 
...
<Button href="/en/documentation/products/guides/secure/lets-encrypt-record/" label="go to add TXT record for Let" type="primary" theme="light" /> 
...
<Button href="https://api.azion.com/v4#/operations/PostDigitalCertificatesCrls" label="create CRL via API" type="primary" theme="light" />
