...
<LinkButton outlined link="/en/documentation/products/guides/secure/digital-certificates/" label="go to acquire and register a digital certificate guide" variant="secondary" /> 
...
| About mTLS | [mTLS](/en/documentation/products/build/edge-application/domains/mtls/) |
...
A Trusted CA is an entity that is authorized to issue digital certificates that can be used for the [Mutual Transport Layer Security (mTLS)](/en/documentation/products/build/edge-application/domains/mtls/) security protocol. You may upload Trusted CA certificates and intermediate certificates.
...
<LinkButton outlined link="/en/documentation/products/guides/secure/lets-encrypt-record/" label="go to add TXT record for Let's Encrypt certificate guide" variant="secondary" /> 
...
The CRL works when associated with an [mTLS CA Certificate](/en/documentation/products/build/edge-application/domains/mtls/). Therefore, you must have mTLS enabled in the domain you want to associate it with.
...
<LinkButton outlined link="https://api.azion.com/#56c3cab2-527e-478b-8dad-1b25b2b48248" label="create CRL via API" variant="secondary" />

You can [associate one or more CRLs with a domain](https://api.azion.com/#d3b79af9-e708-4a4f-9bc6-d2df3700c502) via API.
