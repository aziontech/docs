...
<LinkButton link="/en/documentation/products/build/applications/cache/tiered-cache/" label="go to Tiered Cache documentation" />
...
<LinkButton link="/en/documentation/products/build/applications/cache/#stale-cache" label="go to stale cache documentation" />
