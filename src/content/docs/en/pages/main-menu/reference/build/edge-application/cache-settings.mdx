...
<Button href="/en/documentation/products/edge-application/edge-caching/#slice-files" text="Learn more about slice files"></Button>
...
<Button href="/en/documentation/products/build/edge-application/edge-caching/#stale-cache" text="Learn more about stale cache"></Button>
...
<Button href="/en/documentation/products/build/edge-application/device-groups/" text="Learn more about Device Groups"></Button>
