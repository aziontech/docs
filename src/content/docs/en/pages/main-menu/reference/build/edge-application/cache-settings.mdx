...
| Cache module | [Cache](/en/documentation/build/cache/)  |
...
- **Override Cache Settings**: overrides the cache setting of your origin server with the desired TTL. To set the TTL of CDN cache to values under 60 seconds, you must enable the [Application Accelerator](/en/documentation/build/application-accelerator/) module.
...
<DocButton href="/en/documentation/build/cache/#large-file-optimization" label="go to Large File Optimization documentation" size="medium" />
...
<DocButton href="/en/documentation/build/cache/tiered-cache/" label="go to Tiered Cache documentation" size="medium" />
...
<DocButton href="/en/documentation/build/cache/#stale-cache" label="go to stale cache documentation" size="medium" />
...
<DocButton href="/en/documentation/platform/applications/device-groups/" label="go to Device Groups documentation" size="medium" />
