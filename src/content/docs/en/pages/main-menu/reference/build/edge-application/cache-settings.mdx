...
| Cache module | [Cache](/en/documentation/products/build/applications/edge-cache/)  |
...
<LinkButton link="/en/documentation/products/build/applications/edge-cache/#stale-cache" label="go to stale cache documentation" />
