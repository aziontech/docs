...
description: Configure cache TTL, large file segmentation, adaptive delivery, and cache rules for your application.
...
- **Override Cache Settings**: overrides the cache setting of your origin server with the desired TTL. To set the TTL of CDN cache to values under 60 seconds, you must enable the [Application Acceleration](/en/documentation/products/build/edge-application/application-acceleration/) module.

---

## Large File Optimization

**Large File Optimization** works with a default fragmentation size of *1,024 kB*. If you want to modify the fragmentation range, [contact the Sales team](https://www.azion.com/en/contact-sales/).

<Button href="/en/documentation/products/edge-application/edge-caching/#large-file-optimization" text="go to Large File Optimization documentation"></Button>

:::note
When activating this feature, each fragment of the file within the defined the range will carry a different cache key.
:::

Large File Optimization can be applied to both the edge caching layer or the L2, provided that **L2 Caching** is an active module.

<Button href="/en/documentation/products/edge-application/l2-caching/" text="go to L2 Caching documentation"></Button>
...
<Button href="/en/documentation/products/build/edge-application/edge-caching/#stale-cache" text="go to stale cache documentation"></Button>
...
<Button href="/en/documentation/products/build/edge-application/device-groups/" text="go to Device Groups documentation"></Button>
