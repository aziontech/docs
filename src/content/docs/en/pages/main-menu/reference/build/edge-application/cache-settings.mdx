...
<Button href="/en/documentation/products/build/edge-application/tiered-cache/" text="go to Tiered Cache documentation"></Button>
...
<Button href="/en/documentation/products/build/edge-application/edge-cache/#stale-cache" text="go to stale cache documentation"></Button>
