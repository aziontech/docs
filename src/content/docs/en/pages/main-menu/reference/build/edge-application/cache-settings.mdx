...
<LinkButton outlined link="/en/documentation/products/edge-application/edge-caching/#large-file-optimization" label="go to Large File Optimization documentation" />
...
<LinkButton outlined link="/en/documentation/products/build/edge-application/tiered-cache/" label="go to Tiered Cache documentation" />
...
<LinkButton outlined link="/en/documentation/products/build/edge-application/edge-cache/#stale-cache" label="go to stale cache documentation" />
...
<LinkButton outlined link="/en/documentation/products/build/edge-application/device-groups/" label="go to Device Groups documentation" />
