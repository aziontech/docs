...
<Button href="/en/documentation/products/build/edge-application/load-balancer/" text="Learn more about Load Balancer"></Button>
...
<Button href="/en/documentation/products/store/object-storage/" text="go to Edge Storage reference"></Button>

---

## Host Header

The `Host` header is used by your origin to identify the *virtualhost* and locate your content or application. When configuring an origin in [Real-Time Manager (RTM)](https://console.azion.com/), you have the option to customize the value sent by Azion in the `Host` header.
