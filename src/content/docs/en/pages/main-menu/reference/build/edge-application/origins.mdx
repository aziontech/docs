...
:::caution[important]
The Origins feature has been replaced by **Edge Connector.**
For more information about the new product, visit the [Edge Connector reference](/en/documentation/products/secure/edge-connector/).
:::
...
| Load Balancer module | [Load Balancer](/en/documentation/products/secure/edge-connector/load-balancer/) |
...
- **Edge Storage**: select a bucket and prefix from the Azion **Edge Storage** to serve the application.
...
<LinkButton link="/en/documentation/products/secure/edge-connector/load-balancer/" label="Learn more about Load Balancer" />
