...
description: >-
  Azion edge connector allows you to customize the edge connector for your content, the Host
...
permalink: /documentation/products/build/edge-application/edge-connector/
---
...
| Scope | Resource |
| --- | --- |
| Edge Application first steps | [First steps](/en/documentation/products/build/edge-application/first-steps/#edge connector) |
