...
permalink: /documentation/products/build/applications/origins/
---
...
:::caution[important]
The Origins feature has been replaced by **Connector**.
For more information about the new product, visit the [Connector reference](/en/documentation/products/secure/connector/).
:::
...
| Scope | Resource |
| --- | --- |
| Applications first steps | [First steps](/en/documentation/products/build/applications/first-steps/#origins) |
| Load Balancer module | [Load Balancer](/en/documentation/products/secure/connector/load-balancer/) |
...
<LinkButton link="/en/documentation/products/secure/connector/load-balancer/" label="Learn more about Load Balancer" />
