...
permalink: /documentation/products/build/edge-application/origins/
---
...
- **Object Storage**: select a bucket and path from your **Azion Object Storage** to serve the application.

<Button href="/en/documentation/products/edge-application/load-balancer/" text="Learn more about Load Balancer"></Button>
<br></br>
<Button href="/en/documentation/products/build/edge-application/object-storage/" text="Learn more about Object Storage"></Button>
...
When [Object Storage](/en/documentation/products/build/edge-application/object-storage/) is selected as an origin type, you must configure two sets of data: **Bucket Name** and **Prefix**.

The bucket name is defined when you [create or modify an object storage bucket](/en/documentation/products/guides/how-to-create-and-manage-bucket/).

The prefix is the path to the folder within the bucket that stores the objects. This field may be left blank if you wish your application's origin to be the root of the bucket.
