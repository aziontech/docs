...
For more information about the new product, visit the [Connectors reference](/en/documentation/products/secure/connectors/).
:::
...
<Button href="/en/documentation/products/secure/connector/load-balancer/" label="Learn more about Load Balancer" type="primary" theme="light" />
