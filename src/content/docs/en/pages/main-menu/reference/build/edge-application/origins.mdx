...
<LinkButton outlined link="/en/documentation/products/build/edge-application/load-balancer/" label="Learn more about Load Balancer" />
...
<LinkButton outlined link="/en/documentation/products/store/edge-storage/" label="go to Edge Storage reference" />
