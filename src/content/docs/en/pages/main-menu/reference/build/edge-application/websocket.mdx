...
permalink: /documentation/platform/applications/websocket/
---
...
:::caution  
Due to their nature as a bidirectional open connection, WebSocket Proxy is incompatible with the use of the [Image Processor](/en/documentation/build/image-processor/), [Cache](/en/documentation/build/cache/) or [Tiered Cache](/en/documentation/build/cache/tiered-cache/) modules.
:::
...
| Functions WebSocket API| [WebSocket API](/en/documentation/devtools/runtime/api-reference/websocket/)  |
| Debug Rules| [Debug Rules](/en/documentation/guides/application-development/getting-started/debug-rules/)  |
...
<DocButton href="/en/documentation/devtools/runtime/api-reference/websocket/" label="Go to WebSocket API reference" kind="secondary" target="_blank" size="medium" />
