...
:::caution  
Due to their nature as a bidirectional open connection, WebSocket Proxy is incompatible with the use of the [Image Processor](/en/documentation/products/build/edge-application/image-processor/), [Edge Cache](/en/documentation/products/build/edge-application/edge-cache/) or [Tiered Cache](/en/documentation/products/build/edge-application/tiered-cache/) modules.
:::
