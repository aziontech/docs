...
By using the [Azion Edge Runtime](/en/documentation/devtools/runtime/overview/) to develop your edge functions, you have a set of tools that help you implement your logic, such as:

- [Web standards APIs](/en/documentation/devtools/runtime-apis/javascript/)
