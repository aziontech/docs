...
| Scope | Guide |
| - | - | 
| API Builder | [How to build an API with Functions and ChatGPT](/en/documentation/guides/application-development/functions-and-runtime/api-builder/) |
| Examples | [Examples](/en/documentation/build/functions/javascript-examples/) |
...
By using the [Azion Runtime](/en/documentation/devtools/runtime/) to develop your functions, you have a set of tools that help you implement your logic.

<DocButton href="/en/documentation/devtools/runtime/" label="go to azion runtime" kind="secondary" target="_blank" size="medium" />
<br /><DocButton href="/en/documentation/devtools/runtime/frameworks/frameworks-compatibility/" label="go to supported Web Frameworks" kind="secondary" target="_blank" size="medium" />
<br /><DocButton href="/en/documentation/devtools/runtime/api-reference/javascript/" label="go to supported Web APIs" kind="secondary" target="_blank" size="medium" />
<br /><DocButton href="/en/documentation/devtools/runtime/node/" label="go to node.js support reference" kind="secondary" target="_blank" size="medium" />
...
1. **Framework detection**: When you initialize a project with [Azion CLI](/en/documentation/devtools/cli/), the bundler identifies your framework and applies the appropriate adapter.
...
For the complete list of supported frameworks and detailed compatibility information, see [Frameworks compatibility](/en/documentation/devtools/runtime/frameworks/frameworks-compatibility/).

### Practical implications

When you deploy a framework project, keep in mind:

- **Compute costs**: Framework deployments generate Functions, which incur compute time and invocation charges. See [Pricing](/en/documentation/fundamentals/pricing/) for details.
- **Debugging**: Use [Preview Deployment](/en/documentation/build/functions/preview-deployment/), [Data Stream](/en/documentation/guides/platform/observability/debugging-functions-data-stream/), or [GraphQL API](/en/documentation/guides/application-development/functions-and-runtime/debugging-functions-graphql/) to debug framework-generated Functions.
- **Environment variables**: Access environment variables in your framework code using [Azion's environment variables API](/en/documentation/build/functions/environment-variables/).

<DocButton href="/en/documentation/devtools/runtime/frameworks/frameworks-compatibility/" label="View all supported frameworks" kind="secondary" target="_blank" size="medium" />
<br /><DocButton href="https://github.com/aziontech/bundler" label="Explore Azion Bundler on GitHub" kind="secondary" target="_blank" size="medium" />
...
- Leverage native [SQL Database](/en/documentation/store/sql-database/) integration for RAG implementations and vector storage, along with MCP Servers that enable agent-to-agent collaboration using Google's Agent2Agent (A2A) protocol.
...
<DocButton href="/en/documentation/build/ai-inference/" label="Learn more about AI Inference" kind="secondary" target="_blank" size="medium" />
...
Learn more on [How to create an function using WebAssembly on the Azion Web Platform](/en/documentation/guides/application-development/functions-and-runtime/webassembly-on-azion-platform/).
...
Learn more about [Functions Instances](/en/documentation/build/functions/functions-instances/).
...
Learn more about [Rules Engine](/en/documentation/platform/applications/rules-engine/).
...
Learn more about the [Functions Code Editor](/en/documentation/build/functions/code-editor/).
...
Learn more about the [AI Assistant](/en/documentation/build/functions/ai-integration/).
...
Learn more about [Preview Deployment](/en/documentation/build/functions/preview-deployment/).

---

## Debug

You can debug your functions in real time using the `inspect` tool inside the [Preview Deployment](/en/documentation/build/functions/preview-deployment/) section.
...
Learn more about [Environment Variables](/en/documentation/build/functions/environment-variables/).
...
There are different ways to manage your functions on the Azion Web Platform. You can do this through [Azion Console](https://console.azion.com), [Azion CLI](/en/documentation/devtools/cli/), [Azion API](https://api.azion.com/), and [Terraform](/en/documentation/devtools/terraform/).
...
Learn more about [Azion CLI functions command and its subcommands](/en/documentation/devtools/cli/)
...
The [Azion Terraform Provider](/en/documentation/devtools/terraform/) allows the management of functions on the Azion platform. It makes possible to treat your infrastructure as code.
