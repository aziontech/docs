...
| Scope | Guide |
| - | - | 
| API Builder | [How to build an API with Functions and ChatGPT](/en/documentation/products/guides/functions/api-builder/) |
...
<br /><LinkButton link="/en/documentation/products/applications/functions/runtime-apis/javascript/" label="go to supported Web APIs" severity="secondary" target="_blank" />
