...
<br /><LinkButton link="/en/documentation/products/applications/edge-functions/runtime-apis/javascript/" label="go to supported Web APIs" severity="secondary" target="_blank" />
...
Learn more about [Functions Instances](/en/documentation/products/build/applications/edge-functions-instances/).
...
Learn more about the [Functions Code Editor](/en/documentation/products/applications/edge-functions/runtime-api/code-editor/).
...
Learn more about the [AI Assistant](/en/documentation/products/applications/edge-functions/runtime-api/ai-integration/).
...
Learn more about [Preview Deployment](/en/documentation/products/applications/edge-functions/runtime-api/preview-deployment/).

---

## Debug

You can debug your functions in real time using the `inspect` tool inside the [Preview Deployment](/en/documentation/products/applications/edge-functions/runtime-api/preview-deployment/) section.
