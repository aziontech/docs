...
**Edge Functions** has specific metrics that define how the product is billed.

<Button href="https://www.azion.com/en/pricing/#EdgeFunctions" text="see pricing"></Button>

### Compute Time

Time for the execution of an edge function. It considers from the moment an edge function is called up to the moment it returns a response.

### Invocations

Total number of times an edge function is called and executed by an edge application, a rule set, or a Jamstack application. One invocation is counted independently of processing results or success of the code’s execution.
