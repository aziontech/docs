...
By using the [Azion Runtime](/en/documentation/devtools/runtime/overview/) to develop your edge functions, you have a set of tools that help you implement your logic, such as:
