...
There are different ways to manage your edge functions on the Azion Edge Platform. You can do this through [Real-Time Manager (RTM)](https://console.azion.com/), [Azion CLI](/en/documentation/products/cli/), [Azion API](https://api.azion.com/), and [Terraform](/en/documentation/products/terraform-provider/).

### RTM

You can create and manage edge functions through [Real-time Manager (RTM)](https://console.azion.com/), found on the **Products menu** below **Edge Libraries**.
