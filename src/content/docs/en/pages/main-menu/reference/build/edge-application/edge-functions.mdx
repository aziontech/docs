...
<LinkButton link="/en/documentation/products/edge-ai/" label="Learn more about Edge AI" severity="secondary" target="_blank" />
...
There are different ways to manage your edge functions on the Azion Edge Platform. You can do this through [Azion Console](https://console.azion.com), [Azion CLI](/en/documentation/products/azion-cli/overview/), [Azion API](https://api.azion.com/), and [Terraform](/en/documentation/products/terraform-provider/).
