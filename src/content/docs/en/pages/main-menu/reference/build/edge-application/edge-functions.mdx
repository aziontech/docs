...
By using the [Azion Runtime](/en/documentation/runtime/overview/) to develop your edge functions, you have a set of tools that help you implement your logic, such as:

<LinkButton link="/en/documentation/runtime/overview/" label="go to azion runtime" outlined target="_blank" />
<br /><LinkButton link="/en/documentation/products/devtools/azion-edge-runtime/frameworks-compatibility/" label="go to supported Web Frameworks" outlined target="_blank" />
<br /><LinkButton link="/en/documentation/products/edge-application/edge-functions/runtime-apis/javascript/" label="go to supported Web APIs" outlined target="_blank" />
<br /><LinkButton link="/en/documentation/products/azion-edge-runtime/compatibility/node/" label="go to node.js support reference" outlined target="_blank" />
