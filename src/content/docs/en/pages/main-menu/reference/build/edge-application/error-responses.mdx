---
title: Error Responses | Deprecated
description: >-
...
:::note
This feature has been deprecated, if your account has already been migrated, please visit the [Custom Pages Reference](/en/documentation/products/secure/custom-pages/).
:::
