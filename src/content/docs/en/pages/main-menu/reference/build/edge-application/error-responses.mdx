...
permalink: /documentation/products/build/applications/error-responses/
---
import LinkButton from 'azion-webkit/linkbutton';

:::caution[important]
The Error Responses feature has been replaced by **Custom Pages**.
For more information about the new prodct, visit the [Custom Pages reference](/en/documentation/products/secure/custom-pages/).
:::
...
<LinkButton link="/en/documentation/products/build/applications/cache-settings/#browser-cache-settings" label="Learn more about expiration settings" />
...
The origin in which the URI file is located. Can only be altered if a URI is provided. Must be configured using **Connectors**.

<LinkButton link="/en/documentation/products/secure/connectors/" label="Learn more about Connectors" />
