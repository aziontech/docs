...
title: Custom Pages
description: >-
  custom pages is an Edge Application capability that allows you to customize
...
namespace: documentation_edge_application_custom_pages
permalink: /documentation/products/build/edge-application/custom-pages/
---
import LinkButton from 'azion-webkit/linkbutton';

**Custom Pages** is an Azion **Edge Application** feature that allows you to customize error pages for users based on the status code received from the origin.
...
* Client custom pages (4xx): the request couldn't be completed due to an apparent error on the client's side.
* Server custom pages (5xx): the server is unable to process the request.
...
<LinkButton link="/en/documentation/products/build/edge-application/cache-settings/#browser-cache-settings" label="Learn more about expiration settings" />
...
The origin in which the URI file is located. Can only be altered if a URI is provided. Must be configured using **Edge Connector**.

<LinkButton link="/en/documentation/products/build/edge-application/edge connector/" label="Learn more about edge connector" />
