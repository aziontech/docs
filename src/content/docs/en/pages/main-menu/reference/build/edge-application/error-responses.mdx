...
description: >-
  Error Responses is an Edge Application capability that allows you to customize
...
permalink: /documentation/products/build/edge-application/error-responses/
---
import LinkButton from 'azion-webkit/linkbutton';

:::caution[important]
The Error Responses feature has been replaced by **Custom Pages.**
For more information about this change and how to configure custom error responses, visit the [Custom Pages Reference](/en/documentation/products/secure/custom-pages/).
:::
...
<LinkButton link="/en/documentation/products/build/edge-application/origins/" label="Learn more about Origins" />
