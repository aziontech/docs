...
<LinkButton link="/en/documentation/products/build/applications/cache-settings/#advanced-cache-key" label="Learn more about Advanced Cache Key" />
...
<LinkButton link="/en/documentation/products/build/applications/rules-engine/" label="Learn more about Rules Engine" />
...
<LinkButton link="/en/documentation/products/build/applications/cache-settings/#caching-http-methods" label="Learn more about caching HTTP methods" />
