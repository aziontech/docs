...
<LinkButton outlined link="/en/documentation/products/build/edge-application/cache-settings/#advanced-cache-key" label="Learn more about Advanced Cache Key" />
...
<LinkButton outlined link="/en/documentation/products/build/edge-application/rules-engine/" label="Learn more about Rules Engine" />
...
<LinkButton outlined link="/en/documentation/products/build/edge-application/cache-settings/#caching-http-methods" label="Learn more about caching HTTP methods" />
