...
<Button href="/en/documentation/products/build/edge-application/cache-settings/#advanced-cache-key" text="Learn more about Advanced Cache Key"></Button>
...
<Button href="/en/documentation/products/build/edge-application/cache-settings/#caching-http-methods" text="Learn more about caching HTTP methods"></Button>
