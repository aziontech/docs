...
**Real-Time Purge** allows you to instantly delete the cache of your content at Azion.
...
::: When you update content at your origin, you must choose the best strategy for updating it in Azion's cache.
...
To use Real-Time Purge via Azion Console:

1. Access [Azion Console](https://console.azion.com) > **Edge Application**.
2. Select the edge application you want to purge.
3. Navigate to the **Real-Time Purge** tab.
4. Select the cache layer: **Edge Cache** or **Tiered Cache**.
5. Choose the purge method: **URL**, **Cache Key**, or **Wildcard**.
6. Enter the URLs, cache keys, or wildcard expressions.
7. Click **Purge Now**.
...
You can use the API v4 to programmatically purge content:
...
For more information, see the [API v4 documentation](/en/documentation/devtools/api-v4/edge-application/).
...
:::caution[Warning]
Azion's API v3 has been discontinued. Use [API v4](/en/documentation/devtools/api-v4/) for future implementations.
:::

You can use the API v3 to programmatically purge content:
...
For more information about API v3 implementation, see the [API v3 documentation](/en/documentation/products/api/) (discontinued).
