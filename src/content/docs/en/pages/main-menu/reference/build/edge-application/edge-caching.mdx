...
When the [Advanced Cache Key](/en/documentation/products/build/edge-application/application-acceleration/#advanced-cache-key) feature is configured, the formation of cache keys is also affected. 
...
**Slice** is a resource for **Edge Application** that processes large amounts of data more effectively, reducing latency and saving bandwidth.
...
<Button href="/en/documentation/products/edge-application/cache-settings/#slice-settings" text="go to slice files documentation"></Button>
