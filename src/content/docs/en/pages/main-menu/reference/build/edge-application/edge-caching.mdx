...
- **Observability**: [Real-Time Metrics](/en/documentation/platform/real-time-metrics/) carries a Cache dataset and a Tiered Cache dataset, and a single response reports its own status through a debug header.
