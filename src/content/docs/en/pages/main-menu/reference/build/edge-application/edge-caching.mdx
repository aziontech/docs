...
When the [Advanced Cache Key](/en/documentation/build/application-accelerator/#advanced-cache-key) feature is configured, the formation of cache keys is also affected. 
