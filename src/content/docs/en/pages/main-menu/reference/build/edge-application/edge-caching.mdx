...
When your application's cache expires, it becomes *stale* (obsolete) and the server searches the origin for the most up-to-date version. This new version, with an updated expiration date, overwrites the old one.
