...
<LinkButton outlined link="/en/documentation/products/build/edge-application/cache-settings/#browser-cache-settings" label="go to expiration settings documentation" />
...
<LinkButton outlined link="/en/documentation/products/build/edge-application/cache-settings/#stale-cache" label="go to stale cache documentation" />
...
<LinkButton outlined link="/en/documentation/products/build/edge-application/cache-settings/#adaptive-delivery" label="go to Adaptive Delivery documentation" />
...
<LinkButton outlined link="/en/documentation/products/build/edge-application/cache-settings/#large-file-optimization" label="go to Large File Optimization documentation" />
