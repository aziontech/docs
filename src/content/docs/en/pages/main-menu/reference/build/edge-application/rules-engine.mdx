...
[<Badge variant="accent">Requires Application Accelerator</Badge>](/en/documentation/products/build/edge-application/application-accelerator/)
...
<Badge>Request Phase</Badge>
[<Badge variant="accent">Requires HTTPS application</Badge>](/en/documentation/products/build/edge-application/main-settings/)
