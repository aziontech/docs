...
<LinkButton link="/en/documentation/products/build/edge-application/domains/mtls/" label="Learn more about support for mTLS" outlined />
...
<LinkButton link="/en/documentation/products/guides/enforce-hls-cache/" label="go to enforce HLS cache guide" outlined />
