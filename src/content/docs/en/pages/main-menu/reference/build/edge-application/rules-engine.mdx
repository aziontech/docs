...
<LinkButton link="/en/documentation/products/secure/firewall/mtls/" label="Learn more about support for mTLS" severity="secondary" />
...
Before configuring this behavior, you must set up your origins using [Connectors](/en/documentation/products/secure/connectors/).
