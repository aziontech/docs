...
description: Rules Engine allows you to create conditional behaviors directly in Azion Console, automating your business logic and improving performance and throughput for your application.
...
<LinkButton outlined link="/en/documentation/products/build/edge-application/domains/mtls/" label="Learn more about support for mTLS" />
...
[<Tag severity="primary" client:only="vue">Requires Application Accelerator</Tag>](/en/documentation/products/build/edge-application/application-accelerator/)
...
### Enforce HLS cache
 <Tag severity="info" client:only="vue">Request Phase</Tag>
<Tag severity="primary" client:only="vue">Requires Live Ingest</Tag>
...
### Optimize Images
 <Tag severity="info" client:only="vue">Request Phase</Tag>
[<Tag severity="primary" client:only="vue">Requires Image Processor</Tag>](/en/documentation/products/build/edge-application/image-processor/)

Enables [Image Processor](/en/documentation/products/build/edge-application/image-processor/).

### Redirect HTTP to HTTPS
 <Tag severity="info" client:only="vue">Request Phase</Tag>
[<Tag severity="primary" client:only="vue">Requires HTTPS application</Tag>](/en/documentation/products/build/edge-application/main-settings/)
...
### Run Function
 <Tag severity="info" client:only="vue">Request Phase</Tag>  <Tag severity="info" client:only="vue">Response Phase</Tag>
[<Tag severity="primary" client:only="vue">Requires Application Accelerator</Tag>](/en/documentation/products/build/edge-application/application-accelerator/)
[<Tag severity="primary" client:only="vue">Requires Edge Functions</Tag>](/en/documentation/products/build/edge-application/edge-functions/)
