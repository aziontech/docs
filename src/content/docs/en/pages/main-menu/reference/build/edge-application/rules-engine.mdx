...
| `${device_group}` | Device group name. You can customize your [device groups](/en/documentation/products/build/edge-application/device-groups/) in the **Device Groups** tab of your application in Real-Time Manager. | Request Phase<br />Response Phase |
...
[<Badge variant="accent">Requires Application Acceleration</Badge>](/en/documentation/products/build/edge-application/application-acceleration/)
...
### Enable Sliced Files
<Badge>Request Phase</Badge>
[<Badge variant="accent">Requires Edge Caching</Badge>](/en/documentation/products/build/edge-application/edge-caching/)
...
To prevent a user from receiving the `Set-Cookie` header from another user's session, see the [guide on cache policies](/en/documentation/products/guides/cache-settings/#creating-a-rule-to-forward-cookies-from-origin-to-user).
...
### Optimize Images
<Badge>Request Phase</Badge>
[<Badge variant="accent">Requires Image Processor</Badge>](/en/documentation/products/build/edge-application/image-processor/)

Enables [Image Processor](/en/documentation/products/build/edge-application/image-processor/).

### Redirect HTTP to HTTPS
<Badge>Request Phase</Badge>
[<Badge variant="accent">Requires HTTPS application</Badge>](/en/documentation/products/edge-application/build/main-settings/)
...
<Badge>Request Phase</Badge> <Badge>Response Phase</Badge>
[<Badge variant="accent">Requires Application Acceleration</Badge>](/en/documentation/products/build/edge-application/application-acceleration/)
[<Badge variant="accent">Requires Edge Functions</Badge>](/en/documentation/products/build/edge-application/edge-functions/)
