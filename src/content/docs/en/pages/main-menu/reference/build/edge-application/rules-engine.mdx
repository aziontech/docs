...
[<Badge variant="accent">Requires Application Accelerator</Tag>](/en/documentation/products/build/edge-application/application-accelerator/)
...
### Enforce HLS cache
 <Tag severity="info" client:only="vue">Request Phase</Tag>
<Badge variant="accent">Requires Live Ingest</Tag>
...
### Optimize Images
 <Tag severity="info" client:only="vue">Request Phase</Tag>
[<Badge variant="accent">Requires Image Processor</Tag>](/en/documentation/products/build/edge-application/image-processor/)

Enables [Image Processor](/en/documentation/products/build/edge-application/image-processor/).

### Redirect HTTP to HTTPS
 <Tag severity="info" client:only="vue">Request Phase</Tag>
[<Badge variant="accent">Requires HTTPS application</Tag>](/en/documentation/products/build/edge-application/main-settings/)
...
### Run Function
 <Tag severity="info" client:only="vue">Request Phase</Tag>  <Tag severity="info" client:only="vue">Response Phase</Tag>
[<Badge variant="accent">Requires Application Accelerator</Tag>](/en/documentation/products/build/edge-application/application-accelerator/)
[<Badge variant="accent">Requires Edge Functions</Tag>](/en/documentation/products/build/edge-application/edge-functions/)
