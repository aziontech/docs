...
| `${device_group}` | Device group name. You can customize your [device groups](/en/documentation/products/build/edge-application/device-groups/) in the **Device Groups** tab of your application | `Mobile` | Request <br />Response |
...
<Tag severity="info" client:only="vue">Request Phase</Tag> <Tag severity="info" client:only="vue">Response Phase</Tag>
[<Tag severity="info" client:only="vue">Requires Application Accelerator</Tag>](/en/documentation/products/build/edge-application/application-accelerator/)
[<Tag severity="info" client:only="vue">Requires Functions</Tag>](/en/documentation/products/build/edge-application/edge-functions/)
