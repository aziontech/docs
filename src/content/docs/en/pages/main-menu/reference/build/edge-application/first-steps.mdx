...
Some **Edge Application modules** are billed products and it may generate usage-related costs. Check the [Edge Application modules pricing](/en/documentation/products/pricing/) for more information.
...
An origin represents the server from which Azion retrieves your content, which can be an object storage service or a cloud server. 

To configure your edge application's origin you'll use [Edge Connector](/en/documentation/products/secure/edge-connector/).
...
4. In the field **Conector Type**, select the desired Connector Type.
5. Fill in the remaining fields.
6. Click the **Save** button.

:::note
For more details on Connector Types, please visit the [Edge Connector Reference](/en/documentation/products/secure/edge-connector/).
:::
...
When using multiple origins for your Edge Application you can use [Load Balancer](/en/documentation/products/build/edge-application/load-balancer/) to balance traffic.
