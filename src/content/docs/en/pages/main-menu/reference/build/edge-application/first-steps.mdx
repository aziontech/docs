...
**Edge Connector** enables you to configure multiple origins and distribute traffic among them by using [Load Balancer](/en/documentation/products/secure/edge-connector/load-balancer/).
