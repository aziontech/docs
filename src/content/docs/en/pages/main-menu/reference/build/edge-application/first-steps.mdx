...
permalink: /documentation/platform/applications/first-steps/
---

Before using **Applications**, make sure you have:

- An Azion Console account. You can find more information about how to create your account on the [documentation page](/en/documentation/fundamentals/creating-account/).
- An application. If you haven't created an application yet, check the [build an application](/en/documentation/guides/application-development/getting-started/build-an-application/) page.

> See also the guides on [how to clone](/en/documentation/guides/application-development/getting-started/clone-applications/) and [how to delete](/en/documentation/guides/application-development/getting-started/delete-applications/) an application.
...
- [Application Accelerator](/en/documentation/build/application-accelerator/)
- [Cache](/en/documentation/build/cache/)
- [Functions](/en/documentation/build/functions/)
- [Image Processor](/en/documentation/build/image-processor/)
- [Tiered Cache](/en/documentation/build/cache/tiered-cache/)

Some **Applications modules** are billed products and it may generate usage-related costs. Check the [Applications modules pricing](/en/documentation/fundamentals/pricing/) for more information.
...
- [Device Groups](/en/documentation/platform/applications/device-groups/)
- [Cache Settings](/en/documentation/build/cache/cache-settings/)
- [Functions](/en/documentation/build/functions/functions-instances/)
- [Rules Engine](/en/documentation/platform/applications/rules-engine/)
...
To configure your application's origin you'll use [Connectors](/en/documentation/platform/connectors/).
...
:::note
For more details on Connector Types, please visit the [Connectors reference](/en/documentation/platform/connectors/).
:::
...
**Connector** enables you to configure multiple origins and distribute traffic among them by using [Load Balancer](/en/documentation/platform/load-balancer/).

:::tip
You can use [Custom Pages](/en/documentation/platform/custom-pages/) to configure custom error pages that are displayed when **Connector** receives specific error responses (such as HTTP 4xx or 5xx status codes) from your origin.
:::

### Device Groups

Manage devices using [Device Groups](/en/documentation/platform/applications/device-groups/):
...
Edit your cache configuration in [Cache Settings](/en/documentation/build/cache/cache-settings/):
...
5. If you've chosen to override cache settings, add the desired **Maximum TTL** in seconds.
    - At this point, you may also customize other cache settings for dynamic content provided by the [Advanced Cache Key](/en/documentation/build/cache/cache-settings/#application-accelerator) feature.
6. Click the **Save** button.

#### Tiered Cache

To use the [Tiered Cache](/en/documentation/build/cache/tiered-cache/) module:
...
Instantiate your functions using [Functions](/en/documentation/build/functions/functions-instances/):
...
Create conditional business rules for your application using [Rules Engine](/en/documentation/platform/applications/rules-engine/).
...
To access [Real-Time Purge](/en/documentation/build/cache/real-time-purge/), proceed as follows:
