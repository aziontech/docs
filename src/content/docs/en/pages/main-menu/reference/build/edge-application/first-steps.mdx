...
permalink: /documentation/products/build/edge-application/first-steps/
---
...
- [Application Acceleration](/en/documentation/products/build/edge-application/application-acceleration/)
- [Edge Caching](/en/documentation/products/build/edge-application/edge-caching/)
...
- [Load Balancer](/en/documentation/products/build/edge-application/load-balancer/)
- [WebSocket Proxy](/en/documentation/products/build/edge-application/websocket/)
...
- [Origins](/en/documentation/products/build/edge-application/origins/)
- [Device Groups](/en/documentation/products/build/edge-application/device-groups/)
- [Error Responses](/en/documentation/products/build/edge-application/error-responses/)
- [Cache Settings](/en/documentation/products/edge-application/cache-settings/)
- [Functions](/en/documentation/products/build/edge-application/edge-functions-instances/)
- [Rules Engine](/en/documentation/products/build/edge-application/rules-engine/)

Each tab stores in other configuration options for your edge application.

### Origins

Configure your edge application's [Single Origin](/en/documentation/products/build/edge-application/origins/) in the **Origins** tab:
...
To set up Azion [Load Balancer](/en/documentation/products/build/edge-application/load-balancer/), follow the steps below:
...
Manage devices using [Device Groups](/en/documentation/products/build/edge-application/device-groups/):
...
Configure your error pages using [Error Responses](/en/documentation/products/build/edge-application/error-responses/):
...
Instantiate your functions using [Edge Functions](/en/documentation/products/build/edge-application/edge-functions-instances/):
...
Create conditional business rules for your application using [Rules Engine](/en/documentation/products/build/edge-application/rules-engine/).
...
To access [Real-Time Purge](/en/documentation/products/build/edge-application/real-time-purge/), proceed as follows:
