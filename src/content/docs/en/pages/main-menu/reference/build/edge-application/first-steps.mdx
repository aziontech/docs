...
- [Tiered Cache](/en/documentation/products/edge-application/l2-caching/)
...
To use the [Tiered Cache](/en/documentation/products/edge-application/l2-caching/) module:
