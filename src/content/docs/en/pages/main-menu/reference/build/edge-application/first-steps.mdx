...
5. If you've chosen to override cache settings, add the desired **Maximum TTL** in seconds.
    - At this point, you may also customize other cache settings for dynamic content provided by the [Advanced Cache Key](/en/documentation/build/cache/cache-settings/#advanced-cache-key) feature.
6. Click the **Save** button.
