...
**Edge Connector** enables you to configure multiple origins and distribute traffic among them by using [Load Balancer](/en/documentation/products/build/edge-application/load-balancer/).

:::tip
You use [Custom Pages](/en/documentation/products/secure/custom-pages/) to configure custom error pages that are displayed when **Edge Connector** receives specific error responses (such as HTTP 4xx or 5xx status codes) from your origin.
:::
