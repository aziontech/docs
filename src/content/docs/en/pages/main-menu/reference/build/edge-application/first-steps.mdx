...
:::tip
You can use [Custom Pages](/en/documentation/products/secure/custom-pages/) to configure custom error pages that are displayed when **Edge Connector** receives specific error responses (such as HTTP 4xx or 5xx status codes) from your origin.
:::
