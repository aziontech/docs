...
- An edge application. If you haven't created an edge application yet, check the [build an application](/en/documentation/products/guides/build/build-an-application/) page.
...
- [Tiered Cache](/en/documentation/products/build/edge-application/tiered-cache/)
...
> See more information about [Edge Application modules pricing](/en/documentation/products/pricing/).
...
- [edge connector](/en/documentation/products/build/edge-application/edge connector/)
- [Device Groups](/en/documentation/products/build/edge-application/device-groups/)
- [custom pages](/en/documentation/products/build/edge-application/custom-pages/)
...
Configure your edge application's [Single Origin](/en/documentation/products/build/edge-application/edge connector/) in the **Edge Connector** tab:

1. Access the **Edge Connector** tab.
...
1. In the **Edge Connector** tab, edit the default origin or add a new one.
...
Configure your error pages using [custom pages](/en/documentation/products/build/edge-application/custom-pages/):

1. Access the **Custom Pages** tab.
...
8. In the **Origin** section, you can define the origin of error page URIs.
    - You can configure their edge connector in the application's **Edge Connector** tab.
9. Click the **Save** button.

### Cache Settings

Edit your cache configuration in [Cache Settings](/en/documentation/products/build/edge-application/cache-settings/):
...
To use the [Tiered Cache](/en/documentation/products/build/edge-application/tiered-cache/) module:
