...
<LinkButton severity="secondary" label="Build your first Applications" link="/en/documentation/products/getting-started/" />
...
Azion **Domains** provides you with the flexibility to use automatically generated domains or your own custom domains, allowing you to manage and deliver content effectively through your applications with support for secure connections over HTTP and HTTPS.
...
<LinkButton severity="secondary" label="Learn more about Certificate Manager" link="/en/documentation/products/secure/edge-firewall/digital-certificates/" />
