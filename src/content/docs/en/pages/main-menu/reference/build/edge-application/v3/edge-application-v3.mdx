...
description: >-
  Edge Application is a product that lets you build applications on Azion Edge- Legacy version
...
Modules can complement your implementation of an **Edge Application**. You can enable or disable modules in the **Main Settings** tab of your application, provided your account supports them and there are no existing dependencies upon deactivation.
