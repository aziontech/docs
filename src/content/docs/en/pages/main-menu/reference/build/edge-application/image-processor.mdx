...
The table below outlines the maximum allowed dimensions and file sizes for image processing.

| Image processor| Maximum size | Maximum height | Maximum width |
|----------|----------|----------|----------|
| Optimization | 150mb | 2160 pixels | 3840 pixels |
