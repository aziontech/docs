...
Volume of data consumed by images processed through Image Processor. Whenever a request is made to Azion Edge Computing Platform, processed images are calculated.
