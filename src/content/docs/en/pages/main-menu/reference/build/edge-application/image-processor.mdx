...
| Creating edge applications | [How to create edge applications](/en/documentation/products/guides/build/first-steps/) |
...
| --- | --- |
| Image processor first steps | [Image Processor first steps](/en/documentation/products/guides/image-processor/) |
| API v4 Edge Application | [API v4 documentation](/en/documentation/devtools/api-v4/edge-application/) |
| Creating edge applications | [How to create edge applications](/en/documentation/products/guides/build/first-steps/) |
...
| --- | --- |
| Image processor first steps | [Image Processor first steps](/en/documentation/products/guides/image-processor/) |
| API v3 Edge Application | [API v3 documentation](/en/documentation/products/api/) |
| Creating edge applications | [How to create edge applications](/en/documentation/products/guides/build/first-steps/) |
