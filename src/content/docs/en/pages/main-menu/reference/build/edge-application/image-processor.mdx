...
**Image Processor** has specific metrics that define how the product is billed.

<Button href="https://www.azion.com/en/pricing/#ImageProcessor" text="see pricing"></Button>

### Images Processed

Volume of data consumed by images processed through Image Processor. Whenever a request is made to Azion Edge Computing Platform for an image, any processed images are calculated.

Data is counted if any of the available features or any filter of the product is used to process an image.
