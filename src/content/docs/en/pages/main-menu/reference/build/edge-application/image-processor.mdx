...
:::tip
You can follow the **Bandwidth Saving** graph through [Real-Time Metrics](/en/documentation/platform/real-time-metrics/) to monitor the traffic savings resulting from the processed images.
:::
...
| Scope | Resource |
| --- | --- |
| Image processor first steps | [Image Processor first steps](/en/documentation/guides/application-performance/delivery-optimization/image-processor/) |
