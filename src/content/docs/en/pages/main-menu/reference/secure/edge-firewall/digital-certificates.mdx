...
description: You can link a TLS certificate to your HTTPS edge applications by using Azion Digital Certificates.
...
<LinkButton link="https://api.azion.com/#b2df23ee-7a28-4900-9ad5-ffd135b4c6cf" label="create CRL via API" outlined />
