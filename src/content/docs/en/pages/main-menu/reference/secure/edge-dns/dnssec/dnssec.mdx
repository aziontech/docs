...
permalink: /documentation/secure/edge-dns/dnssec-compatibility/
---
...
<DocButton href="/en/documentation/guides/application-security/dns/activate-dnssec/" label="activate DNSSEC" kind="secondary" size="medium" /> 
