...
- **Legitimate traffic**: This category is assigned to requests that don't match either "good bot" or "bad bot" criteria. It typically refers to normal user traffic (non-bots) showing legitimate access patterns without signs of automation or suspicious behavior.
...
You can also check the Bot Manager graphs in [Real-Time Metrics](/en/documentation/products/observe/real-time-metrics/)
