...
:::tip
You can use the ALTCHA Edge Function independently—only with Edge Firewall—to protect specific areas of your application by requiring the challenge. Read the guide [How to use the ALTCHA Edge Function through Azion Marketplace](https://www.azion.com/en/documentation/products/guides/altcha/) to know more.
:::
