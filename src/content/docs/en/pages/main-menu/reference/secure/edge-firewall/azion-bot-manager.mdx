...
| dynamic_rules_baseline | Number | No | `0` | Lower baseline means more strict detections. For example: 0.1 = increase baseline by 10% or -0.234 = decrease baseline by 23,4%. |
