...
:::note
If you choose to deliver your application through HTTP and HTTPS, you must set up a [digital certificate](/en/documentation/products/secure/firewall/digital-certificates/) to your domain.
:::
