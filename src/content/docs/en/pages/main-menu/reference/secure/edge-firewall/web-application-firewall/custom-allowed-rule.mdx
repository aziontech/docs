...
:::tip
Learn more about [Firewall modules](/en/documentation/platform/firewall/) and [Web Application Firewall](/en/documentation/secure/waf/).
:::
...
For more information on how WAF tuning works in practice, [check our guide on how to configure it](https://www.azion.com/en/documentation/guides/application-security/firewall-and-waf/tune-waf/).
...
| 13      | Invalid POST format. <br/> **Note**: requests that fall under rule 13 will be blocked in some cases, even if the WAF is operating in *learning* mode. Read the [Rules Engine for Firewall](/en/documentation/platform/firewall/rules-engine/) documentation for the definition of learning/blocking modes. Read this guide [how to check your WAF mode](/en/documentation/guides/application-security/firewall-and-waf/how-to-check-your-waf-mode/).                                                                                                                      |
...
| `match_zone` | string | The part of the request to match against. See [Match Zone options](/en/documentation/secure/waf/#match-zone-dropdown-options) |
