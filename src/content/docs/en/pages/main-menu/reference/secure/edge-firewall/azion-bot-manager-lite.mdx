...
<LinkButton link="/en/documentation/products/guides/bot-manager-lite-integration-kit/" label="Go to the How to add Bot Manager Lite to an existent firewall with a template guide" severity="secondary" /> 
