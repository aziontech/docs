...
<DocButton href="/en/documentation/guides/application-development/integrations/bot-manager-lite/" label="Go to the Bot Manager Lite installation guide" kind="secondary" size="medium" />
