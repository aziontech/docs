...
permalink: /documentation/platform/load-balancer/
---
...
For more options on how to direct traffic to **Load Balancer** based on other criteria, see the [Rules Engine for Application](/en/documentation/platform/applications/rules-engine/) page.
...
<DocButton href="/en/documentation/platform/connectors/origins/#address" label="Learn more about origin addresses" size="medium" />
...
You can request to increase the limits. Contact the [technical support team](/en/documentation/support/) to request it.
:::
