...
| Scope | Resource |
| --- | --- |
| Edge Connector | [Edge Connector](/en/documentation/products/secure/edge-connector/) |
...
With **Load Balancer** active, you may create up to 10 origin addresses for each Edge Connector.
