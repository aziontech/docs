...
:::note
This page documents the new Custom Pages product. If your account hasn't been migrated yet, refer to the [legacy Error Responses](/en/documentation/products/build/edge-application/error-responses/).
:::


**Custom Pages** is an Azion feature that allows you to customize error pages for users based on the status code received from an [Edge Connector](/en/documentation/products/secure/edge-connector/).
...
| Edge Connector | [Edge Connector reference](/en/documentation/products/secure/edge-connector/) |
...
The code Azion receives from Edge Connector when connecting to the origin.
