...
permalink: /documentation/platform/custom-pages/
---
...
:::note
This page documents the new Custom Pages product. If your account hasn't been migrated yet, refer to the [legacy Error Responses documentation](/en/documentation/platform/custom-pages/error-responses/).
:::

**Custom Pages** is an Azion feature that allows you to customize error pages for users based on the status code received from an [Connector](/en/documentation/platform/connectors/).
...
| Connectors | [Connectors reference](/en/documentation/platform/connectors/) |
| Workloads | [Workloads reference](/en/documentation/platform/workloads/) |
...
The code Azion receives from the Connector when connecting to the origin.
...
<DocButton href="/en/documentation/build/cache/cache-settings/#browser-cache-settings" label="Learn more about cache expiration settings" size="medium" />
