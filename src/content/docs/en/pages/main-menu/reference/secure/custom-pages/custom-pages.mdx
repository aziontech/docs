...
<DocButton href="/en/documentation/products/build/applications/cache-settings/#browser-cache-settings" label="Learn more about cache expiration settings" size="medium" />
