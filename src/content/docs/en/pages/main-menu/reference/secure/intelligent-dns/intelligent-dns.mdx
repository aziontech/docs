...
After configuring Intelligent DNS, you can test if your zone is processing your information.
...
<Button href="/en/documentation/products/secure/intelligent-dns/dnssec-compatibility/" text="go to DNSSEC compatibility reference" variant="secondary"> 
</Button> 
...
**Intelligent DNS** has specific metrics that define how the product is billed.

<Button href="https://www.azion.com/en/pricing/#IntelligentDNS" text="see pricing"></Button>

### Hosted Zones

Total number of zones hosted in Intelligent DNS. 

### Standard Queries

Total amount of queries made to your zones hosted in Intelligent DNS. One query is processed whenever your zone, composed by a domain and records, receives a request.
