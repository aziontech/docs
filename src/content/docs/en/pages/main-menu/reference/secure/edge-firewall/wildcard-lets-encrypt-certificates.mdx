...
<LinkButton link="/en/documentation/products/guides/secure/digital-certificates/" label="consult the guide on obtaining and registering a digital certificate" severity="secondary" />
