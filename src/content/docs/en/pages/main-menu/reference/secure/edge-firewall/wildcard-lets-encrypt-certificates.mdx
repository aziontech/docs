...
permalink: /documentation/platform/certificate-manager/wildcard-lets-encrypt-certificates/
---
...
For automatic issuance to work, the customer's DNS zone must be configured and active in [Azion Edge DNS](/en/documentation/secure/edge-dns/). This configuration allows the platform to have full control over the DNS records needed for validation.
...
<DocButton href="/en/documentation/guides/application-security/tls-and-certificates/digital-certificates/" label="consult the guide on obtaining and registering a digital certificate" kind="secondary" size="medium" />
