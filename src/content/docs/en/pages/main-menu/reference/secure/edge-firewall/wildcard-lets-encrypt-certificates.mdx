...
<DocButton href="/en/documentation/products/guides/secure/digital-certificates/" label="consult the guide on obtaining and registering a digital certificate" kind="secondary" size="medium" />
