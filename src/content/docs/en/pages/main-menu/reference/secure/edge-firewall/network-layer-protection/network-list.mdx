---
title: Network Lists
description: Discover how Azion's Network Lists provide granular control over network layer protection allowlists, blocklists, and graylists with IPs, ASNs and countries.
...
permalink: /documentation/products/secure/edge-firewall/network-layer-protection/network-lists/
---
...
<LinkButton outlined link="/en/documentation/products/guides/blocklists-ip-addresses-edge/" label="create network lists" variant="secondary" /> 
...
<LinkButton outlined link="/en/documentation/products/guides/secure/block-tor-networks/" label="go to block Tor networks guide" variant="secondary" />
...
Watch a video tutorial about Network Lists on Azion’s YouTube channel:

<iframe
   src="https://www.youtube.com/embed/KBYXwr11uUo"
   title="Create and manage allowlists, blocklists, and graylists with Network Lists"
   loading="lazy"
   width="600"
   height="400"
   frameborder="0"
