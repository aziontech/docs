...
<LinkButton link="/en/documentation/products/guides/blocklists-ip-addresses-edge/" label="create network lists" outlined /> 
...
<LinkButton link="/en/documentation/products/guides/secure/block-tor-networks/" label="go to block Tor networks guide" outlined />
