...
For more details on the product's accounting, see the [pricing](https://www.azion.com/en/pricing/) page.
...
| Network Layer Protection | [How to create IP blocklists with Network Layer Protection](/en/documentation/products/guides/blocklists-ip-addresses-edge/) |
