...
permalink: /documentation/platform/firewall/
---

import DocButton from '~/components/webkit/DocButton.vue';

**Firewall** is a resource in the Azion platform that protects workloads running on its globally distributed infrastructure by inspecting and filtering traffic close to the requester—before it reaches the application.
Its composable architecture allows you to combine powerful modules—**DDoS Protection**, **Web Application Firewall**, **Network Shield**, **Bot Manager**, and **Functions**—to address specific aspects of traffic inspection and threat mitigation.

These capabilities can be used to build a comprehensive security policy that matches your workload’s requirements, while leveraging the platform’s global reach and low-latency performance.
...
For more details on the product's accounting, see the [pricing](/en/documentation/fundamentals/pricing/) page.

## Implementation

| Scope | Source |
| ----- | ------ |
| Main settings | [How to configure main settings](/en/documentation/guides/application-security/firewall-and-waf/firewall-configure-main-settings/) |
| Update Firewall | [How to update your Firewall](/en/documentation/guides/application-security/firewall-and-waf/how-to-update-your-firewall/) |
| Get to know Network Lists | [Network Lists](/en/documentation/secure/network-shield/network-lists/) |
| Get to know WAF Rule Sets | [WAF Rule Sets](/en/documentation/secure/waf/rules-set/) |
| Get to know WAF Custom Allowed Rules | [WAF Custom Allowed Rules](/en/documentation/secure/waf/custom-allowed-rules/) |
| Get to know Functions | [Functions Instances for Firewall](/en/documentation/platform/firewall/functions-instances/) |
| Get to know Rules Engine | [Rules Engine for Firewall](/en/documentation/platform/firewall/rules-engine/) |
| Get to know Certificate Manager | [Certificate Manager for Secure](/en/documentation/platform/certificate-manager/for-firewall/) |
| DNSSEC Compatibility | [DNSSEC Compatibility](/en/documentation/secure/edge-dns/dnssec-compatibility/) |
| Create network lists | [How to create IP blocklists with Network Shield](/en/documentation/guides/application-security/bots-and-network/blocklists-ip-addresses-edge/) |
| WAF Mode | [Check or change the WAF mode](/en/documentation/guides/application-security/firewall-and-waf/how-to-check-your-waf-mode/) |
...
<DocButton href="/en/documentation/guides/application-security/firewall-and-waf/firewall-configure-main-settings/" label="go to configure main settings guide" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/platform/firewall/rules-engine/" label="go to Rules Engine reference" kind="secondary" size="medium" />

<DocButton href="/en/documentation/guides/application-security/firewall-and-waf/work-with-rules-engine/" label="go to work with rules engine guide" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/platform/ddos-protection/" label="go to DDoS Protection reference" kind="secondary" size="medium" />

### Functions

**Functions** are components of Azion Web Platform**, which enable serverless functions to be added to your applications or firewall configurations, relieving your infrastructure, performing functions closer to the end-user, ensuring the necessary agility and scalability to meet your business objectives. You can also choose a ready-to-use function, or even write your own.

<DocButton href="/en/documentation/platform/firewall/functions/" label="go to Functions for Firewall reference" kind="secondary" size="medium" />

<DocButton href="/en/documentation/guides/application-security/firewall-and-waf/instantiate-functions/" label="go to instantiate functions guide" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/secure/network-shield/" label="go to Network Shield reference" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/secure/waf/" label="go to Web Application Firewall reference" kind="secondary" size="medium" />

<DocButton href="/en/documentation/guides/application-security/firewall-and-waf/create-waf-rule-set/" label="go to create waf rule set guide" kind="secondary" size="medium" />
...
<DocButton href="https://api.azion.com/#7e92d69a-c98c-4578-b920-38a13e1a3bd2" label="clone an firewall" kind="secondary" size="medium" />
