...
<Button href="/en/documentation/products/secure/firewall/rules-engine/" label="go to Rules Engine reference" type="primary" theme="light" />
...
<Button href="/en/documentation/products/secure/firewall/ddos-protection/" label="go to DDoS Protection reference" type="primary" theme="light" />
...
<Button href="/en/documentation/products/secure/firewall/functions/" label="go to Functions for Firewall reference" type="primary" theme="light" />

<Button href="/en/documentation/products/guides/secure/instantiate-edge-functions/" label="go to instantiate functions guide" type="primary" theme="light" />
...
<Button href="/en/documentation/products/secure/firewall/network-shield/" label="go to Network Shield reference" type="primary" theme="light" />
...
<Button href="/en/documentation/products/secure/firewall/web-application-firewall/" label="go to Web Application Firewall reference" type="primary" theme="light" />

<Button href="/en/documentation/products/guides/secure/create-waf-rule-set/" label="go to create waf rule set guide" type="primary" theme="light" />
...
<Button href="https://api.azion.com/#7e92d69a-c98c-4578-b920-38a13e1a3bd2" label="clone an firewall" type="primary" theme="light" />
