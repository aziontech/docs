...
<LinkButton link="/en/documentation/products/guides/secure/instantiate-edge-functions/" label="go to instantiate functions guide" severity="secondary" />
...
<LinkButton link="/en/documentation/products/secure/firewall/network-shield/" label="go to Network Layer Protection reference" severity="secondary" />
