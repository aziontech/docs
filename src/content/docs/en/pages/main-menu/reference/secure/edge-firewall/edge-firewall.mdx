...
permalink: /documentation/products/secure/edge-firewall/
---
...
| Update Edge Firewall | [How to update your Edge Firewall](/en/documentation/products/guides/how-to-update-your-edge-firewall/) |
...
:::tip
You can share the same edge firewall among all applications that adopt the same security policy.
:::
...
<LinkButton outlined link="/en/documentation/products/guides/secure/edge-firewall-configure-main-settings/" label="go to configure main settings guide" variant="secondary" />

:::note
You need to activate at least one for the edge firewall to work.
:::
...
<LinkButton outlined link="/en/documentation/products/secure/edge-firewall/rules-engine/" label="go to Rules Engine reference" variant="secondary" />

<LinkButton outlined link="/en/documentation/products/guides/secure/work-with-rules-engine/" label="go to work with rules engine guide" variant="secondary" />
...
The **DDoS Protection Unmetered** module protects your content and applications against *Distributed Denial of Service (DDoS)* attacks, as it detects attacks using advanced algorithms that run on Azion's distributed network. This distributed network is connected to several mitigation centers to guarantee mitigation during large-scale attacks, both at the network and application levels.

<LinkButton outlined link="/en/documentation/products/secure/edge-firewall/ddos-protection/" label="go to DDoS Protection reference" variant="secondary" /> 

<LinkButton outlined link="/en/documentation/products/guides/secure/activate-ddos/" label="go to activate DDoS guide" variant="secondary" />
...
<LinkButton outlined link="/en/documentation/products/secure/edge-firewall/edge-functions/" label="go to Edge Functions for Edge Firewall reference" variant="secondary" /> 

<LinkButton outlined link="/en/documentation/products/guides/secure/instantiate-edge-functions/" label="go to instantiate edge functions guide" variant="secondary" />
...
<LinkButton outlined link="/en/documentation/products/secure/edge-firewall/network-layer-protection/" label="go to Network Layer Protection reference" variant="secondary" /> 
...
<LinkButton outlined link="/en/documentation/products/secure/edge-firewall/network-layer-protection/#origin-shield)" label="go to Origin Shield reference" variant="secondary" /> 

<LinkButton outlined link="/en/documentation/products/secure/automate/origin-shield/" label="go to automate origin shield guide" variant="secondary" />
...
<LinkButton outlined link="/en/documentation/products/secure/edge-firewall/web-application-firewall/" label="go to Web Application Firewall reference" variant="secondary" /> 

<LinkButton outlined link="/en/documentation/products/guides/secure/create-waf-rule-set/" label="go to create waf rule set guide" variant="secondary" />

---

## Clone for an edge firewall
...
You need to retrieve the [ID of the edge firewall](https://api.azion.com/#58376993-e0dd-4b51-9cd3-41d86122728f) you want to clone and then run a POST request to clone it, providing a new name.

<LinkButton outlined link="https://api.azion.com/#171c4570-b717-4fb1-aa01-805fdbc21ab9" label="clone an edge firewall" variant="secondary" />
...
<AuthorList filePath="src/content/docs/en/pages/main-menu/reference/secure/edge-firewall/edge-firewall.mdx" />
