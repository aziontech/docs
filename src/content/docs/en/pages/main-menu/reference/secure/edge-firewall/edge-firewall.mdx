...
<LinkButton link="/en/Users/luiza.santos/Documents/azion-repos/docs/src/content/docs/en/pages/secure-**journey**/documentation/products/secure/firewall/network-shield/" label="go to Network Shield reference" severity="secondary" />
