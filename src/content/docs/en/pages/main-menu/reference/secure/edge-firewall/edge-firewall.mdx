...
Its composable architecture allows you to combine powerful modules—**DDoS Protection**, **Web Application Firewal**, **Network Shield**, **Bot Manager**, and **Functions**—to address specific aspects of traffic inspection and threat mitigation.
