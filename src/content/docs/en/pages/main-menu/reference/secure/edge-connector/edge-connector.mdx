...
<Button href="/en/documentation/products/secure/connectors/load-balancer/" label="Learn more about Load Balancer" type="primary" theme="light" />
...
<Button href="/en/documentation/products/store/edge-storage/" label="Go to Object Storage reference" type="primary" theme="light" />
...
<Button href="/en/documentation/architectures/live-streaming-delivery/live-streaming-delivery-with-hls/" label="Go to Live Ingest Solution" type="primary" theme="light" />
