...
<DocButton href="/en/documentation/products/secure/connectors/load-balancer/" label="Learn more about Load Balancer" size="medium" />
...
<DocButton href="/en/documentation/products/store/object-storage/" label="Go to Object Storage reference" size="medium" />
...
<DocButton href="/en/documentation/architectures/live-streaming-delivery/live-streaming-delivery-with-hls/" label="Go to Live Ingest Solution" size="medium" />
