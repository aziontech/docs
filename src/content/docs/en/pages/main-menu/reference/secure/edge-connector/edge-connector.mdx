...
### Object Storage
  ...
  When Object Storage is selected as an origin type, it connects directly with an [Azion Object Storage](/en/documentation/products/store/edge-storage/) bucket where you select the bucket and define the prefix.
