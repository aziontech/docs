...
title: Connector
description: >-
  Connector allows you to connect your origin to an Edge Application. An origin represents the server from which Azion retrieves your content, such as an object storage service or a cloud server.
meta_tags: 'Connector, Edge Computing, Edge, Origin'
namespace: documentation_products_edge_connector
permalink: /documentation/products/secure/connector/
---
...
Below are the attributes for the [Connector API](https://api.azion.com/v4#/operations/GetEdgeConnectorConnectors) when using the HTTP connector type.
...
Below are the attributes for the [Connector API](https://api.azion.com/v4#/operations/GetEdgeConnectorConnectors) when using the Object Storage connector type.
