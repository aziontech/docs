...
permalink: /documentation/platform/connectors/
---
...
:::note
This page documents the new Connectors product. If your account hasn't been migrated yet, refer to the [legacy Origins reference](/en/documentation/platform/connectors/origins/).
:::
...
| Scope | Resource |
| --- | --- |
| Application first steps | [First steps](/en/documentation/platform/applications/first-steps/) |
| Load Balancer module | [Load Balancer](/en/documentation/platform/load-balancer/) |
...
The following table summarizes the default timeout and connection-management settings. Some values are configurable per connector, while others are controlled by global settings or the operating system.
...
<DocButton href="/en/documentation/platform/load-balancer/" label="Learn more about Load Balancer" size="medium" />
...
### Object Storage
  ...
  When Object Storage is selected as an origin type, it connects directly with an [Azion Object Storage](/en/documentation/store/object-storage/) bucket where you select the bucket and define the prefix.

The bucket name is defined when you [create or modify an Object Storage bucket](/en/documentation/guides/application-development/data/create-and-modify-bucket/). When creating a connector, the bucket selector automatically lists your existing buckets and provides a search field to help you find the desired bucket.
...
<DocButton href="/en/documentation/store/object-storage/" label="Go to Object Storage reference" size="medium" />
...
<DocButton href="/en/documentation/guides/application-performance/delivery-optimization/live-streaming-delivery-with-hls/" label="Go to Live Ingest Solution" size="medium" />
