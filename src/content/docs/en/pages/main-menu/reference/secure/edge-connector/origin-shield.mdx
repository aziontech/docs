...
permalink: /documentation/products/secure/connector/origin-shield/
---
...
| Connector | [ Connector](/en/documentation/products/secure/connector/) |
...
To activate it, enable Origin IP ACL for at least one [ Connector](/en/documentation/products/secure/connector/) in your account.
