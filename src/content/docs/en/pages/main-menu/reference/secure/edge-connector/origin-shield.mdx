...
permalink: /documentation/secure/origin-shield/
---
...
| Scope | Resource |
| --- | --- |
| Secure an application | [Secure an application](/en/documentation/secure/network-shield/) |
| Retrieve IP ranges for origin allowlisting | [How to retrieve Azion IP ranges](/en/documentation/guides/application-security/bots-and-network/retrieve-azion-ip-ranges/) |
| Connectors | [Connectors](/en/documentation/platform/connectors/) |
...
To activate it, enable Origin IP ACL for at least one [connector](/en/documentation/platform/connectors/) in your account.
