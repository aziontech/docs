...
permalink: /documentation/products/secure/edge-connector/origin-shield/
---
...
To activate it, enable Origin IP ACL for at least one [Edge Connector](/en/documentation/products/secure/edge-connector/) in your account.
