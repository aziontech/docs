...
In the filters below, you can enter the **Workload** (required), **Time Range**, which **Network Lists** you prefer to use, which **IPs** you are investigating, and the **Country** of origin of the requests.

:::note
To see requests identified by WAF, you must at least specify the workload (or the workloads) of your application.
:::
