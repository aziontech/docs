...
<Button href="/en/documentation/products/secure/edge-firewall/web-application-firewall/rules-engine/#threat-types" text="go to waf rule sets reference" variant="secondary"></Button>
...
<Button href="/en/documentation/products/secure/edge-firewall/web-application-firewall/rules-engine/#sensitivity-levels" text="go to waf rule sets reference" variant="secondary"></Button>
