...
<LinkButton link="/en/documentation/products/guides/secure/edge-firewall-configure-main-settings/" label="go to configure firewall guide" severity="secondary" /> 
...
[TECHWRITER TODO: ADD A SECTION EXPLAINING THE USE OF THE REAL-TIME MANAGER FOR WAF MANAGEMENT AND ITS DISCONTINUATION]
[TECHWRITER TODO: ADD A COMPARISON BETWEEN THE OLD INTERFACE (REAL-TIME MANAGER) AND THE NEW INTERFACE (AZION CONSOLE) TO ADDRESS USABILITY DIFFERENCES]