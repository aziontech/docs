...
<LinkButton outlined link="/en/documentation/products/guides/secure/edge-firewall-configure-main-settings/" label="go to configure edge firewall guide" variant="secondary" /> 
...
<LinkButton outlined link="/en/documentation/products/secure/edge-firewall/web-application-firewall/rules-set/#threat-types" label="go to types of threats reference" variant="secondary" /> <br></br>

<LinkButton outlined link="/en/documentation/products/guides/secure/create-waf-rule-set/" label="go to create a rule set guide" variant="secondary" />
...
<LinkButton outlined link="/en/documentation/products/secure/edge-firewall/web-application-firewall/rules-set/#sensitivity-levels" label="go to sensitivity levels reference" variant="secondary" />
...
<LinkButton outlined link="/en/documentation/products/guides/secure/tune-waf/" label="go to tune WAF guide" variant="secondary" /> 
...
<LinkButton outlined link="/en/documentation/products/secure/edge-firewall/web-application-firewall/custom-allowed-rules/" label="go to WAF Custom Allowed Rules reference" variant="secondary" />
