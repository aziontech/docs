...
<Button href="/en/documentation/products/guides/secure/edge-firewall-configure-main-settings/" text="go to configure edge firewall guide" variant="secondary"></Button> 
...
<Button href="/en/documentation/products/guides/secure/tune-waf/" text="go to tune WAF guide" variant="secondary"></Button> 
