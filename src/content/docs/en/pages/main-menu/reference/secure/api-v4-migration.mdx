...
<Button href="/en/documentation/products/secure/workloads" label="Visit the Workloads Reference" type="primary" theme="light" />
...
<Button href="/en/documentation/products/secure/edge-connector" label="Visit the Connectors reference" type="primary" theme="light" />
...
<Button href="/en/documentation/products/secure/custom-pages" label="Visit the Custom Pages Reference" type="primary" theme="light" />
