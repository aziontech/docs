...
- New accounts starting created from **August 1, 2025**, will use API v4 by default. Existing accounts will be migrated in waves.
...
|------------------------------------------------------|---------------------------------|
| Edge Application > Main Settings > Delivery Settings                                         | Workloads                  |
| Edge Application > Origin Settings                                      | Edge Connector                  |
| Edge Application > Error Responses                                      | Custom Pages                    |
| Edge Application > Load Balancer                                        | Edge Connector                  |
...
<<<<<<< HEAD
- **Azion Custom Domain**: You can set up a custom Azion domain for your application using the format `example.azion.app`.
=======
...
<LinkButton link="/en/documentation/products/secure/edge-connector" label="Visit the Edge Connector Reference"/>
...
- **Response Details**: Customize the response for an status code. Specify the URI, status code, TTL, content type, and the response body to be returned to the client.
