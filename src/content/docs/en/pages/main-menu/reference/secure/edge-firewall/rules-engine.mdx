...
Learn how to configure rate limited to Azion's Web Application Firewall.

	<iframe width="560" height="315" src="https://www.youtube.com/embed/SdD-1jZ_tK4?si=_-G2wxiKrREJVZJF" loading="lazy" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
