...
| Scope | Resource |
| --- | --- |
| Secure an application | [How to secure an application](https://www.azion.com/en/documentation/products/secure/secure-application/) |
...
:::note 
The availability of certain criteria depends on the enabled modules of your Edge Firewall. Go to the [Edge Firewall modules reference](/en/documentation/products/secure/edge-firewall/#how-azion-edge-firewall-works) for more details.
:::
...
You can [debug rules created with Rules Engine](/en/documentation/products/guides/debug-rules/) created in Rules Engine for Edge Firewall through the GraphQL API, Data Stream, or Real-Time Events.
