...
<Button href="/en/documentation/products/secure/edge-firewall/" text="go to Edge Firewall reference" variant="secondary"></Button>
...
<Button href="/en/documentation/products/secure/edge-firewall/#how-azion-edge-firewall-works" text="go to Edge Firewall modules reference" variant="secondary"></Button>
