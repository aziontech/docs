...
<LinkButton link="/en/documentation/products/secure/edge-firewall/#how-azion-edge-firewall-works" label="go to Edge Firewall modules reference" severity="secondary" />
