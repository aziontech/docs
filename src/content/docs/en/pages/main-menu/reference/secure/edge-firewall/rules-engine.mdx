...
<LinkButton outlined link="/en/documentation/products/secure/edge-firewall/" label="go to Edge Firewall reference" variant="secondary" />
...
<LinkButton outlined link="/en/documentation/products/secure/edge-firewall/#how-azion-edge-firewall-works" label="go to Edge Firewall modules reference" variant="secondary" />
