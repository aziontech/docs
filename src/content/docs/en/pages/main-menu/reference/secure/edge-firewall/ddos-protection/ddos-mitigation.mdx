...
At Azion, DDoS Mitigation is performed by [DDoS Protection](/en/documentation/products/secure/edge-firewall/ddos-protection/), an **Edge Firewall** add-on. DDoS Protection is designed to mitigate the largest and most complex network, transport, presentation, and application-layer DDoS attacks without bandwidth limitations.
