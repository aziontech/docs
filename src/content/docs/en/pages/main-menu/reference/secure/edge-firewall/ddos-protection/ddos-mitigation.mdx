...
description: At Azion, DDoS Mitigation is performed by DDoS Protection, an Edge Firewall add-on.
meta_tags:  'ddos, protection, attacks, Edge Firewall, security'
namespace: documentation_products_ddos_protection_ddos_mitigation
permalink: /documentation/products/secure/edge-firewall/ddos-protection/ddos-mitigation/
---

import LinkButton from 'azion-webkit/linkbutton'

At Azion, DDoS Mitigation is performed by [DDoS Protection](/en/documentation/products/secure/edge-firewall/ddos-protection/), an **Edge Firewall** add-on. DDoS Protection is designed to mitigate the largest and most complex network, transport, and application-layer DDoS attacks without bandwidth limitations.
...
<LinkButton link="/en/documentation/products/secure/edge-firewall/ddos-protection/" label="Go to DDoS Protection" severity="secondary" target="_blank" />
...
In the best effort, this is a **non-exhaustive list** of some DDoS attacks that can be mitigated by Azion's platform:
...
Attack records and monitoring can be done through Azion **Real-Time Events**, **Real-Time Metrics**, or using **Data Streaming** connectors to integrate *Security Information and Event Management (SIEMs)*.
