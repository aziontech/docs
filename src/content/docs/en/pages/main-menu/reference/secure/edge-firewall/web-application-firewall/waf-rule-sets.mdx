...
<DocButton href="/en/documentation/products/guides/secure/work-with-rules-engine/" label="go to create a rule guide" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/products/observe/real-time-metrics/#waf" label="go to real-time metrics reference" kind="secondary" size="medium" />
