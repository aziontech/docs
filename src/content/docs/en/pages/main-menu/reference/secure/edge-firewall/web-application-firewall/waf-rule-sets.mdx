...
<LinkButton link="/en/documentation/products/guides/secure/work-with-rules-engine/" label="go to create a rule guide" outlined />
...
<LinkButton link="/en/documentation/products/observe/real-time-metrics/#waf" label="go to real-time metrics reference" outlined />
