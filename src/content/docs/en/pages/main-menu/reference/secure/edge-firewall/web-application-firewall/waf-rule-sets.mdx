...
permalink: /documentation/products/secure/edge-firewall/web-application-firewall/rules-set/
---
...
Once you've completed your WAF rule set configuration and your edge application is receiving incoming traffic, you can use **Real-Time Metrics** to monitor requests and threats. You'll find charts comparing how WAF processed requests and a few specific charts for different threat families.
...
Watch a video introduction to WAF Rule Sets on Azion’s YouTube channel:

<iframe
   src="https://www.youtube.com/embed/nmnKwC_6Y0Y"
   title="WAF Rule Sets"
   loading="lazy"
   width="600"
   height="400"
...
<iframe
   src="https://www.youtube.com/embed/nmnKwC_6Y0Y"
   title="WAF rules sets: an Introduction to Azion's WAF"
   loading="lazy"
   width="600"
   height="400"
   frameborder="0"
