...
permalink: >-
  /documentation/products/secure/edge-firewall/web-application-firewall/rules-set/
---
...
Discover how to protect your application from attacks like XSS, SQL Injection, RFI, and Directory Traversal with our exclusive playlist! Check it out below:
<div class="cms-embed">
  <iframe width="600" height="400" src="https://www.youtube.com/embed/VIDEO_ID?playlist=nvtQ00A6An4,b2H3cPDPKhk,s-Pr5Xg8qFg,Z3kuwg-lmb4" loading="lazy" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
...
<LinkButton link="/en/documentation/products/guides/secure/work-with-rules-engine/" label="go to create a rule guide" severity="secondary" />
...
<LinkButton link="/en/documentation/products/observe/real-time-metrics/#waf" label="go to real-time metrics reference" severity="secondary" />
