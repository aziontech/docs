...
[Web Application Firewall (WAF)](/en/documentation/products/secure/firewall/web-application-firewall/) provides the creation of rule sets to protect your edge applications against threat families.
