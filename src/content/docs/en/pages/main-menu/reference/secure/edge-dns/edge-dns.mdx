...
<Button href="/en/documentation/products/secure/troubleshoot/test-zone/" label="go to test zone guide" type="primary" theme="light" /> 

---

## Edge DNS Records

<Button href="/en/documentation/products/guides/secure/add-records/" label="go add records guide" type="primary" theme="light" />
...
<Button href="/en/documentation/products/guides/secure/load-balance-dns/" label="go load balance DNS records guide" type="primary" theme="light" />
...
<Button href="/en/documentation/products/guides/secure/access-root-domain/" label="go to access addresses through a root domain guide" type="primary" theme="light" /> 
...
<Button href="/en/documentation/products/secure/edge-dns/dnssec-compatibility/" label="go to DNSSEC compatibility reference" type="primary" theme="light" /> 
