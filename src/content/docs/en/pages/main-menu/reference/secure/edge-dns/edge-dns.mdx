...
<DocButton href="/en/documentation/products/secure/troubleshoot/test-zone/" label="go to test zone guide" kind="secondary" size="medium" /> 
...
<DocButton href="/en/documentation/products/guides/secure/load-balance-dns/" label="go to load balance DNS records guide" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/products/guides/secure/access-root-domain/" label="go to access addresses through a root domain guide" kind="secondary" size="medium" /> 
...
<DocButton href="/en/documentation/products/secure/edge-dns/dnssec-compatibility/" label="go to DNSSEC compatibility reference" kind="secondary" size="medium" /> 
...
| Tool | Purpose | Guide |
|------|---------|-------|
| **DIG** | Query DNS servers directly, verify record responses | [How to use the DIG command](/en/documentation/products/guides/run-the-dig-command/) |
| **HOST** | Convert domain names to IP addresses and vice versa | [Test zone guide](/en/documentation/products/secure/troubleshoot/test-zone/) |
| **NSLOOKUP** | Query DNS records for domains and IPs | [Test zone guide](/en/documentation/products/secure/troubleshoot/test-zone/) |
| **Traceroute** | Diagnose network path and latency issues | [How to use Traceroute](/en/documentation/products/guides/run-the-traceroute-command/) |

### Monitor DNS Queries

Track DNS query patterns and identify potential issues using Azion's Observe products:

- **[Real-Time Metrics](/en/documentation/products/observe/real-time-metrics/#edge-dns)**: View aggregated charts showing query volumes, response codes, and geographic distribution over time.
- **[GraphQL API](/en/documentation/devtools/graphql-api/features/#datasets)**: Query raw and aggregated DNS data for custom analysis and integration with monitoring tools.

<DocButton href="/en/documentation/products/secure/troubleshoot/edge-dns-understand-metrics/" label="view Edge DNS metrics guide" kind="secondary" size="medium" />
...
3. **Contact Azion Support** through [Azion Support](/en/documentation/services/support/) with the collected information
...
<DocButton href="/en/documentation/services/support/" label="go to Support documentation" kind="secondary" size="medium" />
