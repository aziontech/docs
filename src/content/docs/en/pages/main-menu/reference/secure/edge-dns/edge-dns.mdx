...
| Scope | Source |
|-------|--------|
| Main settings | [How to configure Edge DNS main settings](/en/documentation/guides/application-security/dns/edge-dns-configure-main-settings/) |
| Dig command | [How to look up DNS servers with the dig command](/en/documentation/guides/application-security/dns/run-the-dig-command/) |
| Traceroute command | [How to diagnose performance and delivery issues with the traceroute command](/en/documentation/guides/application-security/dns/run-the-traceroute-command/) |
...
<DocButton href="/en/documentation/platform/firewall/" label="go to test zone guide" kind="secondary" size="medium" /> 

---

## Edge DNS Records

<DocButton href="/en/documentation/guides/application-security/dns/add-records/" label="go to add records guide" kind="secondary" size="medium" />
...
Your domain is now set up and ready to be served by Azion **Edge DNS**. To make sure everything is working well, run some of the tests described in the [test zone guide](/en/documentation/platform/firewall/).
...
<DocButton href="/en/documentation/guides/application-security/dns/load-balance-dns/" label="go to load balance DNS records guide" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/guides/application-security/dns/access-root-domain/" label="go to access addresses through a root domain guide" kind="secondary" size="medium" /> 
...
<DocButton href="/en/documentation/secure/edge-dns/dnssec-compatibility/" label="go to DNSSEC compatibility reference" kind="secondary" size="medium" /> 
...
Before troubleshooting DNS issues, verify the current health of Azion's platform on the [Azion Status Page](https://status.azion.com). This page provides real-time information about service availability and any ongoing incidents affecting Edge DNS or other Azion services.
...
| Tool | Purpose | Guide |
|------|---------|-------|
| **DIG** | Query DNS servers directly, verify record responses | [How to use the DIG command](/en/documentation/guides/application-security/dns/run-the-dig-command/) |
| **HOST** | Convert domain names to IP addresses and vice versa | [Test zone guide](/en/documentation/platform/firewall/) |
| **NSLOOKUP** | Query DNS records for domains and IPs | [Test zone guide](/en/documentation/platform/firewall/) |
| **Traceroute** | Diagnose network path and latency issues | [How to use Traceroute](/en/documentation/guides/application-security/dns/run-the-traceroute-command/) |

### Monitor DNS Queries

Track DNS query patterns and identify potential issues using Azion's Observe products:

- **[Real-Time Metrics](/en/documentation/platform/real-time-metrics/#edge-dns)**: View aggregated charts showing query volumes, response codes, and geographic distribution over time.
- **[GraphQL API](/en/documentation/devtools/graphql/features/#datasets)**: Query raw and aggregated DNS data for custom analysis and integration with monitoring tools.

<DocButton href="/en/documentation/platform/firewall/" label="view Edge DNS metrics guide" kind="secondary" size="medium" />
...
2. **Check the status page** for any ongoing incidents at [status.azion.com](https://status.azion.com)

3. **Contact Azion Support** through [Azion Support](/en/documentation/support/) with the collected information
...
To configure massive redirection for domain migration, access the [Massive Redirect](/en/documentation/guides/application-development/integrations/massive-redirect-integration/) documentation.
...
<DocButton href="/en/documentation/guides/application-security/dns/run-the-dig-command/" label="go to dig command guide" kind="secondary" size="medium" />
...
<DocButton href="https://status.azion.com" label="go to Azion Status Page" kind="secondary" size="medium" />
<DocButton href="/en/documentation/support/" label="go to Support documentation" kind="secondary" size="medium" />
