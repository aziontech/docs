...
<LinkButton outlined link="/en/documentation/products/secure/troubleshoot/test-zone/" label="go to test zone guide" variant="secondary" /> 

## Edge DNS Records

<LinkButton outlined link="/en/documentation/products/guides/secure/add-records/" label="go add records guide" variant="secondary" />
...
<LinkButton outlined link="/en/documentation/products/guides/secure/load-balance-dns/" label="go load balance DNS records guide" variant="secondary" />
...
<LinkButton outlined link="/en/documentation/products/guides/secure/access-root-domain/" label="go to access addresses through a root domain guide" variant="secondary" /> 
...
<LinkButton outlined link="/en/documentation/products/secure/edge-dns/dnssec-compatibility/" label="go to DNSSEC compatibility reference" variant="secondary" />  
