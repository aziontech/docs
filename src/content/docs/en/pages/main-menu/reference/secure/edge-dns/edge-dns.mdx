...
<LinkButton link="/en/documentation/products/guides/secure/load-balance-dns/" label="go to load balance DNS records guide" severity="secondary" />
...
<LinkButton link="/en/documentation/products/secure/troubleshoot/edge-dns-understand-metrics/" label="view Edge DNS metrics guide" severity="secondary" />
