...
The account type configuration is available at Real-Time Manager (RTM), going to the **Account menu**, located in the upper-right corner. Under **Billing & Subscriptions**, then on the **Subscriptions** tab, at the last section, [Service Plans](https://console.azion.com/billing-subscriptions/subscriptions).
...
You can also optimize protection against DDoS attacks at the application layer (layer 7) using the [Web Application Firewall](/en/documentation/products/secure/edge-firewall/web-application-firewall/), an [Edge Firewall](/en/documentation/products/secure/edge-firewall/) module.
...
**DDoS Protection - Unmetered** offers complete visibility of application attacks through [RTM](https://console.azion.com) or [Azion API](https://api.azion.com) to be able to view the attack volume. In conjunction with the **Security Response Team (SRT)**, you'll have access to post-event analysis and investigations.
