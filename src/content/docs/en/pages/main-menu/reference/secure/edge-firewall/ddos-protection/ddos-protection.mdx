...
You can also optimize protection against DDoS attacks at the application layer (layer 7) using the [Web Application Firewall](/en/ddocumentation/products/secure/edge-firewall/web-application-firewall/), an [Edge Firewall](/en/documentation/products/edge-firewall/) module.
