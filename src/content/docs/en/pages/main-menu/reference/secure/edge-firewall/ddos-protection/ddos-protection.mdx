...
The account type configuration is available at Azion Console, going to the **Account menu**, located in the upper-right corner. Under **Billing & Subscriptions**, then on the **Subscriptions** tab, at the last section, [Service Plans](https://console.azion.com/billing-subscriptions/subscriptions).
...
**DDoS Protection - Unmetered** offers complete visibility of application attacks through [Azion Console](https://console.azion.com) or [Azion API](https://api.azion.com) to be able to view the attack volume. In conjunction with the **Security Response Team (SRT)**, you'll have access to post-event analysis and investigations.
