...
Azion's DNS servers get their configuration from the customer's Master server, whether it's inside their infrastructure or in the cloud. If your infrastructure already uses the [DNSSEC](/en/documentation/products/secure/edge-dns/dnssec-compatibility/) extension, you can count on DDoS Protection without giving up the guarantee of integrity and authenticity of your records, thus providing security and availability for address resolution for your business.
