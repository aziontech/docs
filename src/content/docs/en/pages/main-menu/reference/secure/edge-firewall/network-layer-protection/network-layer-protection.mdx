...
When activating the **Network Shield** module in the *Main Settings* of an **Firewall Rule Set**, the conditions (*criteria*) and commands (*behavior*) will be enabled in the **Rules Engine** tab of the firewall.
