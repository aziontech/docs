...
:::tip
Learn more about [Edge Firewall](/en/documentation/products/edge-firewall/) configurations and [Edge Firewall Rule Sets](/en/documentation/products/secure/edge-firewall/rules-engine/).
:::
