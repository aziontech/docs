...
| Scope | Source |
|-------|--------|
| Network Layer Protection | [How to create IP, ASN, and geolocation block/allow lists with Network Lists](/en/documentation/products/guides/blocklists-ip-addresses-edge/) |
...
:::tip
Learn more about [Edge Firewall](/en/documentation/products/secure/edge-firewall/) configurations and [Edge Firewall Rule Sets](/en/documentation/products/secure/edge-firewall/rules-engine/).
:::
...
<Button href="/en/documentation/products/secure/edge-firewall/network-layer-protection/network-lists/" text="go to Network Lists reference" variant="secondary"></Button>
