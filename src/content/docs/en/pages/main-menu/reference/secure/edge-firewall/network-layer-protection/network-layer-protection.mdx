...
permalink: /documentation/secure/network-shield/
---
...
| Scope | Source |
|-------|--------|
| Create network list | [How to create IP, ASN, and geolocation block/allow lists with Network Lists](/en/documentation/guides/application-security/bots-and-network/blocklists-ip-addresses-edge/) |
| Block Tor addresses | [How to block Tor exit node IP addresses](/en/documentation/guides/application-security/bots-and-network/block-tor-networks/) |
...
:::tip
Learn more about [Firewall](/en/documentation/platform/firewall/) configurations and [Rules Engine for Firewall](/en/documentation/platform/firewall/rules-engine/).
:::
...
Network Shield configuration is done in the **Firewall Rules Engine** tab. There, you can use the `Network` criteria, to create rules with [Network Lists](/en/documentation/secure/network-shield/network-lists/), based on the network, user location, or ASN, or use ready-to-use lists that are kept up-to-date by Azion itself. You can also monitor and block suspicious behavior, or even apply restrictions according to the chosen behavior.
...
:::note
The conditions and behaviors available in the Firewall Rules Engine tab depend on the activated modules. Learn more about [Firewall modules](/en/documentation/platform/firewall/).
:::
