...
Origin Shield contains exclusively the IPs/CIDRs that Azion uses to connect to customer origins or product endpoints such as Datastream. The downstream IPs customers use to connect to Azion *aren't added*.
