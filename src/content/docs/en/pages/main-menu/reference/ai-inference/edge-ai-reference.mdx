...
<Button href="/en/documentation/products/ai/ai-inference/models/" label="See Available Models" type="primary" theme="light" />
...
<Button href="/en/documentation/architectures/artificial-intelligence/ai-agent-copilot-assistant/" label="Go to Copilot Assistant architecture" type="primary" theme="light" />
<Button href="/en/documentation/products/guides/langgraph-ai-agent-boilerplate/" label="Go to the LangGraph AI Agent template guide" type="primary" theme="light" />
