...
<ItemList>
  ...
  <DocItem title="AI Inference architecture" href="/en/documentation/guides/ai/inference/ai-inference-architecture/">The deployed shape around a model call, where your application is the inference endpoint.</DocItem>
