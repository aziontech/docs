...
At Azion, edge functions are code blocks in JavaScript that run on the edge network on top of the [Edge Runtime](/en/documentation/devtools/runtime/overview/).
