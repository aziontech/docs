...
The *common name* type record of a domain registered in the DNS. By using [Intelligent DNS](/en/documentation/products/secure/intelligent-dns/), you can create and manage CNAME records without using a DNS provider.
...
An entry created by a person or organization that associates a domain name with a specific value. DNS records can have [multiple types](/en/documentation/products/secure/intelligent-dns/#type).
...
A specialized entity within the DNS that is responsible for storing and managing DNS records. A nameserver is usually managed by a DNS provider but you can redirect nameserver authority to Azion using [Intelligent DNS](/en/documentation/products/secure/intelligent-dns/).
