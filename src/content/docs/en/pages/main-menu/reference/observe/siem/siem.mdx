...
**Azion SIEM** allows the visualization of aggregated and raw data through data from [Real-Time Metrics](/en/documentation/products/real-time-metrics/) and [Real-Time Events](/en/documentation/products/real-time-events/).

## Dashboards

Each dashboard has a set of graphs that allows for a more in-depth analysis of specific metrics and metric categories. The available dashboards are detailed below.
