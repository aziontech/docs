...
Before beginning to use **Real-Time Metrics**, make sure you have a [Real-Time Manager (RTM)](https://console.azion.com/) account. You can find more information on creating one on the [documentation page](/en/documentation/products/accounts/creating-account/).
