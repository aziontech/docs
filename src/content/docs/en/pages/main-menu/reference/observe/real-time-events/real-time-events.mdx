...
- [Data Streaming](/en/documentation/products/observe/data-streaming/)
- [Edge Applications](/en/documentation/products/build/edge-application/)
- [Edge Functions](/en/documentation/products/build/edge-application/edge-functions/)
- [Edge Pulse](/en/documentation/products/observe/edge-pulse/)
- [WAF Events](/en/documentation/products/secure/edge-firewall/web-application-firewall/)
...
Displays the event records from requests made to your [edge applications](/en/documentation/products/build/edge-application/).
...
| $upstream_addr | Client's IP address and port. Can also store multiple servers or server groups. Example: `192.168.1.1:80`. When the response is `127.0.0.1:1666`, the upstream is [Azion Cells Runtime](/en/documentation/devtools/runtime/overview/). |
...
| $waf_attack_family | Informs the attack’s families, which are categories of attack identified by WAF and classified according to the OWASP Top 10. Example: `$XSS`. [See the categories](/en/documentation/products/secure/edge-firewall/web-application-firewall/#main-settings). |
...
| $function_id | Unique Azion function identifier number. Can be found on Azion Console's function URL path or [via API request](https://api.azion.com/#a6fce388-702e-4eca-ad54-791946b34501). Example: `1111` |
...
:::note
To query an edge function logs', see the [Debbuging documentation](/en/documentation/devtools/debugging/).
:::
...
Displays the event records from requests made to your [edge pulse](/en/documentation/products/observe/edge-pulse/) using the performance data measured from the user's browser.
...
| Variable | Description |
| -------- | ----------- |
| $attack_family | Informs the attack's families, which are categories of attack identified by WAF and classified according to the OWASP Top 10. Example: `$XSS`. [See the categories](/en/documentation/products/secure/edge-firewall/web-application-firewall/#waf-main-settings) |
