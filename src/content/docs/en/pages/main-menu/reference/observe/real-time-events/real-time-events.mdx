...
| qtype | Definition of the [type of record](/en/documentation/products/secure/intelligent-dns/#types-of-supported-entries-and-the-respective-recommendations-of-intelligent-dns) that'll be used. Example: `PTR`, `A`, `AAAA`, `HTTPS`, `NS`, `SRV` |
