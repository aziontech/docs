...
| Variable | Description |
| -------- | ----------- |
| $attack_family | Informs the attack's families, which are categories of attack identified by WAF and classified according to the OWASP Top 10. Example: `$XSS`. [See the categories](/en/documentation/products/secure/edge-firewall/web-application-firewall/#main-settings) |
