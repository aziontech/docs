...
To monitor the page, you need to insert the **Edge Pulse JavaScript tag** on it. It's available on the **Edge Pulse** page [on RTM](https://console.azion.com/) through the **Copy to Clipboard** button.
