...
| Scope | Source |
| ----- | ------ |
| First steps | [Edge Pulse first steps](/en/documentation/products/observe/edge-pulse/first-steps/) |
...
<Button href="/en/documentation/products/observe/real-time-events/" label="explore via Real-Time Events" type="primary" theme="light" />
