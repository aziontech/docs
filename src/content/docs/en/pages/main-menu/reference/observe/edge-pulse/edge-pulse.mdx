...
title: Edge Pulse
description: >-
  Discover how to get detailed insights into your customers' experience and
  improve your content delivery with Edge Pulse.
namespace: documentation_products_edge_pulse
permalink: /documentation/observe/edge-pulse/
---

import DocButton from '~/components/webkit/DocButton.vue';

**Edge Pulse** is an [Observe](/en/documentation/) product based on the market-leading *Real User Monitoring (RUM)* solution. With it, you can, in real time:
...
| Scope | Source |
| ----- | ------ |
| First steps | [Edge Pulse first steps](/en/documentation/observe/edge-pulse/first-steps/) |
...
<DocButton href="/en/documentation/observe/real-time-events/" label="explore via Real-Time Events" size="medium" />

---

## Edge Pulse JavaScript tag 

To monitor the page, you need to insert the **Edge Pulse JavaScript tag** on it. It's available on the **Edge Pulse** page [on Azion Console](https://console.azion.com) through the **Copy to Clipboard** button.
