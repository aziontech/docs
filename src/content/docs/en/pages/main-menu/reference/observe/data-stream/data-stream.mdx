...
- **Encoded API Key**: the `Base64` key corresponding to the `"encoded"` value generated during the creation of the API key in ElasticSearch. Example: `VnVhQ2ZHY0JDZGJrUW0tZTVhT3g6dWkybHAyYXhUTm1zeWFrdzl0dk5udw==`
