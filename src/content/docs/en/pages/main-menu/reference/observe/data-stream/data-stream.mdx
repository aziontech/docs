---
title: Data Stream
description: Data Stream is an Observe product that allows you to feed your SIEM, big data, and stream processing platforms with access to your content and applications data in real time, adding even more intelligence to your business.
...
By creating a Data Stream, you can:

- Have an organized set of logs.
- Connect your Data Streams to endpoints.
...
See the [Data Stream first steps](/en/documentation/products/observe/data-stream/first-steps/).

## Implementation

| Task | Guide |
| ---- | ----- |
| Configure Data Stream | [How to use Data Stream](/en/documentation/products/guides/use-data-stream/) |
...
| $upstream_addr | Client IP address and port. Can also store multiple servers or server groups. Example: 192.168.1.1:80. When the response is `127.0.0.1:1666`, the upstream is Azion [Cells Runtime](/en/documentation/devtools/runtime/overview/). |
...
<LinkButton outlined link="/en/documentation/products/guides/data-stream-custom-template/" label="How to create a custom template on Data Stream" />
...
<LinkButton outlined link="/en/documentation/products/guides/data-stream-associate-domains/" label="How to associate domains on Data Stream" />
...
<LinkButton outlined link="/en/documentation/products/guides/endpoint-amazon-kinesis/" label="How to use Amazon Kinesis Data Firehose to receive data" />
...
<LinkButton outlined link="/en/documentation/products/guides/endpoint-azure-blob/" label="How to use Azure Blob Storage to receive data" />
...
<LinkButton outlined link="/en/documentation/products/guides/endpoint-azure-monitor/" label="How to use Azure Monitor to receive data" />
...
<LinkButton outlined link="/en/documentation/products/guides/endpoint-datadog/" label="How to use Datadog to receive data" />
...
<LinkButton outlined link="/en/documentation/products/guides/endpoint-elasticsearch/" label="How to use Elasticsearch to receive data" />
...
<LinkButton outlined link="/en/documentation/products/guides/endpoint-google-bigquery/" label="How to use Google BigQuery to receive data" />
...
<LinkButton outlined link="/en/documentation/products/guides/endpoint-amazon-s3/" label="How to use Amazon S3 to receive data" />
...
<LinkButton outlined link="/en/documentation/products/guides/endpoint-splunk/" label="How to use Splunk to receive data" />
...
<AuthorList filePath="src/content/docs/en/pages/main-menu/reference/observe/data-stream/data-stream.mdx"/>
