...
- [Create a new data stream](/en/documentation/products/guides/use-data-stream/) by clicking the **+ Stream** button.
...
- View detailed information about each stream to ensure everything is running smoothly.
- [Delete or stop data streams](/en/documentation/products/guides/delete-data-stream/) that are no longer needed to optimize your system.
