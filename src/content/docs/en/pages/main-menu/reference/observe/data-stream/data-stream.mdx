...
Once you activate a Data Stream, there's a propagation time until the logs become available for consultation in tools or products such as **Real-Time Events**.
...
<Button href="/en/documentation/products/guides/data-stream-associate-domains/" text="How to associate domains on Data Stream"></Button>

In case you select the **All Domains** option, you can also set the percentage of data you want to receive randomly from your Data Stream through the *Sampling* option. In addition to filtering by sampling, it can also reduce costs of data collection and analysis.
...
When the Sampling option is enabled, you're allowed to add only *one* Data Stream on your account. Once this Data Stream is disabled, the **Add Streaming** option will be enabled again on the Data Stream screen on Azion Console.
