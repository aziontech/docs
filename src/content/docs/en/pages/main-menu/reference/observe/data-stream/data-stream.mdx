...
<Button href="/en/documentation/products/guides/data-stream-custom-template/" label="How to create a custom template on Data Stream" type="primary" theme="light" />
...
<Button href="/en/documentation/products/guides/data-stream-associate-domains/" label="How to associate domains on Data Stream" type="primary" theme="light" />
...
<Button href="/en/documentation/products/guides/endpoint-amazon-kinesis/" label="How to use Amazon Kinesis Data Firehose to receive data" type="primary" theme="light" />
...
<Button href="/en/documentation/products/guides/endpoint-azure-blob/" label="How to use Azure Blob Storage to receive data" type="primary" theme="light" />
...
<Button href="/en/documentation/products/guides/endpoint-azure-monitor/" label="How to use Azure Monitor to receive data" type="primary" theme="light" />
...
<Button href="/en/documentation/products/guides/endpoint-datadog/" label="How to use Datadog to receive data" type="primary" theme="light" />
...
<Button href="/en/documentation/products/guides/endpoint-elasticsearch/" label="How to use Elasticsearch to receive data" type="primary" theme="light" />
...
<Button href="/en/documentation/products/guides/endpoint-google-bigquery/" label="How to use Google BigQuery to receive data" type="primary" theme="light" />
...
<Button href="/en/documentation/products/guides/endpoint-amazon-s3/" label="How to use Amazon S3 to receive data" type="primary" theme="light" />
<Button href="/en/documentation/products/guides/connector-azion-edge-storage/" label="How to use Azion Object Storage to receive data" type="primary" theme="light" />
...
<Button href="/en/documentation/products/guides/endpoint-splunk/" label="How to use Splunk to receive data" type="primary" theme="light" />
