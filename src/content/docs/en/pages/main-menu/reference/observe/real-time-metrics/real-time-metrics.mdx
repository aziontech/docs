...
After selecting one of the category tabs and the product tab, you'll see the available charts for that specific product according to the data on your account. If you select Data Stream, for example, you'll see charts related to the Data Streams configured in your account.
...
import TotalQueries from "~/includes/docs_help_center/en/real-time-metrics/edge-dns/standard-queries/total-queries/index.md"
...
The Data Stream tab displays metrics related to the data and requests of the [Data Streams](/en/documentation/products/observe/data-stream/) configured in your account.

Find out more about each chart:

import TotalDataStreamed from "~/includes/docs_help_center/en/real-time-metrics/data-stream/requests/total-data-streamed/index.md"

import TotalRequestsDts from "~/includes/docs_help_center/en/real-time-metrics/data-stream/requests/total-requests/index.md"
