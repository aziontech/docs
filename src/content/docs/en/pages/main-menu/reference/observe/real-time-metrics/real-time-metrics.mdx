...
The Total Queries graph shows you the total amount of queries received by your DNS configured on [Edge DNS](https://www.azion.com/en/documentation/products/secure/edge-dns/).
