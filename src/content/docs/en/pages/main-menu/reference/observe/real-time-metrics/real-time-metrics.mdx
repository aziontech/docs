...
<LinkButton outlined link="/en/documentation/products/observe/historical-real-time-metrics/" label="Use the Historical Real-Time Metrics" />
...
<LinkButton outlined link="/en/documentation/products/guides/use-real-time-metrics/" label="How to use Real-Time Metrics" />
...
<LinkButton outlined link="/en/documentation/products/guides/observe/add-filters-metrics/" label="go to add filters guide" />
