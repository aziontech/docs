...
- **Context menu**: extra options of actions related to the chart.
  ...
  - **Show Mean Line**: to exhibit or stop exhibiting the average value of the chart. Each point of the chart is summed and divided by the total number of points, generating a mean for the data shown on that specific chart and time period.
...
import AverageRequestTime from "~/includes/docs_help_center/en/real-time-metrics/edge-applications/requests/average-request-time/index.md"

import RequestsByScheme from "~/includes/docs_help_center/en/real-time-metrics/edge-applications/requests/requests-by-scheme/index.md"
...
import RequestsByStatusAndUpstreamStatus from "~/includes/docs_help_center/en/real-time-metrics/edge-applications/status-codes/requests-by-status-and-upstream-status/index.md"

<HttpStatusCodes2xx />
<HttpStatusCodes3xx />
<HttpStatusCodes4xx />
<HttpStatusCodes5xx />
<RequestsByStatusAndUpstreamStatus />
...
import IPAddressInformation from "~/includes/docs_help_center/en/real-time-metrics/edge-applications/requests-breakdown/ip-address-information/index.md"
...
import TopWAFThreatRequestsByCountryPieGraph from "~/includes/docs_help_center/en/real-time-metrics/waf/threats/top-waf-threat-requests-by-country-pie-graph/index.md"

import TopWAFThreatRequestsByCountryBarGraph from "~/includes/docs_help_center/en/real-time-metrics/waf/threats/top-waf-threat-requests-by-country-bar-graph/index.md"

import WAFThreatRequestsByFamilyAttack from "~/includes/docs_help_center/en/real-time-metrics/waf/threats/waf-threat-requests-by-family-attack/index.md"

import WAFThreatRequestsByHost from "~/includes/docs_help_center/en/real-time-metrics/waf/threats/waf-threat-requests-by-host/index.md"
...
<SqlInjectionThreats />
<OtherThreats />
<TopWAFThreatRequestsByCountryPieGraph />
<TopWAFThreatRequestsByCountryBarGraph />
<WAFThreatRequestsByFamilyAttack />
<WAFThreatRequestsByHost />
...
import TopBotTraffic from "~/includes/docs_help_center/en/real-time-metrics/bot-manager-advanced/overview/top-bot-traffic/index.md"
...
import TopWAFThreatRequestsByIp from "~/includes/docs_help_center/en/real-time-metrics/threats/breakdown/top-waf-threat-requests-by-ip/index.md"

<TopWAFThreatRequestsByIp />
