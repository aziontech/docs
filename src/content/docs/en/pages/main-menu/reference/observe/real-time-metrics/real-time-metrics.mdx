...
- **Region**: the geographic location where the requests are originating.
...
- **Legitimate**: the request wasn't identified as an attack and there's enough data to ensure it isn't an attack, being considered legitimate legitimate human users.
- **Bad Bot**: the request reached the score threshold or it was identified as an attack.
