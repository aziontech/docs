...
**Real-Time Metrics** allows you to filter your analysis with the specific fields and values you want to receive. You can add a single or multiple filters depending on the analysis you want to conduct.

<Button href="/en/documentation/products/guides/observe/add-filters-metrics/" text="go to add filters guide"></Button>
