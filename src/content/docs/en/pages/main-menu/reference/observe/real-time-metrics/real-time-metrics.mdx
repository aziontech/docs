...
<Button href="/en/documentation/products/observe/historical-real-time-metrics/" label="Use the Historical Real-Time Metrics" type="primary" theme="light" />
...
<Button href="/en/documentation/products/guides/use-real-time-metrics/" label="How to use Real-Time Metrics" type="primary" theme="light" />
...
<Button href="/en/documentation/products/guides/observe/add-filters-metrics/" label="Go to add filters guide" type="primary" theme="light" />
