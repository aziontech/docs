...
The L2 Caching tab displays metrics related to the data of your applications using [L2 Caching](/en/documentation/products/edge-application/l2-caching/) configured in your account.
