...
Real-Time Metrics fetches your data and metrics using [Azion GraphQL API](/en/documentation/products/graphql-api/) and generates charts based on its response. The maximum time for data aggregation to occur is 10 minutes.
