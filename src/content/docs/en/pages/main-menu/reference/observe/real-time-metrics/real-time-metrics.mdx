...
The Bot Manager Advanced tab displays metrics related to Bot Manager Advanced activity.

:::note
To visualize these graphs, you must be subscribed to Azion Bot Managar Advanced. Contact the [Sales team](https://www.azion.com/en/contact-sales/) for more details on the subscription.
:::
...
The Top Bot Action graph shows the actions performed by Azion Bot Manager Advanced for accesses identified as bots.
...
- Red: more than 100,000 requests.
- Orange: more than 10,000 requests.
- Yellow: more than 1,000 requests.
- Green: fewer than 1,000 requests.
