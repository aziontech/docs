...
![Edge Cache graph information flow for Edge Application In, representing data being transferred from the end user to the edges and from the edges to the client’s origin.](/assets/docs/images/uploads/edge-applications-in.png)

**Edge Application Out** flow:

![Edge Cache graph information flow for Edge Application Out, representing data being transferred from the client’s origin to the edges and from the edges to the end user.](/assets/docs/images/uploads/edge-applications-out.png)
...
If you have [L2 Caching](/en/documentation/products/build/edge-application/edge-caching/#l2-caching) enabled, your Edge Cache graph will exhibit:

- **Edge Applications In**: data transferred from the end user to the edges, and from the edges to L2 cache.

![Edge Cache with L2 enabled graph information flow for Edge Application In, representing data being transferred from the end user to the edges and from the edges to the L2 cache.](/assets/docs/images/uploads/l2-enabled-edge-applications-in.png)

- **Edge Applications Out**: data transferred from L2 cache to the edges, and from the edges to the end user.

![Edge Cache with L2 enabled graph information flow for Edge Application Out, representing data being transferred from the L2 cache to the edges and from the edges to the end user.](/assets/docs/images/uploads/l2-enabled-edge-applications-out.png)

- **Edge Applications**: all data that was transferred in the process; value of Edge Applications In + Edge Applications Out.

![Edge Cache with L2 enabled graph information flow for Edge Applications, representing all data being transferred from both Edge Applications In and Edge Applications Out.](/assets/docs/images/uploads/l2-enabled-edge-applications.png)
