...
| Feature | Limit |
| ------- | ----- |
| Data Streaming | 60 seconds or packages of 2,000 requests, whichever happens first. For the **AWS Kinesis Data Firehose** endpoint: 60 seconds or packages of 500 requests |
