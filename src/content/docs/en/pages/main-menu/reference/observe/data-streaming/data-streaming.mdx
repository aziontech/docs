...
| Feature | Limit |
| ------- | ----- |
| Data Streaming | 60 seconds or packages of 2,000 requests, whichever happens first.<br /><br />For the **AWS Kinesis Data Firehose** endpoint: 60 seconds or packages of 500 requests |
| Sampling | 1 active stream |
| Time for data transfer to client's infrastructure | Lower than 3 minutes |
