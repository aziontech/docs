...
For example, if a package reaches 2,000 records in 13 seconds, it'll be sent. If another package only has 700 records, but 60 seconds pass, it'll also be sent.
