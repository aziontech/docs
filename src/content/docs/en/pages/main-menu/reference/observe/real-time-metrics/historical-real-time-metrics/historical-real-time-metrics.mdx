...
[Data Streaming](/en/documentation/products/observe/data-streaming/), [Edge Functions](/en/documentation/products/build/edge-application/edge-functions/), [Intelligent DNS](/en/documentation/products/secure/intelligent-dns/), and [Image Processor](/en/documentation/products/build/edge-application/image-processor/) are paid products. To view their metrics, you must subscribe to the products and activate them in your account.
