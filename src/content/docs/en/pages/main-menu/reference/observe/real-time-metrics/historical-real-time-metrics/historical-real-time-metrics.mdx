...
After selecting one of the product's tabs, you'll see the available graphs for that specific product according to the data on your account. If you select Data Stream, for example, you'll see graphs related to the Data Streams configured in your account.
