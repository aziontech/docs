...
permalink: /documentation/products/observe/historical-real-time-metrics/
---
...
You can already use the [New Real-Time Metrics](/en/documentation/products/observe/real-time-metrics/) and will be able to continue using it.
...
[Data Stream](/en/documentation/products/observe/data-stream/), [Edge Functions](/en/documentation/products/build/edge-application/edge-functions/), [Edge DNS](/en/documentation/products/secure/edge-dns/), and [Image Processor](/en/documentation/products/build/edge-application/image-processor/) are paid products. To view their metrics, you must subscribe to the products and activate them in your account.
...
![Historical Real-Time Metrics graph properties location on Azion Console's screen.](https://www.azion.com/static/images/uploads/doc/graph-historical-real-time-metrics.png)
...
You can find detailed information about each tab and subtabs and about each of the graphs available on the [New Real-Time Metrics documentation](/en/documentation/products/observe/real-time-metrics/).
