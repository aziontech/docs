...
description: >-
  At Azion, you're served by a team of engineers who are specialized in
  performance, security, high availability, and scalability.
...
The **Developer Support** service offers unlimited access to documentation, guides, whitepapers, bug reports, and the [Azion Community on Discord](https://discord.com/invite/Yp9N7RMVZy). Customers with the **Business Support** service have access to technical support 24×7 via ticket and email. The **Enterprise** and **Mission-Critical Support** services have support access 24×7 via ticket, email, and phone, and 8×5 access to R&D Engineers through ticket and phone.

### Contact options

| Channel | Availability | Support Services |
| :--- | :--- | :--- |
| [Support portal](https://tickets.azion.com/en/support/login) | 24×7 | Business, Enterprise, Mission-Critical |
| [Email](mailto:support@azion.com) | 24×7 | Business, Enterprise, Mission-Critical |
| Phone (English): [+1 (833) 33-AZION](tel:18333329466) | 24×7 | Enterprise, Mission-Critical |
| Phone (Portuguese): [0800 883 6313](tel:08008836313) | 24×7 | Enterprise, Mission-Critical |
| Phone (Spanish): [+52 800 872 0565](tel:528008720565) | 24×7 | Enterprise, Mission-Critical |
| R&D Engineers (ticket & phone) | 8×5 | Enterprise, Mission-Critical |
...
| Support Service | Technical Support Channels |
| :--- | :--- |
...
The response time depends on the type of support service contracted and the severity of the support request. The time elapsed between the opening of the ticket and the start of actions taken by Azion is counted.

## Tickets

:::tip
If you want to open a ticket, see the guide on [How to open a Support Ticket](/en/documentation/guides/platform/account-and-billing/open-tickets/).
:::
...
| Type | Purpose |
| :--- | :--- |
| **Incident** | Report an incident, such as system failures or errors that require immediate attention. |
| **Request** | Make a specific request, such as integrations, solutions, or new features. |
| **Question** | Clarify questions or concerns regarding Azion's platform. |
...
<Tabs client:visible>
  <Fragment slot="tab.incident">Incident</Fragment>
  <Fragment slot="tab.request">Request</Fragment>
  <Fragment slot="tab.question">Question</Fragment>

  <Fragment slot="panel.incident">
  ...
  | **CNAMEs already in use** | You have encountered the error *CNAMEs already in use* when listing a CNAME in one of your [Azion domains](/en/documentation/platform/workloads/domains/). |
  ...
  | **Template (Preview)** | You need a new [Template](/en/documentation/marketplace/templates/) to be added to the Azion Marketplace. |

  </Fragment>

  <Fragment slot="panel.question">
  ...
  | **Rules Engine** | You have questions about how to set up a behavior using [Rules Engine for Applications](/en/documentation/platform/applications/rules-engine/) or [Rules Engine for Firewall](/en/documentation/platform/firewall/rules-engine/). |

  </Fragment>
</Tabs>

## Severity of cases and response times according to support services

| Support Services | General guidance | System impaired | Production system impaired | Production system down | Business-critical system down |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Developer** | N/A | N/A | N/A | N/A | N/A |
| **Business** | `<24 hours` (business hours) | `<12 hours` | `<4 hours` | `<2 hours` | N/A |
