...
- **Question**: to clarify questions or concerns regarding the Azion Platform.
...
| Severity | Definition |
| --------------- | ---------- |
| General Guidance | You have a general request for the Azion Platform. |
| New Feature | You want to request a feature. |
| Solutions Labs | You want to request the assistance of a specialist. |
...
| Integration Services | You want to request [Integration Services](/en/documentation/services/solutions-lab/integration-services/) to migrate your content to Azion. |
