...
The **Developer Support** plan offers unlimited access to documentation, guides, whitepapers, bug reports, and the [Azion Community on Discord](https://discord.com/invite/Yp9N7RMVZy). Customers with the **Business Support** plan have access to technical support 24×7 via ticket and email. The **Enterprise** and **Mission-Critical Support** plans have support access 24×7 via ticket, email, and phone, and 8×5 access to R&D Engineers through ticket and phone.
...
| Severity | Business | Enterprise | Mission-Critical |
| :--- | :--- | :--- | :--- |
| General guidance | `<24 hours` (business hours) | `<24 hours` (business hours) | `<12 hours` (business hours) |
| System impaired | `<12 hours` | `<12 hours` | `<12 hours` |
| Production system impaired | `<4 hours` | `<4 hours` | `<2 hours` |
| Production system down | `<2 hours` | `<1 hour` | `<30 minutes` |
| Business-critical system down | N/A | `<15 minutes` | `<15 minutes` |
