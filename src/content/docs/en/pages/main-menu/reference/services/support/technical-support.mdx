...
| CNAMEs already in use | You have encountered the error *CNAMEs already in use* when listing a CNAME in one of your [Azion workloads](/en/documentation/products/secure/workloads/). |
