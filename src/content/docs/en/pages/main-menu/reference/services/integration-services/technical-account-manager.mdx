...
description: >-
  The TAM acts as a consultant, proactively providing strategic technical
  guidance to help accelerate the digital transformation and edge computing
  journey, and provide insights to maximize infrastructure investment
...
They also help with the use, performance, and security of the applications executed and delivered by Azion, minimizing the risks involved during deployment and updates of settings and applications. All of this comes with the support of an Azion Specialist for your IT and business teams, aimed at improving the development, security, delivery, performance, reliability, observability, and cost optimization of your applications running on Azion, while keeping them operationally healthy.

Customers with **Mission-Critical** Support service already have a package of up to *20 hours per month partial TAM* included. It's possible for **Enterprise** and **Mission-Critical** Support to buy additional packages, providing more TAM hours, with a minimum commitment of 12 months. Hiring a **Dedicated TAM** is also available as a separate package.
