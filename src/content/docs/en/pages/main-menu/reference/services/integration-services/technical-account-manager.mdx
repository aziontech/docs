...
Customers with **Mission Critical** plan already have a package of up to *20 hours per month partial TAM* included. It's possible for **Enterprise** and **Mission Critical** plans to buy additional packages, providing more TAM hours, with a minimum commitment of 12 months. Hiring a **Dedicated TAM** is also available as a separate package.
