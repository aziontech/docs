...
description: By acquiring this service, a team of experienced engineers can perform certain day-to-day tasks on your behalf, such as configuring, monitoring, and maintaining the configurations for you.
...
The **Managed Configurations** service provides management and control over your Azion edge infrastructure configurations. This service employs the expertise of a team of experienced engineers to tackle certain day-to-day tasks on your behalf, such as configuring, monitoring, and maintaining the configurations.

The Managed Configuration service is operated by the Azion's Solutions Architects team, which will be responsible for implementing configuration changes requested by the Azion customer. To request the Managed Configuration service for applications running on Azion, [open a Support Ticket](https://tickets.azion.com/). 

:::note
This add-on is available for the **Enterprise** and **Mission Critical** Service Plans. This service has a monthly package with a fixed pricing, limited by configuration request. Each request for this service accounts for one configuration change. See [Pricing](https://www.azion.com/en/pricing/) for more information on how this service incurs charges.
:::
