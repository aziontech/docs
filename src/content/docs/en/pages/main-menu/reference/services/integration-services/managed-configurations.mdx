...
The **Managed Configurations** service provides management and control over your Azion edge infrastructure configurations. By acquiring this service, a team of experienced engineers can perform certain day-to-day tasks on your behalf, such as configuring, monitoring, and maintaining the configurations.

The Managed Configuration service is operated by Azion's Solutions Architects team, which will be responsible for implementing configuration changes requested by the Azion customer. To request the Managed Configuration service for applications running on Azion, [open a Support Ticket](https://tickets.azion.com/). 

:::note
This add-on is available for the **Enterprise** and **Mission Critical** Service Plans. This service has a monthly package with a fixed pricing, limited by configuration request. Each service request yields one configuration change. See [Pricing](https://www.azion.com/en/pricing/) for more information on how this service incurs charges.
:::

## Scope

The table below outlines the products and capabilities included, as well as the major configurations under the scope of **Managed Configurations**.
