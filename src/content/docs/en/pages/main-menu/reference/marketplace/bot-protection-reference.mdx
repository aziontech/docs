...
<LinkButton outlined link="/en/documentation/products/guides/bot-manager/" label="go to how to install Bot Manager guide" variant="secondary" /> 
---
...
<LinkButton outlined link="/en/documentation/products/secure/edge-firewall/network-layer-protection/network-lists/" label="go to network lists reference" variant="secondary" /> 
...
<LinkButton outlined link="/en/documentation/products/observe/data-stream/" label="go to Data Stream reference" variant="secondary" /> 
<br />
