...
The requests will generate logs that can be seen in **Real-Time Events** and **Data Streaming**. By analyzing the logs generated by Bot Manager, you can get insights to understand if any changes in the function instance's JSON Args are needed.
