...
<LinkButton link="/en/documentation/products/guides/bot-manager/" label="go to how to install Bot Manager guide" outlined /> 
...
<LinkButton link="/en/documentation/products/secure/edge-firewall/network-layer-protection/network-lists/" label="go to network lists reference" outlined /> 
...
<LinkButton link="/en/documentation/products/observe/data-stream/" label="go to Data Stream reference" outlined /> 
