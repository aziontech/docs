...
By accessing [Real-Time Manager (RTM)](https://console.azion.com/), you find the ideal option to attend to your needs. You can select it, complete the setup, and deploy it.
