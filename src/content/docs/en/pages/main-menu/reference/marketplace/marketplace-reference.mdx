...
In Azion Marketplace, you'll find integrations that run edge functions in two ways: by using [Edge Firewall](/en/documentation/products/secure/edge-firewall/) or by using [Application](/en/documentation/products/build/edge-application/). The Edge Firewall functions are focused on network security, authentication, and traffic control, while Application functions are best fit to process data or run services on the edge, closer to the user.
