...
description: Azion Marketplace is a digital catalog that makes it easy to find, test, and deploy edge-running software closer to the end user.
...
| [Azion Marketplace’s permissions](/en/documentation/products/guides/permissions-marketplace/) | Reference to learn about required permissions for some templates and integrations. |
