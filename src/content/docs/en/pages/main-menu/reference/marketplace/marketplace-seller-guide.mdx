...
description: Azion Marketplace is a curated digital catalog that offers ready-to-use edge-running software, accelerating the development workflow.
...
-   Easy launch process through Azion's platform.
...
- **Seller**: the customer is a provider of ready-to-use software and uses Marketplace as a distribution channel. A seller can be an Independent Software Vendor (ISV), individual software developer, or open-source community that has a product to offer that works with Azion products and services.
...
Every software product available on the **Azion Marketplace** has been through a curation process before being published. To start this process, you need first to become a Marketplace ISV and register the product. Then, the application will be analyzed by the Azion team.
...
If you want to turn into a Seller, the first step is to fill in the [ISV application form](https://docs.google.com/forms/d/e/1FAIpQLScrOc_FyjVC11VFbVgDjuh6THh2jJs0-I8vduW0nZSCDGEPIg/viewform), provide key information about your organization, and accept the conditions on the
[Marketplace Agreement](https://azion.com/en/documentation/agreements/marketplace/marketplace-agreement/). Additionally, you must also fill in the [product registration
form](https://docs.google.com/forms/d/e/1FAIpQLSeoTbF2Qifr7qqHjoaxv9ujFB1Ak4xg6wqV0WfZfpBrpkQ12A/viewform) and provide key details about the product intended to be published through Azion Marketplace.
...
:::note
Azion may require you to provide additional information to verify your identity, including legal, financial, business, tax, or personal information. Azion may make, directly or through third parties, any inquiries considered necessary to validate the information that you provide, including checking commercial databases.
:::

<Button href="/en/documentation/products/marketplace/isv-signup/" text="go to Become an ISV guide" variant="secondary"> 

</Button>

### Types of products to be registered

The products can take different forms to be offered in the Azion Marketplace, including [Software as a Service (SaaS)](#saas-based-products) or [Azion Edge Platform-based](#azion-edge-platform-based-product) products. For example:
...
:::note
Azion will charge buyers for the Azion services costs generated by the usage, whether in the free or BYOL model. In case of charges defined by the seller in a BYOL product, it becomes part of the buyer’s bill and, after payment, Azion Marketplace pays the seller.
:::

Azion requires that all BYOL products also have a [paid option](#pricing). This is so that users who don’t have existing licenses have the option to purchase and use the products.

In this matter, for the first *90 days* after launch, Azion will relax the requirement that this software is accompanied by a version available for purchase on the Azion Marketplace. During this time, Azion Marketplace
account management teams will work with you to address challenges and to determine if and how the software can be made available for purchase on Azion Marketplace.
...
product to their Azion Edge Libraries to manage how the product is accessed and used in the buyers’s organization.

<Button href="https://www.azion.com/en/pricing/" text="go to Pricing page" variant="secondary"> 

</Button>

### Pricing

When you submit a product to Azion Marketplace, you define the price of the product and the terms and conditions of use. When a buyer subscribes to a product offering, they agree to the pricing and terms and
conditions set for it.
...
The Azion Marketplace Metering Service requires that your software report usage every hour, recording the buyer usage for the hour. If there's a failure in the transmission or receipt of metering service records, Azion will be unable to bill for such usage. You're responsible for ensuring the successful receipt of metering records. You can use any
metering records that suit your SaaS business model, regarding that you've established the price list for it and your SaaS reports the usage correctly.
...
-   In month 11, the customer increases their usage and is billed $21,000, so the Listing Fee drops to 11% (Tier 2, Monthly rate). In month 13, the customer has maintained their usage and is billed $21000, but because the subscription has entered year 2, the Listing Fee drops to 10% (Tier 2, Year 2 rate).
...
- If in month two the buyer increases usage of your software and is billed \$21,000, the Listing Fee will drop to 17% for that Transaction (Tier 2).

:::caution[Warning]
All Terms and Conditions are included in the [Marketplace Agreement](https://www.azion.com/en/documentation/agreements/marketplace/marketplace-agreement/). You must agree with this document to offer your products on Azion Marketplace.
:::
