...
<LinkButton outlined link="/en/documentation/products/marketplace/isv-signup/" label="go to Become an ISV guide" variant="secondary" /> 
...
<LinkButton outlined link="/en/documentation/products/pricing/" label="go to Pricing page" variant="secondary" /> 
