...
| --------------------- | --------- | ------------------------------------------------------------------- |
| `stream`              | `boolean` | If `true`, enables streaming responses from the model.              |
...
| `object`                               | `string` | Type of the object, here `"chat.completion"`.           |
...
| `choices[].stop_reason`               | `string`   | Optional extra reason for stopping. |
...
| `choices[].finish_reason`                            | `string` | Why the model stopped generating output.                    |
| `choices[].stop_reason`                              | `string`   | Reason for stopping.                                         |
