...
description: >-
  Edge AI offers a diverse range of edge-optimized models for various AI workloads, ensuring efficient deployment and performance.
...
Azion's edge-optimized models span multiple AI workloads including text generation, image analysis, embeddings, and more. Each model is designed to balance performance and resource efficiency for edge deployment.
