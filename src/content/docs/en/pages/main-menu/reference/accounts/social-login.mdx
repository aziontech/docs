...
title: Social Login
description: >-
  It uses existing information from a social network to log in to third-party
  sites without the need to create a new login account.
meta_tags: 'social login, contas, autenticação de usuários'
namespace: documentation_accounts_social_login
permalink: /documentation/fundamentals/social-login/
---
...
To find out more about signing up to Azion with **Social Login**, visit the [creating an account page](/en/documentation/fundamentals/creating-account/).
