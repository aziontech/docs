...
<DocButton href="/en/documentation/products/guides/configure-user-session-timeout/" label="Go to Configuring User Session Timeout guide" kind="secondary" target="_blank" size="medium" />
