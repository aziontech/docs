...
Before you enable this setting on **Azion Console***, make sure your mobile device supports an MFA application, such as Google Authenticator or Microsoft Authenticator, available in the iOS App Store, Google Play, and other mobile app stores.
...
Incorrect Pairing: errors may occur if the authenticator app isn't correctly paired with the Azion Console account.
