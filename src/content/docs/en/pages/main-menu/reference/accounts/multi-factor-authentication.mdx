...
description: >-
  Multi-Factor Authentication (MFA) is an electronic verification method used to
  secure logins.
meta_tags: Multi-Factor Authentication
namespace: documentation_accounts_multi_factor
permalink: /documentation/fundamentals/multi-factor-authentication/
---
...
Before you enable this setting on Azion, make sure your mobile device supports an MFA application, such as Google Authenticator or Microsoft Authenticator, available in the iOS App Store, Google Play, and other mobile app stores.
...
- **Incorrect pairing**: errors may occur if the authenticator app isn't correctly paired with the Azion account.
