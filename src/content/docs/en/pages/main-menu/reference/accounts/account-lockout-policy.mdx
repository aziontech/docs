...
permalink: /documentation/fundamentals/account-lockout-policy/
---
...
| Scope | Resource |
| ----------- | ----------- |
| Configure Account Lockout Policy | [How to configure Account Lockout Policy](/en/documentation/guides/application-security/access-and-compliance/configure-account-lockout-policy/) |
| Check logs | [How to check Account Lockout Policy logs](/en/documentation/guides/application-security/access-and-compliance/account-lockout-policy-logs/) |
| Unlock a user | [How to manually unlock a user from the Account Lockout Policy](/en/documentation/guides/application-security/access-and-compliance/unlock-account-lockout-policy/) |
...
<DocButton href="/en/documentation/guides/application-security/access-and-compliance/configure-account-lockout-policy/" label="Go to Configuring Account Lockout Policy guide" kind="secondary" target="_blank" size="medium" />
...
<DocButton href="/en/documentation/guides/application-security/access-and-compliance/account-lockout-policy-logs/" label="Go to Checking Account Lockout Policy logs guide" kind="secondary" target="_blank" size="medium" />
...
<DocButton href="/en/documentation/guides/application-security/access-and-compliance/unlock-account-lockout-policy/" label="Go to Unlocking users guide" kind="secondary" target="_blank" size="medium" />
