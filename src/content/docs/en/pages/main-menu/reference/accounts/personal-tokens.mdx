...
**Personal Tokens** are a string of characters used to authenticate your user and access to certain interfaces and tools. You can create a long-lived authentication personal token in [Azion Console](https://console.azion.com/) to call [Azion APIs](https://api.azion.com/) or to execute commands in the [command-line interface (CLI)](/en/documentation/products/azion-cli/overview/).
...
You can create as many personal tokens as you like and you can view them under the **Personal Tokens** option in the **Account Menu**, located in the top-right corner of **Azion Console**. You can’t modify a token once it's created, but you'll be able to see its *scope*, *last modified date*, and *expiration date*.
