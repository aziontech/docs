...
**Personal Tokens** are a string of characters used to authenticate your user and access to certain interfaces and tools. You can create a long-lived authentication personal token in [Real-Time Manager (RTM)](https://console.azion.com/) to call [Azion APIs](https://api.azion.com/) or to execute commands in the [command-line interface (CLI)](/en/documentation/products/cli/).
