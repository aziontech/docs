...
description: >-
  The Users Management functionality on Azion gives you tools to efficiently
  manage users in your account.
meta_tags: Users
namespace: documentation_accounts_users_management
permalink: /documentation/fundamentals/users-management/
---

The **Users Management** functionality on Azion gives you tools to efficiently manage users in your account. This feature enables you to add, modify, and delete users, granting you control over who has access to your Azion account and its associated resources.
...
- Add new users to your Azion account.
...
- **Timezone**: select the timezone where the new user is located. Choosing the correct timezone guarantees precision when accessing data and metrics on Azion.
- **Language**: English is the only language currently available on Azion.
...
You can also allocate non-owners to more than one team, which expands the permission possibilities for the same user. See [Team Permissions](/en/documentation/fundamentals/teams-permissions/) for more details.
