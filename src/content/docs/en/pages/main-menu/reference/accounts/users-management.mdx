...
description: The Users Management functionality on Azion Console gives you tools to efficiently manage users in your account.
meta_tags: Users
...
**Timezone**: select the timezone where the new user is located. Choosing the correct timezone guarantees precision when accessing data and metrics on Console.
**Language**: English is the only language currently available on Console.
