...
permalink: /documentation/fundamentals/billing-and-subscriptions/
---
...
When you first sign up to use Azion Web Platform, you start for free. You get *$300* in credit to use within *365 days*, which is called a *trial period*. Once the given amount of credit is used or the time period for use expires, you'll be billed according to your usage.

During the sign up process, you aren't obligated to insert your credit card information. Feel free to make the best use of your credit within the time limit.
...
<DocButton href="/en/documentation/guides/platform/account-and-billing/billing-and-subscriptions/" label="Go to How to access the Billing page guide" kind="secondary" target="_blank" size="medium" />
