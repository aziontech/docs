...
When you first sign up to use Azion Edge Platform, you start for free. You get *$300* in credit to use within *365 days*, which is called a *trial period*. Once the given amount of credit is used or the time period for use expires, you'll be billed according to your usage.
...
<LinkButton link="/en/documentation/products/guides/billing-and-subscriptions/" label="Go to How to access the Billing page guide" severity="secondary" target="_blank" />
