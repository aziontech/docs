...
This section allows you to change the information related to the main account on Azion. See more about each field next:
...
If you're the *Account Owner*, you can enable and disable the **Social Login** functionality using its switch. When it's enabled, users linked to the account can authenticate to Azion's platform using the supported social networks. Otherwise, they have to log in using their email and password. Learn more about it on the [Social Login](/en/documentation/fundamentals/social-login/) page.

:::note
When you enable **Social Login**, it applies to all users of the account.
:::

Once Social Login is enabled, users can access Azion via Social Login on their next login.
...
Learn how to set up an MFA mobile application on the [Multi-Factor Authentication](/en/documentation/fundamentals/multi-factor-authentication/) page.

---

## Delete account

Azion's platform allows you to delete your account. 
...
You can [create a new account](/en/documentation/fundamentals/creating-account/) at any time and continue your experience with Azion.
