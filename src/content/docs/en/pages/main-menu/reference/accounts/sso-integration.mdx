...
description: Azion Console allows the account owner to configure their users' login between two account authentication options, SSO from Azion or an external Identity Provider of their choice.
...
| Task | Guide |
| ---- | ----- |
| Configure Azure SAML| [Using Azure AD custom SAML app as an IdP for Azion Console](/en/documentation/products/guides/sso-azure-saml/) |
| Configure Google SAML | [Using Google custom SAML app as an IdP for Azion Console](/en/documentation/products/guides/sso-google-saml/) |
