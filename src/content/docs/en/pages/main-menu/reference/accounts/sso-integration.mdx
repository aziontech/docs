...
**Single sign-on (SSO)** allows you to give your team members one account for all the systems your company uses. If you have an **Enterprise** or **Mission-Critical** Support plan and have SSO configured for your company, your users can log in to Azion's platform using their SSO credentials.
