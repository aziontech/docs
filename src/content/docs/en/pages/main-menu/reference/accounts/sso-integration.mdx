...
To configure an X.509 certificate on Azion, see [How to configure an X.509 certificate](/en/documentation/products/secure/firewall/certificate-manager/#how-to-configure-an-x509-certificate) in the Certificate Manager documentation.
