...
You can also stream your **Activity History** logs by using them as a data source in Data Stream. Find out more in the [Data Stream](/en/documentation/products/observe/data-stream/#activity-history) page.
