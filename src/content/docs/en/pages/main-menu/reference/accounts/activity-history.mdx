...
On [Real-Time Manager (RTM)](https://console.azion.com/), you can access the **Activity History** associated with your account. This feature provides insights into the actions carried out within your account by all connected users.
