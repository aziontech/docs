...
permalink: /documentation/build/orchestrator/edge-node/
---
...
| Scope | Guide |
| - | - | 
| Edge Node | [ Edge Node first steps](/en/documentation/guides/application-development/automation/edge-node-first-steps/) |
