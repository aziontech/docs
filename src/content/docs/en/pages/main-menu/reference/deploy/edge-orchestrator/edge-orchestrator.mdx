...
An Azion Edge Orchestrator agent is installed on the edge nodes and provides end-to-end encrypted remote node management from [Real-Time Manager](https://console.azion.com/). 
...
**Edge Services** enables you to create your own services. You can use your customized services and ensure your device is managed and orchestrated by [Real-Time Manager](https://console.azion.com).
