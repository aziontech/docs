...
- Manage and control edge resources in real time, including provisioning, updating, and managing applications, edge firewalls, edge functions, digital certificates, Nodes, Services, and third-party services via Marketplace.
