...
permalink: /documentation/build/orchestrator/
---
...
| Scope | Guide |
| - | - | 
| Node | [Node first steps](/en/documentation/guides/application-development/automation/edge-node-first-steps/) |
| Services| [Creating an Edge Service](/en/documentation/guides/application-development/automation/edge-services-first-steps/) |
...
Learn more about the [Azion Orchestrator agent installation](/en/documentation/guides/application-development/automation/edge-node-first-steps/#installing).
...
[Learn more about Node](/en/documentation/build/orchestrator/edge-node/).
...
[Learn more about Services](/en/documentation/build/orchestrator/edge-services/).
