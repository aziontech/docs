...
permalink: /documentation/guides/platform/migration/configure-a-domain/
---
...
1. Run the following `POST` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/guides/platform/account-and-billing/personal-tokens/) to create a new Workload.
...
| `digital_certificate_id` | When `null`, selects the **Azion SAN** certificate. You can also [associate a digital certificate](/en/documentation/guides/application-security/tls-and-certificates/create-a-digital-certificate/#via-api) to your Workload. |
...
1. Run the following `POST` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/guides/platform/account-and-billing/personal-tokens/), the `<edge_application_id>` variable with the [ID of your application](/en/documentation/guides/application-development/getting-started/configure-main-settings/):

<Code client:visible lang="bash" code={`curl --location 'https://api.azionapi.net/domains' \
...
--data '{
  ...
  | `digital_certificate_id` | When `null`, selects the **Azion SAN** certificate. You can also [associate a digital certificate](/en/documentation/guides/application-security/tls-and-certificates/create-a-digital-certificate/#via-api) to your domain. |
  | `edge_application_id` | The [ID of the application](/en/documentation/guides/application-development/getting-started/build-an-application/#via-api) linked to the domain. |
...
You can choose to customize your domain by [associating a domain record](/en/documentation/guides/platform/migration/point-domain-to-azion/) or [migrating your name resolution to Azion](/en/documentation/guides/platform/migration/migrate-ns-to-azion/).
