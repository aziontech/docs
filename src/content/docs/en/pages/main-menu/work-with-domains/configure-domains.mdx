...
With Azion, you can create and run applications directly on the edge. To allow access to your application through the browser and start receiving users and monitoring metrics, you need to configure a domain.
