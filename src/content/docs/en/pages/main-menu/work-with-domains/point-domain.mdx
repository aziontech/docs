...
If you already own a domain, you can associate your domain CNAME entries to your Azion Workload address effectively directing access to your edge application. 
...
`} />
  ...
  | Key | Description |
  | --- | --- |
  | `domains` | Accepts a list of CNAMEs for the workload as values. For example, `["*.yourdomain.com", "*.yourdomain.org"]`. |
