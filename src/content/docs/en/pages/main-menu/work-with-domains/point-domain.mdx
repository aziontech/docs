...
:::note
This process will require you to associate a CNAME record to your domain. See [Migrate nameservers to Azion](/en/documentation/products/guides/migrate-ns-to-azion/) for more information on how to associate an ANAME record.
:::
