...
To configure custom domain via API v4:

<Code lang="bash" code={`curl --request PATCH \\\\
  --url https://api.azion.com/v4/domains/<domain_id> \\\\
  --header 'Accept: application/json' \\\\
  --header 'Content-Type: application/json' \\\\
  --header 'Authorization: Token [TOKEN VALUE]' \\\\
  --data '{
    "cnames": ["yourdomain.com"],
    "cname_access_only": true
  }'`} />

:::tip
Check the [Domains API v4 documentation](https://api.azion.com/v4#/operations/PatchDomain) for more details.
:::
