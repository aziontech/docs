...
9. Keep these values in hand for when you [redirect the authoritative DNS of your domain](#redirect-authoritative-dns-servers).
...
The next step is to redirect your domain's authoritative DNS servers, and for this, you'll need to access your domain provider and modify your NS records. Here are some of the most popular domain providers and how they handle DNS nameserver changes:
