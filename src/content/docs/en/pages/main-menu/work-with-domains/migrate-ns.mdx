...
Azion allows you to host and manage DNS zones and records by redirecting the DNS resolution of your domain provider to Azion's authoritative nameservers (NS) through [Intelligent DNS](/en/documentation/products/secure/intelligent-dns/).
...
1. [Access RTM](http://console.azion.com).
...
```
  ...
  | Key | Description |
  | --- | --- |
  | `record_type` | The type of record being created. See a full list of accepted record types in the [Intelligent DNS documentation](/en/documentation/products/secure/intelligent-dns/). |
