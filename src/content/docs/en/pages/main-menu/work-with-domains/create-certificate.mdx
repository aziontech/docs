...
3. To add a new **Custom certificate**, click the **Add certificate** button, then select the **Edge Certificate** option from the dropdown.
...
1. [Access RTM](https://manager.azion.com).
2. On the upper-left corner of the page, open the **Products menu**, represented by three horizontal lines, and then select **Digital Certificates**.
3. To add a new **Custom certificate**, click the **Add certificate** button, then select **Trusted CA** from the dropdown.
4. Name your certificate.
5. In the field **Certificate**, paste the mTLS certificate.
