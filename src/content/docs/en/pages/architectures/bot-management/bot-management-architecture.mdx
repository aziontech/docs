...
- [Bot Manager](/en/documentation/products/secure/edge-firewall/bot-manager/) is an Firewall add-on for bot management.
...
- Using [Azion Templates](/en/documentation/products/marketplace/templates/) based on the Bot Manager Lite version: pre-built and pre-configured projects designed to accelerate the implementation of bot management.
    ...
    - [Bot Manager Lite Integration Kit](/en/documentation/products/guides/bot-manager-lite-integration-kit/): an easy way to integrate the Bot Manager Lite function in an existent firewall on Azion. To easily deploy this template at the edge, click the button below:
