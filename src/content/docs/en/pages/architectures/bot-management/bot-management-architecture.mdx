...
meta_tags: >-
  ...
  detection, edge computing, real-time events, edge application, data stream,
  preventive security
...
- [Edge Application](/en/documentation/products/build/edge-application/) is your application running on top of the Azion Web Platform.
...
- Using [Azion Templates](/en/documentation/products/marketplace/templates/) based on the Bot Manager Lite version: pre-built and pre-configured projects designed to accelerate the implementation of bot management.
    ...
    - [Bot Manager Lite and TOR Block Starter Kit](/en/documentation/products/guides/bot-manager-lite-and-tor-block-starter-kit/): deploy a basic security suite to protect your workloads from bad bots and TOR Exit Nodes requests. To easily deploy this template at the edge, click the button below:
