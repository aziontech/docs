...
- [Bot Manager](/en/documentation/products/marketplace/bot-manager/) is an Edge Firewall add-on for bot management.
...
- Using [Azion Templates](/en/documentation/products/marketplace/templates/) based on the Bot Manager Lite version: pre-built and pre-configured projects designed to accelerate the implementation of bot management.
    ...
    - [Bot Manager Lite Integration Kit](/en/documentation/products/guides/bot-manager-lite-integration-kit/): an easy way to integrate the Bot Manager Lite function in an existent edge firewall on Azion.
...
- From scratch: create an entire edge stack from zero, including Bot Manager. To do so: 
    ...
    3. [Enable Bot Manager](/en/documentation/products/marketplace/bot-manager/).
