...
![Overview of a request/response through Application](/assets/docs/images/uploads/app-acceleration-arch.png)
...
- Application contains delivery and cache policies, rules to automate cache policy assignments based on content type, and determines how content is cached.
