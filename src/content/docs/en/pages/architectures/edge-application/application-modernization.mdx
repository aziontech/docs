...
description: Discover how Azion's Edge Platform enables application modernization through a serverless approach and microservices architecture. Learn how to migrate legacy applications to the edge, improving speed, reliability, and cost efficiency.
...
With Edge Functions, you can have the logic performed at the edge, improving the usability and maintainability of decentralized applications. These functions are written in Javascript and run on Azion Edge Runtime.
