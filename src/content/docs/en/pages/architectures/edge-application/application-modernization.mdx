...
![Overview of a request/response through Applications](/assets/docs/images/uploads/app-modernization.png?v=3)
...
- [Azion Console](/en/documentation/products/guides/how-to-access-azion-console/): Azion’s configuration interface where you can access all the available products and their settings. It enables you to complete all tasks in Azion’s platform
