...
3. The request reaches the edge application and based on its Rules Engine configuration, accesses the requested content. If configured, Image Processor, Edge Cache, Application Accelerator, and Functions will be executed. 
