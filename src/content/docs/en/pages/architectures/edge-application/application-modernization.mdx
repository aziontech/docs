...
description: Explore how Azion Edge Platform leverages serverless technology and microservices for modernizing applications, enhancing scalability and performance.
permalink: /documentation/architectures/edge-application/application-modernization/
meta_tags: Azion, serverless, edge applications, microservices architecture, content delivery, edge computing, scalability, application modernization, operational simplicity, edge infrastructure
