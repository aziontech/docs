---
title: Optimize and process images with the Azion 
description: Use Azion's Image Processor to automate resource management, reduce load times and storage costs, and leverage the speed and reliability of the edge network.
meta_tags: edge, applications, web applications, api, content delivery, cdn, image processing
