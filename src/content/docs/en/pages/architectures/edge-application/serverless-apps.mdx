...
description: >-
  Explore serverless computing with Azion Edge Platform to build responsive
...
meta_tags: >-
  Azion Edge Platform, serverless computing, Edge Functions, Edge Application,
...
1. Create an edge application:
    ...
    - Use [Azion CLI](/documentation/products/azion-cli/overview/) to create and deploy an edge application.
    - Choose the Dynamic and Static File Optimization template.
2. Create a domain and associate it with the edge application: 
    - On Console, [create a domain](/documentation/products/guides/configure-a-domain/) using the **+ Create** button on the homepage.
