...
3. The request reaches the **Edge Application** and based on its **Rules Engine** configuration, accesses the requested content. If configured, **Image Processor**, **Edge Cache**, **Application Acceleration**, and **Functions** will be executed.
