...
[Serverless computing](https://www.azion.com/en/solutions/serverless-applications/) allows you to build and run applications without worrying about the underlying infrastructure. With Azion Edge Platform, you can focus more on creating quality products and less on managing servers.
