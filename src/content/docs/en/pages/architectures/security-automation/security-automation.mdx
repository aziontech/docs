...
2. In the edge node, Edge Firewall processes the request and executes the security configurations:
  ...
  - Any configured and instantiated edge function is executed. Read more on how to [automate security with Azion Functions](/en/documentation/products/secure/automate/functions/).
