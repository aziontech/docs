...
2. In the edge node, Firewall processes the request and executes the security configurations:
  ...
  - Firewall Rules Engine identifies if there are rules from WAF and Network Layer Protection, and executes the corresponding behaviors.
...
3. Define all your rules and configurations:
  ...
  - [Functions](/en/documentation/products/secure/edge-firewall/edge-functions/), creating your own code or using [Marketplace Firewall integrations](/en/documentation/products/marketplace/integrations/#edge-firewall-functions).
