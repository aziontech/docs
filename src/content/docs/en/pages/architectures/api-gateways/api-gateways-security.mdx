...
- [Applications](/en/documentation/products/build/edge-application/): allows you to set up an edge application to configure delivery and cache policies.
...
5. [Create an firewall](/en/documentation/products/guides/secure/edge-firewall-configure-main-settings/) and select the domain you want to protect.
