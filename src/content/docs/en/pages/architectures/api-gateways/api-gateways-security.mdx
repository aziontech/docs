...
3. Edge Firewall verifies and analyzes the request to make sure is safe, including Rules Engine Rules, Functions, WAF Rules, DDoS mitigation, network list policies, and more.
