...
2. The edge application rule, which has been configured to activate a function, is triggered. This function, developed in JavaScript and deployed onto the Azion Web Platform, runs the logic for the shopping cart.
