...
3. Application processes it adequately, executing any implemented rule.
...
- [Application](/en/documentation/products/build/edge-application/): allows you to build applications that run in Azion Edge Network.
