...
Integrating edge computing with [artificial intelligence](https://www.azion.com/en/solutions/ai-agents/) enables innovative use cases. It allows the deployment of AI algorithms and models directly through edge applications, making real-time data processing and analysis possible. In this context, AI agents are a relevant concept, acting as autonomous systems capable of analyzing data, making decisions, and taking action. This approach delivers intelligence right where data is generated and consumed, ensuring faster decision-making, reduced latency, and enhanced efficiency.
...
- [Edge Application](/en/documentation/products/build/edge-application/): allows you to build applications that run in Azion Edge Network.
  - [Functions for Edge Application](/en/documentation/products/build/edge-application/edge-functions/): executes code closer to the end user, enhancing performance and enabling custom logic for handling requests and responses.
- [SQL Database](/en/documentation/products/store/edge-sql/): an edge-native SQL solution designed for serverless applications.
...
- [Azion Edge SQL: enabling access and analysis of structured data at the edge](https://www.azion.com/en/products/edge-sql/)
