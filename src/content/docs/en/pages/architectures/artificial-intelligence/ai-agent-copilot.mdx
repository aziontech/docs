...
- [Edge Network](/en/products/our-network/): a highly distributed architecture that includes strategically located edge nodes.
...
2. Create an [Edge SQL database](/en/documentation/products/store/sql/create-database/) that will be consulted.
