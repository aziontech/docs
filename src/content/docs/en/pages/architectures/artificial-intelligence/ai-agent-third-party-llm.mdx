...
**Figure 1.** AI agent architecture diagram with a Third Party LLM.
...
- **[Applications](https://www.azion.com/en/documentation/platform/applications/)**: an application on Azion that hosts the AI agent.
- **[Functions](https://www.azion.com/en/documentation/build/functions/)**: a serverless function that contains the AI agent logic.
- **[Object Storage](https://www.azion.com/en/documentation/store/object-storage/)**: Azion's object storage service to store the data that the agent uses to answer questions.
- **[SQL Database](https://www.azion.com/en/documentation/store/sql-database/)**: Azion's database to store chat state and documents.
...
Use the [LangGraph AI Agent Boilerplate](/en/documentation/guides/application-development/frameworks/langgraph-ai-agent-boilerplate/) to quickly set up a LangGraph backend and SQL base that ensures reliable persistence of state and documents.
...
:::note
This template uses [Application Accelerator](/en/documentation/build/application-accelerator/), [Functions](/en/documentation/build/functions/), and [SQL Database](/en/documentation/store/sql-database/), and may generate usage-related costs. Check the [pricing page](https://www.azion.com/en/pricing/) for more information.
:::
---

## Reference Guide

- [Reference Guide - How to integrate an AI agent with Third Party LLM](/en/documentation/guides/application-development/frameworks/langgraph-ai-agent-boilerplate/)

## Related Documentation

- [Object Storage](/en/documentation/store/object-storage/)
- [SQL Database](/en/documentation/store/sql-database/)
- [Azion GitHub App](/en/documentation/guides/application-development/automation/azion-github-app/)
- [Vector Search with SQL Database](/en/documentation/guides/application-development/data/sql-database-vector-search/)
