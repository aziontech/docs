...
- **[Firewall](/en/documentation/platform/firewall/)**  
...
- **[Functions](/en/documentation/platform/firewall/functions/)**  
...
- **[AI Inference](/en/documentation/build/ai-inference/)**  
...
- **[Applications](/en/documentation/platform/applications/)**  (Optional)
  Hosts the web application that consumes file uploads and exposes HTTP(S) endpoints for end users.

- **[Object Storage](/en/documentation/store/object-storage/)** (optional)  
  Used for:
...
```
**Note:** Make sure the selected model is available and properly configured in the Azion environment. Check the [available models](/en/documentation/build/ai-inference/models/).
...
- Adjust:
   ...
   - **WAF** and **Network Shield** rules based on collected insights.  
...
- [Implement a Copilot assistant based on a ReAct AI agent](/en/documentation/guides/ai/agents-and-rag/ai-agent-copilot-assistant/)  
- [Security automation with Edge Computing](/en/documentation/guides/application-security/firewall-and-waf/security-automation-with-edge-computing/)  
...
- [Protect web applications and APIs with WAAP](/en/documentation/guides/application-security/firewall-and-waf/web-application-and-api-protection-waap/)  
- [Azion Observe products](/en/documentation/platform/real-time-metrics/)