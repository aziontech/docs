...
description: >-
  ...
  content delivery.
permalink: >-
  /documentation/architecture/live-streaming-delivery/live-streaming-delivery-with-hls/
meta_tags: >-
  Edge Computing, live streaming delivery, HLS, real-time transcoding, adaptive
  bitrate streaming, content delivery network, Azion Edge Platform, stream
