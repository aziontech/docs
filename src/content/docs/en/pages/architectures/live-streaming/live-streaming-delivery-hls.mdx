...
description: >-
  ...
  content delivery.
permalink: /documentation/guides/application-performance/delivery-optimization/live-streaming-delivery-with-hls/
meta_tags: >-
...
7. The transcoded stream is cached in the Cache for subsequent high-demand simultaneous client requests.
...
- [Applications](/en/documentation/platform/applications/) allows you to build applications on top of the Azion Web Platform and deliver your content.
  - [Cache](/en/documentation/build/cache/) enables you to configure how your application caches content to reduce latency and increase transfer rates.
...
2. [Create a domain](https://www.azion.com/en/documentation/guides/platform/migration/configure-a-domain/#create-a-domain-with-azion) and [associate it with the application](/en/documentation/guides/platform/migration/configure-a-domain/#link-a-custom-domain-to-your-application).
3. Set up and [enforce cache policies for HLS](/en/documentation/guides/application-performance/cache-and-purge/enforce-hls-cache/) in the application.
...
- [Content delivery architecture](/en/documentation/guides/application-performance/delivery-optimization/content-delivery/)
