...
- **Azion Marketplace Integrations** for security are executed to complete the analysis and verification.
  ...
  - Reputation analysis.
4. Based on the firewall, account management, and integrations' configurations, the system denies any unauthorized request. Otherwise, the request continues the flow to **Application**.
5. **Application** executes all the configurations, according to the request:
...
6. **Application** resolves the request and sends an adequate response.
