...
meta_tags: >-
  cyber security, Bot management, Edge Firewall, DDoS Protection, Web Application Firewall, Edge
  Application, online security, e-commerce, fintech
...
5. **Edge Application** applies all the configurations, according to the request.
...
8. Customers can use observability tools to monitor and act proactively against any thread.
...
2. Integrate your custom integrations with Azion's platform.
