...
- [Firewall](/en/documentation/products/secure/edge-firewall/): provides main settings to set up your instance, enabling you to associate it with domains and activate modules to protect users, applications, and networks.
  ...
  - [Functions for Firewall](/en/documentation/products/secure/edge-firewall/edge-functions/): build event-driven, serverless web applications including functions with your own security source code.
...
- [Set the criteria and behaviors](/en/documentation/products/build/edge-application/rules-engine/) for the Rules Engine rules. For example:
  ...
  - Redirects.
  - Rewrite the request.
4. [Create and configure a firewall](/en/documentation/products/guides/secure/edge-firewall-configure-main-settings/).
...
- [Instantiate functions](/en/documentation/products/guides/secure/instantiate-edge-functions/) and [integrations](/en/documentation/products/marketplace/integrations/#edge-firewall-functions).
