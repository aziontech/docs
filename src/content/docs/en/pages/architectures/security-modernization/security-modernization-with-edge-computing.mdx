...
description: Explore how edge computing enhances security with Edge Firewall, DDoS Protection, and observability products for effective threat detection and system resilience.
permalink: /documentation/architecture/security-modernization/security-modernization-with-edge-computing/
meta_tags: Edge Computing, Edge Firewall, Security Modernization, DDoS Protection, Edge Functions, Rules Engine, Data Stream, Real-Time Metrics, Observability Products, Network Layer Protection
...
- [Edge Firewall](/en/documentation/products/secure/edge-firewall/): executes its modules and security rules.
    ...
    - [Edge Functions](/en/documentation/products/secure/edge-firewall/edge-functions/): serverless functions that run on Azion Runtime with low latency, bringing the operational power and security processing closer to the end user.
