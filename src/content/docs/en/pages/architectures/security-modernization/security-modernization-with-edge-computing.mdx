...
4. Application Rules Engine identifies if there are rules related to caching, image optimization, cookies, and redirects, among others.
...
6. Application or Edge Firewall Rules Engine executes any rule configured for the Response Phase.
