...
3. Firewall Rules Engine identifies if there are rules from WAF, Network Layer Protection, and Bot Manager.
...
- If the request doesn't match an Firewall rule and isn't blocked, the request continues the flow.
