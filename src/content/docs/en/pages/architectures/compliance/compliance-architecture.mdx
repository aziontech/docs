...
6. In the Edge Node, Edge Firewall verifies and analyzes the request to make sure is safe, including Rules Engine Rules, functions, WAF rules, DDoS mitigation, network list policies, and more.
  - Based on the configurations, the system denied any unauthorized request. Otherwise, the request continues the flow. 
7. Edge Application verifies and analyzes the request to execute the rules accordingly, such as cache, and image optimization, among others.
...
- [Edge Firewall](/en/documentation/products/secure/edge-firewall/): provides main settings to set up your instance, enabling you to associate it with domains and activate modules to protect users, applications, and networks.
  ...
  - [Functions for Edge Firewall](/en/documentation/products/secure/edge-firewall/edge-functions/): build event-driven, serverless edge applications including functions with your own security source code.
...
3. [Create a domain](/en/documentation/products/guides/configure-a-domain/) and associate it with the edge application, and [point your traffic to Azion](/en/documentation/products/guides/point-domain-to-azion/).
4. [Create your Digital Certificates](/en/documentation/products/guides/create-a-digital-certificate/).
5. [Create an edge firewall](/en/documentation/products/guides/secure/edge-firewall-configure-main-settings/) and select the domains you want to protect.
