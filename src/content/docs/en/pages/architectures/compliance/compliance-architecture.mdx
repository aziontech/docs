...
- [Firewall](/en/documentation/products/secure/firewall/): provides main settings to set up your instance, enabling you to associate it with workloads and activate modules to protect users, applications, and networks.
...
5. [Create a firewall](/en/documentation/products/guides/secure/firewall-configure-main-settings/) and select the workloads you want to protect.
