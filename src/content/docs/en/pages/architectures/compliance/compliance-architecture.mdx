...
- [Real-Time Events](/en/documentation/products/observe/real-time-metrics/) enables you to monitor all your applications' activity and by using [Data Stream](/en/documentation/products/observe/data-stream/) connectors you can feed event logs into your stream processing, SIEM, and big data platforms.
