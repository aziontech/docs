...
By using this ecosystem, it's possible to build and manage edge applications, domains, edge nodes, edge services, edge firewalls, data streams, and more, while observing products and usage behavior in real time.

You can access it and get a simple and fast user experience through:

- [Real-Time Manager (RTM)](https://www.azion.com/en/documentation/products/getting-started/#getting-to-know-real-time-manager): it's the configuration's interface. With RTM, you have access to all the products and services provided by Azion, being able to create and manage them. RTM also enables the management of provisioning, accounting, billing, and user permissions.
...
<Button href="/en/documentation/products/azion-products-catalog/" text="Get to Know Azion Products Catalog"> 
