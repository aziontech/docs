...
In the **Custom Pages** section, the **Status Code** field can't be modified. This field represents every error status code received from the origin. The **Default Response TTL** field allows you to customize the cache TTL for every status code received.
