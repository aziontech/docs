...
permalink: /documentation/guides/application-development/getting-started/configure-main-settings/
---
...
In this guide, you'll modify some configurations of your application. You can see if the changes ocurred by [accessing your Azion domain](/en/documentation/guides/platform/migration/configure-a-domain/).

:::note
Don't have an application? [Start with a template](/en/documentation/marketplace/).
:::
...
<Fragment slot="panel.console">
        ...
        **Delivery protocols**
        ...
        Modify your application to support the available [delivery protocols](/en/documentation/platform/applications/main-settings/#delivery-protocols).
...
```
        ...
        **Delivery ports**
        ...
        Choose between the supported [delivery ports](/en/documentation/platform/applications/main-settings/#ports) for each protocol selected.
...
```
        ...
        **Modules**
        ...
        [Modules](/en/documentation/platform/applications/#modules) can unlock additional functionalities and features for your applications. See the [Pricing page](/en/documentation/fundamentals/pricing/) for more details.

        For now, you'll enable two modules. The **Application Accelerator** and **Functions** modules will be used for when you [tune your cache settings](/en/documentation/guides/application-performance/cache-and-purge/tune-cache-settings/), [instantiate a function](/en/documentation/guides/application-development/getting-started/instantiate-functions/), and [work with Rules Engine](/en/documentation/guides/application-development/getting-started/work-with-rules-engine/). 

        If you're an [Account owner](/en/documentation/guides/platform/account-and-billing/users-management/), start by enabling the following modules for your account:
...
```
        ...
        7.  Check the supported cipher suite by inspecting the page or [running the DIG command](/en/documentation/guides/application-security/dns/run-the-dig-command/).
