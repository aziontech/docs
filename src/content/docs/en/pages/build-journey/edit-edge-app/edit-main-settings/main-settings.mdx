...
Modify your application to support the available [delivery protocols](/en/documentation/products/edge-application/delivery-settings/#delivery-protocols).
...
Choose between the supported [delivery ports](/en/documentation/products/edge-application/delivery-settings/#delivery-ports) for each protocol selected.
...
Specify the [minimum TLS version](/en/documentation/products/edge-application/delivery-settings/#minimum-tls-version) and [cipher suite](/en/documentation/products/edge-application/delivery-settings/#ciphers) supported by your application.
...
The application may still be running in TLS 1.3, since you selected the minimum version and not the exact TLS version. However, you can check the cipher suite being used against the [list of supported ciphers](/en/documentation/products/edge-application/delivery-settings/#ciphers).
...
```
  ...
  | `supported_ciphers` | Sets the supported cipher suite, with its value in this case being `TLSv1.2_2021`. See the full list of [list of supported ciphers](/en/documentation/products/edge-application/delivery-settings/#ciphers) for further details.
