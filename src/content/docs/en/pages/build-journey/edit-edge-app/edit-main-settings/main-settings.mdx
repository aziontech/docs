...
Modify your application to support the available [delivery protocols](/en/documentation/products/edge-application/#delivery-protocols).
...
Choose between the supported [delivery ports](/en/documentation/products/edge-application/#ports) for each protocol selected.
...
Specify the [minimum TLS version](/en/documentation/products/edge-application/#minimum-tls-version) and [cipher suite](/en/documentation/products/edge-application/#ciphers) supported by your application.
