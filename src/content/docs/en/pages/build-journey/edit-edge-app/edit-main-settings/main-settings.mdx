...
After some propagation time, you'll be able to access your edge application using the HTTP protocol. To test it, access the `http://xxxxxxxxxx.map.azionedge.net` address. You can also make the following cURL request in your terminal with the HTTP schema:
