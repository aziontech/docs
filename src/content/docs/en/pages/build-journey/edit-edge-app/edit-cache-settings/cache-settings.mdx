...
6. The **Edge caching** layer is already selected by default. If you have the **Tiered Cache** module activated, you can also enable slicing for the tiered cache layer.
...
```
  ...
  | `is_slice_l2_caching_enabled` | Enables file slicing for the tiered cache layer. You must have the [Tiered Cache](/en/documentation/products/edge-application/l2-caching/) module active to enable this setting. |
