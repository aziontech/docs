...
6. The **Edge caching** layer is already selected by default. If you have the **L2 Caching** module activated, you can also enable this feature for the L2.
...
```
  ...
  | `is_slice_l2_caching_enabled` | Enables Large File Optimization for the L2. You must have the [L2 Caching](/en/documentation/products/edge-application/l2-caching/) module active to enable this setting. |
