...
description: Boost your edge application's efficiency with strategic cache handling with custom cache TTL values, object segmentation methods, and large file optimization.
...
:::note
The maximum and default TTL values for the edge should be between `60` and `31536000` seconds (1 year). If you have the [Application Acceleration](/en/documentation/products/build/edge-application/application-acceleration/) module activated, you can set this value to a minimum of `0`. Additionally, if you have the [Tiered Cache](/en/documentation/products/edge-application/l2-caching/) module activated and wish to maintain cache in the tiered cache layer, you must set TTL to at least `3` seconds.
...
Instead of downloading a large content file and risking timeouts or connection terminations, [files can be segmented](/en/documentation/products/edge-application/cache-settings/#large-file-optimization) in pieces and cached on-demand.
...
:::note
The default fragment size is of `1024KB`.
:::
...
:::caution[warning]
To enable all advanced cache key functionalities, you must activate the [Application Acceleration](/en/documentation/products/build/edge-application/application-acceleration/) module.
:::
...
```
  ...
  | `l2_caching_enabled` | Enables caching in the tiered cache layer. You must have the [Tiered Cache](/en/documentation/products/edge-application/l2-caching/) module active to enable this setting. |
  | `is_slice_configuration_enabled` | Enables the [Large File Optimization](/en/documentation/products/edge-application/cache-settings/#large-file-optimization) feature. |
  ...
  | `is_slice_l2_caching_enabled` | Enables Large File Optimization for the tiered cache layer. You must have the [Tiered Cache](/en/documentation/products/edge-application/l2-caching/) module active to enable this setting. |
