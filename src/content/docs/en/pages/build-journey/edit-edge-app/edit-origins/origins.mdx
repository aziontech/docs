...
:::note
The `${uri}` variable may already be selected by default if you didn't activate **Application Acceleration**. For more information on Edge Application modules, see the [Edge Application documentation](/en/documentation/products/build/edge-application/#modules).
:::
