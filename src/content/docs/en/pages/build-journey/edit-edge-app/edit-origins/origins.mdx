...
5. In the **Connection Options** section, in the **Transport Protocol Policy** field select **Force HTTPS**.
6. in the **Address Management** section, in the **Address** field, add `httpbin.org`
