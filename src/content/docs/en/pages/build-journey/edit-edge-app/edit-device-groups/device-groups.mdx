...
description: Learn how to create and manage Device Groups in Azion Console to tailor responses based on User-Agent, enhancing application responsiveness.
permalink: /documentation/products/guides/build/create-device-groups/
meta_tags: Device Groups, User-Agent, Azion Console, Edge Application, API, Mobile User Detection, Response Rules, Add Response Header, User-Agent Regular Expressions, Device Group Configuration
