...
description: Learn how to create and manage Device Groups in Azion Console to tailor
...
meta_tags: Device Groups, User-Agent, Azion Console, Edge Application, API, Mobile
  User Detection, Response Rules, Add Response Header, User-Agent Regular Expressions,
