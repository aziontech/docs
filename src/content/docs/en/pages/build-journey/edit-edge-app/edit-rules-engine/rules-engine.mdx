...
Rules Engine is configured through Edge Applications, even when using Workloads. To configure rules:
...
:::note
Rules Engine remains under Edge Applications, not directly in the Workloads interface.
:::
