...
[TECHWRITER TODO: ADD INFORMATION ABOUT THE MAXIMUM NUMBER OF RULES THAT CAN BE CONFIGURED IN THE RULES ENGINE FOR EDGE APPLICATIONS, INCLUDING DISTRIBUTION BETWEEN REQUESTS AND RESPONSES]