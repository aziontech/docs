...
This guide uses the pre-configured *Azion - Hello World* function, a global function included in all Azion accounts. You can repeat this process using any function already available on [Azion Marketplace](https://marketplace.azion.com/) or [develop your own function](/en/documentation/products/guides/edge-functions/api-builder/)

## Via RTM

In this section, you'll instantiate a function for your application.
