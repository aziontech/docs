...
:::note
The `${uri}` variable may already be selected by default if you didn't activate the [Application Acceleration](/en/documentation/products/build/edge-application/application-acceleration/) module.
:::
