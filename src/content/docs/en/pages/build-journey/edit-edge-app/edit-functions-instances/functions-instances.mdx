...
This guide uses the pre-configured *Azion - Hello World* function, a global function included in all Azion accounts. You can repeat this process using any function already available on [Azion Marketplace](/en/documentation/products/marketplace/) or [develop your own function](/en/documentation/products/guides/edge-functions/api-builder/)
