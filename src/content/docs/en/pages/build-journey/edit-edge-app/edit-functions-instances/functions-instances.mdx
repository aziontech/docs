...
description: Learn how to instantiate and activate serverless Edge Functions within
  your Azion Edge Application, including setup via Azion Console and API.
permalink: /documentation/products/guides/build/instantiate-edge-functions/
meta_tags: Edge Functions, Azion Marketplace, serverless functions, Edge Application,
  Edge Computing, activate Edge Functions, instantiate functions, API requests, function
  deployment, Azion Console
