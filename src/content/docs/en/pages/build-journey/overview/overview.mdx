...
When you [build an application](/en/documentation/products/start-with-a-template/), you determine the origin of your content and configure the domain that'll be used to deliver your application to end users. 

<DocButton href="/en/documentation/products/build/applications/" kind="secondary" label="Go to Applications documentation" size="medium" />
