...
When you [build an application](/en/documentation/products/start-with-a-template/), you determine the origin of your content and configure the workload that'll be used to deliver your application to end users.

<LinkButton link="/en/documentation/products/build/applications/" severity="secondary" label="Go to Applications documentation" />
...
When a user requests content from your application, their browser converts the requested [workload](/en/documentation/products/secure/workloads/) into a pre-set IP address via DNS resolution.
...
After deploying your application, you can [observe metrics](/en/documentation/products/observe/real-time-metrics/#build) related to your application's data, such as access, data transfers, bandwidth, and requests.
