...
When you build an edge application, you determine the origin of your content and configure the domain that will be used to deliver your application to end users. 
