...
description: >-
  Explore how to create Functions using JavaScript and WebAssembly on
...
meta_tags: >-
  Functions, WebAssembly, JavaScript, Edge Computing, Azion, wasmCode, Edge
  Libraries, wasm tutorial, wasm in Functions, Applications
namespace: documentation_dev_with_azion_lang_wasm
---



Learn about the required process to create a [function](/en/documentation/guides/) that uses a [WebAssembly](https://webassembly.org/getting-started/developers-guide/) originated function.
