...
description: Explore how to create Edge Functions using JavaScript and WebAssembly
  on Azion, including guide on wasmCode implementation for Edge Computing.
permalink: /documentation/products/build/develop-with-azion/language-specific/wasm/
meta_tags: Edge Functions, WebAssembly, JavaScript, Edge Computing, Azion, wasmCode,
  Edge Libraries, wasm tutorial, wasm in Edge Functions, Edge Application
