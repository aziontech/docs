...
<LinkButton outlined link="/en/documentation/products/edge-application/edge-functions/runtime-api/code-editor/" label="go to azion code editor reference" variant="secondary" target="_blank" />
