...
description: >-
  Explore how Azion CLI enhances local development for Applications with
...
<DocButton href="/en/documentation/devtools/cli/dev-command/" label="Go to local dev command reference" kind="secondary" size="medium" />
...
Through [Azion CLI](/en/documentation/devtools/cli/) it's possible to have your application running locally, and it brings some key benefits:
