...
permalink: /documentation/guides/application-development/frameworks/hono/
meta_tags: >-
  Hono, Functions, Azion platform, static site generator, 
...
- [If you chose to have a local development server running](/en/documentation/guides/application-development/frameworks/hono/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/guides/application-development/frameworks/hono/#answering-no-to-local-dev).
