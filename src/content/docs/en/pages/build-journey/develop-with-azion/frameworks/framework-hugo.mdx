---
title: How to build with Hugo
description: >-
  Learn how to initialize and deploy an Hugo project on the Azion platform
  using Functions, featuring guides on setting up with the Azion CLI and
  managing deployments.
permalink: /documentation/guides/application-development/frameworks/hugo/
meta_tags: >-
  Hugo, Functions, Azion platform, Jamstack, static site generator, 
  Application, project deployment, Azion CLI, local development server, Edge
  Computing
namespace: docs_framework_hugo
---
...
## Initializing an Hugo project on the edge
...
- [If you chose to have a local development server running](/en/documentation/guides/application-development/frameworks/hugo/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/guides/application-development/frameworks/hugo/#answering-no-to-local-dev).
...
2. On the browser, go to `http://localhost:3333/` and you can see your Hugo project running.
...
After indicating you don't want to have a local server running, deploy the Hugo project to the edge.
