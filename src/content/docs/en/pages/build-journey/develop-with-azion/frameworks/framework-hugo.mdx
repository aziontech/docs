...
permalink: /documentation/products/cli/frameworks/hugo/
meta_tags: >-
  Hugo, Edge Functions, Azion platform, Jamstack, static site generator, Edge
...
Now, Hugo's CLI will follow the process and initialize your Hugo project.
...
- [If you chose to have a local development server running](/en/documentation/products/cli/frameworks/hugo/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/products/cli/frameworks/hugo/#answering-no-to-local-dev).
