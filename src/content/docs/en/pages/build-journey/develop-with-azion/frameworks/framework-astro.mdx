...
description: >-
  Learn how to initialize and deploy an Astro project on the Azion platform
...
meta_tags: >-
  Astro, Edge Functions, Azion platform, Jamstack, static site generator, Edge
...
<div class="cms-embed">
  <iframe width="600" height="400" src="https://www.youtube.com/embed/lQo6rLigHfk?si=2vfJZxAP1gzNzeta" loading="lazy" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
...
<iframe
   src="https://www.youtube.com/embed/FIMBJBpZsdU"
   title="How to build with Astro"
   loading="lazy"
   width="600"
   height="400"
