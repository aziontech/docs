...
permalink: /documentation/guides/application-development/frameworks/astro/
meta_tags: >-
  Astro, Functions, Azion platform, Jamstack, static site generator, 
...
- [If you chose to have a local development server running](/en/documentation/guides/application-development/frameworks/astro/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/guides/application-development/frameworks/astro/#answering-no-to-local-dev).
...
<Video src="https://www.youtube.com/embed/FIMBJBpZsdU" title="How to build with Astro" />
