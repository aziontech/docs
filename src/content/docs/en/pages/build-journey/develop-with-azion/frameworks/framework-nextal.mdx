...
permalink: /documentation/guides/application-development/frameworks/nextal/
meta_tags: >-
...
- A valid [Azion personal token](/en/documentation/fundamentals/personal-tokens/) configured in your terminal environment.
- Code editor.
...
- [If you chose to have a local development server running](/en/documentation/guides/application-development/frameworks/nextal/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/guides/application-development/frameworks/nextal/#answering-no-to-local-dev).
...
For more information about Next.js compatibility on the Azion Web Platform, visit the [Next.js frameworks compatibility page](/en/documentation/devtools/runtime/frameworks/nextjs/).
