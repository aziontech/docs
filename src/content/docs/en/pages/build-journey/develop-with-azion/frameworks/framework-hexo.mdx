...
description: Learn to deploy a Hexo project using the Azion CLI to the Edge Platform,
  covering setup, local development, and Edge Functions integration.
permalink: /documentation/products/cli/frameworks/hexo/
meta_tags: Hexo, Jamstack, Azion Edge Platform, Edge Functions, static site generator,
  Azion CLI, deploy Hexo project, local development server, node.js development, web
  deployment
