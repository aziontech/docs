...
permalink: /documentation/products/cli/frameworks/docusaurus/
meta_tags: >-
  Docusaurus, Edge Functions, Azion platform, Jamstack, static site generator, Edge
...
Docusaurus is listed on [the Jamstack documentation](https://jamstack.org/generators/docusaurus/) as a static site generator, aligned to the Jamstack approach.
...
Now, Docusaurus's CLI will follow the process and initialize your Docusaurus project.
...
- [If you chose to have a local development server running](/en/documentation/products/cli/frameworks/docusaurus/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/products/cli/frameworks/docusaurus/#answering-no-to-local-dev).
