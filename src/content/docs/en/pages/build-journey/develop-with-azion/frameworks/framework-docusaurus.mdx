---
title: How to build with Docusaurus
description: >-
  Learn how to initialize and deploy an Docusaurus project on the Azion platform
  using Functions, featuring guides on setting up with the Azion CLI and
  managing deployments.
permalink: /documentation/guides/application-development/frameworks/docusaurus/
meta_tags: >-
  Docusaurus, Functions, Azion platform, Jamstack, static site generator,
  Application, project deployment, Azion CLI, local development server, Edge
  Computing
namespace: docs_framework_docusaurus
---
...
Docusaurus is a static-site generator that builds a **single-page application** with fast client-side navigation and relies on React to make the site interactive.
...
## Initializing an Docusaurus project on the edge
...
3. Choose the Docusaurus preset: 
...
- [If you chose to have a local development server running](/en/documentation/guides/application-development/frameworks/docusaurus/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/guides/application-development/frameworks/docusaurus/#answering-no-to-local-dev).
...
2. On the browser, go to `http://localhost:3333/` and you can see your Docusaurus project running.
...
After indicating you don't want to have a local server running, deploy the Docusaurus project to the edge.
