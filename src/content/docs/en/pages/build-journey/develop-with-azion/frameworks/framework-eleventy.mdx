---
title: How to build with Eleventy
description: >-
  Learn how to initialize and deploy an Eleventy project on the Azion platform
  using Functions, featuring guides on setting up with the Azion CLI and
  managing deployments.
permalink: /documentation/guides/application-development/frameworks/eleventy/
meta_tags: >-
  Eleventy, Functions, Azion platform, Jamstack, static site generator, 
  Application, project deployment, Azion CLI, local development server, Edge
  Computing
namespace: docs_framework_eleventy
---
...
Eleventy (11ty) is listed on [the Jamstack documentation](https://jamstack.org/generators/eleventy/) as a static site generator, aligned to the Jamstack approach.

Learn more about [Eleventy](https://www.11ty.dev/).
...
## Initializing an Eleventy project on the edge
...
- [If you chose to have a local development server running](/en/documentation/guides/application-development/frameworks/eleventy/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/guides/application-development/frameworks/eleventy/#answering-no-to-local-dev).
...
2. On the browser, go to `http://localhost:3333/` and you can see your Eleventy project running.
...
After indicating you don't want to have a local server running, deploy the Eleventy project to the edge.
