...
permalink: /documentation/products/cli/frameworks/eleventy/
meta_tags: >-
  Eleventy, Edge Functions, Azion platform, Jamstack, static site generator, Edge
...
Now, Eleventy's CLI will follow the process and initialize your Eleventy project.
...
- [If you chose to have a local development server running](/en/documentation/products/cli/frameworks/eleventy/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/products/cli/frameworks/eleventy/#answering-no-to-local-dev).
