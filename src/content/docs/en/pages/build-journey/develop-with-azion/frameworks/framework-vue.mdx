...
description: >-
  ...
  Platform.
permalink: /documentation/guides/application-development/frameworks/vue/
meta_tags: >-
...
- [If you chose to have a local development server running](/en/documentation/guides/application-development/frameworks/vue/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/guides/application-development/frameworks/vue/#answering-no-to-local-dev).
