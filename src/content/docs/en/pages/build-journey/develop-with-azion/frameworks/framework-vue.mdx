...
description: >-
  ...
  initializing and deploying your project using Azion Edge Functions and
  Platform.
permalink: /documentation/products/cli/frameworks/vue/
meta_tags: >-
  Vue.js, JavaScript Framework, Front-End Development, Edge Functions, Azion
  Platform, Edge Application Deployment, Local Development Server, Vue Project
