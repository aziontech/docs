...
permalink: /documentation/products/cli/frameworks/gatsby/
meta_tags: >-
  Gatsby, Edge Functions, Azion platform, Jamstack, static site generator, Edge
...
Now, Gatsby's CLI will follow the process and initialize your Gatsby project.
...
- [If you chose to have a local development server running](/en/documentation/products/cli/frameworks/gatsby/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/products/cli/frameworks/gatsby/#answering-no-to-local-dev).
