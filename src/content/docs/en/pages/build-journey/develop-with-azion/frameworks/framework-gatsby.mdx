---
title: How to build with Gatsby
description: >-
  Learn how to initialize and deploy an Gatsby project on the Azion platform
  using Functions, featuring guides on setting up with the Azion CLI and
  managing deployments.
permalink: /documentation/guides/application-development/frameworks/gatsby/
meta_tags: >-
  Gatsby, Functions, Azion platform, Jamstack, static site generator, 
  Application, project deployment, Azion CLI, local development server, Edge
  Computing
namespace: docs_framework_gatsby
---
...
Gatsby is listed on [the Jamstack documentation](https://jamstack.org/generators/gatsby/) as a static site generator, aligned to the Jamstack approach.

Learn more about [Gatsby](https://www.gatsbyjs.com/docs/).
...
- [If you chose to have a local development server running](/en/documentation/guides/application-development/frameworks/gatsby/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/guides/application-development/frameworks/gatsby/#answering-no-to-local-dev).
