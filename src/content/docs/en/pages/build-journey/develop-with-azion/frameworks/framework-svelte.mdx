---
title: How to build with Svelte
description: >-
  Learn how to initialize and deploy an Svelte project on the Azion platform
  using Functions, featuring guides on setting up with the Azion CLI and
  managing deployments.
permalink: /documentation/guides/application-development/frameworks/svelte/
meta_tags: >-
  Svelte, Functions, Azion platform, static site generator, 
  Application, project deployment, Azion CLI, local development server, Edge
  Computing
namespace: docs_framework_svelte
---
...
Learn more about [Svelte](https://svelte.dev/docs/introduction).
...
## Initializing an Svelte project on the edge
...
- [If you chose to have a local development server running](/en/documentation/guides/application-development/frameworks/svelte/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/guides/application-development/frameworks/svelte/#answering-no-to-local-dev).
...
2. On the browser, go to `http://localhost:3333/` and you can see your Svelte project running.
...
After indicating you don't want to have a local server running, deploy the Svelte project to the edge.
