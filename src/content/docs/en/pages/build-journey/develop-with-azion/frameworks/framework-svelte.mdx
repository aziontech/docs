...
permalink: /documentation/products/cli/frameworks/svelte/
meta_tags: >-
  Svelte, Edge Functions, Azion platform, static site generator, Edge
...
Now, Svelte's CLI will follow the process and initialize your Svelte project.
...
- [If you chose to have a local development server running](/en/documentation/products/cli/frameworks/svelte/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/products/cli/frameworks/svelte/#answering-no-to-local-dev).
