...
description: Learn how to deploy a React project using Azion CLI, optimize it for the Edge, and utilize Edge Functions, with a complete guide on setting up and deploying on the Azion platform.
permalink: /documentation/products/cli/frameworks/react/
meta_tags: React, Edge Functions, Azion, Jamstack, React Static Site, Azion CLI, React project, Edge deployment, React application, React template
