...
description: >-
  ...
  and utilize Edge Functions, with a complete guide on setting up and deploying
  on the Azion platform.
permalink: /documentation/products/cli/frameworks/react/
meta_tags: >-
  React, Edge Functions, Azion, Jamstack, React Static Site, Azion CLI, React
...
- [If you chose to have a local development server running](/en/documentation/products/cli/frameworks/react/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/products/cli/frameworks/react/#answering-no-to-local-dev).
