...
description: >-
  Learn how to deploy a React project using Azion CLI, optimize it for the Edge,
  and utilize Functions, with a complete guide on setting up and deploying
  on the Azion platform.
permalink: /documentation/guides/application-development/frameworks/react/
meta_tags: >-
  React, Functions, Azion, Jamstack, React Static Site, Azion CLI, React
  project, Edge deployment, React application, React template
namespace: docs_framework_react
---
...
- [If you chose to have a local development server running](/en/documentation/guides/application-development/frameworks/react/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/guides/application-development/frameworks/react/#answering-no-to-local-dev).
...
2. On the browser, go to `http://localhost:3333/` and you can now see your React project running.
