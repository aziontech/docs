---
title: How to build with Jekyll
description: >-
  Learn how to initialize and deploy an Jekyll project on the Azion platform
  using Functions, featuring guides on setting up with the Azion CLI and
  managing deployments.
permalink: /documentation/guides/application-development/frameworks/jekyll/
meta_tags: >-
  Jekyll, Functions, Azion platform, Jamstack, static site generator, 
  Application, project deployment, Azion CLI, local development server, Edge
  Computing
namespace: docs_framework_jekyll
---
...
## Initializing an Jekyll project on the edge
...
- [If you chose to have a local development server running](/en/documentation/guides/application-development/frameworks/jekyll/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/guides/application-development/frameworks/jekyll/#answering-no-to-local-dev).
...
2. On the browser, go to `http://localhost:3333/` and you can see your Jekyll project running.
...
After indicating you don't want to have a local server running, deploy the Jekyll project to the edge.
