...
permalink: /documentation/products/cli/frameworks/jekyll/
meta_tags: >-
  Jekyll, Edge Functions, Azion platform, Jamstack, static site generator, Edge
...
Now, Jekyll's CLI will follow the process and initialize your Jekyll project.
...
- [If you chose to have a local development server running](/en/documentation/products/cli/frameworks/jekyll/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/products/cli/frameworks/jekyll/#answering-no-to-local-dev).
