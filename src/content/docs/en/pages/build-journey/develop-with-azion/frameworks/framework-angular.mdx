...
description: Learn to initialize and deploy your Angular project on the Azion Edge Platform using Edge Functions, enhancing your web development capabilities.
permalink: /documentation/products/cli/frameworks/angular/
meta_tags: Angular, Edge Functions, Azion Edge Platform, Web Framework, Angular CLI, Local Development Server, Deploy Angular to Edge, JavaScript Development, Edge Application, Angular Project
