...
description: >-
  Learn to initialize and deploy your Angular project on the Azion Web Platform
  using Functions, enhancing your web development capabilities.
permalink: /documentation/guides/application-development/frameworks/angular/
meta_tags: >-
  Angular, Functions, Azion Web Platform, Web Framework, Angular CLI,
  Local Development Server, Deploy Angular to Edge, JavaScript Development,
...
- [If you chose to have a local development server running](/en/documentation/guides/application-development/frameworks/angular/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/guides/application-development/frameworks/angular/#answering-no-to-local-dev).
