...
description: Learn how to initialize and deploy a Next.js project on the Azion Edge
  Platform, leveraging Edge Functions and the latest Node.js features.
permalink: /documentation/products/cli/frameworks/next/
meta_tags: Azion, Next.js, Edge Functions, Azion Platform, Edge Application, Deploy
  Next Project, Node.js, Local Development Server, Azion Edge Deployment, Next.js
  on Edge
