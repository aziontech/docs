...
description: >-
  ...
  Platform, leveraging Functions and the latest Node.js features.
permalink: /documentation/guides/application-development/frameworks/next/
meta_tags: >-
  Azion, Next.js, Functions, Azion Platform, Applications, Deploy Next
...
- An [Azion platform account](/en/documentation/fundamentals/creating-account/) with [Functions](/en/documentation/build/functions/) enabled.
- [The latest version of Azion CLI installed](/en/documentation/devtools/cli/).
- Code editor.
...
- [If you chose to have a local development server running](/en/documentation/guides/application-development/frameworks/next/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/guides/application-development/frameworks/next/#answering-no-to-local-dev).
...
2. On the browser, go to `http://localhost:3333/`, and you can now see your Next project running.
