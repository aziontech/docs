...
:::note 
This guide covers the initialization of a Next.js static project. The project is always initialized in Next.js latest version for the deliver (static) mode.
:::
