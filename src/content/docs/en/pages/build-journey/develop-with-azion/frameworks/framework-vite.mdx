...
description: Learn how to initialize and deploy a Vite project on the Azion Edge Platform using Edge Functions and the Azion CLI, enhancing your frontend development skills.
permalink: /documentation/products/cli/frameworks/vite/
meta_tags: Vite, Azion Edge Functions, Edge Computing, Jamstack, Static Site Generator, Azion CLI, Node.js, Frontend Development, Application Deployment, Local Development Server
