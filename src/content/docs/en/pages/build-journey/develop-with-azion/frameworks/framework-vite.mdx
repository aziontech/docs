---
title: How to build with VitePress
description: >-
  Learn how to initialize and deploy a VitePress project on the Azion Web Platform
  using Functions and the Azion CLI, enhancing your frontend development
  skills.
permalink: /documentation/guides/application-development/frameworks/vite/
meta_tags: >-
  Vitepress, Azion Functions, Edge Computing, Jamstack, Static Site Generator,
  Azion CLI, Node.js, Frontend Development, Application Deployment, Local
  Development Server
...
VitePress is listed on [the Jamstack documentation](https://jamstack.org/generators/vitepress/) as a static site generator, aligned to the Jamstack approach. It is powered by [Vue](https://vuejs.org/guide/introduction.html).

Learn more about [Vite](https://vitejs.dev/) and [VitePress](https://vitepress.dev/guide/what-is-vitepress). 
...
- [If you chose to have a local development server running](/en/documentation/guides/application-development/frameworks/vite/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/guides/application-development/frameworks/vite/#answering-no-to-local-dev).
...
2. On the browser, go to `http://localhost:3333/` and you can now see your VitePress project running.
