...
description: >-
  Learn how to initialize and deploy a Vite project on the Azion Edge Platform
  using Edge Functions and the Azion CLI, enhancing your frontend development
  skills.
permalink: /documentation/products/cli/frameworks/vite/
meta_tags: >-
  Vite, Azion Edge Functions, Edge Computing, Jamstack, Static Site Generator,
...
- [If you chose to have a local development server running](/en/documentation/products/cli/frameworks/vite/#answering-yes-to-local-dev).
- [If you chose not to have a local development server running](/en/documentation/products/cli/frameworks/vite/#answering-no-to-local-dev).
...
Learn how to build with Vite. Watch the video below:
<div class="cms-embed">
  <iframe width="600" height="400" src="https://www.youtube.com/embed/0r1nM5KqTFg?si=T4Z2WPX9EnyxgtLq" loading="lazy" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
