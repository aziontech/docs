...
7. In the **Expiration Settings** section, configure the [expiration policy](/en/documentation/products/build/edge-application/cache-settings/#browser-cache-settings) for your images.
