...
description: >-
  Explore how to configure Load Balancer for Applicationss on Azion,
...
There are separate instructions for API v3 using [legacy Origin](/en/documentation/products/build/edge-application/origins/) settings and API v4 using the new [Connector](/en/documentation/products/secure/edge-connector) product.
