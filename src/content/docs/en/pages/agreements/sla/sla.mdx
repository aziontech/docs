...
The availability of Applications, Cache, Tiered Cache, Load Balancer, Image Processor, Application Accelarator, Functions, Firewall, Network Shield and Web Application Firewall (WAF) services is to be calculated according to the same rules and their respective features correctly set up on the Azion Console for the Test Object.
...
The availability of Content Delivery, Cloud Storage, Load Balancer, Image Optimization, Application Acceleration, Adaptive Delivery, Firewall, and Web Application Firewall (WAF) services is to be calculated according to the same rules and their respective features correctly set up on the Azion Real-Time Manager for the Test Object.
