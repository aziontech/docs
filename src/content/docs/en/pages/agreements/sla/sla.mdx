...
The availability of Edge Application, Edge Cache, Tiered Cache, Load Balancer, Image Processor, Application Acceleration, Adaptive Delivery, Edge Functions, Edge Firewall, and Web Application Firewall (WAF) services is to be calculated according to the same rules and their respective features correctly set up on the Azion Real-Time Manager for the Test Object.
