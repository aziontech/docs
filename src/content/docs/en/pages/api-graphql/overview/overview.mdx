...
You can maximize the use of your data accessed through two Azion GraphQLs:

- [Real-Time Metrics GraphQL API](/en/documentation/products/real-time-metrics/), which provides you with real-time access to metrics so you can optimize all of your potential.
- [Real-Time Events GraphQL API](/en/documentation/products/real-time-events/), which provides data in real time so you can perform complex searches to explore your information.

With the Real-Time Metrics GraphQL API, you can:
...
With the Real-Time Events GraphQL API, you can:

- View top IPs that generate most requests.
- View top URIs that generate most requests.
