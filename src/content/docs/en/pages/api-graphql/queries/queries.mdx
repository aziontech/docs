...
- Which consulted data should be exhibited. On the presented example, the **ts** and **sum** fields were used, in which **sum** represents the response of the **requestTime** aggregation.
