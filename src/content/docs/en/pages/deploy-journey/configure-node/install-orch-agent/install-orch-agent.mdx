...
description: Learn how to download and install the Azion Edge Orchestrator for various
  OS like Linux, FreeBSD, and MacOS, including command line instructions.
permalink: /documentation/products/guides/deploy/install-orchestrator-agent/
meta_tags: Edge Orchestrator, Edge Node, installation, download, Azion, download Edge
