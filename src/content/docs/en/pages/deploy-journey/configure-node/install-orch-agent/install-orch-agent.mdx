...
<Button href="/en/documentation/products/guides/personal-tokens/" label="go to how to generate a personal token" type="primary" theme="light" />
<Button href="/en/documentation/products/accounts/personal-tokens/" label="go to Personal Token reference documentation" type="primary" theme="light" target="_blank" />
