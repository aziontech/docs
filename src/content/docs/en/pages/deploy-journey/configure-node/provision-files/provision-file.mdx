...
description: Learn how to configure and deploy resources via Azion Console and API, manage edge services, and effectively use edge nodes and orchestrators.
permalink: /documentation/products/guides/deploy/provision-files/
meta_tags: Azion Console, Azion API, Edge Services, Configure Edge Resources, Deploy Edge Resources, API Resource Management, Edge Node Configuration, Edge Service Orchestrator, Shell Script Edge, Text Resource Edge
...
<LinkButton link="/en/documentation/products/guides/deploy/work-with-variables/" label="Go to Work with Variables Guide" outlined target="_blank" />