...
permalink: /documentation/guides/application-development/automation/provision-files/
meta_tags: >-
...
1. Run the following `GET` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/guides/platform/account-and-billing/personal-tokens/) and retrieve the edge service ID:
...
<DocButton href="/en/documentation/guides/application-development/automation/work-with-variables/" label="Go to Work with Variables Guide" kind="secondary" target="_blank" size="medium" />