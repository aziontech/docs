...
description: Learn to create and deploy edge services using Azion Console and API, configuring resources and activating with ease for efficient edge node deployment.
permalink: /documentation/products/guides/deploy/create-edge-service/
meta_tags: Edge Service, Azion Console, Azion API, Deploy Edge Service, Edge Node Deployment, Create Edge Service, Edge Service Tutorial, Edge Computing, Service Configuration, Edge Resources
