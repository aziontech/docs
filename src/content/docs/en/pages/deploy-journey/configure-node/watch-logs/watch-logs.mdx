...
<Button href="http://localhost:3000/en/documentation/products/guides/deploy/advanced/run-scripts/" text="go to how to run scripts" variant="secondary" target="_blank"></Button>
