...
description: Learn to manage your edge node and service logs with the Edge Orchorstrator
  Agent, including deployment and troubleshooting.
permalink: /documentation/products/guides/deploy/watch-logs/
meta_tags: Edge Orchestrator Agent, edge node logs, edge services logs, deploy edge
...
<LinkButton link="http://localhost:3000/en/documentation/products/guides/deploy/advanced/run-scripts/" label="go to how to run scripts" outlined target="_blank" />
