...
This command outputs the logs related to the edge node in specific, presenting the logs of the install, update, and delete triggers that were configured inside the edge service.
