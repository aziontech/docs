...
description: >-
  Learn to manage your edge node and service logs with the Orchorstrator
  Agent, including deployment and troubleshooting.
permalink: /documentation/guides/application-development/automation/watch-logs/
meta_tags: >-
...
1. Access your [edge node](/en/documentation/guides/application-development/automation/install-orchestrator-agent/).
2. Open the terminal. 
...
<DocButton href="/en/documentation/guides/application-development/automation/run-scripts/" label="go to how to run scripts" kind="secondary" target="_blank" size="medium" />
