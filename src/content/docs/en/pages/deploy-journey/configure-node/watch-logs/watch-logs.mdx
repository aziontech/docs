...
<LinkButton outlined link="http://localhost:3000/en/documentation/products/guides/deploy/advanced/run-scripts/" label="go to how to run scripts" variant="secondary" target="_blank" />
