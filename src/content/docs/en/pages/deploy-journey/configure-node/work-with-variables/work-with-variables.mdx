...
description: Explore how to utilize variables in Edge Orchestrator with Azion Console
  and API to manage and override edge service and node variables effectively.
permalink: /documentation/products/guides/deploy/work-with-variables/
meta_tags: Edge Orchestrator, Azion Console, API, edge service variables, edge node
