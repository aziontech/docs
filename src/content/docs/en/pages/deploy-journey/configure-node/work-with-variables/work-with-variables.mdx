...
During the deployment process on **Edge Orchestrator**, you can work with variables. A variable can be set on an [edge service](#edge-services-variables) and an [edge node](#edge-node-variables).
