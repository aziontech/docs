...
description: Explore how to utilize variables in Edge Orchestrator with Azion Console and API to manage and override edge service and node variables effectively.
permalink: /documentation/products/guides/deploy/work-with-variables/
meta_tags: Edge Orchestrator, Azion Console, API, edge service variables, edge node variables, deploy, orchestrator
...
1. Navigate to the **Resources** tab. 
2. Click on **Add Resource** or select the resource to which you wish to use the variable.
3. Enter the **Path** of the resource.
4. Choose the type **Text**.
5. Add the following content to the content block: 
...
<Fragment slot="panel.console">
1. Go to [Azion Console](/en/documentation/products/guides/how-to-access-azion-console/) > **Edge Nodes**.
...
<Fragment slot="panel.rtm">
1. Go to [Real-Time Manager (RTM)](https://manager.azion.com/) > **Edge Nodes**.
2. Select the edge node to which you want to add a variable.
3. Go to the **Services** tab.
4. Choose the service to which you want to apply the variable.
5. Add the following content to the variables block: 
...
1. Go to [Real-Time Manager (RTM)](https://manager.azion.com/) > **Edge Libraries** > **Edge Services** and select the service related to the resource. 
