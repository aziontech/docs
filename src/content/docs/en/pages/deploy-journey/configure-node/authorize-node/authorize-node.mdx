...
description: >-
  ...
  optimal Edge Services integration and Edge Orchestrator.
permalink: /documentation/products/guides/deploy/authorize-an-edge-node/
meta_tags: >-
  Azion, Edge Node, Authorization, Edge Orchestrator, API, Deployment, Edge
...
3. Click on the three dots button and then click **Authorize**.
