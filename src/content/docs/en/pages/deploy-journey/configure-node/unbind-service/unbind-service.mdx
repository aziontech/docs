...
description: Learn how to unbind services from edge nodes using the Azion Console and API, with detailed steps on execution of DELETE requests through Curl commands.
permalink: /documentation/products/guides/deploy/unbind-service/
meta_tags: Azion Console, Edge Nodes, Unbind Services, API, DELETE request, Edge Service, Azion API, Edge Node Management, Curl Commands, Configuration Steps
...
2. Select the edge node to which you want to unbind a service.
3. Go to the **Services** tab.
4. Find the service you wish to unbind.
5. Click on the icon of a trash can. 
6. Confirm the unbind in the modal.
</Fragment>
