...
description: Learn how to unbind services from edge nodes using the Azion Console
  and API, with detailed steps on execution of DELETE requests through Curl commands.
permalink: /documentation/products/guides/deploy/unbind-service/
meta_tags: Azion Console, Edge Nodes, Unbind Services, API, DELETE request, Edge Service,
