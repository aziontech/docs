...
description: Explore Azion's API for seamless automation of credentials, edge services,
  and nodes, designed to boost developer experience and resource management.
permalink: /documentation/products/deploy/automate/api/
meta_tags: Azion API, automate management, developer experience, API documentation,
  Edge Services API, credentials API, edge nodes API, resource automation
