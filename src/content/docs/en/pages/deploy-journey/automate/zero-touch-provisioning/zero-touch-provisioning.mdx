---
title: Automate with zero-touch provisioning
...
Zero-touch provisioning, is a feature that allows for the automatic provisioning of files and configurations.
...
1. Install the Edge Orchestrator Agent on your device. This device now represents an edge node.
2. Authorize the node on the Azion platform.
