...
Azion Edge Services facilitates resource registration and configuration through [Real-Time Manager (RTM)](), enabling service orchestration on specified edge nodes.
