...
<LinkButton link="/en/documentation/products/deploy/edge-orchestrator/" label="go to Orchestrator reference documentation" severity="secondary" target="_blank" />
...
<LinkButton link="/en/documentation/products/deploy/edge-orchestrator/edge-services/" label="go to edge services reference documentation" severity="secondary" target="_blank" />
