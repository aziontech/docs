...
description: Explore the comprehensive guide on using Edge Orchestrator for real-time management and deployment of edge services and resources, featuring step-by-step instructions.
permalink: /documentation/products/deploy/deploy-a-service/
meta_tags: Edge Orchestrator, edge service management, real-time edge control, edge resources, edge deployment, managing edge services, edge node authorization, edge orchestration guide, install edge agent, edge service API
...
<LinkButton link="/en/documentation/products/guides/deploy/provision-files/" label="go to how to provision files" outlined target="_blank" />
...
<LinkButton link="/en/documentation/products/guides/deploy/generate-credentials/" label="go to create a credential" outlined />
...
<br/>
<LinkButton link="/en/documentation/products/deploy/edge-orchestrator/edge-node/" label="go to edge node reference documentation" outlined />
...
<LinkButton link="/en/documentation/products/guides/deploy/bind-service-node/" label="how to bind an edge service to an edge node" outlined target="_blank" />
