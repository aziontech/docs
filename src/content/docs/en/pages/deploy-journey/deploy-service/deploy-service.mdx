...
description: Explore the comprehensive guide on using Edge Orchestrator for real-time
  management and deployment of edge services and resources, featuring step-by-step
  instructions.
permalink: /documentation/products/deploy/deploy-a-service/
meta_tags: Edge Orchestrator, edge service management, real-time edge control, edge
  resources, edge deployment, managing edge services, edge node authorization, edge
  orchestration guide, install edge agent, edge service API
