...
<Button href="/en/documentation/products/deploy/edge-orchestrator/edge-node/#agent-commands-and-options" label="Go to Orchestrator agent" type="primary" theme="light" target="_blank" />
