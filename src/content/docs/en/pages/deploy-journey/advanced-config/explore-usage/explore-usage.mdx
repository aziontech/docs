...
<LinkButton link="/en/documentation/products/deploy/edge-orchestrator/edge-node/#agent-commands-and-options" label="Go to Orchestrator agent's commands reference" severity="secondary" target="_blank" />
