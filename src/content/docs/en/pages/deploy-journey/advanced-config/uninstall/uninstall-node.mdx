...
description: Uninstall Azion Edge Orchestrator Agent and remove an edge node from the list of nodes.
...
:::note 
Uninstalling the agent from your device doesn't remove the node from the list of nodes. To complete the process, you need to remove your node from the list of available edge nodes.
::: 
