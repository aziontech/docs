...
permalink: /documentation/guides/application-development/automation/run-scripts/
meta_tags: >-
...
This guide presents how to install [Azion CLI](/en/documentation/devtools/cli/) on your edge nodes through a resource of the type `Shell Script` configured on a specific edge service. 
...
1. Run the following `POST` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/guides/platform/account-and-billing/personal-tokens/) and informing the name of the service being created:
...
3. Run the following `PATCH` request in your terminal to set the service as active, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/guides/platform/account-and-billing/personal-tokens/):
...
<Fragment slot="panel.api">
1. Run the following `GET` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/guides/platform/account-and-billing/personal-tokens/) and retrieve the edge node ID you wish to bind to an edge service:
...
Replace `[TOKEN VALUE]` with your [personal token](/en/documentation/guides/platform/account-and-billing/personal-tokens/), `:id` with the ID of the edge node and inform the ID of the service in the request body:
