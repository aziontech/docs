...
Replace `[TOKEN VALUE]` with your [personal token](/en/documentation/products/guides/personal-tokens/), `<nodeId>` with the ID of the edge node and inform the ID of the service in the request body:
