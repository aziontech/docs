...
og_image: ''
permalink: /documentation/products/guides/deploy/run-scripts/
---
...
```bash 
{"id":1196,"name":"Azion CLI Installation","updated_at":"2024-01-18T17:24:33Z","last_editor":"xxxxx","active":false,"bound_nodes":0,"permissions":["read","write"]}
```
...
:::note 
If an edge service isn't set as active, it's not available for binding to an edge node.
:::

### Creating a resource

1. Run the following `POST` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/products/guides/personal-tokens/), `:id` with the ID of the edge service and informing the following parameters in the request body:
...
1. Run the following `LIST` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/products/guides/personal-tokens/) and retrieve the edge node ID you wish to bind to an edge service:
...
2. Run the following `POST` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/products/guides/personal-tokens/), `:id` with the ID of the edge node and informing the ID of the service in the request body:
