...
2. Select the edge service you want to add a resource.
...
<Button href="" text="go to work with variables" variant="secondary" target="_blank"></Button>
