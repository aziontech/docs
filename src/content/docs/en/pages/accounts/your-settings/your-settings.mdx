...
On the **Your Settings** page you can edit and manage your personal information, preferences, and security settings within the [Real-Time Manager (RTM)](https://manager.azion.com/).. 

> To see the general information of the account check the [Account Settings](/en/documentation/products/accounts/your-settings/) page. 
