...
The **Users Management** functionality on Real-Time Manager (RTM) gives you tools to efficiently manage users in your account. This feature enables you to add, modify, and delete users, granting you control over who has access to your RTM account and its associated resources. To add users to the account you need to have _Account Owner_ privilegies or have the permissions to **View Users** and **Edit Users**.

In the **User Management** you can easily:
...
In this section, youl'll fill with the new user's personal information. 
...
In this section, youl'll need to provide the new user's contact information. 
...
In here, you can set security measures to the new user's account.
