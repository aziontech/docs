...
Using the SSO you can:

- Reduce password-related issues.
- Enhace security, minimizing potencial vulnerabilities.
- Reduce support requests, since the user manage fewer passwords.
- Enable seamless navigation between app
