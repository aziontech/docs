...
The Billing page provides a comprehensive view of your usage-based pricing model. It's where you see how you're charged for using Azion products based on what you use.
