...
Advantages of setting MFA in you account:
...
Incorrect Pairing: errors may occur if the authenticator app is not correctly paired with the RTM account.
...
Lost mobile device: without backup access methods, a lost or damaged mobile device could result in account lockout. In this case, you need to ask the _Account Owner_ to restore your MFA
