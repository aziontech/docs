...
In this part, you need the fill with the affiliate details.
...
After confirming the registration, the Account owner receives an automatic email to activate the account, which will be available for 14 days. If it's not activated within that period, the Account owner will be automatically removed from the **Real-Time Manager**.
