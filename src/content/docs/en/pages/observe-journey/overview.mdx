...
<LinkButton link="/en/documentation/products/observe/monitor-applications/" label="go to monitor applications" outlined target="_blank" />
...
<LinkButton link="/en/documentation/products/observe/analyze-logs/" label="go to analyze logs" outlined target="_blank" />
...
<LinkButton link="/en/documentation/products/observe/stream-data/" label="go to stream data" outlined target="_blank" />
...
<LinkButton link="/en/documentation/products/guides/observe/analyze-navigation-data/" label="go collect navigation data" outlined target="_blank" /><br />
