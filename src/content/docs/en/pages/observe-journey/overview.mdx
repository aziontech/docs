...
<Button href="/en/documentation/products/observe/monitor-applications/" label="go to monitor applications" type="primary" theme="light" target="_blank" />
...
<Button href="/en/documentation/products/observe/analyze-logs/" label="go to analyze logs" type="primary" theme="light" target="_blank" />
...
<Button href="/en/documentation/products/observe/stream-data/" label="go to stream data" type="primary" theme="light" target="_blank" />
...
<Button href="/en/documentation/products/guides/observe/analyze-navigation-data/" label="go collect navigation data" type="primary" theme="light" target="_blank" /><br />
