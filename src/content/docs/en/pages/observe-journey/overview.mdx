...
<LinkButton outlined link="/en/documentation/products/observe/monitor-applications/" label="go to monitor applications" variant="secondary" target="_blank" />
...
<LinkButton outlined link="/en/documentation/products/observe/analyze-logs/" label="go to analyze logs" variant="secondary" target="_blank" />
...
<LinkButton outlined link="/en/documentation/products/observe/stream-data/" label="go to stream data" variant="secondary" target="_blank" />
...
<LinkButton outlined link="/en/documentation/products/guides/observe/analyze-navigation-data/" label="go collect navigation data" variant="secondary" target="_blank" />
<br /><br />
---
