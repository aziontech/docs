...
You can also use [GraphQL API](/en/documentation/devtools/graphql/overview/) to query your data via API and customize your queries.

![Overview of a Real-Time Metrics query flow](/assets/docs/images/uploads/real-time-metrics-overview.png)

<DocButton href="/en/documentation/platform/real-time-metrics/" label="go to monitor applications" kind="secondary" target="_blank" size="medium" />

## Real-Time Events

Analyze logs in real time through detailed lists of variables to understand and diagnose behaviors.

You can also use [GraphQL API](/en/documentation/devtools/graphql/overview/) to query your data via API, customize your queries, and create top X queries.

![Overview of a Real-Time Events query flow](/assets/docs/images/uploads/real-time-events-overview.png)

<DocButton href="/en/documentation/observe/real-time-events/" label="go to analyze logs" kind="secondary" target="_blank" size="medium" />
...
<DocButton href="/en/documentation/observe/data-stream/" label="go to stream data" kind="secondary" target="_blank" size="medium" />
...
<DocButton href="/en/documentation/guides/platform/observability/analyze-navigation-data/" label="go collect navigation data" kind="secondary" target="_blank" size="medium" /><br />
