...
<DocButton href="/en/documentation/guides/platform/observability/analyze-navigation-data/" label="go collect navigation data" kind="secondary" target="_blank" size="medium" />
