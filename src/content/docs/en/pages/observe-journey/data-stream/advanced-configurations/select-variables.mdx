...
<LinkButton link="/en/documentation/products/guides/use-data-stream/" label="go to how to configure a stream guide" outlined />
...
<LinkButton link="/en/documentation/products/guides/data-stream-custom-template/" label="go to custom template via Azion Console guide" outlined /> <br /><br />

<LinkButton link="https://api.azion.com/#e4586549-13a9-4bc2-a37e-9000e4588d9a" label="go to custom template api request" outlined /><br />
---
