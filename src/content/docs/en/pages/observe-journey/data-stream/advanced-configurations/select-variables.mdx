...
<DocButton href="/en/documentation/products/guides/use-data-stream/" label="go to how to configure a stream guide" kind="secondary" size="medium" />
...
<DocButton href="/en/documentation/products/guides/data-stream-custom-template/" label="go to custom template via Azion Console guide" kind="secondary" size="medium" /> <br /><br />
