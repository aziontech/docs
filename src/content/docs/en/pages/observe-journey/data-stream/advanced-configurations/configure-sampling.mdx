...
When you [configure a stream](/en/documentation/products/guides/use-data-stream/) and choose to associate all of your workloads, you can configure the **Sampling** option to filter the percentage of data you'll be streaming. It's a viable option to reduce the costs of data collection and analysis.
...
3. On **Workloads** > **Options**, choose **All Curent and Future workloads**.
