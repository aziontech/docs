...
permalink: /documentation/guides/platform/observability/endpoint-amazon-kinesis/
---
...
You can keep track of the calls made by Data Stream to Amazon Kinesis Data Firehose on [Real-Time Events](/en/documentation/observe/real-time-events/). To do so, select **Data Source** > **Data Stream** and choose the filters options as you wish.
