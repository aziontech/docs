...
3. On **Encoded API Key**, add the `Base64` key corresponding to the `"encoded"` value generated during the creation of the API key in ElasticSearch. Example: `VnVhQ2ZHY0JDZGJrUW0tZTVhT3g6dWkybHAyYXhUTm1zeWFrdzl0dk5udw==`
...
Learn how to use Elasticsearch to receive data from Data Stream. Watch the video below:

<div class="cms-embed">
  <iframe width="600" height="400" src="https://www.youtube.com/embed/VdoISBuwYxI?si=r8sE599SVJbn8Xto" loading="lazy" title="How to use Elasticsearch to receive data from Data Stream" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
