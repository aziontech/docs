...
description: Hands-on to use Azure Monitor streaming to receive data from Azion Data Stream.
...
While configuring [Data Streams](/en/documentation/products/observe/data-stream/), you need to set up a specific endpoint to stream your Azion data.
