...
permalink: /documentation/guides/platform/observability/endpoint-azure-monitor/
---

import Tabs from '~/components/tabs/Tabs'


While configuring [streams](/en/documentation/observe/data-stream/), you need to set up a specific endpoint to stream your Azion data.
...
You can find detailed steps for the entire configuration on the [How to use Data Stream guide](/en/documentation/guides/platform/observability/use-data-stream/).
...
You can keep track of the calls made by Data Stream to Azure Monitor on [Real-Time Events](/en/documentation/observe/real-time-events/). To do so, select **Data Source** > **Data Stream** and choose the filters options as you wish.
