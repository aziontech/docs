...
permalink: /documentation/guides/platform/observability/connector-standard-https-post/
---
...
You can find detailed steps for the entire configuration on the [How to configure Data Stream main settings](/en/documentation/guides/platform/observability/use-data-stream/) guide.
...
1. Run the following `POST` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/guides/platform/account-and-billing/personal-tokens/) to create your data stream.
...
:::tip
With this type of connector, you can also [set up a payload](/en/documentation/guides/platform/observability/data-stream-set-payload/).
:::

You can keep track of the calls made by Data Stream to Datadog on [Real-Time Events](/en/documentation/observe/real-time-events/). To do so, select **Data Source** > **Data Stream** and choose the filters options as you wish.
<br /><br />
---
