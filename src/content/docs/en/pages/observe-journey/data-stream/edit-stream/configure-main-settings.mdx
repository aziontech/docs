...
In this section, you’ll modify the main settings of your stream: name, data source, template, workloads, and destination via [Azion Console](https://console.azion.com).
...
6. On **Workloads** > **Options**, select between ****All Curent and Future workloads** or **Filter workloads**.
    - See more about each option on [How to associate workloads on Data Stream](/en/documentation/products/guides/data-stream-associate-workloads/).
...
| `all_domains` | Used to associate all current and future workloads in your account to the stream |
