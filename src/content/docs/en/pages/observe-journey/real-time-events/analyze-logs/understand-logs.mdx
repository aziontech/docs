...
You have the option of querying a [general search](querying-a-general-search) and receive all possible variables and values or querying a [filtered search](querying-a-filtered-search), so you can decide which variables will be queried.

<LinkButton outlined link="/en/documentation/products/guides/observe/add-filters-events/" label="go to add filters guide" variant="secondary" target="_blank" />
