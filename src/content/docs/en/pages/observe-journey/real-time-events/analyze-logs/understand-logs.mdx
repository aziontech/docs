...
permalink: /documentation/guides/platform/observability/understand-logs/
---
...
You can find all available variables, their descriptions, and examples in the [data source](/en/documentation/observe/real-time-events/#data-sources) reference.
...
<DocButton href="/en/documentation/guides/platform/observability/add-filters-events/" label="go to add filters guide" kind="secondary" target="_blank" size="medium" />
