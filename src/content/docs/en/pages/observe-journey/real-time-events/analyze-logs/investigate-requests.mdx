...
<LinkButton link="/en/documentation/products/guides/blocklists-ip-addresses-edge/#associate-network-list-with-edge-firewall-rule-set" label="go to associate network list to rule guide" outlined target="_blank" />
