...
<LinkButton outlined link="/en/documentation/products/guides/blocklists-ip-addresses-edge/#associate-network-list-with-edge-firewall-rule-set" label="go to associate network list to rule guide" variant="secondary" target="_blank" />
