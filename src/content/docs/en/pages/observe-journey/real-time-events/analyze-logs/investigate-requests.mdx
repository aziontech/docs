...
<Button href="/en/documentation/products/guides/blocklists-ip-addresses-edge/#associate-network-list-with-edge-firewall-rule-set" label="go to associate network list to rule guide" type="primary" theme="light" target="_blank" />
...
2. Select an existing firewall or [create a new one](/en/documentation/products/guides/secure/edge-firewall-configure-main-settings/).
