...
Once you [understand Real-Time Events logs](/en/documentation/products/guides/observe/understand-logs/) and decide the variables you want to query, you can use the filter and query for more exact results.

If you run a query with blank Filter by field, you’ll get all existing records for the variables of the selected data source available during the selected time filter.
