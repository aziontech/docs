...
description: The Azion data source plugin on Grafana allows you to visualize the data from your Azion edge applications on a Grafana dashboard.
meta_tags: azion, edge, observe, observability, logs, grafana, analytics
namespace: docs_plugin_grafana_log_table
permalink: /documentation/products/guides/observe/azion-plugin-grafana-customize-log-table/
---
