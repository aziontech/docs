...
permalink: /documentation/guides/platform/observability/azion-plugin-grafana-customize-log-table/
---
...
5. On the code box, add the query you want to use.
    - See the [GraphQL API guides](/en/documentation/devtools/graphql/overview/) for a few examples of queries.
