...
In this section, you’ll modify the main settings of your streaming: name, data source, template, domains, and destination via [Real-Time Manager (RTM)](https://console.azion.com/).
