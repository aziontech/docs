...
To find more detailed information on the product and each configurationm, see the [reference documentation](/en/documentation/products/observe/data-streaming/).
...
4. On the **Data Source** dropdown menu, select the one you want to use: **Activity History**, **Edge Applications**, **Edge Functions**, or **WAF Events**. For **Edge Functions** and **WAF Events**, you must be [subscribed to the products](/en/documentation/products/data-streaming/first-steps/).
...
6. On **Options**, select between **Filter Domains** or **All Domains**. See more about each option on [How to associate domains on Data Streaming](/en/documentation/products/guides/data-streaming-associate-domains/).
...
For the API guide, you'll be modifying an existing streaming with an Elasticsearch connector. To create a new one, use the [Data Streaming POST method](https://api.azion.com/#b9aac0c7-173a-462b-87f6-a18d6558d3e5).

You can also check the [Data Streaming Properties](https://api.azion.com/#b9aac0c7-173a-462b-87f6-a18d6558d3e5) table to see all available properties and their accepted values.
