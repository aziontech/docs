---
title: How to set a payload on Data Streaming
...
permalink: /documentation/products/guides/observe/data-streaming-set-payload/
menu_namespace: observeMenu
---

import Button from '~/components/Button.astro'

While configuring a streaming with a [Standard HTTP/HTTPS POST](/en/documentation/products/guides/observe/connector-standard-https-post/) connector, you can set a payload to customize the data and how it'll be streamed.
