...
While configuring [data streamings](/en/documentation/products/observe/data-streaming/), you need to set up a specific endpoint to stream your Azion data.
...
You can keep track of the calls made by Data Streaming to Amazon Kinesis Data Firehose on [Real-Time Events](/en/documentation/products/observe/real-time-events/). To do so, select **Data Source** > **Data Streaming** and choose the filters options as you wish.

Watch a video tutorial on how to use Amazon Kinesis Data Firehose with Data Streaming on Azion’s YouTube channel:

<iframe
   src="https://www.youtube.com/embed/YOeHXAiYUHw"
