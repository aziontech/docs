---
title: How to use a HTTP/HTTPS POST connector to receive data from Data Streaming
...
namespace: docs_guides_standard_http_htpps_post
...
Follow these steps to configure the endpointyou in your Azion **Data Streaming**.
...
3. On **Custom Headers** (*optional*), you can provide additional data the third-party platform accepts or requires, such as an acces key. You can pass up to 5 headers.
