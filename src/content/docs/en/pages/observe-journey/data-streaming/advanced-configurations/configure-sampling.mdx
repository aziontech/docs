...
When you [configure a streaming](/en/documentation/products/guides/use-data-streaming/) and choose to associate all of your domains, you can configure the **Sampling** option, which allows you to filter the percentage of data you'll be streaming. It's a viable option to reduce costs of data collection and analysis.
...
4. On **Sampling (%)**, add the value, from `0` to `100`, of the percentage of data you want to stream. Example: `60`.
