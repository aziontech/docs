...
permalink: /documentation/guides/platform/observability/analyze-metrics/
---

import DocButton from '~/components/webkit/DocButton.vue';

Your analysis using **Real-Time Metrics** depends on the [product you choose](/en/documentation/platform/real-time-metrics/#product-choice-to-view-metrics) to use and its available fields. Each product has specific fields that generate the charts providing information on access, behavior, and performance of your applications and related products.
...
<DocButton href="/en/documentation/guides/platform/observability/add-filters-metrics/" label="go to add filters guide" kind="secondary" target="_blank" size="medium" />
