...
permalink: /documentation/changelog/previous-year/
meta_tags: >-
...
* **Data Stream TLS support for Apache Kafka endpoint:** Data Stream enables you to send encrypted data to Apache Kafka endpoints using Transport Layer Security (TLS). Learn more about this feature [here](/en/documentation/observe/data-stream/#apache-kafka).
...
* **IBM QRadar**: a new  connector available for integration. Check it out [here](/en/documentation/observe/data-stream/#ibm-qradar) and learn how to configure your IBM QRadar endpoint to receive data collected via Data Stream.
...
* You now have Functions as one of the Real-Time Events Data Source options, allowing you to build native applications on the edge or add functionalities to origin applications with event-driven functions. Learn more [here](/en/documentation/observe/real-time-events/).
...
* **Data Dog**: a new  connector available for integration. Check it out [here](/en/documentation/observe/data-stream/#datadog) and learn how to configure your Datadog endpoint to receive data collected via Data Stream.
...
* **AWS Kinesis Data Firehose**: a new  connector available for integration. Check it out [here](/en/documentation/observe/data-stream/#endpoints) and learn how to configure your Kinesis Data Firehose endpoint to receive data collected via Data Stream.
...
* Real-Time Events now shows the variables `geoloc_city_name` and  `asn`  for the Edge Applications [data source](/en/documentation/observe/real-time-events/#data-sources).
...
* **Splunk:** one more connector available for integration. Check out the documentation for your endpoint configuration [possibilities](/en/documentation/observe/data-stream/#endpoints).
...
* Users can now define the separator that will be used in logs for the HTTP/HTTPS POST endpoint types. [Learn more](/en/documentation/observe/data-stream/).
...
* We have changed our filter: now queries must be performed with the same syntax used in SQL. See details in our documentation  [here](/en/documentation/observe/real-time-events/).
...
* **Elastic** and **BigQuery:** more connectors are now available for codeless integration, increasing your endpoint configuration [possibilities](/en/documentation/observe/data-stream/#endpoints).
...
* A new [data source](/en/documentation/observe/data-stream/#data-sources), Functions, is now available for Data Stream.
...
* Making  [API](/en/documentation/secure/edge-dns/) available for managing Zones and Records for the Edge DNS product.
...
* Added Azion Function for Cookie Targeting.
...
* Option to enable/disable the use of the Functions Product for a given Application configuration.
* Created an option to delete a parameterized function instance in an Application configuration.
* Option created to add a parameterized function to an Application configuration.
...
* Created the option to edit an Function already parameterized linked to an Edge Application configuration.
...
* Implementation of [Multi-Factor Authentication](/en/documentation/fundamentals/multi-factor-authentication/).
...
* Implementation of the Elastic Search endpoint in the [Data Stream](/en/documentation/observe/data-stream/) product.
...
* Launch of the new [Data Stream](/en/documentation/observe/data-stream/) product.
...
* Launch of new Image Optimization graphics in [Analytics](/en/documentation/platform/real-time-metrics/).
...
* HTTP/2 support.
* Update of the Origins tab in Real-Time Manager to integrate the [Load Balancer](/en/documentation/products/secure/connector/load-balancer/) product functionalities.
