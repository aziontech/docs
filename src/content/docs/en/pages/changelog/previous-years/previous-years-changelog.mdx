...
* **Data Streaming TLS support for Apache Kafka endpoint:** Data Streaming enables you to send encrypted data to Apache Kafka endpoints using Transport Layer Security (TLS). Learn more about this feature [here](/en/documentation/products/observe/data-streaming//#apache-kafka).
...
* **IBM QRadar**: a new  connector available for integration. Check it out [here](/en/documentation/products/observe/data-streaming//#ibm-qradar) and learn how to configure your IBM QRadar endpoint to receive data collected via Data Streaming.
...
* **Data Dog**: a new  connector available for integration. Check it out [here](/en/documentation/products/observe/data-streaming//#datadog) and learn how to configure your Datadog endpoint to receive data collected via Data Streaming.
...
* **AWS Kinesis Data Firehose**: a new  connector available for integration. Check it out [here](/en/documentation/products/observe/data-streaming/#endpoints) and learn how to configure your Kinesis Data Firehose endpoint to receive data collected via Data Streaming.
...
* **Splunk:** one more connector available for integration. Check out the documentation for your endpoint configuration [possibilities](/en/documentation/products/observe/data-streaming/#endpoints).
...
* Users can now define the separator that will be used in logs for the HTTP/HTTPS POST endpoint types. [Learn more](/en/documentation/products/observe/data-streaming/).
...
* **Elastic** and **BigQuery:** more connectors are now available for codeless integration, increasing your endpoint configuration [possibilities](/en/documentation/products/observe/data-streaming/#endpoints).
...
* A new [data source](/en/documentation/products/observe/data-streaming/#data-sources), Edge Functions, is now available for Data Streaming.
...
* A new feature, [Slice configuration](/en/documentation/products/build/edge-application/edge-caching/#slice-settings), is available on Edge Application.
...
* Making  [API](/en/documentation/products/secure/intelligent-dns/) available for managing Zones and Records for the Intelligent DNS product.
...
* New Bot Management solution integrated to the Azion platform, using [Edge Functions](/en/documentation/products/build/edge-application/edge-functions/) in [Edge Firewall](/en/documentation/products/edge-firewall/).
...
* Implementation of the Elastic Search endpoint in the [Data Streaming](/en/documentation/products/observe/data-streaming/) product.
...
* Launch of the new [Data Streaming](/en/documentation/products/observe/data-streaming/) product.
* Improvements to the texts of the [Advanced Cache Key](/en/documentation/products/build/edge-application/application-acceleration/#advanced-cache-key) options.
...
* Integration of the Advanced Cache Key functionalities (cache key by cookie and cache key by query string) of the [Application Acceleration](/en/documentation/products/build/edge-application/application-acceleration/) product with Real-Time Manager.
