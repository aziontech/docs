...
description: Explore major updates for Azion's products and services, including Edge
...
meta_tags: Azion, Edge Application, Edge Firewall, Data Stream, Edge Functions, API
  V3, Edge DNS, Real-Time Events, Digital Certificates, Edge Orchestrator
