...
* [API for Edge Firewall - Edge Functions Instances](https://api.azion.com/): with this new API, you can check, remove or update existing settings, besides creating new ones.
...
* Now, with support for using [HTTP](https://api.azion.com/) methods (POST, PUT, PATCH and DELETE) in Edge Functions JavaScript, improving performance, flexibility, and security issues;
...
* [API for Edge Application - Edge Functions Instance](https://api.azion.com/).
