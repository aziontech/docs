...
description: Explore major updates for Azion's products and services, including Edge Applications, Data Stream, Edge Firewall adjustments and API V3 developments.
permalink: /documentation/products/changelog/previous-year/
meta_tags: Azion, Edge Application, Edge Firewall, Data Stream, Edge Functions, API V3, Edge DNS, Real-Time Events, Digital Certificates, Edge Orchestrator
