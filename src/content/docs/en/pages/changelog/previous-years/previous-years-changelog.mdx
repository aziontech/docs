...
meta_tags: >-
  Azion, Edge Application, Edge Firewall, Data Stream, Edge Functions, API V3,
...
* **Digital Certificates**: you can provide the _complete chain_ of certificates for your workloads in the **Certificate** field.
...
* API workloads: duplicate entry - Error 500 - solved.
...
* [API for Edge Application - edge connector](/en/documentation/products/api/v3/edge-applications/edge connector/);
...
* Bugfix for using HMAC authentication with custom pages.
...
* Improvements in Network Layer Protection, Web Application Firewall, and Edge Functions to support a larger number of workloads per Edge Firewall.
...
* Bugfix in the feature of duplicate an Edge Application with custom pages.
...
* Bug fix Real-Time Metrics supporting larger number of workloads Edge Application
...
* Improvements in Edge Cache to support a larger number of workloads per Edge Application.
...
* Added the value domain_name to the results of the V3 API for workloads.
...
* Launch of API [V3](https://api.azion.com/) with API endpoints for managing Digital Certificates, workloads and Edge Application.
...
* Team Permissions improvements for Edge Applications and workloads.
...
* Created an option to list the custom pages presets in an Edge Application configuration.
...
* Created option to add/edit custom pages presets.
...
* Contrast adjustments made to the new Edge Applications and workloads layout for easy viewing.
...
* Implementation of the functionality of multiple workloads to be associated with the same Edge Application.
...
* New workloads interface launched.
...
* Added the Others field in the custom pages tab to configure cache time for other error codes, not listed.
...
* Launch of API endpoints for managing custom pages.
...
* Launch of new API endpoints for [creating, changing and removing edge connector](https://api.azion.com/#8043d292-fd5c-4883-ac79-22332ff9121e).
...
* Launch of new API endpoints for [querying edge connector](https://api.azion.com/#8043d292-fd5c-4883-ac79-22332ff9121e).
...
* HTTP/2 support.
* Update of the edge connector tab in Real-Time Manager to integrate the [Load Balancer](/en/documentation/products/build/edge-application/load-balancer/) product functionalities.
