...
* **Functions:**  you can now integrate this powerful tool into your systems to manage edge functions in a simple, agile and secure way. See our [documentation](https://api.azion.com/) to learn more.
...
* Support for JSON Args on Functions JS, which enables you to modify a function behavior without changing the code itself. Go to Args tab to insert JSON parameters by internal code functions – no need to hard-code and you can use the same function in different Edge Applications.
...
* [API for Edge Firewall - Functions Instances](https://api.azion.com/): with this new API, you can check, remove or update existing settings, besides creating new ones.
...
* [API for Edge Application - Rules Engine](https://api.azion.com/);
* [API for Edge Application - Functions Instance](https://api.azion.com/).

**Edge Firewall**

* [API for Edge Firewall - Main Settings](https://api.azion.com/);
* [API for Edge Firewall - Rules Engine](https://api.azion.com/).
...
* [API for Edge Application - Origins](https://api.azion.com/);
* [API for Edge Application - Cache Settings](https://api.azion.com/).
...
* Improvements in Network Layer Protection, Web Application Firewall, and Functions to support a larger number of Domains per Edge Firewall.
...
* Launch of Functions Instances to run in Edge Application.
* Added the Azion Function Instance for Massive Redirect.
