...
- The [GraphQL API Sorting](/en/documentation/devtools/graphql-api/features/#queries-sorting) feature now allows you to use the descending order specification for all fields of all datasets with the `groupBy` property.
