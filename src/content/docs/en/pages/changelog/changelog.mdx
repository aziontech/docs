...
:::note
As of July/23, this changelog is no longer being updated. You can keep track of Azion updates through [the website](https://www.azion.com/en/) and the [system staus page](https://status.azion.com/).
:::
