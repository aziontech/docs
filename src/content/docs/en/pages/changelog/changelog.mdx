...
:::note
Azion no longer updates the changelog here. Check the [roadmap](https://www.azion.com/en/roadmap/) and [system status](https://status.azion.com/) for product updates and news.
:::
