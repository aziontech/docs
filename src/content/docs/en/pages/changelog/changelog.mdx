---
title: Changelog
description: Discover the latest updates and releases for Azion products and services,
  including Edge Application enhancements, new CLI features, marketplace solutions,
  and essential bug fixes.
permalink: /documentation/products/changelog/
meta_tags: Azion products updates, Azion services, Azion release notes, Azion roadmap,
  system status, Real-Time Manager, Edge Application, Edge Functions, Rules Engine,
  GraphQL API, Azion Marketplace, Digital Certificates, CLI updates, Edge Firewall,
  new features, bug fixes, Azion API
