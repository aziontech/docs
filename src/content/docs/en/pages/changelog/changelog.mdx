...
:::note
Azion doesn't update this page anymore. You can keep track of Azion updates through [the roadmap](https://www.azion.com/en/roadmap/) and the [system status page](https://status.azion.com/).
:::
