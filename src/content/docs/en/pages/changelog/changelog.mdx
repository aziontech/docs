...
- **Azure Monitor** and **Azure Blob Storage**: two new connectors available for integration. Now, you can analyze your data in Microsoft Sentinel more easily. Check them out [here](/en/documentation/products/observe/data-streaming/#azure-blob-storage).
...
* **Logs v7**: now available to all customers through [Data Streaming](/en/documentation/products/observe/data-streaming/) and [Real-Time Events](/en/documentation/products/observe/real-time-events/). To learn more, read the updated product documentation.
