---
title: How to use an Edge Storage bucket as the origin of a static edge application | v3
description: >-
...
permalink: /documentation/products/store/storage/use-bucket-as-origin/v3/
...
:::caution[Important]
You're viewing an older version of this documentation. If your account has already been migrated, refer to the [legacy Use Bucket as An Origin Guide](/en/documentation/products/store/storage/use-bucket-as-origin/).
:::
