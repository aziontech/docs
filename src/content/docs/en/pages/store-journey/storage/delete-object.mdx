...
permalink: /documentation/guides/application-development/data/delete-object/
---

This guide walks you through deleting an Object Storage bucket's object using the [Console](https://console.azion.com/object-storage), [Azion API](https://api.azion.com/), [Azion CLI](/en/documentation/devtools/cli/), and [Azion Runtime](/en/documentation/devtools/runtime/api-reference/storage/).
...
To delete an object, run the following `DELETE` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/guides/platform/account-and-billing/personal-tokens/), `<bucket_name>` with the name of your bucket, `<object_key>` with an ID or name for the object:
...
<DocButton href="/en/documentation/platform/applications/first-steps/" label="Go to Applications first steps" kind="secondary" target="_blank" size="medium" />
<DocButton href="/en/documentation/guides/application-development/getting-started/instantiate-functions/" label="Go to how to instantiate an function" kind="secondary" target="_blank" size="medium" />
