---
title: How to use an Edge Storage bucket as an Edge Connector linked to a static edge application
description: >-
  Learn how to use a bucket as an Edge Connector linked to a static edge application using Edge Storage.
meta_tags: >-
...
permalink: /documentation/products/store/storage/use-bucket-as-edge-connector/
...
1. In the Azion Console, navigate to the **Edge Connectors** menu.
...
7. Click **Save** to create the Edge Connector.

To activate the Edge Connector in your edge application:

1. Navigate to the **Rules Engine** tab.
2. Select or create a new Rule,
3. Under **Behaviors**, in the **Set Edge Connector** behavior, select the Edge Connector you created for your bucket.
4. Click **Save**.
