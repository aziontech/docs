...
description: >-
  ...
  Azion CLI.
permalink: /documentation/guides/application-development/data/list-buckets/
meta_tags: >-
...
1. Run the following `GET` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/guides/platform/account-and-billing/personal-tokens/) and retrieve the list of buckets in your account:
