...
permalink: /documentation/guides/application-development/data/update-object/
...
This guide walks you through updating an object from an Object Storage bucket using the [Azion API](https://api.azion.com/), [Azion CLI](/en/documentation/devtools/cli/), and [Azion Runtime](/en/documentation/devtools/runtime/api-reference/storage/).
...
Run the following `PUT` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/guides/platform/account-and-billing/personal-tokens/), `<bucket_name>` with the name of the bucket, `<object_key>` with the key of the object, and `path/file.src` with the path to your new file:
