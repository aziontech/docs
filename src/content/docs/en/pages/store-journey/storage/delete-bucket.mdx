...
description: >-
  ...
  CLI.
permalink: /documentation/guides/application-development/data/delete-buckets/
meta_tags: >-
...
Run the following `DELETE` request in your terminal, replacing `[TOKEN VALUE]` with your [personal token](/en/documentation/guides/platform/account-and-billing/personal-tokens/) and `bucket_name` with the name of the bucket you want to delete:
