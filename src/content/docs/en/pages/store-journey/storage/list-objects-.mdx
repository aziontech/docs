...
<Button href="/en/documentation/products/guides/build/instantiate-edge-functions/" label="Go to how to instantiate a function" type="primary" theme="light" target="_blank" />
