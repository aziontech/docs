...
This guide walks you through listing an Edge Storage bucket's objects using the [Azion API](https://api.azion.com/), [Azion CLI](/en/documentation/products/azion-cli/overview/), and [Azion Runtime](/en/documentation/runtime/api-reference/storage/).
...
To list an Edge Storage bucket's objectst: 
