...
<LinkButton link="/en/documentation/products/guides/build/instantiate-functions/" label="Go to how to instantiate a function" severity="secondary" target="_blank" />
