---
title: Set up S3 credentials for Object Storage
description: >-
...
permalink: /documentation/guides/application-development/data/s3-protocol-for-object-storage/
---
...
For more details on S3 protocol and s3cmd commands, check the [official documentation](https://s3tools.org/s3cmd). You can also visit the [Object Storage reference](/en/documentation/store/object-storage/). 
