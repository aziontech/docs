...
3. Navigate to the **Edge Connector** tab.
...
:::tip
After creating your application with an Edge Storage bucket as the origin, you can manage and configure settings, such as [custom pages](/en/documentation/products/build/edge-application/custom-pages/) and [cache settings](/en/documentation/products/guides/cache-settings/).
:::
