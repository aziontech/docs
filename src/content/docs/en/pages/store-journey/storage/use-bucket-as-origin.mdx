...
There are separate instructions for API v3 using [legacy Origin](/en/documentation/products/build/applications/origins/) settings and API v4 using the new [Connector](/en/documentation/products/secure/connectors) product.
