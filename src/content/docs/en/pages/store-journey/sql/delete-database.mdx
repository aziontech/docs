---
title: How to delete an Edge SQL database
description: >-
  Learn how to delete an Edge SQL database.
...
This guide demonstrates how to use Azion API to delete an existent database. K
