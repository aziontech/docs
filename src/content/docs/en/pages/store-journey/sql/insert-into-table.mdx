---
title: How to insert data into an Edge SQL table
description: >-
  Learn how to insert data into an Edge SQL table using the Azion API.
...
If you have already created a database, you can use Azion **Edge SQL** to insert new data into it throught the Azion API.
