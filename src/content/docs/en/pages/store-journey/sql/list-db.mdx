---
title: How to list Edge SQL databases
description: >-
  Learn how to list Edge SQL databases.
...
This guide demonstrates how to use Azion **Edge SQL** to list the databases related to your account using the Azion API.
