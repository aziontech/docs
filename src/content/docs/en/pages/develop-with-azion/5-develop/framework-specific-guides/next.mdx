...
## Initializing an Next project on the edge
...
After the deployment is complete, you'll receive a domain for accessing your Next project on the Azion Platform.
...
Now, after indicating you don't want to have a local server running, let's deploy the Next project to the edge. 
