...
Now, you've created an Angular project and it's time to deploy it to the Azion nodes.
...
2. On the browser, go to `http://localhost:3000/`, and you can now see your Angular Project running: 
...
After the deployment is complete, you'll receive a domain for accessing your Angular project on the Azion Platform.
...
Now, after indicating you don't want to have a local server running, let's deploy the Angular project to the edge. 
