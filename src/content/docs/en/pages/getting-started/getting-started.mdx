---
title: Getting started with Azion
...
On the right side of **RTM's** homepage, you can find helpful links taking you to Azion's [documentation page](/en/documentation/products/), [changelogs](/en/documentation/products/changelog), Azion's [API library](https://api.azion.com/), and to contact the [Support team](https://tickets.azion.com/en/support/login).
...
By pointing your traffic to Azion, the Edge Network will attend every content request from your edge application. Through our Edge Traffic Router, it selects the nearest, healthiest Edge Node to handle the request, deliver the content, and process the business rules.
