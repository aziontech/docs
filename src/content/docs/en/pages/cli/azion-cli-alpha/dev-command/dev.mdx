...
The `dev` command adapts the environment for building your edge application and runs it locally. It's used for projects already initialized as **Azion edge applications**.
