...
:::note 
From September 2023 Azion CLI Beta (0.x.y) stopped receiving updates. Azion CLI alpha (1.x.y) is now available. To check the version, run `azioncli -v` or `azion -v`.
:::
