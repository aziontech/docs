...
* **Data Streaming TLS support for Apache Kafka endpoint:** Data Streaming enables you to send encrypted data to Apache Kafka endpoints using Transport Layer Security (TLS). Learn more about this feature [here](https://www.azion.com/en/documentation/products/data-streaming/#apache-kafka).
...
* **IBM QRadar**: a new  connector available for integration. Check it out [here](https://www.azion.com/en/documentation/products/data-streaming/#ibm-qradar) and learn how to configure your IBM QRadar endpoint to receive data collected via Data Streaming.
...
* **Data Dog**: a new  connector available for integration. Check it out [here](https://www.azion.com/en/documentation/products/data-streaming/#datadog) and learn how to configure your Datadog endpoint to receive data collected via Data Streaming.
...
* **AWS Kinesis Data Firehose**: a new  connector available for integration. Check it out [here](https://www.azion.com/en/documentation/products/data-streaming/#setting-endpoint) and learn how to configure your Kinesis Data Firehose endpoint to receive data collected via Data Streaming.
...
* Making  [API](https://www.azion.com/en/documentation/products/intelligent-dns/) available for managing Zones and Records for the Intelligent DNS product.
...
* Added support for ECC - _Elliptic Curve Cryptography_ in [Digital Certificates](https://www.azion.com/en/documentation/products/edge-application/digital-certificates/).
...
* Bug fix on the _subdomain_ purge when using [Wildcard Purge](https://www.azion.com/en/documentation/products/edge-application/real-time-purge/).
...
* New Bot Management solution integrated to the Azion platform, using [Edge Functions](https://www.azion.com/en/documentation/products/edge-application/edge-functions/) in [Edge Firewall](https://www.azion.com/en/documentation/products/edge-firewall/).
* Added [TLS Minimum Version](https://www.azion.com/en/documentation/products/edge-application/#minimum-tls-version) selection component to the Edge Application interface.
...
* New [types of purge](https://www.azion.com/en/documentation/products/edge-application/real-time-purge/): purges can now be done via URL, CacheKey or Wildcard.
...
* Implementation of [Multi-Factor Authentication](https://www.azion.com/en/documentation/products/accounts/multi-factor-authentication/).
...
* [Edge Firewall's](https://www.azion.com/en/documentation/products/edge-firewall/) IP Blocking functionality is integrated into Real-Time Manager.
* [Edge Firewall](https://www.azion.com/en/documentation/products/edge-firewall/) IP Blocking integrated in to the API.
...
* Implementation of the Elastic Search endpoint in the [Data Streaming](https://www.azion.com/en/documentation/products/data-streaming/) product.
...
* Evolution of the Learning Tool of the [Web Application Firewall](https://www.azion.com/en/documentation/products/edge-firewall/web-application-firewall/) product.
...
* Launch of the new [Data Streaming](https://www.azion.com/en/documentation/products/data-streaming/) product.
* Improvements to the texts of the [Advanced Cache Key](https://www.azion.com/en/documentation/products/edge-application/application-acceleration/#advanced-cache-key) options.
...
* Renewal of the Azion [Shared Certificate](https://www.azion.com/en/documentation/products/edge-application/digital-certificates/) with CA, for all customers of the product.
...
* Integration of the Advanced Cache Key functionalities (cache key by cookie and cache key by query string) of the [Application Acceleration](https://www.azion.com/en/documentation/products/edge-application/application-acceleration/) product with Real-Time Manager.
...
* Launch of new Image Optimization graphics in [Analytics](https://www.azion.com/en/documentation/products/real-time-metrics/).
...
* HTTP/2 support.
* Update of the Origins tab in Real-Time Manager to integrate the [Load Balancer](https://www.azion.com/en/documentation/products/edge-application/load-balancer/) product functionalities.
* Update of Real-Time Manager to include the new interface for creating [Web Application Firewall](https://www.azion.com/en/documentation/products/edge-firewall/web-application-firewall/) rule sets.
...
* Update of the [Image Optimization](https://www.azion.com/en/documentation/products/edge-application/image-processor/) platform, with good gains in image optimization.

---

**may/2016**

* Launch of the new interface for uploading [Digital Certificates](https://www.azion.com/en/documentation/products/edge-application/digital-certificates/) to Real-Time Manager.
...
* Update of the [Edge Firewall](https://www.azion.com/en/documentation/products/edge-firewall/) interface to support the reuse of rule sets.
