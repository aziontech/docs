...
You can add users before or after creating teams, as they are independent actions. See how to add teams in the [Teams Permissions](https://www.azion.com/en/documentation/products/accounts/teams-permissions/) documentation.
...
You can also allocate Non-owners to more than one team, which expands the permission possibilities for the same user. See [Team Permissions](https://www.azion.com/en/documentation/products/accounts/teams-permissions/) for more details.
...
> Users can also modify their information on the [Your Settings](https://manager.azion.com/user) page. See more information on the [documentation page](https://www.azion.com/en/documentation/products/accounts/your-settings/).
