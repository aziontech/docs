...
You can also stream your Activity History logs by using them as a data source in Data Streaming. Find out more in the [Data Streaming](https://www.azion.com/en/documentation/products/data-streaming/#selecting-data-sources) page.
