...
description: >-
  Real-Time Manager allows the account owner to configure their users' login between two account authentication options: SSO from Azion or an external Identity Provider of their choice.
