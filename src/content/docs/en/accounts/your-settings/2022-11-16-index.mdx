...
> Learn how to edit general information of the account in the [Account Settings](https://www.azion.com/en/documentation/products/accounts/your-settings/) page. 
...
> If the main account doesn't have the MFA enabled and your user has this permission, you can only enable it for use in your login. However, if the MFA is already enabled, you can't edit this option. See more about it on the [Multi-Factor Authentication](https://www.azion.com/en/documentation/products/accounts/multi-factor-authentication/) page.
