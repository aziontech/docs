...
> You automatically agree to the [Customer Agreement Terms of Service](https://www.azion.com/en/documentation/agreements/customer-agreement/) and [Privacy Policy](https://www.azion.com/en/documentation/agreements/privacy-policy/) by proceeding with the registration process.
...
You're now able to access **RTM** and start building your **Edge Applications**! Check the [Getting Started](https://www.azion.com/en/documentation/products/getting-started/) page to continue your onboarding journey.
