...
> 2. [Regras](#regras)
> 3. [Configurar o Azion Edge Firewall](#passo-a-passo-para-configurar-o-azion-edge-firewall)
> 4. [Criar uma configuração com Módulo Web Application Firewall usando Criteria e Behavior](#hands-on-waf-criteria-behavior)
> 5. [Criar uma configuração Web Application Firewall usando WAF Rule Set para sua aplicação](#hands-on-waf-rule-sets)
> 6. [Debug de regras](#debug-de-regras)
...
## 3. Passo a passo para configurar o Azion Edge Firewall {#passo-a-passo-para-configurar-o-azion-edge-firewall}
