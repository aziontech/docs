...
> 2. [Códigos de erro disponíveis](#codigos-de-erro-disponiveis)
...
> Consulte [Como personalizar uma página de resposta de erro]({% tl documentation_how_to_configurations_customizing_error_response_page %}) para um guia sobre essa funcionalidade.
