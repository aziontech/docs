...
>4. [Adicionando Origins](#adicionando-origin)
>5. [Instanciando a solução](#instanciando-a-solucao)
>6. [Configurando o Rules Engine](#rules-engine)
...
- Visitar a [documentação de ponto de partida]({% tl documentation_getting_started%}#crie-edge-app) para aprender a criar uma edge application.
...
Visite o artigo [Configure testes A/B no Edge]({% tl docs_use_case_ab_testing %}) na página de casos de uso para encontrar mais informações de referência.
