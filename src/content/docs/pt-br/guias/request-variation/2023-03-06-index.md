...
- Visitando a documentação de [ponto de partida]({% tl documentation_getting_started %}).
...
## 3. Configurando a sua solução {#configurando-solucao}
...
## 5. Configurando o Rules Engine {#rules-engine}
