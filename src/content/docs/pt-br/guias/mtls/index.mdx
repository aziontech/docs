...
## 1. Adicione um Trusted CA à sua biblioteca de Digital Certificates
...
## 3. Adicionando regras específicas para uso do Permissive mTLS
...
## 4. Especificando variáveis do mTLS no Header da aplicação
...
* [Suporte para mTLS](/pt-br/documentacao/produtos/edge-application/domains/mtls/)
* [Variáveis do mTLS](/pt-br/documentacao/produtos/edge-application/rules-engine/#mtls)
