...
# Como utilizar a solução IP Address Reputation através do Marketplace da Azion
...
> 3. [Obtendo uma chave API na IPQualityScore](#obtendo-chave-api)
> 4. [Configurando a solução](#configurando-solucao)
> 5. [Instanciando a solução](#instanciando-solucao)
> 6. [Configurando uma regra no Rules Engine](#rules-engine)
...
Para aprender como criar uma edge application, visite a [documentação de ponto de partida]({% tl documentation_getting_started %}).
...
## 3. Obtendo uma chave API na IPQualityScore {#obtendo-api-key}
...
## 6. Definindo uma regra para o Rules Engine {#rules-engine}
