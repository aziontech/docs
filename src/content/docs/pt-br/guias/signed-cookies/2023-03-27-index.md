...
> 1. [Obtendo a solução](#obtendo-solution)
> 2. [Usando a solução](#usando-solution)
> 3. [Configurando a solução](#config-solution)
> 4. [Instanciando a solução](#instanciando-solution)
...
## Usando a solução {#usando-solution}
...
- Visite a documentação do [ponto de partida]({% tl documentation_getting_started %}).
