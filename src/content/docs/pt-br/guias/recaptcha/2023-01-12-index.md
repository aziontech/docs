...
# Como utilizar a solução reCaptcha através do Marketplace da Azion
...
> 2. [Obtendo as credenciais no site do Google](#credenciais)
> 3. [Usando a solução](#usando-solucao)\
> 3.1 [Criando uma regra dentro do Edge Firewall](#criando-regras)\
> 3.2 [Configurando a solução](#configurando-regras)
