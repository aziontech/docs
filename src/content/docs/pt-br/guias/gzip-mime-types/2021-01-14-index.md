...
## 1. Usando Rules Engine para habilitar compressão gzip
...
## 2. Suporte para compressão gzip
...
### 2.2. Lista de tipos MIME suportados para compressão gzip
