...
Você pode utilizar o [processo de debugging](/pt-br/documentacao/devtools/runtime/debugging/) para identificar erros em suas functions. Uma das opções para debugging é utilizar a [GraphQL⁠ API](/pt-br/documentacao/produtos/graphql-api/visao-geral/).
