...
Antes de analisar o processo, você deve aplicar o código de debugging. Descubra mais em [Debugging edge functions](/pt-br/documentacao/devtools/runtime/debugging/).
