...
Para criar um dashboard no Grafana com as métricas de **Data Transferred** do [Real-Time Metrics](https://www.azion.com/pt-br/documentacao/produtos/real-time-metrics/), use o seguinte JSON com a URL `https://api.azionapi.net/metrics/graphql`:
