...
meta_tags: azion, secure, edge firewall, Edge DNS
    ...
    cards:
      ...
      - icon: /assets/docs/images/uploads/network-layer-protection.svg
        ...
        description: >-
          ...
          de entrada e saída.
        link: /pt-br/documentacao/produtos/secure/edge-firewall/network-layer-protection/
      - icon: /assets/docs/images/uploads/waf-rules.svg
        title: Web Application Firewall
        description: >-
          Proteja sua aplicação web das ameaças OWASP Top 10 aos sofisticados
          ataques zero-day.
        link: /pt-br/documentacao/produtos/secure/edge-firewall/web-application-firewall/
  - title: Recursos
    cards:
