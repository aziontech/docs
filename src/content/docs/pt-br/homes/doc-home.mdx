...
O Console é a interface de configuração da Azion, onde você acessa todos os produtos e suas configurações disponíveis. Permite realizar todas as tarefas na plataforma Azion, como criar Edge Applications, configurar Functions, gerenciar regras do Edge Firewall, definir Edge Caching e monitorar métricas e eventos em tempo real.
