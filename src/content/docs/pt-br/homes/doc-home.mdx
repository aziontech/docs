...
<div class="[&_.flex.flex-col]:!gap-4 [&_.flex.flex-col]:md:!gap-8 [&_.flex.flex-col]:2xl:!gap-16">
  <HeroHome
    ...
    logos={[]}
    buttons={[
      { label: "Crie a sua conta", link: "https://console.azion.com/signup/", type: "primary", theme: "light" },
      { label: "Visão geral da plataforma", link: "/pt-br/documentacao/produtos/visao-geral-da-plataforma-da-azion/", type: "primary", theme: "light" }
    ]}
  />
</div>
...
<Button href="/pt-br/documentacao/produtos/templates/astro-boilerplate/." label="Comece agora" type="primary" theme="light" />
...
<Button href="/pt-br/documentacao/produtos/templates/gatsby-blog/." label="Comece agora" type="primary" theme="light" />
...
<Button href="/pt-br/documentacao/produtos/templates/react-boilerplate/." label="Comece agora" type="primary" theme="light" />
...
<Button href="/pt-br/documentacao/produtos/templates/nextjs-app-configurations/." label="Comece agora" type="primary" theme="light" />
...
<Button href="/pt-br/documentacao/produtos/templates/angular-boilerplate/." label="Comece agora" type="primary" theme="light" />

### Mais frameworks 

Estamos expandindo continuamente o suporte a frameworks. Clique abaixo para ver a lista completa.

<Button href="/pt-br/documentacao/produtos/devtools/azion-edge-runtime/compatibilidade-frameworks/" label="Ver detalhes" type="primary" theme="light" />
...
<Button href="/pt-br/documentacao/produtos/guias/conhecendo-o-azion-console/" label="Ver detalhes" type="primary" theme="light" />
...
<Button href="https://api.azion.com/?_gl=1*kkolsv*_gcl_au*OTAxOTIzMjQ2LjE3NDc3NDYzNTkuMTk3ODMzMTk3LjE3NDg0NTUzNTYuMTc0ODQ1NjI4OQ.." label="Ver detalhes" type="primary" theme="light" />
...
<Button href="/pt-br/documentacao/produtos/azion-cli/visao-geral/" label="Ver detalhes" type="primary" theme="light" />
...
<Button href="/pt-br/documentacao/produtos/azion-lib/visao-geral/" label="Ver detalhes" type="primary" theme="light" />
...
<Button href="/pt-br/documentacao/devtools/console-kit/" label="Ver detalhes" type="primary" theme="light" />
...
<Button href="/pt-br/documentacao/devtools/graphql-api/" label="Ver detalhes" type="primary" theme="light" />
...
<Button href="/pt-br/documentacao/devtools/sdk/go/" label="Ver detalhes" type="primary" theme="light" />
...
<Button href="/pt-br/documentacao/produtos/terraform-provider/" label="Ver detalhes" type="primary" theme="light" />
...
<Button href="/pt-br/documentacao/arquiteturas/por-solucao/desenvolvimento-de-aplicacoes/" label="Ver detalhes" type="primary" theme="light" />
...
<Button href="/pt-br/documentacao/arquiteturas/por-solucao/automacao-de-aplicacoes-e-infraestrutura/" label="Ver detalhes" type="primary" theme="light" />
...
<Button href="/pt-br/documentacao/arquiteturas/por-solucao/seguranca-de-aplicacoes-e-redes/" label="Ver detalhes" type="primary" theme="light" />
...
<Button href="/pt-br/documentacao/arquiteturas/por-solucao/inteligencia-artificial/" label="Ver detalhes" type="primary" theme="light" />
...
<Button href="/pt-br/documentacao/arquiteturas/por-solucao/performance-e-confiabilidade-do-servico/" label="Ver detalhes" type="primary" theme="light" />

### Veja mais

Consulte todas as soluções para casos de uso.

<Button href="/pt-br/documentacao/arquiteturas/" label="Ver detalhes" type="primary" theme="light" />
...
<Button href="/pt-br/documentacao/produtos/visao-geral-da-plataforma-da-azion/" label="Ver detalhes" type="primary" theme="light" />

### <i class='ai ai-build-pillar'></i> Build

Construa aplicações com ferramentas e frameworks poderosos.

<Button href="/pt-br/documentacao/produtos/guias/build/visao-geral/" label="Ver detalhes" type="primary" theme="light" />

### <i class='ai ai-store-pillar'></i> Store

Gerencie e processe dados no edge.

<Button href="/pt-br/documentacao/produtos/store/visao-geral/" label="Ver detalhes" type="primary" theme="light" />

### <i class='ai ai-secure-pillar'></i> Secure

Proteja totalmente suas aplicações.

<Button href="/pt-br/documentacao/produtos/secure/visao-geral/" label="Ver detalhes" type="primary" theme="light" />

### <i class='ai ai-deploy-pillar'></i> Deploy

Gerencie recursos de edge de maneira eficiente.

<Button href="/pt-br/documentacao/produtos/deploy/visao-geral/" label="Ver detalhes" type="primary" theme="light" />

### <i class='ai ai-observe-pillar'></i> Observe

Monitore e obtenha análises em tempo real.

<Button href="/pt-br/documentacao/produtos/observe/visao-geral/" label="Ver detalhes" type="primary" theme="light" />
...
<Button href="/pt-br/documentacao/produtos/release-notes/" label="Ver detalhes" type="primary" theme="light" />
