...
<HeroHome
  ...
  buttons={[
    ...
    { label: "Visão geral da plataforma", link: "/pt-br/documentacao/fundamentos/",severity: "secondary" }
  ]}
/>
...
Aqui estão alguns dos nossos templates mais populares para você começar. Para mais informações, acesse nossa página de documentação sobre [como usar templates](/pt-br/documentacao/marketplace/).
...
Para ver a lista completa de templates Astro, [clique aqui](/pt-br/documentacao/devtools/runtime/frameworks/astro/#templates-disponíveis).

<DocButton href="/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/astro-boilerplate/" label="Comece agora" kind="secondary" size="medium" />
...
Para ver a lista completa de templates Gatsby, [clique aqui](/pt-br/documentacao/devtools/runtime/frameworks/gatsby/#templates-disponíveis).

<DocButton href="/pt-br/documentacao/marketplace/" label="Comece agora" kind="secondary" size="medium" />
...
Para ver a lista completa de templates React, [clique aqui](/pt-br/documentacao/devtools/runtime/frameworks/react/#templates-disponíveis).

<DocButton href="/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/react-boilerplate/" label="Comece agora" kind="secondary" size="medium" />
...
Para ver a lista completa de templates Next.js, [clique aqui](/pt-br/documentacao/devtools/runtime/frameworks/nextjs/#templates-disponíveis).

<DocButton href="/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/nextjs-static-boilerplate/" label="Comece agora" kind="secondary" size="medium" />
...
Para ver a lista completa de templates Angular, [clique aqui](/pt-br/documentacao/devtools/runtime/frameworks/angular/#templates-disponíveis).

<DocButton href="/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/angular-boilerplate/" label="Comece agora" kind="secondary" size="medium" />

### Mais frameworks 

Estamos expandindo continuamente o suporte a frameworks. Clique abaixo para ver a lista completa.

<DocButton href="/pt-br/documentacao/devtools/runtime/frameworks/compatibilidade-frameworks/" label="Ver detalhes" kind="secondary" size="medium" />
...
Você pode utilizar a Azion CLI para fazer o deploy de um projeto compatível com nossos [frameworks disponíveis](/pt-br/documentacao/devtools/runtime/frameworks/compatibilidade-frameworks/).

:::tip[Dica]
Consulte nosso [guia da CLI](/pt-br/documentacao/devtools/cli/) para instruções detalhadas de instalação.
:::
...
<DocButton href="/pt-br/documentacao/guias/plataforma/conta-e-billing/conhecendo-o-azion-console/" label="Ver detalhes" kind="secondary" size="medium" />
...
<DocButton href="https://api.azion.com/?_gl=1*kkolsv*_gcl_au*OTAxOTIzMjQ2LjE3NDc3NDYzNTkuMTk3ODMzMTk3LjE3NDg0NTUzNTYuMTc0ODQ1NjI4OQ.." label="Ver detalhes" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/devtools/cli/" label="Ver detalhes" kind="secondary" size="medium" />

### Azion Lib

Azion Lib são ferramentas JavaScript/TypeScript desenhadas para funcionar dentro do [Azion Runtime](/pt-br/documentacao/devtools/runtime/), aproveitando recursos internos para performance otimizada. Também compatível fora do runtime, acessando serviços Azion como Purge, Object Storage e Image Processor via APIs REST. Suporta modo de debug e configuração por variáveis de ambiente.

<DocButton href="/pt-br/documentacao/devtools/azion-lib/" label="Ver detalhes" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/devtools/console-kit/" label="Ver detalhes" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/devtools/graphql/" label="Ver detalhes" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/devtools/sdk/" label="Ver detalhes" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/devtools/terraform/" label="Ver detalhes" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/guias/" label="Ver detalhes" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/fundamentos/" label="Ver detalhes" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/" label="Ver detalhes" kind="secondary" size="medium" />

### <i class='ai ai-secure-pillar'></i> Secure

Proteja totalmente suas aplicações.

<DocButton href="/pt-br/documentacao/plataforma/firewall/" label="Ver detalhes" kind="secondary" size="medium" />

### <i class='ai ai-deploy-pillar'></i> Deploy

Gerencie recursos de edge de maneira eficiente.

<DocButton href="/pt-br/documentacao/build/orchestrator/" label="Ver detalhes" kind="secondary" size="medium" />

### <i class='ai ai-observe-pillar'></i> Observe

Monitore e obtenha análises em tempo real.

<DocButton href="/pt-br/documentacao/plataforma/real-time-metrics/" label="Ver detalhes" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/changelog/" label="Ver detalhes" kind="secondary" size="medium" />

### <i class='pi pi-discord'></i> Junte-se à Comunidade

Compartilhe experiências com a comunidade Azion no Discord.

<DocButton href="https://discord.com/invite/Yp9N7RMVZy" label="Join" kind="secondary" size="medium" />
