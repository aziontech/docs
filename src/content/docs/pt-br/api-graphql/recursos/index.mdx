...
| Dataset   | Description |
|----------|-----------|
| httpMetrics | Eventos de requests registradas pelo [Edge Application](/pt-br/documentacao/produtos/edge-application/) e [Edge Firewall](/pt-br/documentacao/produtos/edge-firewall/).     |
| l2CacheMetrics | Eventos de requests registradas pelo [L2 Caching](/pt-br/documentacao/produtos/edge-application/edge-caching/#l2-caching).    |
...
| httpEvents | Eventos de requests registradas pelo [Edge Application](/pt-br/documentacao/produtos/edge-application/) e [Edge Firewall](/pt-br/documentacao/produtos/edge-firewall/)..     |
| l2CacheEvents | Eventos de requests registradas pelo [L2 Caching](/pt-br/documentacao/produtos/edge-application/edge-caching/#l2-caching).    |
