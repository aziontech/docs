...
title: Changelog anos anteriores
...
* Disponibilizado [API]({% tl documentation_products_intelligent_dns %}) para gerenciamento de Zonas e Records para o produto Intelligent DNS.
...
* Adicionado suporte à ECC - _Elliptic Curve Cryptography_ em [Digital Certificates]({% tl documentation_products_edge_applications_digital_certificates %}).
...
* Bug fix no purge de _subdomain_ quando utilizado [Wildcard Purge]({% tl documentation_products_edge_applications_real_time_purge %}).
...
* Nova solução Bot Management integrada à plataforma da Azion, usando [Edge Functions]({% tl documentation_products_edge_functions %}) no [Edge Firewall]({% tl documentation_products_edge_firewall %}).
* Adicionado componente de seleção [TLS Minimum Version]({% tl documentation_products_edge_applications %}#minimum-tls-version), na interface da Edge Application.
...
* Novos [tipos de purge]({% tl documentation_products_edge_applications_real_time_purge %}#tipos-de-purge): purges agora podem ser feitos por URL, CacheKey ou por Wildcard.
...
* Implementação de [Multi-Factor Authentication]({% tl documentation_accounts_multi_factor %}).
...
* Integração ao Real-Time Manager da funcionalidade de IP Blocking do [Edge Firewall]({% tl documentation_products_edge_firewall %}#ip-blocking).
* Integração à API da funcionalidade de IP Blocking do [Edge Firewall]({% tl documentation_products_edge_firewall %}).
...
* Implementação do endpoint Elasticsearch no produto [Data Streaming]({% tl documentation_products_data_streaming %}).
...
* Evolução da Learning Tool do produto [Web Application Firewall]({% tl documentation_products_web_application_firewall %}).
...
* Lançamento do novo produto de [Data Streaming]({% tl documentation_products_data_streaming %}).
* Melhorias dos textos das opções de [Advanced Cache Key]({% tl documentation_products_application_acceleration %}#advanced-cache-key).
...
* Renovação do [Shared Certificate]({% tl documentation_products_edge_applications_digital_certificates %}) da Azion junto a CA, para todos os clientes do produto.
...
* Integração das funcionalidades de Advanced Cache Key (cache key por cookie e cache key por query string) do produto [Application Acceleration]({% tl documentation_products_application_acceleration %}) ao Real-Time Manager.
...
* Lançamento de novos gráficos de Image Optimization no [Analytics]({% tl documentation_products_real_time_analytics %}).
...
* Suporte a HTTP/2.
* Atualização da aba Origins no Real-Time Manager para integração de funcionalidades do produto [Load Balancer]({% tl documentation_products_load_balancer %}).
* Atualização do Real-Time Manager para inclusão da nova interface para criação de rule sets do [Web Application Firewall]({% tl documentation_products_web_application_firewall %}).
...
* Atualização da plataforma de [Image Optimization]({% tl documentation_products_image_optimization %}), com ganhos superiores na otimização de imagens.

---

**mai/2016**

* Lançamento da nova interface para upload de [Digital Certificates]({% tl documentation_products_edge_applications_digital_certificates %}) no Real-Time Manager.
...
* Atualização da interface do [Edge Firewall]({% tl documentation_products_edge_firewall %}) para suporte a reuso de rule sets.
