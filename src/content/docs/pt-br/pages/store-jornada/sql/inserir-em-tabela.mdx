---
title: Como inserir dados em uma tabela do Edge SQL
description: Aprenda como inserir dados em uma tabela do Edge SQL usando a API Azion.
permalink: /documentacao/produtos/store/sql/inserir-dados-em-tabela/
meta_tags: Edge SQL, SQL, database, CRUD, API, insert data
namespace: docs_store_journey_sql_insert_into_table
menu_namespace: storeMenu
---

Se você já criou um banco de dados, você pode usar o **Edge SQL** da Azion para inserir novos dados através da API da Azion.
