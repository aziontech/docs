...
Você também precisará de um [token pessoal](/pt-br/documentacao/guias/plataforma/conta-e-billing/personal-tokens/) da Azion.
...
<DocButton href="/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/edge-sql-shell-commands/" label="Consulte a referência de comandos do EdgeSQL Shell" kind="secondary" size="medium" />
