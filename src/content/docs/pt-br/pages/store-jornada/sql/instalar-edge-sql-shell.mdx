...
<DocButton href="/pt-br/documentacao/produtos/store/sql/edge-sql-shell-commands/" label="Consulte a referência de comandos do EdgeSQL Shell" kind="secondary" size="medium" />
