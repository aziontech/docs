---
title: Como listar bancos de dados do Edge SQL
description: >-
  Aprenda a listar bancos de dados do Edge SQL.
...
Este guia demonstra como usar o **Edge SQL** da Azion para listar os bancos de dados relacionados à sua conta usando a API da Azion.
