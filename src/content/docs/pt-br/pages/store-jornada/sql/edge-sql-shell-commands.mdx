...
<Button href="/pt-br/documentacao/produtos/store/sql/install-edge-sql-shell" label="Consulte o guia de instalação do EdgeSQL Shell" type="primary" theme="light" />
