...
<DocButton href="/pt-br/documentacao/produtos/store/sql/install-edge-sql-shell" label="Consulte o guia de instalação do EdgeSQL Shell" kind="secondary" size="medium" />
