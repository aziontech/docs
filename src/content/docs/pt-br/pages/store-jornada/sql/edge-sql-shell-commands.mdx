...
description: >-
   Aprenda a usar os comandos do EdgeSQL Shell para interagir com seu banco de dados Edge SQL.
...
Ao usar o EdgeSQL Shell para importar dados de fontes externas, você pode enviar as credenciais e tokens como variáveis de ambiente usando o comando `export`. Este comando também é utilizado para definir seu **personal token** da Azion.
