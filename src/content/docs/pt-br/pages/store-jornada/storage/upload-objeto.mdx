...
Este guia descreve o processo de upload de um objeto para um bucket do Edge Storage usando a [API da Azion](https://api.azion.com/), [CLI da Azion](/pt-br/documentacao/produtos/azion-cli/visao-geral/), e [Azion Runtime](/pt-br/documentacao/runtime/api-reference/storage/).
...
Uma vez que você criado a edge function, você precisa criar uma edge application que irá servir de proxy para o processo de upload do bucket e instanciar a edge function.
