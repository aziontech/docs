...
Este guia descreve o processo de exclusão de um objeto de um bucket do Object Storage usando a [API da Azion](https://api.azion.com/), a [CLI da Azion](/pt-br/documentacao/produtos/azion-cli/visao-geral/) e o [Azion Runtime](/pt-br/documentacao/runtime/api-reference/storage/).
