...
3. Navegue até a guia **Edge Connector**.
...
:::tip
Após criar sua aplicação com um bucket do Edge Storage como origem, você pode gerenciar e configurar configurações, como [respostas de erro](/pt-br/documentacao/produtos/build/edge-application/custom-pages/) e [configurações de cache](/pt-br/documentacao/produtos/guias/cache-settings/).
:::
