...
Existem instruções separadas para API v3 usando configurações de [Origin legado](/pt-br/documentacao/produtos/build/edge-application/origins/) e API v4 usando o novo produto [Connector](/pt-br/documentacao/produtos/secure/edge-connector).
...
1. [Acesse o Azion Console](/pt-br/documentacao/produtos/guias/como-acessar-o-azion-console/) > **Connector**.
