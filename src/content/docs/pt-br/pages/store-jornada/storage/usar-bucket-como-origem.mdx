...
Existem instruções separadas para API v3 usando configurações de [Origin legado](/pt-br/documentacao/produtos/build/edge-application/origins/) e API v4 usando o novo produto [Connectors](/pt-br/documentacao/produtos/secure/edge-connector).
...
<LinkButton link="/pt-br/documentacao/produtos/store/edge-storage/" label="Consulte a referência do Object Storage" severity="secondary" target="_blank" />
...
:::tip
Após criar sua aplicação com um bucket do Object Storage como origem, você pode gerenciar e configurar configurações, como [respostas de erro](/pt-br/documentacao/produtos/build/edge-application/error-responses/) e [configurações de cache](/pt-br/documentacao/produtos/guias/cache-settings/).
:::
