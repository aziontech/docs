...
Este guia mostra como usar o serviço **Object Storage** da Azion para criar um bucket somente leitura e atribuir permissões de leitura e escrita usando a API da Azion.
