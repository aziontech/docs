...
Este guia descreve como você pode atualizar um bucket do Object Storage usando oconsole da Azion, a API da Azion e a Azion CLI. Isso inclui a alteração das permissões de um bucket, o que pode ser crucial para gerenciar o acesso aos seus dados.
