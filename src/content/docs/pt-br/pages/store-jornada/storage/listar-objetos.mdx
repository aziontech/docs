...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/dados/listar-objetos/
---

Este guia descreve como listar objetos de um bucket do Object Storage usando o [Console](https://console.azion.com/object-storage), a [API da Azion](https://api.azion.com/), [Azion CLI](/pt-br/documentacao/devtools/cli/), e [Azion Runtime](/pt-br/documentacao/devtools/runtime/api-reference/storage/).
...
Para listar os objetos em um bucket, execute a seguinte requisição `GET` no seu terminal, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/guias/plataforma/conta-e-billing/personal-tokens/) e `<bucket_name>` pelo nome do seu bucket:
...
1. Acesse [Azion Console](/pt-br/documentacao/guias/plataforma/conta-e-billing/como-acessar-o-azion-console/) > **Funções de Borda**.
...
:::note
Consulte a [referência da API do Object Storage](/pt-br/documentacao/devtools/runtime/api-reference/storage/) para obter mais detalhes sobre as funções disponíveis para outros tipos de requisições.
:::
