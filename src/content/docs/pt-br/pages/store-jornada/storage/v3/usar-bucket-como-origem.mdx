...
namespace: documentation_products_sotre_storage_object_storage_origin_v3
permalink: /documentacao/produtos/store/storage/usar-bucket-como-origin/v3/
...
:::caution[Importante]
Você está visualizando uma versão anterior desta documentação. Se a sua conta já foi migrada, consulte o [Guia Como utilizar o Edge Storage como origem](/pt-br/documentacao/produtos/store/storage/usar-bucket-como-origin/).
:::
