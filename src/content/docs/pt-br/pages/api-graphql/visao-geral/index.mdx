...
Você pode aprimorar o uso de seus dados acessados pelas duas APIs GraphQL da Azion:

- [API GraphQL do Real-Time Metrics](/pt-br/documentacao/produtos/real-time-metrics/), que fornece acesso em tempo real a métricas para que você possa otimizar o uso desses dados.
- [API GraphQL Real-Time Events](/pt-br/documentacao/produtos/real-time-events/), que fornece dados em tempo real para você realizar pesquisas complexas para explorar suas informações.
...
- Visualizar requsiições bloqueadas por IP ou por país.
