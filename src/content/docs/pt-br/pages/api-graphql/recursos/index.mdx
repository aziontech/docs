...
<Button href="/pt-br/documentacao/produtos/graphql-api/recursos/campos-metrics/" text="veja as descrições dos Campos API GraphQL do Real⁠-⁠Time Metrics" variant="secondary"></Button>
