...
Para ver quais campos estão disponíveis em cada conjunto de dados de Metrics, leia a documentação [Campos API GraphQL do Real-Time Metrics](/pt-br/documentacao/produtos/graphql-api/recursos/campos-metrics/).

:::tip[dica]
Você também pode rodar uma **Introspection Query** para consultar os metadados dos datasets de Metrics e Events. Os metadados fornecem o que cada dataset das APIs GraphQL permitem e informações específicas: nome, descrição e formato. Veja mais no guia [Como consultar metadados com a API GraphQL](/pt-br/documentacao/produtos/guias/graphql-metadados/).
:::
