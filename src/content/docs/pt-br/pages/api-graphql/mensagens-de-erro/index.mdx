...
| 400         | The start and end dates must have the same timezone.                                                                            | O fuso horário informado no campo `tsGt` e `tsLt` estão diferentes. Se você estiver utilizando apenas um deles, utilize o horário em formato UTC (Ex.: "2023-10-10T10:47:00")
