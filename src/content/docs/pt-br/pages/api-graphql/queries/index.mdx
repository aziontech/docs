...
Para cada tipo de dados, você consultará com diferentes [conjuntos de dados da GraphQL](/en/documentation/products/graphql-api-features/#datasets).
...
- Quais os dados consultados que devem ser exibidos. No exemplo apresentado, foram utilizados os campos **ts** e **sum**, em que **sum** representa a resposta da **agregação** requestTime.
...
Veja mais informações e exemplos no guia [Como realizar consultas agregando dados com a API GraphQL](/en/documentation/products/guides/graphql-aggregated-data/).
...
Dependendo do [tipo de campo de um conjunto de dados](/en/documentation/products/graphql-api-features/#datasets) que você está consultando, você poderá usar operadores diferentes:
