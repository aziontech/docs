...
Você também pode fazer streaming dos seus logs de Activity History utilizando-os como um data source no Data Streaming. Descubra mais na página do [Data Streaming](/pt-br/documentacao/produtos/data-streaming/#activity-history).
