...
O **[Real-Time Manager](https://manager.azion.com/)** permite que você crie contas distintas, chamadas de **Clients**, para cada uma das afiliadas na conta tipo Groups de sua empresa. Você precisa ser **Account Owner** ou ter as permissões **View client list** e **Change clients** para acrescentar clientes a sua conta.
...
Nesta parte, você precisa preencher com os detalhes da afiliada.
...
Aqui, você precisa detalhar as informações de endereço da afiliada.
...
Ao confirmar o cadastro através, o Account Owner receberá um email automático para ativação da conta, que ficará disponível por 14 dias. Após esse período, se não ativar a conta, o Account Owner será excluído automaticamente do Real-Time Manager.