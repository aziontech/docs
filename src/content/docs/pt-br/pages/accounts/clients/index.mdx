...
O **[Real-Time Manager](https://manager.azion.com/)** permite que você crie contas distintas, chamadas de **Clients**, para cada uma das afiliadas ao seu grupo de empresas. Você precisa ser **Account Owner** ou ter as permissões **View client list** e **Change clients** para acrescentar clientes a sua conta.
