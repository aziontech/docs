...
description: >-
  Este documento destaca os papéis e responsabilidades de cada parte quando as
  organizações usam a Plataforma de Edge da Azion.
meta_tags: 'azion, responsabilidade compartilhada'
namespace: docs_shared_responsibility
permalink: /documentacao/fundamentos/responsabilidade-compartilhada/
---
