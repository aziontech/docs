...
- [Arquivo do changelog](/pt-br/documentacao/produtos/changelog/anos-anteriores/): entradas agrupadas por ano, cada uma nomeando o produto e a mudança. Ainda sem versão em português.
...
This release does not upgrade existing installations. To get the new Lite version, launch [Bot Manager Lite](https://console.azion.com/marketplace/solution/azion/bot-manager-lite) through Azion Marketplace. The standard version of [Azion Bot Manager](/en/documentation/secure/bot-manager/) remains available on demand, upon request to the Service Delivery team.

For more information, refer to [Azion Bot Manager Lite](/en/documentation/secure/bot-manager/bot-manager-lite/).
```
