...
- [Arquiteturas](/pt-br/documentacao/arquiteturas/) - Uma linha de orientação, e depois os designs agrupados pelo problema que resolvem.
...
- [Create an Object Storage bucket](/en/documentation/guides/application-development/data/create-bucket/) - Create a bucket to store your objects.
- [Update an Object Storage bucket](/en/documentation/guides/application-development/data/update-buckets/) - Update a bucket after you create it.
- [Delete an Object Storage bucket](/en/documentation/guides/application-development/data/delete-buckets/) - Delete a bucket that you no longer need.
- [List Object Storage buckets](/en/documentation/guides/application-development/data/list-buckets/) - List all of your buckets.
- [Use a bucket as origin](/en/documentation/guides/application-development/data/use-bucket-as-origin/) - Use a bucket as the origin for your content.
```
