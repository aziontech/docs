...
- **Cresça dividindo um slot que a seção já tem:** Guias e tutoriais em grupos de tarefa nomeados na página de hub, Features e capacidades por superfície. O Quickstart cresce dentro da própria página, por tabs de interface, e se divide apenas quando as etapas não podem ser compartilhadas.
