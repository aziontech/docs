...
<FrameBox>
<ItemList>
  <DocItem title="Create an Object Storage bucket" href="/en/documentation/guides/application-development/data/create-bucket/">create a bucket and set its `workloads_access` permission.</DocItem>
