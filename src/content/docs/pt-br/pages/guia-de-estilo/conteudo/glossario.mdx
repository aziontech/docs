...
O primeiro glossário de produto é o [glossário do Functions](/pt-br/documentacao/build/functions/glossario/): 22 termos, cada definição apontando sua página canônica.
