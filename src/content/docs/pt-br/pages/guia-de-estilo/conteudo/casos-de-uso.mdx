...
| --- | --- | --- | --- |
| Páginas de catálogo entregues rápido sob carga | Armazenar respostas idênticas em cache na rede distribuída da Azion | Applications | [Cache Settings](/pt-br/documentacao/build/cache/cache-settings/) |
| Cart stays personal | Bypass cache for authenticated paths | Applications | [Rules Engine](/pt-br/documentacao/plataforma/applications/rules-engine/) |
| Checkout resists abuse | Rate limit by client identity | Firewall | [Rules Engine for Firewall](/pt-br/documentacao/plataforma/firewall/rules-engine/) |
```
