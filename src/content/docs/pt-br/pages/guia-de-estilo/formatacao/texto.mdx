...
- Incorreto: `Consulte [**Configurações de cache**](/pt-br/documentacao/build/cache/cache-settings/).`
- Correto: `Consulte [Configurações de cache](/pt-br/documentacao/build/cache/cache-settings/).`
...
- Correto: `[Applications](/pt-br/documentacao/plataforma/applications/)`
...
Quando a prosa nomeia um produto, um módulo ou uma feature que tem página própria, a primeira menção na página aponta para essa página: `Cache é um módulo do [Applications](/pt-br/documentacao/plataforma/applications/).` As menções seguintes ficam em texto simples, ou em negrito onde a regra de nomes de produto pede.
