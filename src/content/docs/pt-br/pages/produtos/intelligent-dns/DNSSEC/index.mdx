...
> **Cuidado**: poderá ocorrer indisponibilidade caso as chaves não sejam excluídas no seu servidor de domínio ou o registro DS ainda esteja cacheado em servidores recursivos.