...
**DDoS Protection** é um módulo de Edge Firewall, que protege suas aplicações contra ataques do tipo, *Denial os Service (DoS)* e *Distributed Denial of Service (DDoS)*, tanto a nível de rede, como a nível de aplicação (camadas 3 e 7 do modelo OSI, respectivamente).
