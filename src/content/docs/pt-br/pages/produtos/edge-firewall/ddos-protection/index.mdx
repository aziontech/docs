...
Para ativar **DDoS Protection - Unmetered**, você precisa ter um *Service Plan* do tipo **Business**, **Enterprise** ou **Mission Critical**. O plano **Developer** não oferece proteção contra DDoS.
