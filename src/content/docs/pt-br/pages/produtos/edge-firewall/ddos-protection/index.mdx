...
**DDoS Protection - Unmetered** oferece acesso 24x7 ao [Security Response Team (SRT)](https://www.azion.com/en/documentation/services/security-response-team/) da Azion. O SRT pode ser acionado durante, após, ou mesmo preventivamente, antes de um ataque, na construção de regras personalizadas. Este serviço está disponível como um complemento para planos de serviço **Enterprise** e **Mission Critical**. Sempre que acionado, o SRT irá apoiá-lo na triagem de incidentes, identificação de causa raiz e aplicação das mitigações necessárias em seu nome.
