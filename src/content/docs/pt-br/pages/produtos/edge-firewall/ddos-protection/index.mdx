...
**DDoS Protection** é um módulo de [Edge Firewall](/en/documentation/edge-firewall/), que protege suas aplicações contra ataques do tipo, *Denial of Service (DoS)* e *Distributed Denial of Service (DDoS)*, tanto a nível de rede, como a nível de transporte e aplicação (camadas 3, 4 e 7 do modelo OSI, respectivamente).
