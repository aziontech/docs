...
Para ativar **DDoS Protection - Unmetered**, você precisa ter um [Service Plan](/pt-br/documentacao/servicos/planos-de-servico/) do tipo **Business**, **Enterprise** ou **Mission Critical**. O plano **Developer** não oferece proteção contra DDoS.
...
Para mais detalhes sobre os Planos de Serviço da Azion, acesse a página de [Preços](/pt-br/precos/).
