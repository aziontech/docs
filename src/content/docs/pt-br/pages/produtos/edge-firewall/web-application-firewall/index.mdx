...
> Saiba mais sobre os [módulos do Edge Firewall](/pt-br/documentacao/produtos/edge-firewall/) e o [Mecanismo de Regras para o Edge Firewall](/pt-br/documentacao/produtos/edge-firewall/rules-engine/).
...
| `Match Zone`       | Partes ou campos da requisição que serão comparados com o `match pattern`. Pode ser `Path`, `Query String`, `Request Header`, `Request Body`, `File Name` e `Raw Body`. |
...
### Tabela de opções de Match Zone
