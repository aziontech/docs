...
> Saiba mais sobre [Real-Time Metrics](/pt-br/documentacao/produtos/real-time-metrics/) e como analisar dados WAF com o produto.
...
Com base nessas informações, você pode ajustar a sensibilidade da *WAF Rule Set*, até que não ocorram mais falsos positivos. Ou mesmo solicitar para Azion a geração de *allowlist* para sua aplicação.
