...
> **Nota**: todas as edge functions usadas no Edge Firewall devem ter um *resultado final* nelas, como: `event.continue()`, `event.deny()` e `event.drop()`.
...
pode acabar com comportamentos inesperados.
