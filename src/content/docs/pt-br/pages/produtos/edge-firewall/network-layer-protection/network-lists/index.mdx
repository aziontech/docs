...
Use listas de bloqueio para monitorar comportamentos suspeitos, criar regras inteligentes e aplicar restrições a atividades maliciosas, bloqueando ou limitando o acesso e protegendo, tanto tráfego de entrada quanto de saída, de seus aplicativos na camada de rede. Você também pode criar listas de permissões em caso de bloqueio de acesso interno, testes e falsos positivos.
