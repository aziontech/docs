...
**Network Lists** é um recurso do módulo [Network Layer Protection](/pt-br/documentacao/produtos/edge-firewall/network-layer-protection/). Com o Netwotk Lists, você pode criar e gerenciar *allowlists*, *blocklists* e até mesmo *greylists*, com base na rede, endereço de IP ou localização do usuário. Com esse recurso, é possível prevenir diversos tipos de ataques à sua rede, bem como impedir que usuários mal-intencionados tenham acesso as suas aplicações.
