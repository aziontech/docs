...
O **Time Filter** possibilita que você refine o resultado da busca de eventos e vem por padrão selecionado para **Last 15 minutes**. Você pode filtrar com os seguinttes intervalos de tempo:
