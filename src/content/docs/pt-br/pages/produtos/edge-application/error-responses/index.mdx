...
<Button href="/pt-br/documentacao/produtos/edge-application/cache-settings/#browser-cache-settings" text="Learn more about expiration settings"></Button>
...
<Button href="/pt-br/documentacao/produtos/edge-application/origins/" text="Learn more about Origins"></Button>
