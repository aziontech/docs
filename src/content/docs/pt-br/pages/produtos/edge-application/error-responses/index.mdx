...
A origem em que o arquivo da URI está localizado. Só pode ser alterada se uma URI for adicionada. Deve ser configurada usando [Origins](/pt-br/documentacao/produtos/edge-application/origins/).
