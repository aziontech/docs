...
Quando o cache do seu aplicativo expira, ele se torna *stale* e o servidor pesquisa a fonte da versão mais atualizada. Esta nova versão, com uma data de validade atualizada, substitui a antiga.
