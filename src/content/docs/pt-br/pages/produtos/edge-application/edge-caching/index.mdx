...
Na Azion, você pode personalizar o tempo que o cache permanece no edge através dos valores de *time-to-live* (TTL). Políticas de cache com valores maiores de TTL podem otimizar o desempenho de seu aplicativo, melhorando a experiência de seus usuários e reduzindo o tráfego com a origem. No entanto, um TTL de cache baixo pode ajudá-lo a garantir que os usuários finais sempre vejam as informações mais atuais.
...
Saiba mais sobre [Browser Cache](/pt-br/documentacao/produtos/edge-application/cache-settings/#browser-cache-settings) e [CDN Cache](/pt-br/documentacao/produtos/edge-application/cache-settings/#cdn-cache-settings).
