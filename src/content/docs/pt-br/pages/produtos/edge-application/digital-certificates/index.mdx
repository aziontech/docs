...
Uma Trusted CA é uma entidade autorizada a emitir certificados digitais que podem ser usados para o protocolo de segurança [Mutual Transport Layer Security (mTLS)](/en/documentation/products/edge-application/domains/mtls/). Você pode fazer o upload certificados de Trusted CA e certificados intermediários.
...
- **CNAME**: o domínio principal do certificado. Deve ser informado em formato FQDN.
...
- **Email**: O email da unidade responsável.
- **Private Key Type**: O tipo de chave privada desejada.
...
Você pode listar até 50 CNAMEs para cada domain que criar.
