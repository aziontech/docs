...
- Uma conta Real-Time Manager (RTM). Você pode encontrar mais informações sobre como criar sua conta na [página de documentação](/pt-br/documentacao/produtos/accounts/creating-account/).
- Uma edge application. Se você ainda não criou uma edge application, siga o [Ponto de Partida](/pt-br/documentacao/produtos/getting-started/).

> Consulte também os guias sobre [como clonar](/pt-br/documentacao/produtos/guides/clonar-edge-application/) e [como excluir](/pt-br/documentacao/produtos/guides/deletar-edge-application/) uma edge application.
...
* [Origins](/pt-br/documentacao/produtos/edge-application/single-origin/)
...
* [Functions](/pt-br/documentacao/produtos/edge-application/functions-instances/)
...
Configure a [origem](/pt-br/documentacao/produtos/edge-application/single-origin/) da sua edge application na aba **Origens**:
...
5. Se você optou por substituir as configurações de cache, adicione o **Maximum TTL** desejado em segundos.
   - Neste ponto, você também pode personalizar outras configurações de cache para conteúdo dinâmico fornecido pelo recurso [Advanced Cache Key](/pt-br/documentacao/produtos/edge-application/application-acceleration/#advanced-cache-key) .
6. Clique no botão **Save**.
...
Crie regras de negócios condicionais para o seu aplicativo usando o [Rules Engine](/pt-br/documentacao/produtos/edge-application/rules-engine/).
