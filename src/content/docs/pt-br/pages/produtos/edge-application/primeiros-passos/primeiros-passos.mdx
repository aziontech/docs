...
- Uma conta no Real-Time Manager (RTM). Você pode encontrar mais informações sobre como criar sua conta na [página de documentação](/en/documentation/products/accounts/creating-account/).
...
Crie regras de negócios condicionais para a sua aplicação usando o [Rules Engine](/en/documentation/products/edge-application/rules-engine/).
