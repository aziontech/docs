...
> Consulte também os guias sobre [como clonar](/pt-br/documentacao/produtos/guias/clonar-edge-application/) e [como excluir](/pt-br/documentacao/produtos/guias/deletar-edge-application/) uma edge application.
