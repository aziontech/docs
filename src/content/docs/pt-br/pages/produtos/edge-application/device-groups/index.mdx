...
| Escopo | Recurso |
| Primeiros passos | [Primeiros passos de Edge Application](/pt-br/documentacao/produtos/edge-application/primeiros-passos/) |
| Sobre Rules Engine | [Rules Engine](/pt-br/documentacao/produtos/edge-application/rules-engine/) |
| Sobre Adaptive Delivery | [Rules Engine](/pt-br/documentacao/produtos/edge-application/cache-settings/#adaptive-delivery) |
...
Nas [Cache Settings](/pt-br/documentacao/produtos/edge-application/cache-settings/), você pode referenciar um grupo de dispositivos existente para **Adaptive Delivery**. Você pode escolher um ou mais grupos para aplicar as mesmas políticas de Adaptive Delivery.
