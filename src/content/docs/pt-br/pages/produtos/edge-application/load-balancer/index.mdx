...
O algoritmo de balanceamento de **hash** de IP rastreia os endereços IP do usuário e associa a mesma origem a cada IP. Ao criar um mapeamento consistente entre usuários e origens, essa abordagem garante que as requisições de cada usuário sejam direcionadas para o mesmo servidor de origem.
...
Saiba mais sobre [Address](/en/documentation/products/edge-application/origins/#address).
...
Em casos de interrupções de manutenção ou origem, você pode desativar um address temporariamente da carga. Desative o switch **Active** e o seu servidor ficará inativo, garantindo que sua infraestrutura passe por manutenção sem perturbar o desempenho geral.
