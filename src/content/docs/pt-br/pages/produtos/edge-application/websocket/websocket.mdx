...
A Azion recicla [conexões keepalive](/pt-br/documentacao/produtos/edge-application/#keepalive-timeout) nos seus servidores quanto elas atingem o TTL máximo de aproximadamente 15 minutos. Portanto, conexões WebSocket ativas poderão ser encerradas se ultrapassarem esse intervalo. Neste caso, sua aplicação deverá tratar esses cenários e restabelecer a conexão sempre que necessário.
