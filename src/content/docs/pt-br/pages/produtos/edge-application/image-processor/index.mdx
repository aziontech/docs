...
O **Image Processor** é um módulo **Edge Application** que pode manipular e processar imagens diretamente no edge, otimizando os tempos de transferência de conteúdo e elevando a experiência do usuário em suas aplicações.
...
| Escopo | Recurso |
| --- | --- |
| Primeiros passos | [Primeiros passos de Image Processor](/pt-br/documentacao/produtos/guias/image-processor/) |
...
### Redimensionar para ajustar as dimensões
