...
8. Na aba **Rules Engine** do aplicativo de borda, adicione ou edite uma regra **Request** para um ou mais caminhos de imagem.
...
12. **Opcional**: para garantir que as imagens sejam convertidas com sucesso para o formato WEBP, você também deve adicionar o comportamento **Add Request Header** e enviar o cabeçalho `Accept: image/webp`.
