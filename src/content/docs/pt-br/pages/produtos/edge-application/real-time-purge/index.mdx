...
:::tip
Você também pode usar a [extensão Modheader](/en/documentation/products/guides/check-page-cache-time/) para Google Chrome para fazer o debug de indicadores de cache de dentro do seu navegador.
:::
