...
O [Azion Terraform Provider](/pt-br/documentacao/produtos/terraform-provider/) permite o gerenciamento de edge functions na plataforma da Azion. Possibilita tratar sua infraestrutura como código.
