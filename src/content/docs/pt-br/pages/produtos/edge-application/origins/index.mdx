...
| Escopo | Recursos |
| --- | --- |
| Módulo Load Balancer | [Load Balancer](/en/documentation/products/edge-application/load-balancer/) |
...
Saiba mais sobre o [Load Balancer](/en/documentation/products/edge-application/load-balancer/).
...
Você deve incluir nas credenciais de acesso HMAC fornecidas pelo seu provedor: **Region**, **Access Key** and **Secret Key**.
