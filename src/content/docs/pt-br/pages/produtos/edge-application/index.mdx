...
| --- | --- |
| [Origins](/pt-br/documentacao/produtos/edge-application/single-origin/) | Modifique seu endereço de origem, cabeçalho `Host`, path, políticas de protocolo e credenciais de autenticação HMAC. |
