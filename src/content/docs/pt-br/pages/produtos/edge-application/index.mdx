...
> Comece a criar uma edge application com o [Ponto de partida](/pt-br/documentacao/produtos/ponto-de-partida/).
...
| Criar uma edge application | [Ponto de partida](/pt-br/documentacao/produtos/ponto-de-partida/) |
| Como clonar uma edge application | [Como clonar uma edge application](/pt-br/documentacao/produtos/guides/clonar-edge-application/) |
| Como excluir uma edge application | [Como excluir uma edge application](/pt-br/documentacao/produtos/guides/deletar-edge-application/) |
...
| [L2 Caching](/pt-br/documentacao/produtos/edge-application/l2-caching/) | Crie uma nova camada de cache entre seus usuários e a borda para manter os objetos no cache por períodos mais longos. |
...
Azion [Domains](/pt-br/documentacao/produtos/edge-application/domains/) oferece a flexibilidade de usar domínios gerados automaticamente ou seus próprios domínios personalizados, permitindo que você gerencie e entregue conteúdo de forma eficaz por meio de seus aplicativos de borda com suporte para conexões seguras por HTTP e HTTPS.

---

## Digital Certificates

Com [Digital Certificates](/pt-br/documentacao/produtos/edge-application/digital-certificates/), você pode aprimorar a segurança de seus aplicativos https vinculando um certificado TLS personalizado ao seu aplicativo Edge.

---

## Real-Time Purge

Use a [Real-Time Purge](/pt-br/documentacao/produtos/edge-application/real-time-purge/) para limpar o conteúdo em cache da edge da Azion ou da [Layer 2](/pt-br/documentacao/produtos/edge-application/l2-caching/) para manter os conteúdos atualizados, reduzir a entrega de conteúdo desatualizado e oferecer uma experiência de usuário ideal em sua edge application.
...
A Azion estabelece um limite de duração de 10 a 15 minutos para as conexões entre os usuários e as edge applications. Para evitar o encerramento de conexões ativas que requerem mais tempo para finalizar, como por exemplo no download de arquivos grandes em conexões lentas, considere a implementação de [file slicing](/pt-br/documentacao/produtos/edge-application/edge-caching/#slice-settings) ou [compressão de dados](/pt-br/documentacao/produtos/guias/use-gzip-mime-types/).
