...
Azion **Domains** oferece a flexibilidade de usar domínios gerados automaticamente ou seus próprios domínios personalizados, permitindo que você gerencie e entregue conteúdo de forma eficaz por meio de seus aplicativos de borda com suporte para conexões seguras por HTTP e HTTPS.
...
Com **Digital Certificates**, você pode aprimorar a segurança de seus aplicativos https vinculando um certificado TLS personalizado ao seu aplicativo Edge.
...
Use o **Real-Time Purge** para limpar o conteúdo em cache da edge da Azion ou da camada [L2 Caching](/pt-br/documentacao/produtos/edge-application/l2-caching/) para manter os conteúdos atualizados, reduzir a entrega de conteúdo desatualizado e oferecer uma experiência de usuário ideal em sua edge application.
