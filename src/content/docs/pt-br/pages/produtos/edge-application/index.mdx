...
| [WebSocket](/pt-br/documentacao/produtos/edge-application/websocket/) | Ative o protocolo WebSocket para estabelecer canais de comunicação full-duplex sobre uma única conexão TCP. |
