...
A Azion limita a duração das conexões entre usuários e edge applications a 15 minutos. Para evitar o encerramento de conexões ativas que requerem mais tempo para serem finalizadas, como o download de arquivos grandes em conexões lentas, considere a implementação de [file slicing](/pt-br/documentacao/produtos/edge-application/edge-caching/#slice-settings) ou [compressão de dados](/pt-br/documentacao/produtos/guias/use-gzip-mime-types/).
