...
Antes de entrar em operação, você pode ativar uma configuração de teste para visualizar as configurações. Ao criar um novo domínio, você pode escolher o tipo de ambiente:
...
Você pode restringir o acesso ao sua aplicação a partir do Azion domain ao ativar **CNAME Access Only**.
