...
Veja os [primeiros passos para começar usar o Edge Pulse](/pt-br/documentacao/produtos/edge-pulse/primeiros-passos/).
...
O **Edge Pulse** coleta as informações do Resolver utilizado para a resolução DNS, a edge location testada e a rede anônima do usuário.

Você pode explorar os dados de experiência de usuário e navegação através do⁠ [Real-Time Events](/pt-br/documentacao/produtos/real-time-events/). Você pode utilizar esses dados para tomar decisões relacionadas a roteamento de usuários.
