...
[Use o Real-Time Metrics Histórico](/pt-br/documentacao/produtos/real-time-metrics-historico/).
...
Alguns produtos, como Edge Application, também podem ter subabas, que separam diferentes tipos de métricas para um mesmo produto. Esses conjuntos de gráficos são dashboards. Descubra mais sobre cada aba, subaba e gráficos na seção Monitorar suas métricas com gráficos.

[Data Streaming](/pt-br/documentacao/produtos/data-streaming/), [Edge Functions](/pt-br/documentacao/produtos/edge-application/edge-functions/), [Intelligent DNS](/pt-br/documentacao/produtos/intelligent-dns/), [Image Processor](/pt-br/documentacao/produtos/edge-application/image-processor/) e [L2 Caching](/pt-br/documentacao/produtos/edge-application/edge-caching/#l2-caching) são produtos pagos. Para visualizar as métricas deles, você deve assinar os produtos e ativá-los em sua conta.
...
Para um passo a passo completo, veja o guia [Como usar o Real-Time Metrics](/pt-br/documentacao/produtos/guias/usar-real-time-metrics/).
...
Ao adicionar um filtro, você pode definir o **campo**, como "host", "status" ou "esquema", por exemplo. Os campos são usados com os **operadores** disponíveis, como "Like", "Range" ou "Ne".
...
Um comportamento importante dos gráficos é o que o último ponto do gráfico pode aparecer como uma métrica decrescente. Isto ocorre porque os últimos dados ainda estão sendo agregados, e passam a impressão de queda. Exemplo: agora, são 15h40 e você solicitou dados dos últimos 3 dias. Os dados das 15h-16h ainda estão sendo calculados e agregados, e por isso a visualização do gráfico parece demonstrar uma queda nas métricas.
...
Ele fornece a primeira camada de caching para o conteúdo do cliente no Azion edges. O gráfico é dividido em:
...
O gráfico **Data Streaming Total Requests** apresenta a soma, a quantidade total de requisições que foram processadas pelo data streaming configurado em sua conta.
