...
![Itens do gráfico do Real-Time Metrics Histórico localizados na tela do Real-Time Manager.](https://www.azion.com/assets/docs/images/uploads/graph-historical-real-time-metrics.png)
