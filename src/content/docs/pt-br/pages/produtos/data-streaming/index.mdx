...
> No momento, a opção *Sampling* não está disponíveis para todas as contas do RTM. Se você deseja usá-la em sua conta, [contate o time de vendas](https://www.azion.com/pt-br/contate-vendas/).
...
Esta funcionalidade está disponível para o endpoint **Standard HTTP/HTTPS POST**.
