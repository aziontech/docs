...
- [Next.js Pages + Middleware](/pt-br/documentacao/produtos/guias/nextjs-pages-middleware/): este template permite implantar rapidamente uma aplicação Next.js com Pages Router, um middleware e configurações personalizadas.
