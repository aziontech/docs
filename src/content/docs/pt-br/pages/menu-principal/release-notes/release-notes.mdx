...
- **Melhorias no Console:**  
  - UI open-source e sem interface gráficas  
...
- **Limites de Execução Aumentados:** As Edge Functions agora executam até 5 minutos de tempo de CPU e suportam pacotes de aplicação de até 20MB.
...
- **Sem Taxas de Egressão:** Sem custo para transferência de dados entre Edge Storage and Edge Application.
