...
- **Execução de Modelos de IA**: Suporta modelos LLMs, VLMs, multimodais, embedding e reranking no **Edge Runtime**.
- **Personalização de Modelos**: Ajuste fino de modelos com **Low-Rank Adaptation (LoRA)** para necessidades específicas de negócios.
