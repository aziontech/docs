...
Dois novos tenmplates estão agora disponíveis:

- [Azion Starter Kit](/pt-br/documentacao/produtos/guias/azion-starter-kit/): esse template é ideal para dar os primeiros passos na Plataforma Edge da Azion. Com este template, você pode acelerar a criação de um stack de edge básico para explorar a plataforma e seus recursos, incluindo configurações de desempenho e segurança para aprimorar e proteger sua aplicação.
- [HTMX Boilerplate](/pt-br/documentacao/produtos/guias/htmx-boilerplate/): o template facilita a implantação e teste de um exemplo mínimo da biblioteca HTMX na Plataforma de Edge da Azion

Saiba mais sobre os [Templates da Azion](/en/documentation/products/marketplace/templates/).
