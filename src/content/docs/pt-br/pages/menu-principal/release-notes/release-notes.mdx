...
Para garantir que seu código seja portátil e preparado para o futuro, o Azion Runtime agora oferece suporte a um conjunto ampliado de APIs padronizadas da Web. Essas melhorias possibilitam compressão nativa de streams, processamento incremental de texto, controle preciso de back-pressure e medições de desempenho em submilissegundos — fornecendo ferramentas avançadas para maximizar a vazão e a observabilidade em cada request para as Edge Functions.
