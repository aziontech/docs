...
A Azion anuncia seu mais recente produto, **Edge AI**. Ele oferece uma gama de soluções que transformam como as aplicações inteligentes são construídas e entregues.

Com o Edge AI, você pode implantar e executar modelos de IA de ponta no [Edge Runtime](/pt-br/documentacao/runtime/visao-geral/), implementando arquiteturas de IA complexas e integrando-as com aplicações que funcionam 100% no edge. Também é possível treinar e especializar modelos para o seu caso de uso específico usando LoRA (Low-Rank Adaptation). Com essa solução, você é capaz de executar suas aplicações de IA em uma rede distribuída, trazendo o poder computacional de IA mais perto dos usuários finais.

Através da integração com [Edge SQL](/pt-br/documentacao/produtos/store/edge-sql/), é possível implantar um banco de dados de vetores distribuído para armazenar, consultar e processar dados estruturados e vetoriais no edge com tempos de resposta rápidos.

**Edge Functions** permite a execução de agentes autônomos com Tool Calling e Agentic RAG, e nosso **Azion Runtime** torna possível executar código e construir aplicações de IA combinando Edge AI e Edge SQL, reduzindo drasticamente a latência e melhorando o desempenho.

Para saber mais sobre Edge AI, leia a documentação do [Edge AI](/pt-br/documentacao/produtos/edge-ai/).
