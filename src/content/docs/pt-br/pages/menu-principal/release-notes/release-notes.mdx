...
**Jornada de importação GitHub simplificada**: Agora quando importando uma aplicação do GitHub não existe mais a necessidade de selecionadar o modo da aplicação, simplificando a implementação de suas aplicações.
