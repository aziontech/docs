---
title: Release notes
description: Veja as últimas mudanças e lançamentos na Plataforma Edge da Azion, na API Azion, CLI e outros canais e produtos.
...
- **Criação de conteúdo e otimização de SEO**: WordPress InstaCreator e Edge Accelerator.
