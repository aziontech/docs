...
- **WinterTC (padrão aberto ECMA)**: Compatibilidade superior a 80% com APIs WinterTC, promovendo portabilidade e eliminando o vendor lock-in.  
...
- **Templates**: Novos templates para implantação rápida de e-commerce, sites, blogs e mais agora disponíveis no Console.
...
- **Programa universal de migração de dados**: Migrações gratuitas, para todos os clientes, de armazenamento de objetos compatível com S3 de grandes provedores de cloud e sem limites de tamanho de dados (consulte a elegibilidade).  
- **Zero custo de egress:** Não há custo de saída na transferência de dados entre Azion Edge Storage e Azion Edge Application.
...
- **Confiabilidade escalável**: Replicação global movida de milhões para bilhões de cargas de trabalho suportadas com alta disponibilidade.
