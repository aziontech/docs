...
O novo campo `serverProtocol` está disponível na **API GraphQL do Real⁠-⁠Time Metrics** através do conjunto de dados **httpMetrics**. Também pode ser consultado através do **Real-Time Metrics** no Real-Time Manager como `Server Protocol`.
