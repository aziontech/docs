...
Como parte da Launch Week, também destacamos atualizações transformadoras recentemente disponibilizadas em nossa plataforma: compatibilidade com APIs Node.js com suporte ampliado e compatibilidade expandida com frameworks como Next.js, Vue, React, Angular, Gatsby, Astro e outros.
...
- **Zero egress**: Sem custo para transferência de dados do Edge Storage para a Edge Application.
...
Como parte da Launch Week, também destacamos atualizações transformadoras recentemente disponibilizadas em nossa plataforma: Busca Vetorial para bancos de dados vetoriais distribuídos e pipelines de RAG eficientes.
