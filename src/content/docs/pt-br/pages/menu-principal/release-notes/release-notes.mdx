...
O **Object Storage** é uma solução de armazenamento de dados escalável e flexível que armazena dados como objetos discretos, cada um contendo os próprios dados, metadados associados e um identificador único. Essa solução agora vem equipada com acesso à **Object Storage API REST** da Azion, proporcionando alta escalabilidade, acessibilidade e economia para diversas necessidades de armazenamento de dados não estruturados.

Veja mais detalhes na [documentação de referência de Object Storage](/pt-br/documentacao/produtos/store/object-storage/), a [documentação da API](https://api.azion.com/#af706383-073d-41f0-aba4-ba3540701137) e nos guias:

- [Como criar e modificar um bucket do Azion Object Storage](/pt-br/documentacao/produtos/guias/criar-e-modificar-um-bucket/)
- [Como fazer o upload e download de objetos de um bucket do Azion Object Storage](/pt-br/documentacao/produtos/guias/upload-e-download-de-objetos-do-bucket/)
- [Como usar um bucket do Azion Object Storage como origem de uma edge application estática](/pt-br/documentacao/produtos/guias/usar-bucket-como-origem/)
...
O suporte a HTTP/3 agora é compatível com todas as versões de TLS suportadas pela **Edge Application**.
...
**Code Assistance para Chat GPT** incorpora assistência de IA ao construir edge functions. Essa integração se incorpora à interface do Real-Time Manager para uma experiência de código otimizada.

Veja a documentação de [Edge Functions e ChatGPT](/pt-br/documentacao/produtos/edge-application/edge-functions/runtime-api/ai-integration/) para mais informações.