...
Explore a [Azion Console](https://console.azion.com/).

> O objetivo é migrar a base de usuários atual para a Console até o final de 2024. Durante essa transição, o Real-Time Manager (RTM) estará disponível para clientes com outros Service Plans e a equipe continuará mantendo e fornecendo suporte a ele.
