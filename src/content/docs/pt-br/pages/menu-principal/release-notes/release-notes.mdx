...
A Azion apresenta o Edge AI, que permite a execução de modelos avançados de IA diretamente no edge para latência mínima e desempenho máximo.
...
- **Fluxos de Trabalho Avançados**: Inclui raciocínio, conversões de áudio, texto, imagem e chamada de ferramentas.
- **Suporte a Agentes**: Construa agentes de IA com **Tool Calling** e **Agentic RAG**, aproveitando o LangGraph do [LangChain](https://www.langchain.com/).
- **Integração com Edge SQL**: Implante bancos de dados vetoriais distribuídos, consultas semânticas e pesquisa híbrida para implementações eficientes de RAG.
- **Compatibilidade**: Integra-se com APIs compatíveis com OpenAI, LangChain/LangGraph e N8N para automação de fluxo de trabalho.

Para mais detalhes, visite a [documentação do Edge AI](/pt-br/documentacao/produtos/edge-ai/visao-geral/).
