...
:::note
Este processo exigirá que você associe um registro CNAME ao seu domínio. Veja [Migrar nameservers para a Azion](/pt-br/documentacao/produtos/guias/migrar-ns-para-a-azion/) para mais informações sobre como associar um registro ANAME.
:::
