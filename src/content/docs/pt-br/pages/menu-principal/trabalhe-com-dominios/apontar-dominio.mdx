...
Antes de direcionar seu tráfego para a Azion, você pode testar seu domínio personalizado na edge localmente ao [fazer o staging da sua aplicação através do arquivo hosts](/pt-br/documentacao/produtos/guias/testar-aplicacao-edge-atraves-do-arquivo-hosts/).
