...
:::tip[Dica]
Neste guia, existem instruções separadas para API v3 e API v4. Se você não tem certeza de quais passos se aplicam à sua conta, consulte [o guia Verifique a migração da sua conta para a API v4](/pt-br/documentacao/produtos/guias/verificar-migracao-conta/) para determinar se sua conta já foi migrada.
:::
...
:::tip
Se sua aplicação usa HTTPS, você pode combinar este processo com a [associação de um certificado digital](/pt-br/documentacao/produtos/guias/criar-certificado-digital/) ao seu domínio personalizado.
:::
