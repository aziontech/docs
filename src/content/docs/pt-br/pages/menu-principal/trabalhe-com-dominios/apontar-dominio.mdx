...
Se você já possui um domínio, pode associar o registro CNAME do seu domínio personalizado ao endereço do seu Azion Workload Domain, efetivamente direcionando acesso à sua edge application.
