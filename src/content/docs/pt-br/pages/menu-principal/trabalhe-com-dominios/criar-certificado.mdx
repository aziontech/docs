...
:::note
Não possui um certificado digital? Consulte o guia sobre [Como adquirir e registrar um Digital Certificate com a Azion](/pt-br/documentacao/produtos/guias/secure/certificado-digital/).
:::
...
3. Para adicionar um novo **Custom certificate**, clique no botão **Add certificate**, em seguida selecione a opção **Edge Certificate** no dropdown.
...
## Opção 2: Fazer upload do Trusted CA para mTLS

### Via RTM

1. [Acesse o RTM](https://manager.azion.com).
2. No canto superior esquerdo da página, abra o **Products menu**, representado por três linhas horizontais, e selecione **Digital Certificates**.
3. Para adicionar um novo **Custom certificate**, clique no botão **Add certificate**, em seguida selecione a opção **Trusted CA** no dropdown.
4. Nomeie seu certificado.
