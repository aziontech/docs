...
3. Para adicionar um novo **Custom certificate**, clique no botão **Add certificate**, em seguida selecione a opção **Edge Certificate**. Se o seu certificado for do tipo CA cert, selecione **Trusted CA**.
