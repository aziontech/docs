...
:::note
- A Azion agora oferece a flexibilidade de emitir e renovar [certificados Let’s Encrypt](documentacao/produtos/secure/edge-firewall/digital-certificates/) via API utilizando tanto o desafio DNS-01 quanto o HTTP-01, permitindo que você escolha o método que melhor atenda às suas necessidades.
