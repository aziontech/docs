...
9. Mantenha esses valores em mão para quando você [redirecionar o DNS autoritativo do seu domínio](#redirecionar-servidores-dns-autoritativos).
...
## Passo 2: Redirecionar servidores DNS autoritativos
