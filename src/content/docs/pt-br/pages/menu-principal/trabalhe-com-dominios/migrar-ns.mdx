...
3. Nos campos  **Subdomain** and **Domain**, adicione os domínios personalizados para a aplicação que deve estar sob sua zona DNS. Se você já adicionou um domínio personalizado, copie esses valores e mantenha-os em mão.
