...
permalink: /documentacao/guias/plataforma/migracao/configurar-dominio/
---
...
:::tip[Dica]
Se você não tem certeza de quais passos se aplicam à sua conta, consulte [este guia](/pt-br/documentacao/guias/seguranca-de-aplicacoes/acesso-e-compliance/verificar-migracao-conta/) para determinar se sua conta já foi migrada.
:::
...
1. Execute a seguinte requisição `POST`, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/guias/plataforma/conta-e-billing/personal-tokens/) para criar um novo Workload.
...
`digital_certificate_id` | Quando `null`, seleciona o certificado Azion SAN. Você também pode [associar um certificado digital](/pt-br/documentacao/guias/seguranca-de-aplicacoes/tls-e-certificados/criar-certificado-digital/) a seu Workload. |
...
1. Execute a seguinte requisição `POST`, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/guias/plataforma/conta-e-billing/personal-tokens/), a variável `<edge_application_id>` pelo [ID da sua application](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/definir-configuracoes-principais/):
...
--data '{
    ...
    | `digital_certificate_id` | Quando `null`, seleciona o certificado Azion SAN. Você também pode [associar um certificado digital](/pt-br/documentacao/guias/seguranca-de-aplicacoes/tls-e-certificados/criar-certificado-digital/) a seu domínio. |
    | `edge_application_id` | O [ID da application](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/definir-configuracoes-principais/#via-api) vinculada ao domínio. |
...
Para personalizar o domínio de sua application, você pode optar por [associar um registro de domínio](/pt-br/documentacao/guias/plataforma/migracao/apontar-dominio-para-a-azion/) ou [migrar nameservers para a Azion](/pt-br/documentacao/guias/plataforma/migracao/migrar-ns-para-a-azion/).
