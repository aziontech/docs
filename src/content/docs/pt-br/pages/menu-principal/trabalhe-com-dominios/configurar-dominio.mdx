...
7. No campo **CNAME**, você pode listar endereços de [domínios personalizados](#vincular-um-dominio-personalizado-a-sua-application) para vincular à sua aplicação.
