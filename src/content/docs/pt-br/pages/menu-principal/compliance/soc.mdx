...
permalink: /documentacao/fundamentos/soc/
---
...
Os relatórios SOC 2 e SOC 3 da Azion são emitidos anualmente. Os clientes com o serviço de suporte **Enterprise** ou **Mission Critical** devem entrar em contato com a **equipe de Suporte da Azion** para solicitar mais informações.

- **Quais regiões e produtos são cobertos?**

Os relatórios SOC 2 e SOC 3 da Azion abrangem toda a plataforma web, o que inclui o Applications e todos os seus add-ons (Application Accelerator, Cache, Functions e Load Balancer), o Firewall e seus add-ons (DDoS Protection, Network Shield, Web Application Firewall - WAF e Origin Shield), cobrindo todas as regiões em que a rede da Azion está implantada. Atualmente, a Azion está presente em seis continentes.

- **A Azion possui certificados de Compliance SOC 2 e SOC 3?**

Não existe certificado de Compliance SOC 2. Em vez disso, avaliadores terceirizados qualificados produzem um relatório de compliance para a organização avaliada, atestando a confiabilidade dos serviços prestados. No caso do SOC 3, os clientes da Azion com o serviço de suporte **Mission Critical** podem solicitar uma cópia do relatório à **equipe de Suporte da Azion**.
