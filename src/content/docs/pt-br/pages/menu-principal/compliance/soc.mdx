...
Os relatórios SOC 2 e SOC 3 da Azion abrangem toda a plataforma de edge, o que inclui o Edge Application e todos os seus add-ons (Application Accelerator, Edge Cache, Edge Functions e Load Balancer), o Edge Firewall e seus add-ons (DDoS Protection, Network Layer Protection, Web Application Firewall - WAF e Origin Shield), cobrindo todas as regiões em que a rede da Azion está implantada. Atualmente, a Azion está presente em seis continentes.
