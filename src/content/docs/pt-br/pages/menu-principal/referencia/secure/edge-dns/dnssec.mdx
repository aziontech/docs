...
permalink: /documentacao/secure/edge-dns/compatibilidade-dnssec/
---
...
<DocButton href="/pt-br/documentacao/guias/seguranca-de-aplicacoes/dns/ativar-dnssec/" label="ative DNSSEC" kind="secondary" size="medium" /> 
...
[Entre em contato com a nossa equipe](https://www.azion.com/pt-br/contato/) para hospedar na Azion uma zona DNS previamente configurada com DNSSEC.
