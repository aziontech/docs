...
<Button href="/pt-br/documentacao/produtos/guias/secure/edge-firewall-definir-main-settings/" text="consulte o guia configurar edge firewall" variant="secondary"></Button>
...
<Button href="/pt-br/documentacao/produtos/secure/edge-firewall/web-application-firewall/rule-sets/#tipos-de-ameacas" text="saiba mais sobre os tipos de ameaça" variant="secondary"></Button> <br></br>
...
<Button href="/pt-br/documentacao/produtos/secure/edge-firewall/web-application-firewall/rule-sets/#niveis-de-sensibilidade" text="saiba mais sobre níveis de sensibilidade" variant="secondary"></Button>
...
<Button href="/pt-br/documentacao/produtos/guias/secure/tune-waf/" text="consulte o guia fazer tuning do WAF" variant="secondary"></Button> 
