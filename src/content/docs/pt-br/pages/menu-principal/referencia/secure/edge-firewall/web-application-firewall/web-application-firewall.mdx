...
<LinkButton link="/pt-br/documentacao/produtos/guias/secure/edge-firewall-definir-main-settings/" label="consulte o guia configurar firewall" severity="secondary" />
...
| Tamanho do payload da requisição | 128 KB (client_body_buffer_size) |
