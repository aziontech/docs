...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/secure/edge-firewall-definir-main-settings/" label="consulte o guia configurar edge firewall" outlined />
...
<LinkButton outlined link="/pt-br/documentacao/produtos/secure/edge-firewall/web-application-firewall/rule-sets/#tipos-de-ameacas" label="saiba mais sobre os tipos de ameaça" outlined /> <br></br>

<LinkButton outlined link="/pt-br/documentacao/produtos/guias/secure/criar-waf-rule-set/" label="consulte o guia sobre criar rule set" outlined />
...
<LinkButton outlined link="/pt-br/documentacao/produtos/secure/edge-firewall/web-application-firewall/rule-sets/#niveis-de-sensibilidade" label="saiba mais sobre níveis de sensibilidade" outlined />
...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/secure/tune-waf/" label="consulte o guia fazer tuning do WAF" outlined /> 
...
<LinkButton outlined link="/pt-br/documentacao/produtos/secure/edge-firewall/web-application-firewall/custom-allowed-rules/" label="saiba mais sobre Custom Allowed Rules do WAF" outlined />
