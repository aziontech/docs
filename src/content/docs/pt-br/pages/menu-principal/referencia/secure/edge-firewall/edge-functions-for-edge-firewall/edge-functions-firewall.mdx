...
| Escopo | Guia |
| - | - |
| Como criar e configurar uma edge function em seu Firewall| [Como criar e configurar uma edge function no seu Firewall](/pt-br/documentacao/produtos/guias/edge-functions/firewall/) |
