...
**DDoS Protection** é um módulo de [Edge Firewall](/pt-br/documentacao/produtos/edge-firewall/) que protege suas aplicações contra ataques do tipo *Denial of Service (DoS)* e *Distributed Denial of Service (DDoS)*, tanto a nível de rede quanto a nível de transporte (camadas 3 e 4 do modelo OSI, respectivamente).
...
**DDoS Protection - Unmetered** oferece visibilidade completa de ataques por meio do [Real-Time Manager (RTM)](https://console.azion.com) ou da [API](https://api.azion.com). Em conjunto com o **Security Response Team (SRT)**, você terá acesso a análises e investigações pós-ataque.
