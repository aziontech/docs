...
permalink: /documentacao/plataforma/workloads/
---
...
:::note[Nota]
Esta página documenta o novo produto Workloads. Se sua conta ainda não foi migrada, consulte a [documentação legada de Domains](/pt-br/documentacao/plataforma/workloads/domains/).
:::
...
Se você já possui um endereço de aplicação com um domínio existente como `www.azion.com`, pode [redirecionar seu tráfego para a Azion](/pt-br/documentacao/guias/plataforma/migracao/apontar-dominio-para-a-azion/) configurando os registros no seu provedor de DNS e listando seus **domínios personalizados**.
...
| Escopo | Recurso |
| --- | --- |
| Adicionando um domínio personalizado | [Primeiros passos](/pt-br/documentacao/guias/plataforma/migracao/configurar-dominio/) |
| Sobre Certificados Digitais | [Certificados Digitais](/pt-br/documentacao/plataforma/certificate-manager/para-firewall/) |
...
Configure o deploy do seu Workload selecionando uma [Applications](/pt-br/documentacao/plataforma/applications/) e um [Firewall](/pt-br/documentacao/plataforma/firewall/). Você também pode configurar [Custom Pages](/pt-br/documentacao/plataforma/custom-pages/) para tratar erros e definir configurações de cache time-to-live (TTL) baseadas no código de status HTTP retornado pelos conectores de edge.
...
:::note
Se optar por entregar sua aplicação via HTTP e HTTPS, é necessário configurar um [certificado digital](/pt-br/documentacao/plataforma/certificate-manager/para-firewall/) ao seu domínio.
:::
...
A Azion bloqueia Renegociação TLS e Resumption TLS por padrão. Se desejar personalizar essa configuração, [entre em contato com o time de vendas](https://www.azion.com/pt-br/contato/).
...
| Versão TLS | Cipher | TLSv1.2_2018 | TLSv1.2_2019 | TLSv1.2_2021 | TLSv1.3_2022 | Legacy_v2025Q1 | Compatible_v2025Q1 | Modern_v2025Q1 | Legacy_v2017Q1 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
<DocButton href="/en/documentation/guides/application-security/tls-and-certificates/ciphers/" label="ir para o guia de configuração de cipher suite TLS" kind="secondary" size="medium" />
...
Para habilitar esse recurso, entre em contato com nosso [time de Vendas](https://www.azion.com/pt-br/contato/).
