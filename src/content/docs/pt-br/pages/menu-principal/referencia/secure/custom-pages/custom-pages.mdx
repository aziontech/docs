...
<Button href="/pt-br/documentacao/produtos/build/edge-application/cache-settings/#browser-cache-settings" label="Saiba mais sobre configurações de expiração de cache" type="primary" theme="light" />
