...
**Custom Pages** é um recurso da Azion que permite personalizar páginas de erro para os usuários com base no código de status recebido de um [Edge Connector](/pt-br/documentacao/produtos/secure/edge-connector/).
...
| Escopo | Recurso |
| --- | --- |
| Primeiros passos com Edge Application | [Primeiros passos](/pt-br/documentacao/produtos/build/edge-application/primeiros-passos/) |
...
| Edge Connector | [Referência do Edge Connector](/pt-br/documentacao/produtos/secure/edge-connector/) |
...
:::tip
Como uma página de erro geralmente é estática e não muda com frequência, a Azion recomenda tempos de cache elevados. Assim, é possível otimizar a performance da sua aplicação e reduzir o custo de processamento na origem.
:::
...
Caminho para o arquivo (geralmente em HTML) com o conteúdo da página de erro que será entregue. Esse caminho é anexado ao domínio da sua aplicação. Por exemplo: `/404.html`.

---

## Response Custom Status Code

Código de status que será entregue ao usuário em vez do original. Por exemplo, é possível definir que o código `404` seja entregue em resposta a um erro `403`.
