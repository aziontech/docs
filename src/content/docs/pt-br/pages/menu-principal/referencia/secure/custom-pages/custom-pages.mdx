...
<DocButton href="/pt-br/documentacao/produtos/build/applications/cache-settings/#browser-cache-settings" label="Saiba mais sobre configurações de expiração de cache" size="medium" />
