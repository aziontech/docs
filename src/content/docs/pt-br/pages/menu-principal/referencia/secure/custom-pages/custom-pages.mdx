...
meta_tags: 'erros, edge application, http, Custom Pages, error status codes'
...
Quando um usuário solicita conteúdo de uma edge application, a Azion envia a requisição para os servidores de origem utilizando o **Connector**. Como resposta, o **Connector** retorna um código de status HTTP, que indica se a requisição foi ou não concluída.
...
| Connector | [Referência do Connector](/pt-br/documentacao/produtos/secure/connector/) |
