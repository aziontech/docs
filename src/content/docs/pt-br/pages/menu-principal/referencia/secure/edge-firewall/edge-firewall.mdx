...
meta_tags: 'Rules Engine, Edge Computing, Applications, Security'
namespace: documentation_products_edge_firewall
permalink: /documentacao/plataforma/firewall/
---

import DocButton from '~/components/webkit/DocButton.vue';

Firewall é um recurso na plataforma Azion que protege workloads em execução na sua infraestrutura distribuída globalmente, inspecionando e filtrando o tráfego próximo ao solicitante—antes que ele atinja a aplicação.
Sua arquitetura configurável permite que você combine módulos poderosos—**DDoS Protection**, **Network Shield**, **Web Application Firewall**, **Bot Manager** e **Functions**—para abordar aspectos específicos de inspeção de tráfego e mitigação de ameaças.

Essas capacidades podem ser utilizadas para construir uma política de segurança abrangente que atenda aos requisitos do seu workload, enquanto aproveita o alcance global e o desempenho de baixa latência da plataforma.
...
Para detalhes sobre a contabilização do produto, acesse a página de [preços](/pt-br/documentacao/fundamentos/precos/).

## Implementação

| Escopo | Fonte |
| ------ | ----- |
| Main settings | [Como definir as main settings de um firewall](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/firewall-definir-main-settings/) |
| Atualizar Firewall | [Como atualizar o seu Firewall](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/como-atualizar-seu-firewall/) |
| Saiba mais sobre Network Lists | [Network Lists](/pt-br/documentacao/secure/network-shield/network-lists/) |
| Saiba mais sobre Rule Sets | [WAF Rule Sets](/pt-br/documentacao/secure/waf/rule-sets/) |
| Saiba mais sobre WAF Custom Allowed Rules | [WAF Custom Allowed Rules](/pt-br/documentacao/secure/waf/custom-allowed-rules/) |
| Saiba mais sobre Functions | [Functions Instances para Firewall](/pt-br/documentacao/plataforma/firewall/functions-instances/) |
| Saiba mais sobre Rules Engine | [Rules Engine para Firewall](/pt-br/documentacao/plataforma/firewall/rules-engine/) |
| Saiba mais sobre Certificate Manager | [Certificate Manager para Secure](/pt-br/documentacao/plataforma/certificate-manager/para-firewall/) |
| Compatibilidade com DNSSEC | [Compatibilidade com DNSSEC](/pt-br/documentacao/secure/edge-dns/compatibilidade-dnssec/) |
| Criar network lists | [Como criar blocklists de IP com Network Shield](/pt-br/documentacao/guias/seguranca-de-aplicacoes/bots-e-rede/blocklists-enderecos-ip-edge/) |
| Modo do WAF | [Verifique ou altere o modo do WAF](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/como-verificar-modo-do-seu-waf/) |
...
<DocButton href="/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/firewall-definir-main-settings/" label="consulte o guia definir main settings" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/plataforma/firewall/rules-engine/" label="saiba mais sobre rules engine" kind="secondary" size="medium" />

<DocButton href="/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/trabalhar-com-rules-engine/" label="consulte o guia trabalhar com rules engine" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/plataforma/ddos-protection/" label="saiba mais sobre DDoS Protection" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/plataforma/firewall/functions/" label="saiba mais sobre Functions para Firewall" kind="secondary" size="medium" />

<DocButton href="/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/instanciar-functions/" label="consulte o guia instanciar functions" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/secure/network-shield/" label="saiba mais sobre Network Shield" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/secure/waf/" label="saiba mais sobre Web Application Firewall" kind="secondary" size="medium" />

<DocButton href="/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/criar-waf-rule-set/" label="consulte o guia criar waf rule set" kind="secondary" size="medium" />
...
<DocButton href="https://api.azion.com/#d770fbf5-9676-43e6-aed7-a32441337918" label="clonar um firewall" kind="secondary" size="medium" />
