...
permalink: /documentacao/plataforma/connectors/sni-check/
---
...
Use o [Real-Time Events](/pt-br/documentacao/observe/real-time-events/) para filtrar requisições com status code `421`. Os dados do evento exibirão os campos `host` e `ssl_server_name`, ajudando a identificar qual parte da sua aplicação está enviando requisições com um hostname fora do escopo do certificado em uso.
...
- Revise os certificados configurados no [Certificate Manager](/pt-br/documentacao/plataforma/certificate-manager/para-firewall/) para cada um dos seus workloads.
...
- [Certificate Manager](/pt-br/documentacao/plataforma/certificate-manager/para-firewall/)
- [Connectors](/pt-br/documentacao/plataforma/connectors/)
