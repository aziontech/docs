...
permalink: /documentacao/plataforma/firewall/rules-engine/
---
...
Você pode usar o Rules Engine para Firewall para configurar todos os aspectos operacionais dos firewalls de suas applications. Aqui estão alguns exemplos de implementações para as quais você pode utilizá-lo:
...
<DocButton href="/pt-br/documentacao/plataforma/firewall/" label="Saiba mais sobre o Firewall" kind="secondary" size="medium" />

<DocButton href="/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/trabalhar-com-rules-engine/" label="Consulte o guia para trabalhar com Rules Engine" kind="secondary" size="medium" />

## Implementação

| Escopo | Recurso |
| --- | --- |
| Proteja sua aplicação | [Como proteger uma aplicação](/pt-br/documentacao/plataforma/firewall/) |
| Configure as main settings | [Como definir as main settings de um firewall](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/firewall-definir-main-settings/) |
| Crie um WAF rule set | [Crie e aplique um WAF rule set](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/criar-waf-rule-set/) |
| Bloqueie endereços IP de exit nodes Tor | [Como bloquear endereços IP de exit nodes Tor](/pt-br/documentacao/guias/seguranca-de-aplicacoes/bots-e-rede/bloquear-redes-tor/) |
...
Depois disso, você poderá adicionar [Functions Instances](/pt-br/documentacao/plataforma/firewall/functions-instances/) e regras do **Rules Engine**. Os campos e requisitos para usar o **Rules Engine para Firewall** são explicados nas seções abaixo.
:::
...
:::note 
A disponibilidade de certos critérios depende dos módulos de Firewall ativados. Acesse a [referência dos módulos do Firewall](/pt-br/documentacao/plataforma/firewall/#sobre-os-modulos-do-edge-firewall) para mais detalhes.
:::
...
<Tag severity="info">Requer WAF</Tag>

Associa a Rule Set de WAF que deve ser utilizada na requisição. As políticas de WAF devem ser previamente configuradas no menu **Edge Libraries** > **WAF Rules*. Você também deve definir o **modo WAF**: **Learning** ou **Blocking**. Leia mais sobre [WAF Rule Sets](/pt-br/documentacao/secure/waf/rule-sets/).
...
<Tag severity="info">Requer Functions</Tag>
...
Você pode [depurar regras criadas com o Rules Engine para Firewall](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/debug-regras/) através da GraphQL API, Data Stream ou Real-Time Events.
