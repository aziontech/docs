...
<DocButton href="/pt-br/documentacao/produtos/secure/firewall/" label="Saiba mais sobre o Firewall" kind="secondary" size="medium" />

<DocButton href="/pt-br/documentacao/produtos/guias/secure/trabalhar-com-rules-engine/" label="Consulte o guia para trabalhar com Rules Engine" kind="secondary" size="medium" />
...
Depois disso, você poderá adicionar [Functions Instances](/pt-br/documentacao/produtos/secure/firewall/functions-instances/) e regras do **Rules Engine**. Os campos e requisitos para usar o **Rules Engine para Firewall** são explicados nas seções abaixo.
:::
