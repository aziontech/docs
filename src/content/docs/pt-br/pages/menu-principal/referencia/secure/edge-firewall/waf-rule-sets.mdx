...
Você também pode realizar análises adicionais sobre as ameaças do WAF usando [Data Stream](/pt-br/documentacao/produtos/data-stream/) e [Real-Time Events](/pt-br/documentacao/produtos/real-time-events/).
