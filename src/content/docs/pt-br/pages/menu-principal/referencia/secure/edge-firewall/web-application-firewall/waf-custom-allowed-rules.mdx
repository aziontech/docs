...
:::tip[dica]
Saiba mais sobre os [módulos do Firewall](/pt-br/documentacao/plataforma/firewall/) e o [Web Application Firewall](/pt-br/documentacao/secure/waf/).
:::
...
Para mais informações sobre como o tuning do WAF funciona na prática, [confira nosso guia sobre como fazer a configuração](https://www.azion.com/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/tune-waf/).
...
| `match_zone` | string | A parte da requisição para correspondência. Veja as [opções de Match Zone](/pt-br/documentacao/secure/waf/#match-zone-dropdown-options) |
