...
permalink: /documentacao/produtos/secure/edge-firewall/web-application-firewall/custom-allowed-rules/
---
...
| 1209 | Possível ataque de Directory Traversal: tentativa evidente de travessia de diretório `/.%2e/)` encontrado no `Body`, `Path`, `Query String` ou `Cookies` |
| 1210 | Possível ataque de Directory Traversal: tentativa evidente de travessia de diretório `/%2e./)` encontrado no `Body`, `Path`, `Query String` ou `Cookies` |
