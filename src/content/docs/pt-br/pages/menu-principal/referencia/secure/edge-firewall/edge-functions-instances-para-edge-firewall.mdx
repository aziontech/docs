...
<LinkButton severity="secondary" link="/pt-br/documentacao/produtos/guias/secure/instanciar-edge-functions/" label="consulte o guia instanciar edge functions" severity="secondary" />
