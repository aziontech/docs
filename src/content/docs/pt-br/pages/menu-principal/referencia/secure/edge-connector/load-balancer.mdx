...
permalink: /documentacao/produtos/secure/connectors/load-balancer/
---
...
| Escopo | Recursos |
| --- | --- |
| Connectors | [Connectors](/pt-br/documentacao/produtos/secure/connectors/) |
...
<Button href="/pt-br/documentacao/produtos/build/edge-application/origins/#address" label="Saiba mais sobre origin addresses" type="primary" theme="light" />
