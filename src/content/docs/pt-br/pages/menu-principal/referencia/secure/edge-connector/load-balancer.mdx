...
Para mais opções de como direcionar o tráfego para o **Load Balancer** baseado em outros critérios, consulte a página [Rules Engine para Applications](/pt-br/documentacao/plataforma/applications/rules-engine/).

## Implementação

| Escopo | Recursos |
| --- | --- |
| Connectors | [Connectors](/pt-br/documentacao/plataforma/connectors/) |
...
Para alterar este comportamento, [contate o time de suporte](/pt-br/documentacao/suporte/).
:::
...
<DocButton href="/pt-br/documentacao/plataforma/connectors/origins/#address" label="Saiba mais sobre origin addresses" size="medium" />
...
Você pode solicitar o aumento dos limites. Contate o [time de suporte técnico](/pt-br/documentacao/suporte/) para fazer a solicitação.
:::
