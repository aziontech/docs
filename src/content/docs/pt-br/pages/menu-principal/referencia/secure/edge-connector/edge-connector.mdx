...
permalink: /documentacao/plataforma/connectors/
---
...
:::note[Nota]
Esta página documenta o novo produto Connectors. Se sua conta ainda não foi migrada, consulte a [documentação legada de Origins](/pt-br/documentacao/plataforma/connectors/origins/).
:::
...
| Escopo | Recurso |
| --- | --- |
| Primeiros passos com Applications| [Primeiros passos](/pt-br/documentacao/plataforma/applications/primeiros-passos/) |
| Módulo Load Balancer | [Load Balancer](/pt-br/documentacao/plataforma/load-balancer/) |
...
A tabela a seguir resume as configurações padrão de timeout e gerenciamento de conexões. Alguns valores são configuráveis por conector, enquanto outros são controlados por configurações globais ou pelo sistema operacional.

| Parâmetro               | Azion      |
| ----------------------- | ---------- |
| Complete TCP Connection | 60s        |
| TCP ACK Timeout         | ~15–30 min |
| TCP Keep-Alive Interval | Off        |
| Proxy Idle Timeout      | 75s        |
| Proxy Read Timeout      | 120s       |
| Proxy Write Timeout     | 120s       |
| HTTP/2 Pings to Origin  | Off        |
| HTTP/2 Connection Idle  | 75s        |
...
<DocButton href="/pt-br/documentacao/plataforma/load-balancer/" label="Saiba mais sobre Load Balancer" size="medium" />
...
Quando o Object Storage é selecionado como tipo de origem, ele se conecta diretamente a um bucket do [Azion Object Storage](/pt-br/documentacao/store/object-storage/), onde você seleciona o bucket e define o prefix.

O nome do bucket é definido ao [criar ou modificar um bucket Object Storage](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/criar-e-modificar-um-bucket/). Ao criar um connector, o seletor de buckets lista automaticamente os buckets existentes e disponibiliza um campo de busca para facilitar encontrar o bucket desejado.
...
<DocButton href="/pt-br/documentacao/store/object-storage/" label="Ir para referência Object Storage" size="medium" />
...
<DocButton href="/pt-br/documentacao/guias/performance-e-confiabilidade/otimizacao-de-entrega/live-streaming-delivery-com-hls/" label="Ir para a solução Live Ingest" size="medium" />
