...
title: Connector
description: >-
  Connector permite conectar sua origem a uma Application. Uma origem representa o servidor de onde a Azion recupera seu conteúdo, como um serviço de armazenamento de objetos ou um servidor em cloud.
meta_tags: 'Connector, Edge Computing, Edge, Origin'
namespace: documentation_products_edge_connector
permalink: /documentacao/produtos/secure/connector/
---
...
:::note[Nota]
Esta página documenta o novo produto Connector. Se sua conta ainda não foi migrada, consulte a [documentação legada de Origins](/pt-br/documentacao/produtos/build/edge-application/origins/).
:::

O **Connector** centraliza as configurações de conexão, permitindo seu reuso em várias aplicações e fornecendo controle granular sobre desempenho, segurança e roteamento por meio de uma interface unificada para conectar Applications a uma origem, incorporando nativamente recursos como balanceamento de carga, autenticação HMAC e Origin Shield.
...
| Módulo Load Balancer | [Load Balancer](/pt-br/documentacao/produtos/secure/edge-connector/load-balancer/) |
...
<LinkButton link="/pt-br/documentacao/produtos/secure/connector/load-balancer/" label="Saiba mais sobre Load Balancer" />
...
Abaixo estão os atributos da [Connector API](https://api.azion.com/v4#/operations/GetEdgeConnectorConnectors) ao utilizar o tipo de connector HTTP.
...
Abaixo estão os atributos da [Connector API](https://api.azion.com/v4#/operations/GetEdgeConnectorConnectors) ao utilizar o tipo de connector Object Storage.
...
<LinkButton link="/pt-br/documentacao/produtos/store/edge-storage/" label="Ir para referência Object Storage" />
