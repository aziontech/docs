...
Quando o Object Storage é selecionado como tipo de origem, ele se conecta diretamente a um bucket do [Azion Object Storage](/pt-br/documentacao/produtos/store/edge-storage/), onde você seleciona o bucket e define o prefix.
