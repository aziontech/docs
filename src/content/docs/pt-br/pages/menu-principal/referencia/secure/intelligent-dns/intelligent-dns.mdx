...
permalink: /documentacao/produtos/secure/intelligent-dns/
---
...
Para que o **Intelligent DNS** passe a responder como autoridade sobre suas zonas, você deve efetuar o apontamento para os nameservers da Azion em seu provedor de DNS, como Registro.br, GoDaddy ou AWS.
