...
| Escopo | Fonte |
|-------|--------|
| Edge DNS | [Como procurar servidores DNS com o comando dig](/pt-br/documentacao/produtos/guias/executar-o-comando-dig/) |
| Edge DNS | [Como diagnosticar problemas de desempenho e entrega com o comando traceroute](/pt-br/documentacao/produtos/guias/executar-o-comando-traceroute/) |
