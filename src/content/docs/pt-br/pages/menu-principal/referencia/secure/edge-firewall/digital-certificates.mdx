...
:::note
Digital Certificates cadastrados sem informar a chave privada permanecerão com status **Pending** até que a validação seja concluída. Para certificados Let's Encrypt, o status **Challenge** indica que o desafio de validação (DNS-01 ou HTTP-01) está em andamento.
:::
