...
Ao utilizar o Azion **Application**, você conta com um certificado TLS para tráfego em HTTPS sem custo adicional. Quando você cria um domínio para sua edge application usando o [Azion Console](https://console.azion.com), um endereço na zona `azionedge.net` é atribuído automaticamente.
