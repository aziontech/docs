...
description: Você pode conectar um certificado TLS para suas edge applications que usam o protocolo HTTPS através do Digital Certificates e do Edge Firewall da Azion.
...
<LinkButton link="/pt-br/documentacao/produtos/guias/secure/certificado-digital/" label="consulte o guia sobre obter e registrar um digital certificate" outlined /> 
...
<LinkButton link="/pt-br/documentacao/produtos/guias/secure/registro-lets-encrypt/" label="consulte o guia sobre criar registro TXT para certificado Let's Encrypt" outlined /> 
...
<LinkButton link="https://api.azion.com/#0fad2fc2-c0c0-44e4-bcf6-273bea4684fe" label="criar CRL via API" outlined />
