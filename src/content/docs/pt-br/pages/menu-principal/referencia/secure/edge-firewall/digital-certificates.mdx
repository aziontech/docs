...
<LinkButton severity="secondary" link="/pt-br/documentacao/produtos/guias/criar-certificado-digital/" label="consulte o guia sobre criar um certificado digital" />
...
<LinkButton link="https://api.azion.com/v4#/operations/create_certificate_revocation_list" label="criar CRL via API" severity="secondary" />
