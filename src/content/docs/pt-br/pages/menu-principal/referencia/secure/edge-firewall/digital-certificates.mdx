...
<DocButton href="/pt-br/documentacao/produtos/guias/secure/certificado-digital/" label="consulte o guia sobre obter e registrar um digital certificate" kind="secondary" size="medium" />
...
3. Execute o seguinte comando cURL no seu terminal, substituindo `[TOKEN VALUE]` pelo seu [token pessoal](/pt-br/documentacao/produtos/guias/personal-tokens/) e adicionando seu certificado e chave privada:
...
<DocButton kind="secondary" href="/pt-br/documentacao/produtos/guias/criar-certificado-digital/" label="consulte o guia sobre criar um certificado digital" size="medium" />
...
Uma Trusted CA é uma entidade autorizada a emitir certificados digitais que podem ser usados para o protocolo de segurança [Mutual Transport Layer Security (mTLS)](/pt-br/documentacao/produtos/secure/firewall/mtls/). Você pode fazer o upload de certificados de Trusted CA e certificados intermediários.
...
<DocButton href="/pt-br/documentacao/produtos/guias/secure/registro-lets-encrypt/" label="consulte o guia sobre criar registro TXT para certificado Let's Encrypt" kind="secondary" size="medium" />
