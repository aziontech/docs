...
<DocButton href="/pt-br/documentacao/produtos/guias/secure/trabalhar-com-rules-engine/" label="consulte o guia sobre criar regra" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/produtos/observe/real-time-metrics/#waf" label="saiba mais sobre real-time metrics" kind="secondary" size="medium" />
