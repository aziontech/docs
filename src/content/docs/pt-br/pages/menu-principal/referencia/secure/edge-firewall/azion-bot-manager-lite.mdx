...
<DocButton href="/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/integracoes/bot-manager-lite/" label="Vá para o guia de instalação do Bot Manager Lite" kind="secondary" size="medium" />

<DocButton href="/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/bot-manager-lite-starter-kit/" label="Vá para o guia do Bot Manager Lite Starter Kit" kind="secondary" size="medium" />

<DocButton href="/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/integracoes/bot-manager-lite-integration-kit/" label="Vá para o guia do Bot Manager Lite Integration Kit" kind="secondary" size="medium" />
