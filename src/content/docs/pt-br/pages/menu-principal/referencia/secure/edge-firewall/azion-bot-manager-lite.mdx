...
<LinkButton link="/pt-br/documentacao/produtos/guias/bot-manager-lite-integration-kit/" label="Vá para o guia Como adicionar o Bot Manager Lite em um firewall existente usando um template" severity="secondary" /> 
