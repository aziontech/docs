...
<Button href="/pt-br/documentacao/produtos/guias/bot-manager-lite-integration-kit/" label="Vá para o guia Como adicionar o Bot Manager Lite em um firewall existente usando um template" type="primary" theme="light" /> 

<Button href="/pt-br/documentacao/produtos/guias/bot-manager-lite-starter-kit/" label="Vá para o guia Como testar o Bot Manager Lite usando um template" type="primary" theme="light" /> 

<Button href="/pt-br/documentacao/produtos/guias/bot-manager-lite/" label="Vá para o guia Como instalar o Bot Manager Lite através do Marketplace da Azion" type="primary" theme="light" /> 
