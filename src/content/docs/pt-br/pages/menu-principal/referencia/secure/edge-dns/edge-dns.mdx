...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/secure/testar-zona/" label="consulte o guia sobre testar zonas" variant="secondary" /> 

## Registros do Edge DNS

<LinkButton outlined link="/pt-br/documentacao/produtos/guias/secure/adicionar-registros/" label="consulte o guia sobre adicionar registros" variant="secondary" />
...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/secure/balanceamento-de-carga-dns/" label="consulte o guia balancear carga entre registros DNS" variant="secondary" />

## Tipos de entradas suportadas e as respectivas recomendações do Edge DNS
...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/secure/acessar-root-domain/" label="consulte o guia sobre acessar endereços de IP por root domain" variant="secondary" /> 
...
<LinkButton outlined link="/pt-br/documentacao/produtos/secure/edge-dns/compatibilidade-dnssec/" label="saiba mais sobre compatibilidade DNSSEC" variant="secondary" />
