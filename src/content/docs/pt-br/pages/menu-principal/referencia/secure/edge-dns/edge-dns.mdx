...
<DocButton href="/pt-br/documentacao/produtos/guias/secure/testar-zona/" label="consulte o guia sobre testar zonas" kind="secondary" size="medium" /> 

---

## Registros do Edge DNS

<DocButton href="/pt-br/documentacao/produtos/guias/secure/adicionar-registros/" label="consulte o guia sobre adicionar registros" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/produtos/guias/secure/balanceamento-de-carga-dns/" label="consulte o guia balancear carga entre registros DNS" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/produtos/guias/secure/acessar-root-domain/" label="consulte o guia sobre acessar endereços de IP por root domain" kind="secondary" size="medium" /> 
...
<DocButton href="/pt-br/documentacao/produtos/secure/edge-dns/compatibilidade-dnssec/" label="saiba mais sobre compatibilidade DNSSEC" kind="secondary" size="medium" />
...
|------------|------------|------|
| **DIG** | Consultar servidores DNS diretamente, verificar respostas de registros | [Como usar o comando DIG](/pt-br/documentacao/produtos/guias/executar-o-comando-dig/) |
| **HOST** | Converter nomes de domínio em endereços IP e vice-versa | [Guia de teste de zona](/pt-br/documentacao/produtos/guias/secure/testar-zona/) |
| **NSLOOKUP** | Consultar registros DNS para domínios e IPs | [Guia de teste de zona](/pt-br/documentacao/produtos/guias/secure/testar-zona/) |
| **Traceroute** | Diagnosticar caminho de rede e problemas de latência | [Como usar o Traceroute](/pt-br/documentacao/produtos/guias/executar-o-comando-traceroute/) |
...
- **[Real-Time Metrics](/pt-br/documentacao/produtos/observe/real-time-metrics/#edge-dns)**: Visualize gráficos agregados mostrando volumes de consulta, códigos de resposta e distribuição geográfica ao longo do tempo.
- **[GraphQL API](/pt-br/documentacao/devtools/graphql-api/)**: Consulte dados brutos e agregados de DNS para análise personalizada e integração com ferramentas de monitoramento.

<DocButton href="/pt-br/documentacao/produtos/secure/troubleshoot/edge-dns-monitorar-metricas/" label="consulte o guia de métricas do Edge DNS" kind="secondary" size="medium" />
...
3. **Entre em contato com o Suporte Azion** através do [Suporte Azion](/pt-br/documentacao/servicos/suporte/) com as informações coletadas
