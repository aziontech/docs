...
- **[GraphQL API](/pt-br/documentacao/devtools/graphql-api/features/#datasets)**: Consulte dados brutos e agregados de DNS para análise personalizada e integração com ferramentas de monitoramento.

<LinkButton link="/pt-br/documentacao/produtos/secure/troubleshoot/edge-dns-entender-metricas/" label="consulte o guia de métricas do Edge DNS" severity="secondary" />
...
3. **Entre em contato com o Suporte Azion** através do [Suporte Azion](https://www.azion.com/pt-br/documentacao/produtos/services/support/) com as informações coletadas
