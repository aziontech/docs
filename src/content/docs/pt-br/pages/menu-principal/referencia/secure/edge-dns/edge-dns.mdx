...
| Escopo | Fonte |
| ------ | ----- |
| Main settings | [Como definir as main settings de uma zona](/pt-br/documentacao/guias/seguranca-de-aplicacoes/dns/edge-dns-definir-main-settings/) |
| Comando dig | [Como procurar servidores DNS com o comando dig](/pt-br/documentacao/guias/seguranca-de-aplicacoes/dns/executar-o-comando-dig/) |
| Comando traceroute | [Como diagnosticar problemas de desempenho e entrega com o comando traceroute](/pt-br/documentacao/guias/seguranca-de-aplicacoes/dns/executar-o-comando-traceroute/) |
...
<DocButton href="/pt-br/documentacao/plataforma/firewall/" label="consulte o guia sobre testar zonas" kind="secondary" size="medium" /> 

---

## Registros do Edge DNS

<DocButton href="/pt-br/documentacao/guias/seguranca-de-aplicacoes/dns/adicionar-registros/" label="consulte o guia sobre adicionar registros" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/guias/seguranca-de-aplicacoes/dns/balanceamento-de-carga-dns/" label="consulte o guia balancear carga entre registros DNS" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/guias/seguranca-de-aplicacoes/dns/acessar-root-domain/" label="consulte o guia sobre acessar endereços de IP por root domain" kind="secondary" size="medium" /> 
...
<DocButton href="/pt-br/documentacao/secure/edge-dns/compatibilidade-dnssec/" label="saiba mais sobre compatibilidade DNSSEC" kind="secondary" size="medium" />
...
Antes de solucionar problemas de DNS, verifique a saúde atual da plataforma Azion na [Página de Status da Azion](https://status.azion.com). Esta página fornece informações em tempo real sobre a disponibilidade do serviço e quaisquer incidentes em andamento que afetem o Edge DNS ou outros serviços da Azion.

### Tempo de propagação DNS

Quando você cria ou modifica registros DNS no Edge DNS, as alterações são distribuídas pela rede global da Azion em segundos. No entanto, a propagação completa para todos os resolvedores DNS worldwide depende da configuração do TTL (Time-to-Live) do seu registro e do comportamento de cache dos resolvedores intermediários.
...
Para confirmar se sua zona DNS está processando requisições corretamente, utilize as seguintes ferramentas de diagnóstico:

| Ferramenta | Finalidade | Guia |
|------------|------------|------|
| **DIG** | Consultar servidores DNS diretamente, verificar respostas de registros | [Como usar o comando DIG](/pt-br/documentacao/guias/seguranca-de-aplicacoes/dns/executar-o-comando-dig/) |
| **HOST** | Converter nomes de domínio em endereços IP e vice-versa | [Guia de teste de zona](/pt-br/documentacao/plataforma/firewall/) |
| **NSLOOKUP** | Consultar registros DNS para domínios e IPs | [Guia de teste de zona](/pt-br/documentacao/plataforma/firewall/) |
| **Traceroute** | Diagnosticar caminho de rede e problemas de latência | [Como usar o Traceroute](/pt-br/documentacao/guias/seguranca-de-aplicacoes/dns/executar-o-comando-traceroute/) |
...
- **[Real-Time Metrics](/pt-br/documentacao/plataforma/real-time-metrics/#edge-dns)**: Visualize gráficos agregados mostrando volumes de consulta, códigos de resposta e distribuição geográfica ao longo do tempo.
- **[GraphQL API](/pt-br/documentacao/devtools/graphql/)**: Consulte dados brutos e agregados de DNS para análise personalizada e integração com ferramentas de monitoramento.

<DocButton href="/pt-br/documentacao/plataforma/firewall/" label="consulte o guia de métricas do Edge DNS" kind="secondary" size="medium" />

### Reportar problemas

Se você enfrentar comportamento inesperado com replicação do Edge DNS ou respostas de consultas:

1. **Colete informações de diagnóstico**:
   - Saída do comando DIG ou HOST mostrando a resposta inesperada
   - Timestamp do problema observado (formato UTC preferido)
   - Nomes de domínio afetados e tipos de registro
   - Nameserver utilizado na consulta (ex: `ns1.aziondns.net`)
   - Localização geográfica onde o problema foi observado

2. **Verifique a página de status** para quaisquer incidentes em andamento em [status.azion.com](https://status.azion.com)

3. **Entre em contato com o Suporte Azion** através do [Suporte Azion](/pt-br/documentacao/suporte/) com as informações coletadas
...
Para configurar o redirecionamento em massa para a migração de domínios, acesse a documentação [Redirecionamento em massa para migração de domínios](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/integracoes/massive-redirect-integration/).
