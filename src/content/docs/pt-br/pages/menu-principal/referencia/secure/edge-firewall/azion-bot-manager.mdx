...
| dynamic_rules_baseline | Número | Não | `0` | Linha de base a ser usada nos cálculos feitos pelo algoritmo de regras dinâmicas. Pode ser usado para tornar as regras dinâmicas ainda mais rigorosas do que usar o `dynamic_rules_tolerance`. |
