...
<LinkButton link="/pt-br/documentacao/produtos/secure/firewall/network-layer-protection/network-lists/" label="saiba mais sobre network lists" severity="secondary" /> 
