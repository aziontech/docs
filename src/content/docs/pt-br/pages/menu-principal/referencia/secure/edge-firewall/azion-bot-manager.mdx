...
| dynamic_rules_baseline | Número | Não | `0` | Uma linha de base mais baixa significa detecções mais rigorosas. Ex.: 0,1 = aumentar a linha de base em 10% ou -0,234 = diminuir a linha de base em 23,4%. |
