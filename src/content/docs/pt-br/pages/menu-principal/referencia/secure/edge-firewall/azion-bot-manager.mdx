...
- Alternativamente, pode usar a Edge Function ALTCHA de forma independente, apenas com o Firewall e proteger áreas específicas da sua aplicação por meio do desafio. 
- Leia o guia [Como utilizar a Edge Function ALTCHA através do Marketplace da Azion](https://www.azion.com/pt-br/documentacao/produtos/guias/altcha/) para saber mais.
:::
