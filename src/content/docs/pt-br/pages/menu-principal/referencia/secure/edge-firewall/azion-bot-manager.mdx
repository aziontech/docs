...
A variedade de gráficos, combinada com o uso de filtros e tags de variação, permite realizar análises detalhadas de bots individuais, além de identificar tendências e padrões na atividade de bots ao longo do tempo.
