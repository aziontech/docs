...
<LinkButton severity="secondary" link="/pt-br/documentacao/produtos/guias/secure/trabalhar-com-rules-engine/" label="consulte o guia trabalhar com rules engine" severity="secondary" />
...
<LinkButton severity="secondary" link="/pt-br/documentacao/produtos/secure/edge-firewall/network-layer-protection/network-lists/" label="saiba mais sobre Network Lists" severity="secondary" />
...
<LinkButton severity="secondary" link="/pt-br/documentacao/produtos/secure/automarizar/origin-shield/" label="consulte o guia automatizar origin shield" severity="secondary" />
