...
:::tip[dica]
Saiba mais sobre as configurações de [Edge Firewall](/pt-br/documentacao/produtos/edge-firewall/) e [Rules Engine para Edge Firewall](/pt-br/documentacao/produtos/edge-firewall/rules-engine/).
:::
