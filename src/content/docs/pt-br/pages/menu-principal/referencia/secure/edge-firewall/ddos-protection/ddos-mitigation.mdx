...
description: >-
  A plataforma de Edge da Azion conta com mecanismos nativos ou programáveis de
  detecção e bloqueio automatizado de ameaças, passíveis de serem integrados a
  serviços de segurança e bases de inteligências de terceiros para uma proteção
  completa e de baixa latência.
...
* restrição de acesso na origem apenas para endereços IP da Azion;
