...
description: Na Azion, a Mitigação de DDoS é realizada pelo DDoS Protection, um add-on do Edge Firewall.
meta_tags: 'ddos, proteção, ataques, Edge Firewall, segurança, mitigação'
namespace: documentation_products_ddos_protection_ddos_mitigation
permalink: /documentacao/produtos/secure/edge-firewall/ddos-protection/ddos-mitigation/
---

import LinkButton from 'azion-webkit/linkbutton'

Na Azion, a mitigação de ataques DDoS é realizada pelo [DDoS Protection](/en/documentation/products/secure/edge-firewall/ddos-protection/), um add-on do **Edge Firewall**. O DDoS Protection é projetado para mitigar os maiores e mais complexos ataques DDoS nas camadas de rede, transporte, apresentação e aplicação, sem limitações de largura de banda.
...
<LinkButton link="/en/documentation/products/secure/edge-firewall/ddos-protection/" label="Saiba mais sobre o DDoS Protection" severity="secondary" target="_blank" />
...
:::tip
Você pode implementar regras personalizadas para mitigar ataques específicos, usando o [Edge Firewall](/en/documentation/products/secure/edge-firewall/), um firewall programável no edge equipado com Network Layer Protection, Rate Limiting, WAF e Bot Manager.
:::
