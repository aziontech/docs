...
<LinkButton link="/pt-br/documentacao/produtos/secure/edge-firewall/ddos-protection/" label="Saiba mais sobre o DDoS Protection" severity="secondary" target="_blank" />
...
:::tip
Você pode implementar regras personalizadas para mitigar ataques específicos, usando o [Edge Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/), um firewall programável no edge equipado com Network Layer Protection, Rate Limiting, WAF e Bot Manager.
:::
