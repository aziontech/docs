...
permalink: /documentacao/plataforma/ddos-protection/ddos-mitigation/
---
...
<DocButton href="/pt-br/documentacao/plataforma/ddos-protection/" label="Saiba mais sobre o DDoS Protection" kind="secondary" target="_blank" size="medium" />
...
:::tip
Você pode implementar regras personalizadas para mitigar ataques específicos, usando o [Firewall](/pt-br/documentacao/plataforma/firewall/), um firewall programável no edge equipado com Network Shield, Rate Limiting, WAF e Bot Manager.
:::
...
:::tip
O Security Response Team (SRT) pode ser contatado durante ou após um ataque, ou até mesmo preventivamente, na construção de regras personalizadas. Este serviço está disponível como um add-on para o suporte **Enterprise** e **Mission Critical**.
:::