...
O Origin Shield possui os IPs/CIDRs que a Azion utiliza para conectar nas origens do cliente ou nos endpoints de produtos como Datastream. Os IPs de downstream utilizados pelos clientes para se conectarem à Azion <ins>não são</ins> adicionados.
