...
Ao ativar o módulo **Network Shield** nas *Main Settings* de um edge firewall, as condições (*criteria*) e os comandos (*behavior*) serão disponibilizados na aba **Rules Engine** do edge firewall.
...
Ative todos os módulos de Firewall para obter todas as combinações de *criteria* e *behavior* durante a configuração do seu edge firewall.
