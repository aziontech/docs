...
Uma única Network List pode ser associada a mais de um firewall. Sempre que uma Network List for atualizada, ela se propagará automaticamente para todos os firewall associados a ela.
