...
Cada Workload está implicitamente associado a um Deployment. O Deployment define a relação entre o Workload e a Applications (obrigatório), além de componentes opcionais como Edge Firewall e Custom Pages.
...
<LinkButton link="/pt-br/documentacao/produtos/secure/edge-connector/" label="Acesse a Referência de Connectors"/>
