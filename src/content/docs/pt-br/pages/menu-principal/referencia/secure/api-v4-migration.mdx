...
<LinkButton link="/pt-br/documentacao/produtos/secure/workloads/" text="Acesse a Referência de Workloads" />
...
<LinkButton link="/pt-br/documentacao/produtos/secure/edge-connector/" text="Acesse a Referência de Edge Connector"/>
...
Os Error Responses existentes serão automaticamente convertidos em **Custom Pages** em fases, mantendo a compatibilidade com as configurações originais. A migração ocorrerá em ondas. Para mais informações sobre datas de migração, veja os detalhes abaixo.
...
<LinkButton link="/pt-br/documentacao/produtos/secure/custom-pages/" text="Acesse a Referência de Custom Pages"/>
