...
permalink: /documentacao/fundamentos/api-v4-migration/
---
...
<DocButton href="/pt-br/documentacao/plataforma/workloads/" label="Acesse a Referência de Workloads" size="medium" />
...
<DocButton href="/pt-br/documentacao/plataforma/connectors/" label="Acesse a Referência de Connectors" size="medium" />

---

## Custom Pages

O **Custom Pages** é um recurso da Azion que permite personalizar páginas de erro para os usuários com base no código de status recebido de um [Connectors](/pt-br/documentacao/plataforma/connectors/) ao buscar o conteúdo da sua origem.
...
<DocButton href="/pt-br/documentacao/plataforma/custom-pages/" label="Acesse a Referência de Custom Pages" size="medium" />
...
Você pode entrar em contato com nossa [equipe de suporte](/pt-br/documentacao/suporte/#canais-de-atendimento) ou perguntar diretamente ao [Azion Copilot](https://console.azion.com/copilot).
