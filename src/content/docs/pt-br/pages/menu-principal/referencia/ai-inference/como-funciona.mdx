...
<ItemList>
  ...
  <DocItem title="Arquitetura do AI Inference" href="/pt-br/documentacao/guias/ai/inferencia/ai-inference-architecture/">A mesma cadeia como arquitetura de referência, com uma função completa.</DocItem>
