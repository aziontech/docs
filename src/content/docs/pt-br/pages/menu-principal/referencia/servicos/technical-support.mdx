...
| CNAMEs already in use | Você encontrou o erro *CNAMEs already in use* ao listar um CNAME em seu [domínio Azion](/pt-br/documentacao/produtos/build/edge-application/workloads/). |
...
| Rules Engine | Você tem dúvidas sobre como configurar um comportamento usando [Rules Engine para Edge Application](/pt-br/documentacao/produtos/build/edge-application/rules-engine/) ou [Rules Engine para Edge Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/rules-engine/). |
