...
O **Azion Edge Services** é um módulo do produto **Edge Orchestrator** que permite o gerenciamento de serviços orquestrados em seus próprios nodes, habilitando o cadastro de recursos e demais configurações via [Real-Time Manager](https://console.azion.com/) e a criação e customização de serviços para que possam ser orquestrados nos Edge Nodes definidos.
