...
:::caution[importante]
Você está visualizando uma versão anterior desta documentação. Se a sua conta já foi migrada, consulte a [referência de main settings Edge Application](/pt-br/documentacao/produtos/build/edge-application/main-settings/) atualizada.
:::
