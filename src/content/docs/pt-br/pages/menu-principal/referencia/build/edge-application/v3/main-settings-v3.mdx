...
permalink: /documentacao/plataforma/applications/main-settings-v3/
---
...
:::note
Se você escolher entregar sua aplicação usando HTTP & HTTPS, você deve associar um [digital certificate](/pt-br/documentacao/plataforma/certificate-manager/para-firewall/) a seu domínio.
:::
...
<DocButton href="/pt-br/documentacao/guias/seguranca-de-aplicacoes/tls-e-certificados/cifras/" label="consulte o guia configurar o conjunto de cifras TLS" kind="secondary" size="medium" />
