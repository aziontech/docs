...
permalink: /documentacao/plataforma/workloads/mtls/
---
...
<DocButton kind="secondary" href="/pt-br/documentacao/guias/seguranca-de-aplicacoes/tls-e-certificados/associar-um-certificado-mtls/" label="consulte o guia associar um certificado mTLS a um domínio" kind="secondary" size="medium" /> 
...
> A lista de variáveis aceitas está disponível na página [Rules Engine para Applications](/pt-br/documentacao/plataforma/applications/rules-engine/).
