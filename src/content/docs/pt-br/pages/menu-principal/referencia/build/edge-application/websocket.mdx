...
description: >-
  Aumente a eficiência de suas edge applications em tempo real com o protocolo
  WebSocket para o Edge Application da Azion.
meta_tags: 'WebSocket, live, edge application, websockets, protocol'
namespace: documentation_products_edge_application_websocket
permalink: /documentacao/produtos/build/edge-application/websocket/
---
...
:::note
No momento, este módulo está disponível apenas para os Service Plans **Enterprise** e **Mission Critical**. [Contate o time de Suporte](https://tickets.azion.com/en/support/loginpt-BR/support/login) para solicitar acesso a esse módulo.
:::

Devido à sua natureza de conexão aberta bidirecional, WebSocket Proxy é incompatível com o uso dos módulos [Edge Functions](/pt-br/documentacao/produtos/build/edge-application/edge-functions/) e [Image Processor](/pt-br/documentacao/produtos/build/edge-application/image-processor/). Conexões WebSocket também não funcionarão em conjunto do [Edge Cache](/pt-br/documentacao/produtos/build/edge-application/edge-cache/) ou do [Tiered Cache](/pt-br/documentacao/produtos/build/edge-application/tiered-cache/).
