...
:::note
Este módulo está disponível apenas para planos **Enterprise** e **Mission Critical**. Para obter informações mais detalhadas sobre os planos de serviço da Azion, entre em contato com o [time de Suporte](https://tickets.azion.com/).
:::
