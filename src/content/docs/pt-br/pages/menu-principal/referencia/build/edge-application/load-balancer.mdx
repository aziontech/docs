...
permalink: /documentacao/produtos/build/edge-application/load-balancer/
---
...
| Escopo | Recursos |
| --- | --- |
| edge connector | [edge connector](/pt-br/documentacao/produtos/build/edge-application/edge connector/) |
...
<LinkButton link="/pt-br/documentacao/produtos/build/edge-application/edge connector/#address" label="Saiba mais sobre origin addresses" />
