...
Para mais opções de como direcionar o tráfego para o **Load Balancer** baseado em outros critérios, consulte a página [Rules Engine para Edge Application](/pt-br/documentacao/produtos/edge-application/rules-engine/).
