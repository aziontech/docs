...
permalink: /documentacao/produtos/build/edge-application/device-groups/
---
...
| Sobre Rules Engine | [Rules Engine](/pt-br/documentacao/produtos/build/edge-application/rules-engine/) |
| Sobre Adaptive Delivery | [Adaptive Delivery](/pt-br/documentacao/produtos/build/edge-application/cache-settings/#adaptive-delivery) |
...
> Para usar esta variável, você deve habilitar [Application Accelerator](/pt-br/documentacao/produtos/build/edge-application/application-accelerator/).
...
Saiba mais sobre o [Rules Engine](/pt-br/documentacao/produtos/build/edge-application/rules-engine/).
