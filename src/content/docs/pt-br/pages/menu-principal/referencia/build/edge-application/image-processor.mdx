...
meta_tags: 'Image Processor, applications computing'
...
:::tip
Acompanhe por meio do [Real-Time Metrics](/pt-br/documentacao/plataforma/real-time-metrics/) o gráfico de *Bandwidth Saving* para monitorar a economia de tráfego resultante do processamento de imagens.
:::
...
| Escopo | Recurso |
| --- | --- |
| Primeiros passos | [Primeiros passos do Image Processor](/pt-br/documentacao/guias/performance-e-confiabilidade/otimizacao-de-entrega/image-processor/) |
