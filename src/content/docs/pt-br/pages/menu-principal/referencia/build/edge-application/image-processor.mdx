...
## Dimensões e tamanho de arquivo

A tabela abaixo apresenta as dimensões máximas e os tamanhos de arquivo permitidos para o processamento de imagens.

| Image processor| Tamanho máximo | Altura máxima | Largura máxima |
|----------|----------|----------|----------|
| Otimização | 150mb | 2160 pixels | 3840 pixels |
