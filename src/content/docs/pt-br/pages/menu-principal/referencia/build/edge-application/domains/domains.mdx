...
Se você já possui um domínio, você pode redirecionar seu tráfego para a Azion configurando os registros em seu provedor de DNS e listando seus **custom domains**.
