...
title: Workloads
description: >-
  workloads Azion mantêm o conteúdo de suas edge applications em cache no edge e
  podem ser personalizados para atender às suas necessidades.
meta_tags: 'workloads, edge computing'
namespace: documentation_products_edge_application_workloads
permalink: /documentacao/produtos/build/edge-application/workloads/
---

O **Workloads** é um recurso do [Azion Console](https://console.azion.com) da Azion que fornece um serviço de geração e gerenciamento de domínios.
...
Se você já possui um domínio, você pode [redirecionar seu tráfego para a Azion](/pt-br/documentacao/produtos/guias/apontar-dominio-para-a-azion/) configurando os registros em seu provedor de DNS e listando seus **custom workloads**.
