...
<Apiv4Rollout />
:::caution[importante]
A Funcionalidade Domains foi substituída por **Workloads**. Para mais informações sobre o novo produto, acesse a [referência de Workloads](/documentacao/produtos/secure/workloads/).
:::
