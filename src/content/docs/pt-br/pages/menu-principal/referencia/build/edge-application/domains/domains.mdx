...
<Apiv4Rollout />
:::caution[importante]
A Funcionalidade Domains foi substituída por **Workloads**. Para mais informações sobre o novo produto, acesse a [Referência de Custom Pages](/pt-br/documentacao/produtos/secure/custom-pages/).
:::
...
Quando você [cria uma edge application](/pt-br/documentacao/produtos/guias/build/criar-uma-aplicacao/), sua aplicação recebe um **Azion domain** gerado automaticamente, no formato `xxxx.map.azionedge.net`. Você pode criar vários domínios para suas edge applications.
