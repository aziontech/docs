...
[<Badge variant="accent">Requer Application Accelerator</Tag>](/pt-br/documentacao/produtos/build/edge-application/application-accelerator/)
...
### Enable Large File Optimization
 <Tag severity="info" client:only="vue">Request Phase</Tag>
[<Badge variant="accent">Requer Edge Cache</Tag>](/pt-br/documentacao/produtos/build/edge-application/edge-cache/)
...
### Enforce HLS cache
 <Tag severity="info" client:only="vue">Request Phase</Tag>
<Badge variant="accent">Requer Live Ingest</Tag>
...
### Optimize Images 
 <Tag severity="info" client:only="vue">Request Phase</Tag>
[<Badge variant="accent">Requer Image Processor</Tag>](/pt-br/documentacao/produtos/build/edge-application/image-processor/)

Ativa a otimização de imagens.

### Redirect HTTP to HTTPS
 <Tag severity="info" client:only="vue">Request Phase</Tag>
[<Badge variant="accent">Requer aplicação HTTPS</Tag>](/pt-br/documentacao/produtos/build/edge-application/main-settings/)
...
### Run Function 
 <Tag severity="info" client:only="vue">Request Phase</Tag>  <Tag severity="info" client:only="vue">Response Phase</Tag>
[<Badge variant="accent">Requer Application Accelerator</Tag>](/pt-br/documentacao/produtos/build/edge-application/application-accelerator/)
[<Badge variant="accent">Requer Edge Functions</Tag>](pt-br/documentacao/produtos/build/edge-application/edge-functions/)
