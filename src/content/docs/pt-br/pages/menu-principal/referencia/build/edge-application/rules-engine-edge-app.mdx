...
<DocButton href="/pt-br/documentacao/produtos/build/applications/domains/mtls/" label="Saiba mais sobre suporte para mTLS" kind="secondary" size="medium" />
...
[<Tag severity="info">Requer Application Accelerator</Tag>](/pt-br/documentacao/produtos/build/applications/application-accelerator/)
...
<Tag severity="info">Request Phase</Tag>
[<Tag severity="info">Requer Cache</Tag>](/pt-br/documentacao/produtos/build/applications/cache/)
...
<DocButton href="/pt-br/documentacao/produtos/guias/implementar-cache-hls/" label="consulte o guia para implementar cache HLS" kind="secondary" size="medium" />
...
### Optimize Images 
<Tag severity="info">Request Phase</Tag>
[<Tag severity="info">Requer Image Processor</Tag>](/pt-br/documentacao/produtos/build/applications/image-processor/)

Ativa a otimização de imagens.

### Redirect HTTP to HTTPS
<Tag severity="info">Request Phase</Tag>
[<Tag severity="info">Requer aplicação HTTPS</Tag>](/pt-br/documentacao/produtos/build/applications/main-settings/)
...
<Tag severity="info">Request Phase</Tag> <Tag severity="info">Response Phase</Tag>
[<Tag severity="info">Requer Application Accelerator</Tag>](/pt-br/documentacao/produtos/build/applications/application-accelerator/)
[<Tag severity="info">Requer Functions</Tag>](/pt-br/documentacao/produtos/build/applications/functions/)
