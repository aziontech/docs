...
<LinkButton link="/pt-br/documentacao/produtos/build/edge-application/workloads/mtls/" label="Saiba mais sobre suporte para mTLS" severity="secondary" />
...
As origens devem ser previamente configuradas usando [edge connector](/pt-br/documentacao/produtos/build/edge-application/edge connector/).
