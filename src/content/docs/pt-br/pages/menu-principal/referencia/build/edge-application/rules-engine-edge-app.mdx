...
<Tag severity="info" client:only="vue">Request Phase</Tag>
[<Tag severity="info" client:only="vue">Requer Cache</Tag>](/pt-br/documentacao/produtos/build/applications/edge-cache/)
...
<Tag severity="info" client:only="vue">Request Phase</Tag> <Tag severity="info" client:only="vue">Response Phase</Tag>
[<Tag severity="info" client:only="vue">Requer Application Accelerator</Tag>](/pt-br/documentacao/produtos/build/applications/application-accelerator/)
[<Tag severity="info" client:only="vue">Requer Functions</Tag>](/pt-br/documentacao/produtos/build/applications/edge-functions/)
