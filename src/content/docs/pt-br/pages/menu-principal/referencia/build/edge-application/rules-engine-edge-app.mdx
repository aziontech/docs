...
[<Badge variant="accent">Requer Application Accelerator</Badge>](/pt-br/documentacao/produtos/build/edge-application/application-accelerator/)
...
<Badge>Request Phase</Badge>
[<Badge variant="accent">Requer Edge Cache</Badge>](/pt-br/documentacao/produtos/build/edge-application/edge-cache/)
...
### Optimize Images 
<Badge>Request Phase</Badge>
[<Badge variant="accent">Requer Image Processor</Badge>](/pt-br/documentacao/produtos/build/edge-application/image-processor/)

Ativa a otimização de imagens.

### Redirect HTTP to HTTPS
<Badge>Request Phase</Badge>
[<Badge variant="accent">Requer aplicação HTTPS</Badge>](/pt-br/documentacao/produtos/build/edge-application/main-settings/)
...
<Badge>Request Phase</Badge> <Badge>Response Phase</Badge>
[<Badge variant="accent">Requer Application Accelerator</Badge>](/pt-br/documentacao/produtos/build/edge-application/application-accelerator/)
[<Badge variant="accent">Requer Edge Functions</Badge>](pt-br/documentacao/produtos/build/edge-application/edge-functions/)
