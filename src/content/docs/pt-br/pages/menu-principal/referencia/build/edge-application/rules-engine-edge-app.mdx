...
permalink: /documentacao/plataforma/applications/rules-engine/
---
...
| Criar uma regra | [Como criar regras de Request e Response usando o Rules Engine para Applications](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/rules-engine/) |
| Criar uma configuração de cache | [Como configurar políticas de cache para Applications](/pt-br/documentacao/guias/performance-e-confiabilidade/cache-e-purge/cache-settings/) |
| Mitigar HTTPoxy usando rules | [Como mitigar a vulnerabilidade HTTPoxy](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/como-mitigar-vulnerabilidade-httpoxy/) |
...
| `${device_group}` | Nome do device group. Você pode criar [device groups](/pt-br/documentacao/plataforma/applications/device-groups/) na aba **Device Groups** de sua aplicação no Azion Console | `Mobile` | Request <br />Response |
...
<DocButton href="/pt-br/documentacao/plataforma/workloads/mtls/" label="Saiba mais sobre suporte para mTLS" kind="secondary" size="medium" />
...
| `${encode_base64(string)}` | Retorna o argumento codificado em base64 | `${encode_base64(http://www.yourdomain.com/)}` assume `aHR0cDovL3d3dy55b3VyZG9tYWluLmNvbS8=` |
...
[<Tag severity="info">Requer Application Accelerator</Tag>](/pt-br/documentacao/build/application-accelerator/)
...
:::tip
Consulte o guia [Como configurar a políticas de cache para Applications](/pt-br/documentacao/guias/performance-e-confiabilidade/cache-e-purge/cache-settings/#bypass-cache) para mais informações sobre o uso de Bypass Cache.
:::
...
Ativa a compressão de dados em gzip, caso suportada pelo browser do usuário. Consulte o guia de [Como habilitar compressão gzip](/pt-br/documentacao/guias/performance-e-confiabilidade/otimizacao-de-entrega/gzip-compression/) para mais informações.

### Enable Large File Optimization
<Tag severity="info">Request Phase</Tag>
[<Tag severity="info">Requer Cache</Tag>](/pt-br/documentacao/build/cache/)
...
Ao ativar esta funcionalidade, a Azion irá requisitar os objetos para sua origem via range requests e os mesmos serão cacheados na Azion com [Advanced Cache Key](/pt-br/documentacao/build/cache/cache-settings/#advanced-cache-key).
...
### Enforce HLS cache
<Tag severity="info">Request Phase</Tag>
<Tag severity="info">Requer Live Ingest</Tag>
...
<DocButton href="/pt-br/documentacao/guias/performance-e-confiabilidade/cache-e-purge/implementar-cache-hls/" label="consulte o guia para implementar cache HLS" kind="secondary" size="medium" />
...
Para evitar que um usuário receba o cabeçalho `Set-Cookie` da sessão de outro usuário, consulte o [guia sobre políticas de cache](/pt-br/documentacao/guias/performance-e-confiabilidade/cache-e-purge/cache-settings/#criando-uma-regra-para-enviar-cookies-da-origem-ao-usuario).
...
### Optimize Images 
<Tag severity="info">Request Phase</Tag>
[<Tag severity="info">Requer Image Processor</Tag>](/pt-br/documentacao/build/image-processor/)

Ativa a otimização de imagens.

### Redirect HTTP to HTTPS
<Tag severity="info">Request Phase</Tag>
[<Tag severity="info">Requer aplicação HTTPS</Tag>](/pt-br/documentacao/plataforma/applications/main-settings/)
...
<Tag severity="info">Request Phase</Tag> <Tag severity="info">Response Phase</Tag>
[<Tag severity="info">Requer Application Accelerator</Tag>](/pt-br/documentacao/build/application-accelerator/)
[<Tag severity="info">Requer Functions</Tag>](/pt-br/documentacao/build/functions/)

Executa uma função criada no **Functions** e instanciada pela aba **Functions** da application. Consulte o guia de [Como executar funções serverless](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/functions-e-runtime/funcoes-serverless/) para mais informações.

### Set Cache Policy
<Tag severity="info">Request Phase</Tag>

Atribui a política de cache que deve ser utilizada para a requisição. As políticas de cache devem ser previamente configuradas na [Cache Settings](/pt-br/documentacao/build/cache/cache-settings/).

Na política de cache você configura o tempo que o objeto deve ser armazenado em cache e as regras para variação dos objetos em cache com a [Advanced Cache Key](/pt-br/documentacao/build/cache/cache-settings/#advanced-cache-key).
...
As origens devem ser previamente configuradas usando [Origins](/pt-br/documentacao/plataforma/connectors/origins/).
...
Você pode executar o fazer o [debug de regras criadas com Rules Engine](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/debug-regras/) usando **GraphQL API**, **Data Stream** ou **Real-Time Events**.
