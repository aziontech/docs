...
| `${device_group}` | Nome do device group. Você pode criar [device groups](/pt-br/documentacao/produtos/edge-application/device-groups/) na aba **Device Groups** de sua aplicação no Azion Console | `Mobile` | Request <br />Response |
...
<Badge>Request Phase</Badge>
[<Badge variant="accent">Requer Edge Cache</Badge>](/pt-br/documentacao/produtos/edge-application/edge-caching/)
