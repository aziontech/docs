...
Com [Edge Application](/pt-br/documentacao/produtos/build/edge-application/), você pode escolher o protocolo de entrega e as portas de sua aplicação. Você também pode garantir a segurança da conexão HTTPS entre a aplicação e seus usuários com cifras TLS.
...
:::note
Se você escolher entregar sua aplicação usando HTTP & HTTPS, você deve associar um [digital certificate](/pt-br/documentacao/produtos/build/edge-application/digital-certificates/) a seu domínio.
:::
...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/secure/cifras/" label="consulte o guia configurar o conjunto de cifras TLS" variant="secondary" />
