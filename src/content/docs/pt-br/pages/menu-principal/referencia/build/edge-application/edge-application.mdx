...
| Saiba mais sobre custom pages | [custom pages](/pt-br/documentacao/produtos/build/edge-application/custom-pages/) |
| Saiba mais sobre edge connector | [edge connector](/pt-br/documentacao/produtos/build/edge-application/edge connector/) |
...
| [Load Balancer](/pt-br/documentacao/produtos/build/edge-application/load-balancer/) | Equilibre o tráfego entre seus servidores de origem e provedores de nuvem para melhorar a tolerância a falhas e evitar o congestionamento da rede. |
...
| [edge connector](/pt-br/documentacao/produtos/build/edge-application/edge connector/) | Modifique seu endereço de origem, cabeçalho `Host`, path, políticas de protocolo e credenciais de autenticação HMAC. |
...
| [custom pages](/pt-br/documentacao/produtos/build/edge-application/custom-pages/) | Personalize as páginas de resposta de erro, seu tempo de expiração em cache e sua origem. |
...
Azion **Workloads** oferece a flexibilidade de usar domínios gerados automaticamente ou seus próprios domínios personalizados, permitindo que você gerencie e entregue conteúdo de forma eficaz por meio de suas edge applications com suporte para conexões seguras por HTTP e HTTPS.

<LinkButton severity="secondary" label="Saiba mais sobre workloads" link="/pt-br/documentacao/produtos/build/edge-application/workloads/" />
