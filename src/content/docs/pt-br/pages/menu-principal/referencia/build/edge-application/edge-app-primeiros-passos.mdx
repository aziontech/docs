...
O **Edge Connector** permite configurar múltiplas origens e distribuir o tráfego entre elas utilizando o [Load Balancer](/pt-br/documentacao/produtos/secure/edge-connector/load-balancer/).
