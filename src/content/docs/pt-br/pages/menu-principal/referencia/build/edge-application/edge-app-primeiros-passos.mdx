...
permalink: /documentacao/plataforma/applications/primeiros-passos/
---

Antes de usar *Applications*, certifique-se que você tem:

- Uma conta no Azion Console. Você pode encontrar mais informações sobre como criar sua conta na [página de documentação](/pt-br/documentacao/fundamentos/criar-uma-conta/).
- Uma application. Se você ainda não criou uma application, confira a página sobre [criar uma aplicação](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/criar-uma-aplicacao/).

> Consulte também os guias sobre [como clonar](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/clonar-applications/) e [como excluir](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/excluir-applications/) uma application.

## Main Settings

Para acessar as configurações principais de sua application:

1. [Acesse o Azion Console](https://console.azion.com).
2. No canto superior esquerdo da página, abra o **Products menu**, identificado pelas três linhas horizontais, e selecione **Applications**.
3. Selecione a application que deseja configurar.

Agora você está na área onde pode definir as configurações gerais de entrega de sua aplicação.

### Módulos de Applications

**Applications** oferece os seguintes módulos:

- [Application Accelerator](/pt-br/documentacao/build/application-accelerator/)
- [Cache](/pt-br/documentacao/build/cache/)
- [Functions](/pt-br/documentacao/build/functions/)
- [Image Processor](/pt-br/documentacao/build/image-processor/)
- [Tiered Cache](/pt-br/documentacao/build/cache/tiered-cache/)

Alguns **módulos de Applications** são produtos faturados.Isso pode gerar custos relacionados ao uso,consulte a [página de preços](/pt-br/documentacao/fundamentos/precos/) para mais informações.

Para ativar um módulo em sua application:

1. [Acesse o Azion Console](https://console.azion.com).
2. No canto superior esquerdo da página, vá para o **Products menu** > **Applications**.
3. Selecione a application que deseja configurar.
...
- [Device Groups](/pt-br/documentacao/plataforma/applications/device-groups/)
- [Cache Settings](/pt-br/documentacao/build/cache/cache-settings/)
- [Functions](/pt-br/documentacao/build/functions/functions-instances/)
- [Rules Engine](/pt-br/documentacao/plataforma/applications/rules-engine/)

Cada aba armazena outras opções de configuração para sua application.
...
Para configurar a origem da sua Applications, você usará o [Connectors](/pt-br/documentacao/plataforma/connectors/).

1. [Acesse o Console](https://console.azion.com).
2. No canto superior esquerdo da página, selecione **Products Menu** > **Connectors**.
3. Crie um Connector clicando no botão **\+ Connector**.
4. No campo **Connector Type**, selecione o tipo de connector desejado.
5. Preencha os demais campos.
6. Clique no botão **Save**.

:::note
Para mais detalhes sobre os tipos de conector, acesse a [referência do Connectors](/pt-br/documentacao/plataforma/connectors/).
:::
...
O **Connectors** permite configurar múltiplas origens e distribuir o tráfego entre elas utilizando o [Load Balancer](/pt-br/documentacao/plataforma/load-balancer/).

:::tip
Você pode usar o [Custom Pages](/pt-br/documentacao/plataforma/custom-pages/) para configurar páginas de erro personalizadas que são exibidas quando o **Connectors** recebe respostas de erro específicas (como códigos de status HTTP 4xx ou 5xx) da sua origem.
:::

### Device Groups

Para gerenciar grupos de dispositivos usando [Device Groups](/pt-br/documentacao/plataforma/applications/device-groups/):
...
Edite suas configurações de cache na aba [Cache Settings](/pt-br/documentacao/build/cache/):
...
5. Se você optou por substituir as configurações de cache, adicione o **Maximum TTL** desejado em segundos.
   - Neste ponto, você também pode personalizar outras configurações de cache para conteúdo dinâmico fornecido pelo recurso [Advanced Cache Key](/pt-br/documentacao/build/cache/cache-settings/#application-accelerator) .
6. Clique no botão **Save**.

#### Tiered Cache

Para usar o módulo [Tiered Cache](/pt-br/documentacao/build/cache/tiered-cache/):

1. Na aba **Main Settings**, no final da seção **Applications Modules**, ative **Tiered Cache**.
...
Instancie suas funções usando as [Functions](/pt-br/documentacao/build/functions/functions-instances/):

1. Na aba **Main Settings* , ative o módulo **Functions**.
...
Crie regras de negócios condicionais para sua aplicação usando o [Rules Engine](/pt-br/documentacao/plataforma/applications/rules-engine/).
...
Para acessar a [Real-Time Purge](/pt-br/documentacao/build/cache/real-time-purge/), proceda da seguinte forma:
