...
- Uma application. Se você ainda não criou uma application, confira a página sobre [criar uma aplicação](/pt-br/documentacao/produtos/guias/build/criar-uma-aplicacao/).

> Consulte também os guias sobre [como clonar](/pt-br/documentacao/produtos/guias/clonar-applications/) e [como excluir](/pt-br/documentacao/produtos/guias/excluir-applications/) uma application.
...
- [Application Accelerator](/pt-br/documentacao/produtos/build/applications/application-accelerator/)
- [Cache](/pt-br/documentacao/produtos/build/applications/edge-cache/)
- [Functions](/pt-br/documentacao/produtos/build/applications/edge-functions/)
...
- [Device Groups](/pt-br/documentacao/produtos/build/applications/device-groups/)
- [Cache Settings](/pt-br/documentacao/produtos/build/applications/cache-settings/)
- [Functions](/pt-br/documentacao/produtos/build/applications/edge-functions-instances/)
...
Para configurar a origem da sua Applications, você usará o [Connector](/pt-br/documentacao/produtos/secure/edge-connector/).

1. [Acesse o Console](https://console.azion.com).
2. No canto superior esquerdo da página, selecione **Products Menu** > **Connector**.
...
:::note
Para mais detalhes sobre os tipos de conector, acesse a [referência do Connector](/pt-br/documentacao/produtos/secure/edge-connector/).
:::
...
O **Connector** permite configurar múltiplas origens e distribuir o tráfego entre elas utilizando o [Load Balancer](/pt-br/documentacao/produtos/secure/edge-connector/load-balancer/).

:::tip
Você pode usar o [Custom Pages](/pt-br/documentacao/produtos/secure/custom-pages/) para configurar páginas de erro personalizadas que são exibidas quando o **Connector** recebe respostas de erro específicas (como códigos de status HTTP 4xx ou 5xx) da sua origem.
:::

### Device Groups

Para gerenciar grupos de dispositivos usando [Device Groups](/pt-br/documentacao/produtos/build/applications/device-groups/):
...
Edite suas configurações de cache na aba [Cache Settings](/pt-br/documentacao/produtos/build/applications/cache/):
...
5. Se você optou por substituir as configurações de cache, adicione o **Maximum TTL** desejado em segundos.
   - Neste ponto, você também pode personalizar outras configurações de cache para conteúdo dinâmico fornecido pelo recurso [Advanced Cache Key](/pt-br/documentacao/produtos/build/applications/cache-settings/#advanced-cache-key) .
6. Clique no botão **Save**.

#### Tiered Cache

Para usar o módulo [Tiered Cache](/pt-br/documentacao/produtos/build/applications/cache/tiered-cache/):
...
Instancie suas funções usando as [Functions](/pt-br/documentacao/produtos/build/applications/functions-instances/):
...
Crie regras de negócios condicionais para sua aplicação usando o [Rules Engine](/pt-br/documentacao/produtos/build/applications/rules-engine/).
...
Para acessar a [Real-Time Purge](/pt-br/documentacao/produtos/build/applications/real-time-purge/), proceda da seguinte forma:
