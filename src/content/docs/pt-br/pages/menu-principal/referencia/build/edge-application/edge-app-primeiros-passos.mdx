...
Uma origem representa o servidor de onde a Azion busca o seu conteúdo, que pode ser um serviço de armazenamento de objetos ou um servidor em nuvem.
...
4. No campo **Connector Type**, selecione o tipo de conector desejado.
...
Ao utilizar múltiplas origens para sua Edge Application, você pode usar o [Load Balancer](/en/documentation/products/build/edge-application/load-balancer/) para balancear o tráfego.
...
Configure suas páginas de erro usando [Error Responses](/pt-br/documentacao/produtos/build/edge-application/error-responses/):
