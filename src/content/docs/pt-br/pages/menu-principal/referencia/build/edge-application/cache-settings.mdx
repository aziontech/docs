...
**Slice** funciona com uma faixa de *slice range* de *1024kB*. Se você deseja modificar a *slice range*, [contate a equipe de Vendas](https://www.azion.com/pt-br/contate-vendas/).
