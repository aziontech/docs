...
**Large File Optimization** funciona com o tamanho de fragmentação de *1.024kB*. Se você deseja modificar o *fragmentation size*, [contate a equipe de Vendas](https://www.azion.com/pt-br/contate-vendas/).
