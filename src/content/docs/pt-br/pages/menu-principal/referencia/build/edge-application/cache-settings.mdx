...
| Configurar Advanced Cache Key | [Como configurar a Advanced Cache Key para Applications](/pt-br/documentacao/produtos/guias/advanced-cache-key/) |
...
- **Override Cache Settings**: substitui a configuração de cache do seu servidor de origem com o TTL desejado. Para definir o TTL de cache CDN para valores inferiores a 60 segundos, você deve habilitar o módulo [Application Accelerator](/pt-br/documentacao/produtos/build/applications/application-accelerator/).
...
<DocButton href="/pt-br/documentacao/produtos/build/applications/cache/#large-file-optimization" label="Saiba mais sobre Large File Optimization" size="medium" />
...
<DocButton href="/pt-br/documentacao/produtos/build/applications/cache/#stale-cache" label="Saiba mais sobre stale cache" size="medium" />
...
<DocButton href="/pt-br/documentacao/produtos/build/applications/device-groups/" label="Saiba mais sobre Device Groups" size="medium" />
