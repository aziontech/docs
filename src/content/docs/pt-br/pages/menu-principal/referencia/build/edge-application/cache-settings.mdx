...
<LinkButton outlined link="/pt-br/documentacao/produtos/build/edge-application/edge-cache/#large-file-optimization" label="Saiba mais sobre Large File Optimization" />
...
<LinkButton outlined link="/ppt-br/documentacao/produtos/build/edge-application/tiered-cache/" label="Saiba mais sobre Tiered Cache" />
...
<LinkButton outlined link="/pt-br/documentacao/produtos/build/edge-application/edge-cache/#stale-cache" label="Saiba mais sobre stale cache" />
...
<LinkButton outlined link="/pt-br/documentacao/produtos/build/edge-application/device-groups/" label="Saiba mais sobre Device Groups" />
