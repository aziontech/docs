...
> Para ambos os casos, este campo diferencia maiúsculas de minúsculas, o que significa que ele trata letras maiúsculas e minúsculas de forma diferente ao armazenar objetos no cache.
