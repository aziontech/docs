...
**Slice** funciona com uma faixa de *slice range* de *1.024kB*. Se você deseja modificar a *slice range*, [contate a equipe de Vendas](https://www.azion.com/pt-br/contate-vendas/).

<Button href="/pt-br/documentacao/produtos/edge-application/edge-caching/#slice-files" text="Saiba mais sobre slice files"></Button>

:::note
Ao ativar a funcionalidade Slice, a *cache key* atual será ignorada e uma nova será criada.
:::

Slice pode ser aplicado tanto à camada da edge quanto à Tiered Cache, desde que o módulo **Tiered Cache** esteja ativo.
