...
- **Override Cache Settings**: substitui a configuração de cache do seu servidor de origem com o TTL desejado. Para definir o TTL de cache CDN para valores inferiores a 60 segundos, você deve habilitar o módulo [Application Accelerator](/pt-br/documentacao/produtos/edge-application/application-accelerator/).
...
<Button href="/pt-br/documentacao/produtos/edge-application/edge-caching/#large-file-optimization" text="Saiba mais sobre Large File Optimization"></Button>
...
<Button href="/pt-br/documentacao/produtos/edge-application/l2-caching/" text="Saiba mais sobre Tiered Cache"></Button>
