...
<Button href="/pt-br/documentacao/produtos/build/edge-application/edge-cache/#large-file-optimization" text="Saiba mais sobre Large File Optimization"></Button>
...
<Button href="/ppt-br/documentacao/produtos/build/edge-application/tiered-cache/" text="Saiba mais sobre Tiered Cache"></Button>
...
<Button href="/pt-br/documentacao/produtos/build/edge-application/edge-cache/#stale-cache" text="Saiba mais sobre stale cache"></Button>
...
<Button href="/pt-br/documentacao/produtos/build/edge-application/device-groups/" text="Saiba mais sobre Device Groups"></Button>
