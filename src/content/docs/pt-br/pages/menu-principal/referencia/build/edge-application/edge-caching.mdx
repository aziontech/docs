...
| **REVALIDATED** | O conteúdo em cache expirou ou foi previamente servido como stale, mas não foi modificado desde o momento em que foi registrado. Se o cache ainda for válido, a edge retorna este status e não irá requisitar o conteúdo completo da origem |
