...
Quando a funcionalidade [Advanced Cache Key](/pt-br/documentacao/build/application-accelerator/#advanced-cache-key) estiver configurada, a formação das cache keys também é afetada.
