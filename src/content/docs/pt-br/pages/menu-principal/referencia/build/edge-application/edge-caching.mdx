...
<LinkButton link="/pt-br/documentacao/produtos/build/edge-application/cache-settings/#stale-cache" text="Saiba mais sobre stale cache" />
...
<LinkButton link="/pt-br/documentacao/produtos/build/edge-application/cache-settings/#adaptive-delivery" text="Saiba mais sobre adaptive delivery" />
...
<LinkButton link="/pt-br/documentacao/produtos/build/edge-application/cache-settings/#large-file-optimization" text="Saiba mais sobre configurações de large file optimization" />
