...
<Button href="/pt-br/documentacao/produtos/edge-application/cache-settings/#large-file-optimization" text="Saiba mais sobre configurações de large file optimization"></Button>
