...
Você pode obter a cache key de qualquer recurso em uma edge application por meio de uma requisição para o URI do conteúdo, adicionando o cabeçalho de debug da Azion `Pragma: azion-debug-cache`:
...
:::note
Saiba mais sobre como obter outros dados de cache no guia [Como verificar indicadores de cache usando Modheader para Google Chrome](/documentacao/produtos/guias/verificar-tempo-de-cache-da-pagina/).
:::
...
Um objeto com o URI `https://static.seudominio.com/pagina/site.js` deveria gerar a cache key `httpsstatic.seudominio.com/pagina/site.js`.
...
Quando o [Image Processor](/pt-br/documentacao/produtos/edge-application/image-processor/) está ativado, além da query string `ims`, variações com formato convertido contém o formato do arquivo após o separador.
