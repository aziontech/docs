...
<Button href="/pt-br/documentacao/produtos/build/applications/cache-settings/#large-file-optimization" label="Saiba mais sobre configurações de large file optimization" type="primary" theme="light" />
