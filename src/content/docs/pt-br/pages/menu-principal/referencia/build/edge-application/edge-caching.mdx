...
<Button href="/pt-br/documentacao/produtos/build/edge-application/cache-settings/#stale-cache" text="Saiba mais sobre stale cache"></Button>
...
<Button href="/pt-br/documentacao/produtos/build/edge-application/cache-settings/#adaptive-delivery" text="Saiba mais sobre adaptive delivery"></Button>
...
<Button href="/pt-br/documentacao/produtos/build/edge-application/cache-settings/#large-file-optimization" text="Saiba mais sobre configurações de large file optimization"></Button>
