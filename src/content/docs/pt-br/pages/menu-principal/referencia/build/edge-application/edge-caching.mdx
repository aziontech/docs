---
title: Edge Cache
description: Edge Cache acelera a entrega de conteúdo através de cache em edge e deixa sua aplicação mais próxima de seus usuários.
meta_tags: caching, edge, edge cache, edge computing, performance, status, bypass, hit, miss
