...
<LinkButton outlined link="/pt-br/documentacao/produtos/build/edge-application/cache-settings/#stale-cache" label="Saiba mais sobre stale cache" />
...
<LinkButton outlined link="/pt-br/documentacao/produtos/build/edge-application/cache-settings/#adaptive-delivery" label="Saiba mais sobre adaptive delivery" />
...
<LinkButton outlined link="/pt-br/documentacao/produtos/build/edge-application/cache-settings/#large-file-optimization" label="Saiba mais sobre configurações de large file optimization" />
