...
Existem diferentes maneiras de gerenciar suas edge functions. Você pode fazer isso através [do Azion Console](https://console.azion.com/), [Azion CLI](/pt-br/documentacao/produtos/cli/), [Azion API](https://api.azion.com/) e [Terraform](/pt-br/documentacao/produtos/terraform-provider/).
