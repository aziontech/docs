...
| Criar edge functions | [Como criar e configurar edge functions](/pt-br/documentacao/produtos/guias/build/instanciar-edge-functions/) |
| Exemplos | [Exemplos](/pt-br/documentacao/devtools/javascript-examples/) |
| Amostras de código | [Repositório GitHub](https://github.com/aziontech/azion-samples/tree/dev/samples) |
...
| - | - | 
| API Builder | [Como construir uma API com Edge Functions e ChatGPT](/pt-br/documentacao/produtos/guias/edge-functions/api-builder/) |
| API v4 Edge Functions | [Documentação da API v4](/pt-br/documentacao/devtools/api-v4/edge-functions/) |
| Criar edge functions | [Como criar e configurar edge functions](/pt-br/documentacao/produtos/guias/build/instanciar-edge-functions/) |
| Exemplos | [Exemplos](/pt-br/documentacao/devtools/javascript-examples/) |
| Amostras de código | [Repositório GitHub](https://github.com/aziontech/azion-samples/tree/dev/samples) |
...
| - | - | 
| API Builder | [Como construir uma API com Edge Functions e ChatGPT](/pt-br/documentacao/produtos/guias/edge-functions/api-builder/) |
| API v3 Edge Functions | [Documentação da API v3](/pt-br/documentacao/produtos/api/) |
| Criar edge functions | [Como criar e configurar edge functions](/pt-br/documentacao/produtos/guias/build/instanciar-edge-functions/) |
| Exemplos | [Exemplos](/pt-br/documentacao/devtools/javascript-examples/) |
| Amostras de código | [Repositório GitHub](https://github.com/aziontech/azion-samples/tree/dev/samples) |
...
O **Edge AI** da Azion permite que você execute modelos de AI no Azion Runtime, e pode ser usado junto com as Edge Functions para criar aplicações complexas impulsionadas por AI.
