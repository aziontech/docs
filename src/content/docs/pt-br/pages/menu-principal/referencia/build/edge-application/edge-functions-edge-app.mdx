...
- Executar agentes de AI diretamente na infraestrutura distribuída da Azion com latência ultra-baixa, construindo soluções de nível empresarial que operam no edge com confiabilidade e escalabilidade.
- Cria fluxos de trabalho de AI sofisticados usando integrações com **LangGraph** e **LangChain**, incluindo capacidades avançadas de recuperação que combinam busca vetorial e busca de texto completo para casos de uso complexos.
- Aproveitar a integração nativa do [Edge SQL](/pt-br/documentacao/produtos/store/edge-sql/) para implementações de RAG e armazenamento vetorial, juntamente com Servidores MCP que permitem a colaboração entre agentes usando o protocolo Agent2Agent (A2A) do Google.
- Acessar modelos de ponta como Mistral, Florence, Qwen e outros, que seguem o padrão de API da OpenAI, tudo isso reduzindo a complexidade com uma infraestrutura de AI completamente integrada que é executada no edge da rede.

O **Edge AI** da Azion permite que você execute modelos de AI no Azion Runtime, e pode ser usada junto com as Edge Functions para criar aplicações complexas impulsionadas por AI.

<LinkButton link="/pt-br/documentacao/produtos/ai/edge-ai/" label="Saiba mais sobre Edge AI" severity="secondary" target="_blank" />
