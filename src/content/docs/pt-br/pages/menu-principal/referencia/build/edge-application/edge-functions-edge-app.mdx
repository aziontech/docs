...
Existem diferentes maneiras de gerenciar suas edge functions. Você pode fazer isso através [do Real-Time Manager (RTM)](https://console.azion.com/), [Azion CLI](/pt-br/documentacao/produtos/cli/), [Azion API](https://api.azion.com/) e [Terraform](/pt-br/documentacao/produtos/terraform-provider/).

### RTM

Você pode criar e gerenciar edge functions através do [Real-time Manager (RTM)](https://console.azion.com/), no **Products menu**, no canto superior esquerdo. abaixo de **Edge Libraries**.
