...
| Escopo | Guia |
| - | - |
| API Builder| [Como construir uma API com Functions e ChatGPT](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/functions-e-runtime/api-builder/) 
| Exemplos de functions em JavaScript| [Exemplos](/pt-br/documentacao/build/functions/javascript-exemplos/)|
...
Ao usar o [Azion Runtime](/pt-br/documentacao/devtools/runtime/) para desenvolver suas functions, você tem um conjunto de ferramentas que o ajudam a implementar sua lógica.

<DocButton href="/pt-br/documentacao/devtools/runtime/" label="saiba mais sobre o Azion Runtime" kind="secondary" target="_blank" size="medium" />

<br /><DocButton href="/pt-br/documentacao/devtools/runtime/frameworks/compatibilidade-frameworks/" label="saiba mais sobre os Web frameworks suportados" kind="secondary" target="_blank" size="medium" />
<br /><DocButton href="/pt-br/documentacao/devtools/runtime/node/" label="saiba mais sobre o suporte ao Node.js" kind="secondary" target="_blank" size="medium" />
<br /><DocButton href="/pt-br/documentacao/devtools/runtime/api-reference/javascript/" label="saiba mais sobre as Web APIs suportadas" kind="secondary" target="blank" size="medium" />
...
1. **Detecção do framework**: Quando você inicializa um projeto com o [Azion CLI](/pt-br/documentacao/devtools/cli/), o bundler identifica seu framework e aplica o adaptador apropriado.
...
Para a lista completa de frameworks suportados e informações detalhadas de compatibilidade, consulte [Compatibilidade de frameworks](/pt-br/documentacao/devtools/runtime/frameworks/compatibilidade-frameworks/).

### Implicações práticas

Ao fazer o deploy de um projeto com framework, considere:

- **Custos de compute**: Deploys de frameworks geram Functions, que incorrem em cobranças de tempo de compute e invocações. Consulte [Preços](/pt-br/documentacao/fundamentos/precos/) para detalhes.
- **Debugging**: Use [Preview Deployment](/pt-br/documentacao/build/functions/preview-deployment/), [Data Stream](/pt-br/documentacao/guias/plataforma/observabilidade/debugging-functions-data-stream/) ou [GraphQL API](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/functions-e-runtime/debugging-functions-graphql/) para depurar Functions geradas por frameworks.
- **Variáveis de ambiente**: Acesse variáveis de ambiente no código do seu framework usando a [API de variáveis de ambiente da Azion](/pt-br/documentacao/devtools/runtime/api-reference/environment-variables/).

<DocButton href="/pt-br/documentacao/devtools/runtime/frameworks/compatibilidade-frameworks/" label="Ver todos os frameworks suportados" kind="secondary" target="_blank" size="medium" />
<br /><DocButton href="https://github.com/aziontech/bundler" label="Explore o Azion Bundler no GitHub" kind="secondary" target="_blank" size="medium" />
...
- Aproveite a integração nativa do [SQL Database](/pt-br/documentacao/store/sql-database/) para implementações de RAG e armazenamento vetorial, juntamente com Servidores MCP que permitem a colaboração entre agentes usando o protocolo Agent2Agent (A2A) do Google.
...
<DocButton href="/pt-br/documentacao/build/ai-inference/" label="Saiba mais sobre AI Inference" kind="secondary" target="_blank" size="medium" />
...
Veja [Como criar uma functions usando WebAssembly na Azion Web Platform](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/functions-e-runtime/webassembly-na-plataforma-azion/).
...
Saiba mais sobre [Functions Instances](/pt-br/documentacao/build/functions/functions-instances/).
...
Saiba mais sobre [Rules Engine](/pt-br/documentacao/plataforma/applications/rules-engine/).
...
Saiba mais sobre o [Functions Code Editor](/pt-br/documentacao/build/functions/code-editor/).
...
Saiba mais sobre o [Assistente de IA](/pt-br/documentacao/build/functions/ai-integration/).
...
Saiba mais sobre o [Preview Deployment](/pt-br/documentacao/build/functions/preview-deployment/).

---

## Debug

Você pode depurar suas functions em tempo real usando a ferramenta de `inspeção` dentro do [Preview Deployment](/pt-br/documentacao/build/functions/preview-deployment/).

Você também pode depurar usando:

- [Data Stream](/pt-br/documentacao/guias/plataforma/observabilidade/debugging-functions-data-stream/)
- [GraphQL API](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/functions-e-runtime/debugging-functions-graphql/)
...
Saiba mais sobre a interface de [Variáveis de Ambiente](/pt-br/documentacao/devtools/runtime/api-reference/environment-variables/).
...
Existem diferentes maneiras de gerenciar suas functions. Você pode fazer isso através [do Azion Console](https://console.azion.com), [Azion CLI](/pt-br/documentacao/devtools/cli/), [Azion API](https://api.azion.com/) e [Terraform](/pt-br/documentacao/devtools/terraform/).
...
O [Azion Terraform Provider](/pt-br/documentacao/devtools/terraform/) permite o gerenciamento de functions na plataforma da Azion. Ele possibilita tratar sua infraestrutura como código.
...
Você pode solicitar o aumento dos limites com base no seu plano. Entre em contato com a [equipe de suporte técnico](/pt-br/documentacao/suporte/) para solicitar.
:::
