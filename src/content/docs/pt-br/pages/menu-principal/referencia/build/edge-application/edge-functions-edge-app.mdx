...
Ao usar o [Azion Runtime](/pt-br/documentacao/devtools/runtime/visao-geral/) para desenvolver suas edge functions, você tem um conjunto de ferramentas que o ajudam a implementar sua lógica, como:
