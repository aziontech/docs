...
<LinkButton severity="secondary" link="/pt-br/documentacao/produtos/guias/secure/certificado-digital/" label="consulte o guia sobre obter e registrar um digital certificate" severity="secondary" /> 
...
<LinkButton severity="secondary" link="/pt-br/documentacao/produtos/guias/secure/registro-lets-encrypt/" label="consulte o guia sobre criar registro TXT para certificado Let's Encrypt" severity="secondary" /> 
...
<LinkButton severity="secondary" link="https://api.azion.com/#0fad2fc2-c0c0-44e4-bcf6-273bea4684fe" label="criar CRL via API" severity="secondary" />
