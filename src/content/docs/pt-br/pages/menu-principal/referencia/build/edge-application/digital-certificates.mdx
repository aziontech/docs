...
Para adicionar seu certificado próprio, você precisará do par Certificado (X.509) e da respectiva chave privada, ambos no formato [ASCII PEM](https://www.google.com.br/search?q=Como+converter+um+certificado+PFX+para+PEM&cad=h). A chave privada não pode estar protegida por *passphrase*.
