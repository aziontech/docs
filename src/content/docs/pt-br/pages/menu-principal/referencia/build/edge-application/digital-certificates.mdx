...
| Escopo | Recurso |
| --- | --- |
| Sobre workloads | [workloads](/pt-br/documentacao/produtos/build/edge-application/workloads/) |
| Sobre mTLS | [mTLS](/pt-br/documentacao/produtos/build/edge-application/workloads/mtls/) |
...
A CRL funciona quando associada a um [Certificado CA mTLS](/pt-br/documentacao/produtos/build/edge-application/workloads/mtls/). Portanto, você precisa ter mTLS habilitado no domínio ao qual deseja associar a CRL.
