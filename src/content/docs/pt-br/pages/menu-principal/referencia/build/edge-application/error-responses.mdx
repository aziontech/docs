...
title: Custom Pages
description: >-
  custom pages é uma capacidade da Azion Edge Application que permite
...
permalink: /documentacao/produtos/build/edge-application/custom-pages/
---
import LinkButton from 'azion-webkit/linkbutton';

**Custom Pages** é uma capacidade do Azion **Edge Application** que permite personalizar páginas de erro para os usuários com base no código de status recebido da origem.
...
A origem em que o arquivo da URI está localizado. Só pode ser alterada se uma URI for adicionada. Deve ser configurada usando **Edge Connector**.

<LinkButton link="/pt-br/documentacao/produtos/build/edge-application/edge connector/" label="Saiba mais sobre edge connector" />
