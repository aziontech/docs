...
description: >-
  Error Responses é uma capacidade da Azion Edge Application que permite
...
:::caution[importante]
A Funcionalidade Error Responses foi substituída por **Custom Pages**. Para mais informações sobre essa mudança e como configurar respostas de erro personalizadas, acesse a [Referência de Custom Pages](/pt-br/documentacao/produtos/secure/custom-pages/).
:::
