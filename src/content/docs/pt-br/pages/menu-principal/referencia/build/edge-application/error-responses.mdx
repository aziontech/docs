...
description: >-
  Error Responses é uma capacidade da Azion Applications que permite
  personalizar páginas de erro para os usuários com base no código de status
  recebido da origem.
meta_tags: 'erros, application, http, páginas de erro'
namespace: documentation_edge_application_error_responses
permalink: /documentacao/plataforma/custom-pages/error-responses/
---
import DocButton from '~/components/webkit/DocButton.vue';

:::caution[importante]
A Funcionalidade Error Responses foi substituída por **Custom Pages**. Para mais informações sobre o novo produto, acesse a [Referência de Custom Pages](/pt-br/documentacao/plataforma/custom-pages/).
:::

**Error Responses** é uma capacidade do Azion **Applications** que permite personalizar páginas de erro para os usuários com base no código de status recebido da origem.

Quando um usuário solicita conteúdo de uma application, a Azion envia a requisição para os servidores de origem. Como resposta, a origem envia de volta um código de status HTTP, o qual indica se a requisição foi ou não concluída.
...
| Personalizar página de erro | [Como personalizar uma página de resposta de erro](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/personalizar-pagina-resposta-erro/) |
...
<DocButton href="/pt-br/documentacao/plataforma/connectors/origins/" label="Saiba mais sobre Origins" size="medium" />
