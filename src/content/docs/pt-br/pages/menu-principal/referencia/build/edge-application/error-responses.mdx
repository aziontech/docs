...
permalink: /documentacao/produtos/build/applications/error-responses/
---
import LinkButton from 'azion-webkit/linkbutton';

:::caution[importante]
A Funcionalidade Error Responses foi substituída por **Custom Pages**. Para mais informações sobre o novo produto, acesse a [Referência de Custom Pages](/pt-br/documentacao/produtos/secure/custom-pages/).
:::
...
A origem em que o arquivo da URI está localizado. Só pode ser alterada se uma URI for adicionada. Deve ser configurada usando **Connectors**.

<LinkButton link="/pt-br/documentacao/produtos/secure/connectors/" label="Saiba mais sobre Connectors" />
