...
:::note
Esta funcionalidade foi **descontinuada**. Se sua conta já foi migrada, acesse a [Referência do Edge Conector](/pt-br/documentacao/produtos/secure/edge-connector/).
:::
