...
<Button href="/pt-br/documentacao/produtos/store/object-storage/" text="Saiba mais sobre Edge Storage"></Button>

---

## Host Header

O cabeçalho `Host` é usado pela sua origem para identificar o *virtualhost* e localizar seu conteúdo ou aplicativo. Ao configurar uma origem no [Real-Time Manager](https://console.azion.com/), você tem a opção de personalizar o valor enviado pela Azion no cabeçalho `Host`.
