...
O nome do bucket é definido quando você [cria ou modifica um bucket de object storage](/pt-br/documentacao/produtos/guias/como-criar-e-gerenciar-um-bucket/).
...
<Button href="/pt-br/documentacao/produtos/build/edge-application/object-storage/" text="Saiba mais sobre Object Storage"></Button>
