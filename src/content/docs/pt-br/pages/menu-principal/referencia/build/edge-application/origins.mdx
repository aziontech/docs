...
- **Object Storage**: selecione um bucket e caminho do serviço Azion **Object Storage** para entregar a aplicação.
...
O nome do bucket é definido quando você [cria ou modifica um bucket de object storage](/pt-br/documentacao/produtos/guias/como-criar-e-configurar-um-bucket/).
