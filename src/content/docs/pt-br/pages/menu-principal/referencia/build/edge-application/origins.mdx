...
- **Edge Storage**: selecione um bucket e o caminho do serviço Azion **Edge Storage** para entregar a aplicação.
...
<Button href="/pt-br/documentacao/produtos/build/edge-application/load-balancer/" text="Saiba mais sobre Load Balancer"></Button>
...
<Button href="/pt-br/documentacao/produtos/store/edge-storage/" text="Saiba mais sobre Edge Storage"></Button>
