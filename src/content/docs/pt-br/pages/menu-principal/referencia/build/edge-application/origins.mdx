...
- **Object Storage**: selecione um bucket e o caminho do serviço Azion **Object Storage** para entregar a aplicação.
...
O nome do bucket é definido quando você [cria ou modifica um bucket de object storage](/pt-br/documentacao/produtos/guias/criar-e-gerenciar-um-bucket/).
...
<Button href="/pt-br/documentacao/produtos/store/object-storage/" text="Saiba mais sobre Object Storage"></Button>
