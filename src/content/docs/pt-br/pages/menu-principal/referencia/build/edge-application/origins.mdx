...
:::caution[importante]
A funcionalidade Origins foi substituída por **Connectors**. Para mais informações sobre o novo produto, acesse a [referência do Connectors](/pt-br/documentacao/produtos/secure/connectors/).
:::
...
<Button href="/pt-br/documentacao/produtos/store/edge-storage/" label="Saiba mais sobre Object Storage" type="primary" theme="light" />
