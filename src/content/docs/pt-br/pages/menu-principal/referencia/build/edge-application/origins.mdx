...
permalink: /documentacao/plataforma/connectors/origins/
---
...
:::caution[importante]
A funcionalidade Origins foi substituída por **Connectors**. Para mais informações sobre o novo produto, acesse a [referência do Connectors](/pt-br/documentacao/plataforma/connectors/).
:::

**Origins** permite que você personalize a origem do conteúdo do **Applications**, o cabeçalho do `Host` da aplicação, o caminho e as credenciais de autenticação HMAC para serviços protegidos.
...
- **Object Storage**: selecione um bucket e o prefix do serviço **Object Storage** da Azion para entregar a aplicação.
...
Quando **Object Storage** é selecionado como o tipo de origem, você deverá informar o **Bucket Name** e **Prefix**.

O nome do bucket é definido quando você [cria ou modifica um bucket de Object Storage](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/criar-e-modificar-um-bucket/).
...
<DocButton href="/pt-br/documentacao/store/object-storage/" label="Saiba mais sobre Object Storage" size="medium" />
...
Para **Single Origin**, se a origem estiver localizada em um armazenamento de objetos com acesso privado, você deve fornecer credenciais de autenticação HMAC. Ao ativar a autenticação HMAC, seu conteúdo privado começará a ser entregue aos seus usuários por meio do **Applications**.
