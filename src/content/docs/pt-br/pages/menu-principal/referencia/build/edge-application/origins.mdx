...
description: >-
  O Azion edge connector permite que você personalize as origens de seu conteúdo, o
...
permalink: /documentacao/produtos/build/edge-application/edge-connector/
---
import LinkButton from 'azion-webkit/linkbutton';

**Edge Connector** permite que você personalize a origem do conteúdo do **Edge Application**, o cabeçalho do `Host` da aplicação, o caminho e as credenciais de autenticação HMAC para serviços protegidos.
