...
permalink: /documentacao/produtos/build/applications/origins/
---
...
:::caution[importante]
A funcionalidade Origins foi substituída por **Connector**. Para mais informações sobre o novo produto, acesse a [referência do Connector](/pt-br/documentacao/produtos/secure/connector/).
:::
...
<LinkButton link="/pt-br/documentacao/produtos/secure/edge-connector/load-balancer/" label="Saiba mais sobre Load Balancer" />

### Object Storage

Quando **Object Storage** é selecionado como o tipo de origem, você deverá informar o **Bucket Name** e **Prefix**.

O nome do bucket é definido quando você [cria ou modifica um bucket de Object Storage](/pt-br/documentacao/produtos/guias/criar-e-modificar-um-bucket/).
...
<LinkButton link="/pt-br/documentacao/produtos/store/edge-storage/" label="Saiba mais sobre Object Storage" />
