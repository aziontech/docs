...
Na Azion, as edge functions são blocos de código em JavaScript que são executados na rede de edge usando o [Azion Runtime](/pt-br/documentacao/devtools/runtime/visao-geral/).
