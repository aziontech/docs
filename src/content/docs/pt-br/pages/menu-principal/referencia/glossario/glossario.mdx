...
Na Azion, as edge functions são blocos de código em JavaScript que são executados na rede de edge usando o [Azion Runtime](/pt-br/documentacao/runtime/visao-geral/).
...
Um serviço digital, como software ou dados, oferecido aos clientes para uso em diferentes cenários. Por exemplo: [Edge Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/).
...
Direção do fluxo de dados do cliente para o servidor. Representa o caminho percorrido pelos dados à medida que eles viajam do dispositivo do usuário para a Azion Web Platform.
