...
O registro de tipo de *nome comum* de um domínio registrado no DNS. Ao usar o [Edge DNS](/pt-br/documentacao/produtos/edge-dns/), você pode criar e gerenciar registros CNAME sem usar um provedor de DNS.
...
Uma entidade especializada dentro do DNS que é responsável por armazenar e gerenciar registros DNS. Um nameserver geralmente é gerenciado por um provedor de DNS, mas você pode redirecionar a autoridade do nameserver para a Azion usando o [Edge DNS](/pt-br/documentacao/produtos/edge-dns/).
...
Uma entrada criada por uma pessoa ou organização que associa um nome de domínio a um valor específico. Os registros DNS podem ter [vários tipos](/pt-br/documentacao/produtos/edge-dns/#type).
