...
Na Azion, as functions são blocos de código em JavaScript que são executados na rede de edge usando o [Azion Runtime](/pt-br/documentacao/runtime/visao-geral/).
