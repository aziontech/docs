...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/bot-manager/" label="consulte o guia para instalar o Bot Manager" variant="secondary" /> 
...
<LinkButton outlined link="/pt-br/documentacao/produtos/secure/edge-firewall/network-layer-protection/network-lists/" label="saiba mais sobre network lists" variant="secondary" /> 
...
<LinkButton outlined link="/pt-br/documentacao/produtos/observe/data-stream/" label="saiba mais sobre o Data Stream" variant="secondary" /> 
<br />
