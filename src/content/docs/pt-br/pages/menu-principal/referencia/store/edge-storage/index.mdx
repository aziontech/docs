...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/protocolo-s3-para-edge-storage/" label="saiba Como acessar o Edge Storage usando o protocolo S3" variant="secondary"/>
