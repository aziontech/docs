...
:::note
Esse produto está disponível via [Azion API](https://api.azion.com), [Azion Runtime](/pt-br/documentacao/devtools/runtime/visao-geral/) e [Azion CLI](/pt-br/documentacao/produtos/azion-cli/visao-geral/).
:::
...
Objetos, ou arquivos, podem ser enviados, modificados, baixados e removidos dos buckets por meio da [Azion REST API](https://api.azion.com), do [Azion Runtime](/pt-br/documentacao/devtools/runtime/visao-geral/) e do [protocolo S3](#compatiblidade-com-protocolo-s3).
