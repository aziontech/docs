...
A forma recomendada de entregar objetos armazenados no **Object Storage** aos usuários finais é através de [Applications](/pt-br/documentacao/produtos/edge-application/) conectadas aos seus buckets usando [Connectors](/pt-br/documentacao/produtos/secure/connectors/). Esta abordagem:
...
<LinkButton link="/pt-br/documentacao/produtos/guias/protocolo-s3-para-object-storage/" label="saiba Como acessar o Object Storage usando o protocolo S3" severity="secondary"/>
