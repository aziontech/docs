...
| Escopo | Recurso |
|---|---|
| Implemente o Vector Search| Guia explicando os fundamentos da [implementação do Vector Search](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/edge-sql-vector-search/) |
| Conheça o SQL Database da Azion e suas funcionalidades | [Referência do SQL Database](/pt-br/documentacao/store/sql-database/) |
| Integre com AI Inference | Saiba mais sobre as [capacidades do AI Inference](/pt-br/documentacao/build/ai-inference/) |
