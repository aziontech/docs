...
Objetos, ou arquivos, podem ser enviados, modificados, baixados e removidos dos buckets por meio da [Azion API](https://api.azion.com), do [Edge Runtime](/pt-br/documentacao/produtos/edge-application/edge-functions/runtime/visao-geral/) e do [protocolo S3](#compatiblidade-com-protocolo-s3).
