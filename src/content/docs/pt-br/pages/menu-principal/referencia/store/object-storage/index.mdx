...
Objetos, ou arquivos, podem ser enviados, modificados, baixados e removidos dos buckets por meio da [Azion REST API](https://api.azion.com), do [Edge Runtime](/pt-br/documentacao/devtools/runtime/visao-geral/) e da [Azion CLI](/pt-br/documentacao/produtos/azion-cli/visao-geral/).
...
O histórico de operações pode ser acessado por meio da [GraphQL API do Real-Time Events](/pt-br/documentacao/devtools/graphql-api/recursos/campos-gql-real-time-events/#activityhistoryevents-activity-history).
