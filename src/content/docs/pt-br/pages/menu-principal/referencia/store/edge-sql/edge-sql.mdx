...
Existem duas maneiras de construir um banco de dados através do Edge SQL: usando a API REST do Edge SQL ou escrevendo uma edge function. A API REST permite criar, ler, atualizar, excluir e listar bancos de dados. Uma edge function permite escrever em um banco de dados.
