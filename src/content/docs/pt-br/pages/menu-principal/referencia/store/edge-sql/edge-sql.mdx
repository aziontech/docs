...
| Escrever em um banco de dados com uma edge function | [Como interagir com o Azion Edge SQL através do Edge Functions](/pt-br/documentacao/produtos/guias/edge-sql/como-interagir-db-edge-functions/) |
