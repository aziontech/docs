...
permalink: /documentacao/produtos/store/sql-database/
---
...
[Criar um banco de dados](/pt-br/documentacao/produtos/guias/gerenciar-bancos-dados-edge-sql/) é o primeiro passo para usar o SQL Database e adicionar dados:
...
<DocButton href="/pt-br/documentacao/produtos/store/sql/install-edge-sql-shell/" label="Ir para o guia de instalação do SQL Database Shell" kind="secondary" size="medium" /> 
<DocButton href="/pt-br/documentacao/produtos/store/sql/edge-sql-shell-commands/" label="Ir para a referência de comandos do SQL Database Shell" kind="secondary" size="medium" />
