...
<Button href="/pt-br/documentacao/produtos/store/sql/install-edge-sql-shell/" label="Ir para o guia de instalação do SQL Database Shell" type="primary" theme="light" /> 
<Button href="/pt-br/documentacao/produtos/store/sql/edge-sql-shell-commands/" label="Ir para a referência de comandos do SQL Database Shell" type="primary" theme="light" />
