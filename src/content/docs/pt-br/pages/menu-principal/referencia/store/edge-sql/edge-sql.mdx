...
<LinkButton link="guidelink" text="ir para o guia de análise de snapshots" outlined />
...
<LinkButton link="apilink" text="criar um banco de dados com a API da Azion" outlined /> <br></br>

<LinkButton link="guidelink" text="criar um banco de dados com edge functions" outlined />
...
<LinkButton link="apilink" text="criar uma consulta com a API da Azion" outlined /> <br></br>>

<LinkButton link="/pt-br/documentacao/produtos/guias/criar-tabelas-edge-sql/" text="ir para o guia de criar queries" outlined />
