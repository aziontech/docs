...
<LinkButton link="/pt-br/documentacao/produtos/store/sql/install-edge-sql-shell/" label="Ir para o guia de instalação do SQL Database Shell" severity="secondary" /> 
<LinkButton link="/pt-br/documentacao/produtos/store/sql/edge-sql-shell-commands/" label="Ir para a referência de comandos do SQL Database Shell" severity="secondary" />
