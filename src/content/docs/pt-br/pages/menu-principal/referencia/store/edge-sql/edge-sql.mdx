...
Existem duas maneiras de construir um banco de dados através do Edge SQL: usando a API REST do Edge SQL ou escrevendo uma edge function. A API REST permite criar, ler, atualizar, excluir e listar bancos de dados. Uma edge function permite ler dados de um banco de dados.
...
| Ler dados de um banco de dados com uma edge function | [Como interagir com o Azion Edge SQL através do Edge Functions](/pt-br/documentacao/produtos/guias/edge-sql/como-interagir-db-edge-functions/) |
