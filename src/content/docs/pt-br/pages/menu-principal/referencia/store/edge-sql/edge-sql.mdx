---
title: Edge SQL
description: Explore o Edge SQL, uma solução de banco de dados distribuído da Azion. Você pode gerenciar bancos de dados, executar consultas e garantir resiliência de dados.
