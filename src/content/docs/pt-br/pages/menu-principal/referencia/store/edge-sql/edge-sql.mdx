...
<DocCardGroup cols={2}>
  <DocCard title="Primeiros passos" href="/pt-br/documentacao/store/sql-database/primeiros-passos/" label="Crie seu primeiro banco de dados e execute uma query, pelo Azion Console ou pela API." />
