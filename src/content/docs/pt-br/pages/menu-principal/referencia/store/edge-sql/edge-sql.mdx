...
| Ler dados de um banco de dados com uma edge function | [Como interagir com o Azion SQL Database através do Functions](/pt-br/documentacao/produtos/guides/edge-sql/listando-dados-edge-functions-edge-sql/) |
