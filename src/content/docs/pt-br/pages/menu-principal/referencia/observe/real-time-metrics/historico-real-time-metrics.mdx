...
description: >-
  O Real-Time Metrics Histórico é um produto de Observe que fornece acesso a
  métricas em tempo real, através de gráficos, para que você analise os eventos
  de suas aplicações e produtos configurados na Azion.
...
permalink: /documentacao/produtos/observe/real-time-metrics-historico/
---
...
Você já pode e poderá continuar usando o [Novo Real-Time Metrics](/pt-br/documentacao/produtos/observe/real-time-metrics/).
...
Para acessar o Real-Time Metrics Histórico, [contate o time de Suporte](https://tickets.azion.com/en/support/loginpt-BR/support/login) e solicite acesso ao **Real-Time Metrics Histórico**. Você receberá o link de acesso para o data source que deseja consultar.
...
Após selecionar uma das abas para um produto, você verá os gráficos disponíveis para aquele produto específico, de acordo com os dados de sua conta. Se você selecionar Data Stream, por exemplo, você verá gráficos com as métricas relacionadas aos stream configurados em sua conta.
...
[Data Stream](/pt-br/documentacao/produtos/observe/data-stream/), [Edge Functions](/pt-br/documentacao/produtos/build/edge-application/edge-functions/), [Edge DNS](/pt-br/documentacao/produtos/secure/edge-dns/) e [Image Processor](/pt-br/documentacao/produtos/build/edge-application/image-processor/) são produtos pagos. Para visualizar as métricas deles, você deve assinar os produtos e ativá-los em sua conta.
...
![Itens do gráfico do Real-Time Metrics Histórico localizados na tela do Azion Console.](https://www.azion.com/static/images/uploads/doc/graph-historical-real-time-metrics.png)
...
**Data Stream** _-_ **Edge Applications** _-_ **Edge Functions** _-_ **Edge DNS** _-_ **Image Processor**

Você encontra informações detalhadas sobre cada aba e subabas e sobre cada um dos gráficos disponíveis na [documentação do Novo Real-Time Metrics](/pt-br/documentacao/produtos/observe/real-time-metrics/).
