...
permalink: /documentacao/observe/edge-pulse/
---

import DocButton from '~/components/webkit/DocButton.vue';

**Edge Pulse** é um produto de [Observe](/pt-br/documentacao/) baseado na solução de mercado *Real User Monitoring (RUM)*. Com ele, você pode, em tempo real:
...
| Escopo | Recurso |
| ------ | ------ |
| Primeiros passos | [Primeiros passos do Edge Pulse](/pt-br/documentacao/observe/edge-pulse/primeiros-passos/) |
...
<DocButton href="/pt-br/documentacao/observe/real-time-events/" label="explorar via Real-Time Events" size="medium" />
