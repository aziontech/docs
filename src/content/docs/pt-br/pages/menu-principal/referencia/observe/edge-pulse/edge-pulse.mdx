...
title: Edge Pulse
description: >-
  Edge Pulse é um produto de Observe baseado na solução de mercado Real User
  Monitor (RUM).
...
<Button href="/pt-br/documentacao/produtos/observe/real-time-events/" label="explorar via Real-Time Events" type="primary" theme="light" />
