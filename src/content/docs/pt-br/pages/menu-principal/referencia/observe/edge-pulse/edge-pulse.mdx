...
Para monitorar a página, é necessário inserir a **tag JavasScript do Edge Pulse** nela. Ela está disponível na página do Edge Pulse [no RTM](https://console.azion.com/) através do botão **Copy to Clipboard**.
