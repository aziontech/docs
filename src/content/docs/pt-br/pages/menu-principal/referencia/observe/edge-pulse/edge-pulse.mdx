...
permalink: /documentacao/produtos/observe/edge-pulse/
---
...
| Escopo | Recurso |
| ------ | ------ |
| Primeiros passos | [Primeiros passos do Edge Pulse](/pt-br/documentacao/produtos/observe/edge-pulse/primeiros-passos/) |
...
<LinkButton outlined link="/pt-br/documentacao/produtos/observe/real-time-events/" label="explorar via Real-Time Events" />

---

## Edge Pulse JavaScript tag

Para monitorar a página, é necessário inserir a **tag JavasScript do Edge Pulse** nela. Ela está disponível na página do Edge Pulse [no Azion Console](https://console.azion.com/) através do botão **Copy to Clipboard**.
