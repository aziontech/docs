...
| Recurso | Limite |
| ------- | ------ |
| Data Streaming | 60 segundos ou pacotes de 2.000 requisições, o que ocorrer primeiro. Para o endpoint **AWS Kinesis Data Firehose**: 60 segundos ou pacotes de 500 requisições |
