...
Após configurar seu stream, você pode conferir os seus logs de dados sendo enviados com sucesso através do [Real-Time Events](/pt-br/documentacao/produtos/real-time-events/).
