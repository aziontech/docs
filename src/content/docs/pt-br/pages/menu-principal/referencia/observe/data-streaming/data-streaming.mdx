...
| $sent_http_content_type | Cabeçalho “Content-Type” enviado na resposta da origem. Exemplo: label/html; charset=UTF-8. |
...
- **Content Type**: formato em que o objeto será criado no bucket. É possível escolher entre *plain/label* ou *application/gzip*.
