...
| $parent_resource_id | Identificador único do recurso pai, se houver. | "1754317987" |
...
| $user_id | Identificador único do usuário que executou a ação. | "2696" |
| $user_ip | Endereço IP do usuário/origem que gerou a requisição. | "179.191.167.238" |
