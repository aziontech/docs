...
- [Criar um novo data stream](/pt-br/documentacao/produtos/guias/como-usar-data-stream/) clicando no botão **+ Stream**.  
...
- Visualizar informações detalhadas sobre cada stream para garantir que tudo esteja funcionando corretamente.  
- [Excluir ou parar data streams](/pt-br/documentacao/produtos/guias/deletar-data-stream/) que não são mais necessários para otimizar seu sistema.
