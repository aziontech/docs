---
title: Data Stream
description: Data Stream é um produto de Observe que permite que você alimente suas plataformas de stream, SIEM e big data com os logs de eventos de suas aplicações na Azion em tempo real.
...
Ao criar um stream, você consegue:

- Ter um conjunto de logs organizado.
- Conectar o seu stream a endpoints.
...
Após configurar seu stream, você pode conferir os seus logs de dados sendo enviados com sucesso através do [Real-Time Events](/pt-br/documentacao/produtos/observe/real-time-events/).

Veja os [primeiros passos do Data Stream](/pt-br/documentacao/produtos/observe/data-stream/primeiros-passos/).

## Implementação

| Tarefa | Guia |
| ---- | ----- |
| Configurar Data Stream | [Como utilizar o Data Stream](/pt-br/documentacao/produtos/guias/como-usar-data-stream/) |
...
| $upstream_addr | Endereço IP e porta do cliente. Também pode armazenar múltiplos servidores ou grupos de servidores. Exemplo: 192.168.1.1:80. Quando a resposta é `127.0.0.1:1666`, o upstream é o Azion [Cells Runtime](/pt-br/documentacao/devtools/runtime/visao-geral/). |
...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/data-stream-template-personalizado/" label="Como criar um template personalizado" />
...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/data-stream-associar-dominios/" label="Como associar domínios" />
...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/amazon-kinesis-endpoint/" label="Como utilizar o AWS Kinesis Data Firehose para receber dados" />
...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/azure-blob-endpoint/" label="Como utilizar o Azure Blob Storage para receber dados" />
...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/azure-monitor-endpoint/" label="Como utilizar o Azure Monitor para receber dados" />
...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/datadog-endpoint/" label="Como utilizar o Datadog para receber dados" />
...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/elasticsearch-endpoint/" label="Como utilizar o Elasticsearch para receber dados" />
...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/google-bigquery-endpoint/" label="Como utilizar o Google BigQuery para receber dados" />
...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/amazon-s3-endpoint/" label="Como utilizar o Amazon S3 para receber dados" />
...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/splunk-endpoint/" label="Como utilizar o Splunk para receber dados" />
