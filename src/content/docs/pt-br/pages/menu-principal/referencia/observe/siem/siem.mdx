...
permalink: /documentacao/observe/data-stream/siem-azion/
---

O **SIEM Azion** permite que você expanda a visibilidade dos acessos realizados as suas aplicações. Ao correlacionar dados disponíveis no [Real-Time Metrics](/pt-br/documentacao/plataforma/real-time-metrics/) e no [Real-Time Events](/pt-br/documentacao/observe/real-time-events/), você poderá ampliar as visões de segurança, volume de acessos, saúde e degradação.
...
Os alertas podem ser configurados considerando um período de tempo, uma consulta utilizando um ou mais itens disponíveis no [Real-Time Events](/pt-br/documentacao/observe/real-time-events/) e um limite esperado, como o valor mínimo, máximo, a média ou a soma dos valores coletados.
