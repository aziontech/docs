...
Os alertas podem ser configurados considerando um período de tempo, uma consulta utilizando um ou mais itens disponíveis no [Real-Time Events](/pt-br/documentacao/produtos/real-time-events/) e um limite esperado, como o valor mínimo, máximo, a média ou a soma dos valores coletados.
