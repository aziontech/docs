...
Você pode usar os filtros de Métricas para refinar sua análise, focando em critérios específicos, como host, código de status, método de requisição ou localização geográfica. Por exemplo, na seção **Filtro**, você pode usar **Host**, **Equals** e **example.com** para ver o tempo médio de requisição para cada host.
