...
Se você tem [Tiered Cache](/pt-br/documentacao/produtos/edge-application/edge-caching/#tiered-cache) habilitado, seu gráfico de Edge Caching irá exibir:

- **Edge Applications In**: ⁠dados transferidos do usuário final para os edges, e dos edges para a camada Tiered Cache.

![Fluxo de informação do gráfico Edge Caching para Edge Application In, representando os dados sendo transferidos do usuário final para os edges e dos edges para o Tiered Cache.](/assets/docs/images/uploads/l2-enabled-edge-applications-in.png)

- **Edge Applications Out**: dados transferidos da camada Tiered Cache para os edges, e dos edges para o usuário final.

![Fluxo de informação do gráfico Edge Caching com a camada Tiered Cache para Edge Application Out, representando os dados sendo transferidos da camada Tiered Cache cache para os edges e dos edges para o usuário final.](/assets/docs/images/uploads/l2-enabled-edge-applications-out.png)

- **Edge Applications**: todos os dados que foram transferidos no processo; valor de Edge Applications In + Edge Applications Out.

![Fluxo de informação do gráfico Edge Caching com a camada Tiered Cache para Edge Applications, representando todos os dados sendo transferidos tanto de Edge Applications In como de Edge Applications Out.](/assets/docs/images/uploads/l2-enabled-edge-applications.png)
