...
- [Secure](#secure)
    - [WAF](#waf) _-_ [Edge DNS](#edge-dns) _-_ [Bot Manager Advanced](#bot-manager-advanced)
...
A aba Bot Manager Advanced exibe métricas relacionadas à atividade do Bot Manager Advanced.
...
O gráfico Top Bot Action mostra as ações realizadas pelo Azion Bot Manager Advanced para acessos identificados como bots.
