...
O gráfico Impacted URLs mostra o número total de requisições detectadas como bots, calculado com base no número de URLs que experimentaram atividade de bots.
