...
A aba **Edge DNS** mostra as métricas relacionadas às [consultas feitas aos seus DNS](/pt-br/documentacao/produtos/edge-dns/) configurados em sua conta.

Descubra mais sobre o gráfico:

## Total Queries

O gráfico **Total Queries** mostra a quantidade total de consultas recebidas pelo seu DNS configurado no [Edge DNS](/pt-br/documentacao/produtos/edge-dns/).
...
A aba **Data Stream** mostra as métricas relacionadas aos dados e às requisições dos [Data Streams](/pt-br/documentacao/produtos/data-stream/) configurados em sua conta.
...
Descubra mais sobre o [Data Stream](/pt-br/documentacao/produtos/data-stream/).
