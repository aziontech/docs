...
**Real-Time Metrics** permite que você filtre sua análise, recebendo campos e valores específicos. Você pode adicionar um ou múltiplos filtros, dependendo da anaálise que deseja conduir.

<Button href="xxx" text="saiba mais sobre adicionar filtros"></Button>
