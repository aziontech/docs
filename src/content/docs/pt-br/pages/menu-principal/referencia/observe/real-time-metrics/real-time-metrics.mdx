...
Se você tem [L2 Caching](/pt-br/documentacao/produtos/edge-application/edge-caching/#l2-caching) habilitado, seu gráfico de Edge Cache irá exibir:

- **Edge Applications In**: ⁠dados transferidos do usuário final para os edges, e dos edges para o L2 cache.

![Fluxo de informação do gráfico Edge Cache para Edge Application In, representando os dados sendo transferidos do usuário final para os edges e dos edges para o L2 cache.](/assets/docs/images/uploads/l2-enabled-edge-applications-in.png)

- **Edge Applications Out**: dados transferidos do L2 cache para os edges, e dos edges para o usuário final.

![Fluxo de informação do gráfico Edge Cache com L2 para Edge Application Out, representando os dados sendo transferidos do L2 cache para os edges e dos edges para o usuário final.](/assets/docs/images/uploads/l2-enabled-edge-applications-out.png)

- **Edge Applications**: todos os dados que foram transferidos no processo; valor de Edge Applications In + Edge Applications Out.

![Fluxo de informação do gráfico Edge Cache com L2 para Edge Applications, representando todos os dados sendo transferidos tanto de Edge Applications In como de Edge Applications Out.](/assets/docs/images/uploads/l2-enabled-edge-applications.png)
