...
<LinkButton link="/pt-br/documentacao/produtos/observe/real-time-metrics-historico/" label="Use o Real-Time Metrics Histórico" />
...
<LinkButton link="/pt-br/documentacao/produtos/guias/usar-real-time-metrics/" label="Como utilizar o Real-Time Metrics" />
...
<LinkButton link="/pt-br/documentacao/produtos/guias/observe/adicionar-filtros-metrics/" label="saiba mais sobre adicionar filtros" />
...
Você deve ativar o Edge Cache em sua conta para usá-lo e para analisar os dados dele. Veja a [documentação de Edge Cache](/pt-br/documentacao/produtos/build/edge-application/edge-cache/) para mais informações.
...
- **Legitimate**: a requisição não foi identificada como um ataque e há dados suficientes para garantir que não seja um ataque, sendo considerada tráfego legítimo e humano.
