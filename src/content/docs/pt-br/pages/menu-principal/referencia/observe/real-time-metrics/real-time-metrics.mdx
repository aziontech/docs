...
- [Build](#build)
    - [Applicationss](#edge-applications) _-_ [Tiered Cache](#tiered-cache) _-_ [Functions](#edge-functions) _-_ [Image Processor](#image-processor)
...
![Fluxo de informação do gráfico Cache para Applicationss, representando os dados sendo transferidos tanto de Data Transferred In como de Data Transferred Out.](/assets/docs/images/uploads/edge-applications.png)
...
> - Applicationss: todos os tipos de requisições; valor de http + https.
...
A aba **Functions** mostra as métricas relacionadas às invocações de suas [edge functions](/pt-br/documentacao/produtos/build/edge-application/edge-functions/) configuradas em sua conta.
...
> - **Applications**: quantidade total de edge functions executadas associadas a uma aplicação.
