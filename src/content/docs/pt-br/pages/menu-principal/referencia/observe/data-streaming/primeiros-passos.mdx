...
Antes de começar a usar o **Data Streaming**, confira que você tem uma conta no [Azion Console](https://console.azion.com/). Você encontra mais informações na [página de documentação](/pt-br/documentacao/produtos/gestao-de-contas/criar-conta/).
