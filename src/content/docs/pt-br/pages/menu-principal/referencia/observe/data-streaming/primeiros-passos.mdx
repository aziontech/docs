---
title: Primeiros passos do Data Streaming
...
permalink: /documentacao/produtos/observe/data-streaming/primeiros-passos/
---

Antes de começar a usar o **Data Streaming**, confira que você tem uma conta no [Real-Time Manager (RTM)](https://console.azion.com/). Você encontra mais informações na [página de documentação](/pt-br/documentacao/produtos/gestao-de-contas/criar-conta/).
...
1. [No RTM](https://console.azion.com/), no canto superior esquerdo, selecione **Products menu**.
