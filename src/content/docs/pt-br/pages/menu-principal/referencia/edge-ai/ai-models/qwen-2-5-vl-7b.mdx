...
| `choices[].logprobs`                  | `string`   | Detalhes de probabilidade logarítmica.                |
...
| `choices[].logprobs`                                 | `string`   | Dados de probabilidade log.                                          |
...
| `prompt_logprobs`                                     | `number`   | Probabilidades log para tokens do prompt.                        |
