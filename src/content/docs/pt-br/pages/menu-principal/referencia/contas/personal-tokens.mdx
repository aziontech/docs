...
**Personal Tokens** são uma string de caracteres usados para autenticar seu usuário e acesso em certas interfaces e ferramentas. Você pode criar um personal token de autenticação de longa duração no [Real-Time Manager (RTM)](https://console.azion.com/) para chamar as [APIs da Azion](https://api.azion.com/) ou para executar comandos na [Command-line Interface (CLI)](/pt-br/documentacao/produtos/cli).
