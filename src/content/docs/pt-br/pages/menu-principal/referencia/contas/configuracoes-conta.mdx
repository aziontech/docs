...
description: Você pode editar as informações gerais de sua conta na área de Account Settings, localizada no menu superior direito do Azion Console.
...
Você pode editar as informações gerais de sua conta na área de **Account Settings**, localizada no menu superior direito do **Azion Console**.

A página de **Account Settings** permite que você gerencie e personalize as informações de sua conta e os recursos de segurança no Azion Console. Ao acessar essa área, você pode fazer ajustes em **Account Profile**, **Address Information** e **Authentication Settings**, assim como iniciar o processo de excluir sua conta, caso necessário.
...
Esta seção permite que você faça mudanças relacionadas à conta principal do Azion Console. Veja abaixo mais informações sobre cada campo:
...
Se você é o dono da conta (*Account Owner*), você pode ativar e desativar a funcionalidade de **Social Login** utilizando o switch. Quando ativado, os usuários conectados à conta podem se autenticar no [Azion Console](https://console.azion.com/) usando as redes sociais disponíveis. Do contrário, eles terão que fazer login utilizando email e senha. Veja mais sobre o assunto na página de [Social Login](/pt-br/documentacao/produtos/gestao-de-contas/social-login/)
...
O [Azion Console](https://console.azion.com/) permite que você exclua sua conta. Apenas o dono da conta (*Account Owner*) pode excluí-la. Se tiver privilégios de Account Owner, você verá o botão **Delete account** no fim da página.
...
**Nota:** você pode [criar uma nova conta](/pt-br/documentacao/produtos/contas/criar-uma-conta/) a qualquer momento para continuar sua experiência com a Azion.
