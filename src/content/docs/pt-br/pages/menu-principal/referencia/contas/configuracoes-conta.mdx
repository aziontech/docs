...
O [Real-Time Manager (RTM)](https://console.azion.com/) permite que você exclua sua conta. Apenas o dono da conta (*Account Owner*) pode excluí-la. Se tiver privilégios de Account Owner, você verá o botão **Delete account** no fim da página.
