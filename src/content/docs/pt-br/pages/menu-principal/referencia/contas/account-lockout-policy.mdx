...
<LinkButton link="/pt-br/documentacao/produtos/guias/configurar-account-lockout-policy/" label="Consulte o guia para configurar a Account Lockout Policy" severity="secondary" target="_blank" />
...
<LinkButton link="/pt-br/documentacao/produtos/guias/account-lockout-policy-logs/" label="Consulte o guia para verificar os logs" severity="secondary" target="_blank" />
...
<LinkButton link="/pt-br/documentacao/produtos/guias/desbloquear-account-lockout-policy/" label="Consulte o guia para desbloquear usuários" severity="secondary" target="_blank" />
