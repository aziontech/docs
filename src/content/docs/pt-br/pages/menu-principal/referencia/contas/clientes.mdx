...
O [Real-Time Manager (RTM)](https://console.azion.com/) permite que você crie contas distintas, chamadas de **Clients**, para cada uma das afiliadas na conta tipo **Groups** de sua empresa. Você precisa ser **Account owner** ou ter as permissões **View client list** e **Change clients** para acrescentar clientes a sua conta.
