...
title: Social Login
description: >-
  O Social Login é uma forma de login único que usa informações existentes de
  uma rede social para entrar em sites de terceiros sem que haja a necessidade
  de criar uma nova conta de login.
meta_tags: 'social login, contas, autenticação de usuários'
namespace: documentation_accounts_social_login
permalink: /documentacao/fundamentos/social-login/
---
...
Para mais informações sobre cadastro na Azion com **Social Login**, visite a página de [criar uma conta](/pt-br/documentacao/fundamentos/criar-uma-conta/).
