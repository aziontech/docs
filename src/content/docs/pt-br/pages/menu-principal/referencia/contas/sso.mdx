...
| Configurar SAML Okta | [Como utilizar Okta SAML como IdP para a Azion](/pt-br/documentacao/produtos/guias/sso-okta-saml/) |
...
Para configurar um certificado X.509 na Azion, consulte [Como configurar um certificado X.509](/pt-br/documentacao/produtos/build/applications/certificate-manager/#como-configurar-um-certificado-x509) na documentação do Certificate Manager.
