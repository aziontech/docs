...
Para configurar um certificado X.509 na Azion, consulte [Como configurar um certificado X.509](/pt-br/documentacao/produtos/secure/firewall/certificate-manager/#como-configurar-um-certificado-x509) na documentação do Certificate Manager.
