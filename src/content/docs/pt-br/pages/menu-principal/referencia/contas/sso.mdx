...
description: Azion permite que os proprietários de contas configurem logins de usuários com o SSO da Azion ou com um Identity Provider externo de sua escolha.
...
| Tarefa | Guia |
| ---- | ----- |
| Configurar SAML Azure | [Como utilizar Azure AD SAML como um IdP para a Azion](/pt-br/documentacao/produtos/guias/sso-azure-saml/) |
