...
<LinkButton link="/pt-br/documentacao/produtos/guias/configurar-user-session-timeout/" label="Consulte o guia para configurar o User Session Timeout" severity="secondary" target="_blank" />
