...
permalink: /documentacao/fundamentos/user-session-timeout/
---
...
Este recurso está disponível para clientes de todos os [Serviços de Suporte da Azion](https://www.azion.com/pt-br/servicos-profissionais/).
:::
...
| Escopo | Recurso |
| ----------- | ----------- |
| Configurar o User Session Timeout | [Como configurar o User Session Timeout](/pt-br/documentacao/guias/seguranca-de-aplicacoes/acesso-e-compliance/configurar-user-session-timeout/) |
...
<DocButton href="/pt-br/documentacao/guias/seguranca-de-aplicacoes/acesso-e-compliance/configurar-user-session-timeout/" label="Consulte o guia para configurar o User Session Timeout" kind="secondary" target="_blank" size="medium" />
