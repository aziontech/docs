...
<DocButton href="/pt-br/documentacao/produtos/guias/configurar-user-session-timeout/" label="Consulte o guia para configurar o User Session Timeout" kind="secondary" target="_blank" size="medium" />
