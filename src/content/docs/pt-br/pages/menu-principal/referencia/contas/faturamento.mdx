...
<LinkButton link="/pt-br/documentacao/produtos/guias/billing-and-subscriptions/" label="Consulte o guia para acessar a página de faturamento" severity="secondary" target="_blank" />