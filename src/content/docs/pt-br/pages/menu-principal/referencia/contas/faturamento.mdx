...
<Button href="/pt-br/documentacao/produtos/guias/billing-and-subscriptions/" label="Consulte o guia para acessar a página de faturamento" type="primary" theme="light" target="_blank" />