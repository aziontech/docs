...
Na página **Your Settings**, você pode editar e gerenciar suas informações pessoais, preferências e configurações de segurança no [Real-Time Manager (RTM)](https://console.azion.com/).
