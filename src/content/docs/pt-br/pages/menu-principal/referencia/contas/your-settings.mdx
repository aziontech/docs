...
title: Your Settings
description: Na página Your Settings do Azion Console você pode editar suas informações pessoais. 
...
Na página **Your Settings**, você pode editar e gerenciar suas informações pessoais, preferências e configurações de segurança no [Azion Console](https://console.azion.com/).
...
- **Timezone** (obrigatório): o fuso horário que você quer usar nos dados do Azion Console. Você pode editar de acordo com as suas preferências. O fuso horário será modificado no Azion Console em páginas como a de **Activity History**.

> **Language**: o Azion Console está disponível apenas em inglês. Não é possível editar este campo.

---

## Contact Information 

- **Email** (obrigatório): email utilizado para logar em sua conta no Azion Console. 
...
- **Password**: a senha utilizada para logar no Azion Console. Você pode redefini-la a qualquer momento. 
