...
Esse paradigma permite a construção e o gerenciamento de [aplicações modernas](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/criar-uma-aplicacao/), capazes de atender à crescente demanda por processamento em tempo real, latência reduzida, melhor privacidade de dados e a capacidade de lidar com a enorme quantidade de dados gerados hoje em dia.
...
- [Build](/pt-br/documentacao/guias/)
- [Store](/pt-br/documentacao/)
- [Secure](/pt-br/documentacao/plataforma/firewall/)
- [Deploy](/pt-br/documentacao/build/orchestrator/)
- [Observe](/pt-br/documentacao/plataforma/real-time-metrics/)

Isto inclui poder completar tarefas como:

- Criação e implantação de [aplicações](/pt-br/documentacao/plataforma/applications/) que são executadas diretamente na rede global.
- Uso de [templates e integrações](/pt-br/documentacao/marketplace/visao-geral-templates-e-integracoes/) para acelerar seu desenvolvimento e testar soluções pré-construídas.
- Criação de [arquiteturas zero trust](/pt-br/documentacao/guias/) para proteger seu conteúdo e aplicações.
- Melhora da entrega de conteúdo confiando em uma [rede altamente distribuída](https://www.azion.com/pt-br/produtos/nossa-rede/).
- Definição de [regras de cache](/pt-br/documentacao/build/cache/), otimizações personalizadas e configurações avançadas.
- Monitoramento de applications com [dados em tempo real](/pt-br/documentacao/plataforma/real-time-metrics/).
- Melhora no [desempenho](/pt-br/documentacao/guias/performance-e-confiabilidade/otimizacao-de-entrega/content-delivery/), com menor latência e uso de largura de banda, ao mesmo tempo em que reduz os custos operacionais.
- Desenvolvimento com diferentes [frameworks e linguagens suportadas](/pt-br/documentacao/guias/).
- [Migração de sua arquitetura e conteúdo](/pt-br/documentacao/fundamentos/migrar-para-a-azion/) para a plataforma da Azion.
...
- [Azion Console](/pt-br/documentacao/guias/plataforma/conta-e-billing/como-acessar-o-azion-console/): é a interface de configuração. Com o Azion Console, você tem acesso a todos os produtos e serviços fornecidos pela Azion, podendo criá-los e gerenciá-los. O Azion Console também permite o provisionamento de recursos, bem como o gerenciamento da sua conta, faturamento e permissões de usuário.
- [Azion CLI](/pt-br/documentacao/devtools/cli/): é uma ferramenta de código aberto que permite o gerenciamento de serviços usando um terminal. A Azion CLI é construída em Go.
...
- [Azion Terraform Provider](/pt-br/documentacao/devtools/terraform/): o Terraform se comunica com as APIs da Azion, para que você possa gerenciar sua infraestrutura hospedada na plataforma da Azion, localmente, como código.
