...
<LinkButton link="/pt-br/documentacao/produtos/guias/bot-manager-and-tor-block-starter-kit/" label="consulte o guia do Bot Manager and TOR Block Starter Kit" severity="secondary" />
...
O template **Bot Manager Integration Kit** fornece uma maneira fácil de integrar a função do Bot Manager em um edge firewall existente na Azion.

<LinkButton link="/pt-br/documentacao/produtos/guias/bot-manager-integration-kit/" label="consulte o guia do Bot Manager Integration Kit" severity="secondary" />
...
<LinkButton link="/pt-br/documentacao/produtos/guias/bot-manager-starter-kit/" label="consulte o guia do Bot Manager Starter Kit" severity="secondary" />
