...
O **Svelte Boilerplate** simplifica a implantação de uma aplicação estática baseada no framework Svelte, diretamente no edge da rede, acelerando e automatizando todo o processo.

<Button href="/pt-br/documentacao/produtos/guias/svelte-boilerplate/" text="consulte o guia do Svelte Boilerplate" variant="secondary" />
