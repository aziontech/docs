...
<LinkButton link="/pt-br/documentacao/produtos/guias/static-cache-videoteca-player/" label="consulte o guia do template Static Cache + Videoteca Player" severity="secondary" /> 

<LinkButton
    label="Deploy"
    link="https://console.azion.com/create/azion/static-cache-videoteca-player"
    icon="ai ai-azion"
    icon-pos="left"
  />
