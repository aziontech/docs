...
permalink: /documentacao/marketplace/instalar-uma-integracao/
---
...
:::tip
Para criar uma nova application, acesse a jornada de [Build](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/criar-uma-aplicacao/) para obter mais detalhes sobre este tópico.
:::
...
:::tip
Vá para a [página de guias da Azion](/pt-br/documentacao/guias/#marketplace) para ler as especificações de cada integração.
:::
...
<DocButton href="/pt-br/documentacao/marketplace/atualizar-uma-integracao/" label="consulte o guia Como atualizar uma integração" kind="secondary" size="medium" />
