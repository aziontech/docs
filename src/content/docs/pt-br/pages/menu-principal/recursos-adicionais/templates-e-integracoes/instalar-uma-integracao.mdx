...
<DocButton href="/pt-br/documentacao/produtos/marketplace/atualizar-uma-integracao/" label="consulte o guia Como atualizar uma integração" kind="secondary" size="medium" />
