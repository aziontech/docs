...
description: >-
  Esta documentação lhe guiará para instalar uma integração em uma edge
...
:::tip
Para criar uma nova edge application, acesse a jornada de [Build](/pt-br/documentacao/produtos/guias/build/criar-uma-aplicacao/) para obter mais detalhes sobre este tópico.
:::
...
Acesse o [Azion Console](https://console.azion.com) e entre no **Marketplace** para selecionar a integração que deseja instalar.
...
<LinkButton link="/pt-br/documentacao/produtos/marketplace/atualizar-uma-integracao/" label="consulte o guia Como atualizar uma integração" severity="secondary" />
