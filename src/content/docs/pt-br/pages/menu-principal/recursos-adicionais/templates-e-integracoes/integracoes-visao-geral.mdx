...
| [Upstash Rate Limiting with Penalty](/pt-br/documentacao/produtos/guias/upstash-rate-limiting-integration/) | Controle o tráfego de entrada diretamente no edge da rede e proteja suas aplicações. |
