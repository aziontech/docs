...
| [Add Request ID](/pt-br/documentacao/produtos/guias/add-request-id-header/) | Adicione um cabeçalho adicional no objeto da requisição recebida, atribuindo um identificador único a cada requisição HTTP atendida pela Plataforma de Edge da Azion. |
