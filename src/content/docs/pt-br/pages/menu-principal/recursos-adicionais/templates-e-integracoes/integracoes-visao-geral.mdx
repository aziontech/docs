...
| [Hello World](/pt-br/documentacao/produtos/guias/hello-world/) | Teste como edge computing funciona, exibindo uma mensagem, `Hello World`, no seu navegador usando uma edge application. |
