...
| Integração | Descrição |
|---|---|
| [Azion Bot Manager](/pt-br/documentacao/produtos/guias/bot-manager/) | Use essa integração para analisar as solicitações recebidas e atribuir uma pontuação com base em regras e comportamentos. |
