...
Você pode instalar e instanciar a integração em poucos passos através do [Real-Time Manager (RTM)](https://console.azion.com/) e melhorar rapidamente suas aplicações.
