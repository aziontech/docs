...
| [Upstash Rate Limiting with Penalty](/pt-br/documentacao/produtos/guias/rate-limiting-with-penalty/) | Controle o tráfego de entrada diretamente no edge da rede e proteja suas aplicações. |
