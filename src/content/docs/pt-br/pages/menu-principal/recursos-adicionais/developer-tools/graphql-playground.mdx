...
<Button href="/pt-br/documentacao/devtools/graphql-api/primeiros-passos/#acessar-o-playground-graphql" label="Como acessar o playground" type="primary" theme="light" />
