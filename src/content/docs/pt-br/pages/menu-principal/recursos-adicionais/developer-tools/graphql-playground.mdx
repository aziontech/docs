...
<DocButton href="/pt-br/documentacao/devtools/graphql-api/primeiros-passos/#acessar-o-playground-graphql" label="Como acessar o playground" kind="secondary" size="medium" />
