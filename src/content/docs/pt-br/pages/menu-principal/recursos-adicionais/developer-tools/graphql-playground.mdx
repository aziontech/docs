...
<Button href="/pt-br/documentacao/devtools/graphql-api/primeiros-passos/#acessar-o-playground-graphql" text="como acessar o playground" variant="secondary"></Button>
