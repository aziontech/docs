...
permalink: /documentacao/devtools/graphql/playground-graphql/
---
...
<DocButton href="/pt-br/documentacao/devtools/graphql/primeiros-passos/#acessar-o-playground-graphql" label="Como acessar o playground" kind="secondary" size="medium" />
...
:::tip
Para mais detalhes, consulte o guia [Como identificar os principais IPs gerando tráfego de ataque com a API GraphQL](/pt-br/documentacao/guias/plataforma/observabilidade/consultar-top-ips-gerando-trafego-de-ataque-com-graphql/).
:::
...
:::tip
Visite a [página de Guias](/pt-br/documentacao/guias/#graphql-api) e a [documentação da GraphQL API](/pt-br/documentacao/devtools/graphql/) para explorar mais opções de consulta de dados.
:::
