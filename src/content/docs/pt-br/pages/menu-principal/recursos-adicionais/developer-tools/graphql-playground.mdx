...
<LinkButton outlined link="/pt-br/documentacao/devtools/graphql-api/primeiros-passos/#acessar-o-playground-graphql" label="como acessar o playground" variant="secondary" />
