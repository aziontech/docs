...
| [Como instalar uma integração](/pt-br/documentacao/produtos/marketplace/instalar-uma-integracao/) | Passo a passo de como usar e instalar as integrações oferecidas pela Azion. |
...
1. **Instalação da integração**: obtenha e instale a integração através do Marketplace da Azion.
2. **Configuração de regra no Edge Firewall**: para adicionar um rule set e ativar Edge Functions.
3. **Configuração da função no Edge Firewall**: para adicionar uma função e definir os Args.
4. **Configuração do Rules Engine**: para criar uma nova regra, com os critérios e o comportamento a serem aplicados à sua função.
...
| Integração | Descrição |
|---|---|
| [Send Event to Endpoint](/pt-br/documentacao/produtos/guias/send-event/) | Essa solução permite transmitir dados de uma solicitação para um endpoint HTTP, recolhendo os dados de requisição e os transmitindo para um endpoint definido pelo usuário por meio de uma API Javascript. |
...
| Integração | Descrição |
|---|---|
| [Limit Payload Size](/pt-br/documentacao/produtos/guias/limitpayload/) | Por meio dessa integração, avalie os dados da requisição e negue payloads que excedam um limite predefinido. |
