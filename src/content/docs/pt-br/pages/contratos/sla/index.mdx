...
A Disponibilidade dos Serviços Edge Application, Load Balancer, Image Processor, Application Accelarator, Edge Functions, Edge Firewall, Network Layer Protection e Web Application Firewall (WAF) deverá ser calculada seguindo as mesmas regras, com a respectiva funcionalidade corretamente configurada no Azion Console para o Objeto de Teste.
