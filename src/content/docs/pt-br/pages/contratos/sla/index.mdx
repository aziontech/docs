...
A Disponibilidade dos Serviços Edge Application, Load Balancer, Image Processor, Application Acceleration, Adaptive Delivery, Edge Functions, Edge Firewall e Web Application Firewall (WAF) deverá ser calculada seguindo as mesmas regras, com a respectiva funcionalidade corretamente configurada no Azion Real-Time Manager para o Objeto de Teste.
