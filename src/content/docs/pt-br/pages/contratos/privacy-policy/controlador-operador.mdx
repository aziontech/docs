...
namespace: documentation_agreements_privacy_policy_controller_operator
permalink: /documentacao/contratos/politica-de-privacidade/controlador-operador/
---
...
- **OPÇÃO B.** (OBS: a "Opção B" é exclusiva para as transferências internacionais de dados realizadas entre operadores) \- não aplicável.
