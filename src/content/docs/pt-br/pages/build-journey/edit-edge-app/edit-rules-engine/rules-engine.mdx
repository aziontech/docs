...
permalink: /documentacao/produtos/guias/build/trabalhe-com-rules-engine/
...
1. Execute a seguinte solicitação `PATCH` em seu terminal, substituindo `[TOKEN VALUE]` por seu [personal token](/pt-br/documentacao/produtos/gestao-de-contas/personal-tokens/) e a variável `<edge_application_id>` por [seu ID de edge application(/en/documentation/products/guides/build/configure-main-settings/) para ativar o módulo [Application Acceleration](/pt-br/documentacao/produtos/edge-application/application-acceleration/):
