---
title: Como construir com Hexo
description: Inicialize uma aplicação Hexo e faça o deploy na edge.
meta_tags: astro, js, jamstack
namespace: docs_framework_astro
permalink: /documentacao/produtos/build/desenvolvimento-azion/frameworks/hexo/
...
- [Se você optou por executar um servidor de desenvolvimento local](/pt-br/documentacao/produtos/build/desenvolvimento-azion/frameworks/hexo/#resposta-sim-para-desenvolvimento-local).
- [Se você optou por não executar um servidor de desenvolvimento local](/pt-br/documentacao/produtos/build/desenvolvimento-azion/frameworks/hexo/#resposta-nao-para-desenvolvimento-local).
