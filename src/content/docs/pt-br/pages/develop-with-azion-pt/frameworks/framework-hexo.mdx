...
description: Faça o deploy de uma aplicação Jamstack com Hexo.
...
- [Se você optou por executar um servidor de desenvolvimento local](/pt-br/documentacao/produtos/cli/frameworks/hexo/#resposta-sim-para-desenvolvimento-local).
