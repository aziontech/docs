---
title: Como construir com Angular
description: Build with Angular.
meta_tags: angular, js, jamstack
namespace: docs_framework_angular
permalink: /documentacao/produtos/build/desenvolvimento-azion/frameworks/angular/
...
## Inicializando um projeto Angular
...
- [Se você optou por executar um servidor de desenvolvimento local](/pt-br/documentacao/produtos/build/desenvolvimento-azion/frameworks/angular/#resposta-sim-para-desenvolvimento-local).
- [Se você optou por não executar um servidor de desenvolvimento local](/pt-br/documentacao/produtos/build/desenvolvimento-azion/frameworks/angular/#resposta-não-para-desenvolvimento-local).
