...
description: Faça o deploy de uma aplicação Jamstack com React.
...
- [Se você optou por executar um servidor de desenvolvimento local](/pt-br/documentacao/produtos/cli/frameworks/react/#resposta-sim-para-desenvolvimento-local).
- [Se você optou por não executar um servidor de desenvolvimento local](/pt-br/documentacao/produtos/cli/frameworks/react/#resposta-nao-para-desenvolvimento-local).
