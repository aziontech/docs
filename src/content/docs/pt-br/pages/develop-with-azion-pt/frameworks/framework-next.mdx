...
- [Se você optou por executar um servidor de desenvolvimento local](/pt-br/documentacao/produtos/cli/frameworks/next/#resposta-sim-para-desenvolvimento-local).
- [Se você optou por não executar um servidor de desenvolvimento local](/pt-br/documentacao/produtos/cli/frameworks/hexo/#resposta-nao-para-desenvolvimento-local).
