...
- [Se você optou por não executar um servidor de desenvolvimento local](/pt-br/documentacao/produtos/cli/frameworks/next/#resposta-nao-para-desenvolvimento-local).
