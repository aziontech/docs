---
title: Como construir com Astro
description: Inicialize uma aplicação Astro e faça o deploy na edge.
meta_tags: astro, js, jamstack
namespace: docs_framework_astro
permalink: /documentacao/produtos/build/desenvolvimento-azion/frameworks/astro/
...
- [Se você optou por executar um servidor de desenvolvimento local](/pt-br/documentacao/produtos/build/desenvolvimento-azion/frameworks/astro/#resposta-sim-para-desenvolvimento-local).
- [Se você optou por não executar um servidor de desenvolvimento local](/pt-br/documentacao/produtos/build/desenvolvimento-azion/frameworks/astro/#resposta-nao-para-desenvolvimento-local).
