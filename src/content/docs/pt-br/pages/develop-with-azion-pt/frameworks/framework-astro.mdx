...
description: Faça o deploy de uma aplicação Jamstack com Astro.
...
- [Se você optou por executar um servidor de desenvolvimento local](/pt-br/documentacao/produtos/cli/frameworks/astro/#resposta-sim-para-desenvolvimento-local).
- [Se você optou por não executar um servidor de desenvolvimento local](/pt-br/documentacao/produtos/cli/frameworks/astro/#resposta-nao-para-desenvolvimento-local).
