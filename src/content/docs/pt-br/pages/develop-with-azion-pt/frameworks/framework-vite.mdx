...
- Uma conta na [plataforma Azion](/pt-br/documentacao/produtos/gestao-de-contas/criar-conta/) com [Edge Functions](/pt-br/documentacao/produtos/edge-application/edge-functions/) habilitadas.
...
- [Se você optou por executar um servidor de desenvolvimento local](/pt-br/documentacao/produtos/cli/frameworks/vite/#resposta-sim-para-desenvolvimento-local).
- [Se você optou por não executar um servidor de desenvolvimento local](/pt-br/documentacao/produtos/cli/frameworks/vite/#resposta-nao-para-desenvolvimento-local).
