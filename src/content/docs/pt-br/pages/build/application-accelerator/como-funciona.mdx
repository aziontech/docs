...
- Variação de cache além da URL, por query string, por cookie e por device group. A funcionalidade é [Advanced Cache Key](/pt-br/documentacao/build/cache/cache-settings/#advanced-cache-key).
