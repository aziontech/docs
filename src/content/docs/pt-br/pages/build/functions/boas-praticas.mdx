...
<ItemList>
  ...
  <DocItem title="Migrando padrões de handler em Functions" href="/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/functions-e-runtime/migrar-padroes-de-handler/">O antes e o depois de cada handler ao sair do Service Worker.</DocItem>
