...
Para direcionar seu tráfego para a Azion, você deve associar as entradas CNAME do seu domínio personalizado ao endereço do seu domínio Azion através de [Domains](/pt-br/documentacao/produtos/edge-application/domains/).

:::note
Este processo exigirá que você associe um registro CNAME ao seu domínio. Veja [Migrar seu DNS para a Azion](/pt-br/documentacao/produtos/guias/migrar-ns-para-a-azion/) para mais informações sobre como associar um registro ANAME.
:::
...
:::note
Alguns serviços não permitem que você altere sua resolução ANAME diretamente, o que significa que você não pode apontar diretamente `seudominio.org` para a Azion desta maneira. Veja como [migrar seu NS para a Azion](/pt-br/documentacao/produtos/guias/migrar-ns-para-a-azion/).
:::
