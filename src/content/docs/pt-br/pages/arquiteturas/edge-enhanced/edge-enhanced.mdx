...
2. A regra da edge application, que foi configurada para ativar uma function, é acionada. Esta function, desenvolvida em JavaScript e implantada na Azion, executa a lógica do carrinho de compras.
