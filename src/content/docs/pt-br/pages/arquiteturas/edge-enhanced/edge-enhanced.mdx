...
2. [Crie uma function](/pt-br/documentacao/build/functions/#implementation) e [instancie](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/instanciar-functions/) na aplicação recém-criada.
