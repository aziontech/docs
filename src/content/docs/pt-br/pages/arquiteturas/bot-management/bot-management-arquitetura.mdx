...
- [Bot Manager](/pt-br/documentacao/produtos/marketplace/bot-manager/) é um add-on do Edge Firewall para o gerenciamento de bots.
...
- Do zero: crie um stack de edge inteiro do zero, incluindo o Bot Manager. Para fazer isso:
    ...
    3. [Habilite o Bot Manager](/pt-br/documentacao/produtos/marketplace/bot-manager/).
