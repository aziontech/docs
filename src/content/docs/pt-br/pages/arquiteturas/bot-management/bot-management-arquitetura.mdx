...
description: >-
  ...
  ataques.
permalink: >-
  /documentacao/arquitetura/gerenciamento-de-bots/proteja-edge-applications-com-bot-management/
meta_tags: >-
...
![Diagrama de arquitetura](/assets/docs/images/uploads/application-and-network-security/light_BotManagement.png)
...
- Usando [Azion Templates](/pt-br/documentacao/produtos/marketplace/templates/): projetos pré-construídos e pré-configurados projetados para acelerar a implementação do gerenciamento de bots, baseados no Bot Manager Lite:
    - [Bot Manager Lite Starter Kit](/pt-br/documentacao/produtos/guias/bot-manager-lite-starter-kit/): com este template, você pode implantar um novo stack de edge e ver o Bot Manager Lite em ação.
    - [Bot Manager Lite Integration Kit](/pt-br/documentacao/produtos/guias/bot-manager-lite-integration-kit/): uma maneira fácil de integrar a função do Bot Manager Lite em um edge firewall existente na Azion.
    - [Bot Manager Lite and TOR Block Starter Kit](/pt-br/documentacao/produtos/guias/bot-manager-lite-and-tor-block-starter-kit/): implante um stack básico de segurança para proteger seus domínios de bots maliciosos e requisições de TOR Exit Nodes.
