...
- [Firewall](/pt-br/documentacao/produtos/secure/firewall/) executa o add-on Bot Manager e outras regras de segurança.
- [Bot Manager](/pt-br/documentacao/produtos/secure/firewall/bot-manager/) é um add-on do Firewall para o gerenciamento de bots.
...
- [Application](/pt-br/documentacao/produtos/build/applications/) é sua aplicação em execução na Azion Web Platform.
...
- Usando [Azion Templates](/pt-br/documentacao/produtos/marketplace/templates/): projetos pré-construídos e pré-configurados projetados para acelerar a implementação do gerenciamento de bots, baseados no Bot Manager Lite:
    ...
    - [Bot Manager Lite Integration Kit](/pt-br/documentacao/produtos/guias/bot-manager-lite-integration-kit/): uma maneira fácil de integrar a função do Bot Manager Lite em um firewall existente na Azion. Para implantar facilmente esse template na edge, clique no botão abaixo:
...
- Do zero: crie um stack de edge inteiro do zero, incluindo o Bot Manager. Para fazer isso:
    ...
    3. [Habilite o Bot Manager](/pt-br/documentacao/produtos/secure/firewall/bot-manager/).
