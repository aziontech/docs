...
- [Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/) executa o add-on Bot Manager e outras regras de segurança.
- [Bot Manager](/pt-br/documentacao/produtos/secure/edge-firewall/bot-manager/) é um add-on do Firewall para o gerenciamento de bots.
