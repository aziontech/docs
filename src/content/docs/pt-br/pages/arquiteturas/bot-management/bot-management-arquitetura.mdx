...
meta_tags: >-
  ...
  arquitetura de segurança, Edge Firewall, Edge Application, análise
...
- [Edge Application](/pt-br/documentacao/produtos/build/edge-application/) é sua aplicação em execução na Azion Web Platform.
