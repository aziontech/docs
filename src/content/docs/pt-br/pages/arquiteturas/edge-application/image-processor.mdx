...
1. Crie uma edge application: primeiro, você deve criar a camada de entrega de conteúdo no edge. Você pode fazer isso usando [Azion Console](https://console.azion.com), [Azion API](https://api.azion.com/#9c61e0fd-e7aa-4a5f-b29e-7f9d71b98d5f) ou [Azion CLI](/pt-br/documentacao/produtos/azion-cli/visao-geral/).
...
2. Crie um domínio e o associe à edge application: 
    ...
    - Utilize a [Azion API](https://api.azion.com/#9c61e0fd-e7aa-4a5f-b29e-7f9d71b98d5f) para criar um domínio.
