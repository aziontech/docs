...
1. Crie uma aplicação: primeiro, você deve criar a camada de entrega de conteúdo no edge. Você pode fazer isso usando [Azion Console](https://console.azion.com), [Azion API](https://api.azion.com/#9c1cc0df-16a2-488e-8cfe-3f1238f47aeb) ou [Azion CLI](/pt-br/documentacao/devtools/cli/).
...
2. Crie um domínio e o associe à aplicação: 
    - No [Console](https://console.azion.com), [crie um domínio](/pt-br/documentacao/guias/plataforma/migracao/configurar-dominio/) usando o botão **+ Create** na barra de navegação superior.
...
3. Configure políticas de cache: [configure uma política de cache](/pt-br/documentacao/guias/performance-e-confiabilidade/cache-e-purge/cache-settings/) para imagens. A configuração recomendada é:
...
4. Aplique políticas de cache em cenários específicos: use Rules Engine para [aplicar políticas específicas com base em várias condições](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/rules-engine/). Crie e modifique as regras:
...
6. Aponte o domínio para Azion: [atualize suas configurações de DNS](/pt-br/documentacao/guias/plataforma/migracao/migrar-ns-para-a-azion/) para apontar o registro CNAME do seu domínio para o endpoint Azion fornecido para o seu domínio.
7. Teste e monitore: depois de configurar sua entrega de conteúdo, teste a entrega de conteúdo para garantir que está funcionando conforme esperado e [monitore o acesso de entrada](/pt-br/documentacao/plataforma/real-time-metrics/).
...
- [Primeiros passos com Image Processor](/pt-br/documentacao/guias/performance-e-confiabilidade/otimizacao-de-entrega/image-processor/).
