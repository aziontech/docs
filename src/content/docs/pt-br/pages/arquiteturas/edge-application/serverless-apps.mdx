...
meta_tags: >-
  Azion, Edge Computing, Applications, serverless, Functions, Edge
...
2. A requisição passa pelo **Edge Firewall** e é analisada. Se não for uma requisição maliciosa, segue em frente e alcança a **Application**.
