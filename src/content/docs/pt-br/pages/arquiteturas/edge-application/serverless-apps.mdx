...
description: >-
  Descubra como utilizar o Applications da Azion para implementações
  serverless. Aproveite Functions, Cache e SQL Database para otimizar
  entrega e performance.
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/functions-e-runtime/serverless-applications/
meta_tags: >-
  Azion, Edge Computing, Applications, serverless, Functions, Cache,
  Application Acceleration, SQL Database, configurar domínio, arquitetura
  serverless
...
![Visão geral de uma requisição/resposta através da aplicação](/assets/docs/images/uploads/serverless-apps.png?v=2)
...
4. O conteúdo, se estático, será armazenado no **Object Storage**. Assim, o conteúdo será requisitado e retornado como resposta.

5. Operações que requerem transações de banco de dados podem ser realizadas com **SQL Database**.
...
- **Workloads**: registre um domínio personalizado com a Azion para entregar sua aplicação.
...
2. Crie um domínio e associe-o à aplicação: 
    - No Console, [crie um domínio](/pt-br/documentacao/guias/plataforma/migracao/configurar-dominio/) usando o botão **+ Create** na homepage.
