...
description: Descubra como utilizar o Edge Application da Azion para implementações
  serverless. Aproveite Edge Functions, Edge Cache e Edge SQL para otimizar entrega
  e performance.
permalink: /documentacao/arquiteturas/edge-application/serverless-applications/
meta_tags: Azion, Edge Computing, Edge Application, serverless, Edge Functions, Edge
  Cache, Application Acceleration, Edge SQL, configurar domínio, arquitetura serverless
