...
description: Descubra como a Azion potencializa a entrega de conteúdo via Edge Computing
  com Edge Application e Edge Cache, melhorando performance e reduzindo custos.
permalink: /documentacao/arquitetura/edge-application/content-delivery/
meta_tags: Edge Computing, Edge Application, Edge Cache, entrega de conteúdo, otimização
  de cache, Application Accelerator, Rules Engine, Image Processor, desempenho de
