...
3. Crie um domínio e associe-o à aplicação:
    - No Console, [crie um domínio](/en/documentation/guides/platform/migration/configure-a-domain/) usando o botão **+ Create** na página inicial.
...
- [Compatibilidade com APIs Web no Azion Runtime](/en/documentation/devtools/runtime/frameworks/frameworks-compatibility/)
- [Compatibilidade com Node.js no Azion Runtime](/en/documentation/devtools/runtime/node/)
