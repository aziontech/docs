...
description: Explora a implementação e benefícios de microsserviços serverless com
  Azion Edge Functions para escalabilidade e economia em arquitetura de microsserviços.
permalink: /documentacao/arquiteturas/edge-application/microservices/
meta_tags: Azion, microsserviços, Edge Functions, escalabilidade, serverless, arquitetura
  de microsserviços, Edge Application, Edge SQL, Edge Storage, implementação edge
