...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/functions-e-runtime/modernizacao-de-aplicacoes/
meta_tags: >-
  Azion, Applications, modernização de aplicações, arquitetura de
...
![Visão geral de uma requisição/resposta via Applications](/assets/docs/images/uploads/app-modernization.png?v=2)
...
5. Operações que exigem transações no banco de dados podem ser realizadas com o SQL Database.
...
1. Crie um aplicação:
    ...
    - Use [Azion CLI](/pt-br/documentacao/devtools/cli/create/#applications) para criar e implantar uma aplicação.
