...
- **Applications**: permite que você configure uma edge application para definir políticas de entrega e cache, criar regras para automatizar a atribuição de políticas de cache com base no tipo de conteúdo e determinar como o conteúdo é armazenado em cache.
