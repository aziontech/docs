...
3. A requisição chega à edge application e, com base em sua configuração do Rules Engine, acessa o conteúdo solicitado. Se configurados, os módulos de Image Processor, Edge Cache, Application Accelerator e Functions serão executados.
