...
description: Descubra como a Azion possibilita a modernização de aplicações por meio de uma abordagem serverless e arquitetura de microsserviços.
...
1. Crie um edge application:
    ...
    - Use a [Azion API](https://api.azion.com/#9c61e0fd-e7aa-4a5f-b29e-7f9d71b98d5f) para criar uma edge application.
...
2. Crie um domínio e associe-o à edge application: 
    ...
    - Use a [API Azion](https://api.azion.com/#9c61e0fd-e7aa-4a5f-b29e-7f9d71b98d5f) para criar um domínio.
