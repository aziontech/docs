...
permalink: /documentacao/guias/performance-e-confiabilidade/otimizacao-de-entrega/live-streaming-delivery-com-hls/
meta_tags: >-
  ...
  fidelity, Global Infrastructure
...
Esta solução é ideal para provedores de conteúdo que necessitam de alta fidelidade e baixa latência para eventos ao vivo, e-sports e conteúdo educacional. Utilizando uma rede de data centers, a plataforma garante entrega eficiente e escalabilidade, ao mesmo tempo que fornece recursos de segurança aprimorados para proteção da transmissão.
...
2. A requisição chega ao edge node mais saudável, que faz parte da Global Infrastructure distribuída globalmente da Azion.
...
- [Applications](/pt-br/documentacao/plataforma/applications/) permite que você construa aplicações na Azion Web Platform e entregue seu conteúdo.
  - [Cache](/pt-br/documentacao/build/cache/) permite que você configure como sua aplicação armazena em cache o conteúdo para reduzir a latência e aumentar as taxas de transferência.
...
2. [Crie um domínio](/pt-br/documentacao/guias/plataforma/migracao/configurar-dominio/#criar-um-dominio-com-a-azion) e [associe-o à aplicação](/pt-br/documentacao/guias/plataforma/migracao/configurar-dominio/#vincular-um-dominio-personalizado-a-sua-application).
3. Configure [políticas de cache para HLS](/pt-br/documentacao/guias/performance-e-confiabilidade/cache-e-purge/implementar-cache-hls/) na aplicação.
...
- [Azion Global Infrastructure](https://www.azion.com/pt-br/produtos/nossa-rede/)
- [Cache Settings](/pt-br/documentacao/build/cache/cache-settings/)
- [Arquitetura de content delivery](/pt-br/documentacao/guias/performance-e-confiabilidade/otimizacao-de-entrega/content-delivery/)
