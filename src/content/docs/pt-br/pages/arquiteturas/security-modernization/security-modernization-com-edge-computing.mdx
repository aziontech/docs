...
2. [Crie um firewall](/pt-br/documentacao/produtos/guias/secure/edge-firewall-definir-main-settings/) e associe-o ao domínio configurado, para que todas as regras de segurança se apliquem a esse domínio específico.
