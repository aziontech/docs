...
meta_tags: >-
  Edge Computing, Edge Firewall, DDoS Protection, Network Layer Protection,
...
- Habilite os módulos Web Application Firewall, Network Layer Protection e Functions.
...
6. [Crie regras no Rules Engine](/pt-br/documentacao/produtos/guias/secure/trabalhar-com-rules-engine/) do Edge Firewall para definir o comportamento a ser executado quando o Edge Firewall detectar uma requisição que corresponda aos critérios definidos pelos rule sets, network lists e functions.
