...
4. Se a requisição não corresponder a uma regra e não for bloqueada, o conteúdo continua o fluxo de requisição para Edge Application.
- Edge Application usa o Rules Engine para identificar se há regras relacionadas ao armazenamento em cache, otimização de imagem, cookies e redirecionamentos, entre outros.
