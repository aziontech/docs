...
1. Todas as configurações e automações são definidas através das interfaces da Azion: Console, API ou CLI. 
2. Um pedido chega à Plataforma de Edge da Azion e é redirecionado para o egde node mais saudável.
3. No edge node, o Edge Firewall processa o pedido e executa as configurações de segurança:
  - A DDoS Protection verifica possíveis ataques DDoS ou DoS, bloqueando ou permitindo o pedido conforme necessário. Está automaticamente habilitado em todas as contas.
  ...
  - Qualquer edge functionß configurada e instanciada é executada. Leia mais sobre como [automatizar a segurança com Edge Functions da Azion](/pt-br/documentacao/produtos/secure/automarizar/functions/).
...
4. Se o pedido não corresponder a uma regra do Edge Firewall e não for bloqueado, o pedido continua o fluxo para o Edge Application.
  - Edge Application Rules Engine identifica se há regras relacionadas a cache, otimização de imagens, cookies e redirecionamentos, entre outros.
5. O sistema responde à requisição conforme necessário.
...
- [Edge Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/) fornece as principais configurações para configurar sua instância, permitindo que você a associe a domínios e ative módulos para proteger usuários, aplicações e redes.
  - [DDoS Protection](/pt-br/documentacao/produtos/secure/edge-firewall/ddos-protection/) detecta e mitiga ataques DDoS e DoS.
  - [Rules Engine para Edge Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/rules-engine/) permite que você defina as condições (Critéria) e omportamentos (behaviors) para suas regras. Se os critérios forem atendidos, os comportamentos serão executados.
  - [Edge Functions no Edge Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/edge-functions/) são funções JavaScript que são executadas na borda da rede, próximas aos usuários, e ajudam a proteger suas aplicações aplicando a lógica que seu negócio requer.
...
2. Configure um [edge firewall](/pt-br/documentacao/produtos/guias/secure/edge-firewall-definir-main-settings/).
3. Defina todas as suas regras e configurações:
  ...
  - [Edge Functions](/pt-br/documentacao/produtos/secure/edge-firewall/edge-functions/), criando seu próprio código ou usando [integrações de Edge Firewall do Marketplace](/pt-br/documentacao/produtos/marketplace/integracoes/#edge-firewall-functions).
