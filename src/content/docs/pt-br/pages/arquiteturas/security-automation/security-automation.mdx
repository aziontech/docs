...
2. No edge node, o Edge Firewall processa o pedido e executa as configurações de segurança:
  ...
  - Qualquer edge function configurada e instanciada é executada. Leia mais sobre como [automatizar a segurança com Functions da Azion](/pt-br/documentacao/produtos/secure/automarizar/functions/).
...
- [Edge Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/) fornece as principais configurações para configurar sua instância, permitindo que você a associe a domínios e ative módulos para proteger usuários, aplicações e redes.
  ...
  - [Functions no Edge Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/edge-functions/) são funções JavaScript que são executadas na borda da rede, próximas aos usuários, e ajudam a proteger suas aplicações aplicando a lógica que seu negócio requer.
...
3. Defina todas as suas regras e configurações:
  ...
  - [Functions](/pt-br/documentacao/produtos/secure/edge-firewall/edge-functions/), criando seu próprio código ou usando [integrações de Edge Firewall do Marketplace](/pt-br/documentacao/produtos/marketplace/integracoes/#edge-firewall-functions).
