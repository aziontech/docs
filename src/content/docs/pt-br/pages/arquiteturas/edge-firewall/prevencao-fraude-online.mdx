...
5. **Edge Application** executa todas as configurações, de acordo com a requisição:
...
- [Configure um domínio personalizado](/pt-br/documentacao/produtos/build/edge-application/workloads/) para sua aplicação.
