...
description: >-
  ...
  cibernéticos.
permalink: /documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/web-application-and-api-protection-waap/
meta_tags: >-
...
- [Firewall](/pt-br/documentacao/plataforma/firewall/): fornece as configurações principais para configurar sua instância e associá-la a domínios e ativar módulos.
    - [DDoS Protection](/pt-br/documentacao/plataforma/ddos-protection/): detecta e mitiga ataques DDoS e DoS quando ativado.
    - [Web Application Firewall](/pt-br/documentacao/secure/waf/): permite configurar proteção contra ataques e vulnerabilidades encontradas no OWASP Top 10 e bloquear requisições.
    ...
    - [Bot Manager](/pt-br/documentacao/secure/bot-manager/): identifica e classifica a requisição de acordo com a análise comportamental baseada em intenção.
...
- [Crie um firewall](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/firewall-definir-main-settings/) e associe-o ao domínio configurado, para que todas as regras de segurança se apliquem a esse domínio específico.
    - Ative o módulo de DDoS Protection.
    - Ative o módulo de Web Application Firewall.
    - Ative o módulo de Network Shield.
- [Crie um conjunto de regras WAF](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/criar-waf-rule-set/).
...
- [Configure o Bot Manager](/pt-br/documentacao/secure/bot-manager/).
...
- [Crie regras no Rules Engine do Firewall](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/trabalhar-com-rules-engine/).
    ...
    - Configure os critérios de [Request URI](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/integracoes/bot-manager-lite/#configure-o-rules-engine).
