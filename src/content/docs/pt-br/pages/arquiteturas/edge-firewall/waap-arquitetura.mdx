...
description: Descubra como a WAAP da Azion protege aplicações e APIs com Web Application
  Firewall, DDoS Protection e Network Layer Protection contra ataques cibernéticos.
permalink: /documentacao/arquitetura/edge-firewall/web-application-and-api-protection-waap/
meta_tags: WAAP, proteção de aplicações, Web Application Firewall, segurança de APIs,
  Edge Firewall, OWASP Top 10, ataques de dia zero, Network Layer Protection, DDoS
