...
- [Edge Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/): fornece as configurações principais para configurar sua instância e associá-la a domínios e ativar módulos.
    ...
    - [Bot Manager](/pt-br/documentacao/produtos/marketplace/bot-manager/): identifica e classifica a requisição de acordo com a análise comportamental baseada em intenção.
...
- [Configure o Bot Manager](/pt-br/documentacao/produtos/marketplace/bot-manager/).
