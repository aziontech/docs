...
1. Uma requisição chega à Azion Web Platform e é redirecionada ao Edge Firewall.
...
- [Edge Application](/pt-br/documentacao/produtos/build/edge-application/): executa sua aplicação na Azion Web Platform.
