...
description: Explore como Azion e Jamstack otimizam arquiteturas de sites com Edge
  Computing, garantindo desempenho, segurança e escalabilidade.
permalink: /documentacao/arquitetura/jamstack/implantacao-aplicacoes-jamstack/
meta_tags: Jamstack, Azion, Edge Computing, Edge Application, arquitetura de sites,
  desempenho de sites, escalabilidade, segurança da aplicação, Edge Storage, Edge
  Functions
