...
- Do zero: crie um stack de edge inteiro do zero, incluindo a integração do Bot Manager. Para fazer isso:
    ...
    2. [Adicione um domínio personalizado a ela](/pt-br/documentacao/produtos/guias/configurar-dominio/).
