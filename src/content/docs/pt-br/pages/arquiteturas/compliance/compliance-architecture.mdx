...
permalink: /documentacao/guias/seguranca-de-aplicacoes/acesso-e-compliance/governanca-risco-conformidade/
meta_tags: >-
...
:::tip
Leia mais sobre o [Modelo de Responsabilidade Compartilhada](/pt-br/documentacao/fundamentos/responsabilidade-compartilhada/) da Azion.
:::
...
- [Azion CLI](/pt-br/documentacao/devtools/cli/): uma interface de linha de comando (CLI) de código aberto que permite interagir com a Azion Web Platform usando um terminal.
- [Azion Console](/pt-br/documentacao/guias/plataforma/conta-e-billing/conhecendo-o-azion-console/): a interface da Azion onde você pode acessar todos os produtos disponíveis e suas configurações.
- [Firewall](/pt-br/documentacao/plataforma/firewall/): fornece as principais configurações para configurar sua instância, permitindo associá-la a domínios e ativar módulos para proteger usuários, aplicações e redes.
  - [Web Application Firewall](/pt-br/documentacao/secure/waf/): permite configurar proteção contra ataques e vulnerabilidades.
  - [DDoS Protection](/pt-br/documentacao/plataforma/ddos-protection/): detecta e mitiga ataques DDoS e DoS.
  - [Network Shield](/pt-br/documentacao/secure/network-shield/): permite criar listas com endereços IP ou países com comportamento suspeito e restringir seu acesso.
  - [Functions for Firewall](/pt-br/documentacao/plataforma/firewall/functions/): construa aplicações serverless e orientadas a eventos, incluindo funções com seu próprio código-fonte de segurança.
- [Applications](/pt-br/documentacao/plataforma/applications/): permite configurar uma aplicação para definir políticas de entrega e cache.
- [Real-Time Events](/pt-br/documentacao/observe/real-time-events/) permite monitorar toda a atividade de suas aplicações e, utilizando conectores [Data Stream](/pt-br/documentacao/observe/data-stream/), você pode alimentar logs de eventos em seu processamento de stream, SIEM e plataformas de big data.

---

## Implementação

1. [Adicione usuários](/pt-br/documentacao/guias/plataforma/conta-e-billing/users-management/), [defina permissões de equipe](/pt-br/documentacao/guias/plataforma/conta-e-billing/teams-permissions/), e configure políticas de conta, como [Single Sign-On (SSO)](/pt-br/documentacao/fundamentos/single-sign-on/), [Autenticação Multifator (MFA)](/pt-br/documentacao/fundamentos/multi-factor-authentication/), ou [User Session timeout](/pt-br/documentacao/fundamentos/user-session-timeout/).
2. [Crie uma aplicação](/pt-br/documentacao/guias/).
  ...
  - [Defina as principais configurações da aplicação](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/definir-configuracoes-principais/).
3. [Crie um domínio](/pt-br/documentacao/guias/plataforma/migracao/configurar-dominio/) e vincule à aplicação, e [aponte seu tráfego para a Azion](/pt-br/documentacao/guias/plataforma/migracao/apontar-dominio-para-a-azion/).
...
5. [Crie um firewall](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/firewall-definir-main-settings/) e selecione os domínios que você deseja proteger.
  - Defina quaisquer [Crie e aplique um WAF rule set](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/criar-waf-rule-set/), [regras do Rules Engine](/pt-br/documentacao/plataforma/firewall/rules-engine/), ou [functions](/pt-br/documentacao/plataforma/firewall/functions/) que você deseja implementar e instanciar no firewall.
6. Monitore suas aplicações através dos [produtos Observe](/pt-br/documentacao/plataforma/real-time-metrics/) e da página [Activity History](/pt-br/documentacao/fundamentos/activity-history/).
...
- [SOC Compliance](/pt-br/documentacao/fundamentos/soc/)
- [PCI Compliance](/pt-br/documentacao/fundamentos/pci-dss-certification/)
