...
Use o template [AI Inference Starter Kit](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/ai-inference-starter-kit/) para acelerar sua jornada e ter uma aplicação pronta com APIs compatíveis com OpenAI, rodando no edge.
...
Observações:
- Acesse a página dos [Modelos do AI Inference da Azion](/pt-br/documentacao/build/ai-inference/modelos/) para ver mais modelos disponíveis.
...
- **[Real-Time Metrics](https://www.azion.com/pt-br/documentacao/plataforma/real-time-metrics/)**: analise os eventos e obtenha insights sobre o desempenho de suas aplicações.
- **[Real-Time Events](https://www.azion.com/pt-br/documentacao/observe/real-time-events/)**: rastreie requisições, dados brutos, logs e pesquisas complexas.
...
- [Guia do AI Inference Starter Kit](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/ai-inference-starter-kit/)
- [Modelos disponíveis](/pt-br/documentacao/build/ai-inference/modelos/)
