...
- **[Firewall](/pt-br/documentacao/plataforma/firewall/)**  
...
- **[Functions](/pt-br/documentacao/plataforma/firewall/functions/)**  
...
- **[AI Inference](/pt-br/documentacao/build/ai-inference/)**  
...
- **[Applications](/pt-br/documentacao/plataforma/applications/)**  (Opcional)
  Hospeda a aplicação web que consome uploads de arquivos e expõe endpoints HTTP(S) para usuários finais.

- **[Object Storage](/pt-br/documentacao/store/object-storage/)** (opcional)  
  Utilizado para:
...
```
**Observação:** Certifique-se de que o modelo selecionado esteja disponível e configurado corretamente no ambiente Azion. Consulte os [modelos disponíveis](/pt-br/documentacao/build/ai-inference/modelos/).
...
- Ajuste:
   ...
   - Regras do **WAF** e **Network Shield** com base nos insights coletados.  
...
- [Implemente um assistente Copilot baseado em um agente de IA ReAct](/pt-br/documentacao/guias/ai/agentes-e-rag/agente-ai-assistente-copilot/)  
- [Automação da segurança com Edge Computing](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/automacao-da-seguranca-com-edge-computing/)  
...
- [Proteja aplicações web e APIs com WAAP](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/web-application-and-api-protection-waap/)  
- [Produtos Observe da Azion](/pt-br/documentacao/plataforma/real-time-metrics/)