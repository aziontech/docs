...
- **[Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/)**: uma aplicação na Azion que hospeda o agente de IA.
- **[Functions](https://www.azion.com/pt-br/documentacao/build/functions/)**: uma função serverless que contém a lógica do agente de IA.
- **[Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/)**: serviço de armazenamento de objetos da Azion para armazenar os dados que o agente usa para responder às perguntas.
- **[SQL Database](https://www.azion.com/pt-br/documentacao/store/sql-database/)**: banco de dados da Azion para armazenar o estado do chat e documentos.
...
Utilize o [LangGraph AI Agent Boilerplate](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/langgraph-ai-agent-boilerplate/) para montar rapidamente um backend em LangGraph e uma base SQL que garante persistência confiável de estado e documentos.
...
:::note
Este template usa [Application Accelerator](/pt-br/documentacao/build/application-accelerator/), [Functions](/pt-br/documentacao/build/functions/) e [SQL Database](/pt-br/documentacao/store/sql-database/), e pode gerar custos relacionados ao uso. Verifique a [página de preços](https://www.azion.com/pt-br/precos/) para obter mais informações.
:::
---

## Guia de Referência

- [Guia de Referência - Como integrar um agente de IA a Third Party LLM](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/langgraph-ai-agent-boilerplate/)

## Documentação Relacionada

- [Object Storage](/pt-br/documentacao/store/object-storage/)
- [SQL Database](/pt-br/documentacao/store/sql-database/)
- [Como configurar um domínio personalizado](/pt-br/documentacao/guias/plataforma/migracao/configurar-dominio/)
- [Azion GitHub App](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/automacao/azion-github-app/)
- [Vector Search com SQL Database](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/edge-sql-vector-search/)