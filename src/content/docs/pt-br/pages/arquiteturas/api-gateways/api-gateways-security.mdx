...
permalink: >-
  /documentacao/arquitetura/api-gateways/implementar-segurança-api-gateways/
meta_tags: >-
  Segurança do API Gateway, perímetro de segurança, API Gateways, Edge Firewall, DDoS Protection, regras WAF, políticas de segurança, Plataforma de Edge da Azion, criptografia de tráfego, atividade maliciosa
...
4. Integrações do Marketplace para segurança, como Bot Manager ou Rate Limit, são executadas para completar a análise e verificação.
...
- [Reforce a segurança cibernética com a solução avançada de WAAP da Azion](/pt-br/documentacao/arquitetura/edge-firewall/web-application-and-api-protection-waap/)
- [Proteja suas edge applications com uma solução de gerenciamento de bots](/pt-br/documentacao/arquitetura/gerenciamento-de-bots/proteja-edge-applications-com-bot-management/)
- [Acelere a modernização da segurança com edge computing](/pt-br/documentacao/arquitetura/modernizacao-da-seguranca/modernizacao-da-seguranca-com-edge-computing/)
- [Fortaleça a Governança, o Risco e a Conformidade em sua organização](/pt-br/documentacao/arquitetura/compliance/governanca-risco-conformidade/)
