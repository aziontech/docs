...
Substitua [TOKEN VALUE] pelo seu [personal token](/pt-br/documentacao/produtos/guias/personal-tokens/), `<serviceId>` pelo ID do edge service e informe os seguintes parâmetros no corpo da requisição:
...
Substitua [TOKEN VALUE] pelo seu [personal token](/pt-br/documentacao/produtos/guias/personal-tokens/), `<nodeId>` pelo ID do edge node e informe os seguintes parâmetros no corpo da requisição:
