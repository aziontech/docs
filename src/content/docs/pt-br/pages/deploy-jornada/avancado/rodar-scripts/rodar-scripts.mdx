...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/deploy/instalar-orchestrator-agent/" label="ir para como instalar o agente de orquestração de borda" variant="secondary" target="_blank" />
<br />
...
1. Acesse [Azion Console](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/) > **Edge Libraries** > **Edge Services**.
...
1. Acesse [Azion Console](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/) > **Edge Nodes**.
...
:::note
Você pode encontrar os links para download das respectivas arquiteturas na [página de lançamentos da Azion CLI](https://github.com/aziontech/azion/releases). Você deve escolher o link de download correto com base na arquitetura do seu edge node e substituir a variável `BINARY_URL` no script pela URL correta.
:::
