...
<LinkButton link="/pt-br/documentacao/produtos/guias/deploy/instalar-orchestrator-agent/" label="ir para como instalar o agente de orquestração de borda" outlined target="_blank" />
