...
2. Crie uma variável relacionada ao serviço. Execute a seguinte requisição `PATCH` no seu terminal, substituindo [TOKEN VALUE] por seu [token pessoal]() e `:id` pelo ID do service e informe o nome e o valor da variável:
