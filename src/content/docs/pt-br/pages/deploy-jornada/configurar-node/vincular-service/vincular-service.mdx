...
<DocButton href="/pt-br/documentacao/produtos/guias/deploy/criar-edge-service/" label="ir para o guia de como criar um edge service" kind="secondary" target="_blank" size="medium" />
