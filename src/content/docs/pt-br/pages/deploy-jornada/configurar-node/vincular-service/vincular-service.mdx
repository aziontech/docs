...
description: Descubra como gerenciar seus serviços no Edge com o Azion Console ou
  RTM e a integração via Azion API para orquestração eficiente.
permalink: /documentacao/produtos/guias/deploy/vincular-servico/
meta_tags: Azion, Edge Services, Edge Nodes, Azion Console, Real-Time Manager, Azion
  API, orchestration, service deployment, API integration, Edge Orchestrator
