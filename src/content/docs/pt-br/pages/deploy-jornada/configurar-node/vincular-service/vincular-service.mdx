...
4. Vá para a aba **Services** e clique no botão **+ Service**.
5. Escolha o serviço que deseja vincular e adicione as variáveis se necessário.
...
2. No canto superior esquerdo da página, abra o **Products menu**, representado por três linhas horizontais, e em seguida selecione **Edge Nodes**.
3. Selecione o edge node que você deseja vincular a um serviço.
4. Na aba **Main Settings**, certifique-se de que a opção **Add-On Services** na seção **Orchestration Modules** esteja ativa.
