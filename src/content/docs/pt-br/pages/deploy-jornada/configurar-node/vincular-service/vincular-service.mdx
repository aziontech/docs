...
<Button href="/pt-br/documentacao/produtos/guias/deploy/criar-edge-service/" text="ir para o guia de como criar um edge service" variant="secondary" target="_blank"></Button>
