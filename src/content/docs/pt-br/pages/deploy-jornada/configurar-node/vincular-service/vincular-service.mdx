...
Substitua `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/produtos/guias/personal-tokens/), `<nodeId>` pelo ID do edge node e informe as seguintes propriedades no corpo da requisição:
