...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/deploy/trabalhar-com-variaveis/" label="ir para o guia de trabalho com variáveis" variant="secondary" target="_blank" />
