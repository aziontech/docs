...
description: Aprenda como configurar e gerenciar resources no Azion Console e Real-Time
  Manager para otimizar seus Edge Services e impulsionar a eficiência do Edge Computing.
permalink: /documentacao/produtos/guias/deploy/provisionar-arquivos/
meta_tags: Azion, Edge Services, Configurar Edge Resources, Azion Console, Real-Time
