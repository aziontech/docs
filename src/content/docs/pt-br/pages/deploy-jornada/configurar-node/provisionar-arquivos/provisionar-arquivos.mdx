...
<Button href="/pt-br/documentacao/produtos/guias/deploy/trabalhar-com-variaveis/" label="ir para o guia de trabalho com variáveis" type="primary" theme="light" target="_blank" />
