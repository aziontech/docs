...
description: >-
  ...
  Computing.
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/automacao/provisionar-arquivos/
meta_tags: >-
...
1. Execute a seguinte requisição `GET` no seu terminal, substituindo [TOKEN VALUE] pelo seu [personal token](/pt-br/documentacao/guias/plataforma/conta-e-billing/personal-tokens/) e recupere o ID do edge service:
...
<DocButton href="/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/automacao/trabalhar-com-variaveis/" label="ir para o guia de trabalho com variáveis" kind="secondary" target="_blank" size="medium" />
