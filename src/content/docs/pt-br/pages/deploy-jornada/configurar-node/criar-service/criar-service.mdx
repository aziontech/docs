...
description: Descubra como criar e gerenciar Edge Services na Azion usando o Console,
...
meta_tags: Azion, Edge Service, Azion Console, Real-Time Manager, Edge Nodes, Gerenciamento
  de serviços, API Azion, Deployment Edge, Configuração Edge, Edge Computing
