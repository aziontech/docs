...
Durante o processo de implantação no [Orchestrator](/pt-br/documentacao/produtos/deploy/edge-orchestrator/), você pode trabalhar com variáveis. Uma variável pode ser definida em [edge services](#variaveis-em-edge-services) e [edge nodes](#variaveis-em-edge-nodes).
