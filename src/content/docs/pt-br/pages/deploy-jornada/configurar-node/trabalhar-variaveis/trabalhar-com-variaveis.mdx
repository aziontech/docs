...
description: Descubra como utilizar variáveis em Edge Services e Edge Nodes com Azion
  Console, Real-Time Manager e API Azion, otimizando o deployment no Edge Orchestrator.
permalink: /documentacao/produtos/guias/deploy/trabalhar-com-variaveis/
meta_tags: Azion, Edge Nodes, Edge Services, Edge Orchestrator, variáveis, Real-Time
...
1. Navegue até a aba **Resources** .
2. Clique em **Add Resource** ou selecione o recurso no qual você deseja usar a variável.
3. Insira o **Path** do arquivo do recurso.
4. Escolha o tipo **Text**.
5. Adicione o seguinte conteúdo ao bloco **Content**:
