...
Durante o processo de implantação no [Edge Orchestrator](/pt-br/documentacao/produtos/edge-orchestrator/), você pode trabalhar com variáveis. Uma variável pode ser definida em [edge services](#variaveis-em-edge-services) e [edge nodes](#variaveis-em-edge-nodes).
...
1. Acesse o [Real-Time Manager (RTM)](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/) > **Edge Libraries** > **Edge Services**.
