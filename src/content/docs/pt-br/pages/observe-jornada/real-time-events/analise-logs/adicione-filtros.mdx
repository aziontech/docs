...
Depois de [entender os logs do Real-Time Events](xxx) e decidir as variáveis que deseja consultar, você pode utilizar o filtro e realizar uma consulta para obter resultados mais precisos.
