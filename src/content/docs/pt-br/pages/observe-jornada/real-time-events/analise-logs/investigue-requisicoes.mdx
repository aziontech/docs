...
2. Acesse o [playground](https://manager.azion.com/events/graphql) da API GraphQL do Real-Time Events.
...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/blocklists-enderecos-ip-edge/#associe-a-network-list-a-um-edge-firewall" label="consulte o guia de associar uma network list a uma regra" variant="secondary" target="_blank" />
