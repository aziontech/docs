...
<DocButton href="/pt-br/documentacao/produtos/guias/blocklists-enderecos-ip-edge/#associe-a-network-list-a-um-edge-firewall" label="consulte o guia de associar uma network list a uma regra" kind="secondary" target="_blank" size="medium" />
