...
:::tip
Se você notar que há requisições legítimas de outros países sendo bloqueadas pela regra do header `User-Agent`, use [WAF Tuning](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/tune-waf/) para analisar requisições e criar regras permitidas.
:::
...
- Use [WAF Tuning](/pt-br/documentacao/secure/waf/#waf-tuning) para monitorar e criar allowed rules específicas.
