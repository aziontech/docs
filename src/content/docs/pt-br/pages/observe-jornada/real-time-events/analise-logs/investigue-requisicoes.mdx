...
permalink: /documentacao/guias/plataforma/observabilidade/investigar-requisicoes-api-graphql/
---
...
2. Acesse o Playground da API GraphQL do Real-Time Events navegando até o menu **Real-Time Events** no Azion Console e clicando em **GraphQL Playground**.
...
1. No **GraphQL Playground** do Real-Time Events, adicione a seguinte query:
...
Depois de identificar um país ao qual você não deseja permitir acesso à sua aplicação, você pode criar uma [network list](/pt-br/documentacao/secure/network-shield/network-lists/) para bloquear o país.
...
<DocButton href="/pt-br/documentacao/guias/seguranca-de-aplicacoes/bots-e-rede/blocklists-enderecos-ip-edge/#associe-a-network-list-a-um-edge-firewall" label="consulte o guia de associar uma network list a uma regra" kind="secondary" target="_blank" size="medium" />
...
1. No **GraphQL Playground** do Real-Time Events, execute a seguinte query:
...
1. [Acesse o Console](/pt-br/documentacao/guias/plataforma/conta-e-billing/como-acessar-o-azion-console/) > **Firewall**.
2. Selecione um firewall existente ou [crie um novo](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/firewall-definir-main-settings/).
...
:::tip
Se você notar que há requisições legítimas de outros países sendo bloqueadas pela regra do header `User-Agent`, consulte [Ajuste um WAF rule set](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/tune-waf/) para analisar requisições e criar regras permitidas.
:::
...
Se você não quiser bloquear todas as requisições de um país por meio de uma network list, existem outros recursos dos [produtos de Secure](/pt-br/documentacao/plataforma/firewall/) da Azion que você pode usar.

- Crie uma regra com o [Set Rate Limit](/pt-br/documentacao/plataforma/firewall/rules-engine/#behaviors).
- Use [WAF Tuning](/pt-br/documentacao/secure/waf/custom-allowed-rules/#tuning) para monitorar e criar allowed rules específicas.
