...
<LinkButton link="/pt-br/documentacao/produtos/guias/blocklists-enderecos-ip-edge/#associe-a-network-list-a-um-edge-firewall" text="consulte o guia de associar uma network list a uma regra" outlined target="_blank" />
