...
permalink: /documentacao/produtos/guias/observe/azion-plugin-grafana-personalizar-tabela-logs/
...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/observe/integrar-grafana/" label="saiba mais sobre integrar com grafana" variant="secondary" target="_blank" />
...
- **Data path**: adicione o valor **Events**.
...
6. No lado direito da página, na lista **Visualization**, selecione o tipo de visualização que você quer usar. 
    - Para analisar logs brutos com uma grande quantidade de dados ou queries top X, é recomendado usar o tipo **Table**. Você também pode combiná-lo com outros tipos de gráficos.
