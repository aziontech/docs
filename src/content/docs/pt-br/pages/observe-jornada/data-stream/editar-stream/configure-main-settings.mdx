...
Ao criar ou editar um stream, existem algumas configurações principais específicas que você pode definir e modificar.
...
2. Na lista, selecione o stream que deseja editar ou clique no botão **Add Stream**.
3. Dê ao stream um nome único e fácil de lembrar.
...
Nesta seção, você estará modificando um stream existente com um conector Elasticsearch via API. Para criar um novo, use o [método POST do Data Stream](https://api.azion.com/#b9aac0c7-173a-462b-87f6-a18d6558d3e5).
...
<iframe
   src="https://www.youtube.com/embed/Yz157Kb18Hg"
   loading="lazy"
   width="600"
   height="400"
