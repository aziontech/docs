...
permalink: /documentacao/guias/plataforma/observabilidade/como-usar-data-stream/
---
...
Ao acessar o Data Stream por meio do [Azion Console](https://console.azion.com/data-stream) ou da [Azion API](https://api.azion.com/#04257075-3691-4b5f-b22b-22a5b6653f3f), você pode realizar diversas ações para gerenciar seus fluxos de dados, incluindo [criar um novo data stream](/pt-br/documentacao/guias/plataforma/observabilidade/como-usar-data-stream/), conectar seus data streams a [endpoints](/pt-br/documentacao/guias/#observe), [editar as configurações](/pt-br/documentacao/guias/plataforma/observabilidade/como-usar-data-stream/), [visualizar informações detalhadas](/pt-br/documentacao/observe/data-stream/) sobre cada stream e [excluir ou parar data streams](/pt-br/documentacao/guias/plataforma/observabilidade/deletar-data-stream/) que não são mais necessários.

Para obter informações mais detalhadas sobre o produto e cada configuração, consulte a [documentação de referência](/pt-br/documentacao/observe/data-stream/).
...
1. [Acesse o Azion Console](/pt-br/documentacao/guias/plataforma/conta-e-billing/como-acessar-o-azion-console/) > **Data Stream**.
...
4. No menu suspenso **Source**, selecione o que deseja usar: **Activity History**, **Applications**, **Functions** ou **WAF Events**.
    - Para usar Functions e WAF Events, você deve [ter os produtos ativados](/pt-br/documentacao/observe/data-stream/#selecionar-data-source).
5. No campo **Template**, selecione o que desejar usar.
    - Caso escolha usar um template personalizado, na caixa de código **Data Set**, adicione as variáveis que você deseja usar nas análises de seus logs. Veja mais sobre [Criar um template personalizado no Data Stream](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/data-stream-template-personalizado/).
6. Em **Workloads** > **Options**, selecione **All Current and Future Domains** ou **Filter Domains**.
    - Saiba mais sobre cada opção em [Como associar domínios no Data Stream](/pt-br/documentacao/guias/plataforma/observabilidade/data-stream-associar-dominios/).
...
1. Execute a seguinte requisição `GET` em seu terminal, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/guias/plataforma/conta-e-billing/personal-tokens/) para recuperar seu `<data_streaming_id>`:
