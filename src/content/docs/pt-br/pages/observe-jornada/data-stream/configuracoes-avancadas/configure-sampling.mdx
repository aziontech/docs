...
permalink: /documentacao/guias/plataforma/observabilidade/configurar-sampling/
---
...
Ao [configurar um stream](/pt-br/documentacao/guias/plataforma/observabilidade/como-usar-data-stream/) e escolher associar todos os seus domínios, você pode configurar a opção de **Sampling** para filtrar a porcentagem de dados que será transmitida. Essa é uma opção viável para reduzir os custos da coleta e análise de dados.

:::caution[aviso]
Para habilitar Sampling em sua conta, você deve entrar em contato com a [equipe de vendas](https://www.azion.com/pt-br/contato/) e solicitar a funcionalidade.
...
2. Para configurar o stream, siga as etapas em [Como configurar as main settings do Data Stream](/pt-br/documentacao/guias/plataforma/observabilidade/como-usar-data-stream/).
3. Em **Workloads** > **Options**, escolha **All Current and Future Domains**. Isso associará todos os domínios atuais e futuros da conta a este stream.
...
1. Execute a seguinte requisição `POST` em seu terminal, substituindo `[VALOR DO TOKEN]` pelo seu [token pessoal](/pt-br/documentacao/guias/plataforma/conta-e-billing/personal-tokens/):
