...
Ao configurar [streams](/pt-br/documentacao/observe/data-stream/), você precisa configurar um endpoint específico para fazer stream dos seus dados da Azion.

Continue lendo para obter o passo a passo sobre como configurar um conector do [Object Storage da Azion](/pt-br/documentacao/store/object-storage/) com o Data Stream.
...
- Crie uma [credencial S3 via API](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/s3-protocol-para-object-storage/#crie-uma-credencial-via-api) e [configure o acesso ao bucket através do s3cmd](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/s3-protocol-para-object-storage/#configure-o-acesso-ao-bucket-atraves-do-s3cmd).
  - Salve a **Access Key** e a **Secret Key** vinculadas à sua credencial. Você precisará delas mais tarde.
- Crie um [bucket de Object Storage](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/criar-bucket/), ou use um existente.
...
Você encontra os passos detalhados para a configuração completa no guia [Como utilizar o Data Stream](/pt-br/documentacao/guias/plataforma/observabilidade/como-usar-data-stream/).
...
Você pode acompanhar as chamadas feitas pelo Data⁠ Stream ao Object Storage pelo [Real-Time Events](/pt-br/documentacao/observe/real-time-events/). Para isso, selecione **Data Source** > **Data Stream** e escolha as opções de filtro que você deseja utilizar.
