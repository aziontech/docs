...
description: Hands-on para utilizar o Amazon Kinesis Data Firehose para receber dados do Data Stream
meta_tags: Data Stream, connector, endpoint, amazon, kinesis
...
Continue lendo para obter o passo a passo sobre como conectar um endpoint [Amazon Kinesis Data Firehose](https://aws.amazon.com/kinesis/data-firehose/) com o Data Stream.
...
4. Salve as informações das duas chaves para usá-las depois no Azion Data Stream.
...
Agora, siga os próximos passos para configurar o novo endpoint criado na **Amazon Kinesis Data Firehose** no seu Azion **Data Stream**.
...
Você pode acompanhar as chamadas feitas pelo Data Stream à Amazon Kinesis Data Firehose no [Real-Time Events](/pt-br/documentacao/produtos/observe/real-time-events/). Para isso, selecione **Data Source** > **Data Stream** e escolha as opções de filtro que você deseja utilizar.

Assista um tutorial sobre como usar o Amazon Kinesis Data Firehose com o Data Stream no canal do YouTube da Azion, com opção de ativar legendas em português:

<iframe src="https://www.youtube.com/embed/zL_1SBbxVBc" title="Como utilizar o Amazon Kinesis Data Firehose para receber dados do Data Stream" loading="lazy" width="600" height="400" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
