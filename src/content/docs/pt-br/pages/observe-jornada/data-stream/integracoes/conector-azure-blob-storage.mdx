...
Ao configurar [stream](/pt-br/documentacao/produtos/observe/data-stream/), você precisa configurar um endpoint específico para transmitir seus dados da Azion.
...
Você pode acompanhar as chamadas feitas pelo Data⁠ Stream ao Azure Blob Storage no [Real-Time Events](/pt-br/documentacao/produtos/observe/real-time-events/). Para isso, selecione **Data Source** > **Data Stream** e escolha as opções de filtro que você deseja utilizar.
