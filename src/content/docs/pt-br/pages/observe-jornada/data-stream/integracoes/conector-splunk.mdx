...
permalink: /documentacao/guias/plataforma/observabilidade/splunk-endpoint/
---
...
Você pode acompanhar as chamadas feitas pelo Data ⁠Stream à Splunk no [Real-Time Events](/pt-br/documentacao/observe/real-time-events/). Para isso, selecione **Data Source** > **Data Stream** e escolha as opções de filtro que você deseja utilizar.
