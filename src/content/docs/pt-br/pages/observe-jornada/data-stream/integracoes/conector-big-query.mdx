...
permalink: /documentacao/guias/plataforma/observabilidade/google-bigquery-endpoint/
---
...
Você pode acompanhar as chamadas feitas pelo Data⁠ Stream ao Google BigQuery no [Real-Time Events](/pt-br/documentacao/observe/real-time-events/). Para isso, selecione **Data Source** > **Data Stream** e escolha as opções de filtro que você deseja utilizar.
