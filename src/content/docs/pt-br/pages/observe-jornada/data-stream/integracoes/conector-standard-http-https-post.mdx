...
permalink: /documentacao/guias/plataforma/observabilidade/conector-standard-https-post/
---
...
Você encontra os passos detalhados para a configuração completa no guia [Como configurar as main settings do Data Stream](/pt-br/documentacao/guias/plataforma/observabilidade/como-usar-data-stream/).
...
1. Execute a seguinte requisição `GET` em seu terminal, substituindo `[TOKEN VALUE]` pelo seu [personal token]/pt-br/documentacao/guias/plataforma/conta-e-billing/personal-tokens/) para criar seu data stream.
...
:::tip
Com esse tipo de conector, você também pode [adicionar um payload](/pt-br/documentacao/guias/plataforma/observabilidade/data-stream-adicionar-payload/).
:::

Você pode acompanhar as chamadas feitas pelo Data Stream ao conector Standard HTTP/HTTPS POST no [Real-Time Events](/pt-br/documentacao/observe/real-time-events/). Para isso, selecione **Data Source** > **Data Stream** e escolha as opções de filtro que você deseja utilizar.
\
---
