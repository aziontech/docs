...
permalink: /documentacao/guias/plataforma/observabilidade/elasticsearch-endpoint/
---

import Tabs from '~/components/tabs/Tabs'


Ao configurar [streams](/pt-br/documentacao/observe/data-stream/), você precisa configurar um endpoint específico para transmitir seus dados da Azion.

Continue lendo para obter o passo a passo sobre como conectar um endpoint [Elasticsearch](https://www.elastic.co/elasticsearch/) com o Data Stream.
...
Agora, siga os próximos passos para configurar o novo endpoint criado no **Elasticsearch** no seu Azion **Data Stream**.
...
1. No menu suspenso **Connector**, selecione **Elasticsearch**.
2. Em **URL**, adicione a URL do seu endpoint que você copiou na Elasticsearch. Exemplo: `https://my-deploy-pg4by0.es.us-central1.gcp.cloud.es.io`
3. Em **Encoded API Key**, adicione a chave `Base64` correspondente ao valor `"encoded"` gerado na criação da chave API no ElasticSearch. Exemplo: `VnVhQ2ZHY0JDZGJrUW0tZTVhT3g6dWkybHAyYXhUTm1zeWFrdzl0dk5udw==`
...
Você pode acompanhar as chamadas feitas pelo Data Stream à Elasticsearch no [Real-Time Events](/pt-br/documentacao/observe/real-time-events/). Para isso, selecione **Data Source** > **Data Stream** e escolha as opções de filtro que você deseja utilizar.
