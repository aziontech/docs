...
Ao configurar [Data Streams](/pt-br/documentacao/produtos/observe/data-stream/), você precisa configurar um endpoint específico para fazer stream dos seus dados da Azion.
...
Você pode acompanhar as chamadas feitas pelo Data ⁠Streaming ao Azure Monitor no [Real-Time Events](/pt-br/documentacao/produtos/observe/real-time-events/). Para isso, selecione **Data Source** > **Data Stream** e escolha as opções de filtro que você deseja utilizar.
