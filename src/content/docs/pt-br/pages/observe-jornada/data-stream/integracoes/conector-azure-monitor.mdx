...
permalink: /documentacao/guias/plataforma/observabilidade/azure-monitor-endpoint/
---
...
Continue lendo para obter o passo a passo sobre como conectar um endpoint [Azure Monitor](https://azure.microsoft.com/en-us/free/) com o Data Stream.
...
Agora, siga os próximos passos para configurar o novo endpoint criado no **Azure Monitor** no seu Azion **Data Stream**.
...
1. No menu suspenso **Connector**, selecione **Azure Monitor**.
...
Você pode acompanhar as chamadas feitas pelo Data ⁠Stream ao Azure Monitor no [Real-Time Events](/pt-br/documentacao/observe/real-time-events/). Para isso, selecione **Data Source** > **Data Stream** e escolha as opções de filtro que você deseja utilizar.
