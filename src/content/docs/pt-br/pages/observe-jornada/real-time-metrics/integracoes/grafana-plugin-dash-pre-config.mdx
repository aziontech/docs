...
<LinkButton link="/pt-br/documentacao/produtos/guias/observe/integrar-grafana/" label="saiba mais sobre integrar com grafana" severity="secondary" target="_blank" />
