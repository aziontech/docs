...
<DocButton href="/pt-br/documentacao/produtos/guias/observe/integrar-grafana/" label="saiba mais sobre integrar com grafana" kind="secondary" target="_blank" size="medium" />
