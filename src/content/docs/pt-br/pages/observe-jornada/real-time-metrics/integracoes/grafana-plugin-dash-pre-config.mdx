...
permalink: /documentacao/guias/plataforma/observabilidade/azion-plugin-grafana-dash-pre-configurado/
---
...
<DocButton href="/pt-br/documentacao/guias/plataforma/observabilidade/integrar-grafana/" label="saiba mais sobre integrar com grafana" kind="secondary" target="_blank" size="medium" />
...
2. Em **Personal Token**, adicione o token que você criou na página de [Personal Tokens no Azion Console](/pt-br/documentacao/fundamentos/personal-tokens/).
