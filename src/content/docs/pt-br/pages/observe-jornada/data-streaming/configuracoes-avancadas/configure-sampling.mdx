...
2. Para configurar o streaming, siga as etapas em [Como configurar as main settings do Data Streaming](/pt-br/documentacao/produtos/guias/como-usar-data-streaming/).
