...
Ao configurar um streaming com um conector [Standard HTTP/HTTPS POST](xxx), você pode definir um payload para personalizar os dados e a forma como serão transmitidos.
...
2. Siga as etapas descritas no guia [Como utilizar o Standard HTTP/HTTPS POST para receber dados](xxx) para a seção **Destination**.
