...
Você encontra os passos detalhados para a configuração completa no guia [Como configurar as main settings do Data Streaming](xxx).
...
:::tip
Com esse tipo de conector, você também pode [configurar um payload](xxx).
:::
