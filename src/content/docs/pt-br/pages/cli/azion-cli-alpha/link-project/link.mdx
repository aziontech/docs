...
O processo de vinculação adapta o ambiente para a construção do seu aplicativo de borda.
...
Depois de inicializar a vinculação de um aplicativo existente, a lista de modos disponíveis será exibida. Em seguida, é necessário escolher um deles.
