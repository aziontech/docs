...
1. Acesse o [Centro de Suporte](https://tickets.azion.com/) ou faça login [no RTM](https://console.azion.com/) e, no cabeçalho, clique no ícone do Help Center **(?)** > selecione a opção **Contact Support**.
