...
- [Como configurar mTLS nos workloads da Edge Application](/pt-br/documentacao/produtos/guias/mtls/)
...
- [Como gerar um certificado Let's Encrypt usando desafio HTTP-01 para sua aplicação via API](/documentacao/produtos/guias/como-gerar-um-certificado-lets-encrypt-via-api/)
...
## Demonstrações de Edge Functions

- [Como construir uma aplicação browserless com Edge Functions](/pt-br/documentacao/produtos/guias/build/aplicacao-browserless-edge-functions/)
- [Como implementar funcionalidade de upload de arquivos com Edge Functions](/pt-br/documentacao/produtos/guias/build/upload-arquivos-edge-functions/)
- [Como integrar o serviço de email Resend com Edge Functions](/pt-br/documentacao/produtos/guias/build/integrar-resend-email-edge-functions/)
- [Como construir uma API RESTful com Edge Functions e Edge SQL](/pt-br/documentacao/produtos/guias/build/api-restful-edge-functions-edge-sql/)
- [Como lidar com webhooks do Stripe com Edge Functions](/pt-br/documentacao/produtos/guias/build/webhooks-stripe-edge-functions/)
...
- [Como implantar o template Edge AI Starter Kit](/pt-br/documentacao/produtos/guias/edge-ai-starter-kit/)
- [Como implantar o template Edge Application Proxy](/pt-br/documentacao/produtos/guias/edge-application-proxy-template/)
- [Como implantar o template Edge Function Starter Kit](/pt-br/documentacao/produtos/guias/edge-function-starter-kit/)
- [Como implantar o template EdgeSQL Starter Kit](/pt-br/documentacao/produtos/guias/edgesql-starter-kit/)
...
- [Como consultar dados de uso do Edge Application](/pt-br/documentacao/produtos/guias/consultar-dados-de-uso-edge-application-com-graphql/)
