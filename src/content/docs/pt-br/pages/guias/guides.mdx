...
- [Como migrar do Azion Terraform Provider 1.x para 2.0](/pt-br/documentacao/produtos/terraform-provider/migration-v3-to-v4/)
---

## Migração

- [Migre da Akamai para a Azion | Guia completo de migração](/pt-br/documentacao/produtos/guias/akamai-guia-migracao/)
- [Migre da AWS para a Azion | Guia completo de migração](/pt-br/documentacao/produtos/guias/aws-guia-migracao/)
- [Migre da Cloudflare para a Azion | Guia completo de migração](/pt-br/documentacao/produtos/guias/cloudflare-guia-migracao/)
- [Migre da Fastly para a Azion | Guia completo de migração](/pt-br/documentacao/produtos/guias/fastly-guia-migracao/)
- [Migre da Vercel para a Azion | Guia completo de migração](/pt-br/documentacao/produtos/guias/vercel-guia-migracao/)
...
- [Como migrar padrões de handler em Functions](/pt-br/documentacao/produtos/guias/functions/migrar-padroes-de-handler/)
...
- [Como utilizar o template QStash Functions Scheduler](/pt-br/documentacao/produtos/guias/qstash-function-scheduler/)
...
- [Como configurar uma WAF Custom Allowed Rule](/pt-br/documentacao/produtos/guias/secure/configurar-waf-allowed-rules/)
- [Como configurar regras de WAF para permitir requisições com um cookie específico](/pt-br/documentation/products/guides/secure/waf-rules-para-cookie-especifico/)
- [Azion Firewall: segurança multi-camadas no Edge](/pt-br/documentacao/produtos/guias/firewall/)
...
- [Paywall com Functions JWT](/pt-br/documentacao/produtos/guias/paywall-function-jwt/)
- [Como monitorar e calibrar o Bot Manager](/pt-br/documentacao/produtos/guias/secure/monitorar-e-calibrar-bot-manager/)
...
- [Como instalar a integração IPQualityScore Phone Validation através do Marketplace da Azion](/pt-br/documentacao/produtos/guias/ipqs-phone-validation/)
- [Como instalar a integração IPQualityScore URL Validation através do Marketplace da Azion](/pt-br/documentacao/produtos/guias/ipqs-url-validation/)
...
- [Como usar KV Store com compatibilidade Redis](/pt-br/documentacao/produtos/guias/kv-store/compatibilidade-redis/)
...
- [Como acessar o Activity History](/pt-br/documentacao/produtos/guias/activity-history/)
...
- [Como fazer o staging de uma application através do arquivo hosts](/pt-br/documentacao/produtos/guias/testar-edge-application-atraves-do-arquivo-hosts/)
- [Como testar uma origem com Functions](/pt-br/documentacao/produtos/guias/test-origin-with-functions/)
