...
- [Como adicionar o Bot Manager em uma instância existente no Edge Firewall usando um template](/pt-br/documentacao/produtos/guias/bot-manager-with-edge-firewall-template/)
- [Como bloquear requisições de Tor Exit Nodes usando um template](/pt-br/documentation/products/guides/block-tor-exit-nodes-template/)
...
- [Como testar o Bot Manager usando um template](/pt-br/documentacao/produtos/guias/bot-manager-basic-template/)
