...
| `waf_block`         | Booleano (1 ou 0). O valor `1` indica que a requisição será bloqueada pelo WAF, se o mesmo estiver configurado em modo `blocking`. Já `0` indica que não foi bloqueada pelo WAF.         |
