...
> Se você não tiver um WAF Rule Set configurado, leia esta documentação sobre [Web Application Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/web-application-firewall/).
