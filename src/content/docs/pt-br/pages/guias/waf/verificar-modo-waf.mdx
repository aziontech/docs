...
:::tip
Veja a lista de todas [as famílias de ameaças](/pt-br/documentacao/secure/waf/) das quais o WAF protege.
:::
...
- Um [firewall](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/firewall-definir-main-settings/), com os domínios de suas applications associados.
- Esse firewall deve ter pelo menos um [WAF Rule Set](/pt-br/documentacao/secure/waf/rule-sets/) configurado.

Se você não tiver um WAF Rule Set configurado, leia [este guia]](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/criar-waf-rule-set/) para mais detalhes.
...
1. Acesse o [Azion Console](/pt-br/documentacao/guias/plataforma/conta-e-billing/como-acessar-o-azion-console/) > **Firewall**, na seção **Secure**.
