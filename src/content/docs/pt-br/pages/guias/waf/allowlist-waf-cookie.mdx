...
- Um [firewall existente](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/firewall-definir-main-settings/) com o **WAF** ativado.
...
Ainda na página **WAF Rules**, você deve criar um **conjunto de regras WAF** secundário incluindo uma [Custom Allowed Rule](/pt-br/documentacao/secure/waf/custom-allowed-rules/). Para fazer isso:
...
3. No menu suspenso **Rule ID**, selecione uma regra. 
    ...
    - Saiba mais sobre todas as [regras internas disponíveis](/pt-br/documentacao/secure/waf/custom-allowed-rules/). 
...
:::tip
Você pode usar os [produtos Observe da Azion](/pt-br/documentacao/plataforma/real-time-metrics/) para monitorar a entrega da sua aplicação, o tráfego de entrada e como suas lógicas de segurança estão sendo aplicadas e com quais requisições.
:::