...
<LinkButton link="/pt-br/documentacao/produtos/secure/edge-firewall/web-application-firewall/custom-allowed-rules/" text="saiba mais sobre as WAF Custom Allowed Rules" severity="secondary" />
