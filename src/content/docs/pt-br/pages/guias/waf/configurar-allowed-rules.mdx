...
<DocButton href="/pt-br/documentacao/produtos/secure/firewall/web-application-firewall/custom-allowed-rules/" label="saiba mais sobre as WAF Custom Allowed Rules" kind="secondary" size="medium" />
