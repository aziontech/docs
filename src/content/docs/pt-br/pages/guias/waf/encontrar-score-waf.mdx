...
> Acesse a documentação do [Real-Time Events](/pt-br/documentacao/produtos/observe/real-time-events/) para mais informações sobre o produto.
...
Consulte os scores referentes a cada nível de sensibilidade disponível na documentação do [Web Application Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/web-application-firewall/).
