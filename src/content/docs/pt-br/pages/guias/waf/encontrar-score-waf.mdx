...
1. Acesse o [Azion Console](/pt-br/documentacao/guias/plataforma/conta-e-billing/como-acessar-o-azion-console/) > **Real-Time Events**.
...
:::tip
Veja a descrição dos campos mencionados na [documentação de Real-Time Events](/pt-br/documentacao/observe/real-time-events/).
:::
