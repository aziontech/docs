...
permalink: /documentacao/guias/plataforma/migracao/akamai-guia-migracao/
---
...
| :------------------------ | :-------- | :---------------- |
| **Ion** | Otimização de performance, confiabilidade e experiência de usuário em escala. | [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) + [Application Accelerator](https://www.azion.com/pt-br/documentacao/build/application-accelerator/) + [Cache](https://www.azion.com/pt-br/documentacao/build/cache/) |
| **API Acceleration** | Otimização de performance e confiabilidade para APIs. | [Application Accelerator](https://www.azion.com/pt-br/documentacao/build/application-accelerator/) + [Cache](https://www.azion.com/pt-br/documentacao/build/cache/) |
| **Adaptive Media Delivery** | Entrega de vídeo online em larga escala. | [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) + [Cache](https://www.azion.com/pt-br/documentacao/build/cache/) + [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/) |
| **Download Delivery** | Entrega otimizada de arquivos grandes, softwares, jogos e assets de mídia. | [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) + [Cache](https://www.azion.com/pt-br/documentacao/build/cache/) + [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/) |
| **Dedicated Delivery** | Entrega de mídia de alto volume com requisitos de offload de origem. | [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) + [Cache](https://www.azion.com/pt-br/documentacao/build/cache/) + [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/cache/tiered-cache/) |
| **Image & Video Manager** | Otimização de imagens e vídeos para dispositivos e condições de rede. | [Image Processor](https://www.azion.com/pt-br/documentacao/build/image-processor/) |
| **Media Services Live** | Fluxos de ingestão e entrega de vídeo ao vivo. | [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) + [Cache](https://www.azion.com/pt-br/documentacao/build/cache/) |
| **Cloudlets** | Aplicações de política para redirects, load balancing, controle de tráfego, phased releases e tratamento de requisições. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/rules-engine/) + [Functions](https://www.azion.com/pt-br/documentacao/build/functions/) + [Load Balancer](https://www.azion.com/pt-br/documentacao/plataforma/load-balancer/) + [Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/) |
| **Cloud Wrapper** | Camada privada de cache para offload de origem e redução de egress. | [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/cache/tiered-cache/) + [Origin Shield](https://www.azion.com/pt-br/documentacao/secure/origin-shield/) + [Cache](https://www.azion.com/pt-br/documentacao/build/cache/) |
| **EdgeWorkers** | Functions JavaScript para customizar comportamento de request e response. | [Functions para Applications](https://www.azion.com/pt-br/documentacao/build/functions/) |
| **Akamai Functions** | Execução serverless distribuída para aplicações e workloads de IA. | [Functions](https://www.azion.com/pt-br/documentacao/build/functions/) |
| **EdgeKV** | Dados key-value distribuídos para aplicações EdgeWorkers. | [KV Store](https://www.azion.com/pt-br/documentacao/store/kv-store/) |
| **API Gateway** | Registro, roteamento, entrega e proteção de APIs. | [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) + [Rules Engine](https://www.azion.com/pt-br/documentacao/plataforma/applications/rules-engine/) + [Functions](https://www.azion.com/pt-br/documentacao/build/functions/) + [Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/) |
| **App Platform** | Deployment gerenciado de aplicações em containers. | [Orchestrator](https://www.azion.com/pt-br/documentacao/build/orchestrator/) |
| **Akamai Inference Cloud** | Plataforma distribuída de inferência de IA. | [AI Inference](https://www.azion.com/pt-br/documentacao/build/ai-inference/) |
| **App & API Protector** | Proteção de aplicações e APIs contra vulnerabilidades, abuso e ameaças distribuídas. | [Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/) + [Web Application Firewall](https://www.azion.com/pt-br/documentacao/secure/waf/) + [DDoS Protection](https://www.azion.com/pt-br/documentacao/plataforma/ddos-protection/) + [Bot Manager](https://www.azion.com/pt-br/documentacao/secure/bot-manager/) |
| **Firewall for AI** | Proteção para aplicações LLM e aplicações orientadas por IA. | [Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/) + [AI Inference](https://www.azion.com/pt-br/documentacao/build/ai-inference/) |
| **API Security** | Descoberta, monitoramento e proteção de APIs. | [Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/) + [Web Application Firewall](https://www.azion.com/pt-br/documentacao/secure/waf/) + [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) |
| **Bot Manager** | Detecção de bots e resposta a tráfego automatizado. | [Bot Manager](https://www.azion.com/pt-br/documentacao/secure/bot-manager/) |
| **Account Protector** | Proteção contra abuso de contas e ataques de credenciais. | [Bot Manager](https://www.azion.com/pt-br/documentacao/secure/bot-manager/) + [Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/) |
| **Content Protector** | Proteção contra scraping e acesso automatizado abusivo. | [Bot Manager](https://www.azion.com/pt-br/documentacao/secure/bot-manager/) + [Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/) + [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/rules-engine/) |
| **Input Validation Cloudlet** | Controles de validação de formulários e requisições. | [Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/) + [Rules Engine para Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/rules-engine/) |
| **Request Control Cloudlet** | Controle de acesso e filtragem de requisições. | [Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/) + [Rules Engine para Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/rules-engine/) |
| **Cloud Firewall** | Controles de segurança de rede para workloads em cloud. | [Network Shield](https://www.azion.com/pt-br/documentacao/secure/network-shield/) + [Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/) |
| **Prolexic Solutions** | Proteção DDoS para ambientes de infraestrutura, cloud, híbridos e on-premises. | [DDoS Protection](https://www.azion.com/pt-br/documentacao/plataforma/ddos-protection/) + [Network Shield](https://www.azion.com/pt-br/documentacao/secure/network-shield/) |
| **Forward Rewrite Cloudlet** | Reescrita de URL para URLs limpas e semânticas. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/rules-engine/) + [Functions](https://www.azion.com/pt-br/documentacao/build/functions/) |
| **Phased Release Cloudlet** | Controle de release gradual e rollback. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/rules-engine/) + [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) |
| **API Prioritization Cloudlet** | Priorização de tráfego de API. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/rules-engine/) + [Application Accelerator](https://www.azion.com/pt-br/documentacao/build/application-accelerator/) |
| **Application Load Balancer Cloudlet** | Load balancing de aplicações para performance e disponibilidade. | [Load Balancer](https://www.azion.com/pt-br/documentacao/plataforma/load-balancer/) |
| **Audience Segmentation Cloudlet** | Segmentação por cookies, A/B testing e padrões de afinidade de sessão. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/rules-engine/) + [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) |
| **Edge Redirector Cloudlet** | Gerenciamento centralizado de redirects. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/rules-engine/) + [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) |
| **NodeBalancers** | Load balancing L4 e L7 para instâncias de compute. | [Load Balancer](https://www.azion.com/pt-br/documentacao/plataforma/load-balancer/) |
| **DNS Infrastructure** | Serviços DNS para ambientes de provedores e empresas. | [Edge DNS](https://www.azion.com/pt-br/documentacao/secure/edge-dns/) |
| **Edge DNS** | DNS autoritativo de alta disponibilidade. | [Edge DNS](https://www.azion.com/pt-br/documentacao/secure/edge-dns/) |
| **Global Traffic Management** | Direcionamento de tráfego para otimização de performance e prevenção de indisponibilidade. | [Load Balancer](https://www.azion.com/pt-br/documentacao/plataforma/load-balancer/) + [Edge DNS](https://www.azion.com/pt-br/documentacao/secure/edge-dns/) |
| **DNS Manager** | Interface de gerenciamento de registros DNS. | [Edge DNS](https://www.azion.com/pt-br/documentacao/secure/edge-dns/) |
| **NetStorage** | Storage replicado para entrega de conteúdo. | [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/) |
| **Object Storage** | Object storage durável para dados e distribuição. | [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/) |
| **Managed Databases** | Workloads de banco relacional gerenciado. | [SQL Database](https://www.azion.com/pt-br/documentacao/store/sql-database/) |
...
| **DataStream** | Feed de dados de baixa latência para ferramentas externas de monitoramento. | [Data Stream](https://www.azion.com/pt-br/documentacao/observe/data-stream/) |
| **mPulse** | Real-user monitoring e analytics de experiência digital. | [Edge Pulse](https://www.azion.com/pt-br/documentacao/observe/edge-pulse/) + [Real-Time Metrics](https://www.azion.com/pt-br/documentacao/plataforma/real-time-metrics/) |
...
* [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/)
* [Applications Main Settings](https://www.azion.com/pt-br/documentacao/plataforma/applications/main-settings/)
...
* [Origin Shield](https://www.azion.com/pt-br/documentacao/secure/origin-shield/)
...
* [Advanced Cache Key](https://www.azion.com/pt-br/documentacao/guias/performance-e-confiabilidade/cache-e-purge/advanced-cache-key/)
* [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/cache/tiered-cache/)
...
* [Como implementar cache HLS para entrega de streaming ao vivo](https://www.azion.com/pt-br/documentacao/guias/performance-e-confiabilidade/cache-e-purge/implementar-cache-hls/)
...
* [Application Accelerator](https://www.azion.com/pt-br/documentacao/build/application-accelerator/)
...
* [WAF Rule Sets](https://www.azion.com/pt-br/documentacao/secure/waf/rule-sets/) 
...
* [Edge DNS](https://www.azion.com/pt-br/documentacao/secure/edge-dns/)
* [Como configurar Edge DNS](https://www.azion.com/pt-br/documentacao/guias/seguranca-de-aplicacoes/dns/edge-dns-definir-main-settings/)
* [Como adicionar registros em uma DNS](https://www.azion.com/pt-br/documentacao/guias/seguranca-de-aplicacoes/dns/adicionar-registros/)
* [Load Balancer](https://www.azion.com/pt-br/documentacao/plataforma/load-balancer/)
...
* [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/)
* [Como acessar o Object Storage usando o protocolo S3](https://www.azion.com/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/protocolo-s3-para-object-storage/)
* [Como criar e modificar um bucket](https://www.azion.com/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/criar-e-modificar-um-bucket/)
* [Como fazer upload e download de objetos](https://www.azion.com/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/upload-e-download-de-objetos-do-bucket/)
...
* [Como criar e consultar dados no SQL Database](https://www.azion.com/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/criar-tabelas-edge-sql/)
...
* [Como construir uma API RESTful com Functions e SQL Database](https://www.azion.com/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/functions-e-runtime/api-restful-edge-functions-edge-sql/)
...
* [Grafana plugin dashboards customizados](https://www.azion.com/pt-br/documentacao/guias/plataforma/observabilidade/azion-plugin-grafana/)
...
* [Como configurar as main settings do Data Stream](https://www.azion.com/pt-br/documentacao/guias/plataforma/observabilidade/como-usar-data-stream/)
* [Como selecionar variáveis no Data Stream](https://www.azion.com/pt-br/documentacao/guias/plataforma/observabilidade/data-stream-selecionar-variaveis/)
...
* [Primeiros passos do Edge Pulse](https://www.azion.com/pt-br/documentacao/observe/edge-pulse/primeiros-passos/)
* [Como analisar dados de navegação do Edge Pulse](https://www.azion.com/pt-br/documentacao/guias/plataforma/observabilidade/analisar-dados-navegacao/)
...
* Revise [Real-Time Metrics](https://www.azion.com/pt-br/documentacao/plataforma/real-time-metrics/) para monitorar performance.
* Configure [Real-Time Events](https://www.azion.com/pt-br/documentacao/observe/real-time-events/) para visibilidade de produção.
* Configure [Web Application Firewall](https://www.azion.com/pt-br/documentacao/secure/waf/) para segurança em produção.
