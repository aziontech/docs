...
Você pode criar funções para [Edge Application](/pt-br/documentacao/produtos/edge-application/edge-functions-instances/) e [Edge Firewall](/pt-br/documentacao/produtos/edge-firewall/edge-functions-instances/).
