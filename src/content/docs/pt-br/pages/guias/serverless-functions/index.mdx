...
[Edge Functions](/pt-br/documentacao/produtos/edge-application/edge-functions/) é um serviço da plataforma de Edge da Azion que permite que você programe e execute funções serverless, sem o uso de servidores.
