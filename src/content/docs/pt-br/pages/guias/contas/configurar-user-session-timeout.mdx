...
permalink: /documentacao/guias/seguranca-de-aplicacoes/acesso-e-compliance/configurar-user-session-timeout/
---
...
<DocButton href="/pt-br/documentacao/fundamentos/user-session-timeout/" label="Saiba mais sobre o User Session Timeout" kind="secondary" target="_blank" size="medium" />
