...
description: Este guia lhe orienta na configuração do recurso User Session Timeout para proteger sua conta contra acesso não autorizado.
...
Isso significa que o recurso está configurado com *1 minuto para o tempo máximo de inatividade e 5 minutos para o tempo máximo de sessão*.
