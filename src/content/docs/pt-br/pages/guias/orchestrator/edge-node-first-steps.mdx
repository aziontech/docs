...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/automacao/edge-node-primeiros-passos/
---
...
:::tip
Para gerar o personal token necessário para autenticar seus edge nodes, siga os passos da [documentação de Personal Token](/pt-br/documentacao/guias/plataforma/conta-e-billing/personal-tokens/).
:::
