...
> Para gerar a credencial necessária para autenticar seus edge nodes, siga os passos da [documentação de credenciais](/pt-br/documentacao/produtos/deploy/credenciais/).
...
Sempre que o código de instalação for executado em algum dispositivo, seguido da autenticação via token, os edge nodes serão listados no [Azion Console](https://console.azion.com/).
