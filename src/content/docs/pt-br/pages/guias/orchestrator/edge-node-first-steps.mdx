...
Sempre que o código de instalação for executado em algum dispositivo, seguido da autenticação via token, os edge nodes serão listados no [Real-Time Manager](https://console.azion.com/).

Para visualizar a lista de edge nodes criados para a sua conta, siga os passos abaixo:

1. Acesse o [Real-Time Manager](https://console.azion.com/).
...
1. Abra a lista de **Edge Nodes** no [Real-Time Manager](https://console.azion.com/).
