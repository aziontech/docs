...
permalink: /documentacao/guias/seguranca-de-aplicacoes/acesso-e-compliance/desbloquear-account-lockout-policy/
---
...
<DocButton href="/pt-br/documentacao/fundamentos/account-lockout-policy/" label="Saiba mais sobre Account Lockout Policy" kind="secondary" target="_blank" size="medium" />
...
Para desbloquear manualmente um usuário, você precisa [obter os logs](/pt-br/documentacao/guias/seguranca-de-aplicacoes/acesso-e-compliance/account-lockout-policy-logs/) e confirmar os dados sobre o usuário. Em seguida, execute o desbloqueio. Para isso:
