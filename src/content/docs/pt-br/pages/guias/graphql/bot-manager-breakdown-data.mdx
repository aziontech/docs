...
:::note
Para recuperar esses dados, você deve estar inscrito no Azion Bot Manager e usar a [API GraphQL](/pt-br/documentacao/devtools/graphql-api/visao-geral/). Entre em contato com a [equipe de vendas](https://www.azion.com/pt-br/contato/) para mais detalhes sobre a assinatura.
:::
