...
permalink: /documentacao/guias/plataforma/observabilidade/graphql-metadados/
---

Metadados são informações relevantes sobre o escopo de dados da [GraphQL API](/pt-br/documentacao/devtools/graphql/visao-geral/). Eles nos auxiliam a compreender melhor o relacionamento e a sua utilidade no processo de consulta.

Para consultar os metadados da GraphQL API, siga os passos descritos no guia [Como rodar requisições da GraphQL no Postman](/pt-br/documentacao/guias/plataforma/observabilidade/consultar-graphql-postman/) utilizando a URL `https://api.azionapi.net/metrics/graphql`.
