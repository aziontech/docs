---
title: Consulte dados de uso de Functions
description: Consulte o conjunto de dados de Consumption pelo GraphiQL Playground para o tempo de computação e as invocações de uma função.
...
Você lê o tempo de computação e as invocações de Functions pelo [GraphiQL Playground](/pt-br/documentacao/devtools/graphql/playground-graphql/).

---

## Consulte o tempo de computação e as invocações

Para ler ambas as métricas em um período:
...
| `total` | O resultado da soma. Para `compute_time`, o tempo total de execução de Functions em segundos, como `436363.41`. Para `invocations`, o número total de invocações, como `33134`. |
