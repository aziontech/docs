...
Este guia explica como consultar as imagens processadas pelo Image Processor usando o [GraphiQL Playground](/pt-br/documentacao/devtools/graphql/playground-graphql/).
