...
permalink: /documentacao/guias/plataforma/observabilidade/query-dados-connected-users-com-graphql/
---
...
:::note
Para obter esses dados, você deve ter a subscrição do [Live Ingest da Azion](https://www.azion.com/pt-br/solucoes/live-streaming/) e usar a [GraphQL API](/pt-br/documentacao/devtools/graphql/visao-geral/).
:::
...
1. Acesse o GraphiQL Playground nesse link `https://api.azion.com/v4`.
