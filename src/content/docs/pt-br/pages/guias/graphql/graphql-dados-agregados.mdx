...
Para saber mais sobre como consultar dados agregados com a GraphQL API, visite a [página de documentação](/pt-br/documentacao/devtools/graphql-api/recursos/#conjuntos-de-dados).
