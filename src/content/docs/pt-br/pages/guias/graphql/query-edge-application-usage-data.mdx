...
permalink: /documentacao/guias/plataforma/observabilidade/consultar-dados-de-uso-edge-application-com-graphql/
---
...
Usando o [GraphiQL Playground](/pt-br/documentacao/devtools/graphql/playground-graphql/), você pode consultar dados relacionados a:
...
:::note
Este exemplo recupera dados do número total de requisições inspecionadas pelo WAF. Os resultados são agrupados por `clientId` e `workloadId`. Para saber mais sobre os campos disponíveis, consulte a documentação [Campos da API GraphQL de Consumption](/pt-br/documentacao/devtools/graphql/campos-gql-consumption/).
:::
...
:::tip
Para saber mais sobre os campos disponíveis, consulte a documentação [Campos da API GraphQL de Consumption](/en/documentation/devtools/graphql/gql-consumption-fields/).
:::
