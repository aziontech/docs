...
description: >-
  As queries Top X costumam ser utilizadas para realizar consultas e análises
  sobre dados. Elas têm a finalidade de visualizar a utilização de recursos e
  ferramentas e ter uma visão sobre determinadas condições que são mais ou menos
  utilizadas.
meta_tags: 'graphql, top x, query, queries'
namespace: documentation_how_to_configurations_graphql_topx
permalink: /documentacao/guias/plataforma/observabilidade/graphql-query-top-x/
---
...
Para selecionar Top X queries através da [GraphQL API](/pt-br/documentacao/devtools/graphql/visao-geral/), siga os passos descritos no guia [Como rodar requisições da GraphQL no Postman](/pt-br/documentacao/guias/plataforma/observabilidade/consultar-graphql-postman/) utilizando a URL `https://api.azionapi.net/events/graphql`.
...
Para saber mais sobre os conjuntos de dados disponíveis para consulta com a GraphQL API, visite a [página de documentação](/pt-br/documentacao/devtools/graphql/recursos/#conjuntos-de-dados).
