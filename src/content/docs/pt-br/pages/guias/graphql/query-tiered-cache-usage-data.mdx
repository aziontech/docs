...
Este guia explica como consultar o total de dados transferidos pelo Tiered Cache usando o [GraphiQL Playground](/en/documentation/products/devtools/graphql-playground/).
...
:::note
Este exemplo recupera dados para o número total de requisições processadas e dados transferidos pelo Tiered Cache. Os resultados são agrupados por `clientId` e `workloadId`. Para saber mais sobre os campos disponíveis, consulte a documentação [Campos da API GraphQL de Consumption](/en/documentation/devtools/graphql-api/features/gql-consumption-fields/).
:::
