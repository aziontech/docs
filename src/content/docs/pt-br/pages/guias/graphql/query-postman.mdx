...
1. No [Azion Console](https://console.azion.com), no canto superior direito, selecione **Account menu** > **Personal Tokens**.
...
Veja a documentação de [Personal Tokens](/pt-br/documentacao/fundamentos/personal-tokens/) para mais informações sobre como criar tokens.
