...
**Edge Storage** da Azion permite que você crie buckets e os use como fonte de conteúdo através de [edge connector](/pt-br/documentacao/produtos/build/edge-application/edge connector/#edge-storage). Dessa forma, você pode tornar público o conteúdo do bucket.
...
3. Navegue até a aba **Edge Connector**.
