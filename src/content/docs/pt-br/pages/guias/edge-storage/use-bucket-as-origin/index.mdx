...
**Object Storage** da Azion permite que você crie buckets e os use como fonte de conteúdo através de [Connectors](/pt-br/documentacao/produtos/secure/connectors/#object-storage). Dessa forma, você pode tornar público o conteúdo do bucket.
