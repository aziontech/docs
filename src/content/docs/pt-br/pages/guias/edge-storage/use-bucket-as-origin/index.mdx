---
title: Como usar um bucket do Edge Storage como origem de uma edge application estática
...
<LinkButton outlined link="/pt-br/documentacao/produtos/store/edge-storage/" label="saiba mais sobre Edge Storage" variant="secondary" />
