---
title: Como utilizar Google SAML como IdP na Azion
description:  Guia para configurar a aplicação personalizada Google SAML como um IdP na plataforma da Azion.
