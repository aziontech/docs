...
:::caution[atenção]
Mesmo se você estiver utilizando um IdP, é necessário registrar todos os usuários da conta no Azion Console, pois eles são sincronizados no Console e no IdP. Um usuário inexistente no Consoleß não conseguirá realizar o login. 
:::
