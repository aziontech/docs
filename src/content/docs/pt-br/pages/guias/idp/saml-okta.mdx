...
3. Clique **Create App Integration**.
...
14. Sob **Metadata details**, clique **More details**.
...
16. Sob a seção **SAML Signing Certificates**, localize o certificado ativo ou gere um novo.
...
8. Para conectar o IdP do RTM com o aplicativo personalizado do Okta, clique nos três pontos no canto do cartão do IdP e selecione **Edit**.
...
2. Localize a seção **SAML Settings** e clique **Edit**.
...
- O e-mail configurado no Okta deve ser o mesmo e-mail registrado para o usuário no RTM.
...
A partir de então, todos os usuários da conta, exceto o **Account Owner**, terão acesso ao RTM utilizando o Okta como provedor de identidade.

:::note
Com a aplicação IdP ativada, a verificação MFA para de ser feita pelo RTM e começa a ser autenticada pelo IdP. Se a conta retornar para o SSO do RTM, será utilizada a última configuração ativa de MFA.
:::
