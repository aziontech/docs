...
2. Clique em **+ Create**.
3. Procure por **AI Inference Starter Kit** e selecione-o.
4. Digite um nome para sua aplicação, como `meu-primeiro-agente`.
5. Clique em **Deploy**.
...
Para manter contexto entre mensagens, adicione histórico de conversação:
