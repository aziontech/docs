---
title: Como usar um bucket do Azion Object Storage como origem de uma edge application estática
description: Aprenda como usar um bucket como origem de uma edge application para servir arquivos estáticos.
...
**Object Storage** da Azion permite que você crie buckets e os use como fonte de conteúdo através de [Origins](/pt-br/documentacao/produtos/edge-application/origins/#object-storage). Este guia abrange como criar e servir uma aplicação estática recuperada de um bucket do Object Storage usando a [API da Azion](https://api.azion.com) e o [Real-Time Manager](https://manager.azion.com).

<Button href="/pt-br/documentacao/produtos/store/object-storage/" text="ir para a referência de Object Storage" variant="secondary" />

:::note
Você também pode usar o método `async storage.get(key)` da [Runtime API](/pt-br/documentacao/devtools/runtime/api-reference/storage/#async-storagegetkey) para servir a aplicação usando uma **Edge Function**.
:::

Consulte os guias [Como criar e modificar um bucket do Azion Object Storage](/pt-br/documentacao/produtos/guias/criar-e-modificar-um-bucket/) para operações de bucket e [Como fazer o upload e download de objetos de um bucket do Azion Object Storage](/pt-br/documentacao/produtos/guias/upload-e-download-de-objetos-do-bucket/) para operações de objetos.
...
## Criando uma edge application e definindo a origem tipo Object Storage
...
1. [Acesse o RTM](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/) > **Edge Application**.
...
<AuthorList filePath="src/content/docs/pt-br/pages/guias/object-storage/use-bucket-as-origin/index.mdx"/>
