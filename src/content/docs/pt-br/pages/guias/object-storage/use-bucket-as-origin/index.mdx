...
**Azion Object Storage** permite que você crie buckets e os use como fonte de conteúdo através de [Origins](/pt-br/documentacao/produtos/build/edge-application/origins/#object-storage). Este guia abrange como criar e servir uma aplicação estática retirada de um bucket do Object Storage usando a [API da Azion](https://api.azion.com) e o [Real-Time Manager](https://manager.azion.com).
