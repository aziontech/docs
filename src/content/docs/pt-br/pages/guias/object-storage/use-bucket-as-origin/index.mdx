---
title: Como usar um bucket do Azion Edge Storage como origem de uma edge application estática
description: Aprenda como usar um bucket como origem de uma edge application para servir arquivos estáticos.
meta_tags: object storage, storage, cloud, s3, bucket, objetos, arquivos, armazenamento, file storage, origin, origem, edge storage
...
**Edge Storage** da Azion permite que você crie buckets e os use como fonte de conteúdo através de [Origins](/pt-br/documentacao/produtos/edge-application/origins/#edge-storage). Este guia abrange como criar e servir uma aplicação estática recuperada de um bucket do Edge Storage usando a [API da Azion](https://api.azion.com) e o [Real-Time Manager](https://manager.azion.com).

<Button href="/pt-br/documentacao/produtos/store/object-storage/" text="saiba mais sobre Edge Storage" variant="secondary" />
...
Consulte os guias [Como criar e modificar um bucket do Azion Edge Storage](/pt-br/documentacao/produtos/guias/criar-e-modificar-um-bucket/) para operações de bucket e [Como fazer o upload e download de objetos de um bucket do Azion Edge Storage](/pt-br/documentacao/produtos/guias/upload-e-download-de-objetos-do-bucket/) para operações de objetos.
