...
**Azion Object Storage** permite que você crie buckets e integre seu armazenamento de objetos com sua infraestrutura do edge. Este guia abrange como fazer upload e download de objetos de um bucket usando a [API da Azion](https://api.azion.com) e [Edge Runtime](/pt-br/documentation/devtools/runtime/overview/).
...
:::note
Consulte a referência [Object Storage API](/en/documentation/devtools/runtime/api-reference/storage/) para mais detalhes sobre as funções disponíveis para outros tipos de requisições.
:::
