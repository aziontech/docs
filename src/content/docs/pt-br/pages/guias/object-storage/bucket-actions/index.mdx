...
permalink: /documentacao/produtos/guias/como-fazer-upload-e-download-de-objetos-do-bucket/
---
...
Leia [Como criar e modificar um bucket de Object Storage da Azion](/pt-br/documentacao/produtos/guias/como-criar-e-modificar-um-bucket/) para operações em buckets.
