...
description: Aprenda como criar, alterar, ou deletar buckets do Object Storage usando a API da Azion.
...
**Object Storage** permite que você crie buckets e integre seu armazenamento de objetos com sua infraestrutura no edge. Este guia abrange como criar, alterar e remover um bucket de armazenamento usando a [API da Azion](https://api.azion.com).

<Button href="/pt-br/documentacao/produtos/store/object-storage/" text="saiba mais sobre Object Storage" variant="secondary"></Button>

Consulte o guia [Como fazer upload e download de objetos de um bucket](/pt-br/documentacao/produtos/guias/upload-e-download-de-objetos-de-bucket/) para realizar operações com objetos.
...
Agora, você pode utilizar o bucket para fazer o upload e download de objetos](/pt-br/documentacao/produtos/guias/upload-e-download-de-objetos-de-bucket/).
