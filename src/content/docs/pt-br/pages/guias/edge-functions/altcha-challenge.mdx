...
Você pode usar a Edge Function ALTCHA de forma independente, apenas com o Edge Firewall e proteger áreas específicas da sua aplicação por meio do desafio. 

Para finalizar, você deve configurar o [Rules Engine](/pt-br/documentacao/produtos/secure/edge-firewall/rules-engine/) para definir o comportamento e os critérios para executar o ALTCHA. Para isso:
