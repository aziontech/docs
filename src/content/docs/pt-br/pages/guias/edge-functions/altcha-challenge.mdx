...
Você pode usar a Edge Function ALTCHA de forma independente, apenas com o Edge Firewall e proteger áreas específicas da sua aplicação por meio do desafio. Para isso, siga os próximos passos:
