...
<DocButton href="/pt-br/documentacao/produtos/build/applications/functions-instances/" label="Saiba mais sobre Functions para Applications" kind="secondary" size="medium" />
