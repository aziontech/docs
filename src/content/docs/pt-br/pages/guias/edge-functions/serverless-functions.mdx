...
description: >-
  O Edge Functions é um serviço da Azion Web Platform que permite que
...
[Edge Functions](/pt-br/documentacao/produtos/build/edge-application/edge-functions/) é um módulo da Azion Web Platform que permite que você programe e execute funções serverless, sem o uso de servidores.
