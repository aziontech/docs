...
<LinkButton link="/pt-br/documentacao/produtos/build/applications/functions-instances/" label="Saiba mais sobre Functions para Applications" severity="secondary" />
