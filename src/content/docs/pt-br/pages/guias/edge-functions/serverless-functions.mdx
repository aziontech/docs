---
title: Como executar funções serverless no Azion Console
...
<LinkButton outlined link="/pt-br/documentacao/produtos/build/edge-application/edge-functions-instances/" label="Saiba mais sobre Edge Functions para Edge Application" />
