...
<Button href="/pt-br/documentacao/produtos/build/edge-application/edge-functions-instances/" label="Saiba mais sobre Functions para Applications" type="primary" theme="light" />
