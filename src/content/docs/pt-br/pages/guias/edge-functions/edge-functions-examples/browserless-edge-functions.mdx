---
title: Como construir uma aplicação browserless com Functions
description: >-
  Aprenda como implementar uma aplicação browserless usando Azion Functions para criar soluções web eficientes, seguras e escaláveis no edge.
meta_tags: 'functions, browserless, web scraping, automação, azion'
...
- Conhecimento básico de JavaScript e Functions

## Código

Este é um exemplo de código de como usar o Browserless com Functions da Azion para tirar uma screenshot. O exemplo completo de código pode ser encontrado neste [repositório do GitHub](https://github.com/egermano/edge-functions-examples/tree/main/packages/browserless).
...
A Function browserless tipicamente inclui:
...
4. **Limitações de memória**: Garanta que suas operações permaneçam dentro dos limites de memória das Functions
...
- **Erros de runtime**: Revise os logs da Function no Console Azion
- **Problemas de performance**: Otimize suas operações browserless para execução no edge
- **Limitações de memória**: Certifique-se de que suas operações permaneçam dentro dos limites de memória das Functions
...
<DocButton href="/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/criar-uma-aplicacao/" label="Construa uma aplicação" size="medium" />
