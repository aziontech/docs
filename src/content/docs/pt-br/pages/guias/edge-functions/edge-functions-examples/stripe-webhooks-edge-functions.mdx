...
<DocSteps>
  <DocStep title="Faça uma requisição à rota de status">
  ...
  <DocStep title="Envie dois eventos nomeados no switch">
  ...
  <DocStep title="Envie um evento que o switch não nomeia">
  ...
  <DocStep title="Leia o que o handler registrou no log">
