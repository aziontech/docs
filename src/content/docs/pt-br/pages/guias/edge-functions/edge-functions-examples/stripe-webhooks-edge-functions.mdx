---
title: Como lidar com webhooks do Stripe com Functions
description: >-
  Aprenda como lidar com webhooks do Stripe de forma segura usando Azion Functions para processar eventos de pagamento em tempo real com performance e confiabilidade otimizadas.
meta_tags: 'functions, webhooks stripe, pagamentos, verificação de webhook, integração stripe'
...
Este guia demonstra como lidar com webhooks do Stripe de forma segura usando Azion Functions. Você aprenderá a processar eventos de pagamento em tempo real, verificar assinaturas de webhook e construir um sistema robusto de processamento de pagamentos no edge.

:::tip
Esta demonstração mostra como aproveitar Functions para processamento seguro de webhooks mantendo conformidade PCI e performance otimizada no edge.
:::
...
Esse é um exemplo de código de como usar webhooks do Stripe com Azion Functions. O exemplo completo do código você pode encontrar nesse [repositório do GitHub](https://github.com/egermano/edge-functions-examples/tree/main/packages/stripe-webhooks).
...
### Passo 4: Faça o deploy da Function
...
3. Verifique logs da Function para confirmação de processamento
...
<DocButton href="https://stripe.com/docs/webhooks" label="Documentação de Webhooks do Stripe" size="medium" />
