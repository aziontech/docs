...
- [Azion CLI](/pt-br/documentacao/devtools/cli/) instalada e configurada
...
Para mais detalhes, veja a [documentação do SQL Database](https://www.azion.com/pt-br/documentacao/#edge-sql).
...
<DocButton href="/pt-br/documentacao/store/sql-database/" label="Saiba mais sobre SQL Database" size="medium" />
