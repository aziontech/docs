...
<Button href="/pt-br/documentacao/produtos/store/edge-sql/" type="primary" theme="light" />
<Button href="/pt-br/documentacao/produtos/build/edge-application/edge-functions/" type="primary" theme="light" />
