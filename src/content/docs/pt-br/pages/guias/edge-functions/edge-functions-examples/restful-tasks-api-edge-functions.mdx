...
<LinkButton link="/pt-br/documentacao/produtos/store/sql-database/" text="Saiba mais sobre SQL Database" />
<LinkButton link="/pt-br/documentacao/produtos/build/applications/functions/" text="Saiba mais sobre Functions" />
