...
Envie uma requisição `POST` para o endpoint de query, substituindo `<your-database-id>` pelo `id` do seu banco de dados:
...
Insira três linhas, para que os endpoints tenham dados a retornar:
