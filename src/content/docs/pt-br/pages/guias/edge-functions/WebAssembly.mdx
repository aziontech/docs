---
title: Como criar uma edge function usando WebAssembly na Azion Web Platform
description: >-
  Saiba mais sobre o processo necessário para a criação de uma edge function que
