...
1. No [Real-Time Manager RTM](https://console.azion.com/), no canto superior esquerdo, selecione **Edge Functions** dentro da seção **Edge Libraries**.
...
1. No [Real-Time Manager RTM](https://console.azion.com/), no canto superior esquerdo, selecione **Edge Firewall** na seção **Secure**.
