...
1. No [Azion Console](https://console.azion.com/), no canto superior esquerdo, selecione **Edge Functions** dentro da seção **Edge Libraries**.
...
### Criando um edge firewall

1. No [Azion Console](https://console.azion.com/), no canto superior esquerdo, selecione **Edge Firewall** na seção **Secure**.
