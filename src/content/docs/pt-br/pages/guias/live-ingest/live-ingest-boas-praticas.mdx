...
permalink: /documentacao/guias/performance-e-confiabilidade/otimizacao-de-entrega/live-ingest-boas-praticas/
...
- Conhecimento básico sobre [Applications](/pt-br/documentacao/plataforma/applications/) e [Cache Settings](/pt-br/documentacao/build/cache/cache-settings/).
- Familiaridade com o [Rules Engine](/pt-br/documentacao/plataforma/applications/rules-engine/) para Applications.
...
Consulte a documentação sobre [como consultar dados de usuários conectados com GraphQL API](/pt-br/documentacao/guias/plataforma/observabilidade/query-dados-connected-users-com-graphql/) para implementar dashboards de monitoramento personalizados.
...
Consulte o guia [Implementar cache HLS](/pt-br/documentacao/guias/performance-e-confiabilidade/cache-e-purge/implementar-cache-hls/) para instruções detalhadas.
...
- [Live Streaming Delivery com HLS](/pt-br/documentacao/guias/performance-e-confiabilidade/otimizacao-de-entrega/live-streaming-delivery-com-hls/)
- [Implementar cache HLS](/pt-br/documentacao/guias/performance-e-confiabilidade/cache-e-purge/implementar-cache-hls/)
...
- [Real-Time Metrics](/pt-br/documentacao/plataforma/real-time-metrics/)
- [Consultar dados de usuários conectados com GraphQL API](/pt-br/documentacao/guias/plataforma/observabilidade/query-dados-connected-users-com-graphql/)