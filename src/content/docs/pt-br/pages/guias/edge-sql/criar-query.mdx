...
description: Aprenda como criar e listar tabelas e adicionar dados em bancos de dados Edge SQL usando a API REST da Azion.
...
<Button href="/pt-br/documentacao/produtos/store/edge-sql/" text="saiba mais sobre o Edge SQL" variant="secondary"></Button>
