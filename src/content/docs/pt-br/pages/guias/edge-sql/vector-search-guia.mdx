...
<DocButton href="/pt-br/documentacao/store/sql-database/vector-search/" label="Saiba mais sobre o Vector Search" kind="secondary" target="_blank" size="medium" />
...
- Gere um [personal token da Azion](/pt-br/documentacao/guias/plataforma/conta-e-billing/personal-tokens/).
- Gere uma [OpenAI API Key](https://platform.openai.com/docs/quickstart/create-and-export-an-api-key).
- Instale a [Azion CLI](/pt-br/documentacao/devtools/cli/).
...
- Configure o [SQL Database](/pt-br/documentacao/store/sql-database/).
