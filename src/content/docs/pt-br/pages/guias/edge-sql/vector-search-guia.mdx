...
<DocButton href="/pt-br/documentacao/produtos/store/sql-database/vector-search/" label="Saiba mais sobre o Vector Search" kind="secondary" target="_blank" size="medium" />
