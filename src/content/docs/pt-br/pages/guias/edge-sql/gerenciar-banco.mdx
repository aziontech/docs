...
description: Aprenda como criar, listar e excluir bancos de dados do Edge SQL usando a API REST da Azion.
...
O **Edge SQL** permite que você crie bancos de dados para inserir dados. Este guia cobre como criar, listar e excluir um banco de dados usando a [API da Azion](https://api.azion.com).

<Button href="/pt-bt/documentacao/produtos/store/edge-sql/" text="saiba mais sobre o Edge SQL" variant="secondary"></Button>
...
:::note
Esta ação é definitiva. Após deletar um banco de dados, você não poderá recuperar as informações dele.
:::
