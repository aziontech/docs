...
<LinkButton link="/pt-br/documentacao/produtos/build/applications/functions-instances/" label="ir para como instanciar functions na sua aplicação"  severity="secondary" />
