...
<LinkButton link="/pt-br/documentacao/produtos/build/edge-application/edge-functions-instances/" label="ir para como instanciar edge functions na sua aplicação"  outlined />
