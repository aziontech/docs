...
<LinkButton link="/pt-br/documentation/products/guides/build/instantiate-edge-functions/" text="ir para como instanciar edge functions na sua aplicação" outlined />
