---
title: Como recuperar dados de um banco de dados com o Edge SQL e as Functions
description: >-
...
Veja como recuperar dados de um banco de dados existente com o **Edge SQL** e as **Functions**.
...
- [O móduto  de Functions habilitado](/pt-br/documentacao/produtos/build/edge-application/edge-functions/).
...
Esta function foi criada para se comunicar com o Edge SQL. Agora, é necessário instanciar esta função em uma edge application em execução:

<LinkButton link="/pt-br/documentacao/produtos/build/edge-application/edge-functions-instances/" label="ir para como instanciar functions na sua aplicação"  severity="secondary" />
