...
<Button href="/pt-br/documentacao/produtos/build/edge-application/edge-functions-instances/" label="ir para como instanciar functions na sua aplicação" type="primary" theme="light" />
