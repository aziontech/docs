...
description: Veja como recuperar dados de um banco de dados (DB) existente com o Edge SQL e as Edge Functions.
...
permalink: /documentacao/produtos/guides/edge-sql/retrieve-data-with-edge-functions/
---
...
<Button href="/pt-br/documentation/products/guides/build/instantiate-edge-functions/" text="ir para como instanciar edge functions na sua aplicação" variant="secondary">
</Button>
