...
> Consulte a documentação sobre [Bypass Cache](/pt-br/documentacao/produtos/edge-application/rules-engine/#bypass-cache) para saber mais sobre a diferença entre esse comportamento e TTL zero.
