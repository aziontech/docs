...
permalink: /documentacao/guias/plataforma/migracao/fastly-guia-migracao/
---
...
| :------------------------ | :---------- | :---------------- |
| **Full-Site Delivery** | Entrega de sites, aplicações, APIs e tráfego mobile por meio de serviços Fastly. | [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) |
| **Serviços Fastly** | Principal recurso de entrega para domínios, origens, caching, tratamento de requisições e versões de serviço. | [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) + [Workloads](https://www.azion.com/pt-br/documentacao/plataforma/workloads/) |
| **Domains** | Hostnames associados a serviços Fastly. | [Workloads](https://www.azion.com/pt-br/documentacao/plataforma/workloads/) |
| **Hosts e origens** | Configuração de backend origin para serviços de entrega Fastly. | [Connectors](https://www.azion.com/pt-br/documentacao/plataforma/connectors/) |
| **Origin Shield / padrões de shielding** | Reduz tráfego na origem roteando cache misses por uma localização intermediária de shield. | [Origin Shield](https://www.azion.com/pt-br/documentacao/secure/origin-shield/) + [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/cache/tiered-cache/) |
| **Conditions** | Condições de request, cache e response na configuração de serviço Fastly. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/rules-engine/) |
| **Request settings** | Manipulação, encaminhamento e tratamento de requisições. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/rules-engine/) + [Functions](https://www.azion.com/pt-br/documentacao/build/functions/) |
| **Response settings** | Comportamento de headers de resposta e entrega. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/rules-engine/) |
...
| **Compute** | Plataforma de compute serverless que executa código customizado na rede da Fastly. | [Functions para Applications](https://www.azion.com/pt-br/documentacao/build/functions/) |
| **Compute packages** | Código de aplicação empacotado e publicado no Fastly Compute. | [Functions](https://www.azion.com/pt-br/documentacao/build/functions/) + [Azion CLI](https://www.azion.com/pt-br/documentacao/devtools/cli/) |
| **Edge Data Storage** | Dados key-value usados por serviços Fastly Compute. | [KV Store](https://www.azion.com/pt-br/documentacao/store/kv-store/) |
| **Object Storage** | Object storage compatível com S3 integrado a serviços de entrega e compute. | [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/) |
| **Cache Reservation** | Capacidade reservada de cache para conteúdo na Fastly. | [Cache](https://www.azion.com/pt-br/documentacao/build/cache/) + [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/cache/tiered-cache/) |
| **Cache APIs** | Padrões de interação programática com cache para aplicações Compute. | [Functions](https://www.azion.com/pt-br/documentacao/build/functions/) + [Cache](https://www.azion.com/pt-br/documentacao/build/cache/) + [Real-Time Purge](https://www.azion.com/pt-br/documentacao/build/cache/real-time-purge/) |
| **Streaming Delivery** | Entrega de conteúdo de live streaming e video-on-demand. | [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) + [Cache](https://www.azion.com/pt-br/documentacao/build/cache/) + [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/) |
| **Media Shield for Live** | Reduz tráfego na origem em fluxos de vídeo ao vivo. | [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/cache/tiered-cache/) + [Origin Shield](https://www.azion.com/pt-br/documentacao/secure/origin-shield/) |
| **Media Shield for VOD** | Reduz tráfego na origem em fluxos de video-on-demand. | [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/cache/tiered-cache/) + [Origin Shield](https://www.azion.com/pt-br/documentacao/secure/origin-shield/) |
| **Image Optimizer** | Serviço de transformação e otimização de imagens em tempo real. | [Image Processor](https://www.azion.com/pt-br/documentacao/build/image-processor/) |
| **WebSockets** | Comunicação bidirecional e persistente para aplicações em tempo real. | [WebSocket Proxy](https://www.azion.com/pt-br/documentacao/plataforma/applications/websocket/) + [WebSocket API](https://www.azion.com/pt-br/documentacao/devtools/runtime/api-reference/websocket/) |
| **Fanout** | Padrões de mensagem publish-subscribe na Fastly. | [Functions](https://www.azion.com/pt-br/documentacao/build/functions/) + [WebSocket Proxy](https://www.azion.com/pt-br/documentacao/plataforma/applications/websocket/) |
| **AI Accelerator** | Cache semântico e aceleração de tráfego para APIs de IA generativa. | [AI Inference](https://www.azion.com/pt-br/documentacao/build/ai-inference/) + [Cache](https://www.azion.com/pt-br/documentacao/build/cache/) |
| **Fastly Next-Gen WAF** | Web application firewall para detectar tráfego suspeito e proteger aplicações. | [Web Application Firewall](https://www.azion.com/pt-br/documentacao/secure/waf/) |
| **Edge Rate Limiting** | Conta requisições e aplica ações quando limites são excedidos. | [Rules Engine para Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/rules-engine/) + [Functions para Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/functions/) |
| **Fastly DDoS Protection** | Visibilidade e mitigação de DDoS. | [DDoS Protection](https://www.azion.com/pt-br/documentacao/plataforma/ddos-protection/) + [Network Shield](https://www.azion.com/pt-br/documentacao/secure/network-shield/) |
| **Bot Management** | Detecta e responde a tráfego automatizado. | [Bot Manager](https://www.azion.com/pt-br/documentacao/secure/bot-manager/) + [Bot Manager Lite](https://www.azion.com/pt-br/documentacao/secure/bot-manager/bot-manager-lite/) |
| **Certainly** | Autoridade certificadora da Fastly para certificados TLS. | [Certificate Manager](https://www.azion.com/pt-br/documentacao/plataforma/certificate-manager/para-firewall/) |
| **Platform TLS** | Gerenciamento de certificados TLS e chaves via API. | [Certificate Manager](https://www.azion.com/pt-br/documentacao/plataforma/certificate-manager/para-firewall/) + [Azion API](https://www.azion.com/pt-br/documentacao/devtools/api/) |
| **TLS Service Options** | Configuração TLS para servir sites e aplicações por HTTPS. | [Certificate Manager](https://www.azion.com/pt-br/documentacao/plataforma/certificate-manager/para-firewall/) + [Workloads](https://www.azion.com/pt-br/documentacao/plataforma/workloads/) |
| **High Volume Logging** | Streaming de logs em tempo real para destinos externos. | [Data Stream](https://www.azion.com/pt-br/documentacao/observe/data-stream/) |
| **Log Explorer & Insights** | Inspeciona e monitora dados de log na plataforma Fastly. | [Real-Time Events](https://www.azion.com/pt-br/documentacao/observe/real-time-events/) |
| **Domain Inspector** | Visibilidade e relatórios de tráfego em nível de domínio. | [Real-Time Metrics](https://www.azion.com/pt-br/documentacao/plataforma/real-time-metrics/) |
| **Origin Inspector** | Visibilidade e relatórios de respostas da origem. | [Real-Time Metrics](https://www.azion.com/pt-br/documentacao/plataforma/real-time-metrics/) + [Real-Time Events](https://www.azion.com/pt-br/documentacao/observe/real-time-events/) |
...
| **Fastly API** | Gerenciamento programático de recursos Fastly. | [Azion API](https://www.azion.com/pt-br/documentacao/devtools/api/) |
| **Fastly CLI** | Fluxo de linha de comando para serviços Fastly e projetos Compute. | [Azion CLI](https://www.azion.com/pt-br/documentacao/devtools/cli/) |
| **Fastly Terraform Provider** | Infrastructure as Code para recursos Fastly. | [Terraform Provider](https://www.azion.com/pt-br/documentacao/devtools/terraform/) |
...
* [WebSocket Proxy](https://www.azion.com/pt-br/documentacao/plataforma/applications/websocket/)
* [WebSocket API](https://www.azion.com/pt-br/documentacao/devtools/runtime/api-reference/websocket/)
* [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/cache/tiered-cache/)
* [Origin Shield](https://www.azion.com/pt-br/documentacao/secure/origin-shield/)
...
* [Modelos AI Inference](https://www.azion.com/en/documentation/build/ai-inference/models/)
* [Functions](https://www.azion.com/pt-br/documentacao/build/functions/)
* [Cache](https://www.azion.com/pt-br/documentacao/build/cache/)
...
* [KV Store](https://www.azion.com/pt-br/documentacao/store/kv-store/)
* [Gerencie KV Store com Functions](https://www.azion.com/en/documentation/guides/application-development/data/manage-with-functions/)
...
* [Analisar métricas](https://www.azion.com/pt-br/documentacao/guias/plataforma/observabilidade/analisar-metricas/)
* [Dashboards customizados com plugin Grafana](https://www.azion.com/pt-br/documentacao/guias/plataforma/observabilidade/azion-plugin-grafana/)
...
* [Como configurar sampling no Data Stream](https://www.azion.com/pt-br/documentacao/guias/plataforma/observabilidade/configurar-sampling/)
...
* Revise [Real-Time Metrics](https://www.azion.com/pt-br/documentacao/plataforma/real-time-metrics/) para monitorar performance da aplicação.
