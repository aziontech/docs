...
Verificar o código para fazer debug de edge functions através do [Data Stream](/pt-br/documentacao/produtos/data-stream/) é importante para identificar se os erros continuam ocorrendo ou se o processo de debugging foi bem sucedido.
...
9.  Na seção **Destination**, selecione um **Endpoint Type** na lista suspensa. Veja mais sobre [configurar um endpoint](/pt-br/documentacao/produtos/data-stream/#endpoints).
