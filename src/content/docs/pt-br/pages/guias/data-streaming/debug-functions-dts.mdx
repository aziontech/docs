...
1. Em **Workloads** > **Options**, selecione **All Current and Future Workloads** ou **Filter Workloads**. Veja mais sobre cada opção em [Como associar workloads no Data Stream](/pt-br/documentacao/guias/plataforma/observabilidade/data-stream-associar-workloads/).
2. Na seção **Destination**, selecione um **Connector** na lista suspensa. Veja mais sobre [configurar um endpoint](/pt-br/documentacao/observe/data-stream/#endpoints).
