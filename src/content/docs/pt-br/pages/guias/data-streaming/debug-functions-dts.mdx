...
description: >-
  Verificar o código para fazer debug de edge functions através do Data Stream é
...
8. Em **Options**, selecione **Filter workloads** ou **All workloads**. Veja mais sobre cada opção em [Como associar domínios no Data Stream](/pt-br/documentacao/produtos/guias/data-stream-associar-dominios/).
