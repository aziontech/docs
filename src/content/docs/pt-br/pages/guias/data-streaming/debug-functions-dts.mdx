...
Verificar o código para fazer debug de functions através do [Data Stream](/pt-br/documentacao/produtos/observe/data-stream/) é importante para identificar se os erros continuam ocorrendo ou se o processo de debugging foi bem sucedido.
