...
6. Na lista suspensa **Template**, selecione qual você deseja usar. Veja mais sobre as opções em [selecionar o Data Source](/pt-br/documentacao/produtos/observe/data-stream/#templates).
