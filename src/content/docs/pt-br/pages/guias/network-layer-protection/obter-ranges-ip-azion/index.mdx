...
permalink: /documentacao/guias/seguranca-de-aplicacoes/bots-e-rede/obter-ranges-ip-azion/
---
...
- O [módulo Network Shield](/pt-br/documentacao/secure/network-shield/) ativado no seu Firewall.
...
Execute a seguinte requisição, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/guias/plataforma/conta-e-billing/personal-tokens/):
...
<DocButton href="/pt-br/documentacao/secure/network-shield/" label="Proteja sua infraestrutura" kind="secondary" size="medium" />
<DocButton href="/pt-br/documentacao/secure/origin-shield/" label="Referência do Origin Shield" kind="secondary" size="medium" />
<DocButton href="/pt-br/documentacao/secure/network-shield/" label="Referência do Network Shield" kind="secondary" size="medium" />
