...
> Saiba mais sobre [Network Lists](/pt-br/documentacao/produtos/edge-firewall/network-layer-protection/network-lists), [Network Layer Protection](/pt-br/documentacao/produtos/secure/edge-firewall/network-layer-protection/), [módulos do Edge Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/) e o [Rules Engine para Edge Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/rules-engine/).
...
3. Escreva o nome de identificação no campo **Edge Firewall Name**.
