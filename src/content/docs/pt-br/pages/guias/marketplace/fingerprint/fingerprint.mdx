...
O script do navegador é um código JavaScript que é executado na página da web que você deseja identificar. Ele captura vários dados do navegador web:
...
Você precisa incorporar todo o código no navegador. Para fazer isso, siga os passos:

1. Copie todo o código incluído neste [repositório]().
2. Crie um novo arquivo JavaScript em seu projeto e cole o código do script.
3. Abra o índice principal para sua página da web. Exemplo: `index.html`.
4. Chame o novo arquivo JavaScript para executar o código do script no navegador.
...
Para instalar **Fingerptint** da Azion:
...
3. Uma vez que a página da integração se abre, clique no botão **Get It Now**, no canto inferior direito da página.
