...
Para utilizar a integração A/B testing fornecida pelo **Marketplace**, acesse no [Real-Time Manager (RTM)](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/) e vá para o **Marketplace**.
...
| `prob` | A probabilidade deste endereço ser enviado ao usuário. Note que este valor deve estar entre `0` e `1`, sendo `0` para `0%` de chance e `1` para `100%` de chance |
