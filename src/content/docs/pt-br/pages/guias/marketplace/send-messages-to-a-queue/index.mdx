...
title: Como utilizar a integração Send messages to a queue através do Marketplace da Azion
description: A integração Send messages to a queue da Azion é uma solução integrada de mensageria que reúne os três principais clientes do mercado.
...
## Definir uma regra para o Rules Engine

Agora você tem que configurar as regras que deseja (*criteria* e *behavior*) aplicar a fim de executar sua função.
