---
title: Como criar edge applications com o Preact JavaScript Boilerplate
description: >-
  O Preact Typescript Boilerplate fornece uma solução de automação para criar uma edge application Preact com JavaScript na Azion.
