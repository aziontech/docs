...
A implantação deste template cria um repositório no GitHub contendo seu projeto, bem como uma application com várias configurações de cache e uma rota pré-configurada para lançar a edge function do Videoteca Player, além de um domínio para facilitar seu acesso e gerenciamento através da Azion Web Platform.
