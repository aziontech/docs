---
title: Como criar edge applications com o Next.js Static Boilerplate
description: O Next.js Static Boilerplate fornece uma solução de automação para criar uma edge application Next.js estática na Azion.
meta_tags: templates, guias, Azion Marketplace
namespace: docs_guides_nextjs_static_boilerplate
permalink: /documentacao/produtos/guias/nextjs-static-boilerplate/
---
...
Acesse a documentação do Next.js para obter mais detalhes sobre [static exports](https://nextjs.org/docs/app/building-your-application/deploying/static-exports).
...
Para começar a usar o **Next.js Static Boilerplate**:
...
3. Encontre o card do **Next.js Static Boilerplate** e selecione-o.
...
O script cria um [repositório do GitHub](https://github.com/aziontech/azion-samples/tree/dev/templates/nextjs-boilerplate) para gerenciar o código-fonte e, em seguida, instala todas as dependências necessárias. Além disso, sua aplicação é implantada na plataforma da Azion e ao mesmo tempo define múltiplas configurações, como o setup da edge application e do seu domínio para hospedar seu projeto Next.js e uma edge function para lógica personalizada.
...
Além disso, para garantir o desempenho ideal deste template, é necessário ativar o seguinte módulo:
...
6. Na aba **Main Settings**, encontre a seção **Edge Application Modules** e ative o switch do módulo.
...
4. Você será redirecionado para a página de **Edge Application**.
- Ela lista todas as edge applications que você criou.
5. Encontre a edge application relacionada ao **Next.js Static Boilerplatee** e selecione-a.
