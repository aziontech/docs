...
Esses recursos exigem um servidor Node.js ou uma lógica dinâmica que não pode ser computada durante o processo de compilação e não tem suporte:
