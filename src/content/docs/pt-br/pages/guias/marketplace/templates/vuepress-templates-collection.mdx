...
description: >-
  Este guia contém instruções para criar uma aplicação web usando templates baseados em VuePress.
meta_tags: >-
...
A coleção **VuePress Templates** oferece configurações para construir aplicações web usando templates. Estes templates são todos baseados no framework **VuePress**.
...
- **VuePress Solid**: crie um belo site estático com VuePress. Utiliza a versão `2.0.0` do VuePress.
