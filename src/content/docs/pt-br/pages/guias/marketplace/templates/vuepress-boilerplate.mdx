...
A implantação deste template cria um repositório no GitHub contendo seu projeto, bem como uma aplicação na borda e um domínio para facilitar seu acesso e gerenciamento através da Plataforma de Edge da Azion.
