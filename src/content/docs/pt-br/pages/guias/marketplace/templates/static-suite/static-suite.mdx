...
O template **Suite Static Cache** inclui configurações que otimizam a entrega e o desempenho de conteúdo estático, como JavaScript, CSS e outros arquivos estáticos. Essas configurações usam regras avançadas de advanced cache key que são aplicadas por meio do **Rules Engine para Edge Application**.
