---
title: Como implantar o template Suite Static Cache
...
permalink: /documentacao/produtos/guias/suite-static-cache/
---
...
O template **Suite Static Cache** inclui configurações que otimizam a entrega e o desempenho de conteúdo estático, como JavaScript, CSS e outros arquivos estáticos. Essas configurações usam regras avançadas de advanced cache key que são aplicadas por meio do **Rules Engine for Edge Application**.
...
Isso abrirá uma nova página onde você pode selecionar o card do **Suite Static Cache**.
...
- **Browser Static Maximum TTL** *: o máximo TTL (time-to-live), em segundos, para conteúdo armazenado em cache no navegador.
