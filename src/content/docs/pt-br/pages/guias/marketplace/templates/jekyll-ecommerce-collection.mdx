...
meta_tags: >-
  Jekyll, e-commerce, templates, guides, Azion Marketplace, deployment, online store
namespace: docs_guides_jekyll_ecommerce_templates_collection
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/jekyll-ecommerce-collection/
---
...
A coleção de **Templates de E-commerce Jekyll** oferece configurações para criar aplicações de e-commerce usando templates. Esses templates são todos baseados no framework **Jekyll**.

Os templates disponíveis são:

- **Jekyll Cart**: implante um carrinho de compras baseado em Jekyll construído com simpleCart(js). Ele usa a versão `0.1.0` do Jekyll Cart.
- **Supply**: construa um e-commerce usando Supply, um tema Jekyll com integração do Gumroad. Ele usa a versão `1.1.1` do Supply.
...
<DocButton
    label="Implantar Jekyll Cart"
    href="https://console.azion.com/create/azion-community/jekyll-cart"
    icon="ai ai-azion"
    size="medium"
/>
<DocButton
    label="Implantar Supply"
    href="https://console.azion.com/create/azion-community/jekyll-supply"
    icon="ai ai-azion"
    size="medium"
/>
