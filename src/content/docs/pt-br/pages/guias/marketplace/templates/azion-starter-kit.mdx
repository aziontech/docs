...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/azion-starter-kit/
---
...
- A criação de um novo firewall com regras para executar uma instância de function para o Bot Manager Lite e negar requisições da network list pré-construída Azion IP Tor Exit Nodes.
...
- Habilitar os módulos de **Functions**, **Application Accelerator**, **Image Processor** e **Network Shield** em sua conta.
- Instalar a versão mais recente do **Bot Manager Lite**.
    - Acesse o [Marketplace da Azion](https://console.azion.com/marketplace) para instalar a integração. Consulte o guia [Como instalar o Azion Bot Manager Lite](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/integracoes/bot-manager-lite/) para mais detalhes.
...
- O template usa [Application Accelerator](/pt-br/documentacao/build/application-accelerator/), [Functions](/pt-br/documentacao/build/functions/), [Image Processor](/pt-br/documentacao/build/image-processor/) e [Network Shield](/pt-br/documentacao/secure/network-shield/). Isso pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/fundamentos/precos/) para mais informações.
...
- **Custom Host Header**: em alguns casos, pode ser necessário substituir o valor do cabeçalho `Host` na requisição para a origem. Defina um valor para o cabeçalho `Host` neste campo.
    - Use a variável `${host}` para retirar o valor do cabeçalho `Host` da URI da requisição. Saiba mais sobre o Host Header e como customizá-lo no [documentação de Origins](/pt-br/documentacao/plataforma/connectors/origins/#host-header).
...
- **Behavior**: then [Set Origin](/pt-br/documentacao/plataforma/applications/rules-engine/#set-origin) as `Default Origin`.
...
Além disso, o firewall aprimora a segurança por meio da network list [IP Tor Exit Nodes da Azion](/pt-br/documentacao/guias/seguranca-de-aplicacoes/bots-e-rede/bloquear-redes-tor/) e do [Bot Manager Lite da Azion](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/integracoes/bot-manager-lite/).
...
Os logs podem ser consultados no [Real-Time Events](/pt-br/documentacao/observe/real-time-events/). Ao analisar os logs gerados pelo Bot Manager Lite, você pode obter insights para entender se são necessárias quaisquer alterações nos argumentos JSON da instância da função. Você também pode usar o [Data Stream da Azion](/pt-br/documentacao/observe/data-stream/) como uma ferramenta de observabilidade. Leia mais sobre [Como observar logs e calibrar regras](/pt-br/documentacao/guias/seguranca-de-aplicacoes/bots-e-rede/gerenciar-bots/#usar-real-time-events-para-observar-e-calibrar-regras).
...
:::tip
Consulte a documentação sobre o [gerenciamento de applications](/pt-br/documentacao/plataforma/applications/primeiros-passos/) para obter mais detalhes.
:::
