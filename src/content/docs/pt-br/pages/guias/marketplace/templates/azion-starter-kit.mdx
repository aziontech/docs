...
Para fazer isso, abra seu novo repositório **Azion Starter Kit** no GitHub. Em seguida, vá para **Settings** > **Secrets and variables** > **Action** para [adicionar suas variáveis](https://docs.github.com/en/actions/security-guides/encrypted-secrets) seguindo estas instruções:
