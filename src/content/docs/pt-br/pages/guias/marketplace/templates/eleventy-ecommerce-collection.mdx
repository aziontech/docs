...
O processo de implantação para cada um desses templates cria um repositório do GitHub para seu projeto, junto com uma edge application e um domínio. Essa configuração permite o acesso e gerenciamento fáceis de sua aplicação de e-commerce através da Azion Web Platform.
