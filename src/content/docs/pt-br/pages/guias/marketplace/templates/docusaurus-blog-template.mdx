---
title: Como implantar o template Docusaurus Blog
...
permalink: /documentacao/produtos/guias/docusaurus-blog-template/
---
...
O template **Docusaurus Blog** simplifica a criação e gestão de uma página de blog com suporte a Markdown e MDX, facilitando a escrita de conteúdo com mídia rica e componentes React.
...
Para começar a usar o template **Docusaurus Blog*:
...
4. Navegue e selecione o card do **Docusaurus Blog**.
