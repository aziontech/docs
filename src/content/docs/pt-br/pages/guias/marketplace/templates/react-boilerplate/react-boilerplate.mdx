...
O **React Boilerplate** da Azion ajuda você a criar uma **edge application React** e executá-la diretamente no edge da rede. Ao executar o boilerplate, várias etapas são automatizadas, desde o gerenciamento de repositório até a implantação.
