...
Este template usa o React versão `xxxxxxx`.
...
O script cria um repositório do GitHub para gerenciar o código-fonte e, em seguida, instala todas as dependências necessárias. Além disso, sua aplicação é implantada na plataforma de Edge da Azion e ao mesmo tempo define múltiplas configurações, como o setup da edge application e do seu domínio para hospedar seu projeto React e uma edge function para lógica personalizada.
