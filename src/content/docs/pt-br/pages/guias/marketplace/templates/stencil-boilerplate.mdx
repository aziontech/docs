---
title: Como criar applications com o Stencil Boilerplate
description: >-
  O Stencil Boilerplate fornece uma solução de automação para criar uma edge
  application Stencil na Azion.
meta_tags: Stencil, templates, guides, Azion Marketplace
namespace: docs_guides_stencil_boilerplate
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/stencil-boilerplate/
---
...
Com o **Stencil Boilerplate**, você pode iniciar um projeto usando [Stencil](https://stenciljs.com/docs/introduction) e implantá-lo no edge. **Stencil** é um compilador que gera componentes web e combina os melhores conceitos dos frameworks mais populares em uma ferramenta simples de compilação.
...
Este template utiliza a versão `4.22.2` do Stencil.
