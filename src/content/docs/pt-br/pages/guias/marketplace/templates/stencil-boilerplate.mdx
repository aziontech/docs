...
Com o **Stencil Boilerplate**, você pode iniciar um projeto usando [Stencil](https://stenciljs.com/docs/introduction) e implantá-lo no edge. **Stencil** é um compilador que gera Web Components e combina os melhores conceitos dos frameworks mais populares em uma ferramenta simples de compilação.
