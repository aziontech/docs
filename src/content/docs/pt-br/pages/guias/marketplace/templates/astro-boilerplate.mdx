...
Para começar a usar o **Astro Boilerplate**, acesse o [Real-Time Manager (RTM)](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/) e selecione a opção **Start with a template** na página inicial.
...
Você deve ativar esse módulo separadamente via RTM. Para fazer isso, proceda da seguinte forma:
