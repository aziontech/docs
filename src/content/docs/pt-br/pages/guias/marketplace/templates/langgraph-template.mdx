...
O banco de dados de documentos de referência agora está pronto e disponível para sua aplicação acessá-lo. Leia a [documentação do template](https://github.com/aziontech/azion-samples/tree/3cf53a690ac7f40508bc020adcfc61ba553d0b2f/templates/typescript/azion-react-agent) para obter mais detalhes sobre como configurar o projeto.
