...
Qualquer custo gerado pelo uso da Turso será processado e cobrado separadamente na plataforma da Turso. Visite a [documentação da Turso](https://docs.turso.tech/introduction) para obter mais detalhes.
:::
