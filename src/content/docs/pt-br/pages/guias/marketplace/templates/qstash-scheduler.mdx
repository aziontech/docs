...
:::note
Você também pode publicá-los usando uma request do tipo API REST. Para mais informações, leia a [documentação do QStash](https://upstash.com/docs/qstash/api/publish).
:::
