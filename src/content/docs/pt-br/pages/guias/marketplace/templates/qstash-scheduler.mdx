...
Para obter o template **QStash EdgeFunction Scheduler**, acesse o [Real-Time Manager (RTM)](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/) e selecione a opção **Start with a template** na página inicial.
...
:::tip
Copie e salve o domínio de sua edge application fornecido nesta etapa. Você precisará dele para [agendar suas tarefas](#agendar-tarefas) mais tarde. Se você quiser usar seu próprio domínio, consulte a seção [Adicionar um domínio personalizado](#adicionar-um-dominio-personalizado).
:::
...
Além disso, para garantir o desempenho ideal deste template, deve ativar em sua conta:
...
:::caution[Atenção]
Se o módulo for ativado, a execução deste modelo poderá gerar custos relacionados ao uso. Consulte a [página de preços](https://www.azion.com/pt-br/precos/) para obter mais informações.
