...
Quando implantado, este template cria uma edge function que inclui os argumentos fornecidos pelo usuário. Ele também cria um novo repositório do GitHub que inclui uma automação para permitir o continuous deployment. Além disso, o template cria e instancia uma application e seu domínio para facilitar a interação com a edge function.
