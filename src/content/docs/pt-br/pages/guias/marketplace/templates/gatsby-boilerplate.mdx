---
title: Como criar applications com o Gatsby Boilerplate
description: >-
  Esse template ajuda você a construir uma Single-Page Application (SPA) baseada
  no framework Gatsby e executá-la diretamente no edge da rede.
meta_tags: 'templates, guides, Azion Marketplace'
namespace: docs_guides_gatsby_boilerplate
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/gatsby-boilerplate/
---
...
Este template implanta uma application, um domínio e um repositório GitHub relacionado para facilitar seu acesso e gerenciamento. Ele também contém uma GitHub Action para habilitar um fluxo de trabalho de integração contínua e manter sua aplicação e repositório atualizados.
...
- O template usa [Application Accelerator](/pt-br/documentacao/build/application-accelerator/). Isso pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/fundamentos/precos/) para mais informações.
