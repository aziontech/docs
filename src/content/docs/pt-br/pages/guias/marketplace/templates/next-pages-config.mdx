---
title: Como criar applications com o template Next.js Pages + Configurations
description: 'Esse template [description]'
meta_tags: 'templates, guides, Azion Marketplace'
namespace: docs_guides_next_pages_configurations
permalink: /documentacao/produtos/guias/nextjs-pages-configurations/
---
