---
title: Como criar edge applications com o template Next.js Pages + Configurations
...
Isso abrirá um modal onde você pode selecionar **Templates** > **Next.js Pages + Configurations** card.
...
Para fazer isso, abra seu novo repositório **Next.js Pages + Configurations** no GitHub. Em seguida, vá para **Settings** > **Secrets and variables** > **Action** para [adicionar suas variáveis](https://docs.github.com/en/actions/security-guides/encrypted-secrets) seguindo estas instruções:
