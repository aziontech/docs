...
meta_tags: >-
  templates, guides, Azion Marketplace, e-commerce, Gatsby, web
namespace: docs_guides_gatsby_ecommerce_theme
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/gatsby-ecommerce-theme/
---
...
O template **Gatsby E-commerce Theme** contém as configurações para criar uma aplicação de e-commerce baseada em Gatsby em poucos passos. Ele inclui componentes estilizados e ferramentas para adicionar funcionalidades, simplificando o processo de personalização.
...
Este template usa a versão `5.13.3` do Gatsby.
