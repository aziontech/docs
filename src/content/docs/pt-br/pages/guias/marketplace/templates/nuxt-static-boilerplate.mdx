---
title: Como implantar o Nuxt 3 Static Boilerplate
description: Este template contém as configurações para construir uma aplicação estática com Nuxt 3.
meta_tags: templates, guides, Azion Marketplace, web
namespace: docs_guides_nuxt_static_boilerplate
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/nuxt-static-boilerplate/
---
...
O template **Nuxt 3 Static Boilerplate** contém as configurações para construir rapidamente uma aplicação estática baseada no Nuxt 3.
...
Este template usa a versão `3.13.0` do Nuxt.
