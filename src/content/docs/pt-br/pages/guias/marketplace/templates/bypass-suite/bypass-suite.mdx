...
description: O template inclui configurações que adicionam uma camada de engine rules para ignorar todas as configurações de cache para uma rota específica de URL.
