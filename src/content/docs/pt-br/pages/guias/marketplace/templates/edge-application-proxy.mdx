...
Você deve vincular sua origem ao template para começar a usar este conjunto de regras de cache para entrega. Após o deployment, o script cria uma nova edge application que é executada na Plataforma de Edge da Azion, com a qual você pode gerenciar e ajustar as configurações.
