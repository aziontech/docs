...
Você deve vincular sua origem ao template para começar a usar este conjunto de regras de cache para entrega. Após o deployment, o script cria uma nova aplicação edge que é executada na Plataforma de Edge da Azion, com a qual você pode gerenciar e ajustar as configurações.
...
Para usar este template, acesse o [Azion Console](/pt-br/documentacao/produtos/guias/como-acessar-o-azion-console/) e clique no botão **+ Create** na página inicial.

Isso abrirá um modal onde você pode selecionar **Templates** > **Edge Application Proxy**.
