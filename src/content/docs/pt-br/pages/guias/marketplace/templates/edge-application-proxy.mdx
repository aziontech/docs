...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/edge-application-proxy-template/
---
...
- **Behavior** (comportamento): then [Set Origin](/pt-br/documentacao/plataforma/applications/rules-engine/#set-origin) `Default Origin`, [Bypass Cache](/pt-br/documentacao/plataforma/applications/rules-engine/#bypass-cache) e [Forward Cookies](/pt-br/documentacao/plataforma/applications/rules-engine/#forward-cookies).
...
- **Custom Host Header**: em alguns casos, pode ser necessário adicionar informações do host no cabeçalho da solicitação para recuperar informações da origem. Esta variável é usada para esse propósito.
    - Exemplo: `${host}`. Saiba mais sobre o host header e como customizá-lo no [documentação de Origins](/pt-br/documentacao/plataforma/connectors/origins/#host-header).
...
:::tip
Leia a documentação sobre o [gerenciamento de applications](/pt-br/documentacao/plataforma/applications/primeiros-passos/) e [como configurar políticas de cache para Applications](/pt-br/documentacao/guias/performance-e-confiabilidade/cache-e-purge/cache-settings/#criando-uma-regra-para-ignorar-o-cache-da-origem) para obter mais detalhes.
:::
