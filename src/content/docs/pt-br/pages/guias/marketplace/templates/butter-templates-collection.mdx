...
O processo de deploy para cada um desses templates cria um repositório GitHub para seu projeto, junto com uma edge application e um domínio. Esta configuração permite fácil acesso e gerenciamento da sua aplicação através da Azion Web Platform.
