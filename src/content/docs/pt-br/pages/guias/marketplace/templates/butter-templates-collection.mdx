...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/butter-templates-collection/
---
...
- Estes templates usam [Functions](/pt-br/documentacao/build/functions/), [Application Accelerator](/pt-br/documentacao/build/application-accelerator/), e [Cache](/pt-br/documentacao/build/cache/). Isso pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/fundamentos/precos/) para mais informações.
...
1. Conecte a Azion com sua conta do GitHub.
   - Uma janela pop-up será aberta para confirmar a instalação do [Azion GitHub App](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/automacao/azion-github-app/), uma ferramenta que conecta sua conta do GitHub com a plataforma da Azion.
...
:::tip
Leia a documentação sobre [gerenciamento de application](/pt-br/documentacao/plataforma/applications/primeiros-passos/) para mais detalhes.
:::
...
<DocButton href="/pt-br/documentacao/guias/plataforma/migracao/configurar-dominio/" label="Ir para o guia de configuração de domínio" kind="secondary" size="medium" />
