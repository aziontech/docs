...
description: Este template lhe ajuda criar uma aplicação com regras comuns de cache para melhorar a entrega do seu conteúdo.
...
1. Acesse o [Real-Time Manager (RTM)](/) > **Account menu**.
