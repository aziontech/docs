---
title: Como implantar o template XXXXXX
...
permalink: /documentacao/produtos/guias/XXXXXXXX/
---
...
<Badge>
[Application Acceleration](/pt-br/documentacao/produtos/build/edge-application/application-acceleration/)
</Badge>
<br/>
<Badge>
...
Você precisa habilitar esses módulos via Real-Time Manager (RTM). Para fazer isso:

1. Acesse o [Real-Time Manager (RTM)](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/) > **Account menu**.
...
Para obter o template, acesse o [Real-Time Manager (RTM)](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/) e selecione a opção **Start with a template** na página inicial.

Isso abrirá uma nova página onde você pode selecionar o card do **xxxxx**.
