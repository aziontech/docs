---
title: Como implantar o template Drizzle + Neon Database
...
permalink: /documentacao/produtos/guias/drizzle-neon-database/
---
...
O template **Drizzle + Neon Database** contém as configurações para conectar uma edge function a um banco de dados Neon via Drizzle ORM.
