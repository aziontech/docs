---
title: Como criar edge applications com o Svelte Boilerplate
description: O Svelte Boilerplate acelera a implantação de uma aplicação estática baseada no framework Svelte, diretamente no edge.
meta_tags: templates, guias, Azion Marketplace
namespace: docs_guides_svelte_boilerplate
permalink: /documentacao/produtos/guias/svelte-boilerplate/
---
...
Este template utiliza a versão `4.2.7` do Svelte e a versão `5.0.3` do Vite.
...
Para começar a usar o **Svelte Boilerplate**:
...
4. Navegue e selecione o card do **Svelte Boilerplate**.
...
O template implanta uma edge application, um domínio e um repositório no GitHub para facilitar seu acesso e gerenciamento. O repositório também inclui uma GitHub Action para garantir um fluxo de trabalho de implantação contínua, mantendo seu projeto atualizado.
