---
title: Como criar applications com o Svelte Boilerplate
description: >-
  O Svelte Boilerplate acelera a implantação de uma aplicação estática baseada
  no framework Svelte, diretamente no edge.
...
O template implanta uma application, um domínio e um repositório no GitHub para facilitar seu acesso e gerenciamento. O repositório também inclui uma GitHub Action para garantir um fluxo de trabalho de implantação contínua, mantendo seu projeto atualizado.
