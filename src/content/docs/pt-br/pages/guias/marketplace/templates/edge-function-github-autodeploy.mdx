...
description: >-
  Este template permite implantar edge functions integradas ao GitHub Actions
  diretamente no edge.
...
3. Encontre a application relacionada ao template **Edge Function GitHub AutoDeploy** e selecione-o.
