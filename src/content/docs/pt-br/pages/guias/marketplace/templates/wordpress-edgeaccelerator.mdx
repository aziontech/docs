...
4. Navegue e selecione o card do **WordPress EdgeAccelerator**.
...
<LinkButton link="/pt-br/documentacao/produtos/guias/configurar-dominio/" text="consulte o guia para configurar domínios" outlined /> 
