...
1. Acesse o [Real-Time Manager (RTM)](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/).
...
Adicionalmente, para garantir o desempenho ideal deste template, é necessário ativar:
...
Você precisa ativar os módulos separadamente via RTM. Para fazer isso:
...
4. Na aba **Main Settings**, encontre a seção **Edge Application Modules** e ative o switch dos módulos que você deseja habilitar.

:::caution[Atenção]
Se esses módulos forem ativados, a execução deste template poderá gerar custos relacionados ao uso. Consulte a [página de preços](https://www.azion.com/pt-br/precos/) para obter mais informações.
:::
