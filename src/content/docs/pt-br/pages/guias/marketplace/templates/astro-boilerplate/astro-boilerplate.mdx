...
Para começar a usar o **Astro Boilerplate**, siga estes passos:
...
3. Encontre o card do **Astro Boilerplate** e selecione-o.
...
A aplicação passa por um processo de criação otimizado, enfatizando no melhor desempenho e a eficiência, aproveitando os recursos da **Plataforma de Edge da Azion**.
...
Você deve ativar esse produto separadamente via RTM. Para fazer isso, proceda da seguinte forma:
...
4. Você será redirecionado para a página de **Edge Application**.
- Ela lista todas as edge applications que você criou.
5. Encontre a edge application relacionada ao **Astro Boilerplate** e selecione-a.
