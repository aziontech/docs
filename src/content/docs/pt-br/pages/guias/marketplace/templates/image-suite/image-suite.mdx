---
title: Como implantar o template Suite Image Cache
...
permalink: /documentacao/produtos/guias/suite-image-cache/
---
...
**Suite Image Cache** inclui configurações para aprimorar o carregamento de imagens e o armazenamento em cache com base na extensão do arquivo. Essas configurações utilizam regras avançadas de cache key aplicadas por meio do Rules Engine para Edge Application.
...
Isso abrirá uma nova página onde você pode selecionar o card do **Suite Image Cache**.
...
3. Na seção de **BUILD**, selecione **Edge Application**.
- Você será redirecionado para a página de **Edge Application**. Ela lista todas as edge applications que você criou.
4. Encontre a aplicação relacionada ao **Image Suite** e selecione-a.
