...
- **CDN Static Maximum TTL** *: o máximo TTL (time-to-live), em segundos, para o conteúdo em cache ser entregue.
    - Aceita valores entre `0` e `31536000`. Valor padrão: `31536000`
- **Browser Image Maximum TTL** *: o máximo TTL (time-to-live), em segundos, para conteúdo armazenado em cache no navegador.
