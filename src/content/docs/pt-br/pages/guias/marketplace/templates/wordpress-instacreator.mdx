...
Este template emprega a infraestrutura do **WordPress** e da **Amazon Web Services (AWS)** para implementar o novo um novo projeto WordPress aprimorado pela plataforma de  edge da Azion.
