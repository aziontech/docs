...
Este template emprega a infraestrutura do **WordPress** e da **Amazon Web Services (AWS)** para implementar um novo projeto WordPress aprimorado pela plataforma de edge da Azion.
