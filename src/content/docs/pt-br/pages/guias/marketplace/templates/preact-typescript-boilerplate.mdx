---
title: Como criar edge applications com o Preact TypeScript Boilerplate
description: >-
  O Preact Typescript Boilerplate fornece uma solução de automação para criar uma edge application Preact com TypeScript na Azion.
