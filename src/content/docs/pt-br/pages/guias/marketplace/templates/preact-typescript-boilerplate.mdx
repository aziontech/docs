...
namespace: docs_guides_preact_typescript_boilerplate
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/preact-typescript-boilerplate/
---
...
Com o **Preact TypeScript Boilerplate**, você pode iniciar um projeto usando [Preact](https://preactjs.com/) e implantá-lo no edge. **Preact** é uma biblioteca JavaScript com a mesma API que o React, mas otimizada para velocidade e tamanho reduzido do bundle.
...
Você pode obter e configurar seu template pelo Azion Console. Para implantá-lo facilmente no edge, clique no botão abaixo.
  ...
  <DocButton
    label="Implantar"
    href="https://console.azion.com/create/preact/preact-ts-boilerplate"
    icon="ai ai-azion"
    size="medium"
  />
