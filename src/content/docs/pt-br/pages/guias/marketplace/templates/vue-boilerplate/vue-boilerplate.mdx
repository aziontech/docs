...
Para começar a usar o **Vue Boilerplate**, proceda da seguinte forma:
...
3. Encontre o card do **Vue Boilerplate** e selecione-o.
...
O script cria um [repositório do GitHub](https://github.com/aziontech/azion-samples/tree/dev/templates/vuejs-boilerplate) para gerenciar o código-fonte e, em seguida, instala todas as dependências necessárias. Além disso, o script implanta sua aplicação na Azion Edge Platform e realiza várias configurações, incluindo o setup da edge application e do seu domínio para hospedar seu projeto Vue e uma edge function para lógica personalizada.
...
5. Encontre a edge application relacionada ao **Vue Boilerplate** e selecione-a.
...
Para fazer isso, abra seu novo repositório do **Vue Boilerplate** no GitHub. Em seguida, vá para **Settings** > **Secrets and Variables** > **Action** para [adicionar suas variáveis](https://docs.github.com/en/actions/security-guides/encrypted-secrets), seguindo estas instruções:
