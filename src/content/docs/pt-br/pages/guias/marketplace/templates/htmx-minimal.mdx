...
O **HTMX Boilerplate** facilita a implantação e teste de um exemplo básico da biblioteca HTMX na Plataforma de Edge da Azion. A implantação deste template criará uma nova edge function, um novo domínio e uma edge application, incluindo a instância da função e uma regra padrão para executar a instância.
...
- Habilitar o **Edge Functions** e **Application Accelerator** em sua conta.
    - Para fazer isso, vá para a seção [Billing & Subscriptions](/pt-br/documentacao/produtos/guias/billing-and-subscriptions/#subscriptions) e ative o switch para cada um.
