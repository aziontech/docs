...
permalink: /documentacao/produtos/guias/htmx-minimal-template/
---
...
O template **HTMX Minimal** facilita a implantação e teste de um exemplo mínimo da biblioteca HTMX na Plataforma de Edge da Azion. A implantação deste template criará uma nova edge function, um novo domínio e uma edge application, incluindo a instância da função e uma regra padrão para executar a instância.
...
- Habilitar **Edge Functions** e **Application Accelerator** em sua conta.
    ...
    - Se eles não estiverem ativados, a execução falhará e um log explicando o motivo será impresso.
...
Isso abrirá um modal onde você pode selecionar **Templates** > **HTMX Minimal** card.
...
Para fazer isso, abra seu novo repositório ** [NAME]** no GitHub. Em seguida, vá para **Settings** > **Secrets and variables** > **Action** para [adicionar suas variáveis](https://docs.github.com/en/actions/security-guides/encrypted-secrets) seguindo estas instruções:
