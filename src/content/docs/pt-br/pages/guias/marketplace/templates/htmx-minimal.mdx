...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/htmx-boilerplate/
---
...
O **HTMX Boilerplate** facilita a implantação e teste de um exemplo básico da biblioteca HTMX na Azion Web Platform. A implantação deste template criará uma nova function, um novo domínio e uma application, incluindo a instância da função e uma regra padrão para executar a instância.

Além disso, um repositório do GitHub é criado em sua conta para gerenciar o código-fonte. O repositório também inclui uma GitHub Action que garante um fluxo de trabalho de implantação contínua, mantendo seu projeto atualizado.
