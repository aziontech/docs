...
O template **Hello World** da Azion cria uma edge application que exibe uma mensagem *Hello, World!* no seu navegador e você pode usá-la como ponto de partida para se familiarizar com a **Plataforma de Edge
 da Azion** e os recursos de edge computing.

---

## Obter o template

Para usar o template **Hello World**, acesse o [Real-Time Manager (RTM)](https://manager.azion.com/) e selecione a opção **Start with a template** na página inicial.
...
Além disso, para garantir o desempenho ideal deste modelo, você deve ativar:
...
5. Encontre a aplicação relacionada ao template **Hello World** e selecione-a.
...
<Button href="/pt-br/documentacao/produtos/edge-application/domains/" text="saiba mais sobre domains" variant="secondary"> 
</Button>
