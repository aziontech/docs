...
Para obter o **MongoDB Atlas Boilerplate**, acesse o [Real-Time Manager (RTM)](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/) e selecione a opção **Start with a template** na página inicial.
