---
title: Como criar edge applications com o CosmicJS Simple Next.js Blog
description: O template CosmicJS Simple Next.js Blog permite criar e gerenciar um blog com facilidade, utilizando os recursos do Next.js para obter desempenho e experiência do usuário ideais.
...
O template **CosmicJS Simple Next.js Blog** da Azion oferece uma plataforma eficiente para a criação de blogs usando[Next.js](https://nextjs.org/docs) e o **Cosmic**, um CMS headless. Ele permite criar e gerenciar um blog com facilidade, utilizando os recursos do Next.js para possibilitar desempenho e experiência do usuário ideais.
