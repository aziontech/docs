...
2. No canto superior direito, abra o **Account menu**.
3. Selecione a opção **Billing & Subscriptions**.
4. Clique na aba **Subscriptions**.
5. Ative o switch para o produto que você deseja habilitar em sua conta.
