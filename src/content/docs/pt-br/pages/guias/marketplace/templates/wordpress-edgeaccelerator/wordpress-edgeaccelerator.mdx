...
O template WordPress EdgeAccelerator está disponível no [Azion Marketplace](pt-br/documentacao/produtos/marketplace/).
...
3. Na seção **BUILD**, selecione **Edge Application**. Você será redirecionado para a página de **Edge Application**.
  - Ela lista todas as edge applications que você criou.
4. Encontre a edge application relacionada ao seu template e selecione-a.
5. Na aba **Main Settings**, encontre a seção **Edge Application Modules** e ative o switch para o produto que você deseja habilitar.
