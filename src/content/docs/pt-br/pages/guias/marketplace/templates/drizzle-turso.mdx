---
title: Como implantar o template Drizzle + Turso
...
permalink: /documentacao/produtos/guias/drizzle-turso/
---
...
O template **Drizzle + Turso** contém as configurações para criar e conectar uma edge application a um banco de dados Turso via Drizzle ORM.
