...
description: Este template contém as configurações para conectar uma Edge Function a um banco de dados Turso.
...
O template **Drizzle + Turso** contém as configurações para conectar uma edge function a um banco de dados Turso via Drizzle ORM.
