...
:::caution[Atenção]
Se esses módulos estiverem ativados, a execução deste modelo pode gerar custos relacionados ao uso. Consulte a [página de preços](https://www.azion.com/pt-br/precos/) para obter mais informações.
