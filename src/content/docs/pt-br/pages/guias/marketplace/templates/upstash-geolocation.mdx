...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/upstash-geolocation-edgedeploy/
---
...
:::tip[dica]
Leia a documentação sobre o [gerenciamento de applications](/pt-br/documentacao/plataforma/applications/primeiros-passos/) para obter mais detalhes. Para perguntas específicas relacionadas ao Upstash, consulte a [documentação](https://docs.upstash.com/) do Upstash.
:::
