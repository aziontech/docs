...
Você deve ativá-lo separadamente via RTM. Para fazer isso:
...
5. Encontre a edge application relacionada ao template **Edge Function GitHub AutoDeploy** e selecione-o.
