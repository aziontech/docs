...
Ao implantar o template **Hello World**, o script cria uma application para ser executada na plataforma da Azion, incluindo seu Azion Workload Domain e várias configurações. Ele também cria uma edge function com a lógica personalizada que mostra o *Hello World!*.
