...
O template **Hello World** da Azion cria uma edge application que exibe uma mensagem *Hello, World!* no seu navegador e você pode usá-la como ponto de partida para se familiarizar com a **Azion Web Platform** e os recursos de edge computing.
