---
title: Como criar applications com o template Next.js App + Middleware
description: >-
  Esse template acelera a implantação de uma aplicação Next.js com configurações
  personalizadas, App Router e um middleware.
meta_tags: 'templates, guides, Azion Marketplace'
namespace: docs_guides_next_app_middleware
permalink: /documentacao/produtos/guias/nextjs-app-middleware/
---
