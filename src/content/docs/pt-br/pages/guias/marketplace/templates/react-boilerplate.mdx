...
Para começar a usar o **React Boilerplate**:
...
4. Navegue e selecione o card do **React Boilerplate**.
...
Além disso, sua aplicação é implantada na Plataforma de Edge da Azion e ao mesmo tempo define múltiplas configurações, como o setup da edge application e do seu domínio para hospedar seu projeto React e uma edge function para lógica personalizada.
