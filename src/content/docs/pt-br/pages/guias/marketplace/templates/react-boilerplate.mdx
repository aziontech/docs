...
Além disso, sua aplicação é implantada na Azion Web Platform e ao mesmo tempo define múltiplas configurações, como o setup da edge application e do seu domínio para hospedar seu projeto React e uma edge function para lógica personalizada.
