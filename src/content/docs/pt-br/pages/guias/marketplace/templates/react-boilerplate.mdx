...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/react-boilerplate/
---
...
Com a integração do [framework adapter Azion Bundler](/pt-br/documentacao/devtools/runtime/frameworks/compatibilidade-frameworks/), a aplicação passa por um processo de criação otimizado, enfatizando no melhor desempenho e a eficiência.
...
Além disso, sua aplicação é implantada na Azion Web Platform e ao mesmo tempo define múltiplas configurações, como o setup da application e do seu domínio para hospedar seu projeto React e uma function para lógica personalizada.
