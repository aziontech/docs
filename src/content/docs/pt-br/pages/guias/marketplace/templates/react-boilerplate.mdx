...
Isso abrirá uma nova página onde você pode selecionar o card do **React Boilerplate**.
...
Com a integração do [framework adapter Vulcan](/pt-br/documentacao/produtos/devtools/azion-edge-runtime/compatibilidade-frameworks/), a aplicação passa por um processo de criação otimizado, enfatizando no melhor desempenho e a eficiência.
...
:::caution[Atenção]
Se esse módulo for ativado, a execução deste template poderá gerar custos relacionados ao uso. Consulte a [página de preços](https://www.azion.com/pt-br/precos/) para obter mais informações.
:::
...
3. Encontre a edge application relacionada ao **React Boilerplate** e selecione-a.
- A lista é organizada em ordem alfabética. Você também pode usar a **barra de busca** localizada no canto superior esquerdo da lista; atualmente, ela é filtrada apenas pelo **Application Name**, ou nome da edge application.
