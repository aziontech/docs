...
description: O template permite que você implante um site Docusaurus integrado com o Material UI diretamente no edge
...
Para começar a usar o template **Docusaurus with Material UI**:
...
4. Navegue e selecione o card do **Docusaurus with Material UI**.
