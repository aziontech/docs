...
Templates baseados em Docusaurus são ideais para recursos de documentação e outros casos, incluindo sites, páginas de produtos, blogs e páginas de destino. A implantação deste template cria um repositório no GitHub contendo seu projeto, bem como uma edge application e um domínio para facilitar seu acesso e gerenciamento através da Azion Web Platform.
...
- O template usa [Application Accelerator](/pt-br/documentacao/produtos/build/edge-application/application-accelerator/). Isso pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/produtos/precos/) para mais informações.
