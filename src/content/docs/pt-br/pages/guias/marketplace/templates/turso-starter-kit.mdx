...
6. Crie a tabela que será usada por este template usando SQL:
...
Também cria um novo repositório no GitHub, incluindo uma GitHub Action para habilitar um fluxo de trabalho de desenvolvimento contínuo (*continuous development*) e manter sua aplicação atualizada.
