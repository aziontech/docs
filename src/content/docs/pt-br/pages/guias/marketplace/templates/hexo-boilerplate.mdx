...
Ao implantar este template, por meio da automação, o script cria uma application junto com uma edge function e um repositório do GitHub para gerenciar o seu projeto e o código-fonte.
