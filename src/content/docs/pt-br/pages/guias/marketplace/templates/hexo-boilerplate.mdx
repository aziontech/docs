...
Acesse o [Real-Time Manager (RTM)](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/) e selecione a opção **Start with a template** na página inicial.
...
Para saber mais sobre como editar e personalizar as configurações do seu projeto, acesse a seção [Gerenciar o template](#gerencie-o-template).
...
:::caution[Atenção]
Se este módulo estiver ativado, a execução deste template pode gerar custos relacionados ao uso. Consulte a [página de preços](https://www.azion.com/pt-br/precos/) para obter mais informações.
:::
