...
Acesse o [Azion Console](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/) e clique no botão **+ Create** na página inicial.

Isso abrirá um modal onde você pode selecionar **Templates** > **Hexo Boilerplate**.
