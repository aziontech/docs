---
title: Como implantar o Docusaurus TypeScript Boilerplate
description: >-
  Este template está escrito em TypeScript usando o framework Docusaurus, um
  gerador de sites estáticos.
meta_tags: 'templates, guias, Azion Marketplace, Docusaurus, React, Jamstack, TypeScript'
namespace: docs_guides_docusaurus_typescript_boilerplate
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/docusaurus-typescript-boilerplate/
---
