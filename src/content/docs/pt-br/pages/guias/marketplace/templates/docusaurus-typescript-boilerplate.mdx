...
description: Este template está escrito em TypeScript usando o framework Docusaurus, um gerador de sites estáticos.
...
Para começar a usar o **Docusaurus TypeScript Boilerplate**:
...
4. Navegue e selecione o card do **Docusaurus TypeScript Boilerplate**.
