...
description: Este template contém as configurações para construir e conectar uma edge application ao TiDB.
...
A implantação deste template cria um repositório do GitHub contendo seu projeto, além de uma edge application e um domínio para facilitar seu acesso e gerenciamento através da Azion Web Platform. Além disso, cria um novo banco de dados com uma tabela no seu cluster TiDB.
