...
Você precisa ativar o módulo separadamente via RTM. Para fazer isso:
...
:::caution[Atenção]
Se este módulo for ativado, a execução deste modelo pode gerar custos relacionados ao uso. Consulte a [página de preços](https://www.azion.com/pt-br/precos/) para obter mais informações.
:::
