...
Isso abrirá uma nova página onde você pode selecionar o card do **ChatGPT Plugin**.
...
## Personalize o plugin

A configuração padrão deste template completa uma busca nos repositórios de uma determinada conta do GitHub. Se você quiser manter essa configuração, pule para a seção [Registrar seu plugin](#registre-seu-plugin).
...
5. Adicione seu **Azion Personal Token** aos *Secrets* do repositório. Leia mais sobre como [obter um personal token da Azion](/pt-br/documentacao/produtos/guias/personal-tokens/).
...
3. Encontre a edge application relacionada ao **ChatGPT Plugin** e selecione-a.
...
:::tip[dica]
Leia a documentação sobre o [gerenciamento de edge applications](/pt-br/documentacao/produtos/build/edge-application/primeiros-passos/) para obter mais detalhes. Para perguntas específicas relacionadas ao ChatGPT, verifique a [documentação do OpenAI](https://platform.openai.com/docs/introduction).
:::
