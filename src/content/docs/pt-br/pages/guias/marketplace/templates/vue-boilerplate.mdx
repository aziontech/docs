...
5. Na aba **Main Settings**, encontre a seção **Edge Application Modules** e ative o switch do módulo.
...
4. Encontre a edge application relacionada ao **Vue Boilerplate** e selecione-a.
