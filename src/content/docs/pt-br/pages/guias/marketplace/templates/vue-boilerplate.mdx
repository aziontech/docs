---
title: Como criar applications com o Vue Boilerplate
description: >-
  O Vue Boilerplate fornece uma solução de automação para criar uma edge
  application Vue na Azion.
meta_tags: 'templates, guias, Azion Marketplace'
namespace: docs_guides_vue_boilerplate
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/vue-boilerplate/
---
...
Além disso, o script implanta sua aplicação na Azion Web Platform e realiza várias configurações, incluindo o setup da application e do seu domínio para hospedar seu projeto Vue e uma function para lógica personalizada.
...
3. Encontre a application relacionada ao **Vue Boilerplate** e selecione-a.
