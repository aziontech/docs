...
Para começar a usar o template, acesse o [Real-Time Manager (RTM)](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/) e selecione a opção **Start with a template** na página inicial.

Isso abrirá uma nova página onde você pode selecionar o card do **Vue Boilerplate**.
...
Além disso, para garantir o desempenho ideal deste template, é necessário ativar:

<Badge>
[Edge Functions](/pt-br/documentacao/produtos/edge-application/edge-functions/)
</Badge>

Você deve ativar esse módulo separadamente via RTM. Para fazer isso:
...
4. Na aba **Main Settings**, encontre a seção **Edge Application Modules** e ative o switch do módulo.

:::caution[Atenção]
Se esse módulo for ativado, a execução deste template poderá gerar custos relacionados ao uso. Consulte a [página de preços](https://www.azion.com/en/pricing/) para obter mais informações.
:::
