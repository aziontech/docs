...
permalink: /documentation/products/guides/astro-webpage-to-pdf-resume-template/
---
...
A implantação deste template cria um repositório no GitHub contendo seu projeto, além de uma edge application e um domínio para facilitar seu acesso e gerenciamento através da Plataforma de Edge da Azion.
