---
title: Como implantar o template Turso Starter Kit with Drizzle
description: Este template contém as configurações para conectar uma Edge Application a um banco de dados Turso.
...
O template **Turso Starter Kit with Drizzle ORM** contém as configurações para criar e conectar uma edge application a um banco de dados Turso via Drizzle ORM.

A implantação deste template cria um repositório do GitHub contendo seu projeto, além de uma edge application e um domínio para facilitar seu acesso e gerenciamento através da Plataforma de Edge da Azion. Além disso, cria um novo banco de dados com uma nova tabela na sua conta Turso.
...
:::note
O armazenamento e as operações do banco de dados também podem gerar custos diretamente pelo Turso. Verifique a [página de preços do Turso](https://turso.tech/pricing) para obter detalhes.
:::
