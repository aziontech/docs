...
- **Domain ID(s)**: os IDs dos domínios que você deseja proteger com este template.
    - Para obter os IDs, você pode acessar a [página de Domínios](https://console.azion.com/workloads), selecionar aquele que deseja usar e copiar o ID na URL. Você também pode obtê-lo por meio da [API Azion](https://api.azion.com/#96dc3b59-87f7-4a57-a841-3fad7947b45e).
...
<LinkButton link="/pt-br/documentacao/produtos/build/edge-application/workloads/" label="consulte o guia para configurar domínios" severity="secondary" />
