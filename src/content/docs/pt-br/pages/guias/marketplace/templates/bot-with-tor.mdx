...
O template **Bot Manager and TOR Exit Nodes** permite implantar um pacote de segurança básico para proteger seus domínios contra bots mal-intencionados e requisições de Tor Exit Nodes.
...
Isso abrirá uma nova página onde você pode selecionar o card do **Bot Manager and TOR Exit Nodes**.
