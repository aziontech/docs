---
title: Como criar edge applications com o Qwik Boilerplate
description: >-
  O Qwik Boilerplate fornece uma solução de automação para criar uma edge
  application Qwik na Azion.
meta_tags: 'templates, guias, Azion Marketplace'
namespace: docs_guides_qwik_boilerplate
permalink: /documentacao/produtos/guias/qwik-boilerplate/
---
...
O **Qwik Boilerplate** da Azion ajuda você a criar um projeto utilizando a framework Qwik e executá-la diretamente no edge da rede. O template encapsula e automatiza diversas etapas, desde o gerenciamento do repositório até a implantação no edge.
...
O script cria um [repositório do GitHub](https://github.com/aziontech/azion-samples/tree/dev/templates/qwik-boilerplate) para gerenciar o código-fonte e, em seguida, instala todas as dependências necessárias. também inclui uma GitHub Action para habilitar a implantação contínua. 
