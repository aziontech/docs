---
title: Como criar applications com o Qwik Boilerplate
description: >-
  O Qwik Boilerplate fornece uma solução de automação para criar uma application Qwik na Azion.
meta_tags: Qwik, templates, guias, Azion Marketplace
namespace: docs_guides_qwik_boilerplate
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/qwik-boilerplate/
---
...
Com o **Qwik Boilerplate**, você pode iniciar um projeto usando [Qwik](https://qwik.dev/docs/) e implantá-lo no edge. **Qwik** é um framework web que usa resumability em vez de hydration, carregando JavaScript somente quando necessário para melhor performance e exibição mais rápida de páginas.
