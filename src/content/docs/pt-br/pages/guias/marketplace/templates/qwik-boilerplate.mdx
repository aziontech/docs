...
Com o template do **Qwik Boilerplate**, você pode iniciar um projeto usando [Qwik](https://qwik.dev/docs/) e implantá-lo no edge. **Qwik** é um framework web que usa resumability em vez de hydration, carregando JavaScript somente quando necessário para melhor performance e carregamento mais rápido de páginas.
...
Você pode obter e configurar seu template pelo Azion Console. Para implantá-lo facilmente no edge, clique no botão abaixo.
  ...
  <LinkButton
    label="Implantar"
    link="https://console.azion.com/create/qwik-boilerplate"
    icon="ai ai-azion"
    icon-pos="left"
  />
