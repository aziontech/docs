...
O script cria um [repositório do GitHub](https://github.com/aziontech/azion-samples/tree/dev/templates/nextjs-boilerplate) para gerenciar o código-fonte e, em seguida, instala todas as dependências necessárias. Além disso, sua aplicação é implantada na plataforma da Azion e ao mesmo tempo define múltiplas configurações, como o setup da application e do seu domínio para hospedar seu projeto Next.js e uma edge function para lógica personalizada.
