...
Para começar a usar o **Next.js Static Boilerplate**, acesse o [Azion Console](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/) e selecione a opção **Start with a template** na página inicial.
