...
Para usar este template, acesse o [Azion Console](https://console.azion.com/) e clique no botão **Next.js Static Boilerplate** na página inicial.

Isso abrirá um modal onde você pode selecionar **Next.js Static Boilerplate** card.
