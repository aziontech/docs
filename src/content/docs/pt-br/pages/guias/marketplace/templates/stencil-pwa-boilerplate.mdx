...
description: Este template contém as configurações para construir uma Progressive Web Application (PWA) usando Stencil.
...
A implantação deste template cria um repositório do GitHub contendo seu projeto, além de uma edge application e um domínio para facilitar seu acesso e gerenciamento através da Plataforma de Edge da Azion.

Este template usa a versão `4.22.2` do Stencil.
