...
Para obter a usar o template **Upstash Rate Limit**, acesse o [Azion Console](/pt-br/documentacao/produtos/guias/como-acessar-o-azion-console/) e clique no botão **+ Create** na página inicial.
