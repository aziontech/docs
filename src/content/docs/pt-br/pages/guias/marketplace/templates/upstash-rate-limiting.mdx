...
Para obter a usar o template **Upstash Rate Limit**, acesse o [Azion Console](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/) e selecione a opção **Start with a template** na página inicial.
