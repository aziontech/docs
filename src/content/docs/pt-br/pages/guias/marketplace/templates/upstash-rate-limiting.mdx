...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/upstash-rate-limiting/
---
...
:::tip
Leia a documentação sobre o [gerenciamento de applications](/pt-br/documentacao/plataforma/applications/primeiros-passos/) para obter mais detalhes. Para perguntas específicas relacionadas ao Upstash, consulte a [documentação do Upstash](https://docs.upstash.com/).
:::
