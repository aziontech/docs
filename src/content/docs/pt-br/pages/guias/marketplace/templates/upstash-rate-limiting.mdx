...
O template **Upstash Rate Limit** cria uma nova application e seu domínio na Azion. Ele também cria uma edge function, para fornecer os argumentos do rate limiting, e um novo repositório em sua conta do GitHub com base em um [template público](https://github.com/aziontech/) que inclui uma GitHUb action para facilitar um continuous depployment.
