---
title: Como implantar o template Edge Function Starter Kit
description: O template Edge Function Starter Kit permite criar uma aplicação baseada em uma edge function, sem dependências de origem.
meta_tags: templates, guides, Azion Marketplace, web, Edge Function, Applications
...
O template **Edge Function Starter Kit** contém as configurações para criar uma aplicação baseada em uma **edge function**, sem dependências de origem. Este template simplifica o processo de configuração, permitindo que você implante rapidamente uma edge function pronta para ser executada no edge.

A implantação desse template cria uma application, uma edge function básica de **"Hello World"** e um domínio para facilitar seu acesso e gerenciamento através da Azion Web Platform.
...
Este template inclui uma edge function simples de `Hello World` pronta para ser executada. Siga esses passos para atualiza-la de acordo com suas necessidades:
