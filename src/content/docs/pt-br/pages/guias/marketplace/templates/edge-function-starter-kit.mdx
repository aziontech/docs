...
A implantação desse template cria uma edge application, uma edge function básica de **"Hello World"** e um domínio para facilitar seu acesso e gerenciamento através da Azion Web Platform.
