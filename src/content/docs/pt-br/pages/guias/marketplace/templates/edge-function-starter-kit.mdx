...
description: O template Function Starter Kit permite criar uma aplicação baseada em uma edge function, sem dependências de origem.
...
O template **Function Starter Kit** contém as configurações para criar uma aplicação baseada em uma **function**, sem dependências de origem. Este template simplifica o processo de configuração, permitindo que você implante rapidamente uma edge function pronta para ser executada no edge.
