...
description: O Jekyll Boilerplate implanta um repositório com um projeto baseado no Jekyll, um framework escrito em Ruby, que permite criar sites estáticos usando arquivos Markdown e HTML.
...
Para começar a usar o **Jekyll Boilerplate**:
...
4. Navegue e selecione o card do **Jekyll Boilerplate**.
