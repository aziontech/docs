---
title: Como implantar o Jekyll Boilerplate
description: >-
  O Jekyll Boilerplate implanta um repositório com um projeto baseado no Jekyll,
  um framework escrito em Ruby, que permite criar sites estáticos usando
  arquivos Markdown e HTML.
meta_tags: 'templates, guias, Azion Marketplace'
namespace: docs_guides_jekyll_boilerplate
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/jekyll-boilerplate/
---
...
O **Jekyll Boilerplate** acelera a implantação de um projeto básico Jekyll, diretamente no edge.
...
Este template usa a versão `4.3.3` do Jekyll.
...
- Instale a [versão 2.5.0 ou superior do Ruby](https://jekyllrb.com/docs/ruby-101/).
  - Sem um ambiente de execução Ruby, você não será capaz de instalar a Jekyll gem ou executar o código Ruby que alimenta o Jekyll.
