---
title: Como criar edge applications com o template Next.js App + Configurations
description: Esse template cria uma aplicação Next.js com configurações personalizadas e App Router
meta_tags: templates, guides, Azion Marketplace
namespace: docs_guides_nextjs_app_configurations
permalink: /documentacao/produtos/guias/nextjs-app-configurations/
---
...
Isso abrirá um modal onde você pode selecionar **Templates** > **Next.js App + Configurations** card.
...
Para fazer isso, abra seu novo repositório **Next.js App + Configurations** no GitHub. Em seguida, vá para **Settings** > **Secrets and variables** > **Action** para [adicionar suas variáveis](https://docs.github.com/en/actions/security-guides/encrypted-secrets) seguindo estas instruções:
