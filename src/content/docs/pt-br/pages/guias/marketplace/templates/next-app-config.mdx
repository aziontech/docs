---
title: Como criar applications com o template Next.js App + Configurations
description: >-
  Esse template cria uma aplicação Next.js com configurações personalizadas e
  App Router
