---
title: Como criar edge applications com o template Qwik Minimal 
description: >-
  O template Qwik Minimal fornece uma solução de automação para criar uma edge application basica de Qwik na Azion.
