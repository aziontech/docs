...
Com o template **Qwik Minimal**, você pode iniciar um projeto básico usando [Qwik](https://qwik.dev/docs/) e implantá-lo no edge. **Qwik** é um framework web que usa resumability em vez de hydration, carregando JavaScript somente quando necessário para melhor performance e carregamento mais rápido de páginas.
