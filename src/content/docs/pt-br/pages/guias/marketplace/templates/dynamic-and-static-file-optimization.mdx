...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/dynamic-static-file-optimization-template/
---
...
- O template usa [Application Accelerator](/pt-br/documentacao/build/application-accelerator/) e [Image Processor](/pt-br/documentacao/build/image-processor/). Isso pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/fundamentos/precos/) para mais informações.
...
:::tip
Leia a documentação sobre o [gerenciamento de applications](/pt-br/documentacao/plataforma/applications/primeiros-passos/) e o [Azion Image Processor](/pt-br/documentacao/guias/performance-e-confiabilidade/cache-e-purge/cache-settings/) para obter mais detalhes.
:::
