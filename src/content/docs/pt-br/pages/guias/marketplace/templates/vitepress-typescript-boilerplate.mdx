...
description: >-
  Este template está escrito em TypeScript usando o VitePress, um gerador de
...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/vitepress-typescript-boilerplate/
---
...
Este template, *escrito em TypeScript*, cria um repositório GitHub contendo seu projeto, bem como uma application e um domínio para facilitar seu acesso e gerenciamento por meio da Azion Web Platform.
