...
Este template, *escrito em TypeScript*, cria um repositório GitHub contendo seu projeto, bem como uma edge application e um domínio para facilitar seu acesso e gerenciamento por meio da Azion Web Platform.
