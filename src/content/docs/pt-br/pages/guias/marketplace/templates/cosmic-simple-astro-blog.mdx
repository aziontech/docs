---
title: Como criar edge applications com o CosmicJS Simple Astro Blog
description: O template CosmicJS Simple Astro Blog permite criar e gerenciar um blog facilmente, usando Astro e o Cosmic, um CMS headless, para gerenciamento de conteúdo.
...
:::caution[importante]
Ao atualizar o conteúdo na plataforma, você precisará reimplantar sua edge application no edge através da [Azion CLI](https://www.azion.com/en/documentation/devtools/cli/deploy).
:::
