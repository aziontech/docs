...
- O template usa [Functions](/pt-br/documentacao/produtos/build/applications/functions/) e [Image Processor](/pt-br/documentacao/produtos/build/applications/image-processor/). Isso pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/produtos/precos/) para mais informações.
