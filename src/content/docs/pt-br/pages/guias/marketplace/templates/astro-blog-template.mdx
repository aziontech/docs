...
- Habilitar o [Edge Functions](/pt-br/documentacao/produtos/build/edge-application/edge-functions/) e o [Image Processor](/pt-br/documentacao/produtos/build/edge-application/image-processor/) na sua conta Azion.
...
Para criar um novo blog Astro com este template:
...
4. Navegue e selecione o card do **Astro Blog Starter Kit**.
