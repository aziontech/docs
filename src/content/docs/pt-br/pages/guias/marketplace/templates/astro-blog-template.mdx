...
permalink: /documentacao/produtos/guias/astro-blog-template/
---
...
- Generar um personal token do GitHub.
...
Isso abrirá um modal onde você pode selecionar **Templates** > **Astro Blog**.
...
Agora você pode [gestionar e ajustar as configurações](#gestione-o-template) através do Azion Console.
...
Para fazer isso, abra seu novo repositório **Astro Blog** no GitHub. Em seguida, vá para **Settings** > **Secrets and variables** > **Action** para [adicionar suas variáveis](https://docs.github.com/en/actions/security-guides/encrypted-secrets) seguindo estas instruções:
