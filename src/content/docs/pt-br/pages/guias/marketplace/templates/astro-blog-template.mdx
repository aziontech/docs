...
description: >-
  Este template contém as configurações para criar uma nova página de blog com
  base no framework Astro.
meta_tags: 'templates, guides, Azion Marketplace'
namespace: docs_guides_astro_blog_template
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/astro-blog-starter-kit/
---
...
O template **Astro Blog Starter Kit** implanta uma application, um domínio e um repositório GitHub relacionado para facilitar seu acesso e gerenciamento do conteúdo e configurações. Ele também contém uma GitHub Action para habilitar um workflow de integração contínua e manter sua aplicação e repositório atualizados.
...
- O template usa [Functions](/pt-br/documentacao/build/functions/) e [Image Processor](/pt-br/documentacao/build/image-processor/). Isso pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/fundamentos/precos/) para mais informações.
