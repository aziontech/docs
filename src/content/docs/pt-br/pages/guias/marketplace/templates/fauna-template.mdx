...
Para obter o **Fauna DB Boilerplate**, acesse o [Real-Time Manager (RTM)](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/) e selecione a opção **Start with a template** na página inicial.
...
- Você será redirecionado para a página de **Edge Application**. Ele lista todas as edge applications que você criou.
3. Encontre a aplicação relacionada ao seu template e selecione-a.
...
4. Na aba **Main Settings**, encontre a seção **Edge Application Modules** e ative o switch dos módulos.
