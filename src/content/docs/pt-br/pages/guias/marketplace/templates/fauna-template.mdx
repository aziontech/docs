...
Você também deve ativar:
 ...
 <Tag severity="info" client:only="vue">[Edge Functions](/pt-br/documentacao/produtos/build/edge-application/edge-functions/)</Tag>
<br />
 <Tag severity="info" client:only="vue">[Application Accelerator](/pt-br/documentacao/produtos/build/edge-application/application-accelerator/)</Tag>
