...
3. Você será redirecionado para a página de **Edge Application**.
- Ele lista todas as edge applications que você criou.
4. Encontre a aplicação relacionada ao seu template e selecione-a.
5. Na aba **Main Settings**, encontre a seção **Edge Application Modules** e ative o switch dos módulos.
...
4. Encontre a aplicação relacionada ao **Fauna DB Boilerplate* e selecione-a.
