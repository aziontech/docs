...
Para começar a usar o **Angular Boilerplate**, acesse o [Real-Time Manager (RTM)](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/) e selecione a opção **Start with a template** na página inicial.

Isso abrirá uma nova página onde você pode selecionar o card do **Angular Boilerplate**.
...
O script cria um [repositório do GitHub](https://github.com/aziontech/azion-samples/tree/dev/templates/angular-boilerplate) para gerenciar o código-fonte e, em seguida, instala todas as dependências necessárias. Com a integração do [framework adapter Vulcan](/pt-br/documentacao/produtos/devtools/azion-edge-runtime/compatibilidade-frameworks/), a aplicação passa por um processo de criação otimizado, enfatizando o melhor desempenho e a eficiência.
...
3. Encontre a edge application relacionada ao **Angular Boilerplate** e selecione-a.
- A lista é organizada em ordem alfabética. Você também pode usar a **barra de busca** localizada no canto superior esquerdo da lista; atualmente, ela é filtrada apenas pelo **Application Name**, ou nome da edge application.
