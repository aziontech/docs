...
- Um [conta no GitHub](https://github.com/signup) para conectar com a Azion e criar seu novo repositório.
...
Para começar a usar o **Angular Boilerplate**:

1. Acesse o [Azion Console](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/).
2. Clique no botão **+ Create** na página inicial.
3. No modal, selecio a opção **Templates**.
4. Navegue e selecione o card do **Angular Boilerplate**.
