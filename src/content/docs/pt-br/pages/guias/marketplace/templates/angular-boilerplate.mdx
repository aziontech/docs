...
Com a integração do [framework adapter Azion Bundler](/pt-br/documentacao/produtos/devtools/azion-edge-runtime/compatibilidade-frameworks/), a aplicação passa por um processo de criação otimizado, enfatizando o melhor desempenho e a eficiência.
