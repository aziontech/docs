---
title: Como criar applications com o Angular Boilerplate
description: >-
  O Angular Boilerplate fornece uma solução de automação para criar uma edge
  application Angular na Azion.
meta_tags: 'templates, guias, Azion Marketplace'
namespace: docs_guides_angular_boilerplate
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/angular-boilerplate/
---

import Tag from '~/components/webkit/Tag.vue';

<Tag severity="info" value="Preview" />
...
Este template usa a versão `19.2.1` do Angular.
...
- Uma janela pop-up será aberta para confirmar a instalação da [Azion GitHub App](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/automacao/azion-github-app/), uma ferramenta que conecta sua conta do GitHub com a plataforma da Azion.
...
O script cria um [repositório do GitHub](https://github.com/aziontech/azion-samples/tree/dev/templates/angular-boilerplate) para gerenciar o código-fonte e, em seguida, instala todas as dependências necessárias. O template também inclui uma GitHub Action para habilitar a implantação contínua.

Com a integração do [framework adapter Azion Bundler](/pt-br/documentacao/devtools/runtime/frameworks/compatibilidade-frameworks/), a aplicação passa por um processo de criação otimizado, enfatizando o melhor desempenho e a eficiência.

Além disso, o script implanta sua aplicação na Azion Web Platform e realiza várias configurações, incluindo o setup da application e do seu domínio para hospedar seu projeto Angular.js e uma function para lógica personalizada.
...
3. Encontre a application relacionada ao **Angular Boilerplate** e selecione-a.
