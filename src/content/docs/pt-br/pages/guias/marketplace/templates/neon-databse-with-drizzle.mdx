---
title: Como implantar o template Neon Database Starter Kit with Drizzle 
...
O template **Neon Database Starter Kit with Drizzle ORM** contém as configurações para conectar uma edge function a um banco de dados Neon via Drizzle ORM.

A implantação deste template cria um repositório do GitHub contendo seu projeto, além de uma edge application e um domínio para facilitar seu acesso e gerenciamento através da Plataforma de Edge da Azion. Além disso, cria uma nova tabela no seu banco de dados Neon.
...
:::note
O armazenamento e as operações do banco de dados também podem gerar custos diretamente pelo Neon. Consulte a [página de preços do Neon](https://neon.tech/pricing) para detalhes.
:::
