...
- Habilitar [Edge Functions](/en/documentation/products/build/edge-application/edge-functions/), [Application Accelerator](/en/documentation/products/build/edge-application/application-accelerator/), e [Edge Cache](/en/documentation/products/build/edge-application/edge-cache/) na sua conta da Azion.
    - Par fazer isso:
