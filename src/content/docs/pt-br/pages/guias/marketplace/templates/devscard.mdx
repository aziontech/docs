...
description: >-
  Este template contém as configurações para criar seu currívulo online e impresso usando o projeto DevsCard.
meta_tags: >-
...
1. Acesse [Console](https://console.azion.com) > **Menu da Conta**.
2. Selecione a opção **Billing & Subscriptions**.
3. Selecione a aba **Subscriptions**.
4. Ative o interruptor para cada módulo.

:::caution[warning]
Se esses módulos forem ativados, a execução deste template pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/produtos/precos/) para mais informações.
:::
