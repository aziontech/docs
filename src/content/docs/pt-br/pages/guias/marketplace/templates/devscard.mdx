...
A implantação deste template cria um repositório no GitHub contendo seu projeto, bem como uma edge application e um domínio para facilitar seu acesso e gerenciamento através da Azion Web Platform.
