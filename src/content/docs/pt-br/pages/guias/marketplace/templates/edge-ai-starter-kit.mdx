...
description: O template AI Inference Starter Kit permite criar uma edge application com APIs compatíveis com OpenAI, funcionando diretamente na rede distribuída da Azion. 
