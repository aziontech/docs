...
<Button
      ...
      href="https://console.azion.com/create/starter-kit-edge-ai"
...
Este template inclui uma function simples de `Hello World` pronta para ser executada. Essa função recebe uma requisição POST para o modelo de AI desejado e retorna a resposta.
