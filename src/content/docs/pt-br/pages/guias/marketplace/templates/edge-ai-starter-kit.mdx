...
meta_tags: templates, guias, Azion Marketplace, AI, Function, Applications
...
A implementação deste template cria uma application com uma function e um domínio para facilitar seu acesso e gerenciamento através da Azion Web Platform.

---

## Requisitos

- O template usa [Application Accelerator](/pt-br/documentacao/build/application-accelerator/), [Functions](/pt-br/documentacao/build/functions/) e [AI Inference](/pt-br/documentacao/build/ai-inference/). Isso pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/fundamentos/precos/) para mais informações.
...
Siga esses passos para atualizar a function de acordo com suas necessidades:
...
O exemplo de código abaixo inclui uma function simples pronta para ser executada. Essa função recebe uma requisição POST para o modelo de AI desejado e retorna a resposta.
...
Este exemplo usa o [modelo Qwen3](/pt-br/documentacao/build/ai-inference/qwen3-30ba3b/). Você pode alterar o modelo e os parâmetros da requisição de acordo com suas preferências. 
Verifique a [referência de modelos de AI](/pt-br/documentacao/build/ai-inference/modelos/) para obter mais informações sobre os modelos disponíveis e como usá-los em sua aplicação.


:::tip
Leia a documentação sobre [gerenciamento de functions](/pt-br/documentacao/build/functions/) para mais detalhes.
:::
