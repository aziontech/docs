...
Este exemplo usa o [modelo Qwen3](/pt-br/documentacao/produtos/ai/ai-inference/modelos/qwen3-30ba3b/). Você pode alterar o modelo e os parâmetros da requisição de acordo com suas preferências. 
Verifique a [referência de modelos de AI](/pt-br/documentacao/produtos/ai/ai-inference/modelos/) para obter mais informações sobre os modelos disponíveis e como usá-los em sua aplicação.
...
<DocButton href="/pt-br/documentacao/produtos/guias/configurar-dominio/" label="Ir para o guia de configuração de domínio" kind="secondary" size="medium" />
