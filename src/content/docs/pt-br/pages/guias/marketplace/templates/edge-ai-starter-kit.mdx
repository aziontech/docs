...
Este template inclui uma edge function simples de `Hello World` pronta para ser executada. Essa função recebe uma requisição POST para o modelo de IA desejado e retorna a resposta.
