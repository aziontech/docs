---
title: Como implantar um banco de dados no edge com o Fauna DB Boilerplate
...
O **Fauna DB Boilerplate** permite que você implante um banco de dados diretamente na **Plataforma de Edge da Azion**. O template inclui a criação de uma interface estática para facilitar a criação, recuperação, atualização e exclusão de itens em suas coleções.
...
Para usar o **Fauna DB Boilerplate**, acesse o [Real-Time Manager (RTM)](https://manager.azion.com/) e selecione a opção **Start with a template** na página inicial.
...
4. Você será redirecionado para a página de **Edge Application**.
- Ela lista todas as edge applications que você criou.
5. Encontre a aplicação relacionada ao **Fauna DB Boilerplate* e selecione-a.
