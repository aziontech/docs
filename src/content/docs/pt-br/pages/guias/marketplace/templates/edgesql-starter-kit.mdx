...
A implantação deste template cria um repositório no GitHub contendo seu projeto, além de uma aplicação edge, um banco de dados e um domínio para facilitar seu acesso e gerenciamento por meio da Plataforma de Edge da Azion.
