---
title: Como criar edge applications com o EdgeSQL starter kit
description: >-
  O kit inicial do EdgeSQL fornece uma solução de automação para construir uma aplicação conectada a um banco de dados EdgeSQL.
meta_tags: EdgeSQL ,SQL ,templates, guias, Azion Marketplace
namespace: docs_guides_edgesql-starter-kit
...
A implantação deste template cria um repositório no GitHub contendo seu projeto, além de uma aplicação edge, um banco de dados e um domínio para facilitar seu acesso e gerenciamento por meio da Azion Edge Platform.

---

## Pré-requisitos
- Um slot de banco de dados EdgeSQL.
    - A quantidade de banco da dados que você pode ter é definido por seu plano se serviço. Para mais informações, visite nossa página de [referência EdgeSQL](https://www.azion.com/pt-br/documentacao/produtos/store/edge-sql/).
...
Você pode obter e configurar seu template pelo Azion Console. Para implantá-lo facilmente no edge, clique no botão abaixo.
  ...
  <LinkButton
    label="Implantar"
    link="https://console.azion.com/create/edgesql-starter-kit
    icon="ai ai-azion"
    icon-pos="left"
  />
...
:::tip
Leia a documentação para mais detalhes sobre [gerenciamento de edge applications](/pt-br/documentacao/produtos/build/edge-application/primeiros-passos/) e o [gerenciamento de banco de dados EdgeSQL](/pt-br/documentacao/produtos/guias/gerenciar-bancos-dados-edge-sql/).
:::
