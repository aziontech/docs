...
A implantação deste template cria um repositório no GitHub contendo seu projeto, além de uma edge application, um banco de dados e um domínio para facilitar seu acesso e gerenciamento por meio da Azion Web Platform.
