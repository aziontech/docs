---
title: Como implantar o template Nuxt Content
description: Este template contém as configurações para criar um blog ou site de documentação com Nuxt Content.
meta_tags: templates, guides, Azion Marketplace, web
namespace: docs_guides_nuxt_content
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/nuxt-content/
---
...
O template **Nuxt Content** contém as configurações para criar um blog ou site de documentação baseado no [Nuxt Content](https://content.nuxt.com/).

A implantação deste template cria um repositório do GitHub contendo seu projeto, além de uma application e um domínio para facilitar seu acesso e gerenciamento através da Azion Web Platform. Ele também cria uma origem no [Object Storage](/pt-br/documentacao/store/object-storage/) para entregar o conteúdo a partir do edge.

Este template usa a versão `3.6.1` do Nuxt.
