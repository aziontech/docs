...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/gatsby-blog-starter-kit/
---
...
O **Gatsby Blog Starter Kit** inclui as configurações para criar uma nova página de blog baseada no framework Gatsby. Após a implantação, você pode interagir com as postagens e interface padrão que já existem neste template e personalizá-las.

Este template cria uma application, um domínio e um repositório no GitHub para facilitar seu acesso e gerenciamento. Ele também contém uma GitHub Action para habilitar um fluxo de trabalho de integração contínua e manter sua aplicação e repositório atualizados.

O Gatsby Boilerplate utiliza a versão `5.13.2` do Gatsby e a versão `18.2.0` do React.
