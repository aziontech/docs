...
description: O template inclui as configurações para criar uma nova página de blog baseada no framework Gatsby
meta_tags: templates, guides, Azion Marketplace
namespace: docs_guides_gatsby_blog_starter_kit
permalink: /documentacao/produtos/guias/gatsby-blog-starter-kit/
---
...
Este template cria uma edge application, um domínio e um repositório no GitHub para facilitar seu acesso e gerenciamento. Ele também contém uma GitHub Action para habilitar um fluxo de trabalho de integração contínua e manter sua aplicação e repositório atualizados.
...
Isso abrirá um modal onde você pode selecionar **Templates** > **Gatsby Blog Starter Kit** card.
...
Para fazer isso, abra seu novo repositório **Gatsby Blog Starter Kit** no GitHub. Em seguida, vá para **Settings** > **Secrets and variables** > **Action** para [adicionar suas variáveis](https://docs.github.com/en/actions/security-guides/encrypted-secrets) seguindo estas instruções:
