...
2. Gerar uma chave de API na Fauna.
    - Para fazer isso, acesse seu dashboard na Fauna e selecione **Security** na barra lateral. Logo, clique no no botão **New Key**, nomeie sua chave e clique no botão **Save**.
...
1. Acesse sua conta no [Real-Time Manager (RTM)](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/) e vá no **Marketplace**.
...
Aparecerá uma mensagem indicando que a edge function foi salvada.

---

## Configurar uma regra para Rules Engine
