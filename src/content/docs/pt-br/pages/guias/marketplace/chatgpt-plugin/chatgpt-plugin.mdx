---
title: Como criar um plugin personalizado com Acceleration ChatGPT Plugin
description: Com Acceleration ChatGPT Plugin, você pode implementar a configuração padrão ou personalizar novos plugins de acordo com suas necessidades.
meta_tags: templates, guides, Azion Marketplace
namespace: docs_guides_acceleration_chatgpt_plugin
permalink: /documentacao/produtos/guias/acceleration-chatgpt-plugin/
---
...
O **Acceleration ChatGPT Plugin** é um template desenvolvido pela Azion para permitir a criação de plugins ChatGPT de forma rápida e simples. Com este template, você pode implementar a configuração padrão (para completar uma busca nos repositórios de uma conta específica do GitHub) ou personalizar novos plugins de acordo com suas necessidades.
...
2. Gerar seu token pessoal do GitHub, conforme explicado na documentação sobre [criação de um token de acesso pessoal](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens#creating-a-personal-access-token-classic).

---

## Obter o template

O template Acceleration ChatGPT Plugin está disponível no Azion Marketplace.

Para começar a usá-lo, siga os passos:
...
3. Encontre o card do **Acceleration ChatGPT Plugin** e selecione-o.
...
- **Criação de edge function**: uma edge function é criada e fornece os argumentos para o modelo, incluindo rotas para o plugin e configurações OpenAPI.
...
1. Acesse seu repositório do Acceleration ChatGPT Plugin no GitHub.
...
4. Ainda na pasta **schemas**, altere os dados do plugin no arquivo **api-plugin.json** . Deverá ser similar com esse exemplo:
...
```
5. Adicione seu **Azion Personal Token** aos *Secrets* do repositório. Leia mais sobre como [obter um token pessoal da Azion](https://www.azion.com/pt-br/documentacao/produtos/gestao-de-contas/personal-tokens/).
...
:::tip[dica]
Leia a documentação sobre o [gerenciamento de edge application](https://www.azion.com/pt-br/documentacao/produtos/ponto-de-partida/#passo-2-gerencie-edge-applications) para obter mais detalhes. Para perguntas específicas relacionadas ao ChatGPT, verifique a [documentação do OpenAI](https://platform.openai.com/docs/introduction).
:::
