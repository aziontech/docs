...
O template **ChatGPT Plugin** está disponível no [Azion Marketplace](pt-br/documentacao/produtos/marketplace/).
...
2. Adicione as informações sobre su ChatGPT Plugin:
