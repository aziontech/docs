...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/integracoes/secure-token/
---
...
Para concluir, você precisa configurar o [Rules Engine](/pt-br/documentacao/plataforma/applications/rules-engine/) para determinar o *behavior* e os *criteria* para executar a função.
