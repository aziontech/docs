---
title: Como utilizar a integração IP Address Reputation através do Marketplace da Azion
description: A integração IP Address Reputation, da IPQS, protege seu site contra IPs maliciosos.
...
Para instanciar a integração **IP Address Reputation**, enquanto ainda estiver na página do Edge Firewall, selecione a aba **Functions** e siga estas etapas:
