...
1. Acesse [Real-Time Manager (RTM)](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/) > **Marketplace**.
...
Pronto. Agora você instanciou a regra para sua função e tem acesso a edge functions em seu edge firewall.

:::caution[Atenção]
Se um produto ou módulo estiver ativado, pode gerar custos relacionados ao uso. Consulte a [página de preços](https://www.azion.com/en/pricing/) para obter mais informações.
:::
...
| `ttl` | Sim | Tempo máximo, em segundos, um usuário pode permanecer no seu site. Exemplo: `180` |
...
3. Dê um nome fácil de lembrar à sua nova regra.
4. Selecione um *criteria* (critério) para executar a solução
