...
A integração obtida no Marketplace é adicionada à sua lista de **Functions**. Esta integração roda sob o **Edge Firewall** da Azion; assim, você deve configurá-la antes de usá-la.
