...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/integracoes/liveness-detection/
---
...
- **[Real-Time Events](/pt-br/documentacao/observe/real-time-events/)**: Acesse a aba **Functions** para inspecionar logs de requisições individuais e respostas da função.
