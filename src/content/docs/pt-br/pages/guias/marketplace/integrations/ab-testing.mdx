...
**A/B ⁠Testing** está disponível no Marketplace da Azion e pode ser acessada através [do Azion Console](https://console.azion.com/) no **Products menu** > **Marketplace**.
...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/ab-testing-marketplace/" label="consulte o guia do A/B Test" variant="secondary"> 
