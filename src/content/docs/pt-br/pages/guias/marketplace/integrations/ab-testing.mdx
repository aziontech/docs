...
1. Criação de variantes A/B em um único arquivo JSON.
...
<LinkButton link="/pt-br/documentacao/produtos/guias/ab-testing-marketplace/" label="consulte o guia do A/B Test" severity="secondary" /> 
