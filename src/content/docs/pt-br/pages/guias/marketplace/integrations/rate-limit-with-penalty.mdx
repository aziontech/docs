...
Ainda na página do **Edge Firewall**, selecione a aba **Functions Instances** e siga estas etapas:

1. Clique no botão **Add ⁠Function**.
2. Dê um nome fácil de lembrar à sua instância.
3. No menu suspenso, selecione a função **Upstash Rate Limiting**.
...
4. Na guia **Arguments**, você passará suas credenciais do Upstash e suas variáveis:
...
6. Selecione a função de **Upstash Rate Limiting** de acordo com o nome que você deu antes.
