...
Para usar Massive Redirect fornecido pelo Marketplace da Azion, você precisa:
...
:::note
Observe que há várias seções na aba **Args**. Isso acontece porque você pode configurar diversos redirecionamentos diferentes ao mesmo tempo.
:::
