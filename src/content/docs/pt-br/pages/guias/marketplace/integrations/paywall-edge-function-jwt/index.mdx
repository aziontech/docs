...
A edge function JWT está disponível no Marketplace da Azion e pode ser acessada através do [Real-Time Manager (RTM)](https://manager.azion.com/), no **Products menu**, localizado no canto superior esquerdo da página inicial do RTM e indicado pelas três linhas horizontais.
...
## Definição as regras no Rules Engine
