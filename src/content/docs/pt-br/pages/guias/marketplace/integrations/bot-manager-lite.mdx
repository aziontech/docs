...
5. Opcionalmente, habilite o switch **Debug Rules** para registrar quais regras do Rules Engine são executadas para cada requisição. Isso é útil durante o ajuste da integração. Consulte [Uso do Debug Rules](#uso-do-debug-rules-para-rastrear-a-execucao-de-regras-do-firewall) para mais detalhes.
