...
:::caution[Atenção]
Se qualquer produto ou módulo for ativado, pode gerar custos relacionados ao uso. Consulte a [página de preços](/pt-br/documentacao/fundamentos/precos/) para obter mais informações.
:::
...
Para uma lista completa dos argumentos disponíveis e suas descrições, consulte a [referência do Bot Manager Lite](/pt-br/documentacao/secure/bot-manager/bot-manager-lite/#configure-a-funcao).
...
Para saber mais informações e detalhes sobre os argumentos, visite a documentação do [Azion Bot Manager Lite](/pt-br/documentacao/secure/bot-manager/bot-manager-lite/#configure-a-funcao).
...
<DocButton href="/pt-br/documentacao/secure/bot-manager/bot-manager-lite/#configuracao-de-actions" label="Ver todas as ações na referência" kind="secondary" size="medium" />

---

## Consulte os logs

Você pode usar [Data Stream](/pt-br/documentacao/observe/data-stream/) e [Real-Time Events](/pt-br/documentacao/observe/real-time-events/) para obter os logs do **Bot Manager Lite** e monitorar a atividade dos bots em suas aplicações.

:::caution[Atenção]
Se um produto ou módulo for ativado, poderá gerar custos relacionados ao uso. Verifique a [página de preços](/pt-br/documentacao/fundamentos/precos/) para obter mais informações.
:::
...
7. Em **Destination**, selecione um **Connector** na lista suspensa.
  - Os campos para preenchimento são diferentes dependendo do tipo de endpoint que você escolher. Descubra mais informações sobre cada campo na página de [configuração de endpoint](/pt-br/documentacao/observe/data-stream/#endpoints).
8. Clique no botão **Save**.

Agora você pode consultar os logs no endpoint selecionado. 

:::tip
Consulte a documentação para dar seus [Primeiros passos do Data Stream](/pt-br/documentacao/observe/data-stream/primeiros-passos/) e [Configurar as main settings do Data Stream](/pt-br/documentacao/guias/plataforma/observabilidade/como-usar-data-stream/).
:::
...
:::tip
Consulte a documentação para dar seus [Primeiros passos do Real⁠-⁠Time Events](/pt-br/documentacao/observe/real-time-events/primeiros-passos/) e [entender os logs do Real⁠-⁠Time Events](/pt-br/documentacao/guias/plataforma/observabilidade/entender-logs/).
:::
...
:::tip
Consulte o guia [Como fazer debug de regras criadas com o Rules Engine](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/debug-regras/) para instruções detalhadas sobre como consultar o `traceback` via Data Stream, Real-Time Events e GraphQL API.
:::

<DocButton href="/pt-br/documentacao/guias/seguranca-de-aplicacoes/bots-e-rede/gerenciar-bots/" label="consulte o guia sobre gerenciar bots" outlined size="medium" />
