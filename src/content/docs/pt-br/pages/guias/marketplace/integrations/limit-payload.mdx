...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/integracoes/limit-payload-size/
---
...
Para terminar o processo, é preciso configurar o [Rules Engine](/pt-br/documentacao/plataforma/applications/rules-engine/) indicando o *behavior* e o *criteria* necessários para executar a integração.
