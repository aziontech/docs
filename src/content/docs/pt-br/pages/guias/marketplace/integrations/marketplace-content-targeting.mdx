...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/integracoes/content-targeting-integration/
---
...
:::tip
Se você ainda na tiver uma aplicação, acesse a [seção Build](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/criar-uma-aplicacao/) para saber como criar uma nova application.
:::
...
2. Na página de listagem de suas applications, selecione aquela que você deseja usar com a integração **Content Targeting**.
3. Na aba **Main Settings**, localize a opção **Functions** e ative-a para habilitar functions em sua application.
