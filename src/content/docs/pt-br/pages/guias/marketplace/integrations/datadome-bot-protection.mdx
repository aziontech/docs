...
- **[Real-Time Events](/pt-br/documentacao/observe/real-time-events/)**: Acesse a aba **Functions** para inspecionar logs de requisições individuais e respostas do DataDome.
- **[Data Stream](/pt-br/documentacao/observe/data-stream/)**: Crie um stream usando o template **Functions Event Collector** para encaminhar logs ao endpoint de sua preferência para análise de longo prazo.
