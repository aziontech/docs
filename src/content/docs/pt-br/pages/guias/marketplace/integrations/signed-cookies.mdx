...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/integracoes/signed-cookies/
---
...
:::tip
Para criar uma nova application, acesse a [seção Build](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/criar-uma-aplicacao/) para obter mais detalhes sobre este tópico.
:::
