...
A integração obtida no Marketplace é adicionada à sua lista de **Functions**. Portanto, para usar a integração **Massive Redirect**, você deverá criar uma nova edge application para incorporar a nova função.
...
3. Certifique-se de habilitar o switch **Functions** na página principal da sua edge application para permitir o uso da sua nova integração.
4. Clique em **Save** no canto inferior direito.

Você receberá uma mensagem de sucesso indicando sua edge application foi atualizada. Agora, o uso de **Functions** está habilitado para a sua aplicação.
