...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/integracoes/massive-redirect-integration/
---
...
:::tip
Para criar uma nova application, acesse a [seção de Build](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/criar-uma-aplicacao/).
:::
...
:::tip
Você pode obter informações e referências mais detalhadas no artigo [Configure redirecionamento em massa para migração de domínios](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/integracoes/massive-redirect-integration/).
:::
