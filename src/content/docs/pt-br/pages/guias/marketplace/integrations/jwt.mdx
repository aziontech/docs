...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/integracoes/jwt/
---
...
Pronto. Agora você tem a sua Function JWT devidamente configurada. 

### Crie uma regra dentro do Rules Engine

Para colocá-la em uso, você deverá configurar no [Rules Engine](/pt-br/documentacao/plataforma/applications/rules-engine/) tanto o critério (*criteria*) como o comportamento (*behavior*) da sua função.
...
:::tip
Veja exemplos casos de uso para essa integração acessando a página [Configure um paywall com Function JWT](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/functions-e-runtime/paywall-function-jwt/).
:::
