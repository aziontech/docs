...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/integracoes/scheduled-blocking/
---
...
Para concluir, você precisa configurar o [Rules Engine](/pt-br/documentacao/plataforma/firewall/rules-engine/) para determinar o *behavior* (comportamento) e os *criteria* (critérios) para executar a função.
