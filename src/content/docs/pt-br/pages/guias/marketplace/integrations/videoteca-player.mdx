...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/integracoes/videofront-player/
---
...
2. Selecione na lista a aplicação à qual você deseja adicionar a integração ou [crie uma nova application](/pt-br/documentacao/plataforma/applications/primeiros-passos/).
