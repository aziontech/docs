...
A edge function Massive Redirect está disponível no Azion Marketplace. Para acessá-la, você pode fazer através do [Azion Console](https://console.azion.com/), no **Products menu**, localizado no canto superior esquerdo e representado pelas três linhas horizontais.
