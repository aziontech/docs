...
permalink: /documentacao/produtos/guias/configurar-massive-redirect/
---
...
A edge function Massive Redirect está disponível no Azion Marketplace. Para acessá-la, você pode fazer através do [Real-Time Manager (RTM)](https://console.azion.com/), no **Products menu**, localizado no canto superior esquerdo e representado pelas três linhas horizontais.
...
Para criar uma função Massive Redirect, você pode consultar o guia sobre [como instalar a integração Massive Redirect através do Marketplace da Azion](/pt-br/documentacao/produtos/guias/how-to-redirecionamento-massivo/).
