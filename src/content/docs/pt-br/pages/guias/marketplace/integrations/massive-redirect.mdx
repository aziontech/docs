...
Para criar uma função Massive Redirect, você pode consultar o guia sobre [como instalar a integração Massive Redirect através do Marketplace da Azion](/pt-br/documentacao/produtos/guias/massive-redirect-integration/).
