---
title: Como utilizar Upstash Rate Limiting with Penalty através do Marketplace da Azion
...
Upstash **Rate Limiting with Penalty** permite que você controle o tráfego de entrada diretamente no edge da rede, evitando gargalos, gerenciando picos de tráfego e protegendo suas aplicações contra possíveis ameaças, como DDoS, fuzzing ou ataques de força bruta.
...
5. Depois de encontrar o card de **Upstash Rate Limiting with Penalty**, selecione-o para abrir a página da integração.
...
Para instanciar a integração **Upstash Rate Limiting com Penalty**, siga os passos:
...
3. No menu suspenso, selecione a função **Upstash Rate Limiting with Penalty**.
...
6. Selecione a função de **Upstash Rate Limiting with Penalty** de acordo com o nome que você deu antes.
7. Clique no botão **Save**.

Pronto. Agora, **Upstash Rate Limiting with Penalty** está em execução e protegendo seus domínios.
