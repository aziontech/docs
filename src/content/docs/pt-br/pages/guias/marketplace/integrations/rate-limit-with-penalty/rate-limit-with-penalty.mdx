...
Ainda na página do **Edge Firewall**, selecione a aba **Functions** e siga estas etapas:
...
- Esta integração permite definir diferentes janelas de limites para diferentes períodos do dia. Exemplo: você pode definir um limite de `10 solicitações/minuto` de `00:00` a `12:00` e outro de `15 solicitações/minuto` de `12:01` a `23:59`.
