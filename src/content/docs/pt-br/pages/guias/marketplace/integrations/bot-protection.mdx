...
Você pode usar [Data Streaming](/pt-br/documentacao/produtos/observe/data-streaming/) e [Real-Time Events](/pt-br/documentacao/produtos/observe/real-time-events/) para obter os logs do **Bot Manager** e monitorar a atividade dos bots em suas aplicações.
