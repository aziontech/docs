...
description: >-
  Azion Bot Manager analisa requisições recebidas e atribui uma pontuação com
...
4. No menu suspenso, selecione a função **Azion Bot Manager**.
...
<Fragment slot="panel.console">
1. No canto superior esquerdo, selecione **Products menu** > **Edge Firewall**, dentro da seção **Secure**.
2. Selecione o firewall relacionado com o **Bot Manager**. 
