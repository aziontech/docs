...
7. Logo selecione a função de acordo com o nome que você deu no passo 3.
...
Você pode usar [Azion Data Streaming](/pt-br/documentacao/produtos/observe/data-streaming/) e [Azion Real-Time Events](/pt-br/documentacao/produtos/observe/real-time-events/) para obter os logs do **Bot Manager** e monitorar a atividade dos bots em suas aplicações.
...
### Uso do Data Streaming

Para criar um novo streaming para monitorar a atividade do Bot Manager:

[Acesse o Azion Console](https://console.azion.com/) > **Data Streaming**.
Clique no botão **Add**.
Dê ao streaming um nome único e fácil de lembrar.
...
:::tip
Consulte a documentação para dar seus [Primeiros passos do Data Streaming](/pt-br/documentacao/produtos/observe/data-streaming/primeiros-passos/) e [Configurar as main settings do Data Streaming](/pt-br/documentacao/produtos/guias/como-usar-data-streaming/)
:::
...
Use a barra **Filter by** para crear uma busca mais específica.
...
2. Selecione o relacionado com o **Bot Manager**. 
