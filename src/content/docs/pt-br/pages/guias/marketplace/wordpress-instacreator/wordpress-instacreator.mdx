...
O template WordPress InstaCreator está disponível no Azion Marketplace.
...
4. Clique na guia **Settings** para abrir o formulário de configuração.
...
Quando você implementa este templates, os seguintes processos são completados, bem como algumas configurações principais são definidas, na plataforma de Edge da Azion:
...
Além disso, a implantação do template WordPress InstaCreator também envolve a automatização dos processos de:
...
<Button href="https://www.azion.com/pt-br/documentacao/produtos/edge-application/domains/" text="Saiba mais sobre domínios"> 
