...
As configurações de teste são definidas na função usando parâmetros no formato `JSON`, chamados **Args**. Os **Args** listam atributos relacionados a cada versão sendo testada; tais como probabilidade, valor do cookie e outros.
...
<Button href="/pt-br/documentacao/produtos/guias/ab-testing-marketplace/" text="go to A/B Test guide" variant="secondary"> 
</Button>
