...
hCaptcha é uma solução *serverless* disponível no Marketplace da Azion. Esse tipo de solução é usado principalmente para proteger domínios contra bots e permite que você monitore o tráfego em seu site usando o painel do hCaptcha.
...
## Obtendo as chaves no site do hCaptcha
