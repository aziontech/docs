...
- **Upstash Redis Rest URL** *: o URL para acessar seu banco de dados Upstash usando REST.
...
- **Criação de edge** application: uma edge application é criada e fornece os argumentos para a geolocalização.
