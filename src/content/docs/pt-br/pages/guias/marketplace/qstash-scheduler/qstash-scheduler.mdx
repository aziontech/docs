...
:::tip
Leia a documentação sobre o [gerenciamento de edge applications](/pt-br/documentacao/produtos/ponto-de-partida/#passo-2-gerencie-edge-applications) para obter mais detalhes. Para perguntas específicas relacionadas ao QStash, consulte a [documentação do Upstash](https://docs.upstash.com/).
:::
