...
3. Na página da integração, clique no botão **Get it now** para iniciar a instalação.

Uma mensagem de sucesso aparecerá indicando que a sua integração está instalada.
...
3. Na página da aplicação, na aba **Main Settings**, localize a opção **Edge Functions** e ative-a para habilitar **Functions** em sua edge application.
...
Para maiores informações sobre como utilizar a integração de Content Targeting, visite o **Use Case** em [Use cookies e lógicas de Edge Computing para segmentar conteúdo](/pt-br/documentacao/produtos/guias/segmentacao-conteudo/)
