...
permalink: /documentacao/guias/plataforma/migracao/aws-guia-migracao/
---
...
| :---------- | :---------- | :--------------- |
| **Amazon CloudFront** | CDN da AWS para entregar conteúdo estático, conteúdo dinâmico, APIs, aplicações e vídeo globalmente. | [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) |
| **CloudFront Distributions** | Recurso principal de entrega do CloudFront para domínios, origens, comportamento de cache, certificados, segurança e configurações de entrega no edge. | [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) |
| **CloudFront Alternate Domain Names** | Configura domínios customizados para distribuições CloudFront. | [Workloads](https://www.azion.com/pt-br/documentacao/plataforma/workloads/) |
| **CloudFront Cache Behaviors** | Comportamento de entrega baseado em caminho, política de cache, política de requisição à origem, métodos permitidos e associações de edge function. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/rules-engine/) |
| **CloudFront Cache Policies** | Controla cache keys, TTLs, cabeçalhos, cookies, query strings e compressão. | [Cache](https://www.azion.com/pt-br/documentacao/build/cache/) |
| **CloudFront Origin Request Policies** | Controla quais valores da requisição o CloudFront encaminha para a origem. | [Rules Engine](https://www.azion.com/pt-br/documentacao/plataforma/applications/rules-engine/) |
| **CloudFront Response Headers Policies** | Adiciona ou modifica cabeçalhos de resposta, como cabeçalhos de segurança e CORS. | [Rules Engine para Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/rules-engine/) |
| **CloudFront Origin Shield** | Camada adicional de cache centralizado para reduzir carga na origem e melhorar cache hit ratio. | [Tiered Cache](https://www.azion.com/pt-br/documentacao/build/cache/tiered-cache/) |
| **CloudFront Invalidation** | Remove conteúdo dos caches de edge do CloudFront antes da expiração. | [Real-Time Purge](https://www.azion.com/pt-br/documentacao/build/cache/real-time-purge/) |
| **CloudFront Functions** | Execução leve de JavaScript no edge para redirects, rewrites, cabeçalhos e normalização de cache key. | [Functions para Applications](https://www.azion.com/pt-br/documentacao/build/functions/) |
| **Lambda@Edge** | Funções Node.js ou Python acionadas por eventos do CloudFront para customizar a entrega. | [Functions para Applications](https://www.azion.com/pt-br/documentacao/build/functions/) |
| **Lambda@Edge for security logic** | Usa funções acionadas pelo CloudFront para validação de requisições, autenticação ou lógica de bloqueio. | [Functions para Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/functions/) |
| **CloudFront Device Detection** | Detecta tipo de dispositivo e encaminha metadados de dispositivo para a origem. | [Device Groups](https://www.azion.com/pt-br/documentacao/plataforma/applications/device-groups/) |
| **AWS Elemental MediaLive** | Codificação de vídeo ao vivo em tempo real. | [Live Ingest](https://www.azion.com/pt-br/documentacao/guias/performance-e-confiabilidade/otimizacao-de-entrega/live-ingest-boas-praticas/) |
| **AWS Elemental MediaPackage** | Empacota e origina streams de vídeo ao vivo para HLS, DASH e formatos relacionados. | [Live Ingest](https://www.azion.com/pt-br/documentacao/guias/performance-e-confiabilidade/otimizacao-de-entrega/live-ingest-boas-praticas/) + [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) |
| **CloudFront for live streaming** | Entrega vídeo ao vivo globalmente usando CloudFront com AWS Media Services. | [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) + [Live Ingest](https://www.azion.com/pt-br/documentacao/guias/performance-e-confiabilidade/otimizacao-de-entrega/live-ingest-boas-praticas/) |
| **AWS Lambda** | Compute serverless de uso geral para execução de código orientada a eventos. | [Functions para Applications](https://www.azion.com/pt-br/documentacao/build/functions/) |
| **Amazon API Gateway** | Cria e gerencia APIs REST, HTTP e WebSocket com integrações de backend. | [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) + [Functions](https://www.azion.com/pt-br/documentacao/build/functions/) |
| **API Gateway request validation / throttling** | Aplica controles, throttling e regras de validação a requisições de API. | [Rules Engine](https://www.azion.com/pt-br/documentacao/plataforma/applications/rules-engine/) + [Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/) |
| **AWS Amplify Hosting** | CI/CD baseado em Git e hospedagem para aplicações web estáticas e server-side rendered. | [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) + [Azion CLI](https://www.azion.com/pt-br/documentacao/devtools/cli/) |
| **AWS App Runner** | Faz deploy de código fonte ou imagens de container para aplicações web gerenciadas. | [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) + [Orchestrator](https://www.azion.com/pt-br/produtos/orchestrator/) |
| **Amazon Bedrock** | Acesso a foundation models e desenvolvimento de aplicações de IA generativa. | [AI Inference](https://www.azion.com/pt-br/documentacao/build/ai-inference/) |
| **Amazon Bedrock model inference** | Invoca foundation models para texto, imagem, embedding e casos de uso de IA generativa. | [AI Inference](https://www.azion.com/pt-br/documentacao/build/ai-inference/) |
...
| **Amazon Bedrock Custom Model Import** | Importa foundation models customizados para o Bedrock. | [AI Inference](https://www.azion.com/pt-br/documentacao/build/ai-inference/) + [LoRA Fine-Tune](https://www.azion.com/pt-br/learning/ai/o-que-e-lora-fine-tuning/) |
| **Amazon SageMaker AI Real-Time Inference** | Faz deploy de modelos de ML em endpoints gerenciados de inferência em tempo real. | [AI Inference](https://www.azion.com/pt-br/documentacao/build/ai-inference/) |
| **Amazon S3** | Armazenamento de objetos para dados não estruturados, assets estáticos, backups, arquivos e sites. | [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/) |
| **Amazon S3 Static Website Hosting** | Hospeda sites estáticos a partir de buckets S3. | [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/) + [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) |
| **S3 Object Lambda** | Transforma objetos S3 com Lambda antes de retorná-los ao solicitante. | [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/) + [Functions](https://www.azion.com/pt-br/documentacao/build/functions/) |
| **S3 Object Lambda for image transformation** | Redimensiona, aplica marca d'água, redige ou transforma conteúdo recuperado do S3. | [Image Processor](https://www.azion.com/pt-br/documentacao/build/image-processor/) + [Functions](https://www.azion.com/pt-br/documentacao/build/functions/) |
| **Amazon Aurora DSQL** | Banco de dados SQL relacional distribuído e serverless para workloads transacionais. | [SQL Database](https://www.azion.com/pt-br/documentacao/store/sql-database/) |
| **Amazon DynamoDB** | Banco de dados serverless key-value e de documentos. | [KV Store](https://www.azion.com/pt-br/documentacao/store/kv-store/) |
| **DynamoDB Global Tables** | Replicação multi-Region para dados NoSQL distribuídos globalmente. | [KV Store](https://www.azion.com/pt-br/documentacao/store/kv-store/) |
| **AWS WAF** | Web application firewall para proteger aplicações e APIs. | [WAF](https://www.azion.com/pt-br/documentacao/secure/waf/) / [Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/) |
| **AWS Managed Rules for AWS WAF** | Grupos de regras gerenciadas para vulnerabilidades comuns e tráfego indesejado. | [WAF Rule Sets](https://www.azion.com/pt-br/documentacao/secure/waf/rule-sets/) |
| **AWS WAF custom rules** | Cria condições de correspondência e ações customizadas para requisições web. | [Rules Engine para Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/rules-engine/) |
| **AWS WAF Bot Control** | Detecção e mitigação gerenciadas de bots. | [Bot Manager](https://www.azion.com/pt-br/documentacao/secure/bot-manager/) |
| **AWS WAF Rate-Based Rules** | Limita taxas de requisições com base em IP, cabeçalhos, URI, método ou outras chaves. | [Rules Engine](https://www.azion.com/pt-br/documentacao/plataforma/applications/rules-engine/) + [Network Shield](https://www.azion.com/pt-br/documentacao/secure/network-shield/) |
| **AWS WAF IP Sets** | Listas reutilizáveis de IP/CIDR para regras de allow ou block. | [Network Lists](https://www.azion.com/pt-br/documentacao/secure/network-shield/network-lists/) |
| **AWS Shield Standard** | Proteção DDoS padrão para recursos AWS. | [DDoS Protection](https://www.azion.com/pt-br/documentacao/plataforma/ddos-protection/) |
| **AWS Shield Advanced** | Proteção DDoS avançada com visibilidade e opções adicionais de mitigação. | [DDoS Protection](https://www.azion.com/pt-br/documentacao/plataforma/ddos-protection/) |
| **AWS Network Firewall** | Firewall de rede VPC gerenciado. | [Network Shield](https://www.azion.com/pt-br/documentacao/secure/network-shield/) |
| **Elastic Load Balancing** | Distribui tráfego entre múltiplos destinos e zonas de disponibilidade. | [Load Balancer](https://www.azion.com/pt-br/documentacao/plataforma/load-balancer/) |
| **Application Load Balancer** | Load balancing HTTP/HTTPS de camada 7 com roteamento em nível de aplicação. | [Load Balancer](https://www.azion.com/pt-br/documentacao/plataforma/load-balancer/) |
| **Network Load Balancer** | Load balancing TCP/UDP/TLS de camada 4. | [Load Balancer](https://www.azion.com/pt-br/documentacao/plataforma/load-balancer/) |
| **AWS Global Accelerator** | IPs Anycast globais e roteamento otimizado na rede global da AWS. | [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/) + [Load Balancer](https://www.azion.com/pt-br/documentacao/plataforma/load-balancer/) |
| **Amazon Route 53** | DNS autoritativo, registro de domínio, políticas de roteamento e health checks. | [Edge DNS](https://www.azion.com/pt-br/documentacao/secure/edge-dns/) |
| **AWS Certificate Manager** | Provisiona, importa, gerencia, faz deploy e renova certificados SSL/TLS. | [Certificate Manager](https://www.azion.com/pt-br/documentacao/plataforma/certificate-manager/para-firewall/) |
| **Amazon CloudWatch Metrics** | Coleta, consulta, visualiza e cria alarmes para métricas de serviço e aplicação. | [Real-Time Metrics](https://www.azion.com/pt-br/documentacao/plataforma/real-time-metrics/) |
| **Amazon CloudWatch Logs** | Coleta, monitora, consulta e analisa logs. | [Real-Time Events](https://www.azion.com/pt-br/documentacao/observe/real-time-events/) |
| **Amazon Data Firehose** | Entrega dados de streaming para destinos como S3, Redshift, OpenSearch e endpoints HTTP. | [Data Stream](https://www.azion.com/pt-br/documentacao/observe/data-stream/) |
| **CloudWatch RUM** | Monitoramento de usuário real para performance de aplicações browser e mobile. | [Edge Pulse](https://www.azion.com/pt-br/documentacao/observe/edge-pulse/) |
| **AWS Management Console** | Interface web para acessar e gerenciar serviços AWS. | [Azion Console](https://console.azion.com/) |
| **AWS APIs** | Interface programática para operações de serviços AWS. | [Azion API](https://www.azion.com/pt-br/documentacao/devtools/api/) |
| **AWS CLI** | Interface de linha de comando para gerenciar serviços AWS. | [Azion CLI](https://www.azion.com/pt-br/documentacao/devtools/cli/) |
| **AWS SDKs** | SDKs específicos por linguagem para criar integrações com serviços AWS. | [SDK](https://www.azion.com/pt-br/documentacao/devtools/sdk/) |
| **AWS CloudFormation** | Serviço de Infrastructure as Code para modelar e provisionar recursos AWS. | [Terraform Provider](https://www.azion.com/pt-br/documentacao/devtools/terraform/) |
| **Lambda runtime environment** | Camada de runtime usada por funções Lambda. | [Azion Runtime](https://www.azion.com/pt-br/documentacao/devtools/runtime/) |
...
* [Variáveis de Ambiente](https://www.azion.com/pt-br/documentacao/guias/)
...
* [Azion referência de variáveis de ambiente de runtime](https://www.azion.com/pt-br/documentacao/build/functions/environment-variables/)
...
* [Applications](https://www.azion.com/pt-br/documentacao/plataforma/applications/)
* [Applications configurações principais](https://www.azion.com/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/definir-configuracoes-principais/)
...
* [JavaScript Runtime APIs referência](https://www.azion.com/pt-br/documentacao/devtools/runtime/api-reference/javascript/)
...
* [Load Balancer](https://www.azion.com/pt-br/documentacao/plataforma/load-balancer/)
* [Connectors](https://www.azion.com/pt-br/documentacao/plataforma/connectors/)
* [Application configurações principais](https://www.azion.com/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/definir-configuracoes-principais/)
...
* [AI Inference modelos](https://www.azion.com/en/documentation/build/ai-inference/models/)
* [AI Inference Starter Kit](https://www.azion.com/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/ai-inference-starter-kit/)
...
Crie um workload no Azion Console e associe seu domínio customizado. Veja a [documentação de Workloads](https://www.azion.com/pt-br/documentacao/plataforma/workloads/).
...
* [Crie um domínio customizado Azion](https://www.azion.com/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/criar-dominio-personalizado-azion/)
* [Edge DNS](https://www.azion.com/pt-br/documentacao/secure/edge-dns/)
* [Certificate Manager](https://www.azion.com/pt-br/documentacao/plataforma/certificate-manager/para-firewall/)
...
* [Edge DNS](https://www.azion.com/pt-br/documentacao/secure/edge-dns/)
* [Compatibilidade DNSSEC](https://www.azion.com/pt-br/documentacao/secure/edge-dns/compatibilidade-dnssec/)
* [Execute o comando dig](https://www.azion.com/pt-br/documentacao/guias/seguranca-de-aplicacoes/dns/executar-o-comando-dig/)
* [Execute o comando traceroute](https://www.azion.com/pt-br/documentacao/guias/seguranca-de-aplicacoes/dns/executar-o-comando-traceroute/)
...
4. Veja o [guia de configuração mTLS](/pt-br/documentacao/guias/seguranca-de-aplicacoes/tls-e-certificados/mtls/) para passos detalhados.
...
* [Certificate Manager](https://www.azion.com/pt-br/documentacao/plataforma/certificate-manager/para-firewall/)
* [Crie um certificado digital](https://www.azion.com/pt-br/documentacao/guias/seguranca-de-aplicacoes/tls-e-certificados/criar-certificado-digital/)
* [mTLS](https://www.azion.com/pt-br/documentacao/plataforma/certificate-manager/mtls/)
...
* [Functions para Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/functions/)
...
* [DDoS Mitigation](https://www.azion.com/pt-br/documentacao/plataforma/ddos-protection/ddos-mitigation/)
...
* [Bot Manager Lite integration kit](https://www.azion.com/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/integracoes/bot-manager-lite-integration-kit/)
* [Radware Bot Manager](https://www.azion.com/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/integracoes/radware-bot-manager/)
...
* [Rules Engine para Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/rules-engine/)
* [Functions para Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/functions/)
* [Functions Instances para Firewall](https://www.azion.com/pt-br/documentacao/plataforma/firewall/functions-instances/)
...
* [Network Lists](https://www.azion.com/pt-br/documentacao/secure/network-shield/network-lists/)
...
* [Object Storage](https://www.azion.com/pt-br/documentacao/store/object-storage/)
* [Como acessar Object Storage usando protocolo S3](https://www.azion.com/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/protocolo-s3-para-object-storage/)
...
* [Faça upload e download de objetos](https://www.azion.com/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/upload-e-download-de-objetos-do-bucket/)
...
* [Referência da biblioteca Storage](https://www.azion.com/pt-br/documentacao/devtools/azion-lib/storage/)
...
Para workloads key-value, use KV Store de dentro de uma função:

<Code client:visible lang="javascript" code={`
// Azion.KV é um global do runtime. Não existe linha de import.
...
* [SQL Database](https://www.azion.com/pt-br/documentacao/store/sql-database/)
* [Crie um banco de dados](https://www.azion.com/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/gerenciar-bancos-dados-edge-sql/)
* [Instale SQL Shell](https://www.azion.com/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/install-edge-sql-shell/)
* [Importe dados para SQL Database](https://www.azion.com/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/importar-dados-edge-sql/)
...
* [SQL Database](https://www.azion.com/pt-br/documentacao/store/sql-database/)
* [Vector Search](https://www.azion.com/pt-br/documentacao/store/sql-database/vector-search/)
* [Crie um banco de dados](https://www.azion.com/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/gerenciar-bancos-dados-edge-sql/)
* [Instale SQL Shell](https://www.azion.com/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/install-edge-sql-shell/)
* [Comandos SQL Database Shell](https://www.azion.com/pt-br/documentacao/store/sql-database/edgesql-shell/)
* [Importe dados para SQL Database](https://www.azion.com/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/importar-dados-edge-sql/)
* [Referência da API SQL Database](https://www.azion.com/pt-br/documentacao/devtools/runtime/api-reference/sql-database/)
...
| **Engines** | Redis, Memcached | Cache HTTP | `Azion.KV`, de dentro de uma função |
| **Persistência** | Opcional (Redis AOF/RDB) | TTL baseado em tempo | Persistente |
| **Estruturas de dados** | Strings, hashes, lists, sets, sorted sets | Respostas HTTP | Um value por key: string, objeto, ArrayBuffer ou stream |
...
Para operações key-value, use KV Store de dentro de uma função:
...
// Depois: KV Store put com expiração
...
* [Real-Time Metrics primeiros passos](https://www.azion.com/pt-br/documentacao/plataforma/real-time-metrics/primeiros-passos/)
* [Historical Real-Time Metrics](https://www.azion.com/pt-br/documentacao/plataforma/real-time-metrics/real-time-metrics-historico/)
* [Analise métricas](https://www.azion.com/pt-br/documentacao/guias/plataforma/observabilidade/analisar-metricas/)
* [Dashboards customizados do plugin Grafana](https://www.azion.com/pt-br/documentacao/guias/plataforma/observabilidade/azion-plugin-grafana/)
* [Dashboards prontos do plugin Grafana](https://www.azion.com/pt-br/documentacao/guias/plataforma/observabilidade/azion-plugin-grafana-dash-pre-configurado/)
...
* [Real-Time Events](https://www.azion.com/pt-br/documentacao/observe/real-time-events/)
* [Real-Time Events primeiros passos](https://www.azion.com/pt-br/documentacao/observe/real-time-events/primeiros-passos/)
* [Investigue requisições com GraphQL API](https://www.azion.com/pt-br/documentacao/guias/plataforma/observabilidade/investigar-requisicoes-api-graphql/)
* [Configure sampling](https://www.azion.com/pt-br/documentacao/guias/plataforma/observabilidade/configurar-sampling/)
...
* Connectors: [Amazon S3](https://www.azion.com/pt-br/documentacao/guias/plataforma/observabilidade/amazon-s3-endpoint/), [Azion Object Storage](https://www.azion.com/pt-br/documentacao/guias/plataforma/observabilidade/conector-azion-object-storage/), [Datadog](https://www.azion.com/pt-br/documentacao/guias/plataforma/observabilidade/datadog-endpoint/), [Splunk](https://www.azion.com/pt-br/documentacao/guias/plataforma/observabilidade/splunk-endpoint/), [Elasticsearch](https://www.azion.com/pt-br/documentacao/guias/plataforma/observabilidade/elasticsearch-endpoint/), [Kinesis](https://www.azion.com/pt-br/documentacao/guias/plataforma/observabilidade/amazon-kinesis-endpoint/), [BigQuery](https://www.azion.com/pt-br/documentacao/guias/plataforma/observabilidade/google-bigquery-endpoint/)
...
| Consultas DynamoDB falham após migração | Sintaxe da API KV Store difere | Abra o cliente com `await Azion.KV.open(nome)`, um global do runtime que não precisa de import; confira convenções de nome de chave |
...
* Configure [Data Stream](https://www.azion.com/pt-br/documentacao/observe/data-stream/) para exportar logs para suas ferramentas existentes de SIEM ou analytics
