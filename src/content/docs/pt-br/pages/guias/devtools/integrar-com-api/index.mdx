...
O objetivo é mostrar os valores TTL para cache do navegador e cache do edge, informados pelas propriedades `browser_cache_settings_maximum_ttl` e `cdn_cache_settings_maximum_ttl` na [API de Cache Settings](https://api.azion.com/#fc4c8368-a64d-4743-9064-58e03786edf4). Para fazer isso:
