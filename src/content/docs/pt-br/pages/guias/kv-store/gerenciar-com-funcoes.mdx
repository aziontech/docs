...
description: >-
  ...
  suas edge functions.
meta_tags: 'kv store, armazenamento, chave-valor, edge functions, dados'
...
Este guia mostra como interagir com o KV Store a partir de suas edge functions 
para armazenar, recuperar e excluir dados chave-valor no edge.
...
- [Functions habilitadas](/pt-br/documentacao/produtos/build/edge-application/edge-functions/) em sua edge application.
...
Siga estes passos para criar uma edge function que se comunica com o KV Store:
...
Após criar sua função, você precisa instanciá-la em sua edge application:
