...
<LinkButton link="/pt-br/documentacao/produtos/guias/build/instanciar-functions/" label="Ir para como instanciar functions em sua aplicação" severity="secondary" />
