...
<DocButton href="/pt-br/documentacao/produtos/store/kv-store/" label="Ir para referência do KV Store" kind="secondary" size="medium" />
...
- [Functions habilitadas](/pt-br/documentacao/produtos/build/applications/functions/) em sua Application.
...
<DocButton href="/pt-br/documentacao/produtos/guias/build/instanciar-functions/" label="Ir para como instanciar functions em sua aplicação" kind="secondary" size="medium" />
...
- Explore as [Functions](/pt-br/documentacao/produtos/build/applications/functions/)
