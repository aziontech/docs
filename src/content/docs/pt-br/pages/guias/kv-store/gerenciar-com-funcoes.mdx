---
title: Gerencie KV Store com Functions
description: >-
  Armazene, recupere e exclua dados de chave-valor dentro de uma função com o
  cliente do KV Store.
...
<DocButton href="/pt-br/documentacao/store/kv-store/" label="Ir para referência do KV Store" kind="secondary" size="medium" />
...
- [Functions habilitadas](/pt-br/documentacao/build/functions/) em sua Application.
- Um namespace do KV Store criado via Console ou API.

---

## Crie uma função que alcança o KV Store
...
<DocButton href="/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/instanciar-functions/" label="Ir para como instanciar functions em sua aplicação" kind="secondary" size="medium" />

---

## Próximos passos

- Saiba mais sobre o [KV Store](/pt-br/documentacao/store/kv-store/)
- Explore as [Functions](/pt-br/documentacao/build/functions/)
