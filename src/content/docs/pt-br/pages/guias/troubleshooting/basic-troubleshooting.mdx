...
:::tip
O **Request ID** é o mesmo identificador exibido na página de erro da Azion, na seção **Error Details**. Para uma descrição de todos os campos dessa página e o significado de cada código de status HTTP, consulte [Códigos de Status de Erro HTTP](/pt-br/documentacao/servicos/suporte/http-error-status-codes/).
:::
