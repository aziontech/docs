...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/investigacao-problemas-basico/
---
...
:::tip
Consulte a [documentação da API GraphQL](/pt-br/documentacao/devtools/graphql/visao-geral/) para mais informações.
:::
...
:::tip
O **Request ID** é o mesmo identificador exibido na página de erro da Azion, na seção **Error Details**. Para uma descrição de todos os campos dessa página e o significado de cada código de status HTTP, consulte [Códigos de Status de Erro HTTP](/pt-br/documentacao/suporte/http-error-status-codes/).
:::
