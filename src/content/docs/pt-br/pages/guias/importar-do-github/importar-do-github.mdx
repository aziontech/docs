...
description: Esta documentação ajuda você a importar seu próprio repositório do GitHub para construir e implantar uma aplicação no edge da Azion.
...
7. Na seção **Variables**, você pode adicionar variáveis de projeto conforme necessário.
...
8. Clique no botão **Salvar** para iniciar a implantação.
