...
> Se você não tiver um WAF Rule Set configurado, leia esta documentação sobre [Web Application Firewall Rule Sets](/en/documentation/products/edge-firewall/waf-rule-sets/).
