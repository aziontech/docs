...
Edge Function Hello World está disponível na biblioteca de functions da plataforma de Edge Computing da Azion e pode ser acessada pelo Azion Console, no menu *Libraries*.
