...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/hospedagem-edge-site/
---
...
Com a Function Hello World, você pode criar páginas de erro ou status que podem ser utilizadas para monitorar ou informar a situação de determinado serviço, em tempo real, diretamente no Edge, com alta disponibilidade e baixa latência.
...
Algumas outras vantagens de utilizar a Function Hello World:
