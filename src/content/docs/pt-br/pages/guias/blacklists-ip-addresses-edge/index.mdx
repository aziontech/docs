...
## Crie um Edge Firewall Rule Set
...
1. Acesse o [Real-Time Manager (RTM)](https://manager.azion.com).
2. Abra o **Products menu**, representado pelas três linhas horizontais, na seção **Edge Libraries** selecione **Network Lists**, from the **Edge Libraries** section.
...
## Associe a Network List ao Edge Firewall Rule Set

1. Acesse o [Real-Time Manager (RTM)](https://manager.azion.com).
2. Abra o **Products menu**, representado pelas três linhas horizontais, e selecione **Edge Firewall**.
3. Selecione o **Edge Firewall Rule Set** que você criou ou configurou na [primeira seção](#crie-um-edge-firewall-rule-set).
