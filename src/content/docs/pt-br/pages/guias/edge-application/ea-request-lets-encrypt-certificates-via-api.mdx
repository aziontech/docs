...
permalink: /documentacao/guias/seguranca-de-aplicacoes/tls-e-certificados/como-gerar-um-certificado-lets-encrypt-via-api/
---
...
A API V4 da Azion oferece emissão e renovação de [certificados Let's Encrypt](/pt-br/documentacao/plataforma/certificate-manager/para-firewall/) utilizando dois métodos de validação:
...
Para mais informações sobre essas atualizações visite a documentação de [Certificate Manager](/pt-br/documentacao/plataforma/certificate-manager/para-firewall/).
...
2. Configure o registro CNAME `_acme-challenge` no seu provedor de DNS conforme descrito no guia [Como gerar um certificado Let's Encrypt para o seu domínio](/pt-br/documentacao/guias/seguranca-de-aplicacoes/tls-e-certificados/como-gerar-um-certificado-lets-encrypt/#opcao-2-preparar-a-entrada-de-dns-com-um-provedor-de-dns-externo).

3. Crie ou use um Token existente de API (ver [Primeiros passos com a API da Azion](https://www.azion.com/pt-br/documentacao/devtools/api/)).
...
2. Garanta que o DNS para tal hostname esteja apontado para Azion (ver [Como apontar seu domínio para a Azion](/pt-br/documentacao/guias/plataforma/migracao/apontar-dominio-para-a-azion/)). Isso deve ser feito no seu serviço provedor de DNS.
...
3. Uma vez que o DNS responda corretamente, crie ou use um Token existente de API (ver [Primeiros passos com a API da Azion](https://www.azion.com/pt-br/documentacao/devtools/api/)).
