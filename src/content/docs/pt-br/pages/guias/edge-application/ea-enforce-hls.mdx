...
<DocButton href="/pt-br/documentacao/arquiteturas/live-streaming-delivery/live-streaming-delivery-com-hls/" label="Consulte a arquitetura de Live Streaming Delivery" kind="secondary" size="medium" />
