...
- Uma application existente na Azion, ou [crie uma nova](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/criar-uma-aplicacao/).
- [Um domínio associado à application](/pt-br/documentacao/guias/plataforma/migracao/configurar-dominio/).
- [Tiered Cache habilitado](/pt-br/documentacao/guias/plataforma/conta-e-billing/billing-and-subscriptions/) em sua conta.
- Acesso ao [Object Storage da Azion](/pt-br/documentacao/store/object-storage/) para armazenar conteúdo de vídeo.
...
1. Abra a [Azion CLI](/pt-br/documentacao/devtools/cli/) no seu terminal.
...
:::tip
Leia mais sobre a configuração de [cache settings](/pt-br/documentacao/build/cache/cache-settings/) para suas applications.
:::
...
:::tip
Acesse a documentação do [Rules Engine for Applications](/pt-br/documentacao/plataforma/applications/rules-engine/) para mais detalhes.
:::

<DocButton href="/pt-br/documentacao/guias/performance-e-confiabilidade/otimizacao-de-entrega/live-streaming-delivery-com-hls/" label="Consulte a arquitetura de Live Streaming Delivery" kind="secondary" size="medium" />
