...
4. Selecione a aplicação que deseja configurar ou [crie uma nova](/pt-br/documentacao/produtos/guias/build/criar-uma-aplicacao/).
...
<LinkButton link="/pt-br/documentacao/produtos/build/edge-application/rules-engine/#bypass-cache" label="Saiba mais sobre Bypass Cache" outlined />
