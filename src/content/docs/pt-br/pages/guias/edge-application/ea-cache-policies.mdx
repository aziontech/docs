...
<DocButton href="/pt-br/documentacao/produtos/build/applications/rules-engine/#bypass-cache" label="Saiba mais sobre Bypass Cache" kind="secondary" size="medium" />
