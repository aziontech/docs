...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/erros-cors/
---
...
Para resolver esse tipo de erro, você precisa configurar o browser no **Azion Console** usando o [Rules Engine](/pt-br/documentacao/plataforma/applications/rules-engine/).
...
1. Acesse o [Console](/pt-br/documentacao/guias/plataforma/conta-e-billing/como-acessar-o-azion-console/) > **Applications**.
