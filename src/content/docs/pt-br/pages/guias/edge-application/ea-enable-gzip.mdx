...
permalink: /documentacao/guias/performance-e-confiabilidade/otimizacao-de-entrega/gzip-compression/
---
...
Você pode habilitar a compressão gzip para qualquer application usando o [Rules Engine para Applications](/pt-br/documentacao/plataforma/applications/rules-engine/).
