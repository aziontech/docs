...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/personalizar-pagina-resposta-erro/
---
...
Existem instruções separadas para API v3 usando configurações de [Error Responses legados](/pt-br/documentacao/plataforma/custom-pages/error-responses/) e API v4 usando o novo produto [Custom Pages](/pt-br/documentacao/plataforma/custom-pages/).
...
4. Selecione o **Page Code**, que representa o código recebido do Connectors ao buscar seu conteúdo.
5. Selecione o **Connectors**.
