...
description: Melhore a performance da sua aplicação e APIs configurando políticas de cache de uma página dependendo da Query String ou Cookie com Application Accelerator para Edge Application.
