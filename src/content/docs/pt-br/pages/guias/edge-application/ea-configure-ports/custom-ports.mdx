...
description: Configure combinações de portas HTTP e HTTPS de entrega e origem com Azion Edge Application.
...
8. Na seção **Behaviors**, selecione o comportamento **Set Origin**.
9. Selecione a origem criada nas instruções anteriores.
