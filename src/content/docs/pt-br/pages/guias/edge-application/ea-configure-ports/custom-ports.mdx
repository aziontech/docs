...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/configurar-portas/
---
...
Existem instruções separadas para API v3 usando configurações de [Origins legados](/pt-br/documentacao/plataforma/connectors/origins/) e API v4 usando o novo produto [Connectors](/pt-br/documentacao/plataforma/connectors/).
...
2. Selecione o Connectors que você deseja configurar.
...
1. Acesse o [Azion Console](/pt-br/documentacao/guias/plataforma/conta-e-billing/como-acessar-o-azion-console/) > **Connectors**.
2. Em **Connectors**, selecione um Connector existente ou adicione um novo.
3. Preencha os campos necessários.
...
6. Acesse o [Azion Console](/pt-br/documentacao/guias/plataforma/conta-e-billing/como-acessar-o-azion-console/) > **Workloads**.
...
:::tip
Você também pode usar o **Rules Engine** e [criar uma regra](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/trabalhar-com-rules-engine/) utilizando o comportamento **Redirect HTTP to HTTPS** para prevenir que seus usuários acessem a aplicação através do protocolo HTTP dado um cenário específico.
:::
...
5. Em **Address**, digite o nome do host de sua origem. Exemplo: `yourorigin.com`.
6. Clique no botão **Save**.
7. Acesse o [Azion Console](/pt-br/documentacao/guias/plataforma/conta-e-billing/como-acessar-o-azion-console/) > **Workloads**.
...
2. Acesse o [Azion Console](/pt-br/documentacao/guias/plataforma/conta-e-billing/como-acessar-o-azion-console/) > **Connectors**.
3. Clique no botão **+ Connectors**.
4. Dê um nome fácil de lembrar para seu Connectors. Exemplo: `myconnector:8080`.
...
8. Na seção **Behaviors**, selecione o comportamento **Set Connectors**.
9. Selecione o Connectors criado nas instruções anteriores.
10. Clique no botão **Save**.
