...
description: Você pode usar GraphQL, Data Stream ou Real-Time Events para fazer o debug de regras criadas na Rules Engine de Edge Application ou Edge Firewall.
meta_tags: regras, graphql, Data Stream, real time events, edge application, edge firewall, rules engine
...
> Consulte a [documentação de Data Stream](/pt-br/documentacao/produtos/data-stream/) para mais informações sobre como configurar um endpoint de Data Stream.
...
4. Dê um nome para seu Data Stream.
...
Para visualizar todos os seus Data Streams, vá para a página de **Data Stream** no Azion Console e selecione um a partir da lista exibida. Você pode criar diversos Data Streams.
