...
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/debug-regras/
---
...
<DocButton href="/pt-br/documentacao/plataforma/applications/rules-engine/" label="Saiba mais sobre Rules Engine" kind="secondary" size="medium" />
...
:::tip
Consulte a [documentação da GraphQL API](/pt-br/documentacao/devtools/graphql/visao-geral/) para mais informações.
:::

Para consultar os dados sobre regras disponibilizados pela **GraphQL API**, siga os passos descritos no guia [Como rodar requisições da GraphQL no Postman](/pt-br/documentacao/guias/plataforma/observabilidade/consultar-graphql-postman/) utilizando a URL `https://api.azionapi.net/events/graphql`.
...
Para saber mais sobre como consultar dados com a **API GraphQL**, visite a [página de documentação](/pt-br/documentacao/devtools/graphql/recursos/#conjuntos-de-dados).
...
:::tip
Consulte a [documentação de Data Stream](/pt-br/documentacao/observe/data-stream/) para mais informações sobre como configurar um endpoint de Data Stream.
:::
...
8. Em **Workloads**, selecione entre **Filter Workloads** ou **All Current and Future Workloads**. Veja mais sobre cada opção em [Como associar workloads no Data Stream](/pt-br/documentacao/guias/plataforma/observabilidade/data-stream-associar-workloads/).
...
8. Em **Domains**, selecione **Filter Domains** ou **All Current and Future Domains**. Veja mais sobre cada opção em [Como associar domínios no Data Stream](/pt-br/documentacao/guias/plataforma/observabilidade/data-stream-associar-dominios/).
...
Para confirmar que seus logs estão sendo enviados, você pode utilizar o [Real-Time Events](/pt-br/documentacao/observe/real-time-events/) para consultar análises detalhadas.
...
:::tip
Consulte a [documentação de Real-Time Events](/pt-br/documentacao/observe/real-time-events/) para mais informações sobre seu funcionamento.
:::
