...
8. Em **Workloads**, selecione **Filter workloads** ou **All Current and Future workloads**. Veja mais sobre cada opção em [Como associar domínios no Data Stream](/pt-br/documentacao/produtos/guias/data-stream-associar-dominios/).
