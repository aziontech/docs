...
## Realize debug de regras usando Data Streaming
...
Para visualizar todos os seus data streamings, vá para a página de **Data Streaming** no Azion Console e selecione um a partir da lista exibida. Você pode criar diversos data streamings.
