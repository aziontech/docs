...
<Button href="https://console.azion.com/signup" label="crie uma conta na Azion" type="primary" theme="light" /> <br></br>

<Button href="/pt-br/documentacao/produtos/guias/secure/edge-dns-definir-main-settings/" label="crie uma zona" type="primary" theme="light" />
...
<Button href="/pt-br/documentacao/produtos/guias/secure/balanceamento-de-carga-dns/" label="teste o registro balanceado" type="primary" theme="light" />
