...
1. Crie um arquivo de texto para armazenar os domínios de interesse. Exemplo: `workloads.txt`.
...
`dig @8.8.8.8 azion.com` ou `dig @8.8.8.8 workloads.txt`
