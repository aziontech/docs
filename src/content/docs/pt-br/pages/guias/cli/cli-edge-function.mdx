...
Agora, crie uma nova edge function diretamente pela **CLI**, sem precisar recorrer ao **Azion Console**.
...
Note que a função `my-new-ef`, cujo ID era *6823*, não aparece mais na lista. Você pode acessar o **Azion Console* para analisar os resultados dos comandos da CLI apresentados neste exemplo.
