...
- Criar um *personal token* no **Azion Console** e configurá-lo na **CLI**. Veja o tópico [Autorização na Plataforma da Azion](/pt-br/documentacao/produtos/cli/primeiros-passos/#autorizacao).
