...
description: >-
  Descubra como a funcionalidade Autocomplete da Azion CLI pode aumentar sua
  eficiência ao digitar comandos, facilitando o desenvolvimento de projetos.
permalink: /documentacao/produtos/guias/cli-auto-complete/
meta_tags: >-
  Azion CLI, Autocomplete CLI, instalar CLI, comandos CLI, Azion autocomplete,
  eficiência de comandos, tecla tab CLI, desenvolvimento Azion, azioncli
  edge_applications
