...
Você pode utilizar o [processo de debugging](/pt-br/documentacao/build/functions/) para identificar erros em suas functions. Uma das opções para debugging é utilizar a [GraphQL⁠ API](/pt-br/documentacao/devtools/graphql/visao-geral/).

Para isso, siga os passos descritos no guia [Como rodar requisições da GraphQL no Postman](/pt-br/documentacao/guias/plataforma/observabilidade/consultar-graphql-postman/) utilizando a URL `https://api.azionapi.net/events/graphql`.
