...
meta_tags: >-
  servidor MCP, Azion, protocolo de contexto de modelo, JSON-RPC, comunicação padronizada, ferramentas de AI, escalabilidade elástica, alta disponibilidade, soberania de dados, implementação rápida e segura
namespace: documentation_products_guides_mcp
permalink: /documentacao/guias/desenvolvimento-de-aplicacoes/automacao/executar-mcp-server/
---
...
Neste guia, criaremos uma [Function](/pt-br/documentacao/build/functions/) para executar o servidor MCP.
...
2. No menu do canto superior esquerdo, selecione **Functions**
