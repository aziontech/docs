...
7. Para cada domínio em **Accepted workloads** do rule set antigo, clique no botão **+ Add Criteria** e repita o passo 6.
...
1. Acesse o [Azion Console](/pt-br/documentacao/produtos/guias/como-acessar-o-azion-console/) > **Edge Firewall**.
2. Selecione o firewall que você criou anteriormente.
3. Na aba **Main Settings**, vá para a seção **Workloads**.
