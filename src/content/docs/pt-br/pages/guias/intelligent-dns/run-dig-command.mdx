...
<LinkButton outlined link="https://console.azion.com/signup/" label="crie uma conta na Azion" variant="secondary" /> <br></br>

<LinkButton outlined link="/pt-br/documentacao/produtos/guias/secure/edge-dns-definir-main-settings/" label="crie uma zona" variant="secondary" />
...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/secure/balanceamento-de-carga-dns/" label="teste o registro balanceado" variant="secondary" />
