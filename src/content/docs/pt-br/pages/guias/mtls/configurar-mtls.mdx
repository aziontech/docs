...
1. Ainda no Console, selecione **Products menu** > **Workloads**.
...
3. Em **Workloads**, selecione o domínio da sua aplicação e cliquei no botão `>`, para mandar o domínio escolhido para **Selected**.
4. Clique em **Save**.
