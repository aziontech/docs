...
permalink: /documentacao/guias/seguranca-de-aplicacoes/tls-e-certificados/mtls/
---
...
Mais informações sobre requisitos, certificados digitais, Trusted CA e como mTLS funciona na Azion estão disponíveis na página [Suporte para mTLS](/pt-br/documentacao/plataforma/certificate-manager/mtls/).
...
<DocButton href="/pt-br/documentacao/plataforma/applications/rules-engine/" label="consulte a lista de variáveis disponíveis" kind="secondary" size="medium" />
