...
Mais informações sobre requisitos, certificados digitais, Trusted CA e como mTLS funciona na Azion estão disponíveis na página [Suporte para mTLS](/pt-br/documentacao/produtos/build/edge-application/domains/mtls/).
...
1. Acesse o [Azion Console](https://console.azion.com) e clique no **Products Menu**, indicado pelo ícone ☰. Busque pela categoria **Edge Libraries** e clique em **Digital Certificates**.
