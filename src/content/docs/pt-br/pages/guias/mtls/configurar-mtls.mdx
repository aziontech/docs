...
1. Acesse o [Real-Time Manager (RTM)](https://console.azion.com) e clique no **Products Menu**, indicado pelo ícone ☰. Busque pela categoria **Edge Libraries** e clique em **Digital Certificates**.
