...
description: >-
  Descubra como criar e instanciar Functions utilizando WebAssembly na
...
meta_tags: >-
  Functions, WebAssembly, desenvolvimento Edge, instanciar funções, Azion
  plataformas, WebAssembly tutorial, criação de Functions, Azion
  Applications, código WebAssembly, Azion Console
namespace: documentation_dev_with_azion_lang_wasm
---



Saiba mais sobre o processo necessário para a criação de uma [function](/pt-br/documentacao/build/functions/) que utiliza uma função originada de um arquivo [WebAssembly](https://webassembly.org/getting-started/developers-guide/).
...
Agora, a função está pronta para ser instanciada em uma application. Veja como [instanciar e executar as funções em sua application](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/instanciar-functions/).
