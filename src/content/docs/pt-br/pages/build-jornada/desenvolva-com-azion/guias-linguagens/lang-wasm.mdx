...
description: Descubra como criar e instanciar Edge Functions utilizando WebAssembly
  na plataforma Azion, otimizando aplicações Edge com eficiência.
permalink: /documentacao/produtos/build/desenvolvimento-azion/linguagens/wasm/
meta_tags: Edge Functions, WebAssembly, desenvolvimento Edge, instanciar funções,
  Azion plataformas, WebAssembly tutorial, criação de Edge Functions, Azion Edge Application,
  código WebAssembly, Azion Console
