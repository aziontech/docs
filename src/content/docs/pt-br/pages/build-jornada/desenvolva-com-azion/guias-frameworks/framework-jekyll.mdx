---
title: Como realizar o deploy de uma aplicação Jamstack com Jekyll
description: >-
  Descubra como implantar e gerenciar projetos Jekyll na plataforma Edge da Azion
  utilizando Edge Functions, desde a inicialização até a implantação e execução.
permalink: /documentacao/produtos/cli/frameworks/jekyll/
meta_tags: >-
  Jekyll, Jamstack, Azion Edge Functions, deploy Jekyll, Azion CLI, desenvolvimento
...
Jekyll está listado na [documentação do Jamstack](https://jamstack.org/generators/jekyll/) como um gerador de site estático, alinhado à abordagem Jamstack.

Saiba mais sobre o [Jekyll](https://jekyllrb.com/docs/).
...
Agora, a CLI do Jekyll seguirá o processo e inicializará o seu projeto.
...
2. No navegador, vá para `http://localhost:3333/` e você verá o seu projeto Jekyll em execução.
