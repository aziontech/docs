...
description: Descubra como implantar e gerenciar projetos Hexo na plataforma Edge
  da Azion utilizando Edge Functions, desde a inicialização até a implantação e execução.
permalink: /documentacao/produtos/cli/frameworks/hexo/
meta_tags: Hexo, Jamstack, Azion Edge Functions, deploy Hexo, Azion CLI, desenvolvimento
  local, Edge platform, implantação de projeto, static site generator, Azion plataforma
