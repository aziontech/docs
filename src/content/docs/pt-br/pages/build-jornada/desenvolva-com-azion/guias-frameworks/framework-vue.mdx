...
meta_tags: >-
  Vue, Jamstack, Azion Edge Platform, Iniciar projeto Vue, Edge Functions,
...
:::note 
Uma vez que o deploy é iniciado, a Azion abrirá o navegador e levará o usuário a uma página no Azion Console onde os logs e o processo de implantação podem ser monitorados. Se não abrir automaticamente, basta clicar no link fornecido.
