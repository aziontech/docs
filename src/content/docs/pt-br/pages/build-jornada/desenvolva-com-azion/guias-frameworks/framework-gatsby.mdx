...
description: >-
  Descubra como implantar e gerenciar projetos Gatsby na plataforma Edge da Azion
  utilizando Edge Functions, desde a inicialização até a implantação e execução.
permalink: /documentacao/produtos/cli/frameworks/gatsby/
meta_tags: >-
  Gatsby, Jamstack, Azion Edge Functions, deploy Gatsby, Azion CLI, desenvolvimento
...
Gatsby está listado na [documentação do Jamstack](https://jamstack.org/generators/gatsby/) como um gerador de site estático, alinhado à abordagem Jamstack.

Saiba mais sobre o [Gatsby](https://www.gatsbyjs.com/docs/).
...
Agora, a CLI do Gatsby seguirá o processo e inicializará o seu projeto.
...
2. No navegador, vá para `http://localhost:3333/` e você verá o seu projeto Gatsby em execução.
