...
description: Faça o deploy de uma aplicação Jamstack com Next.
meta_tags: next, js, jamstack
...
:::note
Este guia aborda a inicialização de um projeto estático Next.js. O projeto é sempre inicializado na última versão do Next.js para o modo deliver (static).
:::
...
4. Selecione a opção `latest (static supported)`: 
...
2. No navegador, vá para `http://localhost:3000/` e você verá o seu projeto Next em execução.
