...
description: Aprenda como implantar projetos Jamstack usando Next.js na plataforma
  da Azion com Edge Functions, incluindo etapas de desenvolvimento e implantação.
permalink: /documentacao/produtos/cli/frameworks/next/
meta_tags: Azion Edge Functions, Next.js, tutorial, Jamstack deploy, Azion CLI, Web
  development, iniciar projeto Next, desenvolvimento local, implantação de projetos,
  práticas Edge Computing
