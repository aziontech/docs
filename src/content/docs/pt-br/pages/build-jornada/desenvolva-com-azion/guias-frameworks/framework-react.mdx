...
description: Aprenda a iniciar e implantar um projeto React na plataforma da Azion
  usando Edge Functions para um desenvolvimento eficiente e escalável.
permalink: /documentacao/produtos/cli/frameworks/react/
meta_tags: React, Jamstack, Azion Edge Functions, Azion CLI, desenvolvimento local,
  deploy React, plataforma Azion, aplicação estática, gerador de site estático, iniciar
  projeto React
