...
description: >-
  ...
  Edge Functions para um desenvolvimento eficiente e escalável.
permalink: /documentacao/produtos/cli/frameworks/react/
meta_tags: >-
  React, Jamstack, Azion Edge Functions, Azion CLI, desenvolvimento local,
  deploy React, plataforma Azion, aplicação estática, gerador de site estático,
...
Agora, a CLI do React seguirá o processo e inicializará o seu projeto.
...
2. No navegador, vá para `http://localhost:3000/` e você verá o seu projeto React em execução.
