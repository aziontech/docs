...
description: >-
  Descubra como implantar e gerenciar projetos Hugo na plataforma Edge da Azion
  utilizando Edge Functions, desde a inicialização até a implantação e execução.
permalink: /documentacao/produtos/cli/frameworks/hugo/
meta_tags: >-
  Hugo, Jamstack, Azion Edge Functions, deploy Hugo, Azion CLI, desenvolvimento
...
Hugo está listado na [documentação do Jamstack](https://jamstack.org/generators/hugo/) como um gerador de site estático, alinhado à abordagem Jamstack.

Saiba mais sobre o [Hugo](https://gohugo.io/documentation/).
...
Agora, a CLI do Hugo seguirá o processo e inicializará o seu projeto.
...
2. No navegador, vá para `http://localhost:3333/` e você verá o seu projeto Hugo em execução.
