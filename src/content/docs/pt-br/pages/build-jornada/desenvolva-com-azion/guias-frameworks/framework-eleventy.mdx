...
description: >-
  Descubra como implantar e gerenciar projetos Eleventy na plataforma Edge da Azion
  utilizando Edge Functions, desde a inicialização até a implantação e execução.
permalink: /documentacao/produtos/cli/frameworks/eleventy/
meta_tags: >-
  Eleventy, Jamstack, Azion Edge Functions, deploy Eleventy, Azion CLI, desenvolvimento
...
Eleventy está listado na [documentação do Jamstack](https://jamstack.org/generators/eleventy/) como um gerador de site estático, alinhado à abordagem Jamstack.

Saiba mais sobre o [Eleventy](https://www.11ty.dev/).
...
## Inicializar um projeto Eleventy
...
3. Escolha o preset do Eleventy:
...
Agora, a CLI do Eleventy seguirá o processo e inicializará o seu projeto.
...
2. No navegador, vá para `http://localhost:3333/` e você verá o seu projeto Eleventy em execução.
