...
description: >-
  Descubra como implantar e gerenciar projetos Svelte na plataforma Edge da Azion
  utilizando Edge Functions, desde a inicialização até a implantação e execução.
permalink: /documentacao/produtos/cli/frameworks/svelte/
meta_tags: >-
  Svelte, Jamstack, Azion Edge Functions, deploy Svelte, Azion CLI, desenvolvimento
...
Saiba mais sobre o [Svelte](https://svelte.dev/docs/introduction).
...
Agora, a CLI do Svelte seguirá o processo e inicializará o seu projeto.
...
2. No navegador, vá para `http://localhost:3333/` e você verá o seu projeto Svelte em execução.
