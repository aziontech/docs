...
description: >-
  Descubra como implantar e gerenciar projetos Docusaurus na plataforma Edge da Azion
  utilizando Edge Functions, desde a inicialização até a implantação e execução.
permalink: /documentacao/produtos/cli/frameworks/docusaurus/
meta_tags: >-
  Docusaurus, Jamstack, Azion Edge Functions, deploy Docusaurus, Azion CLI, desenvolvimento
...
Docusaurus está listado na [documentação do Jamstack](https://jamstack.org/generators/docusaurus/) como um gerador de site estático, alinhado à abordagem Jamstack.

Saiba mais sobre o [Docusaurus](https://docusaurus.io/docs/).
...
## Inicializar um projeto Docusaurus
...
3. Escolha o preset do Docusaurus:
...
Agora, a CLI do Docusaurus seguirá o processo e inicializará o seu projeto.
...
2. No navegador, vá para `http://localhost:3333/` e você verá o seu projeto Docusaurus em execução.
