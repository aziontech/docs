...
description: Aprenda a implantar e gerenciar uma aplicação Angular na plataforma Azion
  com Edge Functions. Passo a passo desde a criação à implantação.
permalink: /documentacao/produtos/cli/frameworks/angular/
meta_tags: Angular, Jamstack, Azion, Edge Functions, deploy Angular, Angular CLI,
  desenvolvimento local, implantação projeto, Azion plataforma, criar conta Azion
