...
description: >-
  ...
  Edge Functions. Passo a passo desde a criação à implantação.
permalink: /documentacao/produtos/cli/frameworks/angular/
meta_tags: >-
  Angular, Jamstack, Azion, Edge Functions, deploy Angular, Angular CLI,
  desenvolvimento local, implantação projeto, Azion plataforma, criar conta
  Azion
...
3. Escolha o template do Angular: 
...
Agora, a CLI do Angular seguirá o processo e inicializará o seu projeto.
...
2. No navegador, vá para `http://localhost:3000/` e você verá o seu projeto Angular em execução.
