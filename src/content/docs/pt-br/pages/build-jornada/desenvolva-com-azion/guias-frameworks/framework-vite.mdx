...
description: >-
  Descubra como implementar uma aplicação Jamstack usando Vite na plataforma
  Azion com Edge Functions. Aprenda sobre o deploy e desenvolvimento local.
permalink: /documentacao/produtos/cli/frameworks/vite/
meta_tags: >-
  Vite, Jamstack, Azion, Edge Functions, deploy projeto, desenvolvimento local,
  CLI Vite, aplicação estática, plataforma edge, Azion CLI
