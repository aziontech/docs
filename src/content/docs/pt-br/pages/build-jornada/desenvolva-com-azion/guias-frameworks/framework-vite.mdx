...
description: Descubra como implementar uma aplicação Jamstack usando Vite na plataforma
...
meta_tags: Vite, Jamstack, Azion, Edge Functions, deploy projeto, desenvolvimento
  local, CLI Vite, aplicação estática, plataforma edge, Azion CLI
