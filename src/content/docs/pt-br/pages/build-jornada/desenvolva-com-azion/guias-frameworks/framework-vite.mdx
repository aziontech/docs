...
meta_tags: >-
  Vitepress, Jamstack, Azion, Edge Functions, deploy projeto, desenvolvimento local,
...
O VitePress está listado na [documentação do Jamstack](https://jamstack.org/generators/vitepress/) como um gerador de site estático, alinhado à abordagem Jamstack. VitePress é impulsionado pelo [Vue](https://vuejs.org/guide/introduction.html)

Saiba mais sobre o [Vite](https://vitejs.dev/) e [VitePress](https://vitepress.dev/guide/what-is-vitepress).
...
3. Escolha o preset do VitePress:
...
Agora, a CLI do VitePress seguirá o processo e inicializará o seu projeto.
...
2. No navegador, vá para `http://localhost:3333/` e você verá o seu projeto VitePress em execução.
