...
description: Faça o deploy de uma aplicação Astro na plataforma da Azion, utilizando
  Edge Functions para otimizar a performance e facilitar o gerenciamento.
permalink: /documentacao/produtos/cli/frameworks/astro/
meta_tags: Astro, Jamstack, Azion Edge Functions, deploy Astro application, create
  Astro project, static site generator, desenvolvimento local, CLI Azion, projeto
  Azion
