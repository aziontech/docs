...
:::note
Os valores máximo e padrão de TTL para o edge devem estar entre `60` e `31536000` segundos (1 ano). Se você tiver o módulo [Application Acceleration](/pt-br/documentacao/produtos/edge-application/application-acceleration/) ativado, você pode definir este valor para um mínimo de `0`. Além disso, se você tiver o módulo [Tiered Cache](/pt-br/documentacao/produtos/edge-application/l2-caching/) ativado e desejar manter o cache na camada de tiered cache, você deve definir o TTL para pelo menos `3` segundos.
...
6. A camada **Edge Caching** já está selecionada por padrão. Se você tiver o módulo **Tiered Cache** ativado, você também pode habilitar o slice para a camada de tiered cache.
...
```
  ...
  | `l2_caching_enabled` | Habilita o cache para a camada Tiered Cache. Você deve ter o módulo [Tiered Cache](/pt-br/documentacao/produtos/edge-application/l2-caching/) ativo para habilitar essa configuração. |
  ...
  | `is_slice_l2_caching_enabled` | Habilita file slicing para a camada Tiered Cache. Você deve ter o módulo [Tiered Cache](/pt-br/documentacao/produtos/edge-application/l2-caching/) ativo para habilitar essa configuração. |
