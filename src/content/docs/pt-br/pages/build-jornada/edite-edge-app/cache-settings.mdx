...
```
  ...
  | `is_slice_l2_caching_enabled` | Habilita Large File Optimization para a camada tiered cache. Você deve ter o módulo [Tiered Cache](/pt-br/documentacao/produtos/edge-application/l2-caching/) ativo para habilitar essa configuração. |
