...
Ajuste as [políticas de cache](/pt-br/documentacao/produtos/edge-application/cache-settings/) da sua edge application, incluindo valores de expiração do cache da edge ou do navegador, file slicing para segmentação de objetos maiores, e definição de cache key com base em query strings ou cookies.
