...
:::caution[atenção]
Algumas funcionalidades de cache requerem que o módulo [Application Accelerator](/pt-br/documentacao/produtos/edge-application/application-accelerator/) esteja ativo. Se o **Application Accelerator** estiver ativado, a transferência de dados pode gerar custos relacionados ao uso. Consulte a [página de preços](https://www.azion.com/pt-br/precos/) para mais informações.
:::
...
:::caution[atenção]
Para habilitar todas as funcionalidades de **Advanced Cache Key**, você deve ativar o módulo [Application Accelerator](/pt-br/documentacao/produtos/edge-application/application-accelerator/).
:::
