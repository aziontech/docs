...
```bash
curl --location 'https://api.azionapi.net/v4/edge_applications/<edge_application_id>/device_groups' \
--header 'Accept: application/json;' \
--header 'Authorization: Token [TOKEN VALUE]'
```
...
```bash
curl --location 'https://api.azionapi.net/v4/edge_applications/<edge_application_id>/cache_settings' \
--header 'Accept: application/json;' \
--header 'Content-Type: application/json' \
--header 'Authorization: Token [TOKEN VALUE]' \
--data '{
...
```bash
curl --location 'https://api.azionapi.net/v4/edge_applications/<edge_application_id>/rules_engine/request/rules' \
--header 'Accept: application/json;' \
--header 'Content-Type: application/json' \
--header 'Authorization: Token [TOKEN VALUE]' \
--data '{
