...
6. A camada **Edge Caching** já está selecionada por padrão. Se você tiver o módulo **Tiered Cache** ativado, você também pode habilitar o slice para a camada Tiered Cache.
