...
description: Aprenda como instanciar e configurar Edge Functions na Azion para otimizar
  sua edge application usando o Console ou Real-Time Manager.
permalink: /documentacao/produtos/guias/build/instanciar-edge-functions/
meta_tags: Azion, Edge Functions, serverless, Edge Application, Real-Time Manager,
...
16. Como argumento, adicione `/hello-world`.
17. Na seção **Behaviors**, selecione **Run Function** da lista de comportamentos.
18. Selecione a função **Hello World** instanciada.
19. Clique no botão **Save**.
