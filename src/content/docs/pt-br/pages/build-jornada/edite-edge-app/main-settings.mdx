...
<Fragment slot="panel.console">
    ...
    **Delivery protocols**
    ...
    Modifique sua aplicação para suportar os [protocolos de entrega](/pt-br/documentacao/produtos/build/applications/main-settings/#protocolos-de-entrega) disponíveis.
    ...
    **Delivery ports**
    ...
    Escolha entre as [portas de entrega](/pt-br/documentacao/produtos/build/applications/main-settings/#portas) suportadas para cada protocolo selecionado.
   ...
   **Módulos**
    ...
    Os [Módulos de Applications](/pt-br/documentacao/produtos/build/applications/#modules) podem desbloquear funcionalidades e recursos adicionais para suas aplicações. Veja a [página de preços](https://www.azion.com/pt-br/precos/) para mais detalhes.

    Por enquanto, você ativará dois módulos. Os módulos **Application Accelerator** e **Functions** serão usados quando você [ajustar suas configurações de cache](/pt-br/documentacao/produtos/guias/build/ajustar-cache-settings/), [instanciar uma function](/pt-br/documentacao/produtos/guias/build/instanciar-functions/) e [Trabalhar com Rules Engine](/pt-br/documentacao/produtos/guias/build/trabalhar-com-rules-engine/). 
