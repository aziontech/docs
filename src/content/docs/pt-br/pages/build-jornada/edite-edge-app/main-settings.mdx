...
Os [Módulos de Edge Application](/pt-br/documentacao/produtos/build/edge-application/#modules) podem desbloquear funcionalidades e recursos adicionais para suas aplicações. Veja a [página de preços](https://www.azion.com/pt-br/pricing/) para mais detalhes.
...
5. Ative **Application Accelerator** e **Edge Functions**.
...
9. Ative os módulos **Application Accelerator** e **Edge Functions**.
