...
1. Execute a seguinte solicitação `PATCH` em seu terminal, substituindo `[TOKEN VALUE]` por seu [personal token](/documentation/products/guides/personal-tokens/) e a variável `<edge_application_id>` por [seu ID de edge application(/pt-br/documentacao/produtos/guias/build/ajustar-cache-settings/) para ativar o módulo [Application Acceleration](/pt-br/documentacao/produtos/edge-application/application-acceleration/):
