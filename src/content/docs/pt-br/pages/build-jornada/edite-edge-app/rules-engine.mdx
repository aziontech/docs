...
Implementar regras em sua aplicação usando o [Rules Engine](/pt-br/documentacao/produtos/build/applications/rules-engine/) permite que você determine as tarefas que ela deve executar em cenários específicos sem modificar o código-fonte da sua aplicação.
