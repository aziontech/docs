...
Existem instruções separadas para API v3 usando as configurações legadas de [Error Responses](/pt-br/documentacao/produtos/build/applications/error-responses/) e API v4 usando o novo produto [Custom Pages](/pt-br/documentacao/produtos/secure/custom-pages/).
...
5. No campo **Connector**, selecione o [Connector](/pt-br/documentacao/produtos/secure/connectors/) que está buscando os dados da sua origem.
