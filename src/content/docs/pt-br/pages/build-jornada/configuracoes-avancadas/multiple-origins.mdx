...
Existem instruções separadas para API v3 usando configurações legadas de [Origin](/pt-br/documentacao/produtos/build/edge-application/origins/) e API v4 usando o novo produto [Connector](/pt-br/documentacao/produtos/secure/edge-connector/).
...
Agora você precisa configurar um novo **Connector** para vincular sua aplicação ao seu bucket do Edge Storage. Para isso:
...
1. Execute a seguinte requisição `POST` em seu terminal, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/produtos/guias/personal-tokens/) para criar um Connector.
