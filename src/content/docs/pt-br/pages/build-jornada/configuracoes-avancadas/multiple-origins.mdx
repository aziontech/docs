...
description: Descubra como configurar o Load Balancer na Azion para otimizar a performance
  de sua Edge Application, utilizando múltiplas origens e o algoritmo Round Robin.
permalink: /documentacao/produtos/guias/build/configure-multiplas-origens/
meta_tags: Azion, Load Balancer, Edge Application, balanceamento de carga, configuração
  de origens, Algoritmo Round Robin, servidores, gestão de tráfego, Azion Console,
  Real-Time Manager
