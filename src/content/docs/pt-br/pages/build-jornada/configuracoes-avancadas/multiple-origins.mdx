...
Existem instruções separadas para API v3 usando configurações legadas de [Origin](/pt-br/documentacao/produtos/build/edge-application/origins/) e API v4 usando o novo produto [Edge Connector](/pt-br/documentacao/produtos/secure/edge-connector/).
...
3. Na seção **General**, dê ao seu Connector um nome único e descritivo (por exemplo, `Multiple Origins Edge Connector`).
