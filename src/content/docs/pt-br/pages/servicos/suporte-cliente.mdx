...
Se você é novo na Azion ou se está aumentando seu uso dos produtos, a Azion fornece os recursos certos para apoiar seu sucesso. O **Suporte ao Cliente** da Azion oferece uma combinação única de ferramentas e conhecimentos para que você possa fazer coisas incríveis com a Azion.
...
O plano **Developer** oferece acesso ilimitado à documentação, guias, whitepapers e relatórios de bug. Clientes com o plano **Business** têm acesso ao suporte técnico 24/7 via ticket e email. Os planos de serviço **Enterprise** e **Mission Critical** têm acesso ao suporte 24 horas por dia, 7 dias por semana, via ticket, email e telefone, e acesso 8/5 aos Engenheiros de P&D via ticket e telefone.
...
| ---------------- | ------------------------- |
| Developer | Acesso ilimitado a documentação, guias, whitepapers e relatórios de bugs. |
