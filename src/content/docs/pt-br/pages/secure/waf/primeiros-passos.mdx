...
<DocCardGroup cols={2}>
  ...
  <DocCard title="Isente um parâmetro de query string" href="/pt-br/documentacao/secure/waf/exemplos/isentar-parametro-query/" label="Tire um argumento do score de uma regra interna, na primeira vez que uma requisição legítima for bloqueada." />
  <DocCard title="Uma regra que aplica um rule set" href="/pt-br/documentacao/secure/waf/exemplos/aplicar-rule-set/" label="O behavior Set WAF como snippet, para o próximo firewall que precisar de um." />
