...
| --- | --- | --- | --- |
| **Entry** | String | Representa o ponto de entrada principal para o sua aplicação, onde o processo de build começa | Entry será ignorado para soluções Jamstack |
...
<br />
<Button href="https://github.com/aziontech/vulcan/tree/main/examples/next/node-pages-12-3-1-fs" text="implementação do arquivo Vulcan.config.js" variant="secondary" target="_blank"></Button>

---

## Compatibilidade

Saiba mais sobre a compatibilidade na Plataforma Edge da Azion.
