...
<br />
<LinkButton link="https://github.com/aziontech/vulcan/tree/main/examples/next/node-pages-12-3-1-fs" text="implementação do arquivo vulcan.config.js" outlined target="_blank" />
