...
permalink: /documentacao/devtools/azion-lib/sql/
meta_tags: >-
...
import type { AzionSQLClient, AzionSQLResponse, AzionSQL } from 'azion/sql';
...
:::note
Nos exemplos a seguir, os métodos são chamados diretamente sem a criação de um `client`. Para mais informações sobre como interagir com serviços e produtos usando um `client`, verifique a [documentação do cliente Azion Lib](/pt-br/documentacao/devtools/azion-lib/client/).
:::
