...
A biblioteca **AI Client** da Azion fornece uma interface simples para interagir com a API de IA da Azion. Essa IA é especializada e possui conhecimento contextual sobre todos os produtos, serviços e tecnologias da Azion, permitindo respostas precisas e relevantes sobre a plataforma de **Edge Computing** da Azion.
...
Envia uma solicitação de chat para o serviço de IA da Azion.
...
Envia uma solicitação de chat via streaming para o serviço de IA da Azion.
