...
permalink: /documentacao/devtools/azion-lib/storage/
meta_tags: >-
...
:::note
Nos exemplos a seguir, os métodos são chamados diretamente sem a criação de um `client`. Para obter mais informações sobre como interagir com serviços e produtos usando um `client`, verifique a [documentação do cliente da Azion Lib](/pt-br/documentacao/devtools/azion-lib/client/).
:::
