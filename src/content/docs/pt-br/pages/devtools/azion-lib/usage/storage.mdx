...
| `edge_access` | [`EdgeAccessType`](#edgeaccesstype) | A configuração de `edge access` do bucket. |
...
| `edge_access` | [`EdgeAccessType`](#edgeaccesstype) | A configuração `edge access` do bucket. |
