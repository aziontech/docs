---
title: Biblioteca `Purge` do Azion
description: >-
...
<LinkButton link="/pt-br/documentacao/produtos/azion-lib/overview/" label="Ir para visão geral da Azion Lib" severity="secondary" target="_blank" />
...
| Parâmetro | Tipo | Descrição |
|-----------|------|-------------|
| `wildcard` | `string[]` | Expressão(s) wildcard para limpar. |
| `options` | `AzionClientOptions` (opcional) | Opções do `client`, incluindo modo de debug. |
