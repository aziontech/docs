...
permalink: /documentacao/devtools/azion-lib/purge/
meta_tags: >-
...
<DocButton href="/pt-br/documentacao/devtools/azion-lib/" label="Saiba mais sobre as Azion Libraries" kind="secondary" size="medium" />
...
:::tip
Nos exemplos a seguir, os métodos são chamados diretamente sem a criação de um `client`. Para obter mais informações sobre como interagir com serviços e produtos usando um `client`, verifique a [documentação do Azion Lib Client](/pt-br/documentacao/devtools/azion-lib/client/).
:::
