---
title: Azion `Application Client` module
description: >-
  Manage Edge Application using the Application Client module.
permalink: /documentacao/produtos/azion-lib/application-client/
meta_tags: >-
  Azion Lib, edge computing, edge applications, Azion products
namespace: documentation_azion_lib_application-client
menu_namespace: libMenu
---
import LinkButton from 'azion-webkit/linkbutton'


O **Cliente de Aplicações Azion** oferece uma interface completa para interagir com a API de **Edge Application** da Azion. Este cliente permite gerenciar Edge Applications e seus componentes, incluindo configurações de cache, grupos de dispositivos, instâncias de funções, origens e configurações do mecanismo de regras.
...
| Tipo de Retorno | Descrição |
|-------------|-------------|
| `Promise<AzionApplicationResponse<AzionCacheSetting>>` | O objeto de configuração atualizado ou erro ou erro se a operação falhou. |
...
| Parâmetro | Tipo | Descrição |
|-----------|------|-------------|
| `cacheSettingId` | Número | O ID da configuração de cache a ser excluiída |
| `options?` | `{ debug?: boolean }`| Parâmetros opcionais para modo debug. |
...
| Tipo de Retorno | Descrição |
|-------------|-------------|
| `Promise<AzionApplicationResponse<AzionDeletedCacheSetting>>` | Confirmação de exclusão ou erro ou erro se a operação falhou. |
...
| Tipo de Retorno | Descrição |
|-------------|-------------|
| `Promise<AzionApplicationResponse<AzionDeviceGroup>>` | O grupo de dispositivos criado ou erro ou erro se a operação falhou. |
...
| Parâmetro | Tipo | Descrição |
|-----------|------|-------------|
| `deviceGroupId` | Número | O ID do grupo de dispositivos a ser removido. |
| `options?` | `{ debug?: boolean }`| Parâmetros opcionais para modo debug. |
...
| Tipo de Retorno | Descrição |
|-------------|-------------|
| `Promise<AzionApplicationResponse<AzionFunctionInstance>>`| Oobjeto instância de function criado ou erro se a operação falhou. |
...
| `data` | `ApiUpdateFunctionInstancePayload` | Os dadaos atualizados da instância da function. |
| `options?` | `{ debug?: boolean }`| Parâmetros opcionais para modo debug. |
