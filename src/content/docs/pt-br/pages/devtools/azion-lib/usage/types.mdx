...
description: >-
  Explore o pacote `Types` para tipos globais TypeScript em toda a plataforma Azion.
...
O pacote **Types** fornece tipos globais TypeScript que são usados em toda a plataforma Azion, garantindo consistência e reduzindo redundância em toda a base de código.

:::note
Esses tipos são especialmente projetados para ambientes **Azion Runtime** e podem não funcionar bem em ambientes de desenvolvimento locais.
:::
