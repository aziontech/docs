...
| Tipo de Retorno | Descrição |
|-------------|-------------|
| `Promise<AzionApplicationCollectionResponse<AzionOrigin>>`| Uma coleção de edge connector encontradas ou erro caso não localizadas. |
