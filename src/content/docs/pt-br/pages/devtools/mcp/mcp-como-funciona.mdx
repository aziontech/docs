...
<Code client:visible lang="typescript" code={`server.tool(
...
<Code client:visible lang="typescript" code={`server.resource(
...
<Code client:visible lang="typescript" code={`server.prompt(
  'deploy-static-site',
  {
...
<Code client:visible lang="text" code={`meu-mcp-server/
├── src/
...
<Code client:visible lang="typescript" code={`// src/index.ts
...
<Code client:visible lang="typescript" code={`// src/middlewares/auth.ts
...
<Code client:visible lang="bash" code={`# Link do projeto
azion link
...
<Code client:visible lang="typescript" code={`// src/core/services/docsService.ts
import { z } from 'zod';
...
- [Repositório Azion MCP](https://github.com/aziontech/mcp-server) - Código-fonte do servidor Azion
