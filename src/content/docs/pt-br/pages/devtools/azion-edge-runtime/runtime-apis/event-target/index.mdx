...
title: EventTarget
description: >-
  A interface EventTarget é usada por objetos que podem receber eventos e ter
  listeners configurados para lidar com esses eventos.
meta_tags: JavaScript Runtime APIs
namespace: documentation_products_edge_functions_runtime_apis_javascript_event_target
permalink: >-
  /documentacao/produtos/edge-application/edge-functions/runtime-apis/javascript/event-target/
