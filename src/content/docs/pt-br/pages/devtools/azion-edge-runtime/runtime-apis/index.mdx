...
Para ver a lista completa de tipos suportados pelo Azion Runtime, acesse [Tipos suportados pelo Azion Runtime](/pt-br/documentacao/produtos/edge-application/edge-functions/runtime-apis/javascript/azion-runtime-globals/).
