...
permalink: /documentacao/devtools/runtime/api-reference/add-eventlistener/
---

### Como Funciona

A função *addEventListener* define o gatilho para execução do código JavaScript para receber os dados da requisição. O tipo do event listener é `fetch`, o qual recebe o [fetchEvent](/pt-br/documentacao/devtools/runtime/api-reference/fetch-event/).
...
- [Runtime APIs](/pt-br/documentacao/devtools/runtime/api-reference/fetch/)
