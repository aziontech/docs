...
permalink: /documentacao/devtools/runtime/api-reference/readable-default-reader/
---
...
Em contraste com um [ReadableStreamBYOBReader](/pt-br/documentacao/devtools/runtime/api-reference/readable-byob-reader/), que só funciona caso a *stream* tenha uma fonte de bytes, o ReadableStreamDefaultReader pode ser usado para qualquer tipo de fonte de *Readable Stream*.
