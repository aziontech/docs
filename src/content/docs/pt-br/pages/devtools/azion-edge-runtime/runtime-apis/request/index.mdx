...
O objeto Request pode ser construído e observado como propriedade de um [fetchevent](/pt-br/documentacao/produtos/applications/functions/runtime-apis/javascript/fetch-event/) recebido pela Function.
