...
permalink: /documentacao/devtools/runtime/api-reference/response/
---

A interface `Response` representa uma resposta HTTP e integra a [Fetch API](/pt-br/documentacao/devtools/runtime/api-reference/fetch/).
