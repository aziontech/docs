...
permalink: >-
  /documentacao/produtos/applications/functions/runtime-apis/javascript/response/
menu_namespace: runtimeMenu
---

A interface `Response` representa uma resposta HTTP e integra a [Fetch API](/pt-br/documentacao/produtos/applications/functions/runtime-apis/javascript/fetch/).
