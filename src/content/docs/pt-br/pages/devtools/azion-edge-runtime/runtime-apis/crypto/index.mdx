...
permalink: /documentacao/devtools/runtime/api-reference/crypto/
---
## Crypto
...
[Crypto.subtle](/pt-br/documentacao/devtools/runtime/api-reference/subtle-crypto/) retorna um objeto SubtleCrypto que fornece acesso a primitivas criptográficas comuns, como hash, assinatura, criptografia ou descriptografia.
