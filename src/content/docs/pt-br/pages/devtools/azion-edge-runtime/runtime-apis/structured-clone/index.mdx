...
description: >-
  O algoritmo de Structured clone é um mecanismo em JavaScript que pode ser
  usado para duplicar objetos complexos. É comumente usado ao invocar
  estruturadoClone() ou ao transferir dados entre Workers via postMessage(),
  armazenar objetos com IndexedDB ou copiar objetos para outras APIs.
...
permalink: >-
  /documentacao/produtos/edge-application/edge-functions/runtime-apis/javascript/structured-clone/
