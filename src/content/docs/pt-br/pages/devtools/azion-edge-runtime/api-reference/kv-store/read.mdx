...
permalink: /documentacao/devtools/runtime/api-reference/read/
---
...
- [Escrever pares chave-valor](/pt-br/documentacao/devtools/runtime/api-reference/write/)
- [Excluir pares chave-valor](/pt-br/documentacao/devtools/runtime/api-reference/delete/)
- [Visão geral da API KV Store](/pt-br/documentacao/devtools/runtime/api-reference/kv-store/)
