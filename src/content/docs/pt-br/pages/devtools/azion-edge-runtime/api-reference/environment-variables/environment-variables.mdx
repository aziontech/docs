...
description: Explore como utilizar Variáveis de Ambiente em Edge Functions para gerenciar
...
meta_tags: Edge Functions, Variáveis de Ambiente, Azion, interação com back-end, API
  privadas, bancos de dados, Azion CLI, gerenciamento de variáveis, ambiente de desenvolvimento
