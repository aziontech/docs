...
description: Explore como Edge Functions e Edge Firewall gerenciam o acesso e segurança
  de aplicações usando metadados, GeoIP e TCP.
permalink: /documentacao/produtos/edge-application/edge-functions/runtime/api-reference/metadata/
meta_tags: Edge Functions, Edge Firewall, metadados, controle de acesso, GeoIP, Remote
