...
description: Explore como Edge Functions e Edge Firewall realizam a verificação de
  endereços IP por meio de network lists, garantindo implementações de segurança eficazes
  e tratamento de erros.
permalink: /documentacao/produtos/edge-application/edge-functions/runtime/api-reference/network-list/
meta_tags: Edge Functions, Edge Firewall, network list, IP address checking, network
  list verification, Edge Computing, security implementation, error handling, best
