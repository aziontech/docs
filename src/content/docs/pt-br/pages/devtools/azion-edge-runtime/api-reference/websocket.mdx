...
title: WebSocket API
description: >-
 WebSocket Proxy permite que sua Edge Application atue como um servidor ou cliente WebSocket completo e faça proxy de tráfego bidirecional para serviços de backend.
