...
title: WebSocket API
description: >-
 WebSocket Proxy permite que sua Applications atue como um servidor ou cliente WebSocket completo e faça proxy de tráfego bidirecional para serviços de backend.
meta_tags: 'function, edge computing'
namespace: documentation_products_edge_functions_websocket_api
permalink: /documentacao/devtools/runtime/api-reference/websocket/
---
...
- As regras do Firewall podem inspecionar o tráfego WebSocket antes do processo de upgrade ser finalizado.
