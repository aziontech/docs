...
permalink: /documentacao/devtools/runtime/api-reference/kv-store/
---
...
|--------|-----------|------------|
| `put(key, value, options?)` | Armazena um par chave-valor | [Escrever pares chave-valor](/pt-br/documentacao/devtools/runtime/api-reference/write/) |
| `get(key, type?, options?)` | Recupera um valor pela chave | [Ler pares chave-valor](/pt-br/documentacao/devtools/runtime/api-reference/read/) |
| `getWithMetadata(key, type?, options?)` | Recupera um valor com seus metadados | [Ler pares chave-valor](/pt-br/documentacao/devtools/runtime/api-reference/read/) |
| `delete(key)` | Exclui um par chave-valor | [Excluir pares chave-valor](/pt-br/documentacao/devtools/runtime/api-reference/delete/) |
...
- [Referência do KV Store](/pt-br/documentacao/store/kv-store/)
- [Como gerenciar KV Store com Functions](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/dados/gerenciar-com-funcoes/)
