---
title: Edge SQL API
description: A API Edge SQL fornece uma interface para interação com um banco de dados a partir das Edge Functions executadas na Azion.
...
A **API Edge SQL** fornece uma interface para interação com banco de dados no [Edge SQL](/en/documentation/products/store/edge-sql/) a partir de Funções Edge executadas na plataforma Azion Edge. Essa documentação destaca os componentes chaves da API e fornece  um exemplo de código.
