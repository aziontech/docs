...
A **SQL Database API** fornece uma interface para interação com banco de dados no [SQL Database](/en/documentation/store/sql-database/) a partir de Functions executadas na Azion Web Platform. Essa documentação destaca os componentes chaves da API e fornece  um exemplo de código.
