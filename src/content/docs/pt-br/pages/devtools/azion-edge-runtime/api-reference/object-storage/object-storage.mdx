...
description: Descubra como usar a API de Edge Functions para gerenciar dados no Azion
  Edge Storage, incluindo métodos para armazenar, recuperar e excluir objetos.
permalink: /documentacao/runtime/api-reference/storage/
meta_tags: Edge Functions, Azion Edge Storage, API, armazenamento de dados, acesso
  a dados, storage buckets, métodos assíncronos, JavaScript, ReadableStream, ArrayBuffer
