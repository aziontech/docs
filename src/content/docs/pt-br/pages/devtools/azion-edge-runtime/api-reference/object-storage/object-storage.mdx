...
description: A Edge Functions Storage API é uma interface que permite o acesso ao Azion Edge Storage. Através dessa interface, é possível ler e escrever dados no storage e seus buckets.
...
A [Edge Functions](/pt-br/documentacao/produtos/edge-application/edge-functions/) Storage API é uma interface que permite o acesso ao Azion Edge Storage. Através dessa interface, é possível ler e escrever dados no storage e seus buckets.
...
Objeto `Storage` usado para acessar o Azion Edge Storage.
...
O `Storage.delete(key)` é usado para remover um objeto do Azion Edge Storage.
...
1. Para excluir um objeto armazenado no Azion Edge Storage:
...
1. Listando objetos do Azion Edge Storage:
