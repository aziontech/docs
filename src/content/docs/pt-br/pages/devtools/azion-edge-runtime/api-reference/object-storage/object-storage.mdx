...
description: >-
  Descubra como usar a API de Functions para gerenciar dados no Azion Object
...
meta_tags: >-
  Functions, Azion Object Storage, API, armazenamento de dados, acesso a
  dados, storage buckets, métodos assíncronos, JavaScript, ReadableStream,
  ArrayBuffer
namespace: documentation_runtime_storage
---

A [Functions](/pt-br/documentacao/build/functions/) Storage API é uma interface que permite o acesso ao Azion Object Storage. Através dessa interface, é possível ler e escrever dados no storage e seus buckets.
...
:::note 
A criação de um **bucket** é realizada durante um deploy de uma aplicação estática através da [Azion CLI](/pt-br/documentacao/devtools/cli/) ou através de requições na [API da Azion](https://api.azion.com/).
:::
