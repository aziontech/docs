...
A [Edge Functions](/pt-br/documentacao/produtos/edge-application/edge-functions/) Storage API é uma interface que permite o acesso ao Edge Storage. Através dessa interface, é possível ler e escrever dados no storage e seus buckets.
