...
A Object Storage API é uma interface que permite o acesso ao Azion Object Storage. Através dessa interface, é possível ler e escrever dados no storage e seus buckets.
...
| ---------- | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `bucket`   | string | Nome de um bucket criado durante a implantação usando [Azion CLI](/pt-br/documentation/products/azion-cli/overview/) ou por meio do [RTM](/pt-br/documentation/products/guides/getting-to-know-real-time-manager/). |
...
O método `storage.get(key)` é usado para excluir um objeto.
