...
description: A Edge Functions Storage API é uma interface que permite o acesso ao Azion Object Storage. Através dessa interface, é possível ler e escrever dados no storage e seus buckets.
meta_tags: edge function, edge computing, storage, jamstack, apis
namespace: documentation_runtime_storage
permalink: /documentacao/devtools/runtime/api-reference/storage/
menu_namespace: runtimeMenu
---

A [Edge Functions](/pt-br/documentacao/produtos/edge-application/edge-functions/) Storage API é uma interface que permite o acesso ao Azion Object Storage. Através dessa interface, é possível ler e escrever dados no storage e seus buckets.
...
| ---------- | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `bucket`   | String | Nome de um bucket criado durante a implantação usando [Azion CLI](/pt-br/documentation/products/azion-cli/overview/) ou por meio do [Real-Time Manager (RTM)](/pt-br/documentation/products/guides/getting-to-know-real-time-manager/) |

### Valor de Retorno

Objeto `Storage` usado para acessar o Azion Object Storage.
...
O `Storage.delete(key)` é usado para remover um objeto do Azion Object Storage.
...
1. Para excluir um objeto armazenado no Azion Object Storage:
...
1. Listando objetos do Azion Object Storage:
