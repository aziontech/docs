...
permalink: /documentacao/devtools/runtime/node/
meta_tags: >-
...
Um polyfill é um trecho de código, frequentemente usado em JavaScript, que traz novos recursos para ambientes que não possuem essas capacidades. Os polyfills são usados durante o tempo de *build* e podem ser configurados através do arquivo [azion.config.js](/pt-br/documentacao/devtools/cli/azion-config-js/).
...
| [async_hooks](/pt-br/documentacao/devtools/runtime/node/async-hooks/)     | 🟢 Suportada     |
| [buffer](/pt-br/documentacao/devtools/runtime/node/buffer/)          | 🟡  Parcialmente suportada    |
| child_process    | 🟡  Parcialmente suportada    |
| cluster          | 🟢 Suportada     |
| console          | 🟢 Suportada     |
| constants        | 🟢 Suportada     |
| [crypto](/pt-br/documentacao/devtools/runtime/node/crypto/)          | 🟡  Parcialmente suportada    |
| dgram           | 🟢 Suportada     |
| diagnostics_channel | 🟢 Suportada     |
| dns             | 🔴  Somente para build     |
| dns/promises    | 🔴  Somente para build     |
| domain          | 🟢 Suportada     |
| [events](/pt-br/documentacao/devtools/runtime/node/events/)          | 🟢 Suportada     |
| [fs](/pt-br/documentacao/devtools/runtime/node/fs/)              | 🟡  Parcialmente suportada    |
| fs/promises     | 🟡  Parcialmente suportada     |
| [http](/pt-br/documentacao/devtools/runtime/node/http/)            | 🟡  Parcialmente suportada    |
| http2           | 🟡  Parcialmente suportada    |
| https           | 🟡  Parcialmente suportada    |
| inspector       | 🟢 Suportada     |
| inspector/promises    | 🟡  Parcialmente suportada     |
| [module](/pt-br/documentacao/devtools/runtime/node/module/)          | 🟡  Parcialmente suportada    |
| net             | 🟡  Parcialmente suportada    |
| [os](/pt-br/documentacao/devtools/runtime/node/os/)              | 🔴  Somente para build     |
| [path](/pt-br/documentacao/devtools/runtime/node/path/)            | 🟢 Suportada     |
| path/posix            | 🟡  Parcialmente suportada     |
| path/win32           | 🟡  Parcialmente suportada     |
| perf_hooks     | 🟢 Suportada     |
| [process](/pt-br/documentacao/devtools/runtime/node/process/)         | 🟡  Parcialmente suportada    |
| punycode             | 🟡  Parcialmente suportada     |
| querystring          | 🟡  Parcialmente suportada     |
| readline        | 🟢 Suportada     |
| readline/promises | 🟢 Suportada     |
| repl                  | 🟡  Parcialmente suportada     |
| [stream](/pt-br/documentacao/devtools/runtime/node/stream/)          | 🟡  Parcialmente suportada    |
| stream/consumers      | 🟡  Parcialmente suportada     |
| stream/promises       | 🟡  Parcialmente suportada     |
| stream/web           | 🟢 Suportada     |
| [string_decoder](/pt-br/documentacao/devtools/runtime/node/string-decoder/)  | 🟢 Suportada     |
| sys                   | 🟡  Parcialmente suportada     |
| [timers](/pt-br/documentacao/devtools/runtime/node/timers/)          | 🟡  Parcialmente suportada    |
| timers/promises | 🟢 Suportada     |
| tls             | 🟡  Parcialmente suportada    |
| trace_events    | 🟢 Suportada     |
| tty             | 🟢 Suportada     |
| [url](/pt-br/documentacao/devtools/runtime/node/url/)             | 🟢 Suportada     |
| [util](/pt-br/documentacao/devtools/runtime/node/utils/)            | 🟡  Parcialmente suportada    |
| util/types           | 🟡  Parcialmente suportada     |
| v8              | 🟢 Suportada     |
| [vm](/pt-br/documentacao/devtools/runtime/node/vm/)              | 🟢 Suportada     |
| wasi            | 🟢 Suportada     |
| worker_threads  | 🟡  Parcialmente suportada    |
| [zlib](/pt-br/documentacao/devtools/runtime/node/zlib/)            | 🟢 Suportada     |
