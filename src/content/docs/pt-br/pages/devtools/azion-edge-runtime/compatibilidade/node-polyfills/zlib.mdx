...
description: >-
  Explore a integração e a funcionalidade do módulo Zlib do Node.js dentro do Azion Edge Runtime. O módulo Zlib fornece utilitários de compressão e descompressão usando os algoritmos Gzip e Deflate/Inflate.
