...
description: Descubra como Vulcan da Azion facilita a integração com frameworks populares
...
meta_tags: Azion, Vulcan, web frameworks, Next.js, Compute, Angular, Astro, React,
  Vue, Edge Computing
...
<LinkButton link="https://github.com/aziontech/vulcan/" label="ir para um exemplo do modo compute" severity="secondary" target="_blank" />
