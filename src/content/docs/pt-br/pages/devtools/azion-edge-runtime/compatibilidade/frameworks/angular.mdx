...
|:-------------|:---------|:-----|
| Angular Boilerplate | Projeto inicial | <Button href="/pt-br/documentacao/produtos/templates/angular-boilerplate/" label="Mais detalhes" type="primary" theme="light" /> |
| ButterCMS + Angular Starter Project | Projeto inicial | <Button href="/pt-br/documentacao/produtos/templates/angular-buttercms/" label="Mais detalhes" type="primary" theme="light" /> |
| Clean Angular + Sanity app | Projeto inicial | <Button href="/pt-br/documentacao/produtos/templates/angular-sanity/" label="Mais detalhes" type="primary" theme="light" /> |
