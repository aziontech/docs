...
permalink: /documentacao/devtools/runtime/frameworks/astro/
meta_tags: >-
...
|:-------------|:---------|:-----|
| Astro Audiophile | E-commerce | <DocButton href="/pt-br/documentacao/marketplace/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Astro Boilerplate | Projeto inicial | <DocButton href="/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/astro-boilerplate/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Astro Blog Starter Kit | Blog | <DocButton href="/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/astro-blog-starter-kit/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Astro Ecommerce | E-commerce | <DocButton href="/pt-br/documentacao/marketplace/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Astro with Multiple Frameworks | Projeto inicial | <DocButton href="/pt-br/documentacao/marketplace/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Astro with Framework Preact | Projeto inicial | <DocButton href="/pt-br/documentacao/marketplace/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Astro Minimal | Projeto inicial| <DocButton href="/pt-br/documentacao/marketplace/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Astro with Non-HTML Pages | Conteúdo não HTML | <DocButton href="/pt-br/documentacao/marketplace/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Astro Portfolio | Portfolio | <DocButton href="/pt-br/documentacao/marketplace/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Astro Quickstore | E-commerce | <DocButton href="/pt-br/documentacao/marketplace/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Astro Starlog | Release notes de projetos | <DocButton href="/pt-br/documentacao/marketplace/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Astro with Markdoc | Projeto inicial| <DocButton href="/pt-br/documentacao/marketplace/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Astro Markdown with Plugins | Projeto inicial | <DocButton href="/pt-br/documentacao/marketplace/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Astro Markdown with Shiki | Demonstração de código| <DocButton href="/pt-br/documentacao/marketplace/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Astro with MDX | Projeto inicial | <DocButton href="/pt-br/documentacao/marketplace/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Astro with Nano Stores | E-commerce | <DocButton href="/pt-br/documentacao/marketplace/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Astro with Tailwind CSS | Projeto inicial| <DocButton href="/pt-br/documentacao/marketplace/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Astro with Vitest | Projeto inicial | <DocButton href="/pt-br/documentacao/marketplace/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Cosmic - Simple Astro Blog | Blog | <DocButton href="/pt-br/documentacao/marketplace/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Devscard | Currículo Online | <DocButton href="/pt-br/documentacao/marketplace/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Clean Astro App with Sanity | Integração com CMS | <DocButton href="/pt-br/documentacao/marketplace/" label="Mais detalhes" kind="secondary" size="medium" /> |
| Webpage to PDF Resume | Gerador de currículos | <DocButton href="/pt-br/documentacao/marketplace/" label="Mais detalhes" kind="secondary" size="medium" /> |
...
:::tip[Dica]
Visite o [Guia CLI](/pt-br/documentacao/devtools/cli/#installing-azion-cli) para instruções detalhadas de instalação.
:::
...
Você pode utilizar o processo abaixo para realizar o deploy de um projeto local, compatível com as [frameworks suportadas](/pt-br/documentacao/devtools/runtime/frameworks/compatibilidade-frameworks/).
