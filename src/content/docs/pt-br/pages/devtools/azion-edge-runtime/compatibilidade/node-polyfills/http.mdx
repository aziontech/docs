...
description: >-
  Explore a integração e a aplicação da API HTTP do Node.js dentro do Azion Edge Runtime. O módulo HTTP do Node.js fornece as ferramentas necessárias para construir e gerenciar servidores e clientes HTTP, facilitando a criação de serviços web e o tratamento de requisições e respostas.
