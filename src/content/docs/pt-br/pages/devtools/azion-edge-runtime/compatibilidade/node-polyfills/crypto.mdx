...
description: >-
  Esta documentação explora a integração e a utilização da API Crypto do Node.js dentro do Azion Edge Runtime. O módulo Crypto no Node.js fornece funcionalidades criptográficas que incluem um conjunto de interfaces para funções de hash, HMAC, cifra, decifra, assinatura e verificação do OpenSSL.
