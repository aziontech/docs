...
Para mais informações sobre a implementação deste template, visite o [guia do template](/en/documentation/guides/application-development/frameworks/astro-ecommerce-collection/).