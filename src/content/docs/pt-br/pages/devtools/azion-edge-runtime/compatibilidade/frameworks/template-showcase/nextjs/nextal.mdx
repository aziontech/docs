...
<TemplateShowcase
  ...
  buttons={[
    { label: "Implantar template", link: "/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/nextal/", outlined: false, icon: "ai ai-azion", iconPos: "left" }
  ]}
...
Para mais informações sobre a implementação deste template, visite o [guia do template](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/frameworks/nextal/).