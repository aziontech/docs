...
description: >-
  Explore a integração e a aplicação do módulo VM do Node.js dentro do Azion Edge Runtime. O módulo VM fornece utilitários para executar código JavaScript em um ambiente virtualizado, oferecendo um nível de isolamento da aplicação principal.
