...
description: >-
  Esta documentação explora como a API async_hooks do Node.js pode ser utilizada de forma eficaz dentro do ambiente Azion Edge Runtime. O módulo async_hooks no Node.js permite que os desenvolvedores monitorem o ciclo de vida das operações assíncronas.
