...
description: >-
  Esta documentação explora a integração e o uso do módulo Path do Node.js dentro do Azion Edge Runtime. O módulo Path fornece utilitários para trabalhar com caminhos de arquivos e diretórios.
