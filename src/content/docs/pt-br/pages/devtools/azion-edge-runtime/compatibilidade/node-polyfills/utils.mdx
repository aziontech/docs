...
description: >-
  Explore a integração e o uso do módulo Util do Node.js dentro do Azion Edge Runtime. O módulo Util fornece um conjunto de funções utilitárias para várias tarefas de processamento de dados, incluindo formatação de strings, depuração e extensão de objetos.
