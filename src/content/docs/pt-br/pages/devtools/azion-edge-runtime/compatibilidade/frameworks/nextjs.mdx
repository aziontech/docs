...
|:-------------|:---------|:-----|
| Next.js Static Boilerplate 14 | Static/SPA | <LinkButton link="/en/documentation/products/templates/nextjs-static-boilerplate/" label="Learn more" severity="secondary" /> |
