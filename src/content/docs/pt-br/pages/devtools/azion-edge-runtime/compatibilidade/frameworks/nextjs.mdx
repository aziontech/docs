...
O Next.js também permite a Renderização do Lado do Servidor (SSR) na Azion Web Platform. Para mais informações sobre a compatibilidade do Next.js, [clique aqui](/pt-br/documentacao/devtools/azion-edge-runtime/compatibilidade/nextjs/)

## Templates disponíveis

| Nome do template | Caso de uso | Detalhes |
|:-------------|:---------|:-----|
| Next.js Static Boilerplate 14 | Static/SPA | <LinkButton link="/en/documentation/products/templates/nextjs-static-boilerplate/" label="Mais detalhes" severity="secondary" /> |
| Next.js Store Ecommerce Template | E-commerce | <LinkButton link="/en/documentation/products/templates/nextjs-store/" label="Mais detalhes" severity="secondary" /> |
| Next.js App Middleware | Middleware Example | <LinkButton link="/en/documentation/products/templates/nextjs-app-midddleware/" label="Mais detalhes" severity="secondary" /> |
| Next.js App Configurations | Config Example | <LinkButton link="/en/documentation/products/templates/nextjs-app-configurations/" label="Mais detalhes" severity="secondary" /> |
| Next.js Pages Configurations | Config Example | <LinkButton link="/en/documentation/products/templates/nextjs-pages-configurations/" label="Mais detalhes" severity="secondary" /> |
| Next.js Pages Middleware | Middleware Example | <LinkButton link="/en/documentation/products/templates/nextjs-pages-middleware/" label="Mais detalhes" severity="secondary" /> |
| Kupingplug  Store| E-commerce | <LinkButton link="/en/documentation/products/templates/kupingplug/" label="Mais detalhes" severity="secondary" /> |
| Next.js Stationary Store | E-commerce | <LinkButton link="/en/documentation/products/templates/stationary-ecommerce/" label="Mais detalhes" severity="secondary" /> |
| Cosmic Next Blog | Blog | <LinkButton link="/en/documentation/products/templates/cosmic-nextjs-blog/" label="Mais detalhes" severity="secondary" /> |
| Cosmic Agency | Agency/Starter | <LinkButton link="/en/documentation/products/templates/cosmic-agency/" label="Mais detalhes" severity="secondary" /> |
| Space Jelly Shop | E-commerce | <LinkButton link="/en/documentation/products/templates/space-jelly-shop/" label="Mais detalhes" severity="secondary" /> |
