...
|:-------------|:---------|:-----|
| Next.js Static Boilerplate 14 | Site estático | <LinkButton link="/pt-br/documentacao/produtos/templates/nextjs-static-boilerplate/" label="Mais detalhes" severity="secondary" /> |
