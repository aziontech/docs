...
- Uma conta na [plataforma da Azion](/pt-br/documentacao/fundamentos/criar-uma-conta/) com o módulo [Functions](/pt-br/documentacao/build/functions/) habilitado.
...
:::note
Para mais informações sobre como configurar o seu projeto, verifique a [referência do arquivo azion.config.js](/pt-br/documentacao/devtools/cli/azion-config-js/).
:::
