...
description: >-
  Esta documentação explora o uso e a compatibilidade do módulo OS do Node.js dentro do Azion Edge Runtime. O módulo OS fornece uma variedade de métodos e propriedades utilitárias relacionadas ao sistema operacional.
