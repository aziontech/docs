...
description: >-
  Esta documentação examina o uso e a compatibilidade do Sistema de Módulos do Node.js, que inclui CommonJS e Módulos ES, dentro do Azion Edge Runtime. O sistema de módulos é um aspecto central do Node.js, permitindo que os desenvolvedores organizem o código em arquivos e bibliotecas reutilizáveis.
