...
description: >-
  Esta documentação examina o uso e a compatibilidade do Module System do Node.js, que inclui CommonJS e  ES Modules, dentro do Azion Edge Runtime. O sistema de módulos é um aspecto central do Node.js, permitindo que os desenvolvedores organizem o código em arquivos e bibliotecas reutilizáveis.
