...
<div class="[&_.flex.flex-col]:!gap-4 [&_.flex.flex-col]:md:!gap-8 [&_.flex.flex-col]:2xl:!gap-16">
  <HeroHome
    ...
    buttons={[
      ...
      { label: "Ver demo", link: "https://mgfmr731me.map.azionedge.net", severity: "secondary" }
    ]}
  />
</div>
...
<div style="display: flex; gap: 1rem; align-items: center; flex-direction: row; flex-wrap: wrap;">
  <div style="flex: 1; min-width: 300px;">
    ...
    | Framework | [Gatsby](/en/pt-br/documentacao/produtos/devtools/azion-edge-runtime/frameworks-compatibility/gatsby/) |
