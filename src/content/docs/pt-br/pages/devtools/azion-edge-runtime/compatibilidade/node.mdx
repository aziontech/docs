...
<Button href="/pt-br/documentacao/produtos/edge-application/edge-functions/runtime-apis/javascript/" text="vá para as Web APIs suportadas" variant="secondary" target="blank"></Button>
<br />
<Button href="/pt-br/documentacao/produtos/devtools/azion-edge-runtime/compatibilidade-frameworks/" text="vá para os Web frameworks suportados" variant="secondary" target="_blank"></Button>