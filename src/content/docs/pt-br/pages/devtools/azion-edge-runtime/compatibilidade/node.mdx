...
|---------|---------------|----------|-------------|
| async_hooks | 🟡 Parcialmente suportada  | [Acessar o exemplo de código](https://github.com/aziontech/azion-samples/tree/dev/samples/node-async-hooks) | Apenas [AsyncLocalStorage](https://nodejs.org/api/async_conlabel.html#class-asynclocalstorage) e [AsyncResource](https://nodejs.org/api/async_hooks.html#class-asyncresource) estão implementadas. |
