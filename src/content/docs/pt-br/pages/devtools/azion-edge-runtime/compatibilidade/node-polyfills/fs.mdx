...
description: >-
  Explore a integração e o uso da API Sistema de Arquivos (FS) do Node.js dentro do Azion Edge Runtime. O módulo FS fornece um conjunto de métodos para interagir com o sistema de arquivos, permitindo a leitura, escrita e manipulação de arquivos e diretórios.
