---
title: Frameworks compatibility | <i class='ai ai-react'></i> React
description: >-
  Explore how Azion Bundler integrates with React, a JavaScript library that uses components for UI elements.
...
|:-------------|:---------|:-----|
| ButterCMS + React Projeto inicial Project | Projeto inicial | <LinkButton link="/pt-br/documentacao/produtos/templates/react-buttercms/" label="Mais detalhes" severity="secondary" /> |
| React Boilerplate | Projeto inicial project | <LinkButton link="/pt-br/documentacao/produtos/templates/react-boilerplate/" label="Mais detalhes" severity="secondary" /> |

Templates com outras framewoeks que também usam React:

| Nome do template | Caso de uso | Detalhes |
|:-------------|:---------|:-----|
| Space Jelly Shop| E-commerce | <LinkButton link="/pt-br/documentacao/produtos/templates/gatsby-boilerplate/" label="Mais detalhes" severity="secondary" /> |
| Cosmic Agency | Projeto inicial | <LinkButton link="/pt-br/documentacao/produtos/templates/gatsby-boilerplate/" label="Mais detalhes" severity="secondary" /> |
| NextJs Store with React | E-commerce | <LinkButton link="/pt-br/documentacao/produtos/templates/gatsby-boilerplate/" label="Mais detalhes" severity="secondary" /> |
| Astro with React | Projeto inicial | <LinkButton link="/pt-br/documentacao/produtos/templates/astro-react/" label="Mais detalhes" severity="secondary" /> |
