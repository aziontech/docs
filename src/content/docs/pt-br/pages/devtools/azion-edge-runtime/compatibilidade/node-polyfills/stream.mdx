...
description: >-
  Esta documentação explora a integração e o uso do módulo Stream do Node.js dentro do Azion Edge Runtime. O módulo Stream é uma parte fundamental do Node.js.
