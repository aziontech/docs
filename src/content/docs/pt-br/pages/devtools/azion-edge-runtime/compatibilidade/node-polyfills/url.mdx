...
description: >-
  Esta documentação examina a integração e o uso do módulo URL do Node.js dentro do Azion Edge Runtime. O módulo URL fornece utilitários para analisar e formatar URLs, gerenciar strings de consulta e garantir a manipulação correta de URLs.
