...
description: Explore a compatibilidade entre várias versões do Next.js e a Azion Edge
  Platform, incluindo suporte para SSR, SSG e API Routes.
permalink: /documentacao/runtime-api/frameworks-suportados/nextjs/
meta_tags: Next.js, Azion Edge Platform, compatibilidade Next.js, versões Next.js,
  pré-renderização Next.js, React framework, SSR, SSG, API Routes, Incremental Static
  Regeneration
...
:::note
 Você pode encontrar exemplos mais detalhados no [repositório Vulcan](https://github.com/aziontech/vulcan/).
:::
