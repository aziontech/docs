---
title: Compatiblidade entre a Azion e Next.js
...
| Next configs | 🟡  | Funcionalidades: rewrite before files, rewrite after files, rewrite fallback, redirects, header definition | 
| i18n routing | 🟢 | | 
| Custom errors | 🟢 | | 
