...
description: Explore como o uso de variáveis de ambiente na plataforma Azion aumenta
  a segurança, flexibilidade e conformidade em projetos de software, com foco em Edge
  Functions.
permalink: /documentacao/produtos/edge-functions/environment-variables/
meta_tags: variáveis de ambiente, segurança de configuração, conformidade de dados,
  Azion Edge Functions, gerenciamento de API, CLI Azion, portabilidade de aplicativos,
