...
description: >-
  Explore o Azion Preview Deployment para testar e visualizar functions em
...
meta_tags: >-
  Azion, Preview Deployment, functions, visualizar funções de borda,
  deployment pré-produção, testes de fluxo HTTP, resposta em HTML, retorno em
  JSON, API Builder, integração ChatGPT, Applications, criação de API
namespace: documentation_products_edge_functions_runtime_preview_deployment
---

O **Azion Preview Deployment** possibilita que você visualize o comportamento de suas functions antes de elas irem para produção. Novas possibilidades são desbloqueadas ao usar o preview, como:
...
A integração com ChatGPT ajuda você a aumentar sua produtividade e, juntamente ao Azion Preview Deployment, permite implementações mais analíticas, possibilitando testar e ver novas ideias em tempo real. Acesse [Functions e ChatGPT](/pt-br/documentacao/build/functions/ai-integration/).
