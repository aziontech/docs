...
| --- | --- |
| [Como criar uma API com Functions e ChatGPT](/pt-br/documentacao/produtos/guias/functions/api-builder/) | Veja como construir uma API e visualizar sua resposta em JSON no Azion Preview Provider, com o auxílio do ChatGPT |
