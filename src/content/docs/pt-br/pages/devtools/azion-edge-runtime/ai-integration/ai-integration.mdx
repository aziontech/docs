---
title: Functions e ChatGPT
description: >-
  Integre Functions e ChatGPT para aumentar a produtividade com geração de
  código, refatoração e explicação diretamente no editor de código.
permalink: /documentacao/build/functions/ai-integration/
meta_tags: >-
  Functions, ChatGPT, geração de código, refatoração de código, editor de
  código, chave API ChatGPT, integração ChatGPT, desenvolvimento de software,
  explicação de código, produtividade de desenvolvedor
...
## Como funciona a integração entre Functions e o ChatGPT?

O **Functions Code Editor** é integrado às APIs do ChatGPT, para que você possa usar um conjunto de recursos dentro do editor, sem a necessidade de abrir outra guia. Os recursos vão desde refatorar o código até gerar um novo código com base na entrada informada pelo prompt.
