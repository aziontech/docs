---
title: >-
  Exemplos em JavaScript - Exemplo geral do uso de edge functions no Edge
  Firewall
...
permalink: >-
  /documentacao/produtos/edge-application/edge-functions/javascript-examples/general-firewall-example/
