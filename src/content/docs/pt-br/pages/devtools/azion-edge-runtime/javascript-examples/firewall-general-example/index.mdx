...
- [Exemplos em JavaScript](/pt-br/documentacao/build/functions/javascript-exemplos/)
- [Runtime APIs](/pt-br/documentacao/devtools/runtime/api-reference/fetch-event/)
