...
description: Explore o novo Edge Functions Code Editor na Azion, facilitando o desenvolvimento
  com recursos como IntelliSense e integração ao ChatGPT.
permalink: /documentacao/produtos/edge-application/edge-functions/runtime-api/code-editor/
meta_tags: Edge Functions, editor de código, Monaco Code Editor, VS Code, desenvolvimento
  de edge, Azion platform, IntelliSense, Debugging, ChatGPT, API with Edge Functions
