...
O novo editor de código para edge functions está preparado para [suportar todos os tipos](/pt-br/documentacao/produtos/edge-application/edge-functions/runtime-apis/javascript/tipos-suportados/) e [Web APIs](/pt-br/documentacao/devtools/runtime-apis/javascript/) que fazem parte do Azion Edge Runtime.
