...
A mensagem, então, é coletada e fica disponível para ser acessada via [Data Stream](/pt-br/documentacao/produtos/data-stream/).
...
Consulte a [documentação do Data Stream](/pt-br/documentacao/produtos/data-stream/) para mais informações.
