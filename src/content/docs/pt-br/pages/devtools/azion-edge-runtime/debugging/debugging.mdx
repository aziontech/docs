...
Para depurar códigos, você deve criar uma nova [function](/pt-br/documentacao/build/functions/) que utilizará o método **log**. Esse métodoo imprime no console uma mensagem que foi previamente enviada como parâmetro para a função.
...
2. Clique na aplicação à qual você deseja adicionar a função ou [crie uma nova](/pt-br/documentacao/plataforma/applications/primeiros-passos/).
...
Agora sua function está instanciada e pronta para ser usada em sua aplicação. Você pode configurar as condições de execução e comportamentos usando o [Rules Engine](/pt-br/documentacao/plataforma/applications/rules-engine/):
...
Consulte a [documentação](/pt-br/documentacao/observe/data-stream/) para saber mais sobre **Data Stream** e suas configurações. Você também pode usar **Real-Time Events** para observar e analisar os logs gerados.
...
Leia a [documentação do Real-Time Events](/pt-br/documentacao/observe/real-time-events/) para saber mais.
