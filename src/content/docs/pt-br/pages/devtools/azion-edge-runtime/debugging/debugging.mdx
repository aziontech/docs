...
Para depurar códigos, você deve criar uma nova [function](/pt-br/documentacao/produtos/build/application/functions/) que utilizará o método **log**. Esse métodoo imprime no console uma mensagem que foi previamente enviada como parâmetro para a função.
