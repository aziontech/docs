---
title: Debugging
description: Explore como realizar debugging com Edge Functions no servidor Azion,
  utilizando console.log e configurando Azion Data Stream para observabilidade eficiente.
permalink: /documentacao/devtools/debugging/
meta_tags: Edge Functions, debug, depuração de código, servidor Azion, logging, console.log,
  Azion Data Stream, configuração de data stream, observabilidade em Edge, gerenciamento
  de logs
