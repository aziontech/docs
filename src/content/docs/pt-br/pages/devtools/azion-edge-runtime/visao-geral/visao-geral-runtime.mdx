---
title: Azion Runtime
description: Descubra o Azion Runtime para desenvolvimento serverless com edge functions
  em JavaScript, integrando padrões Web e suporte a várias Web APIs.
permalink: /documentacao/runtime/visao-geral/
meta_tags: Azion Runtime, edge functions, Edge Computing, serverless, JavaScript,
  Web Standards, Jamstack, strict mode, Web APIs, desenvolvimento na borda
