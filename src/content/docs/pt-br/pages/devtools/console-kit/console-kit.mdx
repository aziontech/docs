---
title: Console Kit
description: 'Descubra o Azion Console Kit: um ambiente de desenvolvimento front-end
  com Vue/Vite e Tailwind, ideal para personalizar e integrar interfaces no Edge Computing.'
permalink: /documentacao/devtools/console-kit/
meta_tags: Azion Console Kit, desenvolvimento front-end, Vue/Vite, Tailwind, PrimeVue,
  GitHub, instalação Azion, integração API, Edge Computing, customização interface
