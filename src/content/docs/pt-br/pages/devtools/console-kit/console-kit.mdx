...
Para uma configuração mais rápida, gere um [personal token](/pt-br/documentacao/guias/plataforma/conta-e-billing/personal-tokens/) no [Azion Console](https://console.azion.com) da Azion e salve em um arquivo `.env.development`:
...
O Azion Console Kit pode ser executado nativamente no edge da Azion usando a [Azion CLI](/pt-br/documentacao/devtools/cli/) (versão >= 0.70.0). Para fazer isso, siga estes passos:

1. [Baixe e instale a Azion CLI](/en/documentation/devtools/cli/#installing-azion-cli) usando o método de sua preferência.
2. Configure seu [personal token](/pt-br/documentacao/guias/plataforma/conta-e-billing/personal-tokens/) na CLI:
...
- [Como personalizar a interface do Console da Azion usando o Console Kit](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/automacao/personalizar-interface-console-kit/)
- [Como integrar o Console da Azion e a API da Azion usando o Console Kit](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/automacao/integrar-com-api-console-kit/)
