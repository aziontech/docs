---
title: Console Kit
description: Desenvolvido com Vue/Vite, PrimeVue e Tailwind, o Azion Console Kit é um kit de desenvolvimento front-end usado para criar uma interface personalizada do Console Azion.
...
O Azion Console Kit pode ser executado nativamente no edge da Azion usando a [Azion CLI](/pt-br/documentacao/produtos/cli/) (versão >= 0.70.0). Para fazer isso, siga estes passos:
