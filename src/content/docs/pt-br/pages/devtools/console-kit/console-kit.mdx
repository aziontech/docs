...
Para uma configuração mais rápida, gere um [personal token](/pt-br/documentacao/produtos/guias/personal-tokens/) no [Real-Time Manager](https://console.azion.com) da Azion e salve em um arquivo `.env.development`:
