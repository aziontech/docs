...
<LinkButton link="https://registry.terraform.io/providers/aziontech/azion/latest/docs/resources/firewall_main_setting" label="Ver no Terraform Registry" severity="secondary" />
