...
permalink: /documentacao/devtools/terraform/migration-v3-to-v4/
---
...
- **Token Pessoal**: Um [token pessoal](/pt-br/documentacao/fundamentos/personal-tokens/) válido com permissões apropriadas
...
- [Documentação do Terraform Provider v2.0](/pt-br/documentacao/devtools/terraform/)
- [Documentação do Terraform Provider v1.x](/pt-br/documentacao/devtools/terraform/terraform-provider-v3/) (Descontinuado)
