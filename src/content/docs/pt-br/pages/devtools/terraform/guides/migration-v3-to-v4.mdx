...
permalink: /documentacao/produtos/terraform-provider/migration-v3-to-v4/
---
...
- **Token Pessoal**: Um [token pessoal](/pt-br/documentacao/produtos/gestao-de-contas/personal-tokens/) válido com permissões apropriadas
...
- **v1.x**: Origins eram definidos dentro do contexto de Applications
...
# Remover recursos da function (serão recriados como azion_function)
...
- [Documentação do Terraform Provider v2.0](/pt-br/documentacao/produtos/terraform-provider/)
- [Documentação do Terraform Provider v1.x](/pt-br/documentacao/produtos/terraform-provider-v3/) (Descontinuado)
...
- [ ] Verificar se a conta está habilitada para API v4
- [ ] Fazer backup do estado Terraform atual
- [ ] Fazer backup dos arquivos de configuração `.tf`
- [ ] Fixar a versão do provider para 1.41.0 (última versão v1.x)
- [ ] Documentar os recursos atuais em uso
- [ ] Identificar recursos que serão removidos ou renomeados

### Migração

- [ ] Atualizar a versão do provider para 2.0.0
- [ ] Executar `terraform init -upgrade`
- [ ] Remover recursos descontinuados do estado (`azion_domain`, `azion_edge_application_origin`, etc.)
- [ ] Atualizar arquivos de configuração `.tf`
- [ ] Substituir `azion_domain` por `azion_workload` + `azion_workload_deployment`
- [ ] Substituir `azion_edge_application_origin` por `azion_connector`
- [ ] Substituir `azion_edge_function` por `azion_function`
- [ ] Importar novos recursos para o estado
- [ ] Executar `terraform plan` e revisar mudanças

### Validação

- [ ] Verificar se nenhum recurso será destruído inesperadamente
- [ ] Verificar se novos recursos serão criados corretamente
- [ ] Confirmar que atributos estão mapeados corretamente
- [ ] Executar `terraform apply` em ambiente de teste
- [ ] Validar funcionamento dos recursos migrados
...
- [ ] Arquivar backups após confirmação de sucesso
