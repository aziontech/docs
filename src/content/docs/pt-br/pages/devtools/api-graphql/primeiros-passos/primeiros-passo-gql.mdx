...
description: Descubra como acessar e autenticar na API GraphQL da Azion, criar tokens
  seguros e usar o playground para testar e otimizar queries.
permalink: /documentacao/devtools/graphql-api/primeiros-passos/
meta_tags: API GraphQL Azion, Azion Console, criar token Azion, personal token, API
  autenticação, playground GraphQL, primeiro passos GraphQL, queries GraphQL, API
  segurança, Azion plataforma API
