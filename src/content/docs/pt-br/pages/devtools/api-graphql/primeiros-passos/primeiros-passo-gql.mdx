...
A segunda opção é criar um **Personal Token** através da interface de configuração da Azion, [Real-Time Manager (RTM)](https://console.azion.com/). Essa opção pode ser mais adequada para uso com APIs, pois proporciona a criação de um token de longa duração. Veja a página de documentação de [Personal Tokens](/pt-br/documentacao/produtos/gestao-de-contas/personal-tokens/) para mais informações.
...
Para interagir com o playground da GraphQL, você deve estar [logado no RTM](https://console.azion.com/). Se você ainda não criou uma conta, veja a página de documentação [Criar uma conta na Azion](/pt-br/documentacao/produtos/gestao-de-contas/criar-conta/).

Após fazer login no **RTM**, acesse [https://console.azion.com/metrics/graphql](https://console.azion.com/metrics/graphql) ou [https://console.azion.com/events/graphql](https://console.azion.com/events/graphql) para interagir com o playground da **GraphQL**.
