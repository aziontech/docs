...
- Para usar a API Accounting com dados brutos, inclua: `https://api.azionapi.net/accounting/graphql`
...
Após fazer login no **Console**, acesse [https://manager.azion.com/metrics/graphql](https://manager.azion.com/metrics/graphql), [https://manager.azion.com/events/graphql](https://manager.azion.com/events/graphql) ou [https://manager.azion.com/accounting/graphql](https://manager.azion.com/accounting/graphql) para interagir com o playground da **GraphQL**.
