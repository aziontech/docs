...
Para interagir com o playground da GraphQL, você deve estar [logado no Azion Console](https://console.azion.com/). Se você ainda não criou uma conta, veja a página de documentação [Criar uma conta na Azion](/pt-br/documentacao/produtos/gestao-de-contas/criar-conta/).

Após fazer login no **Console**, acesse [https://console.azion.com/metrics/graphql](https://console.azion.com/metrics/graphql) ou [https://console.azion.com/events/graphql](https://console.azion.com/events/graphql) para interagir com o playground da **GraphQL**.
