...
description: Explore campos detalhados e métricas em tempo real da API GraphQL no
  Azion Console, otimizando a performance com Edge Computing.
permalink: /documentacao/devtools/graphql-api/recursos/campos-gql-real-time-metrics/
meta_tags: graphql, api, azion, metrics, Real-Time Metrics, Edge Computing, dados,
