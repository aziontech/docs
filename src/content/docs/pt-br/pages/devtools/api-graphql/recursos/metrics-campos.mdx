...
permalink: /documentacao/devtools/graphql/campos-gql-real-time-metrics/
meta_tags: >-
...
| edgeRequestsTotal | Quantidade total de todas as requisições na application. Exemplo: `23` |
| edgeRequestsTotalPerSecond | Quantidade total de requisições por segundo na application. Exemplo: `0.00026` |
...
| configurationId | Identificador único de configuração Azion definido no arquivo de configuração do virtual host. Exemplo: `1595368520` |
| edgeFunctionId | Identificador da function. Exemplo: `1321` |
...
:::tip
Você pode usar outros parâmetros para filtrar e consultar dados mais específicos. Leia mais sobre [filtragem da GraphQL API](/pt-br/documentacao/devtools/graphql/recursos/#filtrar).
:::
...
:::note
Para consultar esses dados, você deve ter o Azion Bot Manager ativo. Entre em contato com a [equipe de vendas](https://www.azion.com/pt-br/contato/) para mais detalhes sobre a assinatura.
:::
...
:::tip
Você pode usar outros parâmetros para filtrar e consultar dados mais específicos. Leia mais sobre [filtragem na API GraphQL](/pt-br/documentacao/devtools/graphql/recursos/#filtrar).
:::
