...
| ----------------- | --------- |
| dataStreamedMetrics | Registros de envio de dados do [Data Stream](/pt-br/documentacao/produtos/data-stream/) para o endpoint do cliente. |
...
| idnsQueriesMetrics | Eventos de consultas realizadas no [Edge DNS](/pt-br/documentacao/produtos/edge-dns/). |
...
| dataStreamedEvents | Registros de envio de dados do [Data Stream](/pt-br/documentacao/produtos/data-stream/) para o endpoint do cliente. |
...
| idnsQueriesEvents | Eventos de consultas realizadas no [Edge DNS](/pt-br/documentacao/produtos/edge-dns/). |
