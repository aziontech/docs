...
permalink: /documentacao/devtools/graphql/recursos/
meta_tags: >-
...
| ----------------- | --------- |
| dataStreamedMetrics | Registros de envio de dados do [Data Stream](/pt-br/documentacao/observe/data-stream/) para o endpoint do cliente |
| edgeFunctionsMetrics | Eventos de execução do [Functions](/pt-br/documentacao/build/functions/) |
| httpMetrics | Eventos de requisições registradas pelo [Applications](/pt-br/documentacao/plataforma/applications/) e [Firewall](/pt-br/documentacao/plataforma/firewall/) |
| httpBreakdownMetrics | Consulte dados agregados, detalhados e em tempo real sobre [eventos de requisições HTTP bloqueadas](/pt-br/documentacao/guias/plataforma/observabilidade/consultar-dados-httpbreakdownmetrics-com-graphql/)  |
| edgeDnsQueriesMetrics | Eventos de consultas realizadas no [Edge DNS](/pt-br/documentacao/secure/edge-dns/) |
| imagesProcessedMetrics |  Eventos de processamento de imagens do [Image Processor](/pt-br/documentacao/build/image-processor/) |
| tieredCacheMetrics | Eventos de requisições registradas pelo [Tiered Cache](/pt-br/documentacao/build/cache/tiered-cache/) |
| connectedUsersMetrics | Consulte o número de usuários conectados às suas aplicações, usando [Live Ingest](/pt-br/documentacao/guias/plataforma/observabilidade/query-dados-connected-users-com-graphql/) |
| botManagerMetrics | Consulte o número de requisições avaliadas e as ações realizadas pelo [Azion Bot Manager](/pt-br/documentacao/guias/plataforma/observabilidade/consultar-dados-bot-manager-com-graphql/) (se inscrito) |
| botManagerBreakdownMetrics | Consulte as URLs mais impactadas por bots maliciosos, de acordo com os dados do [Azion Bot Manager](/pt-br/documentacao/guias/plataforma/observabilidade/consultar-dados-bot-manager-breakdown-com-graphql/) (se inscrito) |

<DocButton href="/pt-br/documentacao/devtools/graphql/campos-gql-real-time-metrics/" label="veja as descrições dos Campos da API GraphQL do Real⁠-⁠Time Metrics" kind="secondary" size="medium" />

### Real-Time Events GraphQL API

| Conjunto de dados | Descrição |
| ----------------- | --------- |
| activityHistoryEvents | Logs de eventos de uma conta no Azion Console relacionados às atividades registradas no [Activity History](/pt-br/documentacao/fundamentos/activity-history/). Armazena dados por *2 anos* e exibe dados a partir de *22 de setembro de 2023*. |
| functionConsoleEvents | Logs de eventos das aplicações usando o [Azion Runtime](/pt-br/documentacao/devtools/runtime/) retornados pelo Cells Console. |
| dataStreamedEvents | Registros de envio de dados do [Data Stream](/pt-br/documentacao/observe/data-stream/) para o endpoint do cliente. |
| functionEvents | Eventos de execução do [Functions](/pt-br/documentacao/build/functions/). |
| workloadEvents | Eventos de requisições registradas pelo [Applications](/pt-br/documentacao/plataforma/applications/) e [Firewall](/pt-br/documentacao/plataforma/firewall/). |
| idnsQueriesEvents | Eventos de consultas realizadas no [Edge DNS](/pt-br/documentacao/secure/edge-dns/). |
| imagesProcessedEvents | Eventos de processamento de imagens do [Image Processor](/pt-br/documentacao/build/image-processor/). |
| l2CacheEvents | Eventos de requisições registradas pelo [Tiered Cache](/pt-br/documentacao/build/cache/tiered-cache/). |
...
<DocButton href="/pt-br/documentacao/devtools/graphql/campos-gql-real-time-events/" label="veja as descrições dos Campos da API GraphQL do Real⁠-⁠Time Events" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/devtools/graphql/campos-gql-billing/" label="veja as descrições dos Campos da API GraphQL de Billing" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/devtools/graphql/campos-gql-accounting/" label="veja as descrições dos Campos da API GraphQL de Accounting" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/devtools/graphql/campos-gql-consumption/" label="Veja as descrições dos campos da API GraphQL de Consumption" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/devtools/graphql/queries/#dados-brutos" label="ir para referência de queries brutas" kind="secondary" size="medium" /> <br></br>

<DocButton href="/pt-br/documentacao/devtools/graphql/queries/#dados-agregados" label="ir para referência de queries agregadas" kind="secondary" size="medium" /> <br></br>

<DocButton href="/pt-br/documentacao/guias/plataforma/observabilidade/graphql-dados-agregados/" label="ir para guia Como realizar consultas agregando dados com a API GraphQL" kind="secondary" size="medium" />
...
Disponível para: <Tag severity="info">Real-Time Metrics GraphQL API</Tag>
