...
<LinkButton link="/pt-br/documentacao/devtools/graphql-api/recursos/campos-gql-real-time-metrics/" label="veja as descrições dos Campos da API GraphQL do Real⁠-⁠Time Metrics" outlined />
...
| cellsConsoleEvents | Logs de eventos das aplicações usando o [Azion Runtime](/pt-br/documentacao/devtools/runtime/visao-geral/) retornados pelo Cells Console. |
...
<LinkButton link="/pt-br/documentacao/devtools/graphql-api/recursos/campos-gql-real-time-events/" label="veja as descrições dos Campos da API GraphQL do Real⁠-⁠Time Events" outlined />
...
<LinkButton link="/pt-br/documentacao/devtools/graphql-api/recursos/campos-gql-billing/" label="veja as descrições dos Campos da API GraphQL de Billing" outlined />
...
<LinkButton link="/pt-br/documentacao/devtools/graphql-api/recursos/campos-gql-accounting/" label="veja as descrições dos Campos da API GraphQL de Accounting" outlined />
...
<LinkButton link="/pt-br/documentacao/devtools/graphql-api/queries/#dados-brutos" label="ir para referência de queries brutas" outlined /> <br></br>

<LinkButton link="/pt-br/documentacao/devtools/graphql-api/queries/#dados-agregados" label="ir para referência de queries agregadas" outlined /> <br></br>

<LinkButton link="/pt-br/documentacao/produtos/guias/graphql-dados-agregados/" label="ir para guia Como realizar consultas agregando dados com a API GraphQL" outlined />
