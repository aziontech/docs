...
O recurso **Reamostrar** permite que você faça uma reamostragem seus dados a fim de exibir uma quantidade menor de pontos exibidos em gráficos. Ele funciona de acordo com a regra que você informa no campo `function`.
