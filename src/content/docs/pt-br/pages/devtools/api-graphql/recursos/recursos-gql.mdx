...
<LinkButton link="/pt-br/documentacao/devtools/graphql-api/recursos/campos-gql-real-time-events/" label="veja as descrições dos Campos da API GraphQL do Real⁠-⁠Time Events" severity="secondary" />
...
<LinkButton link="/pt-br/documentacao/devtools/graphql-api/queries/#dados-brutos" label="ir para referência de queries brutas" severity="secondary" /> <br></br>

<LinkButton link="/pt-br/documentacao/devtools/graphql-api/queries/#dados-agregados" label="ir para referência de queries agregadas" severity="secondary" /> <br></br>

<LinkButton link="/pt-br/documentacao/produtos/guias/graphql-dados-agregados/" label="ir para guia Como realizar consultas agregando dados com a API GraphQL" severity="secondary" />
