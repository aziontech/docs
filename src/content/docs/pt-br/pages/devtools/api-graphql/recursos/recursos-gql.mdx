...
<LinkButton link="/pt-br/documentacao/devtools/graphql-api/recursos/campos-gql-real-time-metrics/" text="veja as descrições dos Campos da API GraphQL do Real⁠-⁠Time Metrics" outlined />
...
<LinkButton link="/pt-br/documentacao/devtools/graphql-api/recursos/campos-gql-real-time-events/" text="veja as descrições dos Campos da API GraphQL do Real⁠-⁠Time Events" outlined />
...
<LinkButton link="/pt-br/documentacao/devtools/graphql-api/recursos/campos-gql-billing/" text="veja as descrições dos Campos da API GraphQL de Billing" outlined />
...
<LinkButton link="/pt-br/documentacao/devtools/graphql-api/recursos/campos-gql-accounting/" text="veja as descrições dos Campos da API GraphQL de Accounting" outlined />
...
<LinkButton link="/pt-br/documentacao/devtools/graphql-api/queries/#dados-brutos" text="ir para referência de queries brutas" outlined /> <br></br>

<LinkButton link="/pt-br/documentacao/devtools/graphql-api/queries/#dados-agregados" text="ir para referência de queries agregadas" outlined /> <br></br>

<LinkButton link="/pt-br/documentacao/produtos/guias/graphql-dados-agregados/" text="ir para guia Como realizar consultas agregando dados com a API GraphQL" outlined />
