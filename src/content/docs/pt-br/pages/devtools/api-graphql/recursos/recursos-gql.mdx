...
| botManagerMetrics | Consulte o número de requisições avaliadas e as ações realizadas pelo [Azion Bot Manager Advanced](/pt-br/documentacao/produtos/guias/consultar-dados-bot-manager-advanced-com-graphql/) (se inscrito) |
