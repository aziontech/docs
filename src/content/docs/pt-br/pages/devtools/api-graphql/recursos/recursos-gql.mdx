...
<DocButton href="/pt-br/documentacao/devtools/graphql/queries/#dados-brutos" label="ir para referência de queries brutas" kind="secondary" size="medium" />

<DocButton href="/pt-br/documentacao/devtools/graphql/queries/#dados-agregados" label="ir para referência de queries agregadas" kind="secondary" size="medium" />
