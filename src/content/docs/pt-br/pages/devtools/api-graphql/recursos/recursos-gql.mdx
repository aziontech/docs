...
| tieredCacheMetrics | Eventos de requisições registradas pelo [Tiered Cache](/pt-br/documentacao/produtos/build/applications/cache/tiered-cache/) |
...
<DocButton href="/pt-br/documentacao/devtools/graphql-api/recursos/campos-gql-real-time-metrics/" label="veja as descrições dos Campos da API GraphQL do Real⁠-⁠Time Metrics" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/devtools/graphql-api/recursos/campos-gql-real-time-events/" label="veja as descrições dos Campos da API GraphQL do Real⁠-⁠Time Events" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/devtools/graphql-api/recursos/campos-gql-billing/" label="veja as descrições dos Campos da API GraphQL de Billing" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/devtools/graphql-api/recursos/campos-gql-accounting/" label="veja as descrições dos Campos da API GraphQL de Accounting" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/devtools/graphql-api/recursos/campos-gql-consumption/" label="Veja as descrições dos campos da API GraphQL de Consumption" kind="secondary" size="medium" />
...
<DocButton href="/pt-br/documentacao/devtools/graphql-api/queries/#dados-brutos" label="ir para referência de queries brutas" kind="secondary" size="medium" /> <br></br>

<DocButton href="/pt-br/documentacao/devtools/graphql-api/queries/#dados-agregados" label="ir para referência de queries agregadas" kind="secondary" size="medium" /> <br></br>

<DocButton href="/pt-br/documentacao/produtos/guias/graphql-dados-agregados/" label="ir para guia Como realizar consultas agregando dados com a API GraphQL" kind="secondary" size="medium" />
