...
<Button href="/pt-br/documentacao/devtools/graphql-api/recursos/campos-gql-real-time-metrics/" text="veja as descrições dos Campos da API GraphQL do Real⁠-⁠Time Metrics" variant="secondary"></Button>
...
<Button href="/pt-br/documentacao/devtools/graphql-api/recursos/campos-gql-real-time-events/" text="veja as descrições dos Campos da API GraphQL do Real⁠-⁠Time Events" variant="secondary"></Button>
...
<Button href="/pt-br/documentacao/devtools/graphql-api/recursos/campos-gql-billing/" text="veja as descrições dos Campos da API GraphQL de Billing" variant="secondary"></Button>
...
<Button href="/pt-br/documentacao/devtools/graphql-api/recursos/campos-gql-accounting/" text="veja as descrições dos Campos da API GraphQL de Accounting" variant="secondary"></Button>
...
<Button href="/pt-br/documentacao/devtools/graphql-api/queries/#dados-brutos" text="ir para referência de queries brutas" variant="secondary"></Button> <br></br>

<Button href="/pt-br/documentacao/devtools/graphql-api/queries/#dados-agregados" text="ir para referência de queries agregadas" variant="secondary"></Button> <br></br>
