...
description: Explore como utilizar a API GraphQL da Azion para filtros precisos, ordenação
  de dados e paginamento eficiente em Real-Time Metrics e Events.
permalink: /documentacao/devtools/graphql-api/recursos/
meta_tags: GraphQL, Azion, Real-Time Metrics, Events, API, dados, queries, filtrar,
