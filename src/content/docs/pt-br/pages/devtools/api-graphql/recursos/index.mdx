...
Suponha que o resultado original da sua consulta, sem reamostragem, retornou *1.456 logs*. Como você fez uma consulta para uma reamostragem de *100 pontos*, o cálculo que a API faz é `1.456 // 100 = 14,56 minutos de intervalo`. Como a API só usa inteiros (números inteiros), ela arredondará o resultado para um intervalo de 14 minutos entre cada ponto retornado.
