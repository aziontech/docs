...
description: >-
  ...
  receber códigos de status de erros ao fazer uma requisição, você também
...
permalink: /documentacao/devtools/graphql/mensagens-erro/
---
...
| 400         | You have exceeded the limit amount allowed for selected fields (37 fields).                                                     | O limite de campos selecionados por query foi excedido.             |
...
Se você recebeu alguma das mensagens de erro detalhadas acima, consulte a [documentação da API GraphQL](/pt-br/documentacao/devtools/graphql/) para encontrar as especificações necessárias e corrigir a sua requisição.
