...
<Button href="/pt-br/documentacao/devtools/graphql-api/queries/" text="saiba mais sobre dados agregados e brutos"></Button>

E você também pode usar a API GraphQL de Accounting:
