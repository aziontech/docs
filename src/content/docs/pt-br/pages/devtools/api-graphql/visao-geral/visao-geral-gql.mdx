---
title: API GraphQL
description: Explore how Azion's GraphQL APIs, including Real-Time Metrics and Events,
...
meta_tags: GraphQL, Azion, API, Real-Time Metrics, Real-Time Events, data querying,
