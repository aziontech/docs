...
permalink: /documentacao/devtools/graphql/visao-geral/
meta_tags: >-
...
- [API GraphQL do Real-Time Metrics](/pt-br/documentacao/plataforma/real-time-metrics/), que fornece métricas agregadas em tempo real.
- [API GraphQL Real-Time Events](/pt-br/documentacao/observe/real-time-events/), que fornece logs brutos em tempo real.

<DocButton href="/pt-br/documentacao/devtools/graphql/queries/" label="saiba mais sobre dados agregados e brutos" size="medium" />

Você também pode usar as APIs GraphQL financeiras:

- [API GraphQL de Billing](/pt-br/documentacao/fundamentos/billing-and-subscriptions/), que fornece dados relacionados às contas de faturamento, tipos de entradas financeiras e pagamentos.
- [API GraphQL de Accounting](/pt-br/documentacao/devtools/graphql/campos-gql-accounting/), que fornece dados relacionados a produtos e suas métricas sendo contabilizadas na conta do cliente.
- [API GraphQL de Consumption](/pt-br/documentacao/devtools/graphql/campos-gql-consumption/), que fornece dados relacionados ao uso dos produtos e suas métricas que estão sendo contabilizadas na conta do cliente.
