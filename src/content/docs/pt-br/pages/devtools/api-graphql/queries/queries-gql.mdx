...
description: Explore como utilizar a API GraphQL para consultas eficientes em tempo
  real, incluindo dados brutos e agregados, e descubra os operadores disponíveis.
permalink: /documentacao/devtools/graphql-api/queries/
meta_tags: GraphQL, API, queries, dados brutos, dados agregados, tempo real, consultas,
  API GraphQL do Real-Time Events, API GraphQL do Real-Time Metrics, operadores GraphQL
