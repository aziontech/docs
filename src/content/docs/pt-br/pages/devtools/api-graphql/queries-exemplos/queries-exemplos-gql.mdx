...
description: Explore o repositório GitHub da Azion para exemplos práticos de queries
  da GraphQL API, incluindo Data Stream e Edge Functions.
permalink: /documentacao/devtools/graphql-api/exemplos-queries/
meta_tags: GraphQL API, Azion, exemplos de queries, repositório GitHub, Data Stream,
  Edge Application, Edge Functions, Top X Queries, consultas dados
