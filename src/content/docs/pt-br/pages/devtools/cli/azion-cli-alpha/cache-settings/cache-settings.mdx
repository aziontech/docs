...
A opção `--slice-l2-caching-enabled` define se o Large File Optimization está ativo para o L2 Caching.
...
A opção `--slice-l2-caching-enabled` define se Large File Optimization está ativo para o L2 Caching.
