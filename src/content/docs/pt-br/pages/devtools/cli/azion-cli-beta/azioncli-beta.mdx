...
<LinkButton outlined link="/pt-br/documentacao/produtos/azion-cli/visao-geral/" label="Acessar a documentação da Azion CLI versão v1.x.y" variant="secondary" /> 
...
A opção `--slice-l2-caching-enabled` define se Large File Optimization está ativo para Tiered Cache.
