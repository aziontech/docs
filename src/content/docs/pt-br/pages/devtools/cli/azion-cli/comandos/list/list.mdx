...
description: Explore and manage Edge applications, functions, rules, and more using
  Azion CLI commands to efficiently access various resources on the platform.
permalink: /documentacao/devtools/cli/list/
meta_tags: Azion CLI, Edge applications, Edge functions, list commands, CLI usage,
  Edge settings, Azion platform, Edge resources, CommandLine Interface, Edge Storage
