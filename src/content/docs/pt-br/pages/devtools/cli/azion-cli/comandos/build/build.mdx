...
description: Faça a build da sua edge application com o comando azion build. Aproveite
  opções como mode e preset para otimização e preparação para deployment.
permalink: /documentacao/devtools/cli/build/
meta_tags: edge computing, edge application, CLI, azion build, javascript, deployment,
