...
description: >-
  Aprenda a usar o Azion CLI para gerenciar o Rules Engine em aplicações edge,
  incluindo a criação, atualização e exclusão de regras, com detalhes sobre
  flags e fases.
permalink: /documentacao/produtos/cli/rules-engine-crud/
meta_tags: >-
  Azion CLI, Rules Engine, edge computing, criar regras, atualizar regras,
  descrição de regras, JSON, interação CLI, flags obrigatórias, application-id,
  fase da regra
