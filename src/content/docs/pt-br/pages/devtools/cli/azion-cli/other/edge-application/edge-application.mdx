...
A flag `--application-acceleration` especifica se a edge application tem o módulo [Application Accelerator](/pt-br/documentacao/produtos/edge-application/application-accelerator/) ativo.
