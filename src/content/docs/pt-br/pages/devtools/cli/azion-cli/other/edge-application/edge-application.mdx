...
A flag `--application-acceleration` especifica se a edge application tem o módulo [Application Accelerator](/pt-br/documentacao/produtos/build/edge-application/application-accelerator/) ativo.
...
A flag `--l2-caching` especifica se a edge application tem o módulo [Tiered Cache](/pt-br/documentacao/produtos/edge-application/l2-caching/) ativo.
...
A flag `--application-id` especifica o identificador exclusivo da edge application.
