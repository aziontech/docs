...
Para mais informações, acesse o [esquema do azion.config.js no repositório Vulcan](https://api.azion.com/#42279c76-58b3-4ce5-9852-1bce43c89524) ou [especificação da API da Azion](https://api.azion.com/#f1a07e9b-861c-4aed-9a93-2dee337df1d1).
