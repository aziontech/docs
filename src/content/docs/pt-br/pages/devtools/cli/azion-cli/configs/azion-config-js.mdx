...
Para mais informações, acesse o [esquema do azion.config.js no repositório Vulcan](https://api.azion.com/#42279c76-58b3-4ce5-9852-1bce43c89524) ou [especificação da API da Azion](https://api.azion.com/#9c61e0fd-e7aa-4a5f-b29e-7f9d71b98d5f).
