...
Para mais informações, acesse o [esquema do azion.config.js no repositório Vulcan](https://github.com/aziontech/vulcan) ou [especificação da API da Azion](https://api.azion.com/#f1a07e9b-861c-4aed-9a93-2dee337df1d1).
