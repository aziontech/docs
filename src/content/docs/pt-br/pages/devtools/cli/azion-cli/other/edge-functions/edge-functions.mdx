...
description: 'Gerencie edge functions na plataforma Azion com a Azion CLI: criar,
  listar, descrever, atualizar e excluir funções de forma eficiente.'
permalink: /documentacao/produtos/cli/edge-functions-crud/
meta_tags: Azion CLI, edge functions, criar, listar, descrever, atualizar, excluir,
  gestão de funções, platforma Azion, serverless
