...
A flag `--name` define o nome da application que está sendo criada. É obrigatória se a flag `--file` não for usada.
...
A flag `--http-port` especifica a porta de entrega HTTP da application. O valor padrão é `80`.

##### https-port

A flag `--https-port` especifica a porta de entrega HTTPS da application. O valor padrão é `443`.
...
A opção `--file` especifica o caminho para um arquivo JSON que contém os atributos da application sendo criada. O caminho também pode ser lido a partir do stdin usando `-`.
...
A opção `--supported-ciphers` determina quais algoritmos criptográficos serão usados nas conexões TLS da sua application.
...
A flag `--name` define o nome da function sendo criada.

##### code

A flag `--code` define o caminho para o código da function.

##### active

A flag `--active` especifica se a function está ativa ou não. Aceita `true` ou `false`.

#### Flags opcionais

##### args

A flag `--args` define o caminho para o arquivo JSON de argumentos da function.

##### file

A flag `--file` especifica o caminho do arquivo com os atributos da function. Você pode usar `-` para ler do stdin.
...
A flag `--application-id` define o identificador único de uma application.
...
```bash
azion create firewall --name "<nome-do-firewall>"
```
...
A flag `--name` define o nome do firewall que está sendo criado.

#### Flags opcionais

##### file

A flag `--file` especifica o caminho para um arquivo JSON contendo os atributos do firewall que será criado. Você pode usar `-` para ler a partir do stdin.

##### help

A flag `--help` exibe mais informações sobre o comando `azion create firewall`.

---

## Firewall instance

Cria uma nova instância de função de Firewall.

#### Uso

```bash
azion create firewall-instance --firewall-id <firewall-id> --name "<nome-da-instancia>"
```
...
A flag `--firewall-id` define o identificador único do firewall.

##### name

A flag `--name` define o nome da instância de firewall que está sendo criada.

#### Flags opcionais

##### file

A flag `--file` especifica o caminho para um arquivo JSON contendo os atributos da instância de firewall. Você pode usar `-` para ler a partir do stdin.

##### help

A flag `--help` exibe mais informações sobre o comando `azion create firewall-instance`.

---

## Firewall rule

Cria uma nova regra de Firewall.

#### Uso

```bash
azion create firewall-rule --firewall-id <firewall-id> --file "./regra.json"
```
...
A flag `--file` especifica o caminho para um arquivo JSON contendo os atributos da regra de firewall. Você pode usar `-` para ler a partir do stdin.

##### help

A flag `--help` exibe mais informações sobre o comando `azion create firewall-rule`.

---

## WAF

Cria um WAF (Web Application Firewall).

#### Uso

```bash
azion create waf --name "<nome-do-waf>"
```
...
A flag `--name` define o nome do WAF que está sendo criado.

#### Flags opcionais

##### file

A flag `--file` especifica o caminho para um arquivo JSON contendo os atributos do WAF. Você pode usar `-` para ler a partir do stdin.

##### help

A flag `--help` exibe mais informações sobre o comando `azion create waf`.

---

## WAF exceptions

Cria uma nova exceção de WAF.

#### Uso

```bash
azion create waf-exceptions --waf-id <waf-id> --file "./excecao.json"
```
...
A flag `--waf-id` define o identificador único do WAF.

#### Flags opcionais

##### file

A flag `--file` especifica o caminho para um arquivo JSON contendo os atributos da exceção de WAF. Você pode usar `-` para ler a partir do stdin.

##### help

A flag `--help` exibe mais informações sobre o comando `azion create waf-exceptions`.

---

## Network list

Cria uma lista de rede (Network List).

#### Uso

```bash
azion create network-list --name "<nome-da-lista>"
```
...
A flag `--name` define o nome da lista de rede que está sendo criada.

#### Flags opcionais

##### file

A flag `--file` especifica o caminho para um arquivo JSON contendo os atributos da lista de rede. Você pode usar `-` para ler a partir do stdin.

##### help

A flag `--help` exibe mais informações sobre o comando `azion create network-list`.
...
A flag `--application-id` define o identificador único da application.
...
Cria um novo deployment de Workload.
...
A flag `--workload-id` define o identificador único do workload.

#### Flags opcionais

##### file

A flag `--file` especifica o caminho para um arquivo JSON contendo os atributos do deployment de workload. Você pode usar `-` para ler a partir do stdin.

##### help

A flag `--help` exibe mais informações sobre o comando `azion create workload-deployment`.
...
A flag `--application-id` define o identificador único para a application na qual a origem será criada.
...
Cria um novo perfil para o Azion CLI.

#### Uso

```bash
azion create profile --name "<nome-do-perfil>"
```
...
A flag `--name` define o nome do perfil que está sendo criado.

#### Flags opcionais

##### file

A flag `--file` especifica o caminho para um arquivo JSON contendo os atributos do perfil. Você pode usar `-` para ler a partir do stdin.

##### help

A flag `--help` exibe mais informações sobre o comando `azion create profile`.
...
```bash
azion create storage bucket --name "zorosola" --workloads-access 'read_only'
```
...
A opção `--workloads-access` indica o tipo de permissão para ações dentro do bucket. Os valores possíveis incluem `read_only`, `read_write` ou `restricted`.
...
A opção `--help` exibe mais informações sobre o comando 'create storage bucket'.
...
```bash
azion create storage object --bucket-name 'mynewbucket' --object-key 'path/to/my/remote/file.txt' --source './local/file.txt'
```
...
A opção `-h` ou `--help` exibe informações mais detalhadas sobre o comando `azion create storage object`.
