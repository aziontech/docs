...
A opção `--debug-rules` permite verificar se as regras ou conjuntos de regras criados usando o módulo Rules Engine para Applications ou Edge Firewall foram executados com sucesso na sua aplicação.
