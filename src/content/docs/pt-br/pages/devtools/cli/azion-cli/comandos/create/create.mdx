...
description: Descubra como criar Edge Applications, Edge Functions, e mais com Azion
  CLI. Inclui configurações de cache, CDN, e storage avançado.
permalink: /documentacao/devtools/cli/create/
meta_tags: Azion CLI, Edge Applications, Edge Functions, Cache Settings, Rules Engine,
