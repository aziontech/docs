...
A flag `--application-acceleration` especifica se a application tem o módulo [Application Acceleration](/pt-br/documentacao/produtos/build/application/application-accelerator/) ativo.

##### delivery-protocol

A flag `--delivery-protocol` especifica o [protocolo de entrega](/pt-br/documentacao/produtos/build/application/main-settings/) da application.
...
A flag `--edge-functions` especifica se a application tem o módulo [Edge Functions](/pt-br/documentacao/produtos/build/application/functions/) ativo.
...
A flag `--image-optimization` especifica se a application tem o módulo [Image Processor](/pt-br/documentacao/produtos/build/application/image-processor/) ativo.
...
A flag `--l2-caching` especifica se a application tem o módulo [Tiered Cache](/pt-br/documentacao/produtos/build/application/tiered-cache/) ativo.
