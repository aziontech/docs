...
A flag `--load-balancer` especifica se a edge application tem o módulo [Load Balancer](/pt-br/documentacao/produtos/secure/edge-connector/load-balancer/) ativo.
