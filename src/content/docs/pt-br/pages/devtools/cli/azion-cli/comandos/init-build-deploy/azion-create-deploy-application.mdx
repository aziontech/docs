...
description: Descubra como usar comandos CLI para iniciar, construir e implantar edge
  applications com múltiplos frameworks na Azion.
permalink: /documentacao/produtos/azion-cli/criar-application/
meta_tags: azion, edge computing, CLI, implantação edge, templates frameworks, desenvolvimento
  edge, comandos azion, inicialização edge, construção edge, deploy edge application
