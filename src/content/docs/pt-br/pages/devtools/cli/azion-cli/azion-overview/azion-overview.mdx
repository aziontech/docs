---
title: Azion CLI
description: Aprenda como usar a Azion CLI para criar, gerenciar e implantar Edge
  Applications eficientemente na plataforma Azion, explorando diversas ferramentas
  e frameworks.
permalink: /documentacao/produtos/azion-cli/visao-geral/
meta_tags: Azion CLI, Edge Applications, Deploy Edge Applications, Jamstack, Edge
  SDK, Command Line Interface, Azion Platform, Web Frameworks, Edge Computing, Edge
  Deployment
