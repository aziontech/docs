...
permalink: /documentacao/devtools/cli/
meta_tags: >-
...
A Azion CLI é desenvolvida em Go e interage com os produtos da Azion através do [Azion SDK (Go)](/pt-br/documentacao/devtools/sdk/). Você também pode interagir com a Azion usando o [Terraform Provider](/pt-br/documentacao/devtools/terraform/) ou a [Azion API](https://api.azion.com/).
...
<Code client:visible lang="bash" code={`curl -fsSL https://cli.azion.app/install.sh | bash
azion login
azion init
azion deploy`} />
...
<Code client:visible lang="shell" code={`sudo rpm -i <arquivo_baixado>`} />
</Fragment>
<Fragment slot="panel.dpkg">
<Code client:visible lang="shell" code={`sudo dpkg -i <arquivo_baixado>`} />
</Fragment>
<Fragment slot="panel.apk">
<Code client:visible lang="shell" code={`apk add <arquivo_baixado>`} />
</Fragment>
<Fragment slot="panel.brew">
<Code client:visible lang="shell" code={`brew install azion`} />
</Fragment>

<Fragment slot="panel.deb">
<Code client:visible lang="shell" code={`sudo apt install  ./<filepath_arquivo>`} />
</Fragment>

<Fragment slot="panel.windows">
Usando o **Chocolatey**:
<Code client:visible lang="shell" code={`choco install azion`} />
Usando o **Windows Package Manager**:

<Code client:visible lang="shell" code={`winget install aziontech.azion`} />
</Fragment>
</Tabs>
...
<Fragment slot="panel.rpm">
<Code client:visible lang="shell" code={`sudo rpm -i <downloaded_file>`} />
</Fragment>
<Fragment slot="panel.windows">
Usando o **Chocolatey**:
<Code client:visible lang="shell" code={`choco upgrade azion`} />
Usando o **Windows Package Manager**:
<Code client:visible lang="shell" code={`winget upgrade aziontech.azion`} />
</Fragment><Fragment slot="panel.dpkg">
<Code client:visible lang="shell" code={`sudo dpkg -i <downloaded_file>`} />
</Fragment><Fragment slot="panel.apk">
<Code client:visible lang="shell" code={`apk add <downloaded_file>`} />
</Fragment>
<Fragment slot="panel.brew">
<Code client:visible lang="shell" code={`brew upgrade azion`} />
</Fragment>
<Fragment slot="panel.deb">
<Code client:visible lang="shell" code={`sudo apt install  ./<download_file_path>`} />
</Fragment>
...
<DocButton href="/pt-br/documentacao/guias/" label="Ver frameworks suportados" kind="secondary" target="_blank" size="medium" />
<DocButton href="/pt-br/documentacao/devtools/runtime/frameworks/compatibilidade-frameworks/" label="Referência de compatibilidade" kind="secondary" target="_blank" size="medium" />
