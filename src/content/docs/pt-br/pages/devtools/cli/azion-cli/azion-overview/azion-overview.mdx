...
A **Azion CLI** é uma interface de linha de comando (CLI) [open source](https://github.com/aziontech/azion-cli/) que permite interagir com a Azion Edge Platform pelo terminal. Com a Azion CLI, você pode:
