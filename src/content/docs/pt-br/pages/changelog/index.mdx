...
:::note[nota]
A partir de Jul/23, este changelog não será mais atualizado. Você pode acompanhar as novidades da Azion através [do website](https://www.azion.com/pt-br/) e da [página de system status](https://status.azion.com/).
:::
