...
:::note[nota]
A Azion não atualiza mais o changelog aqui. Você pode acompanhar as novidades e atualizações dos produtos através do [roadmap](https://www.azion.com/en/roadmap/) e do [system status](https://status.azion.com/).
:::
