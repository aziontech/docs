...
:::note[nota]
A Azion não atualiza mais esta página. Você pode acompanhar as novidades da Azion através [do roadmap](https://www.azion.com/pt-br/) e da [página de system status](https://status.azion.com/).
:::
