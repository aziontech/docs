---
title: Changelog
description: Explore as últimas atualizações e lançamentos de Edge Application, Edge
  Firewall e mais na Azion. Mantenha-se à frente com soluções inovadoras de Edge Computing.
permalink: /documentacao/produtos/changelog/anos-anteriores/
meta_tags: Azion, Edge Application, Edge Firewall, Digital Certificates, WAF Self-Calibration,
  Data Stream, Edge Functions, Real-Time Metrics, Product updates, Edge Computing
  Solutions
...
* Usuários podem criar suas próprias [Credentials](/pt-br/documentacao/produtos/deploy/credenciais/).
