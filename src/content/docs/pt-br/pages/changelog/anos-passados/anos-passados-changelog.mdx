...
* **Digital Certificates:** estamos agora oferecendo suporte à geração de **CSR** em nossa plataforma. Um Certificate Signing Request (CSR) é um dos primeiros passos para obter seu próprio certificado TLS com a CA (_Certificate Authority_) de sua escolha. Saiba mais sobre essa funcionalidade, [aqui](/pt-br/documentacao/produtos/secure/edge-firewall/digital-certificates/).

**Edge Firewall**

* **WAF Self-Calibration:** com a nova opção de **Tuning**, você pode visualizar insights e personalizar quais regras serão permitidas de forma rápida e fácil, com apenas alguns cliques. Leia a [documentação](/pt-br/documentacao/produtos/secure/edge-firewall/web-application-firewall/) para mais informações.

## Updates

**Data Stream**

* **Suporte do Data Stream a TLS para endpoint Apache Kafka**: o Data Stream possibilita que você realize envios de dados criptografados para endpoints Apache Kafka usando o Transport Layer Security (TLS). Saiba mais sobre essa funcionalidade, [aqui](/pt-br/documentacao/observe/data-stream/#apache-kafka).
...
* **IBM QRadar**: **Data Dog** é um novo conector disponível para integração. Veja [aqui](/pt-br/documentacao/observe/data-stream/#ibm-qradar) como configurar o endpoint do IBM QRadar para receber dados coletados via Data Stream.
...
* **Data Dog**: um novo conector disponível para integração. Veja [aqui](/pt-br/documentacao/observe/data-stream/#datadog) como configurar o endpoint do Data Dog para receber dados coletados via Data Stream.
...
* **AWS Kinesis Data Firehose**: um novo conector disponível para integração. Veja [aqui](/en/documentation/observe/data-stream/) como configurar o endpoint do Kinesis Data Firehose para receber dados coletados via Data Stream.
...
* Real-Time Events agora exibe as variáveis `geoloc_city_name`  e  `asn` para o [data source](/en/documentation/observe/real-time-events/#data-sources) Edge Applications.
...
* **Splunk:** mais um conector disponível para integração. Confira na documentação suas [possibilidades](/pt-br/documentacao/observe/data-stream/#endpoints) de configuração de endpoints.
...
* Adicionamos uma funcionalidade para acesso [multiportas](/pt-br/documentacao/produtos/build/edge-application/#multiport) às Edge Applications, tornando sua implementação mais flexível.
...
* Os usuários já podem definir o separador que será usado nos logs para endpoints do tipo HTTP/HTTPS POST.  Leia mais detalhes [aqui](/en/documentation/observe/data-stream/).
...
* Também aperfeiçoamos questões de segurança em relação à criação de regras no [Rules Engine](/pt-br/documentacao/produtos/secure/edge-firewall/rules-engine/).

**Real Time Events**

* Nosso filtro foi alterado e agora as consultas devem ser realizadas com a mesma sintaxe utilizada no SQL. A nova documentação pode ser encontrada [aqui](/en/documentation/observe/real-time-events/).
...
* **Elastic** e **BigQuery:** mais conectores disponíveis para integração, aumentando suas [possibilidades](/pt-br/documentacao/observe/data-stream/#endpoints) de configuração de endpoints.
...
* Um novo [data source](/pt-br/documentacao/observe/data-stream/#data-sources), _Edge Functions_, está disponível no Data Stream.
...
* Nova funcionalidade [Slice Configuration](/pt-br/documentacao/produtos/build/edge-application/edge-cache/#slice-settings).
...
* Adicionada a funcionalidade de envio de notificação por email quando houver mudanças na Network List do produto [Origin Shield.](/pt-br/documentacao/secure/network-shield/#origin-shield)
* Adicionada a funcionalidade de visualizar as mudanças que ocorreram na Network List do produto [Origin Shield](/pt-br/documentacao/secure/network-shield/#origin-shield) por meio do *History* do RTM.
...
* Disponibilizado [API](/pt-br/documentacao/secure/edge-dns/) para gerenciamento de Zonas e Records para o produto Edge DNS.
* Adicionado o gráfico referente à métrica "Data Stream Requests" do produto Data Stream, na interface do Real-Time Metrics.
* Adicionado suporte à ECC - _Elliptic Curve Cryptography_ em [Digital Certificates](/pt-br/documentacao/produtos/secure/edge-firewall/digital-certificates/).
...
* Bug fix no purge de _subdomain_ quando utilizado [Wildcard Purge](/pt-br/documentacao/produtos/build/edge-application/real-time-purge/).
...
* Nova solução Bot Management integrada à plataforma da Azion, usando [Edge Functions](/pt-br/documentacao/produtos/build/edge-application/edge-functions/) no [Edge Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/).
* Adicionado componente de seleção [TLS Minimum Version](/pt-br/documentacao/produtos/build/edge-application/#minimum-tls-version), na interface da Edge Application.
...
* Novos [tipos de purge](/pt-br/documentacao/produtos/build/edge-application/real-time-purge/#tipos-de-purge): purges agora podem ser feitos por URL, CacheKey ou por Wildcard.
...
* Implementação de [Multi-Factor Authentication](/pt-br/documentacao/fundamentos/multi-factor-authentication/).
...
* Integração ao Real-Time Manager da funcionalidade de IP Blocking do [Edge Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/#ip-blocking).
* Integração à API da funcionalidade de IP Blocking do [Edge Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/).
...
* Implementação do endpoint Elasticsearch no produto [Data Stream](/pt-br/documentacao/observe/data-stream/).
...
* Evolução da Learning Tool do produto [Web Application Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/web-application-firewall/).
...
* Lançamento do novo produto de [Data Stream](/pt-br/documentacao/observe/data-stream/).
* Melhorias dos textos das opções de [Advanced Cache Key](/pt-br/documentacao/produtos/build/edge-application/application-accelerator/#advanced-cache-key).
...
* Renovação do [Shared Certificate](/pt-br/documentacao/produtos/secure/edge-firewall/digital-certificates/) da Azion junto a CA, para todos os clientes do produto.
...
* Integração das funcionalidades de Advanced Cache Key (cache key por cookie e cache key por query string) do produto [Application Accelerator](/pt-br/documentacao/produtos/build/edge-application/application-accelerator/) ao Real-Time Manager.
...
* Lançamento de novos gráficos de Image Optimization no [Analytics](/pt-br/documentacao/plataforma/real-time-metrics/).
...
* Suporte a HTTP/2.
* Atualização da aba Origins no Real-Time Manager para integração de funcionalidades do produto [Load Balancer](/pt-br/documentacao/produtos/secure/edge-connector/load-balancer/).
* Atualização do Real-Time Manager para inclusão da nova interface para criação de rule sets do [Web Application Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/web-application-firewall/).
...
* Atualização da plataforma de [Image Optimization](/pt-br/documentacao/produtos/build/edge-application/image-processor/), com ganhos superiores na otimização de imagens.

---

**mai/2016**

* Lançamento da nova interface para upload de [Digital Certificates](/pt-br/documentacao/produtos/secure/edge-firewall/digital-certificates/) no Real-Time Manager.
