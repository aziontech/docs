...
* Real-Time Events agora exibe as variáveis `geoloc_city_name`  e  `asn` para o [data source](/en/documentation/products/real-time-events/#data-sources) Edge Applications.
