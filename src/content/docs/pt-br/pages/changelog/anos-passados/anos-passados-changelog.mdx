...
* Permite criar/editar Data Streams com endpoint do tipo Google BigQuery.
...
* Adicionado suporte à ECC - _Elliptic Curve Cryptography_ em [Digital Certificates](/pt-br/documentacao/produtos/build/edge-application/digital-certificates/).
...
* Renovação do [Shared Certificate](/pt-br/documentacao/produtos/build/edge-application/digital-certificates/) da Azion junto a CA, para todos os clientes do produto.
...
* Lançamento da nova interface para upload de [Digital Certificates](/pt-br/documentacao/produtos/build/edge-application/digital-certificates/) no Real-Time Manager.
