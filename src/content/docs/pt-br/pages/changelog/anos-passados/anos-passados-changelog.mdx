...
* **Suporte do Data Stream a TLS para endpoint Apache Kafka**: o Data Stream possibilita que você realize envios de dados criptografados para endpoints Apache Kafka usando o Transport Layer Security (TLS). Saiba mais sobre essa funcionalidade, [aqui](/pt-br/documentacao/produtos/data-stream/#apache-kafka).
...
* **IBM QRadar**: **Data Dog** é um novo conector disponível para integração. Veja [aqui](/pt-br/documentacao/produtos/data-stream/#ibm-qradar) como configurar o endpoint do IBM QRadar para receber dados coletados via Data Stream.
...
* **Data Dog**: um novo conector disponível para integração. Veja [aqui](/pt-br/documentacao/produtos/data-stream/#datadog) como configurar o endpoint do Data Dog para receber dados coletados via Data Stream.
...
* **Splunk:** mais um conector disponível para integração. Confira na documentação suas [possibilidades](/pt-br/documentacao/produtos/data-stream/#endpoints) de configuração de endpoints.
...
* **Elastic** e **BigQuery:** mais conectores disponíveis para integração, aumentando suas [possibilidades](/pt-br/documentacao/produtos/data-stream/#endpoints) de configuração de endpoints.
...
* Um novo [data source](/pt-br/documentacao/produtos/data-stream/#data-sources), _Edge Functions_, está disponível no Data Stream.
...
* Disponibilizado [API](/pt-br/documentacao/produtos/edge-dns/) para gerenciamento de Zonas e Records para o produto Edge DNS.
...
* Implementação do endpoint Elasticsearch no produto [Data Stream](/pt-br/documentacao/produtos/data-stream/).
...
* Lançamento do novo produto de [Data Stream](/pt-br/documentacao/produtos/data-stream/).
* Melhorias dos textos das opções de [Advanced Cache Key](/pt-br/documentacao/produtos/edge-application/application-accelerator/#advanced-cache-key).
...
* Integração das funcionalidades de Advanced Cache Key (cache key por cookie e cache key por query string) do produto [Application Accelerator](/pt-br/documentacao/produtos/edge-application/application-accelerator/) ao Real-Time Manager.
