...
* API workloads:  entrada duplicada – Error 500 – solucionado.
...
* [API para Edge Application - edge connector](/pt-br/documentacao/produtos/api/v3/edge-applications/edge connector/) ;
...
* Bugfix para utilização da autenticação HMAC com custom pages.
...
* Melhorias no Network Layer Protection, Web Application Firewall e Edge Functions para suportar um número maior de workloads por Edge Firewall.
...
* Bugfix na funcionalidade de duplicar uma Edge Application com custom pages.
...
* Melhorias no Edge Cache para suportar um número maior de workloads por Edge Application.
...
* Adicionado o valor domain_name nos resultados da API V3 para workloads.
...
* Lançamento da [Versão 3](https://api.azion.com/) da API com endpoints da API para gerenciamento de Digital Certificates, workloads e Edge Application.
...
* Melhorias em Team Permissions para Edge Applications e workloads.
...
* Criada opção para listagem dos presets de custom pages em uma configuração de Edge Application.
...
* Criada opção para adicionar/editar presets de custom pages.
...
* Ajustes de contraste do novo layout do Edge Applications e workloads para facilitar a visualização.
...
* Implementação da funcionalidade de múltiplos workloads estarem associados a um mesmo Edge Application.
...
* Lançada nova interface de workloads.
...
* Adicionado o campo Others na aba custom pages para configuração de tempo de cache de outros códigos de erro, não listados.
...
* Lançamento dos endpoints da API para gerenciamento de custom pages.
...
* Lançamento de novos endpoints da API para [criação, alteração e remoção de edge connector](https://api.azion.com/#8043d292-fd5c-4883-ac79-22332ff9121e).
...
* Lançamento de novos endpoints da API para [consulta de edge connector](https://api.azion.com/#8043d292-fd5c-4883-ac79-22332ff9121e).
...
* Suporte a HTTP/2.
* Atualização da aba edge connector no Real-Time Manager para integração de funcionalidades do produto [Load Balancer](/pt-br/documentacao/produtos/build/edge-application/load-balancer/).
