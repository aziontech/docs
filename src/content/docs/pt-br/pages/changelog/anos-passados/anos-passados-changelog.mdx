...
* **Suporte do Data Streaming a TLS para endpoint Apache Kafka**: o Data Streaming possibilita que você realize envios de dados criptografados para endpoints Apache Kafka usando o Transport Layer Security (TLS). Saiba mais sobre essa funcionalidade, [aqui](/pt-br/documentacao/produtos/data-streaming/#apache-kafka).
...
* **IBM QRadar**: **Data Dog** é um novo conector disponível para integração. Veja [aqui](/pt-br/documentacao/produtos/data-streaming/#ibm-qradar) como configurar o endpoint do IBM QRadar para receber dados coletados via Data Streaming.
...
* Corrigido o problema em relação às requisições do Data Streaming ficarem superiores às de Edge Cache.
...
* **AWS Kinesis Data Firehose**: um novo conector disponível para integração. Veja [aqui](/en/documentation/products/observe/data-streaming/) como configurar o endpoint do Kinesis Data Firehose para receber dados coletados via Data Streaming.
...
* **Splunk:** mais um conector disponível para integração. Confira na documentação suas [possibilidades](/pt-br/documentacao/produtos/data-streaming/#endpoints) de configuração de endpoints.
...
* Os usuários já podem definir o separador que será usado nos logs para endpoints do tipo HTTP/HTTPS POST.  Leia mais detalhes [aqui](/en/documentation/products/observe/data-streaming/).
...
* **Elastic** e **BigQuery:** mais conectores disponíveis para integração, aumentando suas [possibilidades](/pt-br/documentacao/produtos/data-streaming/#endpoints) de configuração de endpoints.
...
* Um novo [data source](/pt-br/documentacao/produtos/data-streaming/#data-sources), _Edge Functions_, está disponível no Data Streaming.
