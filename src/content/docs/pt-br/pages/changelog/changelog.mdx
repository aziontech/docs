...
- **Azure Monitor** e **Azure Blob Storage**: dois novos conectores disponíveis para integração. Agora, você pode analisar seus dados no Microsoft Sentinel com mais facilidade. Saiba mais [aqui](/pt-br/documentacao/produtos/data-stream/#azure-blob-storage).
...
* **Logs v7:** agora disponível para todos os clientes através do [Data Stream](/pt-br/documentacao/produtos/data-stream/) e [Real-Time Events](/pt-br/documentacao/produtos/real-time-events/). Para mais informações, veja a documentação do produto atualizada.
