...
- **Azure Monitor** e **Azure Blob Storage**: dois novos conectores disponíveis para integração. Agora, você pode analisar seus dados no Microsoft Sentinel com mais facilidade. Saiba mais [aqui](/pt-br/documentacao/produtos/data-streaming/#azure-blob-storage).
