...
Você pode proteger suas aplicações e seus conteúdos contra ataques de bots por meio da Azion Web Platform. Para tanto, você aproveita o uso de edge functions e permite uma solução serverless alinhada com as políticas de segurança do [Edge Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/).
