...
meta_tags: 'secure, waf, firewall, tune'
...
Você pode usar o recurso [WAF Tuning](/pt-br/documentacao/secure/waf/#waf-tuning) para analisar listas de redes, IPs e países que correspondem aos conjuntos de regras do WAF configurados.
...
- <Tag severity="info">[Um firewall configurado]()</Tag><br></br>

- <Tag severity="info">[WAF ativado no firewall](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/firewall-definir-main-settings/)</Tag>
...
1. Acesse o [Azion Console](/pt-br/documentacao/guias/plataforma/conta-e-billing/como-acessar-o-azion-console/) > **WAF Rules**.
2. Selecione o WAF Rule Set que deseja usar ou [crie um novo](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/criar-waf-rule-set/).
...
1. Acesse o [Azion Console](/pt-br/documentacao/guias/plataforma/conta-e-billing/como-acessar-o-azion-console/) > selecione **WAF Rules**.
2. Selecione o WAF Rule Set que deseja usar ou [crie um novo](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/criar-waf-rule-set/).
3. Selecione a aba **Tuning**.
    - Você encontrará as variáveis disponíveis para filtrar.
...
Ao filtrar uma consulta com o WAF Tuning, você pode criar uma [allowed rule](/pt-br/documentacao/secure/waf/custom-allowed-rules/) a partir dos resultados apresentados. Para fazer isso:
...
Você pode ir para a aba **Allowed Rules** na página **WAF Rules** para verificar se a regra permitida foi criada com sucesso. Todas as novas requisições para os domínios especificados no seu firewall configurado serão tratadas de acordo com as novas regras adicionadas.
