...
- <Tag severity="info" client:only="vue">[Um firewall configurado]()</Tag><br></br>

- <Tag severity="info" client:only="vue">[WAF ativado no firewall](/pt-br/documentacao/produtos/guias/secure/edge-firewall-definir-main-settings/)</Tag>
