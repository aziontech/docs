...
permalink: /documentacao/guias/seguranca-de-aplicacoes/dns/edge-dns-definir-main-settings/
---
...
Neste guia, você aprenderá a criar uma zona no [Edge DNS](/pt-br/documentacao/secure/edge-dns/) com suas principais configurações e editá-las.
...
<DocButton href="/pt-br/documentacao/guias/seguranca-de-aplicacoes/dns/adicionar-registros/" label="consulte o guia de adicionar registros" kind="secondary" size="medium" />
</Fragment>

<Fragment slot="panel.api">

1. Execute a seguinte requisição `POST` no seu terminal, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/guias/plataforma/conta-e-billing/personal-tokens/) para criar uma nova zona:
