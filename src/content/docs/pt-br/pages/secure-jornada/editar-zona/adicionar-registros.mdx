...
Após definir suas [main settings do Intelligent DNS](/pt-br/documentacao/produtos/guias/secure/intelligent-dns-definir-main-settings/), você pode adicionar registros para especificar quais IPs estão associados ao domínio e como o **Intelligent DNS** deve lidar com requisições para o domínio.
