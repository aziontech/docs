...
5. Em **Name**, forneça o nome do novo registro. Dependendo do [tipo de registro](/pt-br/documentacao/produtos/edge-dns/#type) que você deseja usar, podem existir formatos e recomendações específicas. Por exemplo: para um registro CNAME, você pode usar o nome `www`.
...
7. Em **Value**, adicione os itens para a resposta DNS ao registro registrado. Os valores aceitos variam de acordo com o [tipo escolhido de registro](/pt-br/documentacao/produtos/edge-dns/#type).
