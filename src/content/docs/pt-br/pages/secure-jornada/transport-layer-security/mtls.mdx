...
Requer:
- <Badge variant="accent">[Application Accelerator](/pt-br/documentacao/produtos/guias/build/definir-configuracoes-principais/#modulos)</Tag>
- <Badge variant="accent">[Dominio com certificado mTLS](#adicione-um-trusted-ca-e-associe-a-um-dominio)</Tag>
