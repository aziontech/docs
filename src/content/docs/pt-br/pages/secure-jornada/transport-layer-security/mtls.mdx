...
1. Acesse o [Real-Time Manager (RTM)](https://manager.azion.com/) > **Digital Certificates**.
...
1. Acesse o [Real-Time Manager (RTM)](https://manager.azion.com/) > **Domains**.
2. Clique no domínio que deseja configurar o **mTLS**.
...
<Fragment slot="panel.rtm">
1. Acesse o [Real-Time Manager (RTM)](https://manager.azion.com/) > **Edge Application**.
2. Encontre e clique na aplicação do domínio com mTLS.
3. Clique na aba **Rules Engine**.
