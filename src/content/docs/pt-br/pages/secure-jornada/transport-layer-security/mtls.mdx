...
Requer:
- <Tag severity="primary" client:only="vue">[Application Accelerator](/pt-br/documentacao/produtos/guias/build/definir-configuracoes-principais/#modulos)</Tag>
- <Tag severity="primary" client:only="vue">[Dominio com certificado mTLS](#adicione-um-trusted-ca-e-associe-a-um-dominio)</Tag>
