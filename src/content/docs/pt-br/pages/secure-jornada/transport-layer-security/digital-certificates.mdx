...
1. [Acesse Real-Time Manager (RTM)](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/) > **Digital Certificates**.
...
:::note
Certifique-se de que o common name e os SANs listados sejam iguais aos [domínios que você configurou com a Azion](/pt-br/documentacao/produtos/guias/configurar-dominio/). Isso evitará que ocorram erros quando você associar o certificado ao domínio.
:::
