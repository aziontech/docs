...
[Digital Certificates](/pt-br/documentacao/produtos/edge-application/digital-certificates/) são essenciais para fornecer à sua infraestrutura confiabilidade e conformidade com as regulamentações de proteção de dados. Na Azion, você tem várias opções para proteger seus domínios com certificados TLS. Além de [registrar um certificado e chave privada](/pt-br/documentacao/produtos/guias/criar-certificado-digital/) que você já possui, você também pode [solicitar um certificado Let's Encrypt](/pt-br/documentacao/produtos/guias/como-gerar-um-certificado-lets-encrypt/) para o seu domínio.
...
## Passo 1. Criar um Certificate Singing Request (CSR)

### Via RTM

1. Acesse [Real-Time Manager (RTM)](/en/documentation/products/guides/how-to-access-rtm/) > **Digital Certificates**.
...
:::note
Certifique-se de que o common name e os SANs listados sejam iguais aos [domínios que você configura com a Azion](/pt-br/documentacao/produtos/guias/configurar-dominio/). Isso evitará que ocorram erros quando você associar o certificado ao domínio.
:::

7. Clique no botão **Save**.
8. Copie o valor no campo **Certificate Singing Request (CSR)**.
...
| `certificate_type` | Enum que indica o tipo do certificado. Certificados CSR são atribuídos o valor `edge_certificates` |
...
## Passo 2. Enviar CSR a uma Certificate Authority
...
## Paso 3. Registrar o certificado gerado com a Azion
