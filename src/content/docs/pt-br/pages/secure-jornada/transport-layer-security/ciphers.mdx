...
| `minimum_tls_version` | Enum que estabelece a versão mínima de TLS |
| `supported_ciphers` | Enum que define o conjunto de cifras suportadas. Veja a lista completa de [lista de cifras suportadas](/pt-br/documentacao/produtos/build/applications/main-settings/#cifras) para mais detalhes |
