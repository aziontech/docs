...
<Button href="/pt-br/documentacao/produtos/observe/real-time-metrics/#waf" label="saiba mais sobre as métricas agregadas" type="primary" theme="light" /> <br></br>

<Button href="/pt-br/documentacao/devtools/graphql-api/recursos/#conjuntos-de-dados" label="saiba mais sobre os conjuntos de dados" type="primary" theme="light" /> <br></br>

<Button href="/pt-br/documentacao/produtos/observe/real-time-events/#waf-events" label="saiba mais sobre os dados brutos" type="primary" theme="light" /><br />
