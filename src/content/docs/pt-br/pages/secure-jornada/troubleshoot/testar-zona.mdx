...
Para testar o **Edge DNS**, você deve usar um dos [servidores de nomes da Azion](/pt-br/documentacao/produtos/edge-dns/#configurar-o-edge-dns-para-responder-pelos-seus-dominios) que você configurou em seu registro DNS.
