...
Depois de configurar a sua [zona de Intelligent DNS](/pt-br/documentacao/produtos/guias/secure/intelligent-dns-definir-main-settings/), você pode testá-la para verificar se está processando corretamente as suas informações.
