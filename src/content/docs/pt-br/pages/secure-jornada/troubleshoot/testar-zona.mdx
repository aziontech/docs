---
title: Como testar o processamento de uma zona de Intelligent DNS
description: Você pode testar suas zonas para verificar se estão processando as informações corretamente.
...
Depois de configurar a sua [zona de Intelligent DNS](/pt-br/documentacao/produtos/guias/secure/intelligent-dns-configurar-main-settings/), você pode testá-la para verificar se está processando corretamente as suas informações.
...
Para testar o **Intelligent DNS**, você deve usar um dos [servidores de nomes da Azion](/pt-br/documentacao/produtos/intelligent-dns/#configurar-o-intelligent-dns-para-responder-pelos-seus-dominios) que você configurou em seu registro DNS.

<Button href="/pt-br/documentacao/produtos/guias/executar-o-comando-dig/" text="ir para o guia do comando dig" variant="secondary"></Button>
...
Para verificar como o Intelligent DNS trata uma consulta do tipo A, registrada no registro `www`, execute:
...
Para verificar como o Intelligent DNS trata uma consulta do tipo A, registrada no registro `www`, execute o seguinte comando:
