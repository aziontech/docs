...
Depois de configurar a sua [zona de Edge DNS](/pt-br/documentacao/guias/seguranca-de-aplicacoes/dns/edge-dns-definir-main-settings/), você pode testá-la para verificar se está processando corretamente as suas informações.
...
Para testar o **Edge DNS**, você deve usar um dos [servidores de nomes da Azion](/pt-br/documentacao/secure/edge-dns/#configurar-o-edge-dns-para-responder-pelos-seus-dominios) que você configurou em seu registro DNS.

<DocButton href="/pt-br/documentacao/guias/seguranca-de-aplicacoes/dns/executar-o-comando-dig/" label="consulte o guia do comando DIG" kind="secondary" size="medium" />
