...
permalink: /documentacao/produtos/secure/automate/sdk/
---

import Button from '~/components/Button.astro'

<Button href="/pt-br/documentacao/devtools/sdk/go/" text="ir para a documentação de referência do Azion SDK" variant="secondary"></Button>
