...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/bot-manager/" label="ir para o guia de instalação do bot manager" variant="secondary" target="_blank" />
