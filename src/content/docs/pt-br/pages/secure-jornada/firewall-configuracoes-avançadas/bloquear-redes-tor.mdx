...
<LinkButton outlined link="/pt-br/documentacao/produtos/secure/edge-firewall/network-layer-protection/network-lists/" label="saiba mais sobre network lists" outlined />
