...
- <Tag severity="info"  severity="primary" client:only="vue">[Um edge firewall configurado]()</Tag><br></br>

- <Tag severity="info"  severity="primary" client:only="vue">[WAF ativado no edge firewall](/pt-br/produtos/guias/secure/edge-firewall-definir-main-settings/#modulos)</Tag>
