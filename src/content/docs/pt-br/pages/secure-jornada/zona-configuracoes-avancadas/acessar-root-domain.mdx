...
<LinkButton link="/pt-bt/documentacao/produtos/guias/secure/adicionar-registros/" label="saiba mais sobre adicionar registros" severity="secondary" />
...
1. Siga as etapas gerais descritas no guia [Como adicionar registros em uma zona de DNS](/pt-br/documentacao/produtos/guias/secure/adicionar-registros/).
2. Em **Name**, insira `@` ou deixe em branco. Dessa forma, você utilizará seu root domain: `domain.com`.
