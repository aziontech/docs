...
Se você escolheu o recurso **Domain** da Azion para criar um certificado Let's Encrypt diretamente do Azion Console para uma zona totalmente configurada no **Intelligent DNS**, todo o processo é automatizado, incluindo o tratamento do registro TXT. Saiba mais no [guia Let's Encrypt](/pt-br/documentacao/produtos/guias/como-gerar-um-certificado-lets-encrypt/).
:::
