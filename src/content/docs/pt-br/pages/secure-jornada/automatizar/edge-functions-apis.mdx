...
<LinkButton link="/pt-br/documentacao/produtos/secure/edge-firewall/edge-functions/" label="saiba mais sobre Functions para Firewall" severity="secondary" target="_blank" />
