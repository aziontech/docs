...
Seus registros do [Web Application Firewall (WAF)](/pt-br/documentacao/secure/waf/) podem ser integrados a plataformas Security Information and Event Management (SIEM) por meio do **Data Stream** para monitorar comportamentos, desempenho e segurança de suas applications.

<DocButton href="/pt-br/documentacao/observe/data-stream/" label="saiba mais sobre Data Stream" kind="secondary" size="medium" />
...
- Encontre mais informações sobre cada opção em [Como associar domínios no Data Stream](/pt-br/documentacao/guias/plataforma/observabilidade/data-stream-associar-dominios/).
...
- Você verá campos diferentes dependendo do tipo de endpoint escolhido. Encontre mais informações sobre cada um deles no guia específico para o endpoint na seção de [Observe](/pt-br/documentacao/guias/#observe) na página de guias.
8. Clique no botão **Save**.
</Fragment>

<Fragment slot="panel.api">
1. Execute a seguinte requisição `POST`, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/guias/plataforma/conta-e-billing/personal-tokens/):
