...
Instancie [funções serverless](/pt-br/documentacao/produtos/edge-firewall/edge-functions-instances/) diretamente no seu edge firewall.
...
Este guia também presume que você possui uma network list do tipo [Countries](/pt-br/documentacao/produtos/edge-firewall/network-layer-protection/network-lists/#tipos-de-network-lists).
