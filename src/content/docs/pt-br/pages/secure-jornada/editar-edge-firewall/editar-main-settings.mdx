...
permalink: /documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/firewall-definir-main-settings/
---
...
<DocButton href="/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/proteja-seu-dominio/" label="Saiba mais sobre como proteger seu domínio" kind="secondary" size="medium" />

### Módulos

[Módulos](/pt-br/documentacao/plataforma/firewall/#sobre-os-modulos-do-edge-firewall) podem desbloquear funcionalidades e recursos adicionais relacionados aos seus firewalls configurados. Veja a [página de Preços](/pt-br/documentacao/fundamentos/precos/) para mais detalhes.

Existem quatro módulos disponíveis que podem ser ativados com o seu firewall:

- <Tag severity="info">[DDoS Protection](/pt-br/documentacao/plataforma/ddos-protection/)</Tag>
...
- <Tag severity="info">[Functions](/pt-br/documentacao/plataforma/firewall/functions/)</Tag>
...
- <Tag severity="info">[Network Shield](/pt-br/documentacao/secure/network-shield/)</Tag>
...
- <Tag severity="info">[Web Application Firewall](/pt-br/documentacao/secure/waf/)</Tag>
...
<DocButton href="/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/debug-regras/" label="saiba mais sobre debug de regras" kind="secondary" size="medium" />
...
:::tip[dica]
Para configurar um firewall para proteger um domínio específico, [consulte o guia Proteja seu domínio](/pt-br/documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/proteja-seu-dominio/)
:::
</Fragment>

<Fragment slot="panel.api">
1. Execute a seguinte requisição `GET` no seu terminal, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/guias/plataforma/conta-e-billing/personal-tokens/) para recuperar seu `<edge_firewall_id>`:
...
| `edge_functions_enabled` | Valor booleano que ativa (`true`) ou desativa (`false`) o módulo [Functions](/pt-br/documentacao/plataforma/firewall/functions/) |
| `network_protection_enabled` | Valor booleano que ativa (`true`) ou desativa (`false`) o módulo [Network Shield](/pt-br/documentacao/secure/network-shield/) |
| `waf_enabled` | Valor booleano que ativa (`true`) ou desativa (`false`) o módulo [Web Application Firewall (WAF)](/pt-br/documentacao/secure/waf/) |
| `debug_rules` | Valor booleano que ativa (`true`) ou desativa (`false`) o recurso [Debug Rules](/pt-br/documentacao/guias/desenvolvimento-de-aplicacoes/primeiros-passos/debug-regras/) |
