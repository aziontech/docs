...
<Button href="/pt-br/documentacao/produtos/guias/secure/proteja-seu-dominio/" label="Saiba mais sobre como proteger seu domínio" type="primary" theme="light" />
...
- <Tag severity="info" client:only="vue">[Functions](/pt-br/documentacao/produtos/secure/edge-firewall/edge-functions/)</Tag>
...
- <Tag severity="info" client:only="vue">[Network Shield](/pt-br/documentacao/produtos/secure/edge-firewall/network-layer-protection/)</Tag>
...
<Button href="/pt-br/documentacao/produtos/guias/debug-regras/" label="saiba mais sobre debug de regras" type="primary" theme="light" />
