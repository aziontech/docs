...
meta_tags: 'seguro, rules engine, firewall, critérios, comportamento'
namespace: docs_secure_work_rules_engine
permalink: /documentacao/guias/seguranca-de-aplicacoes/firewall-e-waf/trabalhar-com-rules-engine/
---
...
Implementar regras em seu firewall usando o [Rules Engine](/pt-br/documentacao/plataforma/firewall/rules-engine/) permitirá que você determine as regras que ele deve executar em cenários específicos.
...
:::note
Existem diferentes critérios que requerem módulos diferentes do Firewall. Certifique-se de ter o [módulo correto](/pt-br/documentacao/plataforma/firewall/rules-engine/#criteria) ativado para criar suas regras.
:::
---
...
1. [No Azion Console](/pt-br/documentacao/guias/plataforma/conta-e-billing/como-acessar-o-azion-console/), vá para **Firewall**.
...
1. Execute a seguinte requisição `POST` para criar uma regra, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/guias/plataforma/conta-e-billing/personal-tokens/) e a variável `<edge_firewall_id>` pelo valor do ID do firewall:
