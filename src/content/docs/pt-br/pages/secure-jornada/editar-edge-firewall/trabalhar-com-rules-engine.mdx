---
title: Como criar regras para executar comportamentos com o Rules Engine para o Edge Firewall
description: Integre regras em seu firewall para definir tarefas a serem executadas em cenários específicos sem alterar seu código existente.
...
Implementar regras em seu edge firewall usando o [Rules Engine](/pt-br/documentacao/produtos/edge-firewall/rules-engine/) permitirá que você determine as regras que ele deve executar em cenários específicos.

:::note
Existem diferentes critérios que requerem módulos diferentes do Edge Firewall. Certifique-se de ter o [módulo correto](/pt-br/documentacao/produtos/edge-firewall/rules-engine/#criteria) ativado para criar suas regras.
:::
...
1. [No Azion Console](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/), vá para **Edge Firewall**.
...
1. Execute a seguinte requisição `POST` para criar uma regra, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/produtos/guias/personal-tokens/) e a variável `<edge_firewall_id>` pelo valor do [ID do edge firewall](https://api.azion.com/#58376993-e0dd-4b51-9cd3-41d86122728f):
...
Veja a [documentação da Azion API](https://api.azion.com/#ff2b221b-0054-407f-aad3-39cda3a9ed0f) para saber mais sobre os objetos de criteria e behaviors.
