...
1. [No RTM](/pt-br/documentacao/produtos/guias/como-acessar-o-rtm/), vá para **Edge Firewall**.
...
1. Execute a seguinte requisição `POST` para criar uma regra, substituindo `[TOKEN VALUE]` pelo seu [personal token](/pt-br/documentacao/produtos/guias/personal-tokens/) e a variável `<edge_firewall_id>` pelo valor do seu [id do edge firewall](https://api.azion.com/#58376993-e0dd-4b51-9cd3-41d86122728f):
