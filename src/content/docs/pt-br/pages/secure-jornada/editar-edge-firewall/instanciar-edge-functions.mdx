...
permalink: /documentacao/produtos/guias/secure/instanciar-functions/
---
...
1. Execute a seguinte requisição `PATCH` no seu terminal, substituindo `[VALOR DO TOKEN]` pelo seu [token pessoal](/pt-br/documentacao/produtos/guias/personal-tokens/) e a variável `<firewall_id>` pelo [ID do seu firewall](https://api.azion.com/v4#/operations/GetEdgeFirewallFirewalls)) para ativar o módulo **Functions**:
