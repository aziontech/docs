...
Para criar a instância com a Azion API, envie duas requisições. A primeira lê o ID da função e a segunda cria a instância no firewall.
...
A instância existe no firewall. Ela não é executada até que uma regra do Rules Engine a selecione. As alterações levam alguns minutos para propagar.
