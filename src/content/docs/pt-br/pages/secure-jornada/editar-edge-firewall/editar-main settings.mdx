...
- <Badge variant="accent">[DDoS Protection Unmetered](/pt-br/documentacao/produtos/secure/edge-firewall/ddos-protection/)</Tag>
...
- <Badge variant="accent">[Edge Functions](/pt-br/documentacao/produtos/secure/edge-firewall/edge-functions/)</Tag>
...
- <Badge variant="accent">[Network Layer Protection](/pt-br/documentacao/produtos/secure/edge-firewall/network-layer-protection/)</Tag>
...
- <Badge variant="accent">[Web Application Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/web-application-firewall/)</Tag>
