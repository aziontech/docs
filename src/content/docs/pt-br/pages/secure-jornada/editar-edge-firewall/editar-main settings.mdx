...
Nesta seção, você modificará as principais configurações de seus edge firewalls: nome, domínios e módulos via [Real-Time Manager (RTM)](https://console.azion.com).
...
[Módulos](/pt-br/documentacao/produtos/edge-firewall/#sobre-os-modulos-do-edge-firewall) podem desbloquear funcionalidades e recursos adicionais relacionados aos seus firewalls configurados. Veja a [página de Preços](https://www.azion.com/pt-br/precos/) para mais detalhes.
