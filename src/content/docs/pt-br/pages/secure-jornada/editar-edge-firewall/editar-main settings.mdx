...
- <Tag severity="primary" client:only="vue">[DDoS Protection Unmetered](/pt-br/documentacao/produtos/secure/edge-firewall/ddos-protection/)</Tag>
...
- <Tag severity="primary" client:only="vue">[Edge Functions](/pt-br/documentacao/produtos/secure/edge-firewall/edge-functions/)</Tag>
...
- <Tag severity="primary" client:only="vue">[Network Layer Protection](/pt-br/documentacao/produtos/secure/edge-firewall/network-layer-protection/)</Tag>
...
- <Tag severity="primary" client:only="vue">[Web Application Firewall](/pt-br/documentacao/produtos/secure/edge-firewall/web-application-firewall/)</Tag>
...
<LinkButton outlined link="/pt-br/documentacao/produtos/guias/debug-regras/" label="saiba mais sobre debug de regras" variant="secondary" />
