...
[Módulos](/ppt-br/documentacao/produtos/secure/edge-firewall/#sobre-os-modulos-do-edge-firewall) podem desbloquear funcionalidades e recursos adicionais relacionados aos seus firewalls configurados. Veja a [página de Preços](/pt-br/documentacao/produtos/precos/) para mais detalhes.
...
<LinkButton link="/pt-br/documentacao/produtos/guias/debug-regras/" text="saiba mais sobre debug de regras" outlined />
...
<LinkButton link="/pt-br/documentacao/produtos/guias/debug-regras/" label="saiba mais sobre debug de regras" outlined />
