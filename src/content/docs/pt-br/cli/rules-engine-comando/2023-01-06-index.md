...
## 1. Listar as regras de uma edge application no Rules Engine
...
## 2. Gerar um template para os subcomandos rules_engine create e update
...
## 3. Criar uma regra no Rules Engine
...
## 4. Atualizar uma regra no Rules Engine
...
## 5. Descrever uma regra no rules engine
...
## 6. Excluir uma regra no Rules Engine
