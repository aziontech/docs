...
## 1. Listar as edge functions instances relacionadas a uma edge application
...
## 2. Criar uma edge functions instance
...
## 3. Atualizar uma edge functions instance
...
## 4. Descrever uma edge functions instance
...
## 5. Excluir uma edge functions instance
