...
| Campo | Descrição |
| --- | --- |
| Origin Type | Os campos a seguir referem-se ao tipo de [Single Origin](https://www.azion.com/pt-br/documentacao/produtos/edge-application/single-origin). Como você está criando uma nova aplicação, a Single Origin é a única opção. <br>Após criar e salvar a nova aplicação, você pode ativar o [Load Balancer](https://www.azion.com/pt-br/documentacao/produtos/edge-application/load-balancer). |
