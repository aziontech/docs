...
> 3. [Configurar o recebimento dos logs](#configurar)
...
A mensagem, então, é coletada e fica disponível para ser acessada via [Data Streaming]({% tl documentation_products_data_streaming %}).
...
Consulte a [documentação do Data Streaming]({% tl documentation_products_data_streaming %}) para mais informações.
