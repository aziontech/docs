 ...
 */
 export default [
	...
	{ text: 'Azion Runtime',header: true, anchor: true, type: 'learn', slug: '/documentacao/produtos/edge-application/edge-functions/runtime/visao-geral/', key: 'devtools/runtime' },
