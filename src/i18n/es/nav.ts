...
export default NavDictionary([
	//startHere
	{ key: 'accountsProfile', text: 'Comece aqui' },
	{ key: 'accountsProfile/createAccount', text: 'Introdução', slug: 'documentação' },
	{ key: 'accountsProfile/settings', text: 'Configurações de Conta' },
	// install: 'Instalación',
