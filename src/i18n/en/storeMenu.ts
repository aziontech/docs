...

	{
		...
		items: [
			...
			},
			{
				...
				anchor: true,
				type: 'learn',
				slug: '/documentation/products/store/storage/get-object/',
				key: 'getObject',
			},
			{
			...
			},
			{
				...
				anchor: true,
				type: 'learn',
				slug: '/documentation/products/store/storage/delete-objects/',
				key: 'deleteObjects',
			},
			{
...

	{
		...
		items: [
			...
			},
			{
				...
				anchor: true,
				type: 'learn',
				slug: '/documentation/products/store/sql/retrieve-database-info/',
...

	{
		...
		items: [
			...
			},
			{
				...
				anchor: true,
				type: 'learn',
				slug: '/documentation/products/store/sql/query-table-rows/',
				key: 'queryTableRows',
			},
			{
				...
				anchor: true,
				type: 'learn',
				slug: '/documentation/products/store/sql/update-record/',
				key: 'updateRecord',
			},
			{
