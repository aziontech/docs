...
export default [
    ...
    { text: 'Environment Variables', header: true, anchor: true, type: 'learn', slug: '/documentation/products/build/develop-with-azion'/en/'vironment-variables/', key: 'envVars', hasLabel: 'menu.buildData', addBorder: true, },
