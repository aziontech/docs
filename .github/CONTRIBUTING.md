...
- On Azion **docs** repository, you can open a issue without opening a PR after, but you should open an issue before opening a PR.
...
You can branch out from main or commit the changes directly once you're pleased with them. We use the [conventional commits](https://www.conventionalcommits.org/en/v1.0.0/) structure to title commits and PRs.
