...
| Role | Who | Owns |
|---|---|---|
| DevRel | `@aziontech/marketing` | The project: content, style, IA, i18n, roadmap. Default owner and the final say on everything |
...
Technical content passes two gates: an SME confirms it's true, and DevRel confirms it's well written and well placed. Neither substitutes for the other. CODEOWNERS routes the DevRel and UXE reviews automatically. There are no per-product entries in CODEOWNERS, so the author asks the right SME directly.
